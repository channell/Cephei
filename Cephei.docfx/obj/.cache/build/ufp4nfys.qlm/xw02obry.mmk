...
<html>
  ...
  <head>
    ...
    <title>Class CeilingTruncationModel
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class CeilingTruncationModel
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="Cephei.QL.CeilingTruncationModel">
  
  
  <h1 id="Cephei_QL_CeilingTruncationModel" data-uid="Cephei.QL.CeilingTruncationModel" class="text-break">Class CeilingTruncationModel
  </h1>
  ...
  <div class="inheritance">
    ...
    <div class="level3"><a class="xref" href="Cephei.Cell.Generic.Model-1.html">Model</a>&lt;<span class="xref">QLNet.CeilingTruncation</span>&gt;</div>
    <div class="level4"><span class="xref">CeilingTruncationModel</span></div>
  </div>
  <div classs="implements">
    <h5>Implements</h5>
    <div><a class="xref" href="Cephei.Cell.Generic.ICell-1.html">ICell</a>&lt;<span class="xref">QLNet.CeilingTruncation</span>&gt;</div>
    ...
    <div><span class="xref">System.IObservable</span>&lt;<span class="xref">QLNet.CeilingTruncation</span>&gt;</div>
    ...
    <div><span class="xref">System.IObservable</span>&lt;<span class="xref">System.Collections.Generic.KeyValuePair</span>&lt;<a class="xref" href="Cephei.Cell.ISession.html">ISession</a>,<span class="xref">System.Collections.Generic.KeyValuePair</span>&lt;<span class="xref">string</span>,<span class="xref">QLNet.CeilingTruncation</span>&gt;&gt;&gt;</div>
    ...
    <div><span class="xref">System.IObserver</span>&lt;<span class="xref">QLNet.CeilingTruncation</span>&gt;</div>
  </div>
  ...
  <h5 id="Cephei_QL_CeilingTruncationModel_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">[&lt;AutoSerializable(true)&gt;]
type CeilingTruncationModel (precision:ICell&lt;int&gt;, digit:ICell&lt;int&gt;)
    ...
    interface ICell&lt;CeilingTruncation&gt;
    interface ICell
    interface ICellEvent
    interface IObservable&lt;CeilingTruncation&gt;
    interface IObservable&lt;KeyValuePair&lt;ISession,KeyValuePair&lt;string,CeilingTruncation&gt;&gt;&gt;
    interface IObservable&lt;ISession * ICell&lt;CeilingTruncation&gt; * CellEvent * ICell * DateTime&gt;
    interface IObserver&lt;CeilingTruncation&gt;</code></pre>
  </div>
  ...
  <a id="Cephei_QL_CeilingTruncationModel__ctor_" data-uid="Cephei.QL.CeilingTruncationModel.#ctor*"></a>
  <h4 id="Cephei_QL_CeilingTruncationModel__ctor_Cephei_Cell_Generic_ICell_int____Cephei_Cell_Generic_ICell_int__" data-uid="Cephei.QL.CeilingTruncationModel.#ctor(Cephei.Cell.Generic.ICell&lt;int&gt; * Cephei.Cell.Generic.ICell&lt;int&gt;)">new: ICell&lt;int&gt; * ICell&lt;int&gt; -&gt; CeilingTruncationModel</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/Cephei.QL.CeilingTruncationModel.yml" sourcestartlinenumber="1" sourceendlinenumber="1">Implicit constructor.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">new: precision:ICell&lt;int&gt; * digit:ICell&lt;int&gt; -&gt; CeilingTruncationModel</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="Cephei.QL.CeilingTruncationModel.html">CeilingTruncationModel</a></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="Cephei_QL_CeilingTruncationModel_digit_" data-uid="Cephei.QL.CeilingTruncationModel.digit*"></a>
  <h4 id="Cephei_QL_CeilingTruncationModel_digit_unit_" data-uid="Cephei.QL.CeilingTruncationModel.digit(unit)">property digit: ICell&lt;int&gt;</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">property digit: ICell&lt;int&gt; with get</code></pre>
  </div>
  ...
  <a id="Cephei_QL_CeilingTruncationModel_GetType_" data-uid="Cephei.QL.CeilingTruncationModel.GetType*"></a>
  <h4 id="Cephei_QL_CeilingTruncationModel_GetType_unit_" data-uid="Cephei.QL.CeilingTruncationModel.GetType(unit)">property GetType: ICell&lt;Type&gt;</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">property GetType: ICell&lt;Type&gt; with get</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="Cephei.Cell.Generic.ICell-1.html">ICell</a>&lt;<span class="xref">QLNet.Rounding.Type</span>&gt;</td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="Cephei_QL_CeilingTruncationModel_precision_" data-uid="Cephei.QL.CeilingTruncationModel.precision*"></a>
  <h4 id="Cephei_QL_CeilingTruncationModel_precision_unit_" data-uid="Cephei.QL.CeilingTruncationModel.precision(unit)">property precision: ICell&lt;int&gt;</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">property precision: ICell&lt;int&gt; with get</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Cephei_QL_CeilingTruncationModel_Round_" data-uid="Cephei.QL.CeilingTruncationModel.Round*"></a>
  <h4 id="Cephei_QL_CeilingTruncationModel_Round_Cephei_Cell_Generic_ICell_double__" data-uid="Cephei.QL.CeilingTruncationModel.Round(Cephei.Cell.Generic.ICell&lt;double&gt;)">member Round: ICell&lt;double&gt; -&gt; ICell&lt;float&gt;</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">member Round: value:ICell&lt;double&gt; -&gt; ICell&lt;float&gt;</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <div>
      <span class="xref">Cephei.Cell.Generic.ICell&lt;QLNet.CeilingTruncation&gt;</span>
  </div>
  <div>
  ...
  <div>
      <span class="xref">System.IObservable&lt;Cephei.Cell.ISession * Cephei.Cell.Generic.ICell&lt;QLNet.CeilingTruncation&gt; * Cephei.Cell.CellEvent * Cephei.Cell.ICell * System.DateTime&gt;</span>
  </div>
  <div>
  ...
  <div>
      <span class="xref">System.IObservable&lt;QLNet.CeilingTruncation&gt;</span>
  </div>
  <div>
  ...
  <div>
      <span class="xref">System.IObservable&lt;System.Collections.Generic.KeyValuePair&lt;Cephei.Cell.ISession,System.Collections.Generic.KeyValuePair&lt;string,QLNet.CeilingTruncation&gt;&gt;&gt;</span>
  </div>
  <div>
  ...
  <div>
      <span class="xref">System.IObserver&lt;QLNet.CeilingTruncation&gt;</span>
  </div>
</article>
          </div>
