...
<html>
  ...
  <head>
    ...
    <title>Class BlackCallableFixedRateBondEngineModel
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class BlackCallableFixedRateBondEngineModel
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="Cephei.QL.BlackCallableFixedRateBondEngineModel">
  
  
  <h1 id="Cephei_QL_BlackCallableFixedRateBondEngineModel" data-uid="Cephei.QL.BlackCallableFixedRateBondEngineModel" class="text-break">Class BlackCallableFixedRateBondEngineModel
  </h1>
  ...
  <div class="inheritance">
    ...
    <div class="level3"><a class="xref" href="Cephei.Cell.Generic.Model-1.html">Model</a>&lt;<span class="xref">QLNet.BlackCallableFixedRateBondEngine</span>&gt;</div>
    <div class="level4"><span class="xref">BlackCallableFixedRateBondEngineModel</span></div>
  </div>
  <div classs="implements">
    <h5>Implements</h5>
    <div><a class="xref" href="Cephei.Cell.Generic.ICell-1.html">ICell</a>&lt;<span class="xref">QLNet.BlackCallableFixedRateBondEngine</span>&gt;</div>
    ...
    <div><span class="xref">System.IObservable</span>&lt;<span class="xref">QLNet.BlackCallableFixedRateBondEngine</span>&gt;</div>
    ...
    <div><span class="xref">System.IObservable</span>&lt;<span class="xref">System.Collections.Generic.KeyValuePair</span>&lt;<a class="xref" href="Cephei.Cell.ISession.html">ISession</a>,<span class="xref">System.Collections.Generic.KeyValuePair</span>&lt;<span class="xref">string</span>,<span class="xref">QLNet.BlackCallableFixedRateBondEngine</span>&gt;&gt;&gt;</div>
    ...
    <div><span class="xref">System.IObserver</span>&lt;<span class="xref">QLNet.BlackCallableFixedRateBondEngine</span>&gt;</div>
  </div>
  ...
  <h5 id="Cephei_QL_BlackCallableFixedRateBondEngineModel_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">[&lt;AutoSerializable(true)&gt;]
type BlackCallableFixedRateBondEngineModel (fwdYieldVol:ICell&lt;Handle&lt;Quote&gt;&gt;, discountCurve:ICell&lt;Handle&lt;YieldTermStructure&gt;&gt;)
    ...
    interface ICell&lt;BlackCallableFixedRateBondEngine&gt;
    interface ICell
    interface ICellEvent
    interface IObservable&lt;BlackCallableFixedRateBondEngine&gt;
    interface IObservable&lt;KeyValuePair&lt;ISession,KeyValuePair&lt;string,BlackCallableFixedRateBondEngine&gt;&gt;&gt;
    interface IObservable&lt;ISession * ICell&lt;BlackCallableFixedRateBondEngine&gt; * CellEvent * ICell * DateTime&gt;
    interface IObserver&lt;BlackCallableFixedRateBondEngine&gt;</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        ...
        <td><span class="parametername">fwdYieldVol</span></td>
        <td></td>
      </tr>
      <tr>
  ...
  <a id="Cephei_QL_BlackCallableFixedRateBondEngineModel__ctor_" data-uid="Cephei.QL.BlackCallableFixedRateBondEngineModel.#ctor*"></a>
  <h4 id="Cephei_QL_BlackCallableFixedRateBondEngineModel__ctor_Cephei_Cell_Generic_ICell_QLNet_Handle_QLNet_Quote_____Cephei_Cell_Generic_ICell_QLNet_Handle_QLNet_YieldTermStructure___" data-uid="Cephei.QL.BlackCallableFixedRateBondEngineModel.#ctor(Cephei.Cell.Generic.ICell&lt;QLNet.Handle&lt;QLNet.Quote&gt;&gt; * Cephei.Cell.Generic.ICell&lt;QLNet.Handle&lt;QLNet.YieldTermStructure&gt;&gt;)">new: ICell&lt;Handle&lt;Quote&gt;&gt; * ICell&lt;Handle&lt;YieldTermStructure&gt;&gt; -&gt; BlackCallableFixedRateBondEngineModel</h4>
  <div class="markdown level1 summary"><p>Implicit constructor.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">new: fwdYieldVol:ICell&lt;Handle&lt;Quote&gt;&gt; * discountCurve:ICell&lt;Handle&lt;YieldTermStructure&gt;&gt; -&gt; BlackCallableFixedRateBondEngineModel</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="Cephei.QL.BlackCallableFixedRateBondEngineModel.html">BlackCallableFixedRateBondEngineModel</a></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="Cephei_QL_BlackCallableFixedRateBondEngineModel_discountCurve_" data-uid="Cephei.QL.BlackCallableFixedRateBondEngineModel.discountCurve*"></a>
  <h4 id="Cephei_QL_BlackCallableFixedRateBondEngineModel_discountCurve_unit_" data-uid="Cephei.QL.BlackCallableFixedRateBondEngineModel.discountCurve(unit)">property discountCurve: ICell&lt;Handle&lt;YieldTermStructure&gt;&gt;</h4>
  ...
  <a id="Cephei_QL_BlackCallableFixedRateBondEngineModel_fwdYieldVol_" data-uid="Cephei.QL.BlackCallableFixedRateBondEngineModel.fwdYieldVol*"></a>
  <h4 id="Cephei_QL_BlackCallableFixedRateBondEngineModel_fwdYieldVol_unit_" data-uid="Cephei.QL.BlackCallableFixedRateBondEngineModel.fwdYieldVol(unit)">property fwdYieldVol: ICell&lt;Handle&lt;Quote&gt;&gt;</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">property fwdYieldVol: ICell&lt;Handle&lt;Quote&gt;&gt; with get</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <div>
      <span class="xref">Cephei.Cell.Generic.ICell&lt;QLNet.BlackCallableFixedRateBondEngine&gt;</span>
  </div>
  <div>
  ...
  <div>
      <span class="xref">System.IObservable&lt;Cephei.Cell.ISession * Cephei.Cell.Generic.ICell&lt;QLNet.BlackCallableFixedRateBondEngine&gt; * Cephei.Cell.CellEvent * Cephei.Cell.ICell * System.DateTime&gt;</span>
  </div>
  <div>
  ...
  <div>
      <span class="xref">System.IObservable&lt;QLNet.BlackCallableFixedRateBondEngine&gt;</span>
  </div>
  <div>
  ...
  <div>
      <span class="xref">System.IObservable&lt;System.Collections.Generic.KeyValuePair&lt;Cephei.Cell.ISession,System.Collections.Generic.KeyValuePair&lt;string,QLNet.BlackCallableFixedRateBondEngine&gt;&gt;&gt;</span>
  </div>
  <div>
  ...
  <div>
      <span class="xref">System.IObserver&lt;QLNet.BlackCallableFixedRateBondEngine&gt;</span>
  </div>
</article>
          </div>
