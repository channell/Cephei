...
<html>
  ...
  <head>
    ...
    <title>Class DigitalReplicationModel
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class DigitalReplicationModel
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="Cephei.QL.DigitalReplicationModel">
  
  
  <h1 id="Cephei_QL_DigitalReplicationModel" data-uid="Cephei.QL.DigitalReplicationModel" class="text-break">Class DigitalReplicationModel
  </h1>
  ...
  <div class="inheritance">
    ...
    <div class="level3"><a class="xref" href="Cephei.Cell.Generic.Model-1.html">Model</a>&lt;<span class="xref">QLNet.DigitalReplication</span>&gt;</div>
    <div class="level4"><span class="xref">DigitalReplicationModel</span></div>
  </div>
  <div classs="implements">
    <h5>Implements</h5>
    <div><a class="xref" href="Cephei.Cell.Generic.ICell-1.html">ICell</a>&lt;<span class="xref">QLNet.DigitalReplication</span>&gt;</div>
    ...
    <div><span class="xref">System.IObservable</span>&lt;<span class="xref">QLNet.DigitalReplication</span>&gt;</div>
    ...
    <div><span class="xref">System.IObservable</span>&lt;<span class="xref">System.Collections.Generic.KeyValuePair</span>&lt;<a class="xref" href="Cephei.Cell.ISession.html">ISession</a>,<span class="xref">System.Collections.Generic.KeyValuePair</span>&lt;<span class="xref">string</span>,<span class="xref">QLNet.DigitalReplication</span>&gt;&gt;&gt;</div>
    ...
    <div><span class="xref">System.IObserver</span>&lt;<span class="xref">QLNet.DigitalReplication</span>&gt;</div>
  </div>
  ...
  <h5 id="Cephei_QL_DigitalReplicationModel_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">[&lt;AutoSerializable(true)&gt;]
type DigitalReplicationModel (t:ICell&lt;Type&gt;, gap:ICell&lt;double&gt;)
    ...
    interface ICell&lt;DigitalReplication&gt;
    interface ICell
    interface ICellEvent
    interface IObservable&lt;DigitalReplication&gt;
    interface IObservable&lt;KeyValuePair&lt;ISession,KeyValuePair&lt;string,DigitalReplication&gt;&gt;&gt;
    interface IObservable&lt;ISession * ICell&lt;DigitalReplication&gt; * CellEvent * ICell * DateTime&gt;
    interface IObserver&lt;DigitalReplication&gt;</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="Cephei.Cell.Generic.ICell-1.html">ICell</a>&lt;<span class="xref">QLNet.Replication.Type</span>&gt;</td>
  ...
  <a id="Cephei_QL_DigitalReplicationModel__ctor_" data-uid="Cephei.QL.DigitalReplicationModel.#ctor*"></a>
  <h4 id="Cephei_QL_DigitalReplicationModel__ctor_Cephei_Cell_Generic_ICell_QLNet_Replication_Type____Cephei_Cell_Generic_ICell_double__" data-uid="Cephei.QL.DigitalReplicationModel.#ctor(Cephei.Cell.Generic.ICell&lt;QLNet.Replication.Type&gt; * Cephei.Cell.Generic.ICell&lt;double&gt;)">new: ICell&lt;Type&gt; * ICell&lt;double&gt; -&gt; DigitalReplicationModel</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/Cephei.QL.DigitalReplicationModel.yml" sourcestartlinenumber="1" sourceendlinenumber="1">Implicit constructor.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">new: t:ICell&lt;Type&gt; * gap:ICell&lt;double&gt; -&gt; DigitalReplicationModel</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="Cephei.QL.DigitalReplicationModel.html">DigitalReplicationModel</a></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="Cephei_QL_DigitalReplicationModel_gap_" data-uid="Cephei.QL.DigitalReplicationModel.gap*"></a>
  <h4 id="Cephei_QL_DigitalReplicationModel_gap_unit_" data-uid="Cephei.QL.DigitalReplicationModel.gap(unit)">property gap: ICell&lt;float&gt;</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">property gap: ICell&lt;float&gt; with get</code></pre>
  </div>
  ...
  <a id="Cephei_QL_DigitalReplicationModel_ReplicationType_" data-uid="Cephei.QL.DigitalReplicationModel.ReplicationType*"></a>
  <h4 id="Cephei_QL_DigitalReplicationModel_ReplicationType_unit_" data-uid="Cephei.QL.DigitalReplicationModel.ReplicationType(unit)">property ReplicationType: ICell&lt;Type&gt;</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">property ReplicationType: ICell&lt;Type&gt; with get</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Cephei_QL_DigitalReplicationModel_t_" data-uid="Cephei.QL.DigitalReplicationModel.t*"></a>
  <h4 id="Cephei_QL_DigitalReplicationModel_t_unit_" data-uid="Cephei.QL.DigitalReplicationModel.t(unit)">property t: ICell&lt;Type&gt;</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">property t: ICell&lt;Type&gt; with get</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <div>
      <span class="xref">Cephei.Cell.Generic.ICell&lt;QLNet.DigitalReplication&gt;</span>
  </div>
  <div>
  ...
  <div>
      <span class="xref">System.IObservable&lt;Cephei.Cell.ISession * Cephei.Cell.Generic.ICell&lt;QLNet.DigitalReplication&gt; * Cephei.Cell.CellEvent * Cephei.Cell.ICell * System.DateTime&gt;</span>
  </div>
  <div>
  ...
  <div>
      <span class="xref">System.IObservable&lt;QLNet.DigitalReplication&gt;</span>
  </div>
  <div>
  ...
  <div>
      <span class="xref">System.IObservable&lt;System.Collections.Generic.KeyValuePair&lt;Cephei.Cell.ISession,System.Collections.Generic.KeyValuePair&lt;string,QLNet.DigitalReplication&gt;&gt;&gt;</span>
  </div>
  <div>
  ...
  <div>
      <span class="xref">System.IObserver&lt;QLNet.DigitalReplication&gt;</span>
  </div>
</article>
          </div>
