...
<html>
  ...
  <head>
    ...
    <title>Class Uniform1dMesherModel
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class Uniform1dMesherModel
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="Cephei.QL.Uniform1dMesherModel">
  
  
  <h1 id="Cephei_QL_Uniform1dMesherModel" data-uid="Cephei.QL.Uniform1dMesherModel" class="text-break">Class Uniform1dMesherModel
  </h1>
  ...
  <div class="inheritance">
    ...
    <div class="level3"><a class="xref" href="Cephei.Cell.Generic.Model-1.html">Model</a>&lt;<span class="xref">QLNet.Uniform1dMesher</span>&gt;</div>
    <div class="level4"><span class="xref">Uniform1dMesherModel</span></div>
  </div>
  <div classs="implements">
    <h5>Implements</h5>
    <div><a class="xref" href="Cephei.Cell.Generic.ICell-1.html">ICell</a>&lt;<span class="xref">QLNet.Uniform1dMesher</span>&gt;</div>
    ...
    <div><span class="xref">System.IObservable</span>&lt;<span class="xref">QLNet.Uniform1dMesher</span>&gt;</div>
    ...
    <div><span class="xref">System.IObservable</span>&lt;<span class="xref">System.Collections.Generic.KeyValuePair</span>&lt;<a class="xref" href="Cephei.Cell.ISession.html">ISession</a>,<span class="xref">System.Collections.Generic.KeyValuePair</span>&lt;<span class="xref">string</span>,<span class="xref">QLNet.Uniform1dMesher</span>&gt;&gt;&gt;</div>
    ...
    <div><span class="xref">System.IObserver</span>&lt;<span class="xref">QLNet.Uniform1dMesher</span>&gt;</div>
  </div>
  ...
  <h5 id="Cephei_QL_Uniform1dMesherModel_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">[&lt;AutoSerializable(true)&gt;]
type Uniform1dMesherModel (start:ICell&lt;double&gt;, End:ICell&lt;double&gt;, size:ICell&lt;int&gt;)
    ...
    interface ICell&lt;Uniform1dMesher&gt;
    interface ICell
    interface ICellEvent
    interface IObservable&lt;Uniform1dMesher&gt;
    interface IObservable&lt;KeyValuePair&lt;ISession,KeyValuePair&lt;string,Uniform1dMesher&gt;&gt;&gt;
    interface IObservable&lt;ISession * ICell&lt;Uniform1dMesher&gt; * CellEvent * ICell * DateTime&gt;
    interface IObserver&lt;Uniform1dMesher&gt;</code></pre>
  </div>
  ...
  <a id="Cephei_QL_Uniform1dMesherModel__ctor_" data-uid="Cephei.QL.Uniform1dMesherModel.#ctor*"></a>
  <h4 id="Cephei_QL_Uniform1dMesherModel__ctor_Cephei_Cell_Generic_ICell_double____Cephei_Cell_Generic_ICell_double____Cephei_Cell_Generic_ICell_int__" data-uid="Cephei.QL.Uniform1dMesherModel.#ctor(Cephei.Cell.Generic.ICell&lt;double&gt; * Cephei.Cell.Generic.ICell&lt;double&gt; * Cephei.Cell.Generic.ICell&lt;int&gt;)">new: ICell&lt;double&gt; * ICell&lt;double&gt; * ICell&lt;int&gt; -&gt; Uniform1dMesherModel</h4>
  <div class="markdown level1 summary"><p>Implicit constructor.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">new: start:ICell&lt;double&gt; * End:ICell&lt;double&gt; * size:ICell&lt;int&gt; -&gt; Uniform1dMesherModel</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="Cephei.QL.Uniform1dMesherModel.html">Uniform1dMesherModel</a></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="Cephei_QL_Uniform1dMesherModel_End_" data-uid="Cephei.QL.Uniform1dMesherModel.End*"></a>
  <h4 id="Cephei_QL_Uniform1dMesherModel_End_unit_" data-uid="Cephei.QL.Uniform1dMesherModel.End(unit)">property End: ICell&lt;double&gt;</h4>
  ...
  <a id="Cephei_QL_Uniform1dMesherModel_Locations_" data-uid="Cephei.QL.Uniform1dMesherModel.Locations*"></a>
  <h4 id="Cephei_QL_Uniform1dMesherModel_Locations_unit_" data-uid="Cephei.QL.Uniform1dMesherModel.Locations(unit)">property Locations: ICell&lt;List&lt;float&gt;&gt;</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">property Locations: ICell&lt;List&lt;float&gt;&gt; with get</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Cephei_QL_Uniform1dMesherModel_size_" data-uid="Cephei.QL.Uniform1dMesherModel.size*"></a>
  <h4 id="Cephei_QL_Uniform1dMesherModel_size_unit_" data-uid="Cephei.QL.Uniform1dMesherModel.size(unit)">property size: ICell&lt;int&gt;</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <a id="Cephei_QL_Uniform1dMesherModel_start_" data-uid="Cephei.QL.Uniform1dMesherModel.start*"></a>
  <h4 id="Cephei_QL_Uniform1dMesherModel_start_unit_" data-uid="Cephei.QL.Uniform1dMesherModel.start(unit)">property start: ICell&lt;double&gt;</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">property start: ICell&lt;double&gt; with get</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Cephei_QL_Uniform1dMesherModel_Dminus_" data-uid="Cephei.QL.Uniform1dMesherModel.Dminus*"></a>
  <h4 id="Cephei_QL_Uniform1dMesherModel_Dminus_Cephei_Cell_Generic_ICell_int__" data-uid="Cephei.QL.Uniform1dMesherModel.Dminus(Cephei.Cell.Generic.ICell&lt;int&gt;)">member Dminus: ICell&lt;int&gt; -&gt; ICell&lt;Nullable&lt;float&gt;&gt;</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">member Dminus: index:ICell&lt;int&gt; -&gt; ICell&lt;Nullable&lt;float&gt;&gt;</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Cephei_QL_Uniform1dMesherModel_Dplus_" data-uid="Cephei.QL.Uniform1dMesherModel.Dplus*"></a>
  <h4 id="Cephei_QL_Uniform1dMesherModel_Dplus_Cephei_Cell_Generic_ICell_int__" data-uid="Cephei.QL.Uniform1dMesherModel.Dplus(Cephei.Cell.Generic.ICell&lt;int&gt;)">member Dplus: ICell&lt;int&gt; -&gt; ICell&lt;Nullable&lt;float&gt;&gt;</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">member Dplus: index:ICell&lt;int&gt; -&gt; ICell&lt;Nullable&lt;float&gt;&gt;</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Cephei_QL_Uniform1dMesherModel_Location_" data-uid="Cephei.QL.Uniform1dMesherModel.Location*"></a>
  <h4 id="Cephei_QL_Uniform1dMesherModel_Location_Cephei_Cell_Generic_ICell_int__" data-uid="Cephei.QL.Uniform1dMesherModel.Location(Cephei.Cell.Generic.ICell&lt;int&gt;)">member Location: ICell&lt;int&gt; -&gt; ICell&lt;float&gt;</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">member Location: index:ICell&lt;int&gt; -&gt; ICell&lt;float&gt;</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <div>
      <span class="xref">Cephei.Cell.Generic.ICell&lt;QLNet.Uniform1dMesher&gt;</span>
  </div>
  <div>
  ...
  <div>
      <span class="xref">System.IObservable&lt;Cephei.Cell.ISession * Cephei.Cell.Generic.ICell&lt;QLNet.Uniform1dMesher&gt; * Cephei.Cell.CellEvent * Cephei.Cell.ICell * System.DateTime&gt;</span>
  </div>
  <div>
  ...
  <div>
      <span class="xref">System.IObservable&lt;QLNet.Uniform1dMesher&gt;</span>
  </div>
  <div>
  ...
  <div>
      <span class="xref">System.IObservable&lt;System.Collections.Generic.KeyValuePair&lt;Cephei.Cell.ISession,System.Collections.Generic.KeyValuePair&lt;string,QLNet.Uniform1dMesher&gt;&gt;&gt;</span>
  </div>
  <div>
  ...
  <div>
      <span class="xref">System.IObserver&lt;QLNet.Uniform1dMesher&gt;</span>
  </div>
</article>
          </div>
