...
<html>
  ...
  <head>
    ...
    <title>Class AmericanExerciseModel
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class AmericanExerciseModel
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="Cephei.QL.AmericanExerciseModel">
  
  
  <h1 id="Cephei_QL_AmericanExerciseModel" data-uid="Cephei.QL.AmericanExerciseModel" class="text-break">Class AmericanExerciseModel
  </h1>
  ...
  <div class="inheritance">
    ...
    <div class="level3"><a class="xref" href="Cephei.Cell.Generic.Model-1.html">Model</a>&lt;<span class="xref">QLNet.AmericanExercise</span>&gt;</div>
    <div class="level4"><span class="xref">AmericanExerciseModel</span></div>
  </div>
  <div classs="implements">
    <h5>Implements</h5>
    <div><a class="xref" href="Cephei.Cell.Generic.ICell-1.html">ICell</a>&lt;<span class="xref">QLNet.AmericanExercise</span>&gt;</div>
    ...
    <div><span class="xref">System.IObservable</span>&lt;<span class="xref">QLNet.AmericanExercise</span>&gt;</div>
    ...
    <div><span class="xref">System.IObservable</span>&lt;<span class="xref">System.Collections.Generic.KeyValuePair</span>&lt;<a class="xref" href="Cephei.Cell.ISession.html">ISession</a>,<span class="xref">System.Collections.Generic.KeyValuePair</span>&lt;<span class="xref">string</span>,<span class="xref">QLNet.AmericanExercise</span>&gt;&gt;&gt;</div>
    ...
    <div><span class="xref">System.IObserver</span>&lt;<span class="xref">QLNet.AmericanExercise</span>&gt;</div>
  </div>
  ...
  <h5 id="Cephei_QL_AmericanExerciseModel_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">[&lt;AutoSerializable(true)&gt;]
type AmericanExerciseModel (latest:ICell&lt;Date&gt;, payoffAtExpiry:ICell&lt;bool&gt;)
    ...
    interface ICell&lt;AmericanExercise&gt;
    interface ICell
    interface ICellEvent
    interface IObservable&lt;AmericanExercise&gt;
    interface IObservable&lt;KeyValuePair&lt;ISession,KeyValuePair&lt;string,AmericanExercise&gt;&gt;&gt;
    interface IObservable&lt;ISession * ICell&lt;AmericanExercise&gt; * CellEvent * ICell * DateTime&gt;
    interface IObserver&lt;AmericanExercise&gt;</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        ...
        <td><span class="parametername">latest</span></td>
        <td></td>
      </tr>
      <tr>
        <td><a class="xref" href="Cephei.Cell.Generic.ICell-1.html">ICell</a>&lt;<span class="xref">bool</span>&gt;</td>
        <td><span class="parametername">payoffAtExpiry</span></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="Cephei_QL_AmericanExerciseModel__ctor_" data-uid="Cephei.QL.AmericanExerciseModel.#ctor*"></a>
  <h4 id="Cephei_QL_AmericanExerciseModel__ctor_Cephei_Cell_Generic_ICell_QLNet_Date____Cephei_Cell_Generic_ICell_bool__" data-uid="Cephei.QL.AmericanExerciseModel.#ctor(Cephei.Cell.Generic.ICell&lt;QLNet.Date&gt; * Cephei.Cell.Generic.ICell&lt;bool&gt;)">new: ICell&lt;Date&gt; * ICell&lt;bool&gt; -&gt; AmericanExerciseModel</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/Cephei.QL.AmericanExerciseModel.yml" sourcestartlinenumber="1" sourceendlinenumber="1">Implicit constructor.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">new: latest:ICell&lt;Date&gt; * payoffAtExpiry:ICell&lt;bool&gt; -&gt; AmericanExerciseModel</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="Cephei.QL.AmericanExerciseModel.html">AmericanExerciseModel</a></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="Cephei_QL_AmericanExerciseModel_Dates_" data-uid="Cephei.QL.AmericanExerciseModel.Dates*"></a>
  <h4 id="Cephei_QL_AmericanExerciseModel_Dates_unit_" data-uid="Cephei.QL.AmericanExerciseModel.Dates(unit)">property Dates: ICell&lt;List&lt;Date&gt;&gt;</h4>
  ...
  <a id="Cephei_QL_AmericanExerciseModel_LastDate_" data-uid="Cephei.QL.AmericanExerciseModel.LastDate*"></a>
  <h4 id="Cephei_QL_AmericanExerciseModel_LastDate_unit_" data-uid="Cephei.QL.AmericanExerciseModel.LastDate(unit)">property LastDate: ICell&lt;Date&gt;</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">property LastDate: ICell&lt;Date&gt; with get</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Cephei_QL_AmericanExerciseModel_latest_" data-uid="Cephei.QL.AmericanExerciseModel.latest*"></a>
  <h4 id="Cephei_QL_AmericanExerciseModel_latest_unit_" data-uid="Cephei.QL.AmericanExerciseModel.latest(unit)">property latest: ICell&lt;Date&gt;</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">property latest: ICell&lt;Date&gt; with get</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Cephei_QL_AmericanExerciseModel_payoffAtExpiry_" data-uid="Cephei.QL.AmericanExerciseModel.payoffAtExpiry*"></a>
  <h4 id="Cephei_QL_AmericanExerciseModel_payoffAtExpiry_unit_" data-uid="Cephei.QL.AmericanExerciseModel.payoffAtExpiry(unit)">property payoffAtExpiry: ICell&lt;bool&gt;</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">property payoffAtExpiry: ICell&lt;bool&gt; with get</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Cephei_QL_AmericanExerciseModel_Type_" data-uid="Cephei.QL.AmericanExerciseModel.Type*"></a>
  <h4 id="Cephei_QL_AmericanExerciseModel_Type_unit_" data-uid="Cephei.QL.AmericanExerciseModel.Type(unit)">property Type: ICell&lt;Type&gt;</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="Cephei.Cell.Generic.ICell-1.html">ICell</a>&lt;<span class="xref">QLNet.Exercise.Type</span>&gt;</td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="Cephei_QL_AmericanExerciseModel_Date_" data-uid="Cephei.QL.AmericanExerciseModel.Date*"></a>
  <h4 id="Cephei_QL_AmericanExerciseModel_Date_Cephei_Cell_Generic_ICell_int__" data-uid="Cephei.QL.AmericanExerciseModel.Date(Cephei.Cell.Generic.ICell&lt;int&gt;)">member Date: ICell&lt;int&gt; -&gt; ICell&lt;Date&gt;</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">member Date: index:ICell&lt;int&gt; -&gt; ICell&lt;Date&gt;</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <div>
      <span class="xref">Cephei.Cell.Generic.ICell&lt;QLNet.AmericanExercise&gt;</span>
  </div>
  <div>
  ...
  <div>
      <span class="xref">System.IObservable&lt;Cephei.Cell.ISession * Cephei.Cell.Generic.ICell&lt;QLNet.AmericanExercise&gt; * Cephei.Cell.CellEvent * Cephei.Cell.ICell * System.DateTime&gt;</span>
  </div>
  <div>
  ...
  <div>
      <span class="xref">System.IObservable&lt;QLNet.AmericanExercise&gt;</span>
  </div>
  <div>
  ...
  <div>
      <span class="xref">System.IObservable&lt;System.Collections.Generic.KeyValuePair&lt;Cephei.Cell.ISession,System.Collections.Generic.KeyValuePair&lt;string,QLNet.AmericanExercise&gt;&gt;&gt;</span>
  </div>
  <div>
  ...
  <div>
      <span class="xref">System.IObserver&lt;QLNet.AmericanExercise&gt;</span>
  </div>
</article>
          </div>
