...
namespace Cephei.Gen
{
    ...
    #line 1 "C:\Users\steve\Source\Repos\Cephei2\Cephei.Gen\NetXL\Control.tt"
...
#line hidden
        ...
        public virtual string TransformText()
        {
            ...
            #line 11 "C:\Users\steve\Source\Repos\Cephei2\Cephei.Gen\NetXL\Control.tt"
 go (); 
        ...
        #line 12 "C:\Users\steve\Source\Repos\Cephei2\Cephei.Gen\NetXL\Control.tt"
...
/// <summary>
/// Access the Root parameter of the template.
/// </summary>
private string Root
{
    get
...
public virtual void Initialize()
{
    ...
    {
bool RootValueAcquired = false;
if (this.Session.ContainsKey("Root"))
{
    this._RootField = ((string)(this.Session["Root"]));
    RootValueAcquired = true;
}
if ((RootValueAcquired == false))
{
    object data = global::System.Runtime.Remoting.Messaging.CallContext.LogicalGetData("Root");
    if ((data != null))
    {
        this._RootField = ((string)(data));
    }
}
