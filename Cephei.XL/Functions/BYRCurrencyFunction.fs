    ...
    let BYRCurrency_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.BYRCurrency ()
                                                       ) :> ICell
    ...
    let BYRCurrency_code
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _BYRCurrency = Helper.toModelReference<BYRCurrency> byrcurrency "BYRCurrency"  
                let builder (current : ICell) = ((BYRCurrencyModel.Cast _BYRCurrency.cell).Code
                                                       ) :> ICell
    ...
    let BYRCurrency_empty
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _BYRCurrency = Helper.toModelReference<BYRCurrency> byrcurrency "BYRCurrency"  
                let builder (current : ICell) = ((BYRCurrencyModel.Cast _BYRCurrency.cell).Empty
                                                       ) :> ICell
    ...
    let BYRCurrency_Equals
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((BYRCurrencyModel.Cast _BYRCurrency.cell).Equals
                                                            _o.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let BYRCurrency_format
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _BYRCurrency = Helper.toModelReference<BYRCurrency> byrcurrency "BYRCurrency"  
                let builder (current : ICell) = ((BYRCurrencyModel.Cast _BYRCurrency.cell).Format
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let BYRCurrency_fractionsPerUnit
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _BYRCurrency = Helper.toModelReference<BYRCurrency> byrcurrency "BYRCurrency"  
                let builder (current : ICell) = ((BYRCurrencyModel.Cast _BYRCurrency.cell).FractionsPerUnit
                                                       ) :> ICell
    ...
    let BYRCurrency_fractionSymbol
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _BYRCurrency = Helper.toModelReference<BYRCurrency> byrcurrency "BYRCurrency"  
                let builder (current : ICell) = ((BYRCurrencyModel.Cast _BYRCurrency.cell).FractionSymbol
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let BYRCurrency_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _BYRCurrency = Helper.toModelReference<BYRCurrency> byrcurrency "BYRCurrency"  
                let builder (current : ICell) = ((BYRCurrencyModel.Cast _BYRCurrency.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let BYRCurrency_numericCode
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _BYRCurrency = Helper.toModelReference<BYRCurrency> byrcurrency "BYRCurrency"  
                let builder (current : ICell) = ((BYRCurrencyModel.Cast _BYRCurrency.cell).NumericCode
                                                       ) :> ICell
                let format (o : int) (l:string) = o :> obj
    ...
    let BYRCurrency_rounding
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _BYRCurrency = Helper.toModelReference<BYRCurrency> byrcurrency "BYRCurrency"  
                let builder (current : ICell) = ((BYRCurrencyModel.Cast _BYRCurrency.cell).Rounding
                                                       ) :> ICell
    ...
    let BYRCurrency_symbol
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _BYRCurrency = Helper.toModelReference<BYRCurrency> byrcurrency "BYRCurrency"  
                let builder (current : ICell) = ((BYRCurrencyModel.Cast _BYRCurrency.cell).Symbol
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let BYRCurrency_ToString
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _BYRCurrency = Helper.toModelReference<BYRCurrency> byrcurrency "BYRCurrency"  
                let builder (current : ICell) = ((BYRCurrencyModel.Cast _BYRCurrency.cell).ToString
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let BYRCurrency_triangulationCurrency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _BYRCurrency = Helper.toModelReference<BYRCurrency> byrcurrency "BYRCurrency"  
                let builder (current : ICell) = ((BYRCurrencyModel.Cast _BYRCurrency.cell).TriangulationCurrency
                                                       ) :> ICell
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                Model.specify 
                    ...
                    ; source =  (fun () -> "(new Cephei.Cell.List<BYRCurrency>(" + (Helper.sourceFoldArray (s) + "))"))
