    ...
    let YoYInflationBachelierCapFloorEngine_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.YoYInflationBachelierCapFloorEngine 
                                                            _index.cell 
                                                            _vol.cell 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                Model.specify 
                    ...
                    ; source =  (fun () -> "(new Cephei.Cell.List<YoYInflationBachelierCapFloorEngine>(" + (Helper.sourceFoldArray (s) + "))"))
