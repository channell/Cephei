    ...
    let GbpLiborSwapIsdaFix_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _GbpLiborSwapIsdaFix = Helper.toModelReference<GbpLiborSwapIsdaFix> gbpliborswapisdafix "GbpLiborSwapIsdaFix"  
                let _tenor = Helper.toCell<Period> tenor "tenor" 
    ...
    let GbpLiborSwapIsdaFix_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<GbpLiborSwapIsdaFix> (c)) :> ICell
                let format (i : Cephei.Cell.List<GbpLiborSwapIsdaFix>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<GbpLiborSwapIsdaFix>(" + (Helper.sourceFoldArray (s) + "))"))
