    ...
    let Bkbm6M_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.Bkbm6M 
                                                            _h.cell 
                                                       ) :> ICell
    ...
    let Bkbm6M_businessDayConvention
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm6M = Helper.toModelReference<Bkbm6M> bkbm6m "Bkbm6M"  
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).BusinessDayConvention
                                                       ) :> ICell
    ...
    let Bkbm6M_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).Clone
                                                            _forwarding.cell 
                                                       ) :> ICell
    ...
    let Bkbm6M_endOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm6M = Helper.toModelReference<Bkbm6M> bkbm6m "Bkbm6M"  
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).EndOfMonth
                                                       ) :> ICell
    ...
    let Bkbm6M_forecastFixing1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).ForecastFixing1
                                                            _d1.cell 
                                                            _d2.cell 
                                                            _t.cell 
                                                       ) :> ICell
    ...
    let Bkbm6M_forecastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).ForecastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let Bkbm6M_forwardingTermStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm6M = Helper.toModelReference<Bkbm6M> bkbm6m "Bkbm6M"  
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).ForwardingTermStructure
                                                       ) :> ICell
    ...
    let Bkbm6M_maturityDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).MaturityDate
                                                            _valueDate.cell 
                                                       ) :> ICell
    ...
    let Bkbm6M_currency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm6M = Helper.toModelReference<Bkbm6M> bkbm6m "Bkbm6M"  
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).Currency
                                                       ) :> ICell
    ...
    let Bkbm6M_dayCounter
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm6M = Helper.toModelReference<Bkbm6M> bkbm6m "Bkbm6M"  
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).DayCounter
                                                       ) :> ICell
    ...
    let Bkbm6M_familyName
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm6M = Helper.toModelReference<Bkbm6M> bkbm6m "Bkbm6M"  
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).FamilyName
                                                       ) :> ICell
    ...
    let Bkbm6M_fixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).Fixing
                                                            _fixingDate.cell 
    ...
    let Bkbm6M_fixingCalendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm6M = Helper.toModelReference<Bkbm6M> bkbm6m "Bkbm6M"  
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).FixingCalendar
                                                       ) :> ICell
    ...
    let Bkbm6M_fixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm6M = Helper.toModelReference<Bkbm6M> bkbm6m "Bkbm6M"  
                let _valueDate = Helper.toCell<Date> valueDate "valueDate" 
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).FixingDate
                                                            _valueDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let Bkbm6M_fixingDays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm6M = Helper.toModelReference<Bkbm6M> bkbm6m "Bkbm6M"  
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).FixingDays
                                                       ) :> ICell
    ...
    let Bkbm6M_isValidFixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm6M = Helper.toModelReference<Bkbm6M> bkbm6m "Bkbm6M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).IsValidFixingDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Bkbm6M_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm6M = Helper.toModelReference<Bkbm6M> bkbm6m "Bkbm6M"  
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let Bkbm6M_pastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm6M = Helper.toModelReference<Bkbm6M> bkbm6m "Bkbm6M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).PastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
    ...
    let Bkbm6M_tenor
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm6M = Helper.toModelReference<Bkbm6M> bkbm6m "Bkbm6M"  
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).Tenor
                                                       ) :> ICell
    ...
    let Bkbm6M_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm6M = Helper.toModelReference<Bkbm6M> bkbm6m "Bkbm6M"  
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).Update
                                                       ) :> ICell
    ...
    let Bkbm6M_valueDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm6M = Helper.toModelReference<Bkbm6M> bkbm6m "Bkbm6M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).ValueDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let Bkbm6M_addFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).AddFixing
                                                            _d.cell 
                                                            _v.cell 
    ...
    let Bkbm6M_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).AddFixings
                                                            _d.cell 
                                                            _v.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
    ...
    let Bkbm6M_addFixings1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).AddFixings1
                                                            _source.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
                let format (o : Bkbm6M) (l:string) = o.ToString() :> obj
    ...
    let Bkbm6M_allowsNativeFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm6M = Helper.toModelReference<Bkbm6M> bkbm6m "Bkbm6M"  
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).AllowsNativeFixings
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Bkbm6M_clearFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm6M = Helper.toModelReference<Bkbm6M> bkbm6m "Bkbm6M"  
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).ClearFixings
                                                       ) :> ICell
                let format (o : Bkbm6M) (l:string) = o.ToString() :> obj
    ...
    let Bkbm6M_registerWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).RegisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : Bkbm6M) (l:string) = o.ToString() :> obj
    ...
    let Bkbm6M_timeSeries
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm6M = Helper.toModelReference<Bkbm6M> bkbm6m "Bkbm6M"  
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).TimeSeries
                                                       ) :> ICell
    ...
    let Bkbm6M_unregisterWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm6M = Helper.toModelReference<Bkbm6M> bkbm6m "Bkbm6M"  
                let _handler = Helper.toCell<Callback> handler "handler" 
                let builder (current : ICell) = ((Bkbm6MModel.Cast _Bkbm6M.cell).UnregisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : Bkbm6M) (l:string) = o.ToString() :> obj
    ...
    let Bkbm6M_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<Bkbm6M> (c)) :> ICell
                let format (i : Cephei.Cell.List<Bkbm6M>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<Bkbm6M>(" + (Helper.sourceFoldArray (s) + "))"))
