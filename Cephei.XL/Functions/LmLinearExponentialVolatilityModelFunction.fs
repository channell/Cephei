    ...
    let LmLinearExponentialVolatilityModel_integratedVariance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((LmLinearExponentialVolatilityModelModel.Cast _LmLinearExponentialVolatilityModel.cell).IntegratedVariance
                                                            _i.cell 
                                                            _j.cell 
                                                            _u.cell 
                                                            _x.cell 
    ...
    let LmLinearExponentialVolatilityModel_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.LmLinearExponentialVolatilityModel 
                                                            _fixingTimes.cell 
                                                            _a.cell 
                                                            _b.cell 
                                                            _c.cell 
    ...
    let LmLinearExponentialVolatilityModel_volatility
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _x = Helper.toDefault<Vector> x "x" null
                let builder (current : ICell) = ((LmLinearExponentialVolatilityModelModel.Cast _LmLinearExponentialVolatilityModel.cell).Volatility
                                                            _i.cell 
                                                            _t.cell 
                                                            _x.cell 
                                                       ) :> ICell
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                Model.specify 
                    ...
                    ; source =  (fun () -> "(new Cephei.Cell.List<LmLinearExponentialVolatilityModel>(" + (Helper.sourceFoldArray (s) + "))"))
