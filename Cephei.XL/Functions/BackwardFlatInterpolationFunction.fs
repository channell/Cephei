    ...
    let BackwardFlatInterpolation_derivative
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _BackwardFlatInterpolation = Helper.toCell<BackwardFlatInterpolation> backwardflatinterpolation "BackwardFlatInterpolation" true 
    ...
    let BackwardFlatInterpolation_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<BackwardFlatInterpolation> i "value" true) |>
                        Seq.toArray
