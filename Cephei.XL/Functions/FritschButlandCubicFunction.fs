    ...
    let FritschButlandCubic_aCoefficients
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _FritschButlandCubic = Helper.toModelReference<FritschButlandCubic> fritschbutlandcubic "FritschButlandCubic"  
    ...
    let FritschButlandCubic_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<FritschButlandCubic> (c)) :> ICell
                let format (i : Cephei.Cell.List<FritschButlandCubic>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<FritschButlandCubic>(" + (Helper.sourceFoldArray (s) + "))"))
