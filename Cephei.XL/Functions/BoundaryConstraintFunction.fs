    ...
    let BoundaryConstraint_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.BoundaryConstraint 
                                                            _low.cell 
                                                            _high.cell 
                                                       ) :> ICell
    ...
    let BoundaryConstraint_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((BoundaryConstraintModel.Cast _BoundaryConstraint.cell).Update
                                                            _p.cell 
                                                            _direction.cell 
                                                            _beta.cell 
                                                       ) :> ICell
    ...
    let BoundaryConstraint_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<BoundaryConstraint>) (l : string) = Helper.Range.fromModelList i l
