    ...
    let LiborForwardModel_discountBond
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((LiborForwardModelModel.Cast _LiborForwardModel.cell).DiscountBond
                                                            _t.cell 
                                                            _maturity.cell 
                                                            _v.cell 
                                                       ) :> ICell
    ...
    let LiborForwardModel_discountBondOption
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((LiborForwardModelModel.Cast _LiborForwardModel.cell).DiscountBondOption
                                                            _Type.cell 
                                                            _strike.cell 
                                                            _maturity.cell 
                                                            _bondMaturity.cell 
    ...
    let LiborForwardModel_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.LiborForwardModel 
                                                            _Process.cell 
                                                            _volaModel.cell 
                                                            _corrModel.cell 
    ...
    let LiborForwardModel_calibrate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((LiborForwardModelModel.Cast _LiborForwardModel.cell).Calibrate
                                                            _instruments.cell 
                                                            _Method.cell 
                                                            _endCriteria.cell 
    ...
    let LiborForwardModel_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<LiborForwardModel>) (l : string) = Helper.Range.fromModelList i l
