    ...
    let BermudanExercise_payoffAtExpiry
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _BermudanExercise = Helper.toModelReference<BermudanExercise> bermudanexercise "BermudanExercise"  
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                Model.specify 
                    ...
                    ; source =  (fun () -> "(new Cephei.Cell.List<BermudanExercise>(" + (Helper.sourceFoldArray (s) + "))"))
