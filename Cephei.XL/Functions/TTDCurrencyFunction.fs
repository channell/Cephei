    ...
    let TTDCurrency_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.TTDCurrency ()
                                                       ) :> ICell
    ...
    let TTDCurrency_code
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TTDCurrency = Helper.toModelReference<TTDCurrency> ttdcurrency "TTDCurrency"  
                let builder (current : ICell) = ((TTDCurrencyModel.Cast _TTDCurrency.cell).Code
                                                       ) :> ICell
    ...
    let TTDCurrency_empty
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TTDCurrency = Helper.toModelReference<TTDCurrency> ttdcurrency "TTDCurrency"  
                let builder (current : ICell) = ((TTDCurrencyModel.Cast _TTDCurrency.cell).Empty
                                                       ) :> ICell
    ...
    let TTDCurrency_Equals
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((TTDCurrencyModel.Cast _TTDCurrency.cell).Equals
                                                            _o.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let TTDCurrency_format
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TTDCurrency = Helper.toModelReference<TTDCurrency> ttdcurrency "TTDCurrency"  
                let builder (current : ICell) = ((TTDCurrencyModel.Cast _TTDCurrency.cell).Format
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let TTDCurrency_fractionsPerUnit
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TTDCurrency = Helper.toModelReference<TTDCurrency> ttdcurrency "TTDCurrency"  
                let builder (current : ICell) = ((TTDCurrencyModel.Cast _TTDCurrency.cell).FractionsPerUnit
                                                       ) :> ICell
    ...
    let TTDCurrency_fractionSymbol
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TTDCurrency = Helper.toModelReference<TTDCurrency> ttdcurrency "TTDCurrency"  
                let builder (current : ICell) = ((TTDCurrencyModel.Cast _TTDCurrency.cell).FractionSymbol
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let TTDCurrency_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TTDCurrency = Helper.toModelReference<TTDCurrency> ttdcurrency "TTDCurrency"  
                let builder (current : ICell) = ((TTDCurrencyModel.Cast _TTDCurrency.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let TTDCurrency_numericCode
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TTDCurrency = Helper.toModelReference<TTDCurrency> ttdcurrency "TTDCurrency"  
                let builder (current : ICell) = ((TTDCurrencyModel.Cast _TTDCurrency.cell).NumericCode
                                                       ) :> ICell
                let format (o : int) (l:string) = o :> obj
    ...
    let TTDCurrency_rounding
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TTDCurrency = Helper.toModelReference<TTDCurrency> ttdcurrency "TTDCurrency"  
                let builder (current : ICell) = ((TTDCurrencyModel.Cast _TTDCurrency.cell).Rounding
                                                       ) :> ICell
    ...
    let TTDCurrency_symbol
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TTDCurrency = Helper.toModelReference<TTDCurrency> ttdcurrency "TTDCurrency"  
                let builder (current : ICell) = ((TTDCurrencyModel.Cast _TTDCurrency.cell).Symbol
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let TTDCurrency_ToString
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TTDCurrency = Helper.toModelReference<TTDCurrency> ttdcurrency "TTDCurrency"  
                let builder (current : ICell) = ((TTDCurrencyModel.Cast _TTDCurrency.cell).ToString
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let TTDCurrency_triangulationCurrency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TTDCurrency = Helper.toModelReference<TTDCurrency> ttdcurrency "TTDCurrency"  
                let builder (current : ICell) = ((TTDCurrencyModel.Cast _TTDCurrency.cell).TriangulationCurrency
                                                       ) :> ICell
    ...
    let TTDCurrency_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<TTDCurrency> (c)) :> ICell
                let format (i : Cephei.Cell.List<TTDCurrency>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<TTDCurrency>(" + (Helper.sourceFoldArray (s) + "))"))
