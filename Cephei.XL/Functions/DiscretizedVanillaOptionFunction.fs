    ...
    let DiscretizedVanillaOption_mandatoryTimes
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscretizedVanillaOption = Helper.toModelReference<DiscretizedVanillaOption> discretizedvanillaoption "DiscretizedVanillaOption"  
    ...
    let DiscretizedVanillaOption_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<DiscretizedVanillaOption> (c)) :> ICell
                let format (i : Cephei.Cell.List<DiscretizedVanillaOption>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<DiscretizedVanillaOption>(" + (Helper.sourceFoldArray (s) + "))"))
