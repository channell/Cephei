    ...
    let ForwardTypePayoff_description
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _ForwardTypePayoff = Helper.toModelReference<ForwardTypePayoff> forwardtypepayoff "ForwardTypePayoff"  
    ...
    let ForwardTypePayoff_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<ForwardTypePayoff>) (l : string) = Helper.Range.fromModelList i l
