    ...
    let Bkbm5M_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.Bkbm5M 
                                                            _h.cell 
                                                       ) :> ICell
    ...
    let Bkbm5M_businessDayConvention
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm5M = Helper.toModelReference<Bkbm5M> bkbm5m "Bkbm5M"  
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).BusinessDayConvention
                                                       ) :> ICell
    ...
    let Bkbm5M_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).Clone
                                                            _forwarding.cell 
                                                       ) :> ICell
    ...
    let Bkbm5M_endOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm5M = Helper.toModelReference<Bkbm5M> bkbm5m "Bkbm5M"  
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).EndOfMonth
                                                       ) :> ICell
    ...
    let Bkbm5M_forecastFixing1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).ForecastFixing1
                                                            _d1.cell 
                                                            _d2.cell 
                                                            _t.cell 
                                                       ) :> ICell
    ...
    let Bkbm5M_forecastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).ForecastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let Bkbm5M_forwardingTermStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm5M = Helper.toModelReference<Bkbm5M> bkbm5m "Bkbm5M"  
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).ForwardingTermStructure
                                                       ) :> ICell
    ...
    let Bkbm5M_maturityDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).MaturityDate
                                                            _valueDate.cell 
                                                       ) :> ICell
    ...
    let Bkbm5M_currency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm5M = Helper.toModelReference<Bkbm5M> bkbm5m "Bkbm5M"  
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).Currency
                                                       ) :> ICell
    ...
    let Bkbm5M_dayCounter
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm5M = Helper.toModelReference<Bkbm5M> bkbm5m "Bkbm5M"  
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).DayCounter
                                                       ) :> ICell
    ...
    let Bkbm5M_familyName
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm5M = Helper.toModelReference<Bkbm5M> bkbm5m "Bkbm5M"  
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).FamilyName
                                                       ) :> ICell
    ...
    let Bkbm5M_fixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).Fixing
                                                            _fixingDate.cell 
    ...
    let Bkbm5M_fixingCalendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm5M = Helper.toModelReference<Bkbm5M> bkbm5m "Bkbm5M"  
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).FixingCalendar
                                                       ) :> ICell
    ...
    let Bkbm5M_fixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm5M = Helper.toModelReference<Bkbm5M> bkbm5m "Bkbm5M"  
                let _valueDate = Helper.toCell<Date> valueDate "valueDate" 
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).FixingDate
                                                            _valueDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let Bkbm5M_fixingDays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm5M = Helper.toModelReference<Bkbm5M> bkbm5m "Bkbm5M"  
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).FixingDays
                                                       ) :> ICell
    ...
    let Bkbm5M_isValidFixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm5M = Helper.toModelReference<Bkbm5M> bkbm5m "Bkbm5M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).IsValidFixingDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Bkbm5M_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm5M = Helper.toModelReference<Bkbm5M> bkbm5m "Bkbm5M"  
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let Bkbm5M_pastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm5M = Helper.toModelReference<Bkbm5M> bkbm5m "Bkbm5M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).PastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
    ...
    let Bkbm5M_tenor
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm5M = Helper.toModelReference<Bkbm5M> bkbm5m "Bkbm5M"  
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).Tenor
                                                       ) :> ICell
    ...
    let Bkbm5M_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm5M = Helper.toModelReference<Bkbm5M> bkbm5m "Bkbm5M"  
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).Update
                                                       ) :> ICell
    ...
    let Bkbm5M_valueDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm5M = Helper.toModelReference<Bkbm5M> bkbm5m "Bkbm5M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).ValueDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let Bkbm5M_addFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).AddFixing
                                                            _d.cell 
                                                            _v.cell 
    ...
    let Bkbm5M_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).AddFixings
                                                            _d.cell 
                                                            _v.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
    ...
    let Bkbm5M_addFixings1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).AddFixings1
                                                            _source.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
                let format (o : Bkbm5M) (l:string) = o.ToString() :> obj
    ...
    let Bkbm5M_allowsNativeFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm5M = Helper.toModelReference<Bkbm5M> bkbm5m "Bkbm5M"  
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).AllowsNativeFixings
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Bkbm5M_clearFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm5M = Helper.toModelReference<Bkbm5M> bkbm5m "Bkbm5M"  
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).ClearFixings
                                                       ) :> ICell
                let format (o : Bkbm5M) (l:string) = o.ToString() :> obj
    ...
    let Bkbm5M_registerWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).RegisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : Bkbm5M) (l:string) = o.ToString() :> obj
    ...
    let Bkbm5M_timeSeries
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm5M = Helper.toModelReference<Bkbm5M> bkbm5m "Bkbm5M"  
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).TimeSeries
                                                       ) :> ICell
    ...
    let Bkbm5M_unregisterWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm5M = Helper.toModelReference<Bkbm5M> bkbm5m "Bkbm5M"  
                let _handler = Helper.toCell<Callback> handler "handler" 
                let builder (current : ICell) = ((Bkbm5MModel.Cast _Bkbm5M.cell).UnregisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : Bkbm5M) (l:string) = o.ToString() :> obj
    ...
    let Bkbm5M_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<Bkbm5M> (c)) :> ICell
                let format (i : Cephei.Cell.List<Bkbm5M>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<Bkbm5M>(" + (Helper.sourceFoldArray (s) + "))"))
