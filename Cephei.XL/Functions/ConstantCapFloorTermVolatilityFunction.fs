    ...
    let ConstantCapFloorTermVolatility_maxDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _ConstantCapFloorTermVolatility = Helper.toModelReference<ConstantCapFloorTermVolatility> constantcapfloortermvolatility "ConstantCapFloorTermVolatility"  
    ...
    let ConstantCapFloorTermVolatility_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<ConstantCapFloorTermVolatility>) (l : string) = Helper.Range.fromModelList i l
