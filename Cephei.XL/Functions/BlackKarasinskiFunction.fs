    ...
    let BlackKarasinski_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.BlackKarasinski1 
                                                            _termStructure.cell 
                                                       ) :> ICell
    ...
    let BlackKarasinski_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.BlackKarasinski 
                                                            _termStructure.cell 
                                                            _a.cell 
                                                            _sigma.cell 
                                                       ) :> ICell
    ...
    let BlackKarasinski_calibrate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((BlackKarasinskiModel.Cast _BlackKarasinski.cell).Calibrate
                                                            _instruments.cell 
                                                            _Method.cell 
                                                            _endCriteria.cell 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                Model.specify 
                    ...
                    ; source =  (fun () -> "(new Cephei.Cell.List<BlackKarasinski>(" + (Helper.sourceFoldArray (s) + "))"))
