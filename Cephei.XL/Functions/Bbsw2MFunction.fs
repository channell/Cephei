...
module Bbsw2MFunction =
    ...
    *)
    [<ExcelFunction(Name="_Bbsw2M_forecastFixing1", Description="Create a Bbsw2M",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    ...
    *)
    [<ExcelFunction(Name="_Bbsw2M_addFixings1", Description="Create a Bbsw2M",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
