    ...
    let TsiveriotisFernandesLattice_stepback
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((TsiveriotisFernandesLatticeModel.Cast _TsiveriotisFernandesLattice.cell).Stepback
                                                            _i.cell 
                                                            _values.cell 
    ...
    let TsiveriotisFernandesLattice_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.TsiveriotisFernandesLattice 
                                                            _tree.cell 
                                                            _riskFreeRate.cell 
                                                            _End.cell 
                                                            _steps.cell 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                Model.specify 
                    ...
                    ; source =  (fun () -> "(new Cephei.Cell.List<TsiveriotisFernandesLattice>(" + (Helper.sourceFoldArray (s) + "))"))
