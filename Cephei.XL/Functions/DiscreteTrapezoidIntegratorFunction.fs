...
module DiscreteTrapezoidIntegratorFunction =
    ...
    let DiscreteTrapezoidIntegrator_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.DiscreteTrapezoidIntegrator 
                                                            _evaluations.cell 
                                                       ) :> ICell
    ...
    *)
    ...
    let DiscreteTrapezoidIntegrator_absoluteAccuracy
        ([<ExcelArgument(Name="Mnemonic",Description = "Identifier for Cell")>] 
         mnemonic : string)
        ([<ExcelArgument(Name="DiscreteTrapezoidIntegrator",Description = "DiscreteTrapezoidIntegrator")>] 
    ...
    let DiscreteTrapezoidIntegrator_value
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((DiscreteTrapezoidIntegratorModel.Cast _DiscreteTrapezoidIntegrator.cell).Value
                                                            _f.cell 
                                                            _a.cell 
                                                            _b.cell 
                                                       ) :> ICell
    ...
    let DiscreteTrapezoidIntegrator_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<DiscreteTrapezoidIntegrator>) (l : string) = Helper.Range.fromModelList i l
