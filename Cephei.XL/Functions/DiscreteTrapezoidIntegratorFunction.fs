    ...
    let DiscreteTrapezoidIntegrator_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic (Fun.DiscreteTrapezoidIntegrator 
                                                            _evaluations.cell 
                                                       ) :> ICell
    ...
    let DiscreteTrapezoidIntegrator_absoluteAccuracy
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscreteTrapezoidIntegrator = Helper.toCell<DiscreteTrapezoidIntegrator> discretetrapezoidintegrator "DiscreteTrapezoidIntegrator" true 
                let builder () = withMnemonic mnemonic ((_DiscreteTrapezoidIntegrator.cell :?> DiscreteTrapezoidIntegratorModel).AbsoluteAccuracy
                                                       ) :> ICell
    ...
    let DiscreteTrapezoidIntegrator_absoluteError
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscreteTrapezoidIntegrator = Helper.toCell<DiscreteTrapezoidIntegrator> discretetrapezoidintegrator "DiscreteTrapezoidIntegrator" true 
                let builder () = withMnemonic mnemonic ((_DiscreteTrapezoidIntegrator.cell :?> DiscreteTrapezoidIntegratorModel).AbsoluteError
                                                       ) :> ICell
    ...
    let DiscreteTrapezoidIntegrator_integrationSuccess
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscreteTrapezoidIntegrator = Helper.toCell<DiscreteTrapezoidIntegrator> discretetrapezoidintegrator "DiscreteTrapezoidIntegrator" true 
                let builder () = withMnemonic mnemonic ((_DiscreteTrapezoidIntegrator.cell :?> DiscreteTrapezoidIntegratorModel).IntegrationSuccess
                                                       ) :> ICell
    ...
    let DiscreteTrapezoidIntegrator_maxEvaluations
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscreteTrapezoidIntegrator = Helper.toCell<DiscreteTrapezoidIntegrator> discretetrapezoidintegrator "DiscreteTrapezoidIntegrator" true 
                let builder () = withMnemonic mnemonic ((_DiscreteTrapezoidIntegrator.cell :?> DiscreteTrapezoidIntegratorModel).MaxEvaluations
                                                       ) :> ICell
    ...
    let DiscreteTrapezoidIntegrator_numberOfEvaluations
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscreteTrapezoidIntegrator = Helper.toCell<DiscreteTrapezoidIntegrator> discretetrapezoidintegrator "DiscreteTrapezoidIntegrator" true 
                let builder () = withMnemonic mnemonic ((_DiscreteTrapezoidIntegrator.cell :?> DiscreteTrapezoidIntegratorModel).NumberOfEvaluations
                                                       ) :> ICell
                let format (o : int) (l:string) = o :> obj
    ...
    let DiscreteTrapezoidIntegrator_setAbsoluteAccuracy
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_DiscreteTrapezoidIntegrator.cell :?> DiscreteTrapezoidIntegratorModel).SetAbsoluteAccuracy
                                                            _accuracy.cell 
                                                       ) :> ICell
    ...
    let DiscreteTrapezoidIntegrator_setMaxEvaluations
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_DiscreteTrapezoidIntegrator.cell :?> DiscreteTrapezoidIntegratorModel).SetMaxEvaluations
    ...
    let DiscreteTrapezoidIntegrator_value
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_DiscreteTrapezoidIntegrator.cell :?> DiscreteTrapezoidIntegratorModel).Value
                                                            _f.cell 
                                                            _a.cell 
                                                            _b.cell 
                                                       ) :> ICell
    ...
    let DiscreteTrapezoidIntegrator_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<DiscreteTrapezoidIntegrator> i "value" true) |>
                        Seq.toArray
                ...
                Model.specify 
                    ...
                    ; source = "cell Generic.List<DiscreteTrapezoidIntegrator>(" + (Helper.sourceFoldArray (s) + ")")
