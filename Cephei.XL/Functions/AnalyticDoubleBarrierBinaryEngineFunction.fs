    ...
    let AnalyticDoubleBarrierBinaryEngine_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.AnalyticDoubleBarrierBinaryEngine 
                                                            _Process.cell 
    ...
    let AnalyticDoubleBarrierBinaryEngine_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<AnalyticDoubleBarrierBinaryEngine>) (l : string) = Helper.Range.fromModelList i l
