    ...
    let UsdLiborSwapIsdaFixPm_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.UsdLiborSwapIsdaFixPm 
                                                            _tenor.cell 
                                                            _h.cell 
                                                       ) :> ICell
    ...
    let UsdLiborSwapIsdaFixPm_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _tenor = Helper.toCell<Period> tenor "tenor" 
                let builder (current : ICell) = (Fun.UsdLiborSwapIsdaFixPm1 
                                                            _tenor.cell 
                                                       ) :> ICell
                let format (i : ICell) (l:string) = Helper.Range.fromModel (i :?> ICell<UsdLiborSwapIsdaFixPm>) l
    ...
    let UsdLiborSwapIsdaFixPm_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UsdLiborSwapIsdaFixPm = Helper.toModelReference<UsdLiborSwapIsdaFixPm> usdliborswapisdafixpm "UsdLiborSwapIsdaFixPm"  
                let _tenor = Helper.toCell<Period> tenor "tenor" 
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).Clone
                                                            _tenor.cell 
                                                       ) :> ICell
    ...
    let UsdLiborSwapIsdaFixPm_clone1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).Clone1
                                                            _forwarding.cell 
                                                            _discounting.cell 
                                                       ) :> ICell
                let format (i : ICell) (l:string) = Helper.Range.fromModel (i :?> ICell<SwapIndex>) l
    ...
    let UsdLiborSwapIsdaFixPm_clone2
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UsdLiborSwapIsdaFixPm = Helper.toModelReference<UsdLiborSwapIsdaFixPm> usdliborswapisdafixpm "UsdLiborSwapIsdaFixPm"  
                let _forwarding = Helper.toHandle<YieldTermStructure> forwarding "forwarding" 
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).Clone2
                                                            _forwarding.cell 
                                                       ) :> ICell
                let format (i : ICell) (l:string) = Helper.Range.fromModel (i :?> ICell<SwapIndex>) l
    ...
    let UsdLiborSwapIsdaFixPm_discountingTermStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UsdLiborSwapIsdaFixPm = Helper.toModelReference<UsdLiborSwapIsdaFixPm> usdliborswapisdafixpm "UsdLiborSwapIsdaFixPm"  
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).DiscountingTermStructure
                                                       ) :> ICell
    ...
    let UsdLiborSwapIsdaFixPm_exogenousDiscount
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UsdLiborSwapIsdaFixPm = Helper.toModelReference<UsdLiborSwapIsdaFixPm> usdliborswapisdafixpm "UsdLiborSwapIsdaFixPm"  
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).ExogenousDiscount
                                                       ) :> ICell
    ...
    let UsdLiborSwapIsdaFixPm_fixedLegConvention
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UsdLiborSwapIsdaFixPm = Helper.toModelReference<UsdLiborSwapIsdaFixPm> usdliborswapisdafixpm "UsdLiborSwapIsdaFixPm"  
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).FixedLegConvention
                                                       ) :> ICell
    ...
    let UsdLiborSwapIsdaFixPm_fixedLegTenor
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UsdLiborSwapIsdaFixPm = Helper.toModelReference<UsdLiborSwapIsdaFixPm> usdliborswapisdafixpm "UsdLiborSwapIsdaFixPm"  
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).FixedLegTenor
                                                       ) :> ICell
    ...
    let UsdLiborSwapIsdaFixPm_forecastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).ForecastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
    ...
    let UsdLiborSwapIsdaFixPm_forwardingTermStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UsdLiborSwapIsdaFixPm = Helper.toModelReference<UsdLiborSwapIsdaFixPm> usdliborswapisdafixpm "UsdLiborSwapIsdaFixPm"  
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).ForwardingTermStructure
                                                       ) :> ICell
                let format (i : ICell) (l:string) = Helper.Range.fromModel (i :?> ICell<Handle<YieldTermStructure>>) l
    ...
    let UsdLiborSwapIsdaFixPm_iborIndex
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UsdLiborSwapIsdaFixPm = Helper.toModelReference<UsdLiborSwapIsdaFixPm> usdliborswapisdafixpm "UsdLiborSwapIsdaFixPm"  
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).IborIndex
                                                       ) :> ICell
    ...
    let UsdLiborSwapIsdaFixPm_maturityDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).MaturityDate
                                                            _valueDate.cell 
                                                       ) :> ICell
    ...
    let UsdLiborSwapIsdaFixPm_underlyingSwap
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UsdLiborSwapIsdaFixPm = Helper.toModelReference<UsdLiborSwapIsdaFixPm> usdliborswapisdafixpm "UsdLiborSwapIsdaFixPm"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).UnderlyingSwap
                                                            _fixingDate.cell 
                                                       ) :> ICell
    ...
    let UsdLiborSwapIsdaFixPm_currency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UsdLiborSwapIsdaFixPm = Helper.toModelReference<UsdLiborSwapIsdaFixPm> usdliborswapisdafixpm "UsdLiborSwapIsdaFixPm"  
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).Currency
                                                       ) :> ICell
    ...
    let UsdLiborSwapIsdaFixPm_dayCounter
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UsdLiborSwapIsdaFixPm = Helper.toModelReference<UsdLiborSwapIsdaFixPm> usdliborswapisdafixpm "UsdLiborSwapIsdaFixPm"  
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).DayCounter
                                                       ) :> ICell
    ...
    let UsdLiborSwapIsdaFixPm_familyName
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UsdLiborSwapIsdaFixPm = Helper.toModelReference<UsdLiborSwapIsdaFixPm> usdliborswapisdafixpm "UsdLiborSwapIsdaFixPm"  
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).FamilyName
                                                       ) :> ICell
    ...
    let UsdLiborSwapIsdaFixPm_fixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).Fixing
                                                            _fixingDate.cell 
    ...
    let UsdLiborSwapIsdaFixPm_fixingCalendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UsdLiborSwapIsdaFixPm = Helper.toModelReference<UsdLiborSwapIsdaFixPm> usdliborswapisdafixpm "UsdLiborSwapIsdaFixPm"  
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).FixingCalendar
                                                       ) :> ICell
    ...
    let UsdLiborSwapIsdaFixPm_fixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UsdLiborSwapIsdaFixPm = Helper.toModelReference<UsdLiborSwapIsdaFixPm> usdliborswapisdafixpm "UsdLiborSwapIsdaFixPm"  
                let _valueDate = Helper.toCell<Date> valueDate "valueDate" 
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).FixingDate
                                                            _valueDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let UsdLiborSwapIsdaFixPm_fixingDays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UsdLiborSwapIsdaFixPm = Helper.toModelReference<UsdLiborSwapIsdaFixPm> usdliborswapisdafixpm "UsdLiborSwapIsdaFixPm"  
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).FixingDays
                                                       ) :> ICell
    ...
    let UsdLiborSwapIsdaFixPm_isValidFixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UsdLiborSwapIsdaFixPm = Helper.toModelReference<UsdLiborSwapIsdaFixPm> usdliborswapisdafixpm "UsdLiborSwapIsdaFixPm"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).IsValidFixingDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let UsdLiborSwapIsdaFixPm_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UsdLiborSwapIsdaFixPm = Helper.toModelReference<UsdLiborSwapIsdaFixPm> usdliborswapisdafixpm "UsdLiborSwapIsdaFixPm"  
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let UsdLiborSwapIsdaFixPm_pastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UsdLiborSwapIsdaFixPm = Helper.toModelReference<UsdLiborSwapIsdaFixPm> usdliborswapisdafixpm "UsdLiborSwapIsdaFixPm"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).PastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
    ...
    let UsdLiborSwapIsdaFixPm_tenor
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UsdLiborSwapIsdaFixPm = Helper.toModelReference<UsdLiborSwapIsdaFixPm> usdliborswapisdafixpm "UsdLiborSwapIsdaFixPm"  
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).Tenor
                                                       ) :> ICell
                let format (i : ICell) (l:string) = Helper.Range.fromModel (i :?> ICell<Period>) l
    ...
    let UsdLiborSwapIsdaFixPm_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UsdLiborSwapIsdaFixPm = Helper.toModelReference<UsdLiborSwapIsdaFixPm> usdliborswapisdafixpm "UsdLiborSwapIsdaFixPm"  
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).Update
                                                       ) :> ICell
    ...
    let UsdLiborSwapIsdaFixPm_valueDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UsdLiborSwapIsdaFixPm = Helper.toModelReference<UsdLiborSwapIsdaFixPm> usdliborswapisdafixpm "UsdLiborSwapIsdaFixPm"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).ValueDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let UsdLiborSwapIsdaFixPm_addFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).AddFixing
                                                            _d.cell 
                                                            _v.cell 
    ...
    let UsdLiborSwapIsdaFixPm_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).AddFixings
                                                            _d.cell 
                                                            _v.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
    ...
    let UsdLiborSwapIsdaFixPm_addFixings1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).AddFixings1
                                                            _source.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
                let format (o : UsdLiborSwapIsdaFixPm) (l:string) = o.ToString() :> obj
    ...
    let UsdLiborSwapIsdaFixPm_allowsNativeFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UsdLiborSwapIsdaFixPm = Helper.toModelReference<UsdLiborSwapIsdaFixPm> usdliborswapisdafixpm "UsdLiborSwapIsdaFixPm"  
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).AllowsNativeFixings
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let UsdLiborSwapIsdaFixPm_clearFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UsdLiborSwapIsdaFixPm = Helper.toModelReference<UsdLiborSwapIsdaFixPm> usdliborswapisdafixpm "UsdLiborSwapIsdaFixPm"  
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).ClearFixings
                                                       ) :> ICell
                let format (o : UsdLiborSwapIsdaFixPm) (l:string) = o.ToString() :> obj
    ...
    let UsdLiborSwapIsdaFixPm_registerWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).RegisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : UsdLiborSwapIsdaFixPm) (l:string) = o.ToString() :> obj
    ...
    let UsdLiborSwapIsdaFixPm_timeSeries
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UsdLiborSwapIsdaFixPm = Helper.toModelReference<UsdLiborSwapIsdaFixPm> usdliborswapisdafixpm "UsdLiborSwapIsdaFixPm"  
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).TimeSeries
                                                       ) :> ICell
    ...
    let UsdLiborSwapIsdaFixPm_unregisterWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UsdLiborSwapIsdaFixPm = Helper.toModelReference<UsdLiborSwapIsdaFixPm> usdliborswapisdafixpm "UsdLiborSwapIsdaFixPm"  
                let _handler = Helper.toCell<Callback> handler "handler" 
                let builder (current : ICell) = ((UsdLiborSwapIsdaFixPmModel.Cast _UsdLiborSwapIsdaFixPm.cell).UnregisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : UsdLiborSwapIsdaFixPm) (l:string) = o.ToString() :> obj
    ...
    let UsdLiborSwapIsdaFixPm_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<UsdLiborSwapIsdaFixPm> (c)) :> ICell
                let format (i : Cephei.Cell.List<UsdLiborSwapIsdaFixPm>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<UsdLiborSwapIsdaFixPm>(" + (Helper.sourceFoldArray (s) + "))"))
