    ...
    let MersenneTwisterUniformRng_factory
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _MersenneTwisterUniformRng = Helper.toModelReference<MersenneTwisterUniformRng> mersennetwisteruniformrng "MersenneTwisterUniformRng"  
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                Model.specify 
                    ...
                    ; source =  (fun () -> "(new Cephei.Cell.List<MersenneTwisterUniformRng>(" + (Helper.sourceFoldArray (s) + "))"))
