    ...
    let Euribor2W_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.Euribor2W 
                                                            _h.cell 
                                                       ) :> ICell
    ...
    let Euribor2W_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.Euribor2W1 ()
                                                       ) :> ICell
                let format (i : ICell) (l:string) = Helper.Range.fromModel (i :?> ICell<Euribor2W>) l
    ...
    let Euribor2W_businessDayConvention
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2W = Helper.toModelReference<Euribor2W> euribor2w "Euribor2W"  
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).BusinessDayConvention
                                                       ) :> ICell
    ...
    let Euribor2W_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).Clone
                                                            _forwarding.cell 
                                                       ) :> ICell
    ...
    let Euribor2W_endOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2W = Helper.toModelReference<Euribor2W> euribor2w "Euribor2W"  
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).EndOfMonth
                                                       ) :> ICell
    ...
    let Euribor2W_forecastFixing1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).ForecastFixing1
                                                            _d1.cell 
                                                            _d2.cell 
                                                            _t.cell 
                                                       ) :> ICell
    ...
    let Euribor2W_forecastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).ForecastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let Euribor2W_forwardingTermStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2W = Helper.toModelReference<Euribor2W> euribor2w "Euribor2W"  
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).ForwardingTermStructure
                                                       ) :> ICell
    ...
    let Euribor2W_maturityDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).MaturityDate
                                                            _valueDate.cell 
                                                       ) :> ICell
    ...
    let Euribor2W_currency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2W = Helper.toModelReference<Euribor2W> euribor2w "Euribor2W"  
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).Currency
                                                       ) :> ICell
    ...
    let Euribor2W_dayCounter
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2W = Helper.toModelReference<Euribor2W> euribor2w "Euribor2W"  
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).DayCounter
                                                       ) :> ICell
    ...
    let Euribor2W_familyName
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2W = Helper.toModelReference<Euribor2W> euribor2w "Euribor2W"  
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).FamilyName
                                                       ) :> ICell
    ...
    let Euribor2W_fixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).Fixing
                                                            _fixingDate.cell 
    ...
    let Euribor2W_fixingCalendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2W = Helper.toModelReference<Euribor2W> euribor2w "Euribor2W"  
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).FixingCalendar
                                                       ) :> ICell
    ...
    let Euribor2W_fixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2W = Helper.toModelReference<Euribor2W> euribor2w "Euribor2W"  
                let _valueDate = Helper.toCell<Date> valueDate "valueDate" 
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).FixingDate
                                                            _valueDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let Euribor2W_fixingDays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2W = Helper.toModelReference<Euribor2W> euribor2w "Euribor2W"  
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).FixingDays
                                                       ) :> ICell
    ...
    let Euribor2W_isValidFixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2W = Helper.toModelReference<Euribor2W> euribor2w "Euribor2W"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).IsValidFixingDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Euribor2W_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2W = Helper.toModelReference<Euribor2W> euribor2w "Euribor2W"  
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let Euribor2W_pastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2W = Helper.toModelReference<Euribor2W> euribor2w "Euribor2W"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).PastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
    ...
    let Euribor2W_tenor
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2W = Helper.toModelReference<Euribor2W> euribor2w "Euribor2W"  
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).Tenor
                                                       ) :> ICell
    ...
    let Euribor2W_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2W = Helper.toModelReference<Euribor2W> euribor2w "Euribor2W"  
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).Update
                                                       ) :> ICell
    ...
    let Euribor2W_valueDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2W = Helper.toModelReference<Euribor2W> euribor2w "Euribor2W"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).ValueDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let Euribor2W_addFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).AddFixing
                                                            _d.cell 
                                                            _v.cell 
    ...
    let Euribor2W_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).AddFixings
                                                            _d.cell 
                                                            _v.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
    ...
    let Euribor2W_addFixings1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).AddFixings1
                                                            _source.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
                let format (o : Euribor2W) (l:string) = o.ToString() :> obj
    ...
    let Euribor2W_allowsNativeFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2W = Helper.toModelReference<Euribor2W> euribor2w "Euribor2W"  
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).AllowsNativeFixings
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Euribor2W_clearFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2W = Helper.toModelReference<Euribor2W> euribor2w "Euribor2W"  
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).ClearFixings
                                                       ) :> ICell
                let format (o : Euribor2W) (l:string) = o.ToString() :> obj
    ...
    let Euribor2W_registerWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).RegisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : Euribor2W) (l:string) = o.ToString() :> obj
    ...
    let Euribor2W_timeSeries
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2W = Helper.toModelReference<Euribor2W> euribor2w "Euribor2W"  
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).TimeSeries
                                                       ) :> ICell
    ...
    let Euribor2W_unregisterWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2W = Helper.toModelReference<Euribor2W> euribor2w "Euribor2W"  
                let _handler = Helper.toCell<Callback> handler "handler" 
                let builder (current : ICell) = ((Euribor2WModel.Cast _Euribor2W.cell).UnregisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : Euribor2W) (l:string) = o.ToString() :> obj
    ...
    let Euribor2W_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<Euribor2W> (c)) :> ICell
                let format (i : Cephei.Cell.List<Euribor2W>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<Euribor2W>(" + (Helper.sourceFoldArray (s) + "))"))
