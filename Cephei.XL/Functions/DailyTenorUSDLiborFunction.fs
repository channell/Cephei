    ...
    let DailyTenorUSDLibor_businessDayConvention
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).BusinessDayConvention
                                                       ) :> ICell
    ...
    let DailyTenorUSDLibor_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).Clone
                                                            _forwarding.cell 
                                                       ) :> ICell
    ...
    let DailyTenorUSDLibor_endOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorUSDLibor = Helper.toCell<DailyTenorUSDLibor> dailytenorusdlibor "DailyTenorUSDLibor"  
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).EndOfMonth
                                                       ) :> ICell
    ...
    let DailyTenorUSDLibor_forecastFixing1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).ForecastFixing1
                                                            _d1.cell 
                                                            _d2.cell 
                                                            _t.cell 
                                                       ) :> ICell
    ...
    let DailyTenorUSDLibor_forecastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).ForecastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let DailyTenorUSDLibor_forwardingTermStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorUSDLibor = Helper.toCell<DailyTenorUSDLibor> dailytenorusdlibor "DailyTenorUSDLibor"  
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).ForwardingTermStructure
                                                       ) :> ICell
    ...
    let DailyTenorUSDLibor_maturityDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).MaturityDate
                                                            _valueDate.cell 
                                                       ) :> ICell
    ...
    let DailyTenorUSDLibor_currency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorUSDLibor = Helper.toCell<DailyTenorUSDLibor> dailytenorusdlibor "DailyTenorUSDLibor"  
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).Currency
                                                       ) :> ICell
    ...
    let DailyTenorUSDLibor_dayCounter
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorUSDLibor = Helper.toCell<DailyTenorUSDLibor> dailytenorusdlibor "DailyTenorUSDLibor"  
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).DayCounter
                                                       ) :> ICell
    ...
    let DailyTenorUSDLibor_familyName
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorUSDLibor = Helper.toCell<DailyTenorUSDLibor> dailytenorusdlibor "DailyTenorUSDLibor"  
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).FamilyName
                                                       ) :> ICell
    ...
    let DailyTenorUSDLibor_fixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).Fixing
                                                            _fixingDate.cell 
    ...
    let DailyTenorUSDLibor_fixingCalendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorUSDLibor = Helper.toCell<DailyTenorUSDLibor> dailytenorusdlibor "DailyTenorUSDLibor"  
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).FixingCalendar
                                                       ) :> ICell
    ...
    let DailyTenorUSDLibor_fixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorUSDLibor = Helper.toCell<DailyTenorUSDLibor> dailytenorusdlibor "DailyTenorUSDLibor"  
                let _valueDate = Helper.toCell<Date> valueDate "valueDate" 
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).FixingDate
                                                            _valueDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let DailyTenorUSDLibor_fixingDays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorUSDLibor = Helper.toCell<DailyTenorUSDLibor> dailytenorusdlibor "DailyTenorUSDLibor"  
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).FixingDays
                                                       ) :> ICell
    ...
    let DailyTenorUSDLibor_isValidFixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorUSDLibor = Helper.toCell<DailyTenorUSDLibor> dailytenorusdlibor "DailyTenorUSDLibor"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).IsValidFixingDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let DailyTenorUSDLibor_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorUSDLibor = Helper.toCell<DailyTenorUSDLibor> dailytenorusdlibor "DailyTenorUSDLibor"  
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let DailyTenorUSDLibor_pastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorUSDLibor = Helper.toCell<DailyTenorUSDLibor> dailytenorusdlibor "DailyTenorUSDLibor"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).PastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
    ...
    let DailyTenorUSDLibor_tenor
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorUSDLibor = Helper.toCell<DailyTenorUSDLibor> dailytenorusdlibor "DailyTenorUSDLibor"  
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).Tenor
                                                       ) :> ICell
    ...
    let DailyTenorUSDLibor_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorUSDLibor = Helper.toCell<DailyTenorUSDLibor> dailytenorusdlibor "DailyTenorUSDLibor"  
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).Update
                                                       ) :> ICell
    ...
    let DailyTenorUSDLibor_valueDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorUSDLibor = Helper.toCell<DailyTenorUSDLibor> dailytenorusdlibor "DailyTenorUSDLibor"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).ValueDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let DailyTenorUSDLibor_addFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).AddFixing
                                                            _d.cell 
                                                            _v.cell 
    ...
    let DailyTenorUSDLibor_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).AddFixings
                                                            _d.cell 
                                                            _v.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
    ...
    let DailyTenorUSDLibor_addFixings1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).AddFixings1
                                                            _source.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
                let format (o : DailyTenorUSDLibor) (l:string) = o.ToString() :> obj
    ...
    let DailyTenorUSDLibor_allowsNativeFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorUSDLibor = Helper.toCell<DailyTenorUSDLibor> dailytenorusdlibor "DailyTenorUSDLibor"  
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).AllowsNativeFixings
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let DailyTenorUSDLibor_clearFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorUSDLibor = Helper.toCell<DailyTenorUSDLibor> dailytenorusdlibor "DailyTenorUSDLibor"  
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).ClearFixings
                                                       ) :> ICell
                let format (o : DailyTenorUSDLibor) (l:string) = o.ToString() :> obj
    ...
    let DailyTenorUSDLibor_registerWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).RegisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : DailyTenorUSDLibor) (l:string) = o.ToString() :> obj
    ...
    let DailyTenorUSDLibor_timeSeries
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorUSDLibor = Helper.toCell<DailyTenorUSDLibor> dailytenorusdlibor "DailyTenorUSDLibor"  
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).TimeSeries
                                                       ) :> ICell
    ...
    let DailyTenorUSDLibor_unregisterWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorUSDLibor = Helper.toCell<DailyTenorUSDLibor> dailytenorusdlibor "DailyTenorUSDLibor"  
                let _handler = Helper.toCell<Callback> handler "handler" 
                let builder () = withMnemonic mnemonic ((DailyTenorUSDLiborModel.Cast _DailyTenorUSDLibor.cell).UnregisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : DailyTenorUSDLibor) (l:string) = o.ToString() :> obj
