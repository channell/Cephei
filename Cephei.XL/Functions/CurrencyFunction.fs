...
module CurrencyFunction =
    ...
    let Currency_code
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = withMnemonic mnemonic ((CurrencyModel.Cast _Currency.cell).Code
                                                       ) :> ICell
    ...
    *)
    ...
    let Currency_create1
        ...
        ([<ExcelArgument(Name="name",Description = "string")>] 
         name : obj)
        ([<ExcelArgument(Name="code",Description = "string")>] 
         code : obj)
        ([<ExcelArgument(Name="numericCode",Description = "int")>] 
         numericCode : obj)
        ([<ExcelArgument(Name="symbol",Description = "string")>] 
         symbol : obj)
        ([<ExcelArgument(Name="fractionSymbol",Description = "string")>] 
         fractionSymbol : obj)
        ([<ExcelArgument(Name="fractionsPerUnit",Description = "int")>] 
         fractionsPerUnit : obj)
        ([<ExcelArgument(Name="rounding",Description = "Rounding")>] 
         rounding : obj)
        ([<ExcelArgument(Name="formatString",Description = "string")>] 
         formatString : obj)
        = 
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = withMnemonic mnemonic (Fun.Currency1 
                                                            _name.cell 
                                                            _code.cell 
                                                            _numericCode.cell 
                                                            _symbol.cell 
    ...
    let Currency_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = withMnemonic mnemonic (Fun.Currency ()
                                                       ) :> ICell
                let format (i : ICell) (l:string) = Helper.Range.fromModel (i :?> ICell<Currency>) l
    ...
    *)
    ...
    let Currency_create2
        ...
        ([<ExcelArgument(Name="formatString",Description = "string")>] 
         formatString : obj)
        ([<ExcelArgument(Name="triangulationCurrency",Description = "Currency")>] 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = withMnemonic mnemonic (Fun.Currency2 
                                                            _name.cell 
                                                            _code.cell 
                                                            _numericCode.cell 
                                                            _symbol.cell 
    ...
    let Currency_empty
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Currency = Helper.toCell<Currency> currency "Currency"  
                let builder (current : ICell) = withMnemonic mnemonic ((CurrencyModel.Cast _Currency.cell).Empty
                                                       ) :> ICell
    ...
    let Currency_Equals
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = withMnemonic mnemonic ((CurrencyModel.Cast _Currency.cell).Equals
                                                            _o.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Currency_format
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Currency = Helper.toCell<Currency> currency "Currency"  
                let builder (current : ICell) = withMnemonic mnemonic ((CurrencyModel.Cast _Currency.cell).Format
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let Currency_fractionsPerUnit
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Currency = Helper.toCell<Currency> currency "Currency"  
                let builder (current : ICell) = withMnemonic mnemonic ((CurrencyModel.Cast _Currency.cell).FractionsPerUnit
                                                       ) :> ICell
    ...
    let Currency_fractionSymbol
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Currency = Helper.toCell<Currency> currency "Currency"  
                let builder (current : ICell) = withMnemonic mnemonic ((CurrencyModel.Cast _Currency.cell).FractionSymbol
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let Currency_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Currency = Helper.toCell<Currency> currency "Currency"  
                let builder (current : ICell) = withMnemonic mnemonic ((CurrencyModel.Cast _Currency.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let Currency_numericCode
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Currency = Helper.toCell<Currency> currency "Currency"  
                let builder (current : ICell) = withMnemonic mnemonic ((CurrencyModel.Cast _Currency.cell).NumericCode
                                                       ) :> ICell
                let format (o : int) (l:string) = o :> obj
    ...
    let Currency_rounding
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Currency = Helper.toCell<Currency> currency "Currency"  
                let builder (current : ICell) = withMnemonic mnemonic ((CurrencyModel.Cast _Currency.cell).Rounding
                                                       ) :> ICell
    ...
    let Currency_symbol
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Currency = Helper.toCell<Currency> currency "Currency"  
                let builder (current : ICell) = withMnemonic mnemonic ((CurrencyModel.Cast _Currency.cell).Symbol
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let Currency_ToString
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Currency = Helper.toCell<Currency> currency "Currency"  
                let builder (current : ICell) = withMnemonic mnemonic ((CurrencyModel.Cast _Currency.cell).ToString
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let Currency_triangulationCurrency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Currency = Helper.toCell<Currency> currency "Currency"  
                let builder (current : ICell) = withMnemonic mnemonic ((CurrencyModel.Cast _Currency.cell).TriangulationCurrency
                                                       ) :> ICell
                let format (i : ICell) (l:string) = Helper.Range.fromModel (i :?> ICell<Currency>) l
    ...
    let Currency_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<Currency> (c)) :> ICell
                let format (i : Cephei.Cell.List<Currency>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<Currency>(" + (Helper.sourceFoldArray (s) + "))"))
