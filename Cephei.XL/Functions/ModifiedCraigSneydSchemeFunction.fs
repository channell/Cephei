    ...
    let ModifiedCraigSneydScheme_factory
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _ModifiedCraigSneydScheme = Helper.toModelReference<ModifiedCraigSneydScheme> modifiedcraigsneydscheme "ModifiedCraigSneydScheme"  
    ...
    let ModifiedCraigSneydScheme_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<ModifiedCraigSneydScheme> (c)) :> ICell
                let format (i : Cephei.Cell.List<ModifiedCraigSneydScheme>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<ModifiedCraigSneydScheme>(" + (Helper.sourceFoldArray (s) + "))"))
