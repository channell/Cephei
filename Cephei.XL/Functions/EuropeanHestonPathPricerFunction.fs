    ...
    let EuropeanHestonPathPricer_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<EuropeanHestonPathPricer> (c)) :> ICell
                let format (i : Cephei.Cell.List<EuropeanHestonPathPricer>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<EuropeanHestonPathPricer>(" + (Helper.sourceFoldArray (s) + "))"))
