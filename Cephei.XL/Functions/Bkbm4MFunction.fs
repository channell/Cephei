    ...
    let Bkbm4M_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.Bkbm4M 
                                                            _h.cell 
                                                       ) :> ICell
    ...
    let Bkbm4M_businessDayConvention
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm4M = Helper.toModelReference<Bkbm4M> bkbm4m "Bkbm4M"  
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).BusinessDayConvention
                                                       ) :> ICell
    ...
    let Bkbm4M_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).Clone
                                                            _forwarding.cell 
                                                       ) :> ICell
    ...
    let Bkbm4M_endOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm4M = Helper.toModelReference<Bkbm4M> bkbm4m "Bkbm4M"  
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).EndOfMonth
                                                       ) :> ICell
    ...
    let Bkbm4M_forecastFixing1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).ForecastFixing1
                                                            _d1.cell 
                                                            _d2.cell 
                                                            _t.cell 
                                                       ) :> ICell
    ...
    let Bkbm4M_forecastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).ForecastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let Bkbm4M_forwardingTermStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm4M = Helper.toModelReference<Bkbm4M> bkbm4m "Bkbm4M"  
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).ForwardingTermStructure
                                                       ) :> ICell
    ...
    let Bkbm4M_maturityDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).MaturityDate
                                                            _valueDate.cell 
                                                       ) :> ICell
    ...
    let Bkbm4M_currency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm4M = Helper.toModelReference<Bkbm4M> bkbm4m "Bkbm4M"  
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).Currency
                                                       ) :> ICell
    ...
    let Bkbm4M_dayCounter
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm4M = Helper.toModelReference<Bkbm4M> bkbm4m "Bkbm4M"  
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).DayCounter
                                                       ) :> ICell
    ...
    let Bkbm4M_familyName
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm4M = Helper.toModelReference<Bkbm4M> bkbm4m "Bkbm4M"  
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).FamilyName
                                                       ) :> ICell
    ...
    let Bkbm4M_fixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).Fixing
                                                            _fixingDate.cell 
    ...
    let Bkbm4M_fixingCalendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm4M = Helper.toModelReference<Bkbm4M> bkbm4m "Bkbm4M"  
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).FixingCalendar
                                                       ) :> ICell
    ...
    let Bkbm4M_fixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm4M = Helper.toModelReference<Bkbm4M> bkbm4m "Bkbm4M"  
                let _valueDate = Helper.toCell<Date> valueDate "valueDate" 
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).FixingDate
                                                            _valueDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let Bkbm4M_fixingDays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm4M = Helper.toModelReference<Bkbm4M> bkbm4m "Bkbm4M"  
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).FixingDays
                                                       ) :> ICell
    ...
    let Bkbm4M_isValidFixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm4M = Helper.toModelReference<Bkbm4M> bkbm4m "Bkbm4M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).IsValidFixingDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Bkbm4M_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm4M = Helper.toModelReference<Bkbm4M> bkbm4m "Bkbm4M"  
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let Bkbm4M_pastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm4M = Helper.toModelReference<Bkbm4M> bkbm4m "Bkbm4M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).PastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
    ...
    let Bkbm4M_tenor
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm4M = Helper.toModelReference<Bkbm4M> bkbm4m "Bkbm4M"  
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).Tenor
                                                       ) :> ICell
    ...
    let Bkbm4M_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm4M = Helper.toModelReference<Bkbm4M> bkbm4m "Bkbm4M"  
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).Update
                                                       ) :> ICell
    ...
    let Bkbm4M_valueDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm4M = Helper.toModelReference<Bkbm4M> bkbm4m "Bkbm4M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).ValueDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let Bkbm4M_addFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).AddFixing
                                                            _d.cell 
                                                            _v.cell 
    ...
    let Bkbm4M_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).AddFixings
                                                            _d.cell 
                                                            _v.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
    ...
    let Bkbm4M_addFixings1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).AddFixings1
                                                            _source.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
                let format (o : Bkbm4M) (l:string) = o.ToString() :> obj
    ...
    let Bkbm4M_allowsNativeFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm4M = Helper.toModelReference<Bkbm4M> bkbm4m "Bkbm4M"  
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).AllowsNativeFixings
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Bkbm4M_clearFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm4M = Helper.toModelReference<Bkbm4M> bkbm4m "Bkbm4M"  
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).ClearFixings
                                                       ) :> ICell
                let format (o : Bkbm4M) (l:string) = o.ToString() :> obj
    ...
    let Bkbm4M_registerWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).RegisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : Bkbm4M) (l:string) = o.ToString() :> obj
    ...
    let Bkbm4M_timeSeries
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm4M = Helper.toModelReference<Bkbm4M> bkbm4m "Bkbm4M"  
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).TimeSeries
                                                       ) :> ICell
    ...
    let Bkbm4M_unregisterWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm4M = Helper.toModelReference<Bkbm4M> bkbm4m "Bkbm4M"  
                let _handler = Helper.toCell<Callback> handler "handler" 
                let builder (current : ICell) = ((Bkbm4MModel.Cast _Bkbm4M.cell).UnregisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : Bkbm4M) (l:string) = o.ToString() :> obj
    ...
    let Bkbm4M_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<Bkbm4M> (c)) :> ICell
                let format (i : Cephei.Cell.List<Bkbm4M>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<Bkbm4M>(" + (Helper.sourceFoldArray (s) + "))"))
