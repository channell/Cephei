    ...
    let NonLinearLeastSquare_exitFlag
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _NonLinearLeastSquare = Helper.toModelReference<NonLinearLeastSquare> nonlinearleastsquare "NonLinearLeastSquare"  
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                Model.specify 
                    ...
                    ; source =  (fun () -> "(new Cephei.Cell.List<NonLinearLeastSquare>(" + (Helper.sourceFoldArray (s) + "))"))
