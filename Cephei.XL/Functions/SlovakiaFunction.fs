    ...
    let Slovakia_addedHolidays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((SlovakiaModel.Cast _Slovakia.cell).AddedHolidays
                                                       ) :> ICell
    ...
    let Slovakia_addHoliday
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((SlovakiaModel.Cast _Slovakia.cell).AddHoliday
                                                            _d.cell 
                                                       ) :> ICell
    ...
    let Slovakia_adjust
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((SlovakiaModel.Cast _Slovakia.cell).Adjust
                                                            _d.cell 
                                                            _c.cell 
                                                       ) :> ICell
    ...
    let Slovakia_advance1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((SlovakiaModel.Cast _Slovakia.cell).Advance1
                                                            _d.cell 
                                                            _n.cell 
                                                            _unit.cell 
                                                            _c.cell 
    ...
    let Slovakia_advance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _c = Helper.toCell<BusinessDayConvention> c "c" 
                let _endOfMonth = Helper.toCell<bool> endOfMonth "endOfMonth" 
                let builder () = withMnemonic mnemonic ((SlovakiaModel.Cast _Slovakia.cell).Advance
                                                            _d.cell 
                                                            _p.cell 
                                                            _c.cell 
                                                            _endOfMonth.cell 
    ...
    let Slovakia_businessDaysBetween
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((SlovakiaModel.Cast _Slovakia.cell).BusinessDaysBetween
                                                            _from.cell 
                                                            _To.cell 
                                                            _includeFirst.cell 
                                                            _includeLast.cell 
    ...
    let Slovakia_calendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Slovakia = Helper.toCell<Slovakia> slovakia "Slovakia"  
                let builder () = withMnemonic mnemonic ((SlovakiaModel.Cast _Slovakia.cell).Calendar
                                                       ) :> ICell
    ...
    let Slovakia_empty
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Slovakia = Helper.toCell<Slovakia> slovakia "Slovakia"  
                let builder () = withMnemonic mnemonic ((SlovakiaModel.Cast _Slovakia.cell).Empty
                                                       ) :> ICell
    ...
    let Slovakia_endOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Slovakia = Helper.toCell<Slovakia> slovakia "Slovakia"  
                let _d = Helper.toCell<Date> d "d" 
                let builder () = withMnemonic mnemonic ((SlovakiaModel.Cast _Slovakia.cell).EndOfMonth
                                                            _d.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let Slovakia_Equals
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((SlovakiaModel.Cast _Slovakia.cell).Equals
                                                            _o.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Slovakia_isBusinessDay
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Slovakia = Helper.toCell<Slovakia> slovakia "Slovakia"  
                let _d = Helper.toCell<Date> d "d" 
                let builder () = withMnemonic mnemonic ((SlovakiaModel.Cast _Slovakia.cell).IsBusinessDay
                                                            _d.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Slovakia_isEndOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Slovakia = Helper.toCell<Slovakia> slovakia "Slovakia"  
                let _d = Helper.toCell<Date> d "d" 
                let builder () = withMnemonic mnemonic ((SlovakiaModel.Cast _Slovakia.cell).IsEndOfMonth
                                                            _d.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Slovakia_isHoliday
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Slovakia = Helper.toCell<Slovakia> slovakia "Slovakia"  
                let _d = Helper.toCell<Date> d "d" 
                let builder () = withMnemonic mnemonic ((SlovakiaModel.Cast _Slovakia.cell).IsHoliday
                                                            _d.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Slovakia_isWeekend
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((SlovakiaModel.Cast _Slovakia.cell).IsWeekend
                                                            _w.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Slovakia_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Slovakia = Helper.toCell<Slovakia> slovakia "Slovakia"  
                let builder () = withMnemonic mnemonic ((SlovakiaModel.Cast _Slovakia.cell).Name
                                                       ) :> ICell
    ...
    let Slovakia_removedHolidays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Slovakia = Helper.toCell<Slovakia> slovakia "Slovakia"  
                let builder () = withMnemonic mnemonic ((SlovakiaModel.Cast _Slovakia.cell).RemovedHolidays
                                                       ) :> ICell
                let format (i : Generic.List<ICell<Date>>) (l : string) = Helper.Range.fromModelList i l
    ...
    let Slovakia_removeHoliday
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Slovakia = Helper.toCell<Slovakia> slovakia "Slovakia"  
                let _d = Helper.toCell<Date> d "d" 
                let builder () = withMnemonic mnemonic ((SlovakiaModel.Cast _Slovakia.cell).RemoveHoliday
                                                            _d.cell 
                                                       ) :> ICell
                let format (o : Slovakia) (l:string) = o.ToString() :> obj
