    ...
    let AbcdFunction_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.AbcdFunction 
                                                            _a.cell 
                                                            _b.cell 
                                                            _c.cell 
                                                            _d.cell 
    ...
    let AbcdFunction_covariance1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _AbcdFunction = Helper.toModelReference<AbcdFunction> abcdfunction "AbcdFunction"  
                let _t1 = Helper.toCell<double> t1 "t1" 
                let _t2 = Helper.toCell<double> t2 "t2" 
                let _T = Helper.toCell<double> T "T" 
                let _S = Helper.toCell<double> S "S" 
                let builder (current : ICell) = ((AbcdFunctionModel.Cast _AbcdFunction.cell).Covariance1
                                                            _t1.cell 
                                                            _t2.cell 
                                                            _T.cell 
                                                            _S.cell 
    ...
    let AbcdFunction_covariance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _T2 = Helper.toCell<double> T2 "T2" 
                let _S = Helper.toCell<double> S "S" 
                let builder (current : ICell) = ((AbcdFunctionModel.Cast _AbcdFunction.cell).Covariance
                                                            _t.cell 
                                                            _T2.cell 
                                                            _S.cell 
                                                       ) :> ICell
    ...
    let AbcdFunction_instantaneousCovariance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _T = Helper.toCell<double> T "T" 
                let _S = Helper.toCell<double> S "S" 
                let builder (current : ICell) = ((AbcdFunctionModel.Cast _AbcdFunction.cell).InstantaneousCovariance
                                                            _u.cell 
                                                            _T.cell 
                                                            _S.cell 
                                                       ) :> ICell
    ...
    let AbcdFunction_instantaneousVariance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _u = Helper.toCell<double> u "u" 
                let _T = Helper.toCell<double> T "T" 
                let builder (current : ICell) = ((AbcdFunctionModel.Cast _AbcdFunction.cell).InstantaneousVariance
                                                            _u.cell 
                                                            _T.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let AbcdFunction_instantaneousVolatility
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _u = Helper.toCell<double> u "u" 
                let _T = Helper.toCell<double> T "T" 
                let builder (current : ICell) = ((AbcdFunctionModel.Cast _AbcdFunction.cell).InstantaneousVolatility
                                                            _u.cell 
                                                            _T.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let AbcdFunction_longTermVolatility
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _AbcdFunction = Helper.toModelReference<AbcdFunction> abcdfunction "AbcdFunction"  
                let builder (current : ICell) = ((AbcdFunctionModel.Cast _AbcdFunction.cell).LongTermVolatility
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let AbcdFunction_maximumVolatility
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _AbcdFunction = Helper.toModelReference<AbcdFunction> abcdfunction "AbcdFunction"  
                let builder (current : ICell) = ((AbcdFunctionModel.Cast _AbcdFunction.cell).MaximumVolatility
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let AbcdFunction_primitive
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _T2 = Helper.toCell<double> T2 "T2" 
                let _S = Helper.toCell<double> S "S" 
                let builder (current : ICell) = ((AbcdFunctionModel.Cast _AbcdFunction.cell).Primitive
                                                            _t.cell 
                                                            _T2.cell 
                                                            _S.cell 
                                                       ) :> ICell
    ...
    let AbcdFunction_shortTermVolatility
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _AbcdFunction = Helper.toModelReference<AbcdFunction> abcdfunction "AbcdFunction"  
                let builder (current : ICell) = ((AbcdFunctionModel.Cast _AbcdFunction.cell).ShortTermVolatility
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let AbcdFunction_variance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _T = Helper.toCell<double> T "T" 
                let builder (current : ICell) = ((AbcdFunctionModel.Cast _AbcdFunction.cell).Variance
                                                            _tMin.cell 
                                                            _tMax.cell 
                                                            _T.cell 
                                                       ) :> ICell
    ...
    let AbcdFunction_volatility
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _tMax = Helper.toCell<double> tMax "tMax" 
                let _T = Helper.toCell<double> T "T" 
                let builder (current : ICell) = ((AbcdFunctionModel.Cast _AbcdFunction.cell).Volatility
                                                            _tMin.cell 
                                                            _tMax.cell 
                                                            _T.cell 
                                                       ) :> ICell
    ...
    let AbcdFunction_a
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _AbcdFunction = Helper.toModelReference<AbcdFunction> abcdfunction "AbcdFunction"  
                let builder (current : ICell) = ((AbcdFunctionModel.Cast _AbcdFunction.cell).A
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let AbcdFunction_b
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _AbcdFunction = Helper.toModelReference<AbcdFunction> abcdfunction "AbcdFunction"  
                let builder (current : ICell) = ((AbcdFunctionModel.Cast _AbcdFunction.cell).B
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let AbcdFunction_c
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _AbcdFunction = Helper.toModelReference<AbcdFunction> abcdfunction "AbcdFunction"  
                let builder (current : ICell) = ((AbcdFunctionModel.Cast _AbcdFunction.cell).C
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let AbcdFunction_coefficients
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _AbcdFunction = Helper.toModelReference<AbcdFunction> abcdfunction "AbcdFunction"  
                let builder (current : ICell) = ((AbcdFunctionModel.Cast _AbcdFunction.cell).Coefficients
                                                       ) :> ICell
    ...
    let AbcdFunction_d
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _AbcdFunction = Helper.toModelReference<AbcdFunction> abcdfunction "AbcdFunction"  
                let builder (current : ICell) = ((AbcdFunctionModel.Cast _AbcdFunction.cell).D
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let AbcdFunction_definiteDerivativeCoefficients
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _t = Helper.toCell<double> t "t" 
                let _t2 = Helper.toCell<double> t2 "t2" 
                let builder (current : ICell) = ((AbcdFunctionModel.Cast _AbcdFunction.cell).DefiniteDerivativeCoefficients
                                                            _t.cell 
                                                            _t2.cell 
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let AbcdFunction_definiteIntegral
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _t1 = Helper.toCell<double> t1 "t1" 
                let _t2 = Helper.toCell<double> t2 "t2" 
                let builder (current : ICell) = ((AbcdFunctionModel.Cast _AbcdFunction.cell).DefiniteIntegral
                                                            _t1.cell 
                                                            _t2.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let AbcdFunction_definiteIntegralCoefficients
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _t = Helper.toCell<double> t "t" 
                let _t2 = Helper.toCell<double> t2 "t2" 
                let builder (current : ICell) = ((AbcdFunctionModel.Cast _AbcdFunction.cell).DefiniteIntegralCoefficients
                                                            _t.cell 
                                                            _t2.cell 
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let AbcdFunction_derivative
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _AbcdFunction = Helper.toModelReference<AbcdFunction> abcdfunction "AbcdFunction"  
                let _t = Helper.toCell<double> t "t" 
                let builder (current : ICell) = ((AbcdFunctionModel.Cast _AbcdFunction.cell).Derivative
                                                            _t.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let AbcdFunction_derivativeCoefficients
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _AbcdFunction = Helper.toModelReference<AbcdFunction> abcdfunction "AbcdFunction"  
                let builder (current : ICell) = ((AbcdFunctionModel.Cast _AbcdFunction.cell).DerivativeCoefficients
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let AbcdFunction_longTermValue
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _AbcdFunction = Helper.toModelReference<AbcdFunction> abcdfunction "AbcdFunction"  
                let builder (current : ICell) = ((AbcdFunctionModel.Cast _AbcdFunction.cell).LongTermValue
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let AbcdFunction_maximumLocation
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _AbcdFunction = Helper.toModelReference<AbcdFunction> abcdfunction "AbcdFunction"  
                let builder (current : ICell) = ((AbcdFunctionModel.Cast _AbcdFunction.cell).MaximumLocation
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let AbcdFunction_maximumValue
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _AbcdFunction = Helper.toModelReference<AbcdFunction> abcdfunction "AbcdFunction"  
                let builder (current : ICell) = ((AbcdFunctionModel.Cast _AbcdFunction.cell).MaximumValue
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let AbcdFunction_value
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _AbcdFunction = Helper.toModelReference<AbcdFunction> abcdfunction "AbcdFunction"  
                let _t = Helper.toCell<double> t "t" 
                let builder (current : ICell) = ((AbcdFunctionModel.Cast _AbcdFunction.cell).Value
                                                            _t.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let AbcdFunction_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<AbcdFunction> (c)) :> ICell
                let format (i : Cephei.Cell.List<AbcdFunction>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<AbcdFunction>(" + (Helper.sourceFoldArray (s) + "))"))
