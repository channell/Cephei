    ...
    *)
    ...
    let CoxIngersollRoss_create
        ([<ExcelArgument(Name="Mnemonic",Description = "Identifier for Cell")>] 
         mnemonic : string)
        ([<ExcelArgument(Name="r0",Description = "double or empty")>] 
         r0 : obj)
        ([<ExcelArgument(Name="theta",Description = "double or empty")>] 
         theta : obj)
        ([<ExcelArgument(Name="k",Description = "double or empty")>] 
         k : obj)
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.CoxIngersollRoss 
                                                            _r0.cell 
                                                            _theta.cell 
                                                            _k.cell 
                                                            _sigma.cell 
    ...
    let CoxIngersollRoss_discountBondOption
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((CoxIngersollRossModel.Cast _CoxIngersollRoss.cell).DiscountBondOption
                                                            _Type.cell 
                                                            _strike.cell 
                                                            _maturity.cell 
                                                            _bondMaturity.cell 
    ...
    let CoxIngersollRoss_discountBond1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((CoxIngersollRossModel.Cast _CoxIngersollRoss.cell).DiscountBond1
                                                            _now.cell 
                                                            _maturity.cell 
                                                            _rate.cell 
                                                       ) :> ICell
    ...
    let CoxIngersollRoss_discountBond
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((CoxIngersollRossModel.Cast _CoxIngersollRoss.cell).DiscountBond
                                                            _now.cell 
                                                            _maturity.cell 
                                                            _factors.cell 
                                                       ) :> ICell
    ...
    let CoxIngersollRoss_calibrate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((CoxIngersollRossModel.Cast _CoxIngersollRoss.cell).Calibrate
                                                            _instruments.cell 
                                                            _Method.cell 
                                                            _endCriteria.cell 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                Model.specify 
                    ...
                    ; source =  (fun () -> "(new Cephei.Cell.List<CoxIngersollRoss>(" + (Helper.sourceFoldArray (s) + "))"))
