    ...
    let EURLibor5M_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.EURLibor5M 
                                                            _h.cell 
                                                       ) :> ICell
    ...
    let EURLibor5M_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.EURLibor5M1 ()
                                                       ) :> ICell
                let format (i : ICell) (l:string) = Helper.Range.fromModel (i :?> ICell<EURLibor5M>) l
    ...
    let EURLibor5M_maturityDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor5M = Helper.toModelReference<EURLibor5M> eurlibor5m "EURLibor5M"  
                let _valueDate = Helper.toCell<Date> valueDate "valueDate" 
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).MaturityDate
                                                            _valueDate.cell 
                                                       ) :> ICell
    ...
    let EURLibor5M_valueDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).ValueDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let EURLibor5M_businessDayConvention
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor5M = Helper.toModelReference<EURLibor5M> eurlibor5m "EURLibor5M"  
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).BusinessDayConvention
                                                       ) :> ICell
    ...
    let EURLibor5M_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).Clone
                                                            _forwarding.cell 
                                                       ) :> ICell
    ...
    let EURLibor5M_endOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor5M = Helper.toModelReference<EURLibor5M> eurlibor5m "EURLibor5M"  
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).EndOfMonth
                                                       ) :> ICell
    ...
    let EURLibor5M_forecastFixing1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).ForecastFixing1
                                                            _d1.cell 
                                                            _d2.cell 
                                                            _t.cell 
                                                       ) :> ICell
    ...
    let EURLibor5M_forecastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor5M = Helper.toModelReference<EURLibor5M> eurlibor5m "EURLibor5M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).ForecastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let EURLibor5M_forwardingTermStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor5M = Helper.toModelReference<EURLibor5M> eurlibor5m "EURLibor5M"  
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).ForwardingTermStructure
                                                       ) :> ICell
    ...
    let EURLibor5M_currency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor5M = Helper.toModelReference<EURLibor5M> eurlibor5m "EURLibor5M"  
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).Currency
                                                       ) :> ICell
    ...
    let EURLibor5M_dayCounter
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor5M = Helper.toModelReference<EURLibor5M> eurlibor5m "EURLibor5M"  
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).DayCounter
                                                       ) :> ICell
    ...
    let EURLibor5M_familyName
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor5M = Helper.toModelReference<EURLibor5M> eurlibor5m "EURLibor5M"  
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).FamilyName
                                                       ) :> ICell
    ...
    let EURLibor5M_fixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).Fixing
                                                            _fixingDate.cell 
    ...
    let EURLibor5M_fixingCalendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor5M = Helper.toModelReference<EURLibor5M> eurlibor5m "EURLibor5M"  
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).FixingCalendar
                                                       ) :> ICell
    ...
    let EURLibor5M_fixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor5M = Helper.toModelReference<EURLibor5M> eurlibor5m "EURLibor5M"  
                let _valueDate = Helper.toCell<Date> valueDate "valueDate" 
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).FixingDate
                                                            _valueDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let EURLibor5M_fixingDays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor5M = Helper.toModelReference<EURLibor5M> eurlibor5m "EURLibor5M"  
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).FixingDays
                                                       ) :> ICell
    ...
    let EURLibor5M_isValidFixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor5M = Helper.toModelReference<EURLibor5M> eurlibor5m "EURLibor5M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).IsValidFixingDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let EURLibor5M_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor5M = Helper.toModelReference<EURLibor5M> eurlibor5m "EURLibor5M"  
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let EURLibor5M_pastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor5M = Helper.toModelReference<EURLibor5M> eurlibor5m "EURLibor5M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).PastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
    ...
    let EURLibor5M_tenor
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor5M = Helper.toModelReference<EURLibor5M> eurlibor5m "EURLibor5M"  
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).Tenor
                                                       ) :> ICell
    ...
    let EURLibor5M_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor5M = Helper.toModelReference<EURLibor5M> eurlibor5m "EURLibor5M"  
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).Update
                                                       ) :> ICell
    ...
    let EURLibor5M_addFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).AddFixing
                                                            _d.cell 
                                                            _v.cell 
    ...
    let EURLibor5M_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).AddFixings
                                                            _d.cell 
                                                            _v.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
    ...
    let EURLibor5M_addFixings1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).AddFixings1
                                                            _source.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
                let format (o : EURLibor5M) (l:string) = o.ToString() :> obj
    ...
    let EURLibor5M_allowsNativeFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor5M = Helper.toModelReference<EURLibor5M> eurlibor5m "EURLibor5M"  
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).AllowsNativeFixings
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let EURLibor5M_clearFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor5M = Helper.toModelReference<EURLibor5M> eurlibor5m "EURLibor5M"  
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).ClearFixings
                                                       ) :> ICell
                let format (o : EURLibor5M) (l:string) = o.ToString() :> obj
    ...
    let EURLibor5M_registerWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).RegisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : EURLibor5M) (l:string) = o.ToString() :> obj
    ...
    let EURLibor5M_timeSeries
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor5M = Helper.toModelReference<EURLibor5M> eurlibor5m "EURLibor5M"  
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).TimeSeries
                                                       ) :> ICell
    ...
    let EURLibor5M_unregisterWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor5M = Helper.toModelReference<EURLibor5M> eurlibor5m "EURLibor5M"  
                let _handler = Helper.toCell<Callback> handler "handler" 
                let builder (current : ICell) = ((EURLibor5MModel.Cast _EURLibor5M.cell).UnregisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : EURLibor5M) (l:string) = o.ToString() :> obj
    ...
    let EURLibor5M_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<EURLibor5M>) (l : string) = Helper.Range.fromModelList i l
