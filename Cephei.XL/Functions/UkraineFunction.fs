...
module UkraineFunction =
    ...
    *)
    [<ExcelFunction(Name="_Ukraine", Description="Create a Ukraine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let Ukraine_create
    ...
    *)
    [<ExcelFunction(Name="_Ukraine_addedHolidays", Description="Create a Ukraine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let Ukraine_addedHolidays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Ukraine = Helper.toCell<Ukraine> ukraine "Ukraine" true 
    ...
    *)
    [<ExcelFunction(Name="_Ukraine_addHoliday", Description="Create a Ukraine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    ...
    *)
    [<ExcelFunction(Name="_Ukraine_adjust", Description="Create a Ukraine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let Ukraine_adjust
        ([<ExcelArgument(Name="Mnemonic",Description = "Identifer for the value")>] 
         mnemonic : string)
        ([<ExcelArgument(Name="Ukraine",Description = "Reference to Ukraine")>] 
    ...
    *)
    [<ExcelFunction(Name="_Ukraine_businessDaysBetween", Description="Create a Ukraine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    ...
    *)
    [<ExcelFunction(Name="_Ukraine_calendar", Description="Create a Ukraine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    ...
    *)
    [<ExcelFunction(Name="_Ukraine_empty", Description="Create a Ukraine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let Ukraine_empty
        ([<ExcelArgument(Name="Mnemonic",Description = "Identifer for the value")>] 
         mnemonic : string)
        ([<ExcelArgument(Name="Ukraine",Description = "Reference to Ukraine")>] 
    ...
    *)
    [<ExcelFunction(Name="_Ukraine_endOfMonth", Description="Create a Ukraine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    ...
    *)
    [<ExcelFunction(Name="_Ukraine_Equals", Description="Create a Ukraine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let Ukraine_Equals
        ([<ExcelArgument(Name="Mnemonic",Description = "Identifer for the value")>] 
         mnemonic : string)
        ([<ExcelArgument(Name="Ukraine",Description = "Reference to Ukraine")>] 
    ...
    *)
    [<ExcelFunction(Name="_Ukraine_isBusinessDay", Description="Create a Ukraine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    ...
    *)
    [<ExcelFunction(Name="_Ukraine_isEndOfMonth", Description="Create a Ukraine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    ...
    *)
    [<ExcelFunction(Name="_Ukraine_isHoliday", Description="Create a Ukraine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    ...
    *)
    [<ExcelFunction(Name="_Ukraine_isWeekend", Description="Create a Ukraine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
...
@returns The name of the calendar.
    *)
    [<ExcelFunction(Name="_Ukraine_name", Description="Create a Ukraine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let Ukraine_name
        ([<ExcelArgument(Name="Mnemonic",Description = "Identifer for the value")>] 
         mnemonic : string)
        ([<ExcelArgument(Name="Ukraine",Description = "Reference to Ukraine")>] 
    ...
    *)
    [<ExcelFunction(Name="_Ukraine_removedHolidays", Description="Create a Ukraine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    ...
    *)
    [<ExcelFunction(Name="_Ukraine_removeHoliday", Description="Create a Ukraine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let Ukraine_removeHoliday
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            "<WIZ>"
    [<ExcelFunction(Name="_Ukraine_Range", Description="Create a range of Ukraine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let Ukraine_Range 
        ([<ExcelArgument(Name="Mnemonic",Description = "Identifer for the value")>] 
         mnemonic : string)
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<Ukraine> i "value" true) |>
                        Seq.toArray
