    ...
    let Bkbm2M_businessDayConvention
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).BusinessDayConvention
                                                       ) :> ICell
    ...
    let Bkbm2M_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).Clone
                                                            _forwarding.cell 
                                                       ) :> ICell
    ...
    let Bkbm2M_endOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm2M = Helper.toCell<Bkbm2M> bkbm2m "Bkbm2M"  
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).EndOfMonth
                                                       ) :> ICell
    ...
    let Bkbm2M_forecastFixing1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).ForecastFixing1
                                                            _d1.cell 
                                                            _d2.cell 
                                                            _t.cell 
                                                       ) :> ICell
    ...
    let Bkbm2M_forecastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).ForecastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let Bkbm2M_forwardingTermStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm2M = Helper.toCell<Bkbm2M> bkbm2m "Bkbm2M"  
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).ForwardingTermStructure
                                                       ) :> ICell
    ...
    let Bkbm2M_maturityDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).MaturityDate
                                                            _valueDate.cell 
                                                       ) :> ICell
    ...
    let Bkbm2M_currency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm2M = Helper.toCell<Bkbm2M> bkbm2m "Bkbm2M"  
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).Currency
                                                       ) :> ICell
    ...
    let Bkbm2M_dayCounter
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm2M = Helper.toCell<Bkbm2M> bkbm2m "Bkbm2M"  
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).DayCounter
                                                       ) :> ICell
    ...
    let Bkbm2M_familyName
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm2M = Helper.toCell<Bkbm2M> bkbm2m "Bkbm2M"  
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).FamilyName
                                                       ) :> ICell
    ...
    let Bkbm2M_fixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).Fixing
                                                            _fixingDate.cell 
    ...
    let Bkbm2M_fixingCalendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm2M = Helper.toCell<Bkbm2M> bkbm2m "Bkbm2M"  
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).FixingCalendar
                                                       ) :> ICell
    ...
    let Bkbm2M_fixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm2M = Helper.toCell<Bkbm2M> bkbm2m "Bkbm2M"  
                let _valueDate = Helper.toCell<Date> valueDate "valueDate" 
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).FixingDate
                                                            _valueDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let Bkbm2M_fixingDays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm2M = Helper.toCell<Bkbm2M> bkbm2m "Bkbm2M"  
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).FixingDays
                                                       ) :> ICell
    ...
    let Bkbm2M_isValidFixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm2M = Helper.toCell<Bkbm2M> bkbm2m "Bkbm2M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).IsValidFixingDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Bkbm2M_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm2M = Helper.toCell<Bkbm2M> bkbm2m "Bkbm2M"  
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let Bkbm2M_pastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm2M = Helper.toCell<Bkbm2M> bkbm2m "Bkbm2M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).PastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
    ...
    let Bkbm2M_tenor
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm2M = Helper.toCell<Bkbm2M> bkbm2m "Bkbm2M"  
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).Tenor
                                                       ) :> ICell
    ...
    let Bkbm2M_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm2M = Helper.toCell<Bkbm2M> bkbm2m "Bkbm2M"  
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).Update
                                                       ) :> ICell
    ...
    let Bkbm2M_valueDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm2M = Helper.toCell<Bkbm2M> bkbm2m "Bkbm2M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).ValueDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let Bkbm2M_addFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).AddFixing
                                                            _d.cell 
                                                            _v.cell 
    ...
    let Bkbm2M_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).AddFixings
                                                            _d.cell 
                                                            _v.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
    ...
    let Bkbm2M_addFixings1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).AddFixings1
                                                            _source.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
                let format (o : Bkbm2M) (l:string) = o.ToString() :> obj
    ...
    let Bkbm2M_allowsNativeFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm2M = Helper.toCell<Bkbm2M> bkbm2m "Bkbm2M"  
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).AllowsNativeFixings
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Bkbm2M_clearFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm2M = Helper.toCell<Bkbm2M> bkbm2m "Bkbm2M"  
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).ClearFixings
                                                       ) :> ICell
                let format (o : Bkbm2M) (l:string) = o.ToString() :> obj
    ...
    let Bkbm2M_registerWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).RegisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : Bkbm2M) (l:string) = o.ToString() :> obj
    ...
    let Bkbm2M_timeSeries
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm2M = Helper.toCell<Bkbm2M> bkbm2m "Bkbm2M"  
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).TimeSeries
                                                       ) :> ICell
    ...
    let Bkbm2M_unregisterWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm2M = Helper.toCell<Bkbm2M> bkbm2m "Bkbm2M"  
                let _handler = Helper.toCell<Callback> handler "handler" 
                let builder () = withMnemonic mnemonic ((Bkbm2MModel.Cast _Bkbm2M.cell).UnregisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : Bkbm2M) (l:string) = o.ToString() :> obj
