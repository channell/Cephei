    ...
    let GaussLegendrePolynomial_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.GaussLegendrePolynomial 
                                                       ) :> ICell
    ...
    let GaussLegendrePolynomial_alpha
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _GaussLegendrePolynomial = Helper.toModelReference<GaussLegendrePolynomial> gausslegendrepolynomial "GaussLegendrePolynomial"  
                let _i = Helper.toCell<int> i "i" 
                let builder (current : ICell) = ((GaussLegendrePolynomialModel.Cast _GaussLegendrePolynomial.cell).Alpha
                                                            _i.cell 
                                                       ) :> ICell
    ...
    let GaussLegendrePolynomial_beta
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _GaussLegendrePolynomial = Helper.toModelReference<GaussLegendrePolynomial> gausslegendrepolynomial "GaussLegendrePolynomial"  
                let _i = Helper.toCell<int> i "i" 
                let builder (current : ICell) = ((GaussLegendrePolynomialModel.Cast _GaussLegendrePolynomial.cell).Beta
                                                            _i.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let GaussLegendrePolynomial_mu_0
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _GaussLegendrePolynomial = Helper.toModelReference<GaussLegendrePolynomial> gausslegendrepolynomial "GaussLegendrePolynomial"  
                let builder (current : ICell) = ((GaussLegendrePolynomialModel.Cast _GaussLegendrePolynomial.cell).Mu_0
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let GaussLegendrePolynomial_w
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((GaussLegendrePolynomialModel.Cast _GaussLegendrePolynomial.cell).W
                                                            _x.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let GaussLegendrePolynomial_value
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _x = Helper.toCell<double> x "x" 
                let builder (current : ICell) = ((GaussLegendrePolynomialModel.Cast _GaussLegendrePolynomial.cell).Value
                                                            _n.cell 
                                                            _x.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let GaussLegendrePolynomial_weightedValue
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _n = Helper.toCell<int> n "n" 
                let _x = Helper.toCell<double> x "x" 
                let builder (current : ICell) = ((GaussLegendrePolynomialModel.Cast _GaussLegendrePolynomial.cell).WeightedValue
                                                            _n.cell 
                                                            _x.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let GaussLegendrePolynomial_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<GaussLegendrePolynomial> (c)) :> ICell
                let format (i : Cephei.Cell.List<GaussLegendrePolynomial>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<GaussLegendrePolynomial>(" + (Helper.sourceFoldArray (s) + "))"))
