    ...
    let SymmetricSchurDecomposition_eigenvalues
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SymmetricSchurDecomposition = Helper.toModelReference<SymmetricSchurDecomposition> symmetricschurdecomposition "SymmetricSchurDecomposition"  
    ...
    let SymmetricSchurDecomposition_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<SymmetricSchurDecomposition>) (l : string) = Helper.Range.fromModelList i l
