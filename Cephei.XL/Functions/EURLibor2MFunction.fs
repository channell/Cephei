    ...
    let EURLibor2M_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.EURLibor2M1 ()
                                                       ) :> ICell
    ...
    let EURLibor2M_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.EURLibor2M
                                                            _h.cell 
                                                       ) :> ICell
                let format (i : ICell) (l:string) = Helper.Range.fromModel (i :?> ICell<EURLibor2M>) l
    ...
    let EURLibor2M_maturityDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor2M = Helper.toModelReference<EURLibor2M> eurlibor2m "EURLibor2M"  
                let _valueDate = Helper.toCell<Date> valueDate "valueDate" 
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).MaturityDate
                                                            _valueDate.cell 
                                                       ) :> ICell
    ...
    let EURLibor2M_valueDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).ValueDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let EURLibor2M_businessDayConvention
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor2M = Helper.toModelReference<EURLibor2M> eurlibor2m "EURLibor2M"  
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).BusinessDayConvention
                                                       ) :> ICell
    ...
    let EURLibor2M_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).Clone
                                                            _forwarding.cell 
                                                       ) :> ICell
    ...
    let EURLibor2M_endOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor2M = Helper.toModelReference<EURLibor2M> eurlibor2m "EURLibor2M"  
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).EndOfMonth
                                                       ) :> ICell
    ...
    let EURLibor2M_forecastFixing1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).ForecastFixing1
                                                            _d1.cell 
                                                            _d2.cell 
                                                            _t.cell 
                                                       ) :> ICell
    ...
    let EURLibor2M_forecastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor2M = Helper.toModelReference<EURLibor2M> eurlibor2m "EURLibor2M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).ForecastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let EURLibor2M_forwardingTermStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor2M = Helper.toModelReference<EURLibor2M> eurlibor2m "EURLibor2M"  
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).ForwardingTermStructure
                                                       ) :> ICell
    ...
    let EURLibor2M_currency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor2M = Helper.toModelReference<EURLibor2M> eurlibor2m "EURLibor2M"  
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).Currency
                                                       ) :> ICell
    ...
    let EURLibor2M_dayCounter
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor2M = Helper.toModelReference<EURLibor2M> eurlibor2m "EURLibor2M"  
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).DayCounter
                                                       ) :> ICell
    ...
    let EURLibor2M_familyName
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor2M = Helper.toModelReference<EURLibor2M> eurlibor2m "EURLibor2M"  
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).FamilyName
                                                       ) :> ICell
    ...
    let EURLibor2M_fixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).Fixing
                                                            _fixingDate.cell 
    ...
    let EURLibor2M_fixingCalendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor2M = Helper.toModelReference<EURLibor2M> eurlibor2m "EURLibor2M"  
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).FixingCalendar
                                                       ) :> ICell
    ...
    let EURLibor2M_fixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor2M = Helper.toModelReference<EURLibor2M> eurlibor2m "EURLibor2M"  
                let _valueDate = Helper.toCell<Date> valueDate "valueDate" 
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).FixingDate
                                                            _valueDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let EURLibor2M_fixingDays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor2M = Helper.toModelReference<EURLibor2M> eurlibor2m "EURLibor2M"  
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).FixingDays
                                                       ) :> ICell
    ...
    let EURLibor2M_isValidFixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor2M = Helper.toModelReference<EURLibor2M> eurlibor2m "EURLibor2M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).IsValidFixingDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let EURLibor2M_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor2M = Helper.toModelReference<EURLibor2M> eurlibor2m "EURLibor2M"  
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let EURLibor2M_pastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor2M = Helper.toModelReference<EURLibor2M> eurlibor2m "EURLibor2M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).PastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
    ...
    let EURLibor2M_tenor
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor2M = Helper.toModelReference<EURLibor2M> eurlibor2m "EURLibor2M"  
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).Tenor
                                                       ) :> ICell
    ...
    let EURLibor2M_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor2M = Helper.toModelReference<EURLibor2M> eurlibor2m "EURLibor2M"  
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).Update
                                                       ) :> ICell
    ...
    let EURLibor2M_addFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).AddFixing
                                                            _d.cell 
                                                            _v.cell 
    ...
    let EURLibor2M_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).AddFixings
                                                            _d.cell 
                                                            _v.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
    ...
    let EURLibor2M_addFixings1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).AddFixings1
                                                            _source.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
                let format (o : EURLibor2M) (l:string) = o.ToString() :> obj
    ...
    let EURLibor2M_allowsNativeFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor2M = Helper.toModelReference<EURLibor2M> eurlibor2m "EURLibor2M"  
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).AllowsNativeFixings
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let EURLibor2M_clearFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor2M = Helper.toModelReference<EURLibor2M> eurlibor2m "EURLibor2M"  
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).ClearFixings
                                                       ) :> ICell
                let format (o : EURLibor2M) (l:string) = o.ToString() :> obj
    ...
    let EURLibor2M_registerWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).RegisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : EURLibor2M) (l:string) = o.ToString() :> obj
    ...
    let EURLibor2M_timeSeries
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor2M = Helper.toModelReference<EURLibor2M> eurlibor2m "EURLibor2M"  
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).TimeSeries
                                                       ) :> ICell
    ...
    let EURLibor2M_unregisterWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor2M = Helper.toModelReference<EURLibor2M> eurlibor2m "EURLibor2M"  
                let _handler = Helper.toCell<Callback> handler "handler" 
                let builder (current : ICell) = ((EURLibor2MModel.Cast _EURLibor2M.cell).UnregisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : EURLibor2M) (l:string) = o.ToString() :> obj
