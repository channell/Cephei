    ...
    let SoftCallability_trigger
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SoftCallability = Helper.toModelReference<SoftCallability> softcallability "SoftCallability"  
    ...
    let SoftCallability_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<SoftCallability>) (l : string) = Helper.Range.fromModelList i l
