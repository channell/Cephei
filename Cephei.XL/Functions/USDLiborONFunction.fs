...
module USDLiborONFunction =
    ...
    let USDLiborON_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.USDLiborON1  
                                                            _h.cell 
                                                       ) :> ICell
    ...
    let USDLiborON_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.USDLiborON ()
                                                       ) :> ICell
                let format (i : ICell) (l:string) = Helper.Range.fromModel (i :?> ICell<USDLiborON>) l
    ...
    *)
    ...
    let USDLiborON_businessDayConvention
        ([<ExcelArgument(Name="Mnemonic",Description = "Identifier for Cell")>] 
         mnemonic : string)
        ([<ExcelArgument(Name="USDLiborON",Description = "USDLiborON")>] 
         usdliboron : obj)
        = 
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _USDLiborON = Helper.toModelReference<USDLiborON> usdliboron "USDLiborON"  
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).BusinessDayConvention
                                                       ) :> ICell
    ...
    let USDLiborON_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).Clone
                                                            _forwarding.cell 
                                                       ) :> ICell
    ...
    let USDLiborON_endOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _USDLiborON = Helper.toModelReference<USDLiborON> usdliboron "USDLiborON"  
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).EndOfMonth
                                                       ) :> ICell
    ...
    let USDLiborON_forecastFixing1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).ForecastFixing1
                                                            _d1.cell 
                                                            _d2.cell 
                                                            _t.cell 
                                                       ) :> ICell
    ...
    let USDLiborON_forecastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).ForecastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let USDLiborON_forwardingTermStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _USDLiborON = Helper.toModelReference<USDLiborON> usdliboron "USDLiborON"  
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).ForwardingTermStructure
                                                       ) :> ICell
    ...
    let USDLiborON_maturityDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).MaturityDate
                                                            _valueDate.cell 
                                                       ) :> ICell
    ...
    let USDLiborON_currency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _USDLiborON = Helper.toModelReference<USDLiborON> usdliboron "USDLiborON"  
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).Currency
                                                       ) :> ICell
    ...
    let USDLiborON_dayCounter
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _USDLiborON = Helper.toModelReference<USDLiborON> usdliboron "USDLiborON"  
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).DayCounter
                                                       ) :> ICell
    ...
    let USDLiborON_familyName
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _USDLiborON = Helper.toModelReference<USDLiborON> usdliboron "USDLiborON"  
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).FamilyName
                                                       ) :> ICell
    ...
    let USDLiborON_fixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).Fixing
                                                            _fixingDate.cell 
    ...
    let USDLiborON_fixingCalendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _USDLiborON = Helper.toModelReference<USDLiborON> usdliboron "USDLiborON"  
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).FixingCalendar
                                                       ) :> ICell
    ...
    let USDLiborON_fixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _USDLiborON = Helper.toModelReference<USDLiborON> usdliboron "USDLiborON"  
                let _valueDate = Helper.toCell<Date> valueDate "valueDate" 
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).FixingDate
                                                            _valueDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let USDLiborON_fixingDays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _USDLiborON = Helper.toModelReference<USDLiborON> usdliboron "USDLiborON"  
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).FixingDays
                                                       ) :> ICell
    ...
    let USDLiborON_isValidFixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _USDLiborON = Helper.toModelReference<USDLiborON> usdliboron "USDLiborON"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).IsValidFixingDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let USDLiborON_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _USDLiborON = Helper.toModelReference<USDLiborON> usdliboron "USDLiborON"  
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let USDLiborON_pastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _USDLiborON = Helper.toModelReference<USDLiborON> usdliboron "USDLiborON"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).PastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
    ...
    let USDLiborON_tenor
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _USDLiborON = Helper.toModelReference<USDLiborON> usdliboron "USDLiborON"  
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).Tenor
                                                       ) :> ICell
    ...
    let USDLiborON_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _USDLiborON = Helper.toModelReference<USDLiborON> usdliboron "USDLiborON"  
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).Update
                                                       ) :> ICell
    ...
    let USDLiborON_valueDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _USDLiborON = Helper.toModelReference<USDLiborON> usdliboron "USDLiborON"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).ValueDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let USDLiborON_addFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).AddFixing
                                                            _d.cell 
                                                            _v.cell 
    ...
    let USDLiborON_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).AddFixings
                                                            _d.cell 
                                                            _v.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
    ...
    let USDLiborON_addFixings1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).AddFixings1
                                                            _source.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
                let format (o : USDLiborON) (l:string) = o.ToString() :> obj
    ...
    let USDLiborON_allowsNativeFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _USDLiborON = Helper.toModelReference<USDLiborON> usdliboron "USDLiborON"  
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).AllowsNativeFixings
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let USDLiborON_clearFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _USDLiborON = Helper.toModelReference<USDLiborON> usdliboron "USDLiborON"  
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).ClearFixings
                                                       ) :> ICell
                let format (o : USDLiborON) (l:string) = o.ToString() :> obj
    ...
    let USDLiborON_registerWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).RegisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : USDLiborON) (l:string) = o.ToString() :> obj
    ...
    let USDLiborON_timeSeries
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _USDLiborON = Helper.toModelReference<USDLiborON> usdliboron "USDLiborON"  
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).TimeSeries
                                                       ) :> ICell
    ...
    let USDLiborON_unregisterWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _USDLiborON = Helper.toModelReference<USDLiborON> usdliboron "USDLiborON"  
                let _handler = Helper.toCell<Callback> handler "handler" 
                let builder (current : ICell) = ((USDLiborONModel.Cast _USDLiborON.cell).UnregisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : USDLiborON) (l:string) = o.ToString() :> obj
    ...
    let USDLiborON_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<USDLiborON> (c)) :> ICell
                let format (i : Cephei.Cell.List<USDLiborON>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<USDLiborON>(" + (Helper.sourceFoldArray (s) + "))"))
