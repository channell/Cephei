    ...
    let SwapRateHelper_create2
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.SwapRateHelper2 
                                                            _rate.cell 
                                                            _tenor.cell 
                                                            _calendar.cell 
    ...
    let SwapRateHelper_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _customPillarDate = Helper.toDefault<Date> customPillarDate "customPillarDate" null
                let _evaluationDate = Helper.toCell<Date> evaluationDate "evaluationDate"
                let builder (current : ICell) = (Fun.SwapRateHelper
                                                            _rate.cell 
                                                            _tenor.cell 
                                                            _calendar.cell 
                                                            _fixedFrequency.cell 
    ...
    let SwapRateHelper_create3
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _customPillarDate = Helper.toDefault<Date> customPillarDate "customPillarDate" null
                let _evaluationDate = Helper.toCell<Date> evaluationDate "evaluationDate"
                let builder (current : ICell) = (Fun.SwapRateHelper3
                                                            _rate.cell 
                                                            _swapIndex.cell 
                                                            _spread.cell 
                                                            _fwdStart.cell 
    ...
    let SwapRateHelper_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _customPillarDate = Helper.toDefault<Date> customPillarDate "customPillarDate" null
                let _evaluationDate = Helper.toCell<Date> evaluationDate "evaluationDate"
                let builder (current : ICell) = (Fun.SwapRateHelper1
                                                            _rate.cell 
                                                            _swapIndex.cell 
                                                            _spread.cell 
                                                            _fwdStart.cell 
