    ...
    let CZKCurrency_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.CZKCurrency ()
                                                       ) :> ICell
    ...
    let CZKCurrency_code
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CZKCurrency = Helper.toModelReference<CZKCurrency> czkcurrency "CZKCurrency"  
                let builder (current : ICell) = ((CZKCurrencyModel.Cast _CZKCurrency.cell).Code
                                                       ) :> ICell
    ...
    let CZKCurrency_empty
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CZKCurrency = Helper.toModelReference<CZKCurrency> czkcurrency "CZKCurrency"  
                let builder (current : ICell) = ((CZKCurrencyModel.Cast _CZKCurrency.cell).Empty
                                                       ) :> ICell
    ...
    let CZKCurrency_Equals
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((CZKCurrencyModel.Cast _CZKCurrency.cell).Equals
                                                            _o.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let CZKCurrency_format
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CZKCurrency = Helper.toModelReference<CZKCurrency> czkcurrency "CZKCurrency"  
                let builder (current : ICell) = ((CZKCurrencyModel.Cast _CZKCurrency.cell).Format
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let CZKCurrency_fractionsPerUnit
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CZKCurrency = Helper.toModelReference<CZKCurrency> czkcurrency "CZKCurrency"  
                let builder (current : ICell) = ((CZKCurrencyModel.Cast _CZKCurrency.cell).FractionsPerUnit
                                                       ) :> ICell
    ...
    let CZKCurrency_fractionSymbol
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CZKCurrency = Helper.toModelReference<CZKCurrency> czkcurrency "CZKCurrency"  
                let builder (current : ICell) = ((CZKCurrencyModel.Cast _CZKCurrency.cell).FractionSymbol
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let CZKCurrency_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CZKCurrency = Helper.toModelReference<CZKCurrency> czkcurrency "CZKCurrency"  
                let builder (current : ICell) = ((CZKCurrencyModel.Cast _CZKCurrency.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let CZKCurrency_numericCode
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CZKCurrency = Helper.toModelReference<CZKCurrency> czkcurrency "CZKCurrency"  
                let builder (current : ICell) = ((CZKCurrencyModel.Cast _CZKCurrency.cell).NumericCode
                                                       ) :> ICell
                let format (o : int) (l:string) = o :> obj
    ...
    let CZKCurrency_rounding
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CZKCurrency = Helper.toModelReference<CZKCurrency> czkcurrency "CZKCurrency"  
                let builder (current : ICell) = ((CZKCurrencyModel.Cast _CZKCurrency.cell).Rounding
                                                       ) :> ICell
    ...
    let CZKCurrency_symbol
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CZKCurrency = Helper.toModelReference<CZKCurrency> czkcurrency "CZKCurrency"  
                let builder (current : ICell) = ((CZKCurrencyModel.Cast _CZKCurrency.cell).Symbol
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let CZKCurrency_ToString
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CZKCurrency = Helper.toModelReference<CZKCurrency> czkcurrency "CZKCurrency"  
                let builder (current : ICell) = ((CZKCurrencyModel.Cast _CZKCurrency.cell).ToString
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let CZKCurrency_triangulationCurrency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CZKCurrency = Helper.toModelReference<CZKCurrency> czkcurrency "CZKCurrency"  
                let builder (current : ICell) = ((CZKCurrencyModel.Cast _CZKCurrency.cell).TriangulationCurrency
                                                       ) :> ICell
    ...
    let CZKCurrency_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<CZKCurrency> (c)) :> ICell
                let format (i : Cephei.Cell.List<CZKCurrency>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<CZKCurrency>(" + (Helper.sourceFoldArray (s) + "))"))
