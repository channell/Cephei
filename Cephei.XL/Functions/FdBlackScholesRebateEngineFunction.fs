    ...
    let FdBlackScholesRebateEngine_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.FdBlackScholesRebateEngine 
                                                            _Process.cell 
                                                            _tGrid.cell 
                                                            _xGrid.cell 
                                                            _dampingSteps.cell 
    ...
    let FdBlackScholesRebateEngine_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<FdBlackScholesRebateEngine>) (l : string) = Helper.Range.fromModelList i l
