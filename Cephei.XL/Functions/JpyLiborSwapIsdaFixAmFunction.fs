    ...
    let JpyLiborSwapIsdaFixAm_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _JpyLiborSwapIsdaFixAm = Helper.toCell<JpyLiborSwapIsdaFixAm> jpyliborswapisdafixam "JpyLiborSwapIsdaFixAm" true 
                let _tenor = Helper.toCell<Period> tenor "tenor" true
    ...
    let JpyLiborSwapIsdaFixAm_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<JpyLiborSwapIsdaFixAm> i "value" true) |>
                        Seq.toArray
