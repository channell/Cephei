    ...
    let DividendVanillaOption_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.DividendVanillaOption 
                                                            _payoff.cell 
                                                            _exercise.cell 
                                                            _dividendDates.cell 
                                                            _dividends.cell 
    ...
    let DividendVanillaOption_impliedVolatility
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((DividendVanillaOptionModel.Cast _DividendVanillaOption.cell).ImpliedVolatility
                                                            _targetValue.cell 
                                                            _Process.cell 
                                                            _accuracy.cell 
