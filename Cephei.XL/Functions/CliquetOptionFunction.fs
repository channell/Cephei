    ...
    let CliquetOption_delta
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CliquetOption = Helper.toModelReference<CliquetOption> cliquetoption "CliquetOption"  
    ...
    let CliquetOption_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<CliquetOption>) (l : string) = Helper.Range.fromModelList i l
