...
module SwitzerlandFunction =
    ...
    let Switzerland_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.Switzerland ()
                                                       ) :> ICell
    ...
    *)
    ...
    let Switzerland_addedHolidays
        ([<ExcelArgument(Name="Mnemonic",Description = "Identifier for Cell")>] 
         mnemonic : string)
        ([<ExcelArgument(Name="Switzerland",Description = "Switzerland")>] 
         switzerland : obj)
        = 
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Switzerland = Helper.toModelReference<Switzerland> switzerland "Switzerland"  
                let builder (current : ICell) = ((SwitzerlandModel.Cast _Switzerland.cell).AddedHolidays
                                                       ) :> ICell
    ...
    let Switzerland_addHoliday
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((SwitzerlandModel.Cast _Switzerland.cell).AddHoliday
                                                            _d.cell 
                                                       ) :> ICell
    ...
    let Switzerland_adjust
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((SwitzerlandModel.Cast _Switzerland.cell).Adjust
                                                            _d.cell 
                                                            _c.cell 
                                                       ) :> ICell
    ...
    let Switzerland_advance1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((SwitzerlandModel.Cast _Switzerland.cell).Advance1
                                                            _d.cell 
                                                            _n.cell 
                                                            _unit.cell 
                                                            _c.cell 
    ...
    let Switzerland_advance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _c = Helper.toCell<BusinessDayConvention> c "c" 
                let _endOfMonth = Helper.toCell<bool> endOfMonth "endOfMonth" 
                let builder (current : ICell) = ((SwitzerlandModel.Cast _Switzerland.cell).Advance
                                                            _d.cell 
                                                            _p.cell 
                                                            _c.cell 
                                                            _endOfMonth.cell 
    ...
    let Switzerland_businessDaysBetween
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((SwitzerlandModel.Cast _Switzerland.cell).BusinessDaysBetween
                                                            _from.cell 
                                                            _To.cell 
                                                            _includeFirst.cell 
                                                            _includeLast.cell 
    ...
    let Switzerland_calendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Switzerland = Helper.toModelReference<Switzerland> switzerland "Switzerland"  
                let builder (current : ICell) = ((SwitzerlandModel.Cast _Switzerland.cell).Calendar
                                                       ) :> ICell
    ...
    let Switzerland_empty
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Switzerland = Helper.toModelReference<Switzerland> switzerland "Switzerland"  
                let builder (current : ICell) = ((SwitzerlandModel.Cast _Switzerland.cell).Empty
                                                       ) :> ICell
    ...
    let Switzerland_endOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Switzerland = Helper.toModelReference<Switzerland> switzerland "Switzerland"  
                let _d = Helper.toCell<Date> d "d" 
                let builder (current : ICell) = ((SwitzerlandModel.Cast _Switzerland.cell).EndOfMonth
                                                            _d.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let Switzerland_Equals
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((SwitzerlandModel.Cast _Switzerland.cell).Equals
                                                            _o.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Switzerland_isBusinessDay
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Switzerland = Helper.toModelReference<Switzerland> switzerland "Switzerland"  
                let _d = Helper.toCell<Date> d "d" 
                let builder (current : ICell) = ((SwitzerlandModel.Cast _Switzerland.cell).IsBusinessDay
                                                            _d.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Switzerland_isEndOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Switzerland = Helper.toModelReference<Switzerland> switzerland "Switzerland"  
                let _d = Helper.toCell<Date> d "d" 
                let builder (current : ICell) = ((SwitzerlandModel.Cast _Switzerland.cell).IsEndOfMonth
                                                            _d.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Switzerland_isHoliday
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Switzerland = Helper.toModelReference<Switzerland> switzerland "Switzerland"  
                let _d = Helper.toCell<Date> d "d" 
                let builder (current : ICell) = ((SwitzerlandModel.Cast _Switzerland.cell).IsHoliday
                                                            _d.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Switzerland_isWeekend
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((SwitzerlandModel.Cast _Switzerland.cell).IsWeekend
                                                            _w.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Switzerland_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Switzerland = Helper.toModelReference<Switzerland> switzerland "Switzerland"  
                let builder (current : ICell) = ((SwitzerlandModel.Cast _Switzerland.cell).Name
                                                       ) :> ICell
    ...
    let Switzerland_removedHolidays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Switzerland = Helper.toModelReference<Switzerland> switzerland "Switzerland"  
                let builder (current : ICell) = ((SwitzerlandModel.Cast _Switzerland.cell).RemovedHolidays
                                                       ) :> ICell
                let format (i : Generic.List<Date>) (l : string) = Helper.Range.fromList i l
    ...
    let Switzerland_removeHoliday
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Switzerland = Helper.toModelReference<Switzerland> switzerland "Switzerland"  
                let _d = Helper.toCell<Date> d "d" 
                let builder (current : ICell) = ((SwitzerlandModel.Cast _Switzerland.cell).RemoveHoliday
                                                            _d.cell 
                                                       ) :> ICell
                let format (o : Switzerland) (l:string) = o.ToString() :> obj
    ...
    let Switzerland_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<Switzerland> (c)) :> ICell
                let format (i : Cephei.Cell.List<Switzerland>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<Switzerland>(" + (Helper.sourceFoldArray (s) + "))"))
