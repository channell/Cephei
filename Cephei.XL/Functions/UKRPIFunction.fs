    ...
    let UKRPI_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.UKRPI 
                                                            _interpolated.cell 
                                                            _ts.cell 
                                                       ) :> ICell
    ...
    let UKRPI_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _interpolated = Helper.toCell<bool> interpolated "interpolated" 
                let builder (current : ICell) = (Fun.UKRPI1 
                                                            _interpolated.cell 
                                                       ) :> ICell
                let format (i : ICell) (l:string) = Helper.Range.fromModel (i :?> ICell<UKRPI>) l
    ...
    let UKRPI_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UKRPI = Helper.toModelReference<UKRPI> ukrpi "UKRPI"  
                let _h = Helper.toHandle<ZeroInflationTermStructure> h "h" 
                let builder (current : ICell) = ((UKRPIModel.Cast _UKRPI.cell).Clone
                                                            _h.cell 
                                                       ) :> ICell
    ...
    let UKRPI_fixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((UKRPIModel.Cast _UKRPI.cell).Fixing
                                                            _aFixingDate.cell 
    ...
    let UKRPI_zeroInflationTermStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UKRPI = Helper.toModelReference<UKRPI> ukrpi "UKRPI"  
                let builder (current : ICell) = ((UKRPIModel.Cast _UKRPI.cell).ZeroInflationTermStructure
                                                       ) :> ICell
    ...
    let UKRPI_addFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((UKRPIModel.Cast _UKRPI.cell).AddFixing
                                                            _fixingDate.cell 
                                                            _fixing.cell 
    ...
    let UKRPI_availabilityLag
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UKRPI = Helper.toModelReference<UKRPI> ukrpi "UKRPI"  
                let builder (current : ICell) = ((UKRPIModel.Cast _UKRPI.cell).AvailabilityLag
                                                       ) :> ICell
    ...
    let UKRPI_currency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UKRPI = Helper.toModelReference<UKRPI> ukrpi "UKRPI"  
                let builder (current : ICell) = ((UKRPIModel.Cast _UKRPI.cell).Currency
                                                       ) :> ICell
    ...
    let UKRPI_familyName
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UKRPI = Helper.toModelReference<UKRPI> ukrpi "UKRPI"  
                let builder (current : ICell) = ((UKRPIModel.Cast _UKRPI.cell).FamilyName
                                                       ) :> ICell
    ...
    let UKRPI_fixingCalendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UKRPI = Helper.toModelReference<UKRPI> ukrpi "UKRPI"  
                let builder (current : ICell) = ((UKRPIModel.Cast _UKRPI.cell).FixingCalendar
                                                       ) :> ICell
    ...
    let UKRPI_frequency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UKRPI = Helper.toModelReference<UKRPI> ukrpi "UKRPI"  
                let builder (current : ICell) = ((UKRPIModel.Cast _UKRPI.cell).Frequency
                                                       ) :> ICell
    ...
    let UKRPI_interpolated
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UKRPI = Helper.toModelReference<UKRPI> ukrpi "UKRPI"  
                let builder (current : ICell) = ((UKRPIModel.Cast _UKRPI.cell).Interpolated
                                                       ) :> ICell
    ...
    let UKRPI_isValidFixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UKRPI = Helper.toModelReference<UKRPI> ukrpi "UKRPI"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((UKRPIModel.Cast _UKRPI.cell).IsValidFixingDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let UKRPI_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UKRPI = Helper.toModelReference<UKRPI> ukrpi "UKRPI"  
                let builder (current : ICell) = ((UKRPIModel.Cast _UKRPI.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let UKRPI_region
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UKRPI = Helper.toModelReference<UKRPI> ukrpi "UKRPI"  
                let builder (current : ICell) = ((UKRPIModel.Cast _UKRPI.cell).Region
                                                       ) :> ICell
    ...
    let UKRPI_revised
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UKRPI = Helper.toModelReference<UKRPI> ukrpi "UKRPI"  
                let builder (current : ICell) = ((UKRPIModel.Cast _UKRPI.cell).Revised
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let UKRPI_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UKRPI = Helper.toModelReference<UKRPI> ukrpi "UKRPI"  
                let builder (current : ICell) = ((UKRPIModel.Cast _UKRPI.cell).Update
                                                       ) :> ICell
                let format (o : UKRPI) (l:string) = o.ToString() :> obj
    ...
    let UKRPI_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((UKRPIModel.Cast _UKRPI.cell).AddFixings
                                                            _d.cell 
                                                            _v.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
    ...
    let UKRPI_addFixings1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((UKRPIModel.Cast _UKRPI.cell).AddFixings1
                                                            _source.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
                let format (o : UKRPI) (l:string) = o.ToString() :> obj
    ...
    let UKRPI_allowsNativeFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UKRPI = Helper.toModelReference<UKRPI> ukrpi "UKRPI"  
                let builder (current : ICell) = ((UKRPIModel.Cast _UKRPI.cell).AllowsNativeFixings
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let UKRPI_clearFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UKRPI = Helper.toModelReference<UKRPI> ukrpi "UKRPI"  
                let builder (current : ICell) = ((UKRPIModel.Cast _UKRPI.cell).ClearFixings
                                                       ) :> ICell
                let format (o : UKRPI) (l:string) = o.ToString() :> obj
    ...
    let UKRPI_registerWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((UKRPIModel.Cast _UKRPI.cell).RegisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : UKRPI) (l:string) = o.ToString() :> obj
    ...
    let UKRPI_timeSeries
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UKRPI = Helper.toModelReference<UKRPI> ukrpi "UKRPI"  
                let builder (current : ICell) = ((UKRPIModel.Cast _UKRPI.cell).TimeSeries
                                                       ) :> ICell
    ...
    let UKRPI_unregisterWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UKRPI = Helper.toModelReference<UKRPI> ukrpi "UKRPI"  
                let _handler = Helper.toCell<Callback> handler "handler" 
                let builder (current : ICell) = ((UKRPIModel.Cast _UKRPI.cell).UnregisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : UKRPI) (l:string) = o.ToString() :> obj
    ...
    let UKRPI_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<UKRPI> (c)) :> ICell
                let format (i : Cephei.Cell.List<UKRPI>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<UKRPI>(" + (Helper.sourceFoldArray (s) + "))"))
