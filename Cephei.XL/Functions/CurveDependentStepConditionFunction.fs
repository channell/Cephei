    ...
    let CurveDependentStepCondition_applyTo
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CurveDependentStepCondition = Helper.toModelReference<CurveDependentStepCondition> curvedependentstepcondition "CurveDependentStepCondition"  
    ...
    let CurveDependentStepCondition_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<CurveDependentStepCondition> (c)) :> ICell
                let format (i : Cephei.Cell.List<CurveDependentStepCondition>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<CurveDependentStepCondition>(" + (Helper.sourceFoldArray (s) + "))"))
