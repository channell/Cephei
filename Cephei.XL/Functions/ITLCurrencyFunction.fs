    ...
    let ITLCurrency_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.ITLCurrency ()
                                                       ) :> ICell
    ...
    let ITLCurrency_code
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _ITLCurrency = Helper.toModelReference<ITLCurrency> itlcurrency "ITLCurrency"  
                let builder (current : ICell) = ((ITLCurrencyModel.Cast _ITLCurrency.cell).Code
                                                       ) :> ICell
    ...
    let ITLCurrency_empty
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _ITLCurrency = Helper.toModelReference<ITLCurrency> itlcurrency "ITLCurrency"  
                let builder (current : ICell) = ((ITLCurrencyModel.Cast _ITLCurrency.cell).Empty
                                                       ) :> ICell
    ...
    let ITLCurrency_Equals
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((ITLCurrencyModel.Cast _ITLCurrency.cell).Equals
                                                            _o.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let ITLCurrency_format
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _ITLCurrency = Helper.toModelReference<ITLCurrency> itlcurrency "ITLCurrency"  
                let builder (current : ICell) = ((ITLCurrencyModel.Cast _ITLCurrency.cell).Format
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let ITLCurrency_fractionsPerUnit
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _ITLCurrency = Helper.toModelReference<ITLCurrency> itlcurrency "ITLCurrency"  
                let builder (current : ICell) = ((ITLCurrencyModel.Cast _ITLCurrency.cell).FractionsPerUnit
                                                       ) :> ICell
    ...
    let ITLCurrency_fractionSymbol
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _ITLCurrency = Helper.toModelReference<ITLCurrency> itlcurrency "ITLCurrency"  
                let builder (current : ICell) = ((ITLCurrencyModel.Cast _ITLCurrency.cell).FractionSymbol
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let ITLCurrency_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _ITLCurrency = Helper.toModelReference<ITLCurrency> itlcurrency "ITLCurrency"  
                let builder (current : ICell) = ((ITLCurrencyModel.Cast _ITLCurrency.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let ITLCurrency_numericCode
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _ITLCurrency = Helper.toModelReference<ITLCurrency> itlcurrency "ITLCurrency"  
                let builder (current : ICell) = ((ITLCurrencyModel.Cast _ITLCurrency.cell).NumericCode
                                                       ) :> ICell
                let format (o : int) (l:string) = o :> obj
    ...
    let ITLCurrency_rounding
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _ITLCurrency = Helper.toModelReference<ITLCurrency> itlcurrency "ITLCurrency"  
                let builder (current : ICell) = ((ITLCurrencyModel.Cast _ITLCurrency.cell).Rounding
                                                       ) :> ICell
    ...
    let ITLCurrency_symbol
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _ITLCurrency = Helper.toModelReference<ITLCurrency> itlcurrency "ITLCurrency"  
                let builder (current : ICell) = ((ITLCurrencyModel.Cast _ITLCurrency.cell).Symbol
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let ITLCurrency_ToString
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _ITLCurrency = Helper.toModelReference<ITLCurrency> itlcurrency "ITLCurrency"  
                let builder (current : ICell) = ((ITLCurrencyModel.Cast _ITLCurrency.cell).ToString
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let ITLCurrency_triangulationCurrency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _ITLCurrency = Helper.toModelReference<ITLCurrency> itlcurrency "ITLCurrency"  
                let builder (current : ICell) = ((ITLCurrencyModel.Cast _ITLCurrency.cell).TriangulationCurrency
                                                       ) :> ICell
    ...
    let ITLCurrency_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<ITLCurrency> (c)) :> ICell
                let format (i : Cephei.Cell.List<ITLCurrency>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<ITLCurrency>(" + (Helper.sourceFoldArray (s) + "))"))
