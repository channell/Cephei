    ...
    let DiscretizedCallableFixedRateBond_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.DiscretizedCallableFixedRateBond 
                                                            _args.cell 
                                                            _referenceDate.cell 
                                                            _dayCounter.cell 
    ...
    let DiscretizedCallableFixedRateBond_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<DiscretizedCallableFixedRateBond>) (l : string) = Helper.Range.fromModelList i l
