    ...
    let PEHCurrency_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.PEHCurrency ()
                                                       ) :> ICell
    ...
    let PEHCurrency_code
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _PEHCurrency = Helper.toModelReference<PEHCurrency> pehcurrency "PEHCurrency"  
                let builder (current : ICell) = ((PEHCurrencyModel.Cast _PEHCurrency.cell).Code
                                                       ) :> ICell
    ...
    let PEHCurrency_empty
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _PEHCurrency = Helper.toModelReference<PEHCurrency> pehcurrency "PEHCurrency"  
                let builder (current : ICell) = ((PEHCurrencyModel.Cast _PEHCurrency.cell).Empty
                                                       ) :> ICell
    ...
    let PEHCurrency_Equals
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((PEHCurrencyModel.Cast _PEHCurrency.cell).Equals
                                                            _o.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let PEHCurrency_format
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _PEHCurrency = Helper.toModelReference<PEHCurrency> pehcurrency "PEHCurrency"  
                let builder (current : ICell) = ((PEHCurrencyModel.Cast _PEHCurrency.cell).Format
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let PEHCurrency_fractionsPerUnit
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _PEHCurrency = Helper.toModelReference<PEHCurrency> pehcurrency "PEHCurrency"  
                let builder (current : ICell) = ((PEHCurrencyModel.Cast _PEHCurrency.cell).FractionsPerUnit
                                                       ) :> ICell
    ...
    let PEHCurrency_fractionSymbol
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _PEHCurrency = Helper.toModelReference<PEHCurrency> pehcurrency "PEHCurrency"  
                let builder (current : ICell) = ((PEHCurrencyModel.Cast _PEHCurrency.cell).FractionSymbol
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let PEHCurrency_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _PEHCurrency = Helper.toModelReference<PEHCurrency> pehcurrency "PEHCurrency"  
                let builder (current : ICell) = ((PEHCurrencyModel.Cast _PEHCurrency.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let PEHCurrency_numericCode
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _PEHCurrency = Helper.toModelReference<PEHCurrency> pehcurrency "PEHCurrency"  
                let builder (current : ICell) = ((PEHCurrencyModel.Cast _PEHCurrency.cell).NumericCode
                                                       ) :> ICell
                let format (o : int) (l:string) = o :> obj
    ...
    let PEHCurrency_rounding
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _PEHCurrency = Helper.toModelReference<PEHCurrency> pehcurrency "PEHCurrency"  
                let builder (current : ICell) = ((PEHCurrencyModel.Cast _PEHCurrency.cell).Rounding
                                                       ) :> ICell
    ...
    let PEHCurrency_symbol
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _PEHCurrency = Helper.toModelReference<PEHCurrency> pehcurrency "PEHCurrency"  
                let builder (current : ICell) = ((PEHCurrencyModel.Cast _PEHCurrency.cell).Symbol
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let PEHCurrency_ToString
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _PEHCurrency = Helper.toModelReference<PEHCurrency> pehcurrency "PEHCurrency"  
                let builder (current : ICell) = ((PEHCurrencyModel.Cast _PEHCurrency.cell).ToString
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let PEHCurrency_triangulationCurrency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _PEHCurrency = Helper.toModelReference<PEHCurrency> pehcurrency "PEHCurrency"  
                let builder (current : ICell) = ((PEHCurrencyModel.Cast _PEHCurrency.cell).TriangulationCurrency
                                                       ) :> ICell
    ...
    let PEHCurrency_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<PEHCurrency>) (l : string) = Helper.Range.fromModelList i l
