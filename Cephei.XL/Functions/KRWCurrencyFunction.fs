    ...
    let KRWCurrency_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.KRWCurrency ()
                                                       ) :> ICell
    ...
    let KRWCurrency_code
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _KRWCurrency = Helper.toModelReference<KRWCurrency> krwcurrency "KRWCurrency"  
                let builder (current : ICell) = ((KRWCurrencyModel.Cast _KRWCurrency.cell).Code
                                                       ) :> ICell
    ...
    let KRWCurrency_empty
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _KRWCurrency = Helper.toModelReference<KRWCurrency> krwcurrency "KRWCurrency"  
                let builder (current : ICell) = ((KRWCurrencyModel.Cast _KRWCurrency.cell).Empty
                                                       ) :> ICell
    ...
    let KRWCurrency_Equals
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((KRWCurrencyModel.Cast _KRWCurrency.cell).Equals
                                                            _o.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let KRWCurrency_format
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _KRWCurrency = Helper.toModelReference<KRWCurrency> krwcurrency "KRWCurrency"  
                let builder (current : ICell) = ((KRWCurrencyModel.Cast _KRWCurrency.cell).Format
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let KRWCurrency_fractionsPerUnit
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _KRWCurrency = Helper.toModelReference<KRWCurrency> krwcurrency "KRWCurrency"  
                let builder (current : ICell) = ((KRWCurrencyModel.Cast _KRWCurrency.cell).FractionsPerUnit
                                                       ) :> ICell
    ...
    let KRWCurrency_fractionSymbol
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _KRWCurrency = Helper.toModelReference<KRWCurrency> krwcurrency "KRWCurrency"  
                let builder (current : ICell) = ((KRWCurrencyModel.Cast _KRWCurrency.cell).FractionSymbol
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let KRWCurrency_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _KRWCurrency = Helper.toModelReference<KRWCurrency> krwcurrency "KRWCurrency"  
                let builder (current : ICell) = ((KRWCurrencyModel.Cast _KRWCurrency.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let KRWCurrency_numericCode
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _KRWCurrency = Helper.toModelReference<KRWCurrency> krwcurrency "KRWCurrency"  
                let builder (current : ICell) = ((KRWCurrencyModel.Cast _KRWCurrency.cell).NumericCode
                                                       ) :> ICell
                let format (o : int) (l:string) = o :> obj
    ...
    let KRWCurrency_rounding
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _KRWCurrency = Helper.toModelReference<KRWCurrency> krwcurrency "KRWCurrency"  
                let builder (current : ICell) = ((KRWCurrencyModel.Cast _KRWCurrency.cell).Rounding
                                                       ) :> ICell
    ...
    let KRWCurrency_symbol
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _KRWCurrency = Helper.toModelReference<KRWCurrency> krwcurrency "KRWCurrency"  
                let builder (current : ICell) = ((KRWCurrencyModel.Cast _KRWCurrency.cell).Symbol
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let KRWCurrency_ToString
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _KRWCurrency = Helper.toModelReference<KRWCurrency> krwcurrency "KRWCurrency"  
                let builder (current : ICell) = ((KRWCurrencyModel.Cast _KRWCurrency.cell).ToString
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let KRWCurrency_triangulationCurrency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _KRWCurrency = Helper.toModelReference<KRWCurrency> krwcurrency "KRWCurrency"  
                let builder (current : ICell) = ((KRWCurrencyModel.Cast _KRWCurrency.cell).TriangulationCurrency
                                                       ) :> ICell
