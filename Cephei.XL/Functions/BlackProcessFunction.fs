    ...
    let BlackProcess_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.BlackProcess1 
                                                            _x0.cell 
                                                            _riskFreeTS.cell 
                                                            _blackVolTS.cell 
                                                       ) :> ICell
    ...
    let BlackProcess_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.BlackProcess
                                                            _x0.cell 
                                                            _riskFreeTS.cell 
                                                            _blackVolTS.cell 
                                                            _d.cell 
    ...
    let BlackProcess_evolve
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((BlackProcessModel.Cast _BlackProcess.cell).Evolve
                                                            _t0.cell 
                                                            _x0.cell 
                                                            _dt.cell 
                                                            _dw.cell 
    ...
    let BlackProcess_expectation
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _x0 = Helper.toCell<double> x0 "x0" 
                let _dt = Helper.toCell<double> dt "dt" 
                let builder (current : ICell) = ((BlackProcessModel.Cast _BlackProcess.cell).Expectation
                                                            _t0.cell 
                                                            _x0.cell 
                                                            _dt.cell 
                                                       ) :> ICell
    ...
    let BlackProcess_stdDeviation
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _x0 = Helper.toCell<double> x0 "x0" 
                let _dt = Helper.toCell<double> dt "dt" 
                let builder (current : ICell) = ((BlackProcessModel.Cast _BlackProcess.cell).StdDeviation
                                                            _t0.cell 
                                                            _x0.cell 
                                                            _dt.cell 
                                                       ) :> ICell
    ...
    let BlackProcess_variance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _x0 = Helper.toCell<double> x0 "x0" 
                let _dt = Helper.toCell<double> dt "dt" 
                let builder (current : ICell) = ((BlackProcessModel.Cast _BlackProcess.cell).Variance
                                                            _t0.cell 
                                                            _x0.cell 
                                                            _dt.cell 
                                                       ) :> ICell
    ...
    let BlackProcess_covariance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _dt = Helper.toCell<double> dt "dt" 
                let builder (current : ICell) = ((BlackProcessModel.Cast _BlackProcess.cell).Covariance
                                                            _t0.cell 
                                                            _x0.cell 
                                                            _dt.cell 
                                                       ) :> ICell
    ...
    let BlackProcess_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<BlackProcess>) (l : string) = Helper.Range.fromModelList i l
