    ...
    let ForwardMeasureProcess1D_diffusion
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _ForwardMeasureProcess1D = Helper.toModelReference<ForwardMeasureProcess1D> forwardmeasureprocess1d "ForwardMeasureProcess1D"  
    ...
    let ForwardMeasureProcess1D_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<ForwardMeasureProcess1D>) (l : string) = Helper.Range.fromModelList i l
