    ...
    let CappedFlooredIborCoupon_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.CappedFlooredIborCoupon 
    ...
    let CappedFlooredIborCoupon_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _evaluationDate = Helper.toCell<Date> evaluationDate "evaluationDate"
                let builder (current : ICell) = (Fun.CappedFlooredIborCoupon1 
                                                            _paymentDate.cell 
                                                            _nominal.cell 
                                                            _startDate.cell 
                                                            _endDate.cell 
    ...
    let CappedFlooredIborCoupon_factory
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _dayCounter = Helper.toDefault<DayCounter> dayCounter "dayCounter" null
                let _isInArrears = Helper.toDefault<bool> isInArrears "isInArrears" false
                let builder (current : ICell) = ((CappedFlooredIborCouponModel.Cast _CappedFlooredIborCoupon.cell).Factory
                                                            _nominal.cell 
                                                            _paymentDate.cell 
                                                            _startDate.cell 
                                                            _endDate.cell 
    ...
    let CappedFlooredIborCoupon_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<CappedFlooredIborCoupon>) (l : string) = Helper.Range.fromModelList i l
