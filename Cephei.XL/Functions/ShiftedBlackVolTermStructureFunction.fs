    ...
    let ShiftedBlackVolTermStructure_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.ShiftedBlackVolTermStructure 
    ...
    let ShiftedBlackVolTermStructure_blackForwardVariance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((ShiftedBlackVolTermStructureModel.Cast _ShiftedBlackVolTermStructure.cell).BlackForwardVariance
                                                            _time1.cell 
                                                            _time2.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let ShiftedBlackVolTermStructure_blackForwardVariance1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((ShiftedBlackVolTermStructureModel.Cast _ShiftedBlackVolTermStructure.cell).BlackForwardVariance1
                                                            _date1.cell 
                                                            _date2.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let ShiftedBlackVolTermStructure_blackForwardVol1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((ShiftedBlackVolTermStructureModel.Cast _ShiftedBlackVolTermStructure.cell).BlackForwardVol1
                                                            _date1.cell 
                                                            _date2.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let ShiftedBlackVolTermStructure_blackForwardVol
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((ShiftedBlackVolTermStructureModel.Cast _ShiftedBlackVolTermStructure.cell).BlackForwardVol
                                                            _time1.cell 
                                                            _time2.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let ShiftedBlackVolTermStructure_blackVariance1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((ShiftedBlackVolTermStructureModel.Cast _ShiftedBlackVolTermStructure.cell).BlackVariance1
                                                            _maturity.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
                                                       ) :> ICell
    ...
    let ShiftedBlackVolTermStructure_blackVariance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((ShiftedBlackVolTermStructureModel.Cast _ShiftedBlackVolTermStructure.cell).BlackVariance
                                                            _maturity.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
                                                       ) :> ICell
    ...
    let ShiftedBlackVolTermStructure_blackVol
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((ShiftedBlackVolTermStructureModel.Cast _ShiftedBlackVolTermStructure.cell).BlackVol
                                                            _maturity.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
                                                       ) :> ICell
    ...
    let ShiftedBlackVolTermStructure_blackVol1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((ShiftedBlackVolTermStructureModel.Cast _ShiftedBlackVolTermStructure.cell).BlackVol1
                                                            _maturity.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
                                                       ) :> ICell
