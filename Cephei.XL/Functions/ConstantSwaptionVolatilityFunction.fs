    ...
    let ConstantSwaptionVolatility_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.ConstantSwaptionVolatility 
                                                            _referenceDate.cell 
                                                            _cal.cell 
                                                            _bdc.cell 
                                                            _vol.cell 
    ...
    let ConstantSwaptionVolatility_create3
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Type = Helper.toCell<VolatilityType> Type "Type" 
                let _shift = Helper.toNullable<double> shift "shift"
                let builder (current : ICell) = (Fun.ConstantSwaptionVolatility3 
    ...
    let ConstantSwaptionVolatility_create2
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Type = Helper.toCell<VolatilityType> Type "Type" 
                let _shift = Helper.toNullable<double> shift "shift"
                let builder (current : ICell) = (Fun.ConstantSwaptionVolatility2 
                                                            _referenceDate.cell 
                                                            _cal.cell 
                                                            _bdc.cell 
                                                            _vol.cell 
    ...
    let ConstantSwaptionVolatility_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Type = Helper.toCell<VolatilityType> Type "Type" 
                let _shift = Helper.toNullable<double> shift "shift"
                let builder (current : ICell) = (Fun.ConstantSwaptionVolatility1 
                                                            _settlementDays.cell 
                                                            _cal.cell 
                                                            _bdc.cell 
                                                            _vol.cell 
    ...
    let ConstantSwaptionVolatility_blackVariance4
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((ConstantSwaptionVolatilityModel.Cast _ConstantSwaptionVolatility.cell).BlackVariance4
                                                            _optionTime.cell 
                                                            _swapLength.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let ConstantSwaptionVolatility_blackVariance5
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((ConstantSwaptionVolatilityModel.Cast _ConstantSwaptionVolatility.cell).BlackVariance5
                                                            _optionDate.cell 
                                                            _swapLength.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let ConstantSwaptionVolatility_blackVariance3
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((ConstantSwaptionVolatilityModel.Cast _ConstantSwaptionVolatility.cell).BlackVariance3
                                                            _optionTenor.cell 
                                                            _swapLength.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let ConstantSwaptionVolatility_blackVariance2
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((ConstantSwaptionVolatilityModel.Cast _ConstantSwaptionVolatility.cell).BlackVariance2
                                                            _optionTime.cell 
                                                            _swapTenor.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let ConstantSwaptionVolatility_blackVariance1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((ConstantSwaptionVolatilityModel.Cast _ConstantSwaptionVolatility.cell).BlackVariance1
                                                            _optionDate.cell 
                                                            _swapTenor.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let ConstantSwaptionVolatility_blackVariance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((ConstantSwaptionVolatilityModel.Cast _ConstantSwaptionVolatility.cell).BlackVariance
                                                            _optionTenor.cell 
                                                            _swapTenor.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let ConstantSwaptionVolatility_shift4
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _swapTenor = Helper.toCell<Period> swapTenor "swapTenor" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((ConstantSwaptionVolatilityModel.Cast _ConstantSwaptionVolatility.cell).Shift4
                                                            _optionTime.cell 
                                                            _swapTenor.cell 
                                                            _extrapolate.cell 
                                                       ) :> ICell
    ...
    let ConstantSwaptionVolatility_shift5
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _swapTenor = Helper.toCell<Period> swapTenor "swapTenor" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((ConstantSwaptionVolatilityModel.Cast _ConstantSwaptionVolatility.cell).Shift5
                                                            _optionDate.cell 
                                                            _swapTenor.cell 
                                                            _extrapolate.cell 
                                                       ) :> ICell
    ...
    let ConstantSwaptionVolatility_shift1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _swapLength = Helper.toCell<double> swapLength "swapLength" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((ConstantSwaptionVolatilityModel.Cast _ConstantSwaptionVolatility.cell).Shift1
                                                            _optionDate.cell 
                                                            _swapLength.cell 
                                                            _extrapolate.cell 
                                                       ) :> ICell
    ...
    let ConstantSwaptionVolatility_shift
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _swapLength = Helper.toCell<double> swapLength "swapLength" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((ConstantSwaptionVolatilityModel.Cast _ConstantSwaptionVolatility.cell).Shift
                                                            _optionTime.cell 
                                                            _swapLength.cell 
                                                            _extrapolate.cell 
                                                       ) :> ICell
    ...
    let ConstantSwaptionVolatility_shift2
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _swapTenor = Helper.toCell<Period> swapTenor "swapTenor" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((ConstantSwaptionVolatilityModel.Cast _ConstantSwaptionVolatility.cell).Shift2
                                                            _optionTenor.cell 
                                                            _swapTenor.cell 
                                                            _extrapolate.cell 
                                                       ) :> ICell
    ...
    let ConstantSwaptionVolatility_shift3
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _swapLength = Helper.toCell<double> swapLength "swapLength" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((ConstantSwaptionVolatilityModel.Cast _ConstantSwaptionVolatility.cell).Shift3
                                                            _optionTenor.cell 
                                                            _swapLength.cell 
                                                            _extrapolate.cell 
                                                       ) :> ICell
    ...
    let ConstantSwaptionVolatility_smileSection1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((ConstantSwaptionVolatilityModel.Cast _ConstantSwaptionVolatility.cell).SmileSection1
                                                            _optionTenor.cell 
                                                            _swapTenor.cell 
                                                            _extr.cell 
                                                       ) :> ICell
    ...
    let ConstantSwaptionVolatility_smileSection2
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _swapLength = Helper.toCell<double> swapLength "swapLength" 
                let _extr = Helper.toCell<bool> extr "extr" 
                let builder (current : ICell) = ((ConstantSwaptionVolatilityModel.Cast _ConstantSwaptionVolatility.cell).SmileSection2
                                                            _optionTime.cell 
                                                            _swapLength.cell 
                                                            _extr.cell 
                                                       ) :> ICell
    ...
    let ConstantSwaptionVolatility_smileSection
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _swapTenor = Helper.toCell<Period> swapTenor "swapTenor" 
                let _extr = Helper.toCell<bool> extr "extr" 
                let builder (current : ICell) = ((ConstantSwaptionVolatilityModel.Cast _ConstantSwaptionVolatility.cell).SmileSection
                                                            _optionDate.cell 
                                                            _swapTenor.cell 
                                                            _extr.cell 
                                                       ) :> ICell
    ...
    let ConstantSwaptionVolatility_volatility4
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((ConstantSwaptionVolatilityModel.Cast _ConstantSwaptionVolatility.cell).Volatility4
                                                            _optionDate.cell 
                                                            _swapTenor.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let ConstantSwaptionVolatility_volatility2
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((ConstantSwaptionVolatilityModel.Cast _ConstantSwaptionVolatility.cell).Volatility2
                                                            _optionDate.cell 
                                                            _swapLength.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let ConstantSwaptionVolatility_volatility5
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((ConstantSwaptionVolatilityModel.Cast _ConstantSwaptionVolatility.cell).Volatility5
                                                            _optionTenor.cell 
                                                            _swapTenor.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let ConstantSwaptionVolatility_volatility1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((ConstantSwaptionVolatilityModel.Cast _ConstantSwaptionVolatility.cell).Volatility1
                                                            _optionTenor.cell 
                                                            _swapLength.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let ConstantSwaptionVolatility_volatility3
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((ConstantSwaptionVolatilityModel.Cast _ConstantSwaptionVolatility.cell).Volatility3
                                                            _optionTime.cell 
                                                            _swapLength.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let ConstantSwaptionVolatility_volatility
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((ConstantSwaptionVolatilityModel.Cast _ConstantSwaptionVolatility.cell).Volatility
                                                            _optionTime.cell 
                                                            _swapTenor.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
