    ...
    *)
    ...
    let GenericSequenceStatistics_add
        ([<ExcelArgument(Name="Mnemonic",Description = "Identifier for Cell")>] 
         mnemonic : string)
        ([<ExcelArgument(Name="GenericSequenceStatistics",Description = "GenericSequenceStatistics")>] 
    ...
    let GenericSequenceStatistics_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.GenericSequenceStatistics 
                                                            _dimension.cell 
                                                       ) :> ICell
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                Model.specify 
                    ...
                    ; source =  (fun () -> "(new Cephei.Cell.List<GenericSequenceStatistics>(" + (Helper.sourceFoldArray (s) + "))"))
