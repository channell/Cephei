    ...
    let FloatingRateBond_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.FloatingRateBond1 
    ...
    let FloatingRateBond_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _evaluationDate = Helper.toCell<Date> evaluationDate "evaluationDate"  
                let _couponPricer = Helper.toCell<FloatingRateCouponPricer> couponPricer "couponPricer"
                let builder (current : ICell) = (Fun.FloatingRateBond
                                                            _settlementDays.cell 
                                                            _faceAmount.cell 
                                                            _schedule.cell 
                                                            _index.cell 
    ...
    let FloatingRateBond_create2
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _couponPricer = Helper.toCell<FloatingRateCouponPricer> couponPricer "couponPricer"
                let _evaluationDate = Helper.toCell<Date> evaluationDate "evaluationDate"  
                let builder (current : ICell) = (Fun.FloatingRateBond2 
                                                            _settlementDays.cell 
                                                            _faceAmount.cell 
                                                            _schedule.cell 
                                                            _index.cell 
    ...
    let FloatingRateBond_create3
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _couponPricer = Helper.toCell<FloatingRateCouponPricer> couponPricer "couponPricer"
                let _evaluationDate = Helper.toCell<Date> evaluationDate "evaluationDate"  
                let builder (current : ICell) = (Fun.FloatingRateBond3 
                                                            _settlementDays.cell 
                                                            _faceAmount.cell 
                                                            _startDate.cell 
                                                            _maturityDate.cell 
    ...
    let FloatingRateBond_cleanPrice1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _settlement = Helper.toCell<Date> settlement "settlement" 
                let builder (current : ICell) = ((FloatingRateBondModel.Cast _FloatingRateBond.cell).CleanPrice1
                                                            _Yield.cell 
                                                            _dc.cell 
                                                            _comp.cell 
                                                            _freq.cell 
    ...
    let FloatingRateBond_dirtyPrice1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _freq = Helper.toCell<Frequency> freq "freq" 
                let _settlement = Helper.toCell<Date> settlement "settlement" 
                let builder (current : ICell) = ((FloatingRateBondModel.Cast _FloatingRateBond.cell).DirtyPrice1
                                                            _Yield.cell 
                                                            _dc.cell 
                                                            _comp.cell 
                                                            _freq.cell 
    ...
    let FloatingRateBond_yield1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((FloatingRateBondModel.Cast _FloatingRateBond.cell).Yield1
                                                            _cleanPrice.cell 
                                                            _dc.cell 
                                                            _comp.cell 
                                                            _freq.cell 
    ...
    let FloatingRateBond_yield
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _accuracy = Helper.toCell<double> accuracy "accuracy" 
                let _maxEvaluations = Helper.toCell<int> maxEvaluations "maxEvaluations" 
                let builder (current : ICell) = ((FloatingRateBondModel.Cast _FloatingRateBond.cell).Yield
                                                            _dc.cell 
                                                            _comp.cell 
                                                            _freq.cell 
                                                            _accuracy.cell 
    ...
    let FloatingRateBond_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<FloatingRateBond>) (l : string) = Helper.Range.fromModelList i l
