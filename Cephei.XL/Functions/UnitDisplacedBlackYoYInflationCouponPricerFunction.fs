    ...
    let UnitDisplacedBlackYoYInflationCouponPricer_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.UnitDisplacedBlackYoYInflationCouponPricer 
                                                            _capletVol.cell 
    ...
    let UnitDisplacedBlackYoYInflationCouponPricer_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<UnitDisplacedBlackYoYInflationCouponPricer>) (l : string) = Helper.Range.fromModelList i l
