    ...
    let UnitDisplacedBlackYoYInflationCouponPricer_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let l = new Cephei.Cell.List<UnitDisplacedBlackYoYInflationCouponPricer> (c)
                ...
                Model.specify 
                    ...
                    ; source =  (fun () -> "cell Generic.List<UnitDisplacedBlackYoYInflationCouponPricer>(" + (Helper.sourceFoldArray (s) + ")"))
