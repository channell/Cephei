    ...
    let DailyTenorJPYLibor_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.DailyTenorJPYLibor 
    ...
    let DailyTenorJPYLibor_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.DailyTenorJPYLibor1 
                                                            _settlementDays.cell 
                                                            _h.cell 
                                                       ) :> ICell
                let format (i : ICell) (l:string) = Helper.Range.fromModel (i :?> ICell<DailyTenorJPYLibor>) l
    ...
    let DailyTenorJPYLibor_businessDayConvention
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorJPYLibor = Helper.toModelReference<DailyTenorJPYLibor> dailytenorjpylibor "DailyTenorJPYLibor"  
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).BusinessDayConvention
                                                       ) :> ICell
    ...
    let DailyTenorJPYLibor_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).Clone
                                                            _forwarding.cell 
                                                       ) :> ICell
    ...
    let DailyTenorJPYLibor_endOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorJPYLibor = Helper.toModelReference<DailyTenorJPYLibor> dailytenorjpylibor "DailyTenorJPYLibor"  
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).EndOfMonth
                                                       ) :> ICell
    ...
    let DailyTenorJPYLibor_forecastFixing1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).ForecastFixing1
                                                            _d1.cell 
                                                            _d2.cell 
                                                            _t.cell 
                                                       ) :> ICell
    ...
    let DailyTenorJPYLibor_forecastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).ForecastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let DailyTenorJPYLibor_forwardingTermStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorJPYLibor = Helper.toModelReference<DailyTenorJPYLibor> dailytenorjpylibor "DailyTenorJPYLibor"  
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).ForwardingTermStructure
                                                       ) :> ICell
    ...
    let DailyTenorJPYLibor_maturityDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).MaturityDate
                                                            _valueDate.cell 
                                                       ) :> ICell
    ...
    let DailyTenorJPYLibor_currency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorJPYLibor = Helper.toModelReference<DailyTenorJPYLibor> dailytenorjpylibor "DailyTenorJPYLibor"  
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).Currency
                                                       ) :> ICell
    ...
    let DailyTenorJPYLibor_dayCounter
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorJPYLibor = Helper.toModelReference<DailyTenorJPYLibor> dailytenorjpylibor "DailyTenorJPYLibor"  
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).DayCounter
                                                       ) :> ICell
    ...
    let DailyTenorJPYLibor_familyName
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorJPYLibor = Helper.toModelReference<DailyTenorJPYLibor> dailytenorjpylibor "DailyTenorJPYLibor"  
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).FamilyName
                                                       ) :> ICell
    ...
    let DailyTenorJPYLibor_fixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).Fixing
                                                            _fixingDate.cell 
    ...
    let DailyTenorJPYLibor_fixingCalendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorJPYLibor = Helper.toModelReference<DailyTenorJPYLibor> dailytenorjpylibor "DailyTenorJPYLibor"  
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).FixingCalendar
                                                       ) :> ICell
    ...
    let DailyTenorJPYLibor_fixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorJPYLibor = Helper.toModelReference<DailyTenorJPYLibor> dailytenorjpylibor "DailyTenorJPYLibor"  
                let _valueDate = Helper.toCell<Date> valueDate "valueDate" 
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).FixingDate
                                                            _valueDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let DailyTenorJPYLibor_fixingDays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorJPYLibor = Helper.toModelReference<DailyTenorJPYLibor> dailytenorjpylibor "DailyTenorJPYLibor"  
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).FixingDays
                                                       ) :> ICell
    ...
    let DailyTenorJPYLibor_isValidFixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorJPYLibor = Helper.toModelReference<DailyTenorJPYLibor> dailytenorjpylibor "DailyTenorJPYLibor"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).IsValidFixingDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let DailyTenorJPYLibor_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorJPYLibor = Helper.toModelReference<DailyTenorJPYLibor> dailytenorjpylibor "DailyTenorJPYLibor"  
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let DailyTenorJPYLibor_pastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorJPYLibor = Helper.toModelReference<DailyTenorJPYLibor> dailytenorjpylibor "DailyTenorJPYLibor"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).PastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
    ...
    let DailyTenorJPYLibor_tenor
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorJPYLibor = Helper.toModelReference<DailyTenorJPYLibor> dailytenorjpylibor "DailyTenorJPYLibor"  
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).Tenor
                                                       ) :> ICell
    ...
    let DailyTenorJPYLibor_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorJPYLibor = Helper.toModelReference<DailyTenorJPYLibor> dailytenorjpylibor "DailyTenorJPYLibor"  
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).Update
                                                       ) :> ICell
    ...
    let DailyTenorJPYLibor_valueDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorJPYLibor = Helper.toModelReference<DailyTenorJPYLibor> dailytenorjpylibor "DailyTenorJPYLibor"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).ValueDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let DailyTenorJPYLibor_addFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).AddFixing
                                                            _d.cell 
                                                            _v.cell 
    ...
    let DailyTenorJPYLibor_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).AddFixings
                                                            _d.cell 
                                                            _v.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
    ...
    let DailyTenorJPYLibor_addFixings1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).AddFixings1
                                                            _source.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
                let format (o : DailyTenorJPYLibor) (l:string) = o.ToString() :> obj
    ...
    let DailyTenorJPYLibor_allowsNativeFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorJPYLibor = Helper.toModelReference<DailyTenorJPYLibor> dailytenorjpylibor "DailyTenorJPYLibor"  
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).AllowsNativeFixings
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let DailyTenorJPYLibor_clearFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorJPYLibor = Helper.toModelReference<DailyTenorJPYLibor> dailytenorjpylibor "DailyTenorJPYLibor"  
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).ClearFixings
                                                       ) :> ICell
                let format (o : DailyTenorJPYLibor) (l:string) = o.ToString() :> obj
    ...
    let DailyTenorJPYLibor_registerWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).RegisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : DailyTenorJPYLibor) (l:string) = o.ToString() :> obj
    ...
    let DailyTenorJPYLibor_timeSeries
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorJPYLibor = Helper.toModelReference<DailyTenorJPYLibor> dailytenorjpylibor "DailyTenorJPYLibor"  
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).TimeSeries
                                                       ) :> ICell
    ...
    let DailyTenorJPYLibor_unregisterWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DailyTenorJPYLibor = Helper.toModelReference<DailyTenorJPYLibor> dailytenorjpylibor "DailyTenorJPYLibor"  
                let _handler = Helper.toCell<Callback> handler "handler" 
                let builder (current : ICell) = ((DailyTenorJPYLiborModel.Cast _DailyTenorJPYLibor.cell).UnregisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : DailyTenorJPYLibor) (l:string) = o.ToString() :> obj
