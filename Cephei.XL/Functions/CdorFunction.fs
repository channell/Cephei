    ...
    let Cdor_businessDayConvention
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Cdor = Helper.toCell<Cdor> cdor "Cdor" true 
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).BusinessDayConvention
                                                       ) :> ICell
    ...
    let Cdor_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).Clone
                                                            _forwarding.cell 
                                                       ) :> ICell
    ...
    let Cdor_endOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Cdor = Helper.toCell<Cdor> cdor "Cdor" true 
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).EndOfMonth
                                                       ) :> ICell
    ...
    let Cdor_forecastFixing1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).ForecastFixing1
                                                            _d1.cell 
                                                            _d2.cell 
                                                            _t.cell 
                                                       ) :> ICell
    ...
    let Cdor_forecastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).ForecastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let Cdor_forwardingTermStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Cdor = Helper.toCell<Cdor> cdor "Cdor" true 
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).ForwardingTermStructure
                                                       ) :> ICell
    ...
    let Cdor_maturityDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).MaturityDate
                                                            _valueDate.cell 
                                                       ) :> ICell
    ...
    let Cdor_currency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Cdor = Helper.toCell<Cdor> cdor "Cdor" true 
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).Currency
                                                       ) :> ICell
    ...
    let Cdor_dayCounter
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Cdor = Helper.toCell<Cdor> cdor "Cdor" true 
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).DayCounter
                                                       ) :> ICell
    ...
    let Cdor_familyName
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Cdor = Helper.toCell<Cdor> cdor "Cdor" true 
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).FamilyName
                                                       ) :> ICell
    ...
    let Cdor_fixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).Fixing
                                                            _fixingDate.cell 
    ...
    let Cdor_fixingCalendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Cdor = Helper.toCell<Cdor> cdor "Cdor" true 
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).FixingCalendar
                                                       ) :> ICell
    ...
    let Cdor_fixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Cdor = Helper.toCell<Cdor> cdor "Cdor" true 
                let _valueDate = Helper.toCell<Date> valueDate "valueDate" true
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).FixingDate
                                                            _valueDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let Cdor_fixingDays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Cdor = Helper.toCell<Cdor> cdor "Cdor" true 
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).FixingDays
                                                       ) :> ICell
    ...
    let Cdor_isValidFixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Cdor = Helper.toCell<Cdor> cdor "Cdor" true 
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" true
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).IsValidFixingDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Cdor_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Cdor = Helper.toCell<Cdor> cdor "Cdor" true 
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let Cdor_pastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Cdor = Helper.toCell<Cdor> cdor "Cdor" true 
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" true
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).PastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
    ...
    let Cdor_tenor
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Cdor = Helper.toCell<Cdor> cdor "Cdor" true 
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).Tenor
                                                       ) :> ICell
    ...
    let Cdor_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Cdor = Helper.toCell<Cdor> cdor "Cdor" true 
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).Update
                                                       ) :> ICell
    ...
    let Cdor_valueDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Cdor = Helper.toCell<Cdor> cdor "Cdor" true 
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" true
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).ValueDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let Cdor_addFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).AddFixing
                                                            _d.cell 
                                                            _v.cell 
    ...
    let Cdor_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" true
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).AddFixings
                                                            _d.cell 
                                                            _v.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
    ...
    let Cdor_addFixings1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" true
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).AddFixings1
                                                            _source.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
                let format (o : Cdor) (l:string) = o.ToString() :> obj
    ...
    let Cdor_allowsNativeFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Cdor = Helper.toCell<Cdor> cdor "Cdor" true 
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).AllowsNativeFixings
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Cdor_clearFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Cdor = Helper.toCell<Cdor> cdor "Cdor" true 
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).ClearFixings
                                                       ) :> ICell
                let format (o : Cdor) (l:string) = o.ToString() :> obj
    ...
    let Cdor_registerWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).RegisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : Cdor) (l:string) = o.ToString() :> obj
    ...
    let Cdor_timeSeries
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Cdor = Helper.toCell<Cdor> cdor "Cdor" true 
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).TimeSeries
                                                       ) :> ICell
    ...
    let Cdor_unregisterWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Cdor = Helper.toCell<Cdor> cdor "Cdor" true 
                let _handler = Helper.toCell<Callback> handler "handler" true
                let builder () = withMnemonic mnemonic ((_Cdor.cell :?> CdorModel).UnregisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : Cdor) (l:string) = o.ToString() :> obj
    ...
    let Cdor_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<Cdor> i "value" true) |>
                        Seq.toArray
