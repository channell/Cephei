...
module KerkhofSeasonalityFunction =
    ...
    *)
    ...
    let KerkhofSeasonality_create
        ...
        ([<ExcelArgument(Name="seasonalityFactors",Description = "double range")>] 
    ...
    let KerkhofSeasonality_seasonalityFactor
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _KerkhofSeasonality = Helper.toModelReference<KerkhofSeasonality> kerkhofseasonality "KerkhofSeasonality"  
    ...
    let KerkhofSeasonality_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<KerkhofSeasonality> (c)) :> ICell
                let format (i : Cephei.Cell.List<KerkhofSeasonality>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<KerkhofSeasonality>(" + (Helper.sourceFoldArray (s) + "))"))
