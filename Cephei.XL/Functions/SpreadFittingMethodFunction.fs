    ...
    let SpreadFittingMethod_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SpreadFittingMethod = Helper.toModelReference<SpreadFittingMethod> spreadfittingmethod "SpreadFittingMethod"  
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                Model.specify 
                    ...
                    ; source =  (fun () -> "(new Cephei.Cell.List<SpreadFittingMethod>(" + (Helper.sourceFoldArray (s) + "))"))
