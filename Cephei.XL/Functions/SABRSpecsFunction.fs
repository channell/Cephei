    ...
    let SABRSpecs_defaultValues
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((SABRSpecsModel.Cast _SABRSpecs.cell).DefaultValues
                                                            _param.cell 
                                                            _b.cell 
                                                            _forward.cell 
                                                            _expiryTime.cell 
    ...
    let SABRSpecs_direct
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((SABRSpecsModel.Cast _SABRSpecs.cell).Direct
                                                            _x.cell 
                                                            _b.cell 
                                                            _c.cell 
                                                            _d.cell 
    ...
    let SABRSpecs_guess
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _addParams = Helper.toNullabletList<double> addParams "addParams" 
                let builder (current : ICell) = ((SABRSpecsModel.Cast _SABRSpecs.cell).Guess
                                                            _values.cell 
                                                            _paramIsFixed.cell 
                                                            _forward.cell 
                                                            _expiryTime.cell 
    ...
    let SABRSpecs_instance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _param = Helper.toNullabletList<double> param "param" 
                let _addParams = Helper.toNullabletList<double> addParams "addParams" 
                let builder (current : ICell) = ((SABRSpecsModel.Cast _SABRSpecs.cell).Instance
                                                            _t.cell 
                                                            _forward.cell 
                                                            _param.cell 
                                                            _addParams.cell 
    ...
    let SABRSpecs_inverse
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _c = Helper.toNullabletList<double> c "c" 
                let _d = Helper.toCell<double> d "d" 
                let builder (current : ICell) = ((SABRSpecsModel.Cast _SABRSpecs.cell).Inverse
                                                            _y.cell 
                                                            _b.cell 
                                                            _c.cell 
                                                            _d.cell 
    ...
    let SABRSpecs_weight
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _addParams = Helper.toNullabletList<double> addParams "addParams" 
                let builder (current : ICell) = ((SABRSpecsModel.Cast _SABRSpecs.cell).Weight
                                                            _strike.cell 
                                                            _forward.cell 
                                                            _stdDev.cell 
                                                            _addParams.cell 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                Model.specify 
                    ...
                    ; source =  (fun () -> "(new Cephei.Cell.List<SABRSpecs>(" + (Helper.sourceFoldArray (s) + "))"))
