    ...
    let ConstantOptionletVolatility_maxDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _ConstantOptionletVolatility = Helper.toModelReference<ConstantOptionletVolatility> constantoptionletvolatility "ConstantOptionletVolatility"  
    ...
    let ConstantOptionletVolatility_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<ConstantOptionletVolatility> (c)) :> ICell
                let format (i : Cephei.Cell.List<ConstantOptionletVolatility>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<ConstantOptionletVolatility>(" + (Helper.sourceFoldArray (s) + "))"))
