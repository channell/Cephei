...
module MixedLinearKrugerCubicFunction =
    ...
    *)
    [<ExcelFunction(Name="_MixedLinearKrugerCubic", Description="Create a MixedLinearKrugerCubic",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    ...
    *)
    [<ExcelFunction(Name="_MixedLinearKrugerCubic_derivative", Description="Create a MixedLinearKrugerCubic",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let MixedLinearKrugerCubic_derivative
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _MixedLinearKrugerCubic = Helper.toCell<MixedLinearKrugerCubic> mixedlinearkrugercubic "MixedLinearKrugerCubic" true 
    ...
    *)
    [<ExcelFunction(Name="_MixedLinearKrugerCubic_empty", Description="Create a MixedLinearKrugerCubic",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    ...
    *)
    [<ExcelFunction(Name="_MixedLinearKrugerCubic_primitive", Description="Create a MixedLinearKrugerCubic",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    ...
    *)
    [<ExcelFunction(Name="_MixedLinearKrugerCubic_secondDerivative", Description="Create a MixedLinearKrugerCubic",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    ...
    *)
    [<ExcelFunction(Name="_MixedLinearKrugerCubic_update", Description="Create a MixedLinearKrugerCubic",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    ...
    *)
    [<ExcelFunction(Name="_MixedLinearKrugerCubic_value1", Description="Create a MixedLinearKrugerCubic",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    ...
    *)
    [<ExcelFunction(Name="_MixedLinearKrugerCubic_value", Description="Create a MixedLinearKrugerCubic",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    ...
    *)
    [<ExcelFunction(Name="_MixedLinearKrugerCubic_xMax", Description="Create a MixedLinearKrugerCubic",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    ...
    *)
    [<ExcelFunction(Name="_MixedLinearKrugerCubic_xMin", Description="Create a MixedLinearKrugerCubic",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    ...
    *)
    [<ExcelFunction(Name="_MixedLinearKrugerCubic_allowsExtrapolation", Description="Create a MixedLinearKrugerCubic",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    ...
    *)
    [<ExcelFunction(Name="_MixedLinearKrugerCubic_disableExtrapolation", Description="Create a MixedLinearKrugerCubic",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    ...
    *)
    [<ExcelFunction(Name="_MixedLinearKrugerCubic_enableExtrapolation", Description="Create a MixedLinearKrugerCubic",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    ...
    *)
    [<ExcelFunction(Name="_MixedLinearKrugerCubic_extrapolate", Description="Create a MixedLinearKrugerCubic",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let MixedLinearKrugerCubic_extrapolate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            "<WIZ>"
    [<ExcelFunction(Name="_MixedLinearKrugerCubic_Range", Description="Create a range of MixedLinearKrugerCubic",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let MixedLinearKrugerCubic_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<MixedLinearKrugerCubic> i "value" true) |>
                        Seq.toArray
