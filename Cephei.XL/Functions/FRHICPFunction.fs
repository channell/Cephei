    ...
    let FRHICP_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.FRHICP 
                                                            _interpolated.cell 
                                                            _ts.cell 
                                                       ) :> ICell
    ...
    let FRHICP_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _interpolated = Helper.toCell<bool> interpolated "interpolated" 
                let builder (current : ICell) = (Fun.FRHICP1 
                                                            _interpolated.cell 
                                                       ) :> ICell
                let format (i : ICell) (l:string) = Helper.Range.fromModel (i :?> ICell<FRHICP>) l
    ...
    let FRHICP_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _FRHICP = Helper.toModelReference<FRHICP> frhicp "FRHICP"  
                let _h = Helper.toHandle<ZeroInflationTermStructure> h "h" 
                let builder (current : ICell) = ((FRHICPModel.Cast _FRHICP.cell).Clone
                                                            _h.cell 
                                                       ) :> ICell
    ...
    let FRHICP_fixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((FRHICPModel.Cast _FRHICP.cell).Fixing
                                                            _aFixingDate.cell 
    ...
    let FRHICP_zeroInflationTermStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _FRHICP = Helper.toModelReference<FRHICP> frhicp "FRHICP"  
                let builder (current : ICell) = ((FRHICPModel.Cast _FRHICP.cell).ZeroInflationTermStructure
                                                       ) :> ICell
    ...
    let FRHICP_addFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((FRHICPModel.Cast _FRHICP.cell).AddFixing
                                                            _fixingDate.cell 
                                                            _fixing.cell 
    ...
    let FRHICP_availabilityLag
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _FRHICP = Helper.toModelReference<FRHICP> frhicp "FRHICP"  
                let builder (current : ICell) = ((FRHICPModel.Cast _FRHICP.cell).AvailabilityLag
                                                       ) :> ICell
    ...
    let FRHICP_currency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _FRHICP = Helper.toModelReference<FRHICP> frhicp "FRHICP"  
                let builder (current : ICell) = ((FRHICPModel.Cast _FRHICP.cell).Currency
                                                       ) :> ICell
    ...
    let FRHICP_familyName
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _FRHICP = Helper.toModelReference<FRHICP> frhicp "FRHICP"  
                let builder (current : ICell) = ((FRHICPModel.Cast _FRHICP.cell).FamilyName
                                                       ) :> ICell
    ...
    let FRHICP_fixingCalendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _FRHICP = Helper.toModelReference<FRHICP> frhicp "FRHICP"  
                let builder (current : ICell) = ((FRHICPModel.Cast _FRHICP.cell).FixingCalendar
                                                       ) :> ICell
    ...
    let FRHICP_frequency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _FRHICP = Helper.toModelReference<FRHICP> frhicp "FRHICP"  
                let builder (current : ICell) = ((FRHICPModel.Cast _FRHICP.cell).Frequency
                                                       ) :> ICell
    ...
    let FRHICP_interpolated
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _FRHICP = Helper.toModelReference<FRHICP> frhicp "FRHICP"  
                let builder (current : ICell) = ((FRHICPModel.Cast _FRHICP.cell).Interpolated
                                                       ) :> ICell
    ...
    let FRHICP_isValidFixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _FRHICP = Helper.toModelReference<FRHICP> frhicp "FRHICP"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((FRHICPModel.Cast _FRHICP.cell).IsValidFixingDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let FRHICP_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _FRHICP = Helper.toModelReference<FRHICP> frhicp "FRHICP"  
                let builder (current : ICell) = ((FRHICPModel.Cast _FRHICP.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let FRHICP_region
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _FRHICP = Helper.toModelReference<FRHICP> frhicp "FRHICP"  
                let builder (current : ICell) = ((FRHICPModel.Cast _FRHICP.cell).Region
                                                       ) :> ICell
    ...
    let FRHICP_revised
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _FRHICP = Helper.toModelReference<FRHICP> frhicp "FRHICP"  
                let builder (current : ICell) = ((FRHICPModel.Cast _FRHICP.cell).Revised
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let FRHICP_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _FRHICP = Helper.toModelReference<FRHICP> frhicp "FRHICP"  
                let builder (current : ICell) = ((FRHICPModel.Cast _FRHICP.cell).Update
                                                       ) :> ICell
                let format (o : FRHICP) (l:string) = o.ToString() :> obj
    ...
    let FRHICP_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((FRHICPModel.Cast _FRHICP.cell).AddFixings
                                                            _d.cell 
                                                            _v.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
    ...
    let FRHICP_addFixings1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((FRHICPModel.Cast _FRHICP.cell).AddFixings1
                                                            _source.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
                let format (o : FRHICP) (l:string) = o.ToString() :> obj
    ...
    let FRHICP_allowsNativeFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _FRHICP = Helper.toModelReference<FRHICP> frhicp "FRHICP"  
                let builder (current : ICell) = ((FRHICPModel.Cast _FRHICP.cell).AllowsNativeFixings
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let FRHICP_clearFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _FRHICP = Helper.toModelReference<FRHICP> frhicp "FRHICP"  
                let builder (current : ICell) = ((FRHICPModel.Cast _FRHICP.cell).ClearFixings
                                                       ) :> ICell
                let format (o : FRHICP) (l:string) = o.ToString() :> obj
    ...
    let FRHICP_registerWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((FRHICPModel.Cast _FRHICP.cell).RegisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : FRHICP) (l:string) = o.ToString() :> obj
    ...
    let FRHICP_timeSeries
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _FRHICP = Helper.toModelReference<FRHICP> frhicp "FRHICP"  
                let builder (current : ICell) = ((FRHICPModel.Cast _FRHICP.cell).TimeSeries
                                                       ) :> ICell
    ...
    let FRHICP_unregisterWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _FRHICP = Helper.toModelReference<FRHICP> frhicp "FRHICP"  
                let _handler = Helper.toCell<Callback> handler "handler" 
                let builder (current : ICell) = ((FRHICPModel.Cast _FRHICP.cell).UnregisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : FRHICP) (l:string) = o.ToString() :> obj
