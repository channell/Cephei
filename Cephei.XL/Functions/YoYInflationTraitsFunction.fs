    ...
    let YoYInflationTraits_guess
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((YoYInflationTraitsModel.Cast _YoYInflationTraits.cell).Guess
                                                            _i.cell 
                                                            _c.cell 
                                                            _validData.cell 
                                                            _f.cell 
    ...
    let YoYInflationTraits_maxValueAfter
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _validData = Helper.toCell<bool> validData "validData" 
                let _f = Helper.toCell<int> f "f" 
                let builder (current : ICell) = ((YoYInflationTraitsModel.Cast _YoYInflationTraits.cell).MaxValueAfter
                                                            _i.cell 
                                                            _c.cell 
                                                            _validData.cell 
                                                            _f.cell 
    ...
    let YoYInflationTraits_minValueAfter
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _validData = Helper.toCell<bool> validData "validData" 
                let _f = Helper.toCell<int> f "f" 
                let builder (current : ICell) = ((YoYInflationTraitsModel.Cast _YoYInflationTraits.cell).MinValueAfter
                                                            _i.cell 
                                                            _c.cell 
                                                            _validData.cell 
                                                            _f.cell 
    ...
    let YoYInflationTraits_updateGuess
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _i = Helper.toCell<int> i "i" 
                let builder (current : ICell) = ((YoYInflationTraitsModel.Cast _YoYInflationTraits.cell).UpdateGuess
                                                            _data.cell 
                                                            _discount.cell 
                                                            _i.cell 
                                                       ) :> ICell
    ...
    let YoYInflationTraits_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<YoYInflationTraits> (c)) :> ICell
                let format (i : Cephei.Cell.List<YoYInflationTraits>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<YoYInflationTraits>(" + (Helper.sourceFoldArray (s) + "))"))
