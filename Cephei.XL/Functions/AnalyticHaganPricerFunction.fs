    ...
    let AnalyticHaganPricer_swapletPrice
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _AnalyticHaganPricer = Helper.toModelReference<AnalyticHaganPricer> analytichaganpricer "AnalyticHaganPricer"  
    ...
    let AnalyticHaganPricer_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<AnalyticHaganPricer>) (l : string) = Helper.Range.fromModelList i l
