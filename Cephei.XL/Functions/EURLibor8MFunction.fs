    ...
    let EURLibor8M_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.EURLibor8M1 ()
                                                       ) :> ICell
    ...
    let EURLibor8M_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.EURLibor8M
                                                            _h.cell 
                                                       ) :> ICell
                let format (i : ICell) (l:string) = Helper.Range.fromModel (i :?> ICell<EURLibor8M>) l
    ...
    let EURLibor8M_maturityDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor8M = Helper.toModelReference<EURLibor8M> eurlibor8m "EURLibor8M"  
                let _valueDate = Helper.toCell<Date> valueDate "valueDate" 
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).MaturityDate
                                                            _valueDate.cell 
                                                       ) :> ICell
    ...
    let EURLibor8M_valueDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).ValueDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let EURLibor8M_businessDayConvention
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor8M = Helper.toModelReference<EURLibor8M> eurlibor8m "EURLibor8M"  
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).BusinessDayConvention
                                                       ) :> ICell
    ...
    let EURLibor8M_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).Clone
                                                            _forwarding.cell 
                                                       ) :> ICell
    ...
    let EURLibor8M_endOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor8M = Helper.toModelReference<EURLibor8M> eurlibor8m "EURLibor8M"  
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).EndOfMonth
                                                       ) :> ICell
    ...
    let EURLibor8M_forecastFixing1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).ForecastFixing1
                                                            _d1.cell 
                                                            _d2.cell 
                                                            _t.cell 
                                                       ) :> ICell
    ...
    let EURLibor8M_forecastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor8M = Helper.toModelReference<EURLibor8M> eurlibor8m "EURLibor8M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).ForecastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let EURLibor8M_forwardingTermStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor8M = Helper.toModelReference<EURLibor8M> eurlibor8m "EURLibor8M"  
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).ForwardingTermStructure
                                                       ) :> ICell
    ...
    let EURLibor8M_currency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor8M = Helper.toModelReference<EURLibor8M> eurlibor8m "EURLibor8M"  
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).Currency
                                                       ) :> ICell
    ...
    let EURLibor8M_dayCounter
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor8M = Helper.toModelReference<EURLibor8M> eurlibor8m "EURLibor8M"  
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).DayCounter
                                                       ) :> ICell
    ...
    let EURLibor8M_familyName
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor8M = Helper.toModelReference<EURLibor8M> eurlibor8m "EURLibor8M"  
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).FamilyName
                                                       ) :> ICell
    ...
    let EURLibor8M_fixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).Fixing
                                                            _fixingDate.cell 
    ...
    let EURLibor8M_fixingCalendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor8M = Helper.toModelReference<EURLibor8M> eurlibor8m "EURLibor8M"  
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).FixingCalendar
                                                       ) :> ICell
    ...
    let EURLibor8M_fixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor8M = Helper.toModelReference<EURLibor8M> eurlibor8m "EURLibor8M"  
                let _valueDate = Helper.toCell<Date> valueDate "valueDate" 
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).FixingDate
                                                            _valueDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let EURLibor8M_fixingDays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor8M = Helper.toModelReference<EURLibor8M> eurlibor8m "EURLibor8M"  
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).FixingDays
                                                       ) :> ICell
    ...
    let EURLibor8M_isValidFixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor8M = Helper.toModelReference<EURLibor8M> eurlibor8m "EURLibor8M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).IsValidFixingDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let EURLibor8M_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor8M = Helper.toModelReference<EURLibor8M> eurlibor8m "EURLibor8M"  
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let EURLibor8M_pastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor8M = Helper.toModelReference<EURLibor8M> eurlibor8m "EURLibor8M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).PastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
    ...
    let EURLibor8M_tenor
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor8M = Helper.toModelReference<EURLibor8M> eurlibor8m "EURLibor8M"  
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).Tenor
                                                       ) :> ICell
    ...
    let EURLibor8M_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor8M = Helper.toModelReference<EURLibor8M> eurlibor8m "EURLibor8M"  
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).Update
                                                       ) :> ICell
    ...
    let EURLibor8M_addFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).AddFixing
                                                            _d.cell 
                                                            _v.cell 
    ...
    let EURLibor8M_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).AddFixings
                                                            _d.cell 
                                                            _v.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
    ...
    let EURLibor8M_addFixings1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).AddFixings1
                                                            _source.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
                let format (o : EURLibor8M) (l:string) = o.ToString() :> obj
    ...
    let EURLibor8M_allowsNativeFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor8M = Helper.toModelReference<EURLibor8M> eurlibor8m "EURLibor8M"  
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).AllowsNativeFixings
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let EURLibor8M_clearFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor8M = Helper.toModelReference<EURLibor8M> eurlibor8m "EURLibor8M"  
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).ClearFixings
                                                       ) :> ICell
                let format (o : EURLibor8M) (l:string) = o.ToString() :> obj
    ...
    let EURLibor8M_registerWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).RegisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : EURLibor8M) (l:string) = o.ToString() :> obj
    ...
    let EURLibor8M_timeSeries
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor8M = Helper.toModelReference<EURLibor8M> eurlibor8m "EURLibor8M"  
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).TimeSeries
                                                       ) :> ICell
    ...
    let EURLibor8M_unregisterWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor8M = Helper.toModelReference<EURLibor8M> eurlibor8m "EURLibor8M"  
                let _handler = Helper.toCell<Callback> handler "handler" 
                let builder (current : ICell) = ((EURLibor8MModel.Cast _EURLibor8M.cell).UnregisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : EURLibor8M) (l:string) = o.ToString() :> obj
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                Model.specify 
                    ...
                    ; source =  (fun () -> "(new Cephei.Cell.List<EURLibor8M>(" + (Helper.sourceFoldArray (s) + "))"))
