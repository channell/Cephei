    ...
    let ForwardVanillaOption_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _resetDate = Helper.toCell<Date> resetDate "resetDate" true
    ...
    let ForwardVanillaOption_delta
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _ForwardVanillaOption = Helper.toCell<ForwardVanillaOption> forwardvanillaoption "ForwardVanillaOption" true 
    ...
    let ForwardVanillaOption_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<ForwardVanillaOption> i "value" true) |>
                        Seq.toArray
