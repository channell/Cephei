    ...
    let DiscrepancyStatistics_add
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let _Begin = Helper.toCell<Generic.List<double>> Begin "Begin" 
                let _weight = Helper.toCell<double> weight "weight" 
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).Add
                                                            _Begin.cell 
                                                            _weight.cell 
                                                       ) :> ICell
    ...
    let DiscrepancyStatistics_add
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let _Begin = Helper.toCell<Generic.List<double>> Begin "Begin" 
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).Add1
                                                            _Begin.cell 
                                                       ) :> ICell
                let format (o : DiscrepancyStatistics) (l:string) = o.ToString() :> obj
    ...
    let DiscrepancyStatistics_discrepancy
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).Discrepancy
                                                       ) :> ICell
    ...
    let DiscrepancyStatistics_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.DiscrepancyStatistics 
                                                            _dimension.cell 
                                                       ) :> ICell
    ...
    let DiscrepancyStatistics_reset
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let _dimension = Helper.toCell<int> dimension "dimension" 
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).Reset
                                                            _dimension.cell 
                                                       ) :> ICell
                let format (o : DiscrepancyStatistics) (l:string) = o.ToString() :> obj
    ...
    let DiscrepancyStatistics_averageShortfall
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).AverageShortfall
                                                            _x.cell 
                                                       ) :> ICell
    ...
    let DiscrepancyStatistics_correlation
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).Correlation
                                                       ) :> ICell
    ...
    let DiscrepancyStatistics_covariance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).Covariance
                                                       ) :> ICell
                let format (i : ICell) (l:string) = Helper.Range.fromModel (i :?> ICell<Matrix>) l
    ...
    let DiscrepancyStatistics_downsideDeviation
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).DownsideDeviation
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let DiscrepancyStatistics_downsideVariance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).DownsideVariance
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let DiscrepancyStatistics_errorEstimate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).ErrorEstimate
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let DiscrepancyStatistics_expectedShortfall
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let _x = Helper.toCell<double> x "x" 
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).ExpectedShortfall
                                                            _x.cell 
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let DiscrepancyStatistics_gaussianAverageShortfall
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let _x = Helper.toCell<double> x "x" 
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).GaussianAverageShortfall
                                                            _x.cell 
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let DiscrepancyStatistics_gaussianExpectedShortfall
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let _x = Helper.toCell<double> x "x" 
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).GaussianExpectedShortfall
                                                            _x.cell 
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let DiscrepancyStatistics_gaussianPercentile
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let _x = Helper.toCell<double> x "x" 
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).GaussianPercentile
                                                            _x.cell 
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let DiscrepancyStatistics_gaussianPotentialUpside
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let _x = Helper.toCell<double> x "x" 
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).GaussianPotentialUpside
                                                            _x.cell 
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let DiscrepancyStatistics_gaussianShortfall
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let _x = Helper.toCell<double> x "x" 
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).GaussianShortfall
                                                            _x.cell 
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let DiscrepancyStatistics_gaussianValueAtRisk
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let _x = Helper.toCell<double> x "x" 
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).GaussianValueAtRisk
                                                            _x.cell 
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let DiscrepancyStatistics_kurtosis
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).Kurtosis
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let DiscrepancyStatistics_max
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).Max
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let DiscrepancyStatistics_mean
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).Mean
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let DiscrepancyStatistics_min
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).Min
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let DiscrepancyStatistics_percentile
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let _x = Helper.toCell<double> x "x" 
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).Percentile
                                                            _x.cell 
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let DiscrepancyStatistics_potentialUpside
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let _x = Helper.toCell<double> x "x" 
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).PotentialUpside
                                                            _x.cell 
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let DiscrepancyStatistics_regret
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let _x = Helper.toCell<double> x "x" 
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).Regret
                                                            _x.cell 
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let DiscrepancyStatistics_samples
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).Samples
                                                       ) :> ICell
    ...
    let DiscrepancyStatistics_semiDeviation
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).SemiDeviation
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let DiscrepancyStatistics_semiVariance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).SemiVariance
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let DiscrepancyStatistics_shortfall
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let _x = Helper.toCell<double> x "x" 
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).Shortfall
                                                            _x.cell 
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let DiscrepancyStatistics_size
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).Size
                                                       ) :> ICell
                let format (o : int) (l:string) = o :> obj
    ...
    let DiscrepancyStatistics_skewness
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).Skewness
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let DiscrepancyStatistics_standardDeviation
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).StandardDeviation
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let DiscrepancyStatistics_valueAtRisk
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let _x = Helper.toCell<double> x "x" 
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).ValueAtRisk
                                                            _x.cell 
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let DiscrepancyStatistics_variance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).Variance
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let DiscrepancyStatistics_weightSum
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _DiscrepancyStatistics = Helper.toModelReference<DiscrepancyStatistics> discrepancystatistics "DiscrepancyStatistics"  
                let builder (current : ICell) = ((DiscrepancyStatisticsModel.Cast _DiscrepancyStatistics.cell).WeightSum
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let DiscrepancyStatistics_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<DiscrepancyStatistics>) (l : string) = Helper.Range.fromModelList i l
