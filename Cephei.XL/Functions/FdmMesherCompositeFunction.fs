    ...
    let FdmMesherComposite_dminus
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _FdmMesherComposite = Helper.toModelReference<FdmMesherComposite> fdmmeshercomposite "FdmMesherComposite"  
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                Model.specify 
                    ...
                    ; source =  (fun () -> "(new Cephei.Cell.List<FdmMesherComposite>(" + (Helper.sourceFoldArray (s) + "))"))
