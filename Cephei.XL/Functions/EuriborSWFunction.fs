    ...
    let EuriborSW_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.EuriborSW1 ()
                                                       ) :> ICell
    ...
    let EuriborSW_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.EuriborSW
                                                            _h.cell 
                                                       ) :> ICell
                let format (i : ICell) (l:string) = Helper.Range.fromModel (i :?> ICell<EuriborSW>) l
    ...
    let EuriborSW_businessDayConvention
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EuriborSW = Helper.toModelReference<EuriborSW> euriborsw "EuriborSW"  
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).BusinessDayConvention
                                                       ) :> ICell
    ...
    let EuriborSW_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).Clone
                                                            _forwarding.cell 
                                                       ) :> ICell
    ...
    let EuriborSW_endOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EuriborSW = Helper.toModelReference<EuriborSW> euriborsw "EuriborSW"  
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).EndOfMonth
                                                       ) :> ICell
    ...
    let EuriborSW_forecastFixing1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).ForecastFixing1
                                                            _d1.cell 
                                                            _d2.cell 
                                                            _t.cell 
                                                       ) :> ICell
    ...
    let EuriborSW_forecastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).ForecastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let EuriborSW_forwardingTermStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EuriborSW = Helper.toModelReference<EuriborSW> euriborsw "EuriborSW"  
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).ForwardingTermStructure
                                                       ) :> ICell
    ...
    let EuriborSW_maturityDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).MaturityDate
                                                            _valueDate.cell 
                                                       ) :> ICell
    ...
    let EuriborSW_currency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EuriborSW = Helper.toModelReference<EuriborSW> euriborsw "EuriborSW"  
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).Currency
                                                       ) :> ICell
    ...
    let EuriborSW_dayCounter
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EuriborSW = Helper.toModelReference<EuriborSW> euriborsw "EuriborSW"  
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).DayCounter
                                                       ) :> ICell
    ...
    let EuriborSW_familyName
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EuriborSW = Helper.toModelReference<EuriborSW> euriborsw "EuriborSW"  
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).FamilyName
                                                       ) :> ICell
    ...
    let EuriborSW_fixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).Fixing
                                                            _fixingDate.cell 
    ...
    let EuriborSW_fixingCalendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EuriborSW = Helper.toModelReference<EuriborSW> euriborsw "EuriborSW"  
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).FixingCalendar
                                                       ) :> ICell
    ...
    let EuriborSW_fixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EuriborSW = Helper.toModelReference<EuriborSW> euriborsw "EuriborSW"  
                let _valueDate = Helper.toCell<Date> valueDate "valueDate" 
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).FixingDate
                                                            _valueDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let EuriborSW_fixingDays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EuriborSW = Helper.toModelReference<EuriborSW> euriborsw "EuriborSW"  
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).FixingDays
                                                       ) :> ICell
    ...
    let EuriborSW_isValidFixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EuriborSW = Helper.toModelReference<EuriborSW> euriborsw "EuriborSW"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).IsValidFixingDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let EuriborSW_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EuriborSW = Helper.toModelReference<EuriborSW> euriborsw "EuriborSW"  
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let EuriborSW_pastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EuriborSW = Helper.toModelReference<EuriborSW> euriborsw "EuriborSW"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).PastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
    ...
    let EuriborSW_tenor
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EuriborSW = Helper.toModelReference<EuriborSW> euriborsw "EuriborSW"  
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).Tenor
                                                       ) :> ICell
    ...
    let EuriborSW_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EuriborSW = Helper.toModelReference<EuriborSW> euriborsw "EuriborSW"  
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).Update
                                                       ) :> ICell
    ...
    let EuriborSW_valueDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EuriborSW = Helper.toModelReference<EuriborSW> euriborsw "EuriborSW"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).ValueDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let EuriborSW_addFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).AddFixing
                                                            _d.cell 
                                                            _v.cell 
    ...
    let EuriborSW_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).AddFixings
                                                            _d.cell 
                                                            _v.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
    ...
    let EuriborSW_addFixings1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).AddFixings1
                                                            _source.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
                let format (o : EuriborSW) (l:string) = o.ToString() :> obj
    ...
    let EuriborSW_allowsNativeFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EuriborSW = Helper.toModelReference<EuriborSW> euriborsw "EuriborSW"  
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).AllowsNativeFixings
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let EuriborSW_clearFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EuriborSW = Helper.toModelReference<EuriborSW> euriborsw "EuriborSW"  
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).ClearFixings
                                                       ) :> ICell
                let format (o : EuriborSW) (l:string) = o.ToString() :> obj
    ...
    let EuriborSW_registerWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).RegisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : EuriborSW) (l:string) = o.ToString() :> obj
    ...
    let EuriborSW_timeSeries
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EuriborSW = Helper.toModelReference<EuriborSW> euriborsw "EuriborSW"  
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).TimeSeries
                                                       ) :> ICell
    ...
    let EuriborSW_unregisterWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EuriborSW = Helper.toModelReference<EuriborSW> euriborsw "EuriborSW"  
                let _handler = Helper.toCell<Callback> handler "handler" 
                let builder (current : ICell) = ((EuriborSWModel.Cast _EuriborSW.cell).UnregisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : EuriborSW) (l:string) = o.ToString() :> obj
    ...
    let EuriborSW_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<EuriborSW>) (l : string) = Helper.Range.fromModelList i l
