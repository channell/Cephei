    ...
    let XABRCoeffHolder_addParams_
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _XABRCoeffHolder = Helper.toModelReference<XABRCoeffHolder> xabrcoeffholder "XABRCoeffHolder"  
    ...
    let XABRCoeffHolder_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<XABRCoeffHolder>) (l : string) = Helper.Range.fromModelList i l
