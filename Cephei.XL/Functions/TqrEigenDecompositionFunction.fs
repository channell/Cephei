    ...
    let TqrEigenDecomposition_eigenvalues
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TqrEigenDecomposition = Helper.toCell<TqrEigenDecomposition> tqreigendecomposition "TqrEigenDecomposition" true 
    ...
    let TqrEigenDecomposition_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _diag = Helper.toCell<Vector> diag "diag" true
                let _sub = Helper.toCell<Vector> sub "sub" true
                let _calc = Helper.toCell<TqrEigenDecomposition.EigenVectorCalculation> calc "calc" true
                let _strategy = Helper.toCell<TqrEigenDecomposition.ShiftStrategy> strategy "strategy" true
    ...
    let TqrEigenDecomposition_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<TqrEigenDecomposition> i "value" true) |>
                        Seq.toArray
