    ...
    let TRLCurrency_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.TRLCurrency ()
                                                       ) :> ICell
    ...
    let TRLCurrency_code
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TRLCurrency = Helper.toModelReference<TRLCurrency> trlcurrency "TRLCurrency"  
                let builder (current : ICell) = ((TRLCurrencyModel.Cast _TRLCurrency.cell).Code
                                                       ) :> ICell
    ...
    let TRLCurrency_empty
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TRLCurrency = Helper.toModelReference<TRLCurrency> trlcurrency "TRLCurrency"  
                let builder (current : ICell) = ((TRLCurrencyModel.Cast _TRLCurrency.cell).Empty
                                                       ) :> ICell
    ...
    let TRLCurrency_Equals
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((TRLCurrencyModel.Cast _TRLCurrency.cell).Equals
                                                            _o.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let TRLCurrency_format
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TRLCurrency = Helper.toModelReference<TRLCurrency> trlcurrency "TRLCurrency"  
                let builder (current : ICell) = ((TRLCurrencyModel.Cast _TRLCurrency.cell).Format
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let TRLCurrency_fractionsPerUnit
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TRLCurrency = Helper.toModelReference<TRLCurrency> trlcurrency "TRLCurrency"  
                let builder (current : ICell) = ((TRLCurrencyModel.Cast _TRLCurrency.cell).FractionsPerUnit
                                                       ) :> ICell
    ...
    let TRLCurrency_fractionSymbol
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TRLCurrency = Helper.toModelReference<TRLCurrency> trlcurrency "TRLCurrency"  
                let builder (current : ICell) = ((TRLCurrencyModel.Cast _TRLCurrency.cell).FractionSymbol
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let TRLCurrency_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TRLCurrency = Helper.toModelReference<TRLCurrency> trlcurrency "TRLCurrency"  
                let builder (current : ICell) = ((TRLCurrencyModel.Cast _TRLCurrency.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let TRLCurrency_numericCode
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TRLCurrency = Helper.toModelReference<TRLCurrency> trlcurrency "TRLCurrency"  
                let builder (current : ICell) = ((TRLCurrencyModel.Cast _TRLCurrency.cell).NumericCode
                                                       ) :> ICell
                let format (o : int) (l:string) = o :> obj
    ...
    let TRLCurrency_rounding
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TRLCurrency = Helper.toModelReference<TRLCurrency> trlcurrency "TRLCurrency"  
                let builder (current : ICell) = ((TRLCurrencyModel.Cast _TRLCurrency.cell).Rounding
                                                       ) :> ICell
    ...
    let TRLCurrency_symbol
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TRLCurrency = Helper.toModelReference<TRLCurrency> trlcurrency "TRLCurrency"  
                let builder (current : ICell) = ((TRLCurrencyModel.Cast _TRLCurrency.cell).Symbol
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let TRLCurrency_ToString
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TRLCurrency = Helper.toModelReference<TRLCurrency> trlcurrency "TRLCurrency"  
                let builder (current : ICell) = ((TRLCurrencyModel.Cast _TRLCurrency.cell).ToString
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let TRLCurrency_triangulationCurrency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TRLCurrency = Helper.toModelReference<TRLCurrency> trlcurrency "TRLCurrency"  
                let builder (current : ICell) = ((TRLCurrencyModel.Cast _TRLCurrency.cell).TriangulationCurrency
                                                       ) :> ICell
    ...
    let TRLCurrency_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<TRLCurrency> (c)) :> ICell
                let format (i : Cephei.Cell.List<TRLCurrency>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<TRLCurrency>(" + (Helper.sourceFoldArray (s) + "))"))
