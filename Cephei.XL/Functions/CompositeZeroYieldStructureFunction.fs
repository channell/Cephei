    ...
    let CompositeZeroYieldStructure_calendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CompositeZeroYieldStructure = Helper.toModelReference<CompositeZeroYieldStructure> compositezeroyieldstructure "CompositeZeroYieldStructure"  
    ...
    let CompositeZeroYieldStructure_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<CompositeZeroYieldStructure> (c)) :> ICell
                let format (i : Cephei.Cell.List<CompositeZeroYieldStructure>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<CompositeZeroYieldStructure>(" + (Helper.sourceFoldArray (s) + "))"))
