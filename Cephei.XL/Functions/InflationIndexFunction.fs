    ...
    let InflationIndex_addFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _InflationIndex = Helper.toCell<InflationIndex> inflationindex "InflationIndex" true 
    ...
    let InflationIndex_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _availabilitiyLag = Helper.toCell<Period> availabilitiyLag "availabilitiyLag" true
    ...
    let InflationIndex_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<InflationIndex> i "value" true) |>
                        Seq.toArray
