    ...
    let Trigeorgis_factory
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Trigeorgis = Helper.toModelReference<Trigeorgis> trigeorgis "Trigeorgis"  
                let _Process = Helper.toCell<StochasticProcess1D> Process "Process" 
                let _End = Helper.toCell<double> End "End" 
                let _steps = Helper.toCell<int> steps "steps" 
                let _strike = Helper.toCell<double> strike "strike" 
                let builder (current : ICell) = ((TrigeorgisModel.Cast _Trigeorgis.cell).Factory
                                                            _Process.cell 
                                                            _End.cell 
                                                            _steps.cell 
                                                            _strike.cell 
    ...
    let Trigeorgis_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _steps = Helper.toCell<int> steps "steps" 
                let _strike = Helper.toCell<double> strike "strike" 
                let builder (current : ICell) = (Fun.Trigeorgis1 
                                                            _Process.cell 
                                                            _End.cell 
                                                            _steps.cell 
                                                            _strike.cell 
    ...
    let Trigeorgis_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.Trigeorgis ()
                                                       ) :> ICell
                let format (i : ICell) (l:string) = Helper.Range.fromModel (i :?> ICell<Trigeorgis>) l
    ...
    let Trigeorgis_probability
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((TrigeorgisModel.Cast _Trigeorgis.cell).Probability
                                                            _x.cell 
                                                            _y.cell 
                                                            _branch.cell 
                                                       ) :> ICell
    ...
    let Trigeorgis_underlying
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((TrigeorgisModel.Cast _Trigeorgis.cell).Underlying
                                                            _i.cell 
                                                            _index.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let Trigeorgis_descendant
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _index = Helper.toCell<int> index "index" 
                let _branch = Helper.toCell<int> branch "branch" 
                let builder (current : ICell) = ((TrigeorgisModel.Cast _Trigeorgis.cell).Descendant
                                                            _x.cell 
                                                            _index.cell 
                                                            _branch.cell 
                                                       ) :> ICell
    ...
    let Trigeorgis_size
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Trigeorgis = Helper.toModelReference<Trigeorgis> trigeorgis "Trigeorgis"  
                let _i = Helper.toCell<int> i "i" 
                let builder (current : ICell) = ((TrigeorgisModel.Cast _Trigeorgis.cell).Size
                                                            _i.cell 
                                                       ) :> ICell
                let format (o : int) (l:string) = o :> obj
    ...
    let Trigeorgis_columns
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Trigeorgis = Helper.toModelReference<Trigeorgis> trigeorgis "Trigeorgis"  
                let builder (current : ICell) = ((TrigeorgisModel.Cast _Trigeorgis.cell).Columns
                                                       ) :> ICell
                let format (o : int) (l:string) = o :> obj
    ...
    let Trigeorgis_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<Trigeorgis> (c)) :> ICell
                let format (i : Cephei.Cell.List<Trigeorgis>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<Trigeorgis>(" + (Helper.sourceFoldArray (s) + "))"))
