    ...
    let MixedLinearFritschButlandCubic_derivative
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _MixedLinearFritschButlandCubic = Helper.toCell<MixedLinearFritschButlandCubic> mixedlinearfritschbutlandcubic "MixedLinearFritschButlandCubic" true 
    ...
    let MixedLinearFritschButlandCubic_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<MixedLinearFritschButlandCubic> i "value" true) |>
                        Seq.toArray
