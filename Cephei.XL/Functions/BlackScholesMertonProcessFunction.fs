    ...
    let BlackScholesMertonProcess_apply
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _BlackScholesMertonProcess = Helper.toModelReference<BlackScholesMertonProcess> blackscholesmertonprocess "BlackScholesMertonProcess"  
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                Model.specify 
                    ...
                    ; source =  (fun () -> "(new Cephei.Cell.List<BlackScholesMertonProcess>(" + (Helper.sourceFoldArray (s) + "))"))
