    ...
    let GaussChebyshev2ndIntegration_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.GaussChebyshev2ndIntegration 
                                                            _n.cell 
                                                       ) :> ICell
    ...
    let GaussChebyshev2ndIntegration_order
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _GaussChebyshev2ndIntegration = Helper.toModelReference<GaussChebyshev2ndIntegration> gausschebyshev2ndintegration "GaussChebyshev2ndIntegration"  
                let builder (current : ICell) = ((GaussChebyshev2ndIntegrationModel.Cast _GaussChebyshev2ndIntegration.cell).Order
                                                       ) :> ICell
    ...
    let GaussChebyshev2ndIntegration_value
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((GaussChebyshev2ndIntegrationModel.Cast _GaussChebyshev2ndIntegration.cell).Value
                                                            _f.cell 
                                                       ) :> ICell
    ...
    let GaussChebyshev2ndIntegration_weights
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _GaussChebyshev2ndIntegration = Helper.toModelReference<GaussChebyshev2ndIntegration> gausschebyshev2ndintegration "GaussChebyshev2ndIntegration"  
                let builder (current : ICell) = ((GaussChebyshev2ndIntegrationModel.Cast _GaussChebyshev2ndIntegration.cell).Weights
                                                       ) :> ICell
    ...
    let GaussChebyshev2ndIntegration_x
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _GaussChebyshev2ndIntegration = Helper.toModelReference<GaussChebyshev2ndIntegration> gausschebyshev2ndintegration "GaussChebyshev2ndIntegration"  
                let builder (current : ICell) = ((GaussChebyshev2ndIntegrationModel.Cast _GaussChebyshev2ndIntegration.cell).X
                                                       ) :> ICell
                let format (i : ICell) (l:string) = Helper.Range.fromModel (i :?> ICell<Vector>) l
    ...
    let GaussChebyshev2ndIntegration_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<GaussChebyshev2ndIntegration> (c)) :> ICell
                let format (i : Cephei.Cell.List<GaussChebyshev2ndIntegration>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<GaussChebyshev2ndIntegration>(" + (Helper.sourceFoldArray (s) + "))"))
