    ...
    let MultiplicativePriceSeasonality_correctYoYRate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _MultiplicativePriceSeasonality = Helper.toModelReference<MultiplicativePriceSeasonality> multiplicativepriceseasonality "MultiplicativePriceSeasonality"  
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                Model.specify 
                    ...
                    ; source =  (fun () -> "(new Cephei.Cell.List<MultiplicativePriceSeasonality>(" + (Helper.sourceFoldArray (s) + "))"))
