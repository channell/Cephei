    ...
    let FlatSmileSection_atmLevel
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _FlatSmileSection = Helper.toModelReference<FlatSmileSection> flatsmilesection "FlatSmileSection"  
    ...
    let FlatSmileSection_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<FlatSmileSection>) (l : string) = Helper.Range.fromModelList i l
