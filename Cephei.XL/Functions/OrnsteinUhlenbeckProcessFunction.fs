    ...
    let OrnsteinUhlenbeckProcess_diffusion
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _OrnsteinUhlenbeckProcess = Helper.toModelReference<OrnsteinUhlenbeckProcess> ornsteinuhlenbeckprocess "OrnsteinUhlenbeckProcess"  
                ...
                let builder (current : ICell) = ((OrnsteinUhlenbeckProcessModel.Cast _OrnsteinUhlenbeckProcess.cell).Diffusion
    ...
    let OrnsteinUhlenbeckProcess_drift
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((OrnsteinUhlenbeckProcessModel.Cast _OrnsteinUhlenbeckProcess.cell).Drift
                                                            _UnnamedParameter1.cell 
                                                            _x.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let OrnsteinUhlenbeckProcess_expectation
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((OrnsteinUhlenbeckProcessModel.Cast _OrnsteinUhlenbeckProcess.cell).Expectation
                                                            _UnnamedParameter1.cell 
                                                            _x0.cell 
                                                            _dt.cell 
                                                       ) :> ICell
    ...
    let OrnsteinUhlenbeckProcess_level
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _OrnsteinUhlenbeckProcess = Helper.toModelReference<OrnsteinUhlenbeckProcess> ornsteinuhlenbeckprocess "OrnsteinUhlenbeckProcess"  
                let builder (current : ICell) = ((OrnsteinUhlenbeckProcessModel.Cast _OrnsteinUhlenbeckProcess.cell).Level
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let OrnsteinUhlenbeckProcess_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.OrnsteinUhlenbeckProcess 
                                                            _speed.cell 
                                                            _vol.cell 
                                                            _x0.cell 
                                                            _level.cell 
    ...
    let OrnsteinUhlenbeckProcess_speed
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _OrnsteinUhlenbeckProcess = Helper.toModelReference<OrnsteinUhlenbeckProcess> ornsteinuhlenbeckprocess "OrnsteinUhlenbeckProcess"  
                let builder (current : ICell) = ((OrnsteinUhlenbeckProcessModel.Cast _OrnsteinUhlenbeckProcess.cell).Speed
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let OrnsteinUhlenbeckProcess_stdDeviation
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _x0 = Helper.toDefault<double> x0 "x0" 0.0
                let _dt = Helper.toCell<double> dt "dt" 
                let builder (current : ICell) = ((OrnsteinUhlenbeckProcessModel.Cast _OrnsteinUhlenbeckProcess.cell).StdDeviation
                                                            _t.cell 
                                                            _x0.cell 
                                                            _dt.cell 
                                                       ) :> ICell
    ...
    let OrnsteinUhlenbeckProcess_variance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _UnnamedParameter2 = Helper.toCell<double> UnnamedParameter2 "UnnamedParameter2" 
                let _dt = Helper.toCell<double> dt "dt" 
                let builder (current : ICell) = ((OrnsteinUhlenbeckProcessModel.Cast _OrnsteinUhlenbeckProcess.cell).Variance
                                                            _UnnamedParameter1.cell 
                                                            _UnnamedParameter2.cell 
                                                            _dt.cell 
                                                       ) :> ICell
    ...
    let OrnsteinUhlenbeckProcess_volatility
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _OrnsteinUhlenbeckProcess = Helper.toModelReference<OrnsteinUhlenbeckProcess> ornsteinuhlenbeckprocess "OrnsteinUhlenbeckProcess"  
                let builder (current : ICell) = ((OrnsteinUhlenbeckProcessModel.Cast _OrnsteinUhlenbeckProcess.cell).Volatility
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let OrnsteinUhlenbeckProcess_x0
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _OrnsteinUhlenbeckProcess = Helper.toModelReference<OrnsteinUhlenbeckProcess> ornsteinuhlenbeckprocess "OrnsteinUhlenbeckProcess"  
                let builder (current : ICell) = ((OrnsteinUhlenbeckProcessModel.Cast _OrnsteinUhlenbeckProcess.cell).X0
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let OrnsteinUhlenbeckProcess_apply1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((OrnsteinUhlenbeckProcessModel.Cast _OrnsteinUhlenbeckProcess.cell).Apply1
                                                            _x0.cell 
                                                            _dx.cell 
                                                       ) :> ICell
    ...
    let OrnsteinUhlenbeckProcess_apply
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((OrnsteinUhlenbeckProcessModel.Cast _OrnsteinUhlenbeckProcess.cell).Apply
                                                            _x0.cell 
                                                            _dx.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let OrnsteinUhlenbeckProcess_evolve
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((OrnsteinUhlenbeckProcessModel.Cast _OrnsteinUhlenbeckProcess.cell).Evolve
                                                            _t0.cell 
                                                            _x0.cell 
                                                            _dt.cell 
                                                            _dw.cell 
    ...
    let OrnsteinUhlenbeckProcess_evolve1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((OrnsteinUhlenbeckProcessModel.Cast _OrnsteinUhlenbeckProcess.cell).Evolve1
                                                            _t0.cell 
                                                            _x0.cell 
                                                            _dt.cell 
                                                            _dw.cell 
    ...
    let OrnsteinUhlenbeckProcess_initialValues
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _OrnsteinUhlenbeckProcess = Helper.toModelReference<OrnsteinUhlenbeckProcess> ornsteinuhlenbeckprocess "OrnsteinUhlenbeckProcess"  
                let builder (current : ICell) = ((OrnsteinUhlenbeckProcessModel.Cast _OrnsteinUhlenbeckProcess.cell).InitialValues
                                                       ) :> ICell
                let format (i : ICell) (l:string) = Helper.Range.fromModel (i :?> ICell<Vector>) l
    ...
    let OrnsteinUhlenbeckProcess_size
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _OrnsteinUhlenbeckProcess = Helper.toModelReference<OrnsteinUhlenbeckProcess> ornsteinuhlenbeckprocess "OrnsteinUhlenbeckProcess"  
                let builder (current : ICell) = ((OrnsteinUhlenbeckProcessModel.Cast _OrnsteinUhlenbeckProcess.cell).Size
                                                       ) :> ICell
    ...
    let OrnsteinUhlenbeckProcess_covariance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _x0 = Helper.toCell<Vector> x0 "x0" 
                let _dt = Helper.toCell<double> dt "dt" 
                let builder (current : ICell) = ((OrnsteinUhlenbeckProcessModel.Cast _OrnsteinUhlenbeckProcess.cell).Covariance
                                                            _t0.cell 
                                                            _x0.cell 
                                                            _dt.cell 
                                                       ) :> ICell
    ...
    let OrnsteinUhlenbeckProcess_factors
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _OrnsteinUhlenbeckProcess = Helper.toModelReference<OrnsteinUhlenbeckProcess> ornsteinuhlenbeckprocess "OrnsteinUhlenbeckProcess"  
                let builder (current : ICell) = ((OrnsteinUhlenbeckProcessModel.Cast _OrnsteinUhlenbeckProcess.cell).Factors
                                                       ) :> ICell
                let format (o : int) (l:string) = o :> obj
    ...
    let OrnsteinUhlenbeckProcess_registerWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((OrnsteinUhlenbeckProcessModel.Cast _OrnsteinUhlenbeckProcess.cell).RegisterWith
                                                            _handler.cell 
                                                       ) :> ICell
    ...
    let OrnsteinUhlenbeckProcess_time
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((OrnsteinUhlenbeckProcessModel.Cast _OrnsteinUhlenbeckProcess.cell).Time
                                                            _d.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let OrnsteinUhlenbeckProcess_unregisterWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _OrnsteinUhlenbeckProcess = Helper.toModelReference<OrnsteinUhlenbeckProcess> ornsteinuhlenbeckprocess "OrnsteinUhlenbeckProcess"  
                let _handler = Helper.toCell<Callback> handler "handler" 
                let builder (current : ICell) = ((OrnsteinUhlenbeckProcessModel.Cast _OrnsteinUhlenbeckProcess.cell).UnregisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : OrnsteinUhlenbeckProcess) (l:string) = o.ToString() :> obj
    ...
    let OrnsteinUhlenbeckProcess_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _OrnsteinUhlenbeckProcess = Helper.toModelReference<OrnsteinUhlenbeckProcess> ornsteinuhlenbeckprocess "OrnsteinUhlenbeckProcess"  
                let builder (current : ICell) = ((OrnsteinUhlenbeckProcessModel.Cast _OrnsteinUhlenbeckProcess.cell).Update
                                                       ) :> ICell
                let format (o : OrnsteinUhlenbeckProcess) (l:string) = o.ToString() :> obj
