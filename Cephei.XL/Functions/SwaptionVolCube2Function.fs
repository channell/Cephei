    ...
    let SwaptionVolCube2_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.SwaptionVolCube2 
    ...
    let SwaptionVolCube2_volSpreads
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let _i = Helper.toCell<int> i "i" 
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).VolSpreads
                                                            _i.cell 
                                                       ) :> ICell
    ...
    let SwaptionVolCube2_atmStrike
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).AtmStrike
                                                            _optionTenor.cell 
                                                            _swapTenor.cell 
                                                       ) :> ICell
    ...
    let SwaptionVolCube2_atmStrike
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _swapTenor = Helper.toCell<Period> swapTenor "swapTenor" 
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).AtmStrike1
                                                            _optionDate.cell 
                                                            _swapTenor.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let SwaptionVolCube2_atmVol
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).AtmVol
                                                       ) :> ICell
    ...
    let SwaptionVolCube2_calendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).Calendar
                                                       ) :> ICell
    ...
    let SwaptionVolCube2_dayCounter
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).DayCounter
                                                       ) :> ICell
    ...
    let SwaptionVolCube2_maxDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).MaxDate
                                                       ) :> ICell
    ...
    let SwaptionVolCube2_maxStrike
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).MaxStrike
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let SwaptionVolCube2_maxSwapTenor
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).MaxSwapTenor
                                                       ) :> ICell
    ...
    let SwaptionVolCube2_maxTime
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).MaxTime
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let SwaptionVolCube2_minStrike
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).MinStrike
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let SwaptionVolCube2_referenceDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).ReferenceDate
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let SwaptionVolCube2_settlementDays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).SettlementDays
                                                       ) :> ICell
    ...
    let SwaptionVolCube2_shortSwapIndexBase
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).ShortSwapIndexBase
                                                       ) :> ICell
    ...
    let SwaptionVolCube2_strikeSpreads
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).StrikeSpreads
                                                       ) :> ICell
    ...
    let SwaptionVolCube2_swapIndexBase
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).SwapIndexBase
                                                       ) :> ICell
                let format (i : ICell) (l:string) = Helper.Range.fromModel (i :?> ICell<SwapIndex>) l
    ...
    let SwaptionVolCube2_vegaWeightedSmileFit
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).VegaWeightedSmileFit
                                                       ) :> ICell
    ...
    let SwaptionVolCube2_volatilityType
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).VolatilityType
                                                       ) :> ICell
    ...
    let SwaptionVolCube2_optionDateFromTime
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).OptionDateFromTime
                                                            _optionTime.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let SwaptionVolCube2_optionDates
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).OptionDates
                                                       ) :> ICell
    ...
    let SwaptionVolCube2_optionTenors
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).OptionTenors
                                                       ) :> ICell
    ...
    let SwaptionVolCube2_optionTimes
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).OptionTimes
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let SwaptionVolCube2_swapLengths
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).SwapLengths
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let SwaptionVolCube2_swapTenors
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).SwapTenors
                                                       ) :> ICell
                let format (i : Generic.List<Period>) (l : string) = Helper.Range.fromList i l
    ...
    let SwaptionVolCube2_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).Update
                                                       ) :> ICell
    ...
    let SwaptionVolCube2_blackVariance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).BlackVariance
                                                            _optionTime.cell 
                                                            _swapLength.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let SwaptionVolCube2_blackVariance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).BlackVariance1
                                                            _optionDate.cell 
                                                            _swapLength.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let SwaptionVolCube2_blackVariance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).BlackVariance2
                                                            _optionTenor.cell 
                                                            _swapLength.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let SwaptionVolCube2_blackVariance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).BlackVariance3
                                                            _optionTime.cell 
                                                            _swapTenor.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let SwaptionVolCube2_blackVariance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).BlackVariance4
                                                            _optionDate.cell 
                                                            _swapTenor.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let SwaptionVolCube2_blackVariance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).BlackVariance5
                                                            _optionTenor.cell 
                                                            _swapTenor.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let SwaptionVolCube2_maxSwapLength
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).MaxSwapLength
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let SwaptionVolCube2_shift
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _swapTenor = Helper.toCell<Period> swapTenor "swapTenor" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).Shift
                                                            _optionTime.cell 
                                                            _swapTenor.cell 
                                                            _extrapolate.cell 
                                                       ) :> ICell
    ...
    let SwaptionVolCube2_shift
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _swapTenor = Helper.toCell<Period> swapTenor "swapTenor" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).Shift1
                                                            _optionDate.cell 
                                                            _swapTenor.cell 
                                                            _extrapolate.cell 
                                                       ) :> ICell
    ...
    let SwaptionVolCube2_shift
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _swapLength = Helper.toCell<double> swapLength "swapLength" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).Shift2
                                                            _optionDate.cell 
                                                            _swapLength.cell 
                                                            _extrapolate.cell 
                                                       ) :> ICell
    ...
    let SwaptionVolCube2_shift
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _swapLength = Helper.toCell<double> swapLength "swapLength" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).Shift3
                                                            _optionTime.cell 
                                                            _swapLength.cell 
                                                            _extrapolate.cell 
                                                       ) :> ICell
    ...
    let SwaptionVolCube2_shift
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _swapTenor = Helper.toCell<Period> swapTenor "swapTenor" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).Shift4
                                                            _optionTenor.cell 
                                                            _swapTenor.cell 
                                                            _extrapolate.cell 
                                                       ) :> ICell
    ...
    let SwaptionVolCube2_shift
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _swapLength = Helper.toCell<double> swapLength "swapLength" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).Shift5
                                                            _optionTenor.cell 
                                                            _swapLength.cell 
                                                            _extrapolate.cell 
                                                       ) :> ICell
    ...
    let SwaptionVolCube2_smileSection
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).SmileSection
                                                            _optionTenor.cell 
                                                            _swapTenor.cell 
                                                            _extr.cell 
                                                       ) :> ICell
    ...
    let SwaptionVolCube2_smileSection
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _swapLength = Helper.toCell<double> swapLength "swapLength" 
                let _extr = Helper.toCell<bool> extr "extr" 
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).SmileSection1
                                                            _optionTime.cell 
                                                            _swapLength.cell 
                                                            _extr.cell 
                                                       ) :> ICell
    ...
    let SwaptionVolCube2_smileSection
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _swapTenor = Helper.toCell<Period> swapTenor "swapTenor" 
                let _extr = Helper.toCell<bool> extr "extr" 
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).SmileSection2
                                                            _optionDate.cell 
                                                            _swapTenor.cell 
                                                            _extr.cell 
                                                       ) :> ICell
    ...
    let SwaptionVolCube2_swapLength
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).SwapLength
                                                            _start.cell 
                                                            _End.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let SwaptionVolCube2_swapLength
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let _swapTenor = Helper.toCell<Period> swapTenor "swapTenor" 
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).SwapLength1
                                                            _swapTenor.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let SwaptionVolCube2_volatility
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).Volatility
                                                            _optionDate.cell 
                                                            _swapTenor.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let SwaptionVolCube2_volatility
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).Volatility1
                                                            _optionDate.cell 
                                                            _swapLength.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let SwaptionVolCube2_volatility
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).Volatility2
                                                            _optionTenor.cell 
                                                            _swapTenor.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let SwaptionVolCube2_volatility
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).Volatility3
                                                            _optionTenor.cell 
                                                            _swapLength.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let SwaptionVolCube2_volatility
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).Volatility4
                                                            _optionTime.cell 
                                                            _swapLength.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let SwaptionVolCube2_volatility
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _strike = Helper.toCell<double> strike "strike" 
                let _extrapolate = Helper.toCell<bool> extrapolate "extrapolate" 
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).Volatility5
                                                            _optionTime.cell 
                                                            _swapTenor.cell 
                                                            _strike.cell 
                                                            _extrapolate.cell 
    ...
    let SwaptionVolCube2_businessDayConvention
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).BusinessDayConvention
                                                       ) :> ICell
    ...
    let SwaptionVolCube2_optionDateFromTenor
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).OptionDateFromTenor
                                                            _p.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let SwaptionVolCube2_timeFromReference
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).TimeFromReference
                                                            _date.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let SwaptionVolCube2_allowsExtrapolation
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).AllowsExtrapolation
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let SwaptionVolCube2_disableExtrapolation
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).DisableExtrapolation
                                                            _b.cell 
                                                       ) :> ICell
                let format (o : SwaptionVolCube2) (l:string) = o.ToString() :> obj
    ...
    let SwaptionVolCube2_enableExtrapolation
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let _b = Helper.toCell<bool> b "b" 
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).EnableExtrapolation
                                                            _b.cell 
                                                       ) :> ICell
                let format (o : SwaptionVolCube2) (l:string) = o.ToString() :> obj
    ...
    let SwaptionVolCube2_extrapolate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toModelReference<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2"  
                let builder (current : ICell) = ((SwaptionVolCube2Model.Cast _SwaptionVolCube2.cell).Extrapolate
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                Model.specify 
                    ...
                    ; source =  (fun () -> "(new Cephei.Cell.List<SwaptionVolCube2>(" + (Helper.sourceFoldArray (s) + "))"))
