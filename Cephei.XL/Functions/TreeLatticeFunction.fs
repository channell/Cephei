    ...
    let TreeLattice_initialize
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TreeLattice = Helper.toModelReference<TreeLattice> treelattice "TreeLattice"  
                let _asset = Helper.toCell<DiscretizedAsset> asset "asset" 
                let _t = Helper.toCell<double> t "t" 
                let builder (current : ICell) = ((TreeLatticeModel.Cast _TreeLattice.cell).Initialize
                                                            _asset.cell 
                                                            _t.cell 
                                                       ) :> ICell
    ...
    let TreeLattice_partialRollback
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((TreeLatticeModel.Cast _TreeLattice.cell).PartialRollback
                                                            _asset.cell 
                                                            _To.cell 
                                                       ) :> ICell
                let format (o : TreeLattice) (l:string) = o.ToString() :> obj
    ...
    let TreeLattice_presentValue
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TreeLattice = Helper.toModelReference<TreeLattice> treelattice "TreeLattice"  
                let _asset = Helper.toCell<DiscretizedAsset> asset "asset" 
                let builder (current : ICell) = ((TreeLatticeModel.Cast _TreeLattice.cell).PresentValue
                                                            _asset.cell 
                                                       ) :> ICell
    ...
    let TreeLattice_rollback
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _asset = Helper.toCell<DiscretizedAsset> asset "asset" 
                let _To = Helper.toCell<double> To "To" 
                let builder (current : ICell) = ((TreeLatticeModel.Cast _TreeLattice.cell).Rollback
                                                            _asset.cell 
                                                            _To.cell 
                                                       ) :> ICell
                let format (o : TreeLattice) (l:string) = o.ToString() :> obj
    ...
    let TreeLattice_statePrices
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((TreeLatticeModel.Cast _TreeLattice.cell).StatePrices
                                                            _i.cell 
                                                       ) :> ICell
    ...
    let TreeLattice_stepback
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((TreeLatticeModel.Cast _TreeLattice.cell).Stepback
                                                            _i.cell 
                                                            _values.cell 
                                                            _newValues.cell 
                                                       ) :> ICell
    ...
    let TreeLattice_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.TreeLattice 
                                                            _timeGrid.cell 
                                                            _n.cell 
                                                       ) :> ICell
    ...
    let TreeLattice_grid
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TreeLattice = Helper.toModelReference<TreeLattice> treelattice "TreeLattice"  
                let _t = Helper.toCell<double> t "t" 
                let builder (current : ICell) = ((TreeLatticeModel.Cast _TreeLattice.cell).Grid
                                                            _t.cell 
                                                       ) :> ICell
                let format (i : ICell) (l:string) = Helper.Range.fromModel (i :?> ICell<Vector>) l
    ...
    let TreeLattice_timeGrid
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TreeLattice = Helper.toModelReference<TreeLattice> treelattice "TreeLattice"  
                let builder (current : ICell) = ((TreeLatticeModel.Cast _TreeLattice.cell).TimeGrid
                                                       ) :> ICell
    ...
    let TreeLattice_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<TreeLattice> (c)) :> ICell
                let format (i : Cephei.Cell.List<TreeLattice>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<TreeLattice>(" + (Helper.sourceFoldArray (s) + "))"))
