    ...
    let AtmSmileSection_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.AtmSmileSection 
                                                            _source.cell 
                                                            _atm.cell 
    ...
    let AtmSmileSection_density
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((AtmSmileSectionModel.Cast _AtmSmileSection.cell).Density
                                                            _strike.cell 
                                                            _discount.cell 
                                                            _gap.cell 
                                                       ) :> ICell
    ...
    let AtmSmileSection_digitalOptionPrice
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _discount = Helper.toCell<double> discount "discount" 
                let _gap = Helper.toCell<double> gap "gap" 
                let builder (current : ICell) = ((AtmSmileSectionModel.Cast _AtmSmileSection.cell).DigitalOptionPrice
                                                            _strike.cell 
                                                            _Type.cell 
                                                            _discount.cell 
                                                            _gap.cell 
    ...
    let AtmSmileSection_optionPrice
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Type = Helper.toCell<Option.Type> Type "Type" 
                let _discount = Helper.toCell<double> discount "discount" 
                let builder (current : ICell) = ((AtmSmileSectionModel.Cast _AtmSmileSection.cell).OptionPrice
                                                            _strike.cell 
                                                            _Type.cell 
                                                            _discount.cell 
                                                       ) :> ICell
    ...
    let AtmSmileSection_volatility
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((AtmSmileSectionModel.Cast _AtmSmileSection.cell).Volatility
                                                            _strike.cell 
    ...
    let AtmSmileSection_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<AtmSmileSection> (c)) :> ICell
                let format (i : Cephei.Cell.List<AtmSmileSection>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<AtmSmileSection>(" + (Helper.sourceFoldArray (s) + "))"))
