    ...
    let LVLCurrency_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.LVLCurrency ()
                                                       ) :> ICell
    ...
    let LVLCurrency_code
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _LVLCurrency = Helper.toModelReference<LVLCurrency> lvlcurrency "LVLCurrency"  
                let builder (current : ICell) = ((LVLCurrencyModel.Cast _LVLCurrency.cell).Code
                                                       ) :> ICell
    ...
    let LVLCurrency_empty
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _LVLCurrency = Helper.toModelReference<LVLCurrency> lvlcurrency "LVLCurrency"  
                let builder (current : ICell) = ((LVLCurrencyModel.Cast _LVLCurrency.cell).Empty
                                                       ) :> ICell
    ...
    let LVLCurrency_Equals
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((LVLCurrencyModel.Cast _LVLCurrency.cell).Equals
                                                            _o.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let LVLCurrency_format
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _LVLCurrency = Helper.toModelReference<LVLCurrency> lvlcurrency "LVLCurrency"  
                let builder (current : ICell) = ((LVLCurrencyModel.Cast _LVLCurrency.cell).Format
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let LVLCurrency_fractionsPerUnit
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _LVLCurrency = Helper.toModelReference<LVLCurrency> lvlcurrency "LVLCurrency"  
                let builder (current : ICell) = ((LVLCurrencyModel.Cast _LVLCurrency.cell).FractionsPerUnit
                                                       ) :> ICell
    ...
    let LVLCurrency_fractionSymbol
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _LVLCurrency = Helper.toModelReference<LVLCurrency> lvlcurrency "LVLCurrency"  
                let builder (current : ICell) = ((LVLCurrencyModel.Cast _LVLCurrency.cell).FractionSymbol
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let LVLCurrency_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _LVLCurrency = Helper.toModelReference<LVLCurrency> lvlcurrency "LVLCurrency"  
                let builder (current : ICell) = ((LVLCurrencyModel.Cast _LVLCurrency.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let LVLCurrency_numericCode
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _LVLCurrency = Helper.toModelReference<LVLCurrency> lvlcurrency "LVLCurrency"  
                let builder (current : ICell) = ((LVLCurrencyModel.Cast _LVLCurrency.cell).NumericCode
                                                       ) :> ICell
                let format (o : int) (l:string) = o :> obj
    ...
    let LVLCurrency_rounding
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _LVLCurrency = Helper.toModelReference<LVLCurrency> lvlcurrency "LVLCurrency"  
                let builder (current : ICell) = ((LVLCurrencyModel.Cast _LVLCurrency.cell).Rounding
                                                       ) :> ICell
    ...
    let LVLCurrency_symbol
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _LVLCurrency = Helper.toModelReference<LVLCurrency> lvlcurrency "LVLCurrency"  
                let builder (current : ICell) = ((LVLCurrencyModel.Cast _LVLCurrency.cell).Symbol
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let LVLCurrency_ToString
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _LVLCurrency = Helper.toModelReference<LVLCurrency> lvlcurrency "LVLCurrency"  
                let builder (current : ICell) = ((LVLCurrencyModel.Cast _LVLCurrency.cell).ToString
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let LVLCurrency_triangulationCurrency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _LVLCurrency = Helper.toModelReference<LVLCurrency> lvlcurrency "LVLCurrency"  
                let builder (current : ICell) = ((LVLCurrencyModel.Cast _LVLCurrency.cell).TriangulationCurrency
                                                       ) :> ICell
