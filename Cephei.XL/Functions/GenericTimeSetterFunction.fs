    ...
    let GenericTimeSetter_setTime
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _GenericTimeSetter = Helper.toModelReference<GenericTimeSetter> generictimesetter "GenericTimeSetter"  
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                Model.specify 
                    ...
                    ; source =  (fun () -> "(new Cephei.Cell.List<GenericTimeSetter>(" + (Helper.sourceFoldArray (s) + "))"))
