    ...
    let Euribor3M_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.Euribor3M ()
                                                       ) :> ICell
    ...
    let Euribor3M_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.Euribor3M1 
                                                            _h.cell 
                                                       ) :> ICell
                let format (i : ICell) (l:string) = Helper.Range.fromModel (i :?> ICell<Euribor3M>) l
    ...
    let Euribor3M_businessDayConvention
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor3M = Helper.toModelReference<Euribor3M> euribor3m "Euribor3M"  
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).BusinessDayConvention
                                                       ) :> ICell
    ...
    let Euribor3M_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).Clone
                                                            _forwarding.cell 
                                                       ) :> ICell
    ...
    let Euribor3M_endOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor3M = Helper.toModelReference<Euribor3M> euribor3m "Euribor3M"  
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).EndOfMonth
                                                       ) :> ICell
    ...
    let Euribor3M_forecastFixing1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).ForecastFixing1
                                                            _d1.cell 
                                                            _d2.cell 
                                                            _t.cell 
                                                       ) :> ICell
    ...
    let Euribor3M_forecastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).ForecastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let Euribor3M_forwardingTermStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor3M = Helper.toModelReference<Euribor3M> euribor3m "Euribor3M"  
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).ForwardingTermStructure
                                                       ) :> ICell
    ...
    let Euribor3M_maturityDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).MaturityDate
                                                            _valueDate.cell 
                                                       ) :> ICell
    ...
    let Euribor3M_currency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor3M = Helper.toModelReference<Euribor3M> euribor3m "Euribor3M"  
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).Currency
                                                       ) :> ICell
    ...
    let Euribor3M_dayCounter
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor3M = Helper.toModelReference<Euribor3M> euribor3m "Euribor3M"  
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).DayCounter
                                                       ) :> ICell
    ...
    let Euribor3M_familyName
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor3M = Helper.toModelReference<Euribor3M> euribor3m "Euribor3M"  
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).FamilyName
                                                       ) :> ICell
    ...
    let Euribor3M_fixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).Fixing
                                                            _fixingDate.cell 
    ...
    let Euribor3M_fixingCalendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor3M = Helper.toModelReference<Euribor3M> euribor3m "Euribor3M"  
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).FixingCalendar
                                                       ) :> ICell
    ...
    let Euribor3M_fixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor3M = Helper.toModelReference<Euribor3M> euribor3m "Euribor3M"  
                let _valueDate = Helper.toCell<Date> valueDate "valueDate" 
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).FixingDate
                                                            _valueDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let Euribor3M_fixingDays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor3M = Helper.toModelReference<Euribor3M> euribor3m "Euribor3M"  
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).FixingDays
                                                       ) :> ICell
    ...
    let Euribor3M_isValidFixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor3M = Helper.toModelReference<Euribor3M> euribor3m "Euribor3M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).IsValidFixingDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Euribor3M_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor3M = Helper.toModelReference<Euribor3M> euribor3m "Euribor3M"  
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let Euribor3M_pastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor3M = Helper.toModelReference<Euribor3M> euribor3m "Euribor3M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).PastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
    ...
    let Euribor3M_tenor
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor3M = Helper.toModelReference<Euribor3M> euribor3m "Euribor3M"  
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).Tenor
                                                       ) :> ICell
    ...
    let Euribor3M_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor3M = Helper.toModelReference<Euribor3M> euribor3m "Euribor3M"  
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).Update
                                                       ) :> ICell
    ...
    let Euribor3M_valueDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor3M = Helper.toModelReference<Euribor3M> euribor3m "Euribor3M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).ValueDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let Euribor3M_addFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).AddFixing
                                                            _d.cell 
                                                            _v.cell 
    ...
    let Euribor3M_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).AddFixings
                                                            _d.cell 
                                                            _v.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
    ...
    let Euribor3M_addFixings1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).AddFixings1
                                                            _source.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
                let format (o : Euribor3M) (l:string) = o.ToString() :> obj
    ...
    let Euribor3M_allowsNativeFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor3M = Helper.toModelReference<Euribor3M> euribor3m "Euribor3M"  
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).AllowsNativeFixings
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Euribor3M_clearFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor3M = Helper.toModelReference<Euribor3M> euribor3m "Euribor3M"  
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).ClearFixings
                                                       ) :> ICell
                let format (o : Euribor3M) (l:string) = o.ToString() :> obj
    ...
    let Euribor3M_registerWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).RegisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : Euribor3M) (l:string) = o.ToString() :> obj
    ...
    let Euribor3M_timeSeries
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor3M = Helper.toModelReference<Euribor3M> euribor3m "Euribor3M"  
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).TimeSeries
                                                       ) :> ICell
    ...
    let Euribor3M_unregisterWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor3M = Helper.toModelReference<Euribor3M> euribor3m "Euribor3M"  
                let _handler = Helper.toCell<Callback> handler "handler" 
                let builder (current : ICell) = ((Euribor3MModel.Cast _Euribor3M.cell).UnregisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : Euribor3M) (l:string) = o.ToString() :> obj
    ...
    let Euribor3M_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<Euribor3M> (c)) :> ICell
                let format (i : Cephei.Cell.List<Euribor3M>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<Euribor3M>(" + (Helper.sourceFoldArray (s) + "))"))
