    ...
    let Euribor6M_businessDayConvention
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor6M = Helper.toCell<Euribor6M> euribor6m "Euribor6M" true 
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).BusinessDayConvention
                                                       ) :> ICell
    ...
    let Euribor6M_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).Clone
                                                            _forwarding.cell 
                                                       ) :> ICell
    ...
    let Euribor6M_endOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor6M = Helper.toCell<Euribor6M> euribor6m "Euribor6M" true 
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).EndOfMonth
                                                       ) :> ICell
    ...
    let Euribor6M_forecastFixing1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).ForecastFixing1
                                                            _d1.cell 
                                                            _d2.cell 
                                                            _t.cell 
                                                       ) :> ICell
    ...
    let Euribor6M_forecastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).ForecastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let Euribor6M_forwardingTermStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor6M = Helper.toCell<Euribor6M> euribor6m "Euribor6M" true 
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).ForwardingTermStructure
                                                       ) :> ICell
    ...
    let Euribor6M_maturityDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).MaturityDate
                                                            _valueDate.cell 
                                                       ) :> ICell
    ...
    let Euribor6M_currency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor6M = Helper.toCell<Euribor6M> euribor6m "Euribor6M" true 
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).Currency
                                                       ) :> ICell
    ...
    let Euribor6M_dayCounter
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor6M = Helper.toCell<Euribor6M> euribor6m "Euribor6M" true 
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).DayCounter
                                                       ) :> ICell
    ...
    let Euribor6M_familyName
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor6M = Helper.toCell<Euribor6M> euribor6m "Euribor6M" true 
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).FamilyName
                                                       ) :> ICell
    ...
    let Euribor6M_fixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).Fixing
                                                            _fixingDate.cell 
    ...
    let Euribor6M_fixingCalendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor6M = Helper.toCell<Euribor6M> euribor6m "Euribor6M" true 
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).FixingCalendar
                                                       ) :> ICell
    ...
    let Euribor6M_fixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor6M = Helper.toCell<Euribor6M> euribor6m "Euribor6M" true 
                let _valueDate = Helper.toCell<Date> valueDate "valueDate" true
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).FixingDate
                                                            _valueDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let Euribor6M_fixingDays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor6M = Helper.toCell<Euribor6M> euribor6m "Euribor6M" true 
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).FixingDays
                                                       ) :> ICell
    ...
    let Euribor6M_isValidFixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor6M = Helper.toCell<Euribor6M> euribor6m "Euribor6M" true 
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" true
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).IsValidFixingDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Euribor6M_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor6M = Helper.toCell<Euribor6M> euribor6m "Euribor6M" true 
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let Euribor6M_pastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor6M = Helper.toCell<Euribor6M> euribor6m "Euribor6M" true 
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" true
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).PastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
    ...
    let Euribor6M_tenor
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor6M = Helper.toCell<Euribor6M> euribor6m "Euribor6M" true 
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).Tenor
                                                       ) :> ICell
    ...
    let Euribor6M_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor6M = Helper.toCell<Euribor6M> euribor6m "Euribor6M" true 
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).Update
                                                       ) :> ICell
    ...
    let Euribor6M_valueDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor6M = Helper.toCell<Euribor6M> euribor6m "Euribor6M" true 
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" true
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).ValueDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let Euribor6M_addFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).AddFixing
                                                            _d.cell 
                                                            _v.cell 
    ...
    let Euribor6M_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" true
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).AddFixings
                                                            _d.cell 
                                                            _v.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
    ...
    let Euribor6M_addFixings1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" true
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).AddFixings1
                                                            _source.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
                let format (o : Euribor6M) (l:string) = o.ToString() :> obj
    ...
    let Euribor6M_allowsNativeFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor6M = Helper.toCell<Euribor6M> euribor6m "Euribor6M" true 
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).AllowsNativeFixings
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Euribor6M_clearFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor6M = Helper.toCell<Euribor6M> euribor6m "Euribor6M" true 
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).ClearFixings
                                                       ) :> ICell
                let format (o : Euribor6M) (l:string) = o.ToString() :> obj
    ...
    let Euribor6M_registerWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).RegisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : Euribor6M) (l:string) = o.ToString() :> obj
    ...
    let Euribor6M_timeSeries
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor6M = Helper.toCell<Euribor6M> euribor6m "Euribor6M" true 
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).TimeSeries
                                                       ) :> ICell
    ...
    let Euribor6M_unregisterWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor6M = Helper.toCell<Euribor6M> euribor6m "Euribor6M" true 
                let _handler = Helper.toCell<Callback> handler "handler" true
                let builder () = withMnemonic mnemonic ((_Euribor6M.cell :?> Euribor6MModel).UnregisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : Euribor6M) (l:string) = o.ToString() :> obj
    ...
    let Euribor6M_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<Euribor6M> i "value" true) |>
                        Seq.toArray
