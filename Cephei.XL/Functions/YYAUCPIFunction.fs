    ...
    let YYAUCPI_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.YYAUCPI1 
                                                            _frequency.cell 
                                                            _revised.cell 
                                                            _interpolated.cell 
                                                            _ts.cell 
    ...
    let YYAUCPI_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _revised = Helper.toCell<bool> revised "revised" 
                let _interpolated = Helper.toCell<bool> interpolated "interpolated" 
                let builder (current : ICell) = (Fun.YYAUCPI 
                                                            _frequency.cell 
                                                            _revised.cell 
                                                            _interpolated.cell 
                                                       ) :> ICell
    ...
    let YYAUCPI_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _YYAUCPI = Helper.toModelReference<YYAUCPI> yyaucpi "YYAUCPI"  
                let _h = Helper.toHandle<YoYInflationTermStructure> h "h" 
                let builder (current : ICell) = ((YYAUCPIModel.Cast _YYAUCPI.cell).Clone
                                                            _h.cell 
                                                       ) :> ICell
    ...
    let YYAUCPI_fixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((YYAUCPIModel.Cast _YYAUCPI.cell).Fixing
                                                            _fixingDate.cell 
    ...
    let YYAUCPI_ratio
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _YYAUCPI = Helper.toModelReference<YYAUCPI> yyaucpi "YYAUCPI"  
                let builder (current : ICell) = ((YYAUCPIModel.Cast _YYAUCPI.cell).Ratio
                                                       ) :> ICell
    ...
    let YYAUCPI_yoyInflationTermStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _YYAUCPI = Helper.toModelReference<YYAUCPI> yyaucpi "YYAUCPI"  
                let builder (current : ICell) = ((YYAUCPIModel.Cast _YYAUCPI.cell).YoyInflationTermStructure
                                                       ) :> ICell
    ...
    let YYAUCPI_addFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((YYAUCPIModel.Cast _YYAUCPI.cell).AddFixing
                                                            _fixingDate.cell 
                                                            _fixing.cell 
    ...
    let YYAUCPI_availabilityLag
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _YYAUCPI = Helper.toModelReference<YYAUCPI> yyaucpi "YYAUCPI"  
                let builder (current : ICell) = ((YYAUCPIModel.Cast _YYAUCPI.cell).AvailabilityLag
                                                       ) :> ICell
    ...
    let YYAUCPI_currency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _YYAUCPI = Helper.toModelReference<YYAUCPI> yyaucpi "YYAUCPI"  
                let builder (current : ICell) = ((YYAUCPIModel.Cast _YYAUCPI.cell).Currency
                                                       ) :> ICell
    ...
    let YYAUCPI_familyName
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _YYAUCPI = Helper.toModelReference<YYAUCPI> yyaucpi "YYAUCPI"  
                let builder (current : ICell) = ((YYAUCPIModel.Cast _YYAUCPI.cell).FamilyName
                                                       ) :> ICell
    ...
    let YYAUCPI_fixingCalendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _YYAUCPI = Helper.toModelReference<YYAUCPI> yyaucpi "YYAUCPI"  
                let builder (current : ICell) = ((YYAUCPIModel.Cast _YYAUCPI.cell).FixingCalendar
                                                       ) :> ICell
    ...
    let YYAUCPI_frequency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _YYAUCPI = Helper.toModelReference<YYAUCPI> yyaucpi "YYAUCPI"  
                let builder (current : ICell) = ((YYAUCPIModel.Cast _YYAUCPI.cell).Frequency
                                                       ) :> ICell
    ...
    let YYAUCPI_interpolated
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _YYAUCPI = Helper.toModelReference<YYAUCPI> yyaucpi "YYAUCPI"  
                let builder (current : ICell) = ((YYAUCPIModel.Cast _YYAUCPI.cell).Interpolated
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let YYAUCPI_isValidFixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _YYAUCPI = Helper.toModelReference<YYAUCPI> yyaucpi "YYAUCPI"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((YYAUCPIModel.Cast _YYAUCPI.cell).IsValidFixingDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let YYAUCPI_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _YYAUCPI = Helper.toModelReference<YYAUCPI> yyaucpi "YYAUCPI"  
                let builder (current : ICell) = ((YYAUCPIModel.Cast _YYAUCPI.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let YYAUCPI_region
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _YYAUCPI = Helper.toModelReference<YYAUCPI> yyaucpi "YYAUCPI"  
                let builder (current : ICell) = ((YYAUCPIModel.Cast _YYAUCPI.cell).Region
                                                       ) :> ICell
    ...
    let YYAUCPI_revised
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _YYAUCPI = Helper.toModelReference<YYAUCPI> yyaucpi "YYAUCPI"  
                let builder (current : ICell) = ((YYAUCPIModel.Cast _YYAUCPI.cell).Revised
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let YYAUCPI_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _YYAUCPI = Helper.toModelReference<YYAUCPI> yyaucpi "YYAUCPI"  
                let builder (current : ICell) = ((YYAUCPIModel.Cast _YYAUCPI.cell).Update
                                                       ) :> ICell
                let format (o : YYAUCPI) (l:string) = o.ToString() :> obj
    ...
    let YYAUCPI_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((YYAUCPIModel.Cast _YYAUCPI.cell).AddFixings
                                                            _d.cell 
                                                            _v.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
    ...
    let YYAUCPI_addFixings1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((YYAUCPIModel.Cast _YYAUCPI.cell).AddFixings1
                                                            _source.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
                let format (o : YYAUCPI) (l:string) = o.ToString() :> obj
    ...
    let YYAUCPI_allowsNativeFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _YYAUCPI = Helper.toModelReference<YYAUCPI> yyaucpi "YYAUCPI"  
                let builder (current : ICell) = ((YYAUCPIModel.Cast _YYAUCPI.cell).AllowsNativeFixings
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let YYAUCPI_clearFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _YYAUCPI = Helper.toModelReference<YYAUCPI> yyaucpi "YYAUCPI"  
                let builder (current : ICell) = ((YYAUCPIModel.Cast _YYAUCPI.cell).ClearFixings
                                                       ) :> ICell
                let format (o : YYAUCPI) (l:string) = o.ToString() :> obj
    ...
    let YYAUCPI_registerWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((YYAUCPIModel.Cast _YYAUCPI.cell).RegisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : YYAUCPI) (l:string) = o.ToString() :> obj
    ...
    let YYAUCPI_timeSeries
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _YYAUCPI = Helper.toModelReference<YYAUCPI> yyaucpi "YYAUCPI"  
                let builder (current : ICell) = ((YYAUCPIModel.Cast _YYAUCPI.cell).TimeSeries
                                                       ) :> ICell
    ...
    let YYAUCPI_unregisterWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _YYAUCPI = Helper.toModelReference<YYAUCPI> yyaucpi "YYAUCPI"  
                let _handler = Helper.toCell<Callback> handler "handler" 
                let builder (current : ICell) = ((YYAUCPIModel.Cast _YYAUCPI.cell).UnregisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : YYAUCPI) (l:string) = o.ToString() :> obj
