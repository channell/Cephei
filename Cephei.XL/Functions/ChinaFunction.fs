...
module ChinaFunction =
    ...
    let China_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _market = Helper.toCell<China.Market> market "market" true
    ...
    *)
    [<ExcelFunction(Name="_China_advance1", Description="Create a China",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let China_advance1
        ([<ExcelArgument(Name="Mnemonic",Description = "Identifer for the value")>] 
         mnemonic : string)
        ([<ExcelArgument(Name="China",Description = "Reference to China")>] 
