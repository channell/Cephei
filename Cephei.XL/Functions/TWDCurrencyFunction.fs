    ...
    let TWDCurrency_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.TWDCurrency ()
                                                       ) :> ICell
    ...
    let TWDCurrency_code
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TWDCurrency = Helper.toModelReference<TWDCurrency> twdcurrency "TWDCurrency"  
                let builder (current : ICell) = ((TWDCurrencyModel.Cast _TWDCurrency.cell).Code
                                                       ) :> ICell
    ...
    let TWDCurrency_empty
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TWDCurrency = Helper.toModelReference<TWDCurrency> twdcurrency "TWDCurrency"  
                let builder (current : ICell) = ((TWDCurrencyModel.Cast _TWDCurrency.cell).Empty
                                                       ) :> ICell
    ...
    let TWDCurrency_Equals
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((TWDCurrencyModel.Cast _TWDCurrency.cell).Equals
                                                            _o.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let TWDCurrency_format
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TWDCurrency = Helper.toModelReference<TWDCurrency> twdcurrency "TWDCurrency"  
                let builder (current : ICell) = ((TWDCurrencyModel.Cast _TWDCurrency.cell).Format
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let TWDCurrency_fractionsPerUnit
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TWDCurrency = Helper.toModelReference<TWDCurrency> twdcurrency "TWDCurrency"  
                let builder (current : ICell) = ((TWDCurrencyModel.Cast _TWDCurrency.cell).FractionsPerUnit
                                                       ) :> ICell
    ...
    let TWDCurrency_fractionSymbol
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TWDCurrency = Helper.toModelReference<TWDCurrency> twdcurrency "TWDCurrency"  
                let builder (current : ICell) = ((TWDCurrencyModel.Cast _TWDCurrency.cell).FractionSymbol
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let TWDCurrency_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TWDCurrency = Helper.toModelReference<TWDCurrency> twdcurrency "TWDCurrency"  
                let builder (current : ICell) = ((TWDCurrencyModel.Cast _TWDCurrency.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let TWDCurrency_numericCode
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TWDCurrency = Helper.toModelReference<TWDCurrency> twdcurrency "TWDCurrency"  
                let builder (current : ICell) = ((TWDCurrencyModel.Cast _TWDCurrency.cell).NumericCode
                                                       ) :> ICell
                let format (o : int) (l:string) = o :> obj
    ...
    let TWDCurrency_rounding
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TWDCurrency = Helper.toModelReference<TWDCurrency> twdcurrency "TWDCurrency"  
                let builder (current : ICell) = ((TWDCurrencyModel.Cast _TWDCurrency.cell).Rounding
                                                       ) :> ICell
    ...
    let TWDCurrency_symbol
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TWDCurrency = Helper.toModelReference<TWDCurrency> twdcurrency "TWDCurrency"  
                let builder (current : ICell) = ((TWDCurrencyModel.Cast _TWDCurrency.cell).Symbol
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let TWDCurrency_ToString
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TWDCurrency = Helper.toModelReference<TWDCurrency> twdcurrency "TWDCurrency"  
                let builder (current : ICell) = ((TWDCurrencyModel.Cast _TWDCurrency.cell).ToString
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let TWDCurrency_triangulationCurrency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _TWDCurrency = Helper.toModelReference<TWDCurrency> twdcurrency "TWDCurrency"  
                let builder (current : ICell) = ((TWDCurrencyModel.Cast _TWDCurrency.cell).TriangulationCurrency
                                                       ) :> ICell
