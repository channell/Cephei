...
module CubicSplineOvershootingMinimization2Function =
    ...
    *)
    ...
    let CubicSplineOvershootingMinimization2_create
        ([<ExcelArgument(Name="Mnemonic",Description = "CubicSplineOvershootingMinimization2")>] 
         mnemonic : string)
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = withMnemonic mnemonic (Fun.CubicSplineOvershootingMinimization2 
                                                            _xBegin.cell 
                                                            _size.cell 
                                                            _yBegin.cell 
                                                       ) :> ICell
    ...
    let CubicSplineOvershootingMinimization2_aCoefficients
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = withMnemonic mnemonic ((CubicSplineOvershootingMinimization2Model.Cast _CubicSplineOvershootingMinimization2.cell).ACoefficients
                                                       ) :> ICell
    ...
    let CubicSplineOvershootingMinimization2_bCoefficients
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CubicSplineOvershootingMinimization2 = Helper.toCell<CubicSplineOvershootingMinimization2> cubicsplineovershootingminimization2 "CubicSplineOvershootingMinimization2"  
                let builder (current : ICell) = withMnemonic mnemonic ((CubicSplineOvershootingMinimization2Model.Cast _CubicSplineOvershootingMinimization2.cell).BCoefficients
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let CubicSplineOvershootingMinimization2_cCoefficients
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CubicSplineOvershootingMinimization2 = Helper.toCell<CubicSplineOvershootingMinimization2> cubicsplineovershootingminimization2 "CubicSplineOvershootingMinimization2"  
                let builder (current : ICell) = withMnemonic mnemonic ((CubicSplineOvershootingMinimization2Model.Cast _CubicSplineOvershootingMinimization2.cell).CCoefficients
                                                       ) :> ICell
                let format (i : Generic.List<double>) (l : string) = (Helper.Range.fromArray (i.ToArray()) l)
    ...
    let CubicSplineOvershootingMinimization2_derivative
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = withMnemonic mnemonic ((CubicSplineOvershootingMinimization2Model.Cast _CubicSplineOvershootingMinimization2.cell).Derivative
                                                            _x.cell 
    ...
    let CubicSplineOvershootingMinimization2_empty
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CubicSplineOvershootingMinimization2 = Helper.toCell<CubicSplineOvershootingMinimization2> cubicsplineovershootingminimization2 "CubicSplineOvershootingMinimization2"  
                let builder (current : ICell) = withMnemonic mnemonic ((CubicSplineOvershootingMinimization2Model.Cast _CubicSplineOvershootingMinimization2.cell).Empty
                                                       ) :> ICell
    ...
    let CubicSplineOvershootingMinimization2_primitive
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _x = Helper.toCell<double> x "x" 
                let _allowExtrapolation = Helper.toCell<bool> allowExtrapolation "allowExtrapolation" 
                let builder (current : ICell) = withMnemonic mnemonic ((CubicSplineOvershootingMinimization2Model.Cast _CubicSplineOvershootingMinimization2.cell).Primitive
                                                            _x.cell 
                                                            _allowExtrapolation.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let CubicSplineOvershootingMinimization2_secondDerivative
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _x = Helper.toCell<double> x "x" 
                let _allowExtrapolation = Helper.toCell<bool> allowExtrapolation "allowExtrapolation" 
                let builder (current : ICell) = withMnemonic mnemonic ((CubicSplineOvershootingMinimization2Model.Cast _CubicSplineOvershootingMinimization2.cell).SecondDerivative
                                                            _x.cell 
                                                            _allowExtrapolation.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let CubicSplineOvershootingMinimization2_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CubicSplineOvershootingMinimization2 = Helper.toCell<CubicSplineOvershootingMinimization2> cubicsplineovershootingminimization2 "CubicSplineOvershootingMinimization2"  
                let builder (current : ICell) = withMnemonic mnemonic ((CubicSplineOvershootingMinimization2Model.Cast _CubicSplineOvershootingMinimization2.cell).Update
                                                       ) :> ICell
    ...
    let CubicSplineOvershootingMinimization2_value1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _x = Helper.toCell<double> x "x" 
                let _allowExtrapolation = Helper.toCell<bool> allowExtrapolation "allowExtrapolation" 
                let builder (current : ICell) = withMnemonic mnemonic ((CubicSplineOvershootingMinimization2Model.Cast _CubicSplineOvershootingMinimization2.cell).Value1
                                                            _x.cell 
                                                            _allowExtrapolation.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let CubicSplineOvershootingMinimization2_value
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CubicSplineOvershootingMinimization2 = Helper.toCell<CubicSplineOvershootingMinimization2> cubicsplineovershootingminimization2 "CubicSplineOvershootingMinimization2"  
                let _x = Helper.toCell<double> x "x" 
                let builder (current : ICell) = withMnemonic mnemonic ((CubicSplineOvershootingMinimization2Model.Cast _CubicSplineOvershootingMinimization2.cell).Value
                                                            _x.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let CubicSplineOvershootingMinimization2_xMax
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CubicSplineOvershootingMinimization2 = Helper.toCell<CubicSplineOvershootingMinimization2> cubicsplineovershootingminimization2 "CubicSplineOvershootingMinimization2"  
                let builder (current : ICell) = withMnemonic mnemonic ((CubicSplineOvershootingMinimization2Model.Cast _CubicSplineOvershootingMinimization2.cell).XMax
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let CubicSplineOvershootingMinimization2_xMin
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CubicSplineOvershootingMinimization2 = Helper.toCell<CubicSplineOvershootingMinimization2> cubicsplineovershootingminimization2 "CubicSplineOvershootingMinimization2"  
                let builder (current : ICell) = withMnemonic mnemonic ((CubicSplineOvershootingMinimization2Model.Cast _CubicSplineOvershootingMinimization2.cell).XMin
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let CubicSplineOvershootingMinimization2_allowsExtrapolation
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CubicSplineOvershootingMinimization2 = Helper.toCell<CubicSplineOvershootingMinimization2> cubicsplineovershootingminimization2 "CubicSplineOvershootingMinimization2"  
                let builder (current : ICell) = withMnemonic mnemonic ((CubicSplineOvershootingMinimization2Model.Cast _CubicSplineOvershootingMinimization2.cell).AllowsExtrapolation
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let CubicSplineOvershootingMinimization2_disableExtrapolation
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = withMnemonic mnemonic ((CubicSplineOvershootingMinimization2Model.Cast _CubicSplineOvershootingMinimization2.cell).DisableExtrapolation
                                                            _b.cell 
                                                       ) :> ICell
                let format (o : CubicSplineOvershootingMinimization2) (l:string) = o.ToString() :> obj
    ...
    let CubicSplineOvershootingMinimization2_enableExtrapolation
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CubicSplineOvershootingMinimization2 = Helper.toCell<CubicSplineOvershootingMinimization2> cubicsplineovershootingminimization2 "CubicSplineOvershootingMinimization2"  
                let _b = Helper.toCell<bool> b "b" 
                let builder (current : ICell) = withMnemonic mnemonic ((CubicSplineOvershootingMinimization2Model.Cast _CubicSplineOvershootingMinimization2.cell).EnableExtrapolation
                                                            _b.cell 
                                                       ) :> ICell
                let format (o : CubicSplineOvershootingMinimization2) (l:string) = o.ToString() :> obj
    ...
    let CubicSplineOvershootingMinimization2_extrapolate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CubicSplineOvershootingMinimization2 = Helper.toCell<CubicSplineOvershootingMinimization2> cubicsplineovershootingminimization2 "CubicSplineOvershootingMinimization2"  
                let builder (current : ICell) = withMnemonic mnemonic ((CubicSplineOvershootingMinimization2Model.Cast _CubicSplineOvershootingMinimization2.cell).Extrapolate
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                Model.specify 
                    ...
                    ; source =  (fun () -> "cell Generic.List<CubicSplineOvershootingMinimization2>(" + (Helper.sourceFoldArray (s) + ")"))
