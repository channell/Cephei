...
module EURLibor9MFunction =
    ...
    let EURLibor9M_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.EURLibor9M 
                                                            _h.cell 
                                                       ) :> ICell
    ...
    let EURLibor9M_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.EURLibor9M1 ()
                                                       ) :> ICell
                let format (i : ICell) (l:string) = Helper.Range.fromModel (i :?> ICell<EURLibor9M>) l
    ...
    *)
    ...
    let EURLibor9M_maturityDate
        ([<ExcelArgument(Name="Mnemonic",Description = "Identifier for Cell")>] 
         mnemonic : string)
        ([<ExcelArgument(Name="EURLibor9M",Description = "EURLibor9M")>] 
         eurlibor9m : obj)
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor9M = Helper.toModelReference<EURLibor9M> eurlibor9m "EURLibor9M"  
                let _valueDate = Helper.toCell<Date> valueDate "valueDate" 
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).MaturityDate
                                                            _valueDate.cell 
                                                       ) :> ICell
    ...
    let EURLibor9M_valueDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).ValueDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let EURLibor9M_businessDayConvention
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor9M = Helper.toModelReference<EURLibor9M> eurlibor9m "EURLibor9M"  
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).BusinessDayConvention
                                                       ) :> ICell
    ...
    let EURLibor9M_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).Clone
                                                            _forwarding.cell 
                                                       ) :> ICell
    ...
    let EURLibor9M_endOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor9M = Helper.toModelReference<EURLibor9M> eurlibor9m "EURLibor9M"  
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).EndOfMonth
                                                       ) :> ICell
    ...
    let EURLibor9M_forecastFixing1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).ForecastFixing1
                                                            _d1.cell 
                                                            _d2.cell 
                                                            _t.cell 
                                                       ) :> ICell
    ...
    let EURLibor9M_forecastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor9M = Helper.toModelReference<EURLibor9M> eurlibor9m "EURLibor9M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).ForecastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let EURLibor9M_forwardingTermStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor9M = Helper.toModelReference<EURLibor9M> eurlibor9m "EURLibor9M"  
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).ForwardingTermStructure
                                                       ) :> ICell
    ...
    let EURLibor9M_currency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor9M = Helper.toModelReference<EURLibor9M> eurlibor9m "EURLibor9M"  
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).Currency
                                                       ) :> ICell
    ...
    let EURLibor9M_dayCounter
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor9M = Helper.toModelReference<EURLibor9M> eurlibor9m "EURLibor9M"  
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).DayCounter
                                                       ) :> ICell
    ...
    let EURLibor9M_familyName
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor9M = Helper.toModelReference<EURLibor9M> eurlibor9m "EURLibor9M"  
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).FamilyName
                                                       ) :> ICell
    ...
    let EURLibor9M_fixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).Fixing
                                                            _fixingDate.cell 
    ...
    let EURLibor9M_fixingCalendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor9M = Helper.toModelReference<EURLibor9M> eurlibor9m "EURLibor9M"  
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).FixingCalendar
                                                       ) :> ICell
    ...
    let EURLibor9M_fixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor9M = Helper.toModelReference<EURLibor9M> eurlibor9m "EURLibor9M"  
                let _valueDate = Helper.toCell<Date> valueDate "valueDate" 
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).FixingDate
                                                            _valueDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let EURLibor9M_fixingDays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor9M = Helper.toModelReference<EURLibor9M> eurlibor9m "EURLibor9M"  
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).FixingDays
                                                       ) :> ICell
    ...
    let EURLibor9M_isValidFixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor9M = Helper.toModelReference<EURLibor9M> eurlibor9m "EURLibor9M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).IsValidFixingDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let EURLibor9M_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor9M = Helper.toModelReference<EURLibor9M> eurlibor9m "EURLibor9M"  
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let EURLibor9M_pastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor9M = Helper.toModelReference<EURLibor9M> eurlibor9m "EURLibor9M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).PastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
    ...
    let EURLibor9M_tenor
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor9M = Helper.toModelReference<EURLibor9M> eurlibor9m "EURLibor9M"  
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).Tenor
                                                       ) :> ICell
    ...
    let EURLibor9M_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor9M = Helper.toModelReference<EURLibor9M> eurlibor9m "EURLibor9M"  
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).Update
                                                       ) :> ICell
    ...
    let EURLibor9M_addFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).AddFixing
                                                            _d.cell 
                                                            _v.cell 
    ...
    let EURLibor9M_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).AddFixings
                                                            _d.cell 
                                                            _v.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
    ...
    let EURLibor9M_addFixings1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).AddFixings1
                                                            _source.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
                let format (o : EURLibor9M) (l:string) = o.ToString() :> obj
    ...
    let EURLibor9M_allowsNativeFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor9M = Helper.toModelReference<EURLibor9M> eurlibor9m "EURLibor9M"  
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).AllowsNativeFixings
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let EURLibor9M_clearFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor9M = Helper.toModelReference<EURLibor9M> eurlibor9m "EURLibor9M"  
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).ClearFixings
                                                       ) :> ICell
                let format (o : EURLibor9M) (l:string) = o.ToString() :> obj
    ...
    let EURLibor9M_registerWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).RegisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : EURLibor9M) (l:string) = o.ToString() :> obj
    ...
    let EURLibor9M_timeSeries
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor9M = Helper.toModelReference<EURLibor9M> eurlibor9m "EURLibor9M"  
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).TimeSeries
                                                       ) :> ICell
    ...
    let EURLibor9M_unregisterWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor9M = Helper.toModelReference<EURLibor9M> eurlibor9m "EURLibor9M"  
                let _handler = Helper.toCell<Callback> handler "handler" 
                let builder (current : ICell) = ((EURLibor9MModel.Cast _EURLibor9M.cell).UnregisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : EURLibor9M) (l:string) = o.ToString() :> obj
    ...
    let EURLibor9M_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (new Cephei.Cell.List<EURLibor9M> (c)) :> ICell
                let format (i : Cephei.Cell.List<EURLibor9M>) (l : string) = Helper.Range.fromModelList i l

                Model.specify 
                    { mnemonic = Model.formatMnemonic mnemonic
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "(new Cephei.Cell.List<EURLibor9M>(" + (Helper.sourceFoldArray (s) + "))"))
