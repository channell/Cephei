...
module CanadaFunction =
    ...
    *)
    ...
    let Canada_create1
        ([<ExcelArgument(Name="Mnemonic",Description = "Canada")>] 
         mnemonic : string)
        = 
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = withMnemonic mnemonic (Fun.Canada1 () 
                                                       ) :> ICell
    ...
    *)
    ...
    let Canada_create
        ([<ExcelArgument(Name="Mnemonic",Description = "Canada")>] 
         mnemonic : string)
        ([<ExcelArgument(Name="m",Description = "Canada.Market")>] 
         m : obj)
        = 
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = withMnemonic mnemonic (Fun.Canada
                                                            _m.cell 
                                                       ) :> ICell
                let format (i : ICell) (l:string) = Helper.Range.fromModel (i :?> ICell<Canada>) l
    ...
    let Canada_addedHolidays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = withMnemonic mnemonic ((CanadaModel.Cast _Canada.cell).AddedHolidays
                                                       ) :> ICell
    ...
    let Canada_addHoliday
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = withMnemonic mnemonic ((CanadaModel.Cast _Canada.cell).AddHoliday
                                                            _d.cell 
                                                       ) :> ICell
    ...
    let Canada_adjust
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = withMnemonic mnemonic ((CanadaModel.Cast _Canada.cell).Adjust
                                                            _d.cell 
                                                            _c.cell 
                                                       ) :> ICell
    ...
    let Canada_advance1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = withMnemonic mnemonic ((CanadaModel.Cast _Canada.cell).Advance1
                                                            _d.cell 
                                                            _n.cell 
                                                            _unit.cell 
                                                            _c.cell 
    ...
    let Canada_advance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _c = Helper.toCell<BusinessDayConvention> c "c" 
                let _endOfMonth = Helper.toCell<bool> endOfMonth "endOfMonth" 
                let builder (current : ICell) = withMnemonic mnemonic ((CanadaModel.Cast _Canada.cell).Advance
                                                            _d.cell 
                                                            _p.cell 
                                                            _c.cell 
                                                            _endOfMonth.cell 
    ...
    let Canada_businessDaysBetween
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = withMnemonic mnemonic ((CanadaModel.Cast _Canada.cell).BusinessDaysBetween
                                                            _from.cell 
                                                            _To.cell 
                                                            _includeFirst.cell 
                                                            _includeLast.cell 
    ...
    let Canada_calendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Canada = Helper.toCell<Canada> canada "Canada"  
                let builder (current : ICell) = withMnemonic mnemonic ((CanadaModel.Cast _Canada.cell).Calendar
                                                       ) :> ICell
    ...
    let Canada_empty
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Canada = Helper.toCell<Canada> canada "Canada"  
                let builder (current : ICell) = withMnemonic mnemonic ((CanadaModel.Cast _Canada.cell).Empty
                                                       ) :> ICell
    ...
    let Canada_endOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Canada = Helper.toCell<Canada> canada "Canada"  
                let _d = Helper.toCell<Date> d "d" 
                let builder (current : ICell) = withMnemonic mnemonic ((CanadaModel.Cast _Canada.cell).EndOfMonth
                                                            _d.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let Canada_Equals
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = withMnemonic mnemonic ((CanadaModel.Cast _Canada.cell).Equals
                                                            _o.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Canada_isBusinessDay
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Canada = Helper.toCell<Canada> canada "Canada"  
                let _d = Helper.toCell<Date> d "d" 
                let builder (current : ICell) = withMnemonic mnemonic ((CanadaModel.Cast _Canada.cell).IsBusinessDay
                                                            _d.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Canada_isEndOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Canada = Helper.toCell<Canada> canada "Canada"  
                let _d = Helper.toCell<Date> d "d" 
                let builder (current : ICell) = withMnemonic mnemonic ((CanadaModel.Cast _Canada.cell).IsEndOfMonth
                                                            _d.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Canada_isHoliday
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Canada = Helper.toCell<Canada> canada "Canada"  
                let _d = Helper.toCell<Date> d "d" 
                let builder (current : ICell) = withMnemonic mnemonic ((CanadaModel.Cast _Canada.cell).IsHoliday
                                                            _d.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Canada_isWeekend
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = withMnemonic mnemonic ((CanadaModel.Cast _Canada.cell).IsWeekend
                                                            _w.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Canada_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Canada = Helper.toCell<Canada> canada "Canada"  
                let builder (current : ICell) = withMnemonic mnemonic ((CanadaModel.Cast _Canada.cell).Name
                                                       ) :> ICell
    ...
    let Canada_removedHolidays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Canada = Helper.toCell<Canada> canada "Canada"  
                let builder (current : ICell) = withMnemonic mnemonic ((CanadaModel.Cast _Canada.cell).RemovedHolidays
                                                       ) :> ICell
                let format (i : Generic.List<ICell<Date>>) (l : string) = Helper.Range.fromModelList i l
    ...
    let Canada_removeHoliday
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Canada = Helper.toCell<Canada> canada "Canada"  
                let _d = Helper.toCell<Date> d "d" 
                let builder (current : ICell) = withMnemonic mnemonic ((CanadaModel.Cast _Canada.cell).RemoveHoliday
                                                            _d.cell 
                                                       ) :> ICell
                let format (o : Canada) (l:string) = o.ToString() :> obj
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                Model.specify 
                    ...
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source =  (fun () -> "cell Generic.List<Canada>(" + (Helper.sourceFoldArray (s) + ")"))
