    ...
    let Euribor2M_businessDayConvention
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).BusinessDayConvention
                                                       ) :> ICell
    ...
    let Euribor2M_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).Clone
                                                            _forwarding.cell 
                                                       ) :> ICell
    ...
    let Euribor2M_endOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2M = Helper.toCell<Euribor2M> euribor2m "Euribor2M"  
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).EndOfMonth
                                                       ) :> ICell
    ...
    let Euribor2M_forecastFixing1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).ForecastFixing1
                                                            _d1.cell 
                                                            _d2.cell 
                                                            _t.cell 
                                                       ) :> ICell
    ...
    let Euribor2M_forecastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).ForecastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let Euribor2M_forwardingTermStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2M = Helper.toCell<Euribor2M> euribor2m "Euribor2M"  
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).ForwardingTermStructure
                                                       ) :> ICell
    ...
    let Euribor2M_maturityDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).MaturityDate
                                                            _valueDate.cell 
                                                       ) :> ICell
    ...
    let Euribor2M_currency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2M = Helper.toCell<Euribor2M> euribor2m "Euribor2M"  
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).Currency
                                                       ) :> ICell
    ...
    let Euribor2M_dayCounter
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2M = Helper.toCell<Euribor2M> euribor2m "Euribor2M"  
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).DayCounter
                                                       ) :> ICell
    ...
    let Euribor2M_familyName
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2M = Helper.toCell<Euribor2M> euribor2m "Euribor2M"  
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).FamilyName
                                                       ) :> ICell
    ...
    let Euribor2M_fixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).Fixing
                                                            _fixingDate.cell 
    ...
    let Euribor2M_fixingCalendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2M = Helper.toCell<Euribor2M> euribor2m "Euribor2M"  
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).FixingCalendar
                                                       ) :> ICell
    ...
    let Euribor2M_fixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2M = Helper.toCell<Euribor2M> euribor2m "Euribor2M"  
                let _valueDate = Helper.toCell<Date> valueDate "valueDate" 
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).FixingDate
                                                            _valueDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let Euribor2M_fixingDays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2M = Helper.toCell<Euribor2M> euribor2m "Euribor2M"  
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).FixingDays
                                                       ) :> ICell
    ...
    let Euribor2M_isValidFixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2M = Helper.toCell<Euribor2M> euribor2m "Euribor2M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).IsValidFixingDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Euribor2M_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2M = Helper.toCell<Euribor2M> euribor2m "Euribor2M"  
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let Euribor2M_pastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2M = Helper.toCell<Euribor2M> euribor2m "Euribor2M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).PastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
    ...
    let Euribor2M_tenor
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2M = Helper.toCell<Euribor2M> euribor2m "Euribor2M"  
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).Tenor
                                                       ) :> ICell
    ...
    let Euribor2M_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2M = Helper.toCell<Euribor2M> euribor2m "Euribor2M"  
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).Update
                                                       ) :> ICell
    ...
    let Euribor2M_valueDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2M = Helper.toCell<Euribor2M> euribor2m "Euribor2M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).ValueDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let Euribor2M_addFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).AddFixing
                                                            _d.cell 
                                                            _v.cell 
    ...
    let Euribor2M_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).AddFixings
                                                            _d.cell 
                                                            _v.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
    ...
    let Euribor2M_addFixings1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).AddFixings1
                                                            _source.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
                let format (o : Euribor2M) (l:string) = o.ToString() :> obj
    ...
    let Euribor2M_allowsNativeFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2M = Helper.toCell<Euribor2M> euribor2m "Euribor2M"  
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).AllowsNativeFixings
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Euribor2M_clearFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2M = Helper.toCell<Euribor2M> euribor2m "Euribor2M"  
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).ClearFixings
                                                       ) :> ICell
                let format (o : Euribor2M) (l:string) = o.ToString() :> obj
    ...
    let Euribor2M_registerWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).RegisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : Euribor2M) (l:string) = o.ToString() :> obj
    ...
    let Euribor2M_timeSeries
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2M = Helper.toCell<Euribor2M> euribor2m "Euribor2M"  
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).TimeSeries
                                                       ) :> ICell
    ...
    let Euribor2M_unregisterWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Euribor2M = Helper.toCell<Euribor2M> euribor2m "Euribor2M"  
                let _handler = Helper.toCell<Callback> handler "handler" 
                let builder () = withMnemonic mnemonic ((Euribor2MModel.Cast _Euribor2M.cell).UnregisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : Euribor2M) (l:string) = o.ToString() :> obj
