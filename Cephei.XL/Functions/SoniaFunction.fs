    ...
    let Sonia_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = withMnemonic mnemonic (Fun.Sonia 
                                                            _h.cell 
                                                       ) :> ICell
    ...
    let Sonia_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _h = Helper.toHandle<YieldTermStructure> h "h" 
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).Clone
                                                            _h.cell 
                                                       ) :> ICell
    ...
    let Sonia_businessDayConvention
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Sonia = Helper.toCell<Sonia> sonia "Sonia"  
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).BusinessDayConvention
                                                       ) :> ICell
    ...
    let Sonia_endOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Sonia = Helper.toCell<Sonia> sonia "Sonia"  
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).EndOfMonth
                                                       ) :> ICell
    ...
    let Sonia_forecastFixing1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).ForecastFixing1
                                                            _d1.cell 
                                                            _d2.cell 
                                                            _t.cell 
                                                       ) :> ICell
    ...
    let Sonia_forecastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).ForecastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let Sonia_forwardingTermStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Sonia = Helper.toCell<Sonia> sonia "Sonia"  
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).ForwardingTermStructure
                                                       ) :> ICell
    ...
    let Sonia_maturityDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).MaturityDate
                                                            _valueDate.cell 
                                                       ) :> ICell
    ...
    let Sonia_currency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Sonia = Helper.toCell<Sonia> sonia "Sonia"  
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).Currency
                                                       ) :> ICell
    ...
    let Sonia_dayCounter
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Sonia = Helper.toCell<Sonia> sonia "Sonia"  
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).DayCounter
                                                       ) :> ICell
    ...
    let Sonia_familyName
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Sonia = Helper.toCell<Sonia> sonia "Sonia"  
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).FamilyName
                                                       ) :> ICell
    ...
    let Sonia_fixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).Fixing
                                                            _fixingDate.cell 
    ...
    let Sonia_fixingCalendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Sonia = Helper.toCell<Sonia> sonia "Sonia"  
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).FixingCalendar
                                                       ) :> ICell
    ...
    let Sonia_fixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Sonia = Helper.toCell<Sonia> sonia "Sonia"  
                let _valueDate = Helper.toCell<Date> valueDate "valueDate" 
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).FixingDate
                                                            _valueDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let Sonia_fixingDays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Sonia = Helper.toCell<Sonia> sonia "Sonia"  
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).FixingDays
                                                       ) :> ICell
    ...
    let Sonia_isValidFixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Sonia = Helper.toCell<Sonia> sonia "Sonia"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).IsValidFixingDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Sonia_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Sonia = Helper.toCell<Sonia> sonia "Sonia"  
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let Sonia_pastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Sonia = Helper.toCell<Sonia> sonia "Sonia"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).PastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
    ...
    let Sonia_tenor
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Sonia = Helper.toCell<Sonia> sonia "Sonia"  
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).Tenor
                                                       ) :> ICell
    ...
    let Sonia_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Sonia = Helper.toCell<Sonia> sonia "Sonia"  
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).Update
                                                       ) :> ICell
    ...
    let Sonia_valueDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Sonia = Helper.toCell<Sonia> sonia "Sonia"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).ValueDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let Sonia_addFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).AddFixing
                                                            _d.cell 
                                                            _v.cell 
    ...
    let Sonia_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).AddFixings
                                                            _d.cell 
                                                            _v.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
    ...
    let Sonia_addFixings1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).AddFixings1
                                                            _source.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
                let format (o : Sonia) (l:string) = o.ToString() :> obj
    ...
    let Sonia_allowsNativeFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Sonia = Helper.toCell<Sonia> sonia "Sonia"  
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).AllowsNativeFixings
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Sonia_clearFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Sonia = Helper.toCell<Sonia> sonia "Sonia"  
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).ClearFixings
                                                       ) :> ICell
                let format (o : Sonia) (l:string) = o.ToString() :> obj
    ...
    let Sonia_registerWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).RegisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : Sonia) (l:string) = o.ToString() :> obj
    ...
    let Sonia_timeSeries
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Sonia = Helper.toCell<Sonia> sonia "Sonia"  
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).TimeSeries
                                                       ) :> ICell
    ...
    let Sonia_unregisterWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Sonia = Helper.toCell<Sonia> sonia "Sonia"  
                let _handler = Helper.toCell<Callback> handler "handler" 
                let builder (current : ICell) = withMnemonic mnemonic ((SoniaModel.Cast _Sonia.cell).UnregisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : Sonia) (l:string) = o.ToString() :> obj
    ...
    let Sonia_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let l = new Cephei.Cell.List<Sonia> (c)
                ...
                Model.specify 
                    ...
                    ; source =  (fun () -> "cell Generic.List<Sonia>(" + (Helper.sourceFoldArray (s) + ")"))
