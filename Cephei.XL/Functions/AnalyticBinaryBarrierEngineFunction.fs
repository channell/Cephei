    ...
    let AnalyticBinaryBarrierEngine_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.AnalyticBinaryBarrierEngine 
                                                            _Process.cell 
    ...
    let AnalyticBinaryBarrierEngine_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<AnalyticBinaryBarrierEngine>) (l : string) = Helper.Range.fromModelList i l
