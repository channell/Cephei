    ...
    let BlackStyleSwaptionEngine_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.BlackStyleSwaptionEngine 
                                                            _discountCurve.cell 
                                                            _volatility.cell 
                                                            _displacement.cell 
                                                            _model.cell 
    ...
    let BlackStyleSwaptionEngine_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _model = Helper.toDefault<CashAnnuityModel> model "model" CashAnnuityModel.DiscountCurve
                let _evaluationDate = Helper.toCell<Date> evaluationDate "evaluationDate"
                let builder (current : ICell) = (Fun.BlackStyleSwaptionEngine1 
                                                            _discountCurve.cell 
                                                            _vol.cell 
                                                            _dc.cell 
                                                            _displacement.cell 
    ...
    let BlackStyleSwaptionEngine_create2
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _model = Helper.toDefault<CashAnnuityModel> model "model" CashAnnuityModel.DiscountCurve
                let _evaluationDate = Helper.toCell<Date> evaluationDate "evaluationDate"
                let builder (current : ICell) = (Fun.BlackStyleSwaptionEngine2 
                                                            _discountCurve.cell 
                                                            _vol.cell 
                                                            _dc.cell 
                                                            _displacement.cell 
    ...
    let BlackStyleSwaptionEngine_termStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _BlackStyleSwaptionEngine = Helper.toModelReference<BlackStyleSwaptionEngine> blackstyleswaptionengine "BlackStyleSwaptionEngine"  
                let builder (current : ICell) = ((BlackStyleSwaptionEngineModel.Cast _BlackStyleSwaptionEngine.cell).TermStructure
                                                       ) :> ICell
    ...
    let BlackStyleSwaptionEngine_volatility
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _BlackStyleSwaptionEngine = Helper.toModelReference<BlackStyleSwaptionEngine> blackstyleswaptionengine "BlackStyleSwaptionEngine"  
                let builder (current : ICell) = ((BlackStyleSwaptionEngineModel.Cast _BlackStyleSwaptionEngine.cell).Volatility
                                                       ) :> ICell
    ...
    let BlackStyleSwaptionEngine_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<BlackStyleSwaptionEngine>) (l : string) = Helper.Range.fromModelList i l
