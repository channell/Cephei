    ...
    let InterpolatingCPICapFloorEngine_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _InterpolatingCPICapFloorEngine = Helper.toModelReference<InterpolatingCPICapFloorEngine> interpolatingcpicapfloorengine "InterpolatingCPICapFloorEngine"  
    ...
    let InterpolatingCPICapFloorEngine_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<InterpolatingCPICapFloorEngine>) (l : string) = Helper.Range.fromModelList i l
