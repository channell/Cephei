...
module EURLibor4MFunction =
    ...
    let EURLibor4M_maturityDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).MaturityDate
                                                            _valueDate.cell 
                                                       ) :> ICell
    ...
    let EURLibor4M_valueDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).ValueDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let EURLibor4M_businessDayConvention
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor4M = Helper.toCell<EURLibor4M> eurlibor4m "EURLibor4M"  
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).BusinessDayConvention
                                                       ) :> ICell
    ...
    let EURLibor4M_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).Clone
                                                            _forwarding.cell 
                                                       ) :> ICell
    ...
    let EURLibor4M_endOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor4M = Helper.toCell<EURLibor4M> eurlibor4m "EURLibor4M"  
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).EndOfMonth
                                                       ) :> ICell
    ...
    *)
    [<ExcelFunction(Name="_EURLibor4M_forecastFixing1", Description="Create a EURLibor4M",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let EURLibor4M_forecastFixing1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).ForecastFixing1
                                                            _d1.cell 
                                                            _d2.cell 
                                                            _t.cell 
                                                       ) :> ICell
    ...
    let EURLibor4M_forecastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor4M = Helper.toCell<EURLibor4M> eurlibor4m "EURLibor4M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).ForecastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let EURLibor4M_forwardingTermStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor4M = Helper.toCell<EURLibor4M> eurlibor4m "EURLibor4M"  
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).ForwardingTermStructure
                                                       ) :> ICell
    ...
    let EURLibor4M_currency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor4M = Helper.toCell<EURLibor4M> eurlibor4m "EURLibor4M"  
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).Currency
                                                       ) :> ICell
    ...
    let EURLibor4M_dayCounter
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor4M = Helper.toCell<EURLibor4M> eurlibor4m "EURLibor4M"  
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).DayCounter
                                                       ) :> ICell
    ...
    let EURLibor4M_familyName
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor4M = Helper.toCell<EURLibor4M> eurlibor4m "EURLibor4M"  
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).FamilyName
                                                       ) :> ICell
    ...
    let EURLibor4M_fixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).Fixing
                                                            _fixingDate.cell 
    ...
    let EURLibor4M_fixingCalendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor4M = Helper.toCell<EURLibor4M> eurlibor4m "EURLibor4M"  
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).FixingCalendar
                                                       ) :> ICell
    ...
    let EURLibor4M_fixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor4M = Helper.toCell<EURLibor4M> eurlibor4m "EURLibor4M"  
                let _valueDate = Helper.toCell<Date> valueDate "valueDate" 
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).FixingDate
                                                            _valueDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let EURLibor4M_fixingDays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor4M = Helper.toCell<EURLibor4M> eurlibor4m "EURLibor4M"  
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).FixingDays
                                                       ) :> ICell
    ...
    let EURLibor4M_isValidFixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor4M = Helper.toCell<EURLibor4M> eurlibor4m "EURLibor4M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).IsValidFixingDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let EURLibor4M_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor4M = Helper.toCell<EURLibor4M> eurlibor4m "EURLibor4M"  
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let EURLibor4M_pastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor4M = Helper.toCell<EURLibor4M> eurlibor4m "EURLibor4M"  
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" 
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).PastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
    ...
    let EURLibor4M_tenor
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor4M = Helper.toCell<EURLibor4M> eurlibor4m "EURLibor4M"  
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).Tenor
                                                       ) :> ICell
    ...
    let EURLibor4M_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor4M = Helper.toCell<EURLibor4M> eurlibor4m "EURLibor4M"  
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).Update
                                                       ) :> ICell
    ...
    let EURLibor4M_addFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).AddFixing
                                                            _d.cell 
                                                            _v.cell 
    ...
    let EURLibor4M_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).AddFixings
                                                            _d.cell 
                                                            _v.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
    ...
    *)
    [<ExcelFunction(Name="_EURLibor4M_addFixings1", Description="Create a EURLibor4M",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let EURLibor4M_addFixings1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" 
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).AddFixings1
                                                            _source.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
                let format (o : EURLibor4M) (l:string) = o.ToString() :> obj
    ...
    let EURLibor4M_allowsNativeFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor4M = Helper.toCell<EURLibor4M> eurlibor4m "EURLibor4M"  
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).AllowsNativeFixings
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let EURLibor4M_clearFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor4M = Helper.toCell<EURLibor4M> eurlibor4m "EURLibor4M"  
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).ClearFixings
                                                       ) :> ICell
                let format (o : EURLibor4M) (l:string) = o.ToString() :> obj
    ...
    let EURLibor4M_registerWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).RegisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : EURLibor4M) (l:string) = o.ToString() :> obj
    ...
    let EURLibor4M_timeSeries
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor4M = Helper.toCell<EURLibor4M> eurlibor4m "EURLibor4M"  
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).TimeSeries
                                                       ) :> ICell
    ...
    let EURLibor4M_unregisterWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor4M = Helper.toCell<EURLibor4M> eurlibor4m "EURLibor4M"  
                let _handler = Helper.toCell<Callback> handler "handler" 
                let builder () = withMnemonic mnemonic ((EURLibor4MModel.Cast _EURLibor4M.cell).UnregisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : EURLibor4M) (l:string) = o.ToString() :> obj
