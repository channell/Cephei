    ...
    let DepositRateHelper_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder (current : ICell) = (Fun.DepositRateHelper 
                                                            _rate.cell 
                                                            _tenor.cell 
                                                            _fixingDays.cell 
                                                            _calendar.cell 
    ...
    let DepositRateHelper_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _evaluationDate = Helper.toCell<Date> evaluationDate "evaluationDate"
                let builder (current : ICell) = (Fun.DepositRateHelper1 
                                                            _rate.cell 
                                                            _i.cell 
                                                            _evaluationDate.cell
                                                       ) :> ICell
    ...
    let DepositRateHelper_create2
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _i = Helper.toCell<IborIndex> i "i" 
                let _evaluationDate = Helper.toCell<Date> evaluationDate "evaluationDate"
                let builder (current : ICell) = (Fun.DepositRateHelper2 
                                                            _rate.cell 
                                                            _i.cell 
                                                            _evaluationDate.cell
                                                       ) :> ICell
    ...
    let DepositRateHelper_create3
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _dayCounter = Helper.toCell<DayCounter> dayCounter "dayCounter" 
                let _evaluationDate = Helper.toCell<Date> evaluationDate "evaluationDate"
                let builder (current : ICell) = (Fun.DepositRateHelper3 
                                                            _rate.cell 
                                                            _tenor.cell 
                                                            _fixingDays.cell 
                                                            _calendar.cell 
    ...
    let DepositRateHelper_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let format (i : Cephei.Cell.List<DepositRateHelper>) (l : string) = Helper.Range.fromModelList i l
