...
(* functions *)
    ...
    let _zc6m = Fun.DepositRateHelper (triv (fun () -> toHandle (_zc6mRate.Box :?> QLNet.Quote))) _zc6mPeriod _fixingDays (triv (fun () -> _calendar.Value :> QLNet.Calendar)) (value BusinessDayConvention.ModifiedFollowing) (value true) (triv (fun () -> _zcBondsDayCounter.Value :> QLNet.DayCounter)) _todaysDate
    ...
    let _zc1y = Fun.DepositRateHelper (triv (fun () -> toHandle (_zc1yRate.Box :?> QLNet.Quote))) _zc1yPeriod _fixingDays (triv (fun () -> _calendar.Value :> QLNet.Calendar)) (value BusinessDayConvention.ModifiedFollowing) (value true) (triv (fun () -> _zcBondsDayCounter.Value :> QLNet.DayCounter)) _todaysDate
    ...
    let _zc3m = Fun.DepositRateHelper (triv (fun () -> toHandle (_zc3mRate.Box :?> QLNet.Quote))) _zc3mPeriod _fixingDays (triv (fun () -> _calendar.Value :> QLNet.Calendar)) (value BusinessDayConvention.ModifiedFollowing) (value true) (triv (fun () -> _zcBondsDayCounter.Value :> QLNet.DayCounter)) _todaysDate
    let _bondInstruments = (new Cephei.Cell.List<RateHelper>([|(trivDate (fun () -> _zc3m.Value :> QLNet.RateHelper) (_zc3m :> IDateDependant));(trivDate (fun () -> _zc6m.Value :> QLNet.RateHelper) (_zc6m :> IDateDependant));(trivDate (fun () -> _zc1y.Value :> QLNet.RateHelper) (_zc1y :> IDateDependant));(triv (fun () -> _bondhelper0.Value :> QLNet.RateHelper));(triv (fun () -> _bondhelper1.Value :> QLNet.RateHelper));(triv (fun () -> _bondhelper2.Value :> QLNet.RateHelper));(triv (fun () -> _bondhelper3.Value :> QLNet.RateHelper));(triv (fun () -> _bondhelper4.Value :> QLNet.RateHelper))|]))
    let _bondDiscountingTermStructure = Fun.PiecewiseYieldCurve (triv (fun () -> _discount.Value :> QLNet.ITraits<QLNet.YieldTermStructure>)) _Adjusted _bondInstruments (triv (fun () -> _termStructureDayCounter.Value :> QLNet.DayCounter)) (value (new System.Collections.Generic.List<QLNet.Handle<QLNet.Quote>>())) (value (new System.Collections.Generic.List<QLNet.Date>())) _tolerance (triv (fun () -> _loglinier.Value :> QLNet.IInterpolationFactory)) _todaysDate
    let _Quarterly = Fun.Period2 (value Frequency.Quarterly)
    let _instruments = (new Cephei.Cell.List<RateHelper>([|(trivDate (fun () -> _zc3m.Value :> QLNet.RateHelper) (_zc3m :> IDateDependant));(trivDate (fun () -> _zc6m.Value :> QLNet.RateHelper) (_zc6m :> IDateDependant));(trivDate (fun () -> _zc1y.Value :> QLNet.RateHelper) (_zc1y :> IDateDependant));(triv (fun () -> _bondhelper0.Value :> QLNet.RateHelper));(triv (fun () -> _bondhelper1.Value :> QLNet.RateHelper));(triv (fun () -> _bondhelper2.Value :> QLNet.RateHelper));(triv (fun () -> _bondhelper3.Value :> QLNet.RateHelper));(triv (fun () -> _bondhelper4.Value :> QLNet.RateHelper))|]))
    ...
    let _bondEngine = Fun.DiscountingBondEngine (triv (fun () -> toHandle (_bondDiscountingTermStructure.Value :> QLNet.YieldTermStructure))) (triv (fun () -> toNullable (true))) _Adjusted
    let _forwardStart = Fun.Period (value (Convert.ToInt32(1))) (value TimeUnit.Days)
    let _Actual365Fixed = Fun.Actual365Fixed()

    do this.Bind (triv (fun () -> _bondEngine.Value :> IPricingEngine))
