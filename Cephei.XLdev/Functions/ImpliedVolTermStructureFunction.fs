    ...
    let ImpliedVolTermStructure_accept
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _ImpliedVolTermStructure = Helper.toCell<ImpliedVolTermStructure> impliedvoltermstructure "ImpliedVolTermStructure" true 
    ...
    let ImpliedVolTermStructure_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _originalTS = Helper.toHandle<Handle<BlackVolTermStructure>> originalTS "originalTS" 
    ...
    let ImpliedVolTermStructure_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<ImpliedVolTermStructure> i "value" true) |>
                        Seq.toArray
