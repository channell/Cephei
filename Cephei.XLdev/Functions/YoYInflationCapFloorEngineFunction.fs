...
module YoYInflationCapFloorEngineFunction =
    ...
    *)
    [<ExcelFunction(Name="_YoYInflationCapFloorEngine_calculate", Description="Create a YoYInflationCapFloorEngine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let YoYInflationCapFloorEngine_calculate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_YoYInflationCapFloorEngine.cell :?> YoYInflationCapFloorEngineModel).Calculate
                                                       ) :> ICell
                let format (o : YoYInflationCapFloorEngine) (l:string) = o.ToString() :> obj

                let source = Helper.sourceFold (_YoYInflationCapFloorEngine.source + ".Calculate") 
