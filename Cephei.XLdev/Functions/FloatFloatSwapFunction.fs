    ...
    let FloatFloatSwap_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _cappedRate1 = Helper.toCell<List<Nullable<double>>> cappedRate1 "cappedRate1" true
                let _flooredRate1 = Helper.toCell<List<Nullable<double>>> flooredRate1 "flooredRate1" true
                ...
                let _cappedRate2 = Helper.toCell<List<Nullable<double>>> cappedRate2 "cappedRate2" true
                let _flooredRate2 = Helper.toCell<List<Nullable<double>>> flooredRate2 "flooredRate2" true
                let _paymentConvention1 = Helper.toNullable<Nullable<BusinessDayConvention>> paymentConvention1 "paymentConvention1"
                let _paymentConvention2 = Helper.toNullable<Nullable<BusinessDayConvention>> paymentConvention2 "paymentConvention2"
    ...
    let FloatFloatSwap_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _cappedRate1 = Helper.toNullable<Nullable<double>> cappedRate1 "cappedRate1"
                let _flooredRate1 = Helper.toNullable<Nullable<double>> flooredRate1 "flooredRate1"
                let _gearing2 = Helper.toCell<double> gearing2 "gearing2" true
                let _spread2 = Helper.toCell<double> spread2 "spread2" true
                let _cappedRate2 = Helper.toNullable<Nullable<double>> cappedRate2 "cappedRate2"
                let _flooredRate2 = Helper.toNullable<Nullable<double>> flooredRate2 "flooredRate2"
                let _paymentConvention1 = Helper.toNullable<Nullable<BusinessDayConvention>> paymentConvention1 "paymentConvention1"
                let _paymentConvention2 = Helper.toNullable<Nullable<BusinessDayConvention>> paymentConvention2 "paymentConvention2"
                let _pricingEngine = Helper.toCell<IPricingEngine> pricingEngine "pricingEngine" true 
                let _evaluationDate = Helper.toCell<Date> evaluationDate "evaluationDate" true 
