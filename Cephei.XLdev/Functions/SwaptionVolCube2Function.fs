    ...
    let SwaptionVolCube2_volSpreads
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SwaptionVolCube2 = Helper.toCell<SwaptionVolCube2> swaptionvolcube2 "SwaptionVolCube2" true 
    ...
    let SwaptionVolCube2_atmStrike
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_SwaptionVolCube2.source + ".AtmStrike1") 
                                               [| _SwaptionVolCube2.source
                                               ;  _optionDate.source
                                               ;  _swapTenor.source
                                               |]
    ...
    let SwaptionVolCube2_blackVariance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_SwaptionVolCube2.source + ".BlackVariance1") 
                                               [| _SwaptionVolCube2.source
                                               ;  _optionDate.source
                                               ;  _swapLength.source
                                               ;  _strike.source
    ...
    let SwaptionVolCube2_blackVariance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_SwaptionVolCube2.source + ".BlackVariance2") 
                                               [| _SwaptionVolCube2.source
                                               ;  _optionTenor.source
                                               ;  _swapLength.source
                                               ;  _strike.source
    ...
    let SwaptionVolCube2_blackVariance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_SwaptionVolCube2.source + ".BlackVariance3") 
                                               [| _SwaptionVolCube2.source
                                               ;  _optionTime.source
                                               ;  _swapTenor.source
                                               ;  _strike.source
    ...
    let SwaptionVolCube2_blackVariance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_SwaptionVolCube2.source + ".BlackVariance4") 
                                               [| _SwaptionVolCube2.source
                                               ;  _optionDate.source
                                               ;  _swapTenor.source
                                               ;  _strike.source
    ...
    let SwaptionVolCube2_blackVariance
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_SwaptionVolCube2.source + ".BlackVariance5") 
                                               [| _SwaptionVolCube2.source
                                               ;  _optionTenor.source
                                               ;  _swapTenor.source
                                               ;  _strike.source
    ...
    let SwaptionVolCube2_shift
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_SwaptionVolCube2.source + ".Shift1") 
                                               [| _SwaptionVolCube2.source
                                               ;  _optionDate.source
                                               ;  _swapTenor.source
                                               ;  _extrapolate.source
    ...
    let SwaptionVolCube2_shift
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_SwaptionVolCube2.source + ".Shift2") 
                                               [| _SwaptionVolCube2.source
                                               ;  _optionDate.source
                                               ;  _swapLength.source
                                               ;  _extrapolate.source
    ...
    let SwaptionVolCube2_shift
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_SwaptionVolCube2.source + ".Shift3") 
                                               [| _SwaptionVolCube2.source
                                               ;  _optionTime.source
                                               ;  _swapLength.source
                                               ;  _extrapolate.source
    ...
    let SwaptionVolCube2_shift
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_SwaptionVolCube2.source + ".Shift4") 
                                               [| _SwaptionVolCube2.source
                                               ;  _optionTenor.source
                                               ;  _swapTenor.source
                                               ;  _extrapolate.source
    ...
    let SwaptionVolCube2_shift
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_SwaptionVolCube2.source + ".Shift5") 
                                               [| _SwaptionVolCube2.source
                                               ;  _optionTenor.source
                                               ;  _swapLength.source
                                               ;  _extrapolate.source
    ...
    let SwaptionVolCube2_smileSection
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_SwaptionVolCube2.source + ".SmileSection1") 
                                               [| _SwaptionVolCube2.source
                                               ;  _optionTime.source
                                               ;  _swapLength.source
                                               ;  _extr.source
    ...
    let SwaptionVolCube2_smileSection
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_SwaptionVolCube2.source + ".SmileSection2") 
                                               [| _SwaptionVolCube2.source
                                               ;  _optionDate.source
                                               ;  _swapTenor.source
                                               ;  _extr.source
    ...
    let SwaptionVolCube2_swapLength
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_SwaptionVolCube2.source + ".SwapLength1") 
                                               [| _SwaptionVolCube2.source
                                               ;  _swapTenor.source
                                               |]
                let hash = Helper.hashFold 
    ...
    let SwaptionVolCube2_volatility
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_SwaptionVolCube2.source + ".Volatility1") 
                                               [| _SwaptionVolCube2.source
                                               ;  _optionDate.source
                                               ;  _swapLength.source
                                               ;  _strike.source
    ...
    let SwaptionVolCube2_volatility
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_SwaptionVolCube2.source + ".Volatility2") 
                                               [| _SwaptionVolCube2.source
                                               ;  _optionTenor.source
                                               ;  _swapTenor.source
                                               ;  _strike.source
    ...
    let SwaptionVolCube2_volatility
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_SwaptionVolCube2.source + ".Volatility3") 
                                               [| _SwaptionVolCube2.source
                                               ;  _optionTenor.source
                                               ;  _swapLength.source
                                               ;  _strike.source
    ...
    let SwaptionVolCube2_volatility
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_SwaptionVolCube2.source + ".Volatility4") 
                                               [| _SwaptionVolCube2.source
                                               ;  _optionTime.source
                                               ;  _swapLength.source
                                               ;  _strike.source
    ...
    let SwaptionVolCube2_volatility
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_SwaptionVolCube2.source + ".Volatility5") 
                                               [| _SwaptionVolCube2.source
                                               ;  _optionTime.source
                                               ;  _swapTenor.source
                                               ;  _strike.source
    ...
    let SwaptionVolCube2_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<SwaptionVolCube2> i "value" true) |>
                        Seq.toArray
