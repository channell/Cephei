    ...
    let EURLibor10M_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold "Fun.EURLibor10M1" 
                                               [||]
                let hash = Helper.hashFold 
                                [||]
                Model.specify 
    ...
    let EURLibor10M_maturityDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _EURLibor10M = Helper.toCell<EURLibor10M> eurlibor10m "EURLibor10M" true 
    ...
    let EURLibor10M_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<EURLibor10M> i "value" true) |>
                        Seq.toArray
