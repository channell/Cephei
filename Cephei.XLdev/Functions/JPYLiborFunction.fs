    ...
    let JPYLibor_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold "Fun.JPYLibor" 
                                               [| _tenor.source
                                               ;  _h.source
                                               |]
    ...
    let JPYLibor_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _JPYLibor = Helper.toCell<JPYLibor> jpylibor "JPYLibor" true 
                let _h = Helper.toHandle<Handle<YieldTermStructure>> h "h" 
    ...
    let JPYLibor_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<JPYLibor> i "value" true) |>
                        Seq.toArray
