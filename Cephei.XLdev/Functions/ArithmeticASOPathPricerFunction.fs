    ...
    let ArithmeticASOPathPricer_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold "Fun.ArithmeticASOPathPricer" 
                                               [| _Type.source
                                               ;  _discount.source
                                               |]
    ...
    let ArithmeticASOPathPricer_value
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _ArithmeticASOPathPricer = Helper.toCell<ArithmeticASOPathPricer> arithmeticasopathpricer "ArithmeticASOPathPricer" true 
    ...
    let ArithmeticASOPathPricer_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<ArithmeticASOPathPricer> i "value" true) |>
                        Seq.toArray
