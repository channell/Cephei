    ...
    let MultiAssetOption_delta
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _MultiAssetOption = Helper.toCell<MultiAssetOption> multiassetoption "MultiAssetOption" true 
    ...
    let MultiAssetOption_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<MultiAssetOption> i "value" true) |>
                        Seq.toArray
