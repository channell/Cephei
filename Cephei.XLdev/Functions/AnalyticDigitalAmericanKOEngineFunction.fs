...
module AnalyticDigitalAmericanKOEngineFunction =
    ...
    let AnalyticDigitalAmericanKOEngine_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _engine = Helper.toCell<GeneralizedBlackScholesProcess> engine "engine" true
    ...
    let AnalyticDigitalAmericanKOEngine_knock_in
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _AnalyticDigitalAmericanKOEngine = Helper.toCell<AnalyticDigitalAmericanKOEngine> analyticdigitalamericankoengine "AnalyticDigitalAmericanKOEngine" true 
    ...
    *)
    [<ExcelFunction(Name="_AnalyticDigitalAmericanKOEngine_calculate", Description="Create a AnalyticDigitalAmericanKOEngine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let AnalyticDigitalAmericanKOEngine_calculate
        ([<ExcelArgument(Name="Mnemonic",Description = "Identifer for the value")>] 
         mnemonic : string)
        ([<ExcelArgument(Name="AnalyticDigitalAmericanKOEngine",Description = "Reference to AnalyticDigitalAmericanKOEngine")>] 
         analyticdigitalamericankoengine : obj)
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _AnalyticDigitalAmericanKOEngine = Helper.toCell<AnalyticDigitalAmericanKOEngine> analyticdigitalamericankoengine "AnalyticDigitalAmericanKOEngine" true 
                let builder () = withMnemonic mnemonic ((_AnalyticDigitalAmericanKOEngine.cell :?> AnalyticDigitalAmericanKOEngineModel).Calculate
                                                       ) :> ICell
                let format (o : AnalyticDigitalAmericanKOEngine) (l:string) = o.ToString() :> obj

                let source = Helper.sourceFold (_AnalyticDigitalAmericanKOEngine.source + ".Calculate") 
                                               [| _AnalyticDigitalAmericanKOEngine.source
                                               |]
                let hash = Helper.hashFold 
                                [| _AnalyticDigitalAmericanKOEngine.cell
    ...
    let AnalyticDigitalAmericanKOEngine_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<AnalyticDigitalAmericanKOEngine> i "value" true) |>
                        Seq.toArray
