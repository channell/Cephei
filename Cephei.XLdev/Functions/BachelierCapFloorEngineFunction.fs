...
module BachelierCapFloorEngineFunction =
    ...
    let BachelierCapFloorEngine_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic (Fun.BachelierCapFloorEngine 
                                                            _discountCurve.cell 
                                                            _vol.cell 
                                                            _dc.cell 
                                                       ) :> ICell
                ...
                let source = Helper.sourceFold "Fun.BachelierCapFloorEngine" 
    ...
    let BachelierCapFloorEngine_create2
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _discountCurve = Helper.toHandle<Handle<YieldTermStructure>> discountCurve "discountCurve" 
                let _vol = Helper.toHandle<Handle<OptionletVolatilityStructure>> vol "vol" 
    ...
    *)
    [<ExcelFunction(Name="_BachelierCapFloorEngine_calculate", Description="Create a BachelierCapFloorEngine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let BachelierCapFloorEngine_calculate
        ([<ExcelArgument(Name="Mnemonic",Description = "Identifer for the value")>] 
         mnemonic : string)
        ([<ExcelArgument(Name="BachelierCapFloorEngine",Description = "Reference to BachelierCapFloorEngine")>] 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_BachelierCapFloorEngine.cell :?> BachelierCapFloorEngineModel).Calculate
                                                       ) :> ICell
                let format (o : BachelierCapFloorEngine) (l:string) = o.ToString() :> obj

                let source = Helper.sourceFold (_BachelierCapFloorEngine.source + ".Calculate") 
    ...
    *)
    ...
    let BachelierCapFloorEngine_Range 
        ([<ExcelArgument(Name="Mnemonic",Description = "Identifer for the value")>] 
         mnemonic : string)
        ([<ExcelArgument(Name="Objects",Description = "Identifer for the BachelierCapFloorEngine")>] 
         values : obj[,])
         =
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                Model.specify 
                    ...
                    ; source = "cell Generic.List<BachelierCapFloorEngine>(" + (Helper.sourceFoldArray (s) + ")")
