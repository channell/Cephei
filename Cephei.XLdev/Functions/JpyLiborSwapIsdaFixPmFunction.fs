    ...
    let JpyLiborSwapIsdaFixPm_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _JpyLiborSwapIsdaFixPm = Helper.toCell<JpyLiborSwapIsdaFixPm> jpyliborswapisdafixpm "JpyLiborSwapIsdaFixPm" true 
                let _tenor = Helper.toCell<Period> tenor "tenor" true
    ...
    let JpyLiborSwapIsdaFixPm_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<JpyLiborSwapIsdaFixPm> i "value" true) |>
                        Seq.toArray
