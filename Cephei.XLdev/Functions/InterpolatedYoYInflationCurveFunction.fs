    ...
    let InterpolatedYoYInflationCurve_yoyRate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_InterpolatedYoYInflationCurve.source + ".YoyRate1") 
                                               [| _InterpolatedYoYInflationCurve.source
                                               ;  _d.source
                                               ;  _instObsLag.source
                                               ;  _forceLinearInterpolation.source
    ...
    let InterpolatedYoYInflationCurve_yoyRate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_InterpolatedYoYInflationCurve.source + ".YoyRate2") 
                                               [| _InterpolatedYoYInflationCurve.source
                                               ;  _d.source
                                               ;  _instObsLag.source
                                               |]
    ...
    let InterpolatedYoYInflationCurve_yoyRate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_InterpolatedYoYInflationCurve.source + ".YoyRate3") 
                                               [| _InterpolatedYoYInflationCurve.source
                                               ;  _d.source
                                               |]
                let hash = Helper.hashFold 
