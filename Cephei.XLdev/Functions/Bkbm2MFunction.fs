    ...
    let Bkbm2M_businessDayConvention
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bkbm2M = Helper.toCell<Bkbm2M> bkbm2m "Bkbm2M" true 
    ...
    let Bkbm2M_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_Bkbm2M.source + ".AddFixings1") 
                                               [| _Bkbm2M.source
                                               ;  _source.source
                                               ;  _forceOverwrite.source
                                               |]
    ...
    let Bkbm2M_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<Bkbm2M> i "value" true) |>
                        Seq.toArray
