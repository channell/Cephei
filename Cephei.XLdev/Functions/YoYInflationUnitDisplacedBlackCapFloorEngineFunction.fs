...
module YoYInflationUnitDisplacedBlackCapFloorEngineFunction =
    ...
    *)
    [<ExcelFunction(Name="_YoYInflationUnitDisplacedBlackCapFloorEngine_calculate", Description="Create a YoYInflationUnitDisplacedBlackCapFloorEngine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let YoYInflationUnitDisplacedBlackCapFloorEngine_calculate
        ([<ExcelArgument(Name="Mnemonic",Description = "Identifer for the value")>] 
         mnemonic : string)
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _YoYInflationUnitDisplacedBlackCapFloorEngine = Helper.toCell<YoYInflationUnitDisplacedBlackCapFloorEngine> yoyinflationunitdisplacedblackcapfloorengine "YoYInflationUnitDisplacedBlackCapFloorEngine" true 
                let builder () = withMnemonic mnemonic ((_YoYInflationUnitDisplacedBlackCapFloorEngine.cell :?> YoYInflationUnitDisplacedBlackCapFloorEngineModel).Calculate
                                                       ) :> ICell
                let format (o : YoYInflationUnitDisplacedBlackCapFloorEngine) (l:string) = o.ToString() :> obj

                let source = Helper.sourceFold (_YoYInflationUnitDisplacedBlackCapFloorEngine.source + ".Calculate") 
    ...
    let YoYInflationUnitDisplacedBlackCapFloorEngine_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<YoYInflationUnitDisplacedBlackCapFloorEngine> i "value" true) |>
                        Seq.toArray
