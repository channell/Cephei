...
module FDVanillaEngineFunction =
    ...
    *)
    [<ExcelFunction(Name="_FDVanillaEngine_calculate", Description="Create a FDVanillaEngine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let FDVanillaEngine_calculate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_FDVanillaEngine.cell :?> FDVanillaEngineModel).Calculate
                                                            _r.cell 
                                                       ) :> ICell
                let format (o : FDVanillaEngine) (l:string) = o.ToString() :> obj

                let source = Helper.sourceFold (_FDVanillaEngine.source + ".Calculate") 
