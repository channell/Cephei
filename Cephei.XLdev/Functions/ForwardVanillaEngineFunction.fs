...
module ForwardVanillaEngineFunction =
    ...
    *)
    [<ExcelFunction(Name="_ForwardVanillaEngine_calculate", Description="Create a ForwardVanillaEngine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let ForwardVanillaEngine_calculate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_ForwardVanillaEngine.cell :?> ForwardVanillaEngineModel).Calculate
                                                       ) :> ICell
                let format (o : ForwardVanillaEngine) (l:string) = o.ToString() :> obj

                let source = Helper.sourceFold (_ForwardVanillaEngine.source + ".Calculate") 
