    ...
    let ConvertibleFloatingRateBond_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _creditSpread = Helper.toHandle<Handle<Quote>> creditSpread "creditSpread" 
    ...
    let ConvertibleFloatingRateBond_callability
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _ConvertibleFloatingRateBond = Helper.toCell<ConvertibleFloatingRateBond> convertiblefloatingratebond "ConvertibleFloatingRateBond" true 
    ...
    let ConvertibleFloatingRateBond_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<ConvertibleFloatingRateBond> i "value" true) |>
                        Seq.toArray
