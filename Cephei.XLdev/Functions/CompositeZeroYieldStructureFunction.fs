    ...
    let CompositeZeroYieldStructure_calendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CompositeZeroYieldStructure = Helper.toCell<CompositeZeroYieldStructure> compositezeroyieldstructure "CompositeZeroYieldStructure" true 
    ...
    let CompositeZeroYieldStructure_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _h1 = Helper.toHandle<Handle<YieldTermStructure>> h1 "h1" 
                let _h2 = Helper.toHandle<Handle<YieldTermStructure>> h2 "h2" 
    ...
    let CompositeZeroYieldStructure_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<CompositeZeroYieldStructure> i "value" true) |>
                        Seq.toArray
