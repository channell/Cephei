    ...
    let PiecewiseTimeDependentHestonModel_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _riskFreeRate = Helper.toHandle<Handle<YieldTermStructure>> riskFreeRate "riskFreeRate" 
                let _dividendYield = Helper.toHandle<Handle<YieldTermStructure>> dividendYield "dividendYield" 
                let _s0 = Helper.toHandle<Handle<Quote>> s0 "s0" 
