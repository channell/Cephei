...
module BlackCapFloorEngineFunction =
    ...
    *)
    [<ExcelFunction(Name="_BlackCapFloorEngine_calculate", Description="Create a BlackCapFloorEngine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let BlackCapFloorEngine_calculate
        ([<ExcelArgument(Name="Mnemonic",Description = "Identifer for the value")>] 
         mnemonic : string)
        ([<ExcelArgument(Name="BlackCapFloorEngine",Description = "Reference to BlackCapFloorEngine")>] 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_BlackCapFloorEngine.cell :?> BlackCapFloorEngineModel).Calculate
                                                       ) :> ICell
                let format (o : BlackCapFloorEngine) (l:string) = o.ToString() :> obj

                let source = Helper.sourceFold (_BlackCapFloorEngine.source + ".Calculate") 
    ...
    *)
    ...
    let BlackCapFloorEngine_Range 
        ([<ExcelArgument(Name="Mnemonic",Description = "Identifer for the value")>] 
         mnemonic : string)
        ([<ExcelArgument(Name="Objects",Description = "Identifer for the BlackCapFloorEngine")>] 
         values : obj[,])
         =
