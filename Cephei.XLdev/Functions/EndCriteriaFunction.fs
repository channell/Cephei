    ...
    let EndCriteria_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _maxStationaryStateIterations = Helper.toNullable<Nullable<int>> maxStationaryStateIterations "maxStationaryStateIterations"
                ...
                let _gradientNormEpsilon = Helper.toNullable<Nullable<double>> gradientNormEpsilon "gradientNormEpsilon"
