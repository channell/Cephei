    ...
    let BasisSwap_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _float1Schedule = Helper.toCell<Schedule> float1Schedule "float1Schedule" true
                let _iborIndex1 = Helper.toCell<IborIndex> iborIndex1 "iborIndex1" true
                let _spread1 = Helper.toCell<double> spread1 "spread1" true
                let _float1DayCount = Helper.toCell<DayCounter> float1DayCount "float1DayCount" true
                let _float2Schedule = Helper.toCell<Schedule> float2Schedule "float2Schedule" true
                let _iborIndex2 = Helper.toCell<IborIndex> iborIndex2 "iborIndex2" true
                let _spread2 = Helper.toCell<double> spread2 "spread2" true
                let _float2DayCount = Helper.toCell<DayCounter> float2DayCount "float2DayCount" true
    ...
    let BasisSwap_fairLongSpread
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _BasisSwap = Helper.toCell<BasisSwap> basisswap "BasisSwap" true 
    ...
    let BasisSwap_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<BasisSwap> i "value" true) |>
                        Seq.toArray
