...
module AnalyticHestonHullWhiteEngineFunction =
    ...
    *)
    [<ExcelFunction(Name="_AnalyticHestonHullWhiteEngine_calculate", Description="Create a AnalyticHestonHullWhiteEngine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let AnalyticHestonHullWhiteEngine_calculate
        ([<ExcelArgument(Name="Mnemonic",Description = "Identifer for the value")>] 
         mnemonic : string)
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_AnalyticHestonHullWhiteEngine.cell :?> AnalyticHestonHullWhiteEngineModel).Calculate
                                                       ) :> ICell
                let format (o : AnalyticHestonHullWhiteEngine) (l:string) = o.ToString() :> obj

                let source = Helper.sourceFold (_AnalyticHestonHullWhiteEngine.source + ".Calculate") 
