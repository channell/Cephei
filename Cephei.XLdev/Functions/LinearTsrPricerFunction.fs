    ...
    let LinearTsrPricer_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _couponDiscountCurve = Helper.toHandle<Handle<YieldTermStructure>> couponDiscountCurve "couponDiscountCurve" 
                let _settings = Helper.toCell<Settings.Settings> settings "settings" true
