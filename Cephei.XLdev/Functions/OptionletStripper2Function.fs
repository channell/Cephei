    ...
    let OptionletStripper2_atmCapFloorPrices
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _OptionletStripper2 = Helper.toCell<OptionletStripper2> optionletstripper2 "OptionletStripper2" true 
    ...
    let OptionletStripper2_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _atmCapFloorTermVolCurve = Helper.toHandle<Handle<CapFloorTermVolCurve>> atmCapFloorTermVolCurve "atmCapFloorTermVolCurve" 
    ...
    let OptionletStripper2_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<OptionletStripper2> i "value" true) |>
                        Seq.toArray
