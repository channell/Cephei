    ...
    let ConvertibleBond_cleanPrice
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_ConvertibleBond.source + ".CleanPrice1") 
                                               [| _ConvertibleBond.source
                                               ;  _Yield.source
                                               ;  _dc.source
                                               ;  _comp.source
    ...
    let ConvertibleBond_dirtyPrice
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_ConvertibleBond.source + ".DirtyPrice1") 
                                               [| _ConvertibleBond.source
                                               |]
                let hash = Helper.hashFold 
                                [| _ConvertibleBond.cell
    ...
    let ConvertibleBond_settlementValue
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_ConvertibleBond.source + ".SettlementValue1") 
                                               [| _ConvertibleBond.source
                                               |]
                let hash = Helper.hashFold 
                                [| _ConvertibleBond.cell
