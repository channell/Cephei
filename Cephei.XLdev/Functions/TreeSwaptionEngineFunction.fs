...
module TreeSwaptionEngineFunction =
    ...
    *)
    [<ExcelFunction(Name="_TreeSwaptionEngine_calculate", Description="Create a TreeSwaptionEngine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let TreeSwaptionEngine_calculate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_TreeSwaptionEngine.cell :?> TreeSwaptionEngineModel).Calculate
                                                       ) :> ICell
                let format (o : TreeSwaptionEngine) (l:string) = o.ToString() :> obj

                let source = Helper.sourceFold (_TreeSwaptionEngine.source + ".Calculate") 
