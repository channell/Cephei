    ...
    let CallableFixedRateBond_callability
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CallableFixedRateBond = Helper.toCell<CallableFixedRateBond> callablefixedratebond "CallableFixedRateBond" true 
    ...
    let CallableFixedRateBond_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<CallableFixedRateBond> i "value" true) |>
                        Seq.toArray
