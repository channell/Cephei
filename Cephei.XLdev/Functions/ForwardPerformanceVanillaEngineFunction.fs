...
module ForwardPerformanceVanillaEngineFunction =
    ...
    *)
    [<ExcelFunction(Name="_ForwardPerformanceVanillaEngine_calculate", Description="Create a ForwardPerformanceVanillaEngine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let ForwardPerformanceVanillaEngine_calculate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_ForwardPerformanceVanillaEngine.cell :?> ForwardPerformanceVanillaEngineModel).Calculate
                                                       ) :> ICell
                let format (o : ForwardPerformanceVanillaEngine) (l:string) = o.ToString() :> obj

                let source = Helper.sourceFold (_ForwardPerformanceVanillaEngine.source + ".Calculate") 
