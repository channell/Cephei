...
module FDStepConditionEngineFunction =
    ...
    *)
    [<ExcelFunction(Name="_FDStepConditionEngine_calculate", Description="Create a FDStepConditionEngine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let FDStepConditionEngine_calculate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_FDStepConditionEngine.cell :?> FDStepConditionEngineModel).Calculate
                                                            _r.cell 
                                                       ) :> ICell
                let format (o : FDStepConditionEngine) (l:string) = o.ToString() :> obj

                let source = Helper.sourceFold (_FDStepConditionEngine.source + ".Calculate") 
