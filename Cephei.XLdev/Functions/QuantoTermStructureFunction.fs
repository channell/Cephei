    ...
    let QuantoTermStructure_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _underlyingDividendTS = Helper.toHandle<Handle<YieldTermStructure>> underlyingDividendTS "underlyingDividendTS" 
                ...
                let _underlyingBlackVolTS = Helper.toHandle<Handle<BlackVolTermStructure>> underlyingBlackVolTS "underlyingBlackVolTS" 
                let _strike = Helper.toCell<double> strike "strike" true
                let _exchRateBlackVolTS = Helper.toHandle<Handle<BlackVolTermStructure>> exchRateBlackVolTS "exchRateBlackVolTS" 
