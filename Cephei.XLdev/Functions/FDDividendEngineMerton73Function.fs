...
module FDDividendEngineMerton73Function =
    ...
    let FDDividendEngineMerton73_factory2
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _FDDividendEngineMerton73 = Helper.toCell<FDDividendEngineMerton73> fddividendenginemerton73 "FDDividendEngineMerton73" true 
    ...
    *)
    [<ExcelFunction(Name="_FDDividendEngineMerton73_calculate", Description="Create a FDDividendEngineMerton73",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let FDDividendEngineMerton73_calculate
        ([<ExcelArgument(Name="Mnemonic",Description = "Identifer for the value")>] 
         mnemonic : string)
        ([<ExcelArgument(Name="FDDividendEngineMerton73",Description = "Reference to FDDividendEngineMerton73")>] 
         fddividendenginemerton73 : obj)
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_FDDividendEngineMerton73.cell :?> FDDividendEngineMerton73Model).Calculate
                                                            _r.cell 
                                                       ) :> ICell
                let format (o : FDDividendEngineMerton73) (l:string) = o.ToString() :> obj

                let source = Helper.sourceFold (_FDDividendEngineMerton73.source + ".Calculate") 
                                               [| _FDDividendEngineMerton73.source
                                               ;  _r.source
                                               |]
                let hash = Helper.hashFold 
    ...
    let FDDividendEngineMerton73_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<FDDividendEngineMerton73> i "value" true) |>
                        Seq.toArray
