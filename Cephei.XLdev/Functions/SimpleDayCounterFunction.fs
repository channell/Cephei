    ...
    let SimpleDayCounter_dayCount
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SimpleDayCounter = Helper.toCell<SimpleDayCounter> simpledaycounter "SimpleDayCounter" true 
    ...
    let SimpleDayCounter_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<SimpleDayCounter> i "value" true) |>
                        Seq.toArray
