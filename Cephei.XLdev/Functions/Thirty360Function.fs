...
module Thirty360Function =
    ...
    let Thirty360_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _c = Helper.toCell<Thirty360Convention> c "c" true
    ...
    *)
    ...
    let Thirty360_dayCount
        ([<ExcelArgument(Name="Mnemonic",Description = "Identifer for the value")>] 
         mnemonic : string)
        ([<ExcelArgument(Name="Thirty360",Description = "Reference to Thirty360")>] 
         thirty360 : obj)
    ...
    *)
    ...
    let Thirty360_Range 
        ([<ExcelArgument(Name="Mnemonic",Description = "Identifer for the value")>] 
         mnemonic : string)
        ([<ExcelArgument(Name="Objects",Description = "Identifer for the Thirty360")>] 
         values : obj[,])
         =
