    ...
    let CatBond_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic (Fun.CatBond 
    ...
    let CatBond_exhaustionProbability
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CatBond = Helper.toCell<CatBond> catbond "CatBond" true 
    ...
    let CatBond_dirtyPrice
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_CatBond.source + ".DirtyPrice1") 
                                               [| _CatBond.source
                                               |]
                let hash = Helper.hashFold 
                                [| _CatBond.cell
    ...
    let CatBond_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<CatBond> i "value" true) |>
                        Seq.toArray
                ...
                Model.specify 
                    ...
                    ; creator = builder
                    ; subscriber = Helper.subscriberModelRange format
                    ; source = "cell Generic.List<CatBond>(" + (Helper.sourceFoldArray (s) + ")")
