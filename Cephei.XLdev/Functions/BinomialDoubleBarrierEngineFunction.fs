...
module BinomialDoubleBarrierEngineFunction =
    ...
    let BinomialDoubleBarrierEngine_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _getTree = Helper.toCell<GetTree> getTree "getTree" true
                let _getAsset = Helper.toCell<GetAsset> getAsset "getAsset" true
    ...
    *)
    [<ExcelFunction(Name="_BinomialDoubleBarrierEngine_calculate", Description="Create a BinomialDoubleBarrierEngine",Category="Cephei", IsThreadSafe = true, IsExceptionSafe=true)>]
    let BinomialDoubleBarrierEngine_calculate
        ([<ExcelArgument(Name="Mnemonic",Description = "Identifer for the value")>] 
         mnemonic : string)
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_BinomialDoubleBarrierEngine.cell :?> BinomialDoubleBarrierEngineModel).Calculate
                                                       ) :> ICell
                let format (o : BinomialDoubleBarrierEngine) (l:string) = o.ToString() :> obj

                let source = Helper.sourceFold (_BinomialDoubleBarrierEngine.source + ".Calculate") 
