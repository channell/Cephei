    ...
    let SpreadBasketPayoff_accumulate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _SpreadBasketPayoff = Helper.toCell<SpreadBasketPayoff> spreadbasketpayoff "SpreadBasketPayoff" true 
    ...
    let SpreadBasketPayoff_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<SpreadBasketPayoff> i "value" true) |>
                        Seq.toArray
