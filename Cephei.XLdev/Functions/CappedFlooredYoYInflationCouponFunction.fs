    ...
    let CappedFlooredYoYInflationCoupon_cap
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CappedFlooredYoYInflationCoupon = Helper.toCell<CappedFlooredYoYInflationCoupon> cappedflooredyoyinflationcoupon "CappedFlooredYoYInflationCoupon" true 
    ...
    let CappedFlooredYoYInflationCoupon_create1
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _underlying = Helper.toCell<YoYInflationCoupon> underlying "underlying" true
                let _cap = Helper.toNullable<Nullable<double>> cap "cap"
                let _floor = Helper.toNullable<Nullable<double>> floor "floor"
    ...
    let CappedFlooredYoYInflationCoupon_setPricer
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CappedFlooredYoYInflationCoupon = Helper.toCell<CappedFlooredYoYInflationCoupon> cappedflooredyoyinflationcoupon "CappedFlooredYoYInflationCoupon" true 
                let _pricer = Helper.toCell<YoYInflationCouponPricer> pricer "pricer" true
    ...
    let CappedFlooredYoYInflationCoupon_price
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _CappedFlooredYoYInflationCoupon = Helper.toCell<CappedFlooredYoYInflationCoupon> cappedflooredyoyinflationcoupon "CappedFlooredYoYInflationCoupon" true 
                let _discountingCurve = Helper.toHandle<Handle<YieldTermStructure>> discountingCurve "discountingCurve" 
    ...
    let CappedFlooredYoYInflationCoupon_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<CappedFlooredYoYInflationCoupon> i "value" true) |>
                        Seq.toArray
