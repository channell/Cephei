    ...
    let Bbsw4M_businessDayConvention
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bbsw4M = Helper.toCell<Bbsw4M> bbsw4m "Bbsw4M" true 
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).BusinessDayConvention
                                                       ) :> ICell
    ...
    let Bbsw4M_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).Clone
                                                            _forwarding.cell 
                                                       ) :> ICell
    ...
    let Bbsw4M_endOfMonth
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bbsw4M = Helper.toCell<Bbsw4M> bbsw4m "Bbsw4M" true 
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).EndOfMonth
                                                       ) :> ICell
    ...
    let Bbsw4M_forecastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).ForecastFixing
                                                            _d1.cell 
                                                            _d2.cell 
                                                            _t.cell 
                                                       ) :> ICell
    ...
    let Bbsw4M_forecastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).ForecastFixing1
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : double) (l:string) = o :> obj
    ...
    let Bbsw4M_forwardingTermStructure
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bbsw4M = Helper.toCell<Bbsw4M> bbsw4m "Bbsw4M" true 
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).ForwardingTermStructure
                                                       ) :> ICell
    ...
    let Bbsw4M_maturityDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).MaturityDate
                                                            _valueDate.cell 
                                                       ) :> ICell
    ...
    let Bbsw4M_currency
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bbsw4M = Helper.toCell<Bbsw4M> bbsw4m "Bbsw4M" true 
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).Currency
                                                       ) :> ICell
    ...
    let Bbsw4M_dayCounter
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bbsw4M = Helper.toCell<Bbsw4M> bbsw4m "Bbsw4M" true 
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).DayCounter
                                                       ) :> ICell
    ...
    let Bbsw4M_familyName
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bbsw4M = Helper.toCell<Bbsw4M> bbsw4m "Bbsw4M" true 
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).FamilyName
                                                       ) :> ICell
    ...
    let Bbsw4M_fixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).Fixing
                                                            _fixingDate.cell 
    ...
    let Bbsw4M_fixingCalendar
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bbsw4M = Helper.toCell<Bbsw4M> bbsw4m "Bbsw4M" true 
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).FixingCalendar
                                                       ) :> ICell
    ...
    let Bbsw4M_fixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bbsw4M = Helper.toCell<Bbsw4M> bbsw4m "Bbsw4M" true 
                let _valueDate = Helper.toCell<Date> valueDate "valueDate" true
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).FixingDate
                                                            _valueDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let Bbsw4M_fixingDays
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bbsw4M = Helper.toCell<Bbsw4M> bbsw4m "Bbsw4M" true 
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).FixingDays
                                                       ) :> ICell
    ...
    let Bbsw4M_isValidFixingDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bbsw4M = Helper.toCell<Bbsw4M> bbsw4m "Bbsw4M" true 
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" true
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).IsValidFixingDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Bbsw4M_name
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bbsw4M = Helper.toCell<Bbsw4M> bbsw4m "Bbsw4M" true 
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).Name
                                                       ) :> ICell
                let format (o : string) (l:string) = o.ToString() :> obj
    ...
    let Bbsw4M_pastFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bbsw4M = Helper.toCell<Bbsw4M> bbsw4m "Bbsw4M" true 
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" true
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).PastFixing
                                                            _fixingDate.cell 
                                                       ) :> ICell
    ...
    let Bbsw4M_tenor
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bbsw4M = Helper.toCell<Bbsw4M> bbsw4m "Bbsw4M" true 
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).Tenor
                                                       ) :> ICell
    ...
    let Bbsw4M_update
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bbsw4M = Helper.toCell<Bbsw4M> bbsw4m "Bbsw4M" true 
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).Update
                                                       ) :> ICell
    ...
    let Bbsw4M_valueDate
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bbsw4M = Helper.toCell<Bbsw4M> bbsw4m "Bbsw4M" true 
                let _fixingDate = Helper.toCell<Date> fixingDate "fixingDate" true
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).ValueDate
                                                            _fixingDate.cell 
                                                       ) :> ICell
                let format (d : Date) (l:string) = d.serialNumber() :> obj
    ...
    let Bbsw4M_addFixing
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).AddFixing
                                                            _d.cell 
                                                            _v.cell 
    ...
    let Bbsw4M_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" true
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).AddFixings
                                                            _d.cell 
                                                            _v.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
    ...
    let Bbsw4M_addFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _forceOverwrite = Helper.toCell<bool> forceOverwrite "forceOverwrite" true
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).AddFixings1
                                                            _source.cell 
                                                            _forceOverwrite.cell 
                                                       ) :> ICell
                let format (o : Bbsw4M) (l:string) = o.ToString() :> obj
    ...
    let Bbsw4M_allowsNativeFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bbsw4M = Helper.toCell<Bbsw4M> bbsw4m "Bbsw4M" true 
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).AllowsNativeFixings
                                                       ) :> ICell
                let format (o : bool) (l:string) = o.ToString() :> obj
    ...
    let Bbsw4M_clearFixings
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bbsw4M = Helper.toCell<Bbsw4M> bbsw4m "Bbsw4M" true 
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).ClearFixings
                                                       ) :> ICell
                let format (o : Bbsw4M) (l:string) = o.ToString() :> obj
    ...
    let Bbsw4M_registerWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).RegisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : Bbsw4M) (l:string) = o.ToString() :> obj
    ...
    let Bbsw4M_timeSeries
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bbsw4M = Helper.toCell<Bbsw4M> bbsw4m "Bbsw4M" true 
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).TimeSeries
                                                       ) :> ICell
    ...
    let Bbsw4M_unregisterWith
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Bbsw4M = Helper.toCell<Bbsw4M> bbsw4m "Bbsw4M" true 
                let _handler = Helper.toCell<Callback> handler "handler" true
                let builder () = withMnemonic mnemonic ((_Bbsw4M.cell :?> Bbsw4MModel).UnregisterWith
                                                            _handler.cell 
                                                       ) :> ICell
                let format (o : Bbsw4M) (l:string) = o.ToString() :> obj
    ...
    let Bbsw4M_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<Bbsw4M> i "value" true) |>
                        Seq.toArray
