    ...
    let BlackVarianceSurface_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _blackVolMatrix = Helper.toCell<Matrix> blackVolMatrix "blackVolMatrix" true
                let _dayCounter = Helper.toCell<DayCounter> dayCounter "dayCounter" true
                let _lowerExtrapolation = Helper.toCell<Extrapolation> lowerExtrapolation "lowerExtrapolation" true
                let _upperExtrapolation = Helper.toCell<Extrapolation> upperExtrapolation "upperExtrapolation" true
    ...
    let BlackVarianceSurface_dates
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _BlackVarianceSurface = Helper.toCell<BlackVarianceSurface> blackvariancesurface "BlackVarianceSurface" true 
    ...
    let BlackVarianceSurface_setInterpolation
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let source = Helper.sourceFold (_BlackVarianceSurface.source + ".SetInterpolation1") 
                                               [| _BlackVarianceSurface.source
                                               |]
                let hash = Helper.hashFold 
                                [| _BlackVarianceSurface.cell
    ...
    let BlackVarianceSurface_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<BlackVarianceSurface> i "value" true) |>
                        Seq.toArray
