    ...
    let GaussLobattoIntegral_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _absAccuracy = Helper.toNullable<Nullable<double>> absAccuracy "absAccuracy"
                let _relAccuracy = Helper.toNullable<Nullable<double>> relAccuracy "relAccuracy"
                let _useConvergenceEstimate = Helper.toCell<bool> useConvergenceEstimate "useConvergenceEstimate" true
    ...
    let GaussLobattoIntegral_absoluteAccuracy
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _GaussLobattoIntegral = Helper.toCell<GaussLobattoIntegral> gausslobattointegral "GaussLobattoIntegral" true 
    ...
    let GaussLobattoIntegral_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<GaussLobattoIntegral> i "value" true) |>
                        Seq.toArray
