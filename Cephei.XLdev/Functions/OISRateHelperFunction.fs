    ...
    let OISRateHelper_impliedQuote
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _OISRateHelper = Helper.toCell<OISRateHelper> oisratehelper "OISRateHelper" true 
    ...
    let OISRateHelper_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _fixedRate = Helper.toHandle<Handle<Quote>> fixedRate "fixedRate" 
    ...
    let OISRateHelper_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<OISRateHelper> i "value" true) |>
                        Seq.toArray
