    ...
    let YoYInflationIndex_clone
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _YoYInflationIndex = Helper.toCell<YoYInflationIndex> yoyinflationindex "YoYInflationIndex" true 
    ...
    let YoYInflationIndex_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _ratio = Helper.toCell<bool> ratio "ratio" true
                ...
                let _yoyInflation = Helper.toHandle<Handle<YoYInflationTermStructure>> yoyInflation "yoyInflation" 
    ...
    let YoYInflationIndex_Range 
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let a = values |>
                        Seq.cast<obj> |>
                        Seq.map (fun (i : obj) -> Helper.toCell<YoYInflationIndex> i "value" true) |>
                        Seq.toArray
