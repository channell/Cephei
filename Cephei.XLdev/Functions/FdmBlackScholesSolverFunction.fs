    ...
    let FdmBlackScholesSolver_create
        ...
        if not (Model.IsInFunctionWizard()) then
            ...
            try
                ...
                let _Process = Helper.toHandle<Handle<GeneralizedBlackScholesProcess>> Process "Process" 
                ...
                let _quantoHelper = Helper.toHandle<Handle<FdmQuantoHelper>> quantoHelper "quantoHelper" 
