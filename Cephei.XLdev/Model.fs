...
//    let private _hash                   = new Dictionary<string, string> ()
    ...
    let private _ranges                 = new Dictionary<KeyValuePair<string, string>, obj[,]> ()

    let private _rtd                    = new Dictionary<string, spec> ()

    let IsInFunctionWizard () = 
        Model.IsInFunctionWizard()
...
type ValueRTD ()  =
    ...
    let _topicIndex             = new Dictionary<KeyValuePair<string, string>, ExcelRtdServer.Topic list>()
    let _subscriptions          = new Dictionary<KeyValuePair<string, string>, IDisposable> ()
