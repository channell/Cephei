...
(* functions *)
    ...
    let _zc6mRate = Fun.SimpleQuote1 (triv (fun () -> toNullable (0.0145)))
    let _couponRates1 = (new List<double>([| Convert.ToDouble(0.04625)|]))
    let _zc3mRate = Fun.SimpleQuote1 (triv (fun () -> toNullable (0.0096)))
    ...
    let _zc1yRate = Fun.SimpleQuote1 (triv (fun () -> toNullable (0.0194)))
    let _zc6mPeriod = Fun.Period (value (Convert.ToInt32(6))) (value TimeUnit.Months)
    let _marketQuotes0 = Fun.SimpleQuote1 (triv (fun () -> toNullable (100.390625)))
    let _marketQuotes4 = Fun.SimpleQuote1 (triv (fun () -> toNullable (102.140625)))
    let _schedule4 = Fun.Schedule (value (new Date(int (31912)))) (value (new Date(int (50540)))) _Semiannual (triv (fun () -> _USgovi.Value :> QLNet.Calendar)) (value BusinessDayConvention.Unadjusted) (value BusinessDayConvention.Unadjusted) (value DateGeneration.Rule.Backward) (value false) (value (null :> QLNet.Date)) (value (null :> QLNet.Date)) _todaysDate
    let _marketQuotes2 = Fun.SimpleQuote1 (triv (fun () -> toNullable (100.59375)))
    let _marketQuotes3 = Fun.SimpleQuote1 (triv (fun () -> toNullable (101.6875)))
    let _zc3mPeriod = Fun.Period (value (Convert.ToInt32(3))) (value TimeUnit.Months)
    let _schedule2 = Fun.Schedule (value (new Date(int (38898)))) (value (new Date(int (41517)))) _Semiannual (triv (fun () -> _USgovi.Value :> QLNet.Calendar)) (value BusinessDayConvention.Unadjusted) (value BusinessDayConvention.Unadjusted) (value DateGeneration.Rule.Backward) (value false) (value (null :> QLNet.Date)) (value (null :> QLNet.Date)) _todaysDate
    let _schedule1 = Fun.Schedule (value (new Date(int (38518)))) (value (new Date(int (40786)))) _Semiannual (triv (fun () -> _USgovi.Value :> QLNet.Calendar)) (value BusinessDayConvention.Unadjusted) (value BusinessDayConvention.Unadjusted) (value DateGeneration.Rule.Backward) (value false) (value (null :> QLNet.Date)) (value (null :> QLNet.Date)) _todaysDate
    let _zc1yPeriod = Fun.Period (value (Convert.ToInt32(1))) (value TimeUnit.Years)
    let _marketQuotes1 = Fun.SimpleQuote1 (triv (fun () -> toNullable (106.21875)))
    let _couponRates3 = (new List<double>([| Convert.ToDouble(0.04000)|]))
    let _schedule3 = Fun.Schedule (value (new Date(int (37575)))) (value (new Date(int (43327)))) _Semiannual (triv (fun () -> _USgovi.Value :> QLNet.Calendar)) (value BusinessDayConvention.Unadjusted) (value BusinessDayConvention.Unadjusted) (value DateGeneration.Rule.Backward) (value false) (value (null :> QLNet.Date)) (value (null :> QLNet.Date)) _todaysDate
    let _schedule0 = Fun.Schedule (value (new Date(int (38426)))) (value (new Date(int (40421)))) _Semiannual (triv (fun () -> _USgovi.Value :> QLNet.Calendar)) (value BusinessDayConvention.Unadjusted) (value BusinessDayConvention.Unadjusted) (value DateGeneration.Rule.Backward) (value false) (value (null :> QLNet.Date)) (value (null :> QLNet.Date)) _todaysDate
    let _zc3m = Fun.DepositRateHelper (triv (fun () -> toHandle (_zc3mRate.Cell.Box :?> QLNet.Quote))) _zc3mPeriod _fixingDays (triv (fun () -> _calendar.Value :> QLNet.Calendar)) (value BusinessDayConvention.ModifiedFollowing) (value true) (triv (fun () -> _zcBondsDayCounter.Value :> QLNet.DayCounter)) _todaysDate
    let _zc6m = Fun.DepositRateHelper (triv (fun () -> toHandle (_zc6mRate.Cell.Box :?> QLNet.Quote))) _zc6mPeriod _fixingDays (triv (fun () -> _calendar.Value :> QLNet.Calendar)) (value BusinessDayConvention.ModifiedFollowing) (value true) (triv (fun () -> _zcBondsDayCounter.Value :> QLNet.DayCounter)) _todaysDate
    let _bondhelper2 = Fun.FixedRateBondHelper (triv (fun () -> toHandle (_marketQuotes2.Cell.Box :?>  QLNet.Quote))) _settlementDays (value (100.0)) _schedule2 _couponRates2  (triv (fun () -> _ActualActualBond.Value :> QLNet.DayCounter)) (value BusinessDayConvention.Unadjusted) _redemption (value (new Date(int (38898)))) (value (null :> QLNet.Calendar)) (value (null :> QLNet.Period)) (value (null :> QLNet.Calendar)) (value BusinessDayConvention.Unadjusted) (value false) (value true)
    let _bondhelper1 = Fun.FixedRateBondHelper (triv (fun () -> toHandle (_marketQuotes1.Cell.Box :?>  QLNet.Quote))) _settlementDays (value (100.0)) _schedule1 (_couponRates1 :> ICell<Generic.List<double>>) (triv (fun () -> _ActualActualBond.Value :> QLNet.DayCounter)) (value BusinessDayConvention.Unadjusted) _redemption (value (new Date(int (38518)))) (value (null :> QLNet.Calendar)) (value (null :> QLNet.Period)) (value (null :> QLNet.Calendar)) (value BusinessDayConvention.Unadjusted) (value false) (value true)
    let _bondhelper4 = Fun.FixedRateBondHelper (triv (fun () -> toHandle (_marketQuotes4.Cell.Box :?> QLNet.Quote))) _settlementDays (value (100.0)) _schedule4 (_couponRates4 :> ICell<Generic.List<double>>) (triv (fun () -> _ActualActualBond.Value :> QLNet.DayCounter)) (value BusinessDayConvention.Unadjusted) _redemption (value (new Date(int (31912)))) (value (null :> QLNet.Calendar)) (value (null :> QLNet.Period)) (value (null :> QLNet.Calendar)) (value BusinessDayConvention.Unadjusted) (value false) (value true)
    let _bondhelper3 = Fun.FixedRateBondHelper (triv (fun () -> toHandle (_marketQuotes3.Cell.Box :?>  QLNet.Quote))) _settlementDays (value (100.0)) _schedule3 (_couponRates3 :> ICell<Generic.List<double>>) (triv (fun () -> _ActualActualBond.Value :> QLNet.DayCounter)) (value BusinessDayConvention.Unadjusted) _redemption (value (new Date(int (37575)))) (value (null :> QLNet.Calendar)) (value (null :> QLNet.Period)) (value (null :> QLNet.Calendar)) (value BusinessDayConvention.Unadjusted) (value false) (value true)
    let _bondhelper0 = Fun.FixedRateBondHelper (triv (fun () -> toHandle (_marketQuotes0.Cell.Box :?> QLNet.Quote))) _settlementDays (value (100.0)) _schedule0 (_couponRates0 :> ICell<Generic.List<double>>) (triv (fun () -> _ActualActualBond.Value :> QLNet.DayCounter)) (value BusinessDayConvention.Unadjusted) _redemption (value (new Date(int (38426)))) (value (null :> QLNet.Calendar)) (value (null :> QLNet.Period)) (value (null :> QLNet.Calendar)) (value BusinessDayConvention.Unadjusted) (value false) (value true)
    let _zc1y = Fun.DepositRateHelper (triv (fun () -> toHandle (_zc1yRate.Cell.Box :?> QLNet.Quote))) _zc1yPeriod _fixingDays (triv (fun () -> _calendar.Value :> QLNet.Calendar)) (value BusinessDayConvention.ModifiedFollowing) (value true) (triv (fun () -> _zcBondsDayCounter.Value :> QLNet.DayCounter)) _todaysDate
    ...
    let _bondInstruments1 = (new List<RateHelper>([|(trivDate (fun () -> _zc3m.Value :> QLNet.RateHelper) (_zc3m :> IDateDependant));(trivDate (fun () -> _zc6m.Value :> QLNet.RateHelper) (_zc6m :> IDateDependant));(trivDate (fun () -> _zc1y.Value :> QLNet.RateHelper) (_zc1y :> IDateDependant));(triv (fun () -> _bondhelper0.Value :> QLNet.RateHelper));(triv (fun () -> _bondhelper1.Value :> QLNet.RateHelper));(triv (fun () -> _bondhelper2.Value :> QLNet.RateHelper));(triv (fun () -> _bondhelper3.Value :> QLNet.RateHelper));(triv (fun () -> _bondhelper4.Value :> QLNet.RateHelper))|]))
    let _loglinier = Fun.LogLinear ()
    let _bondDiscountingTermStructure = Fun.PiecewiseYieldCurve (triv (fun () -> _discount.Value :> QLNet.ITraits<QLNet.YieldTermStructure>)) _settlementDateAdjusted _bondInstruments1  (triv (fun () -> _termStructureDayCounter.Value :> QLNet.DayCounter)) (value (new System.Collections.Generic.List<QLNet.Handle<QLNet.Quote>>())) (value (new System.Collections.Generic.List<QLNet.Date>())) _tolerance (triv (fun () -> _loglinier.Value :> QLNet.IInterpolationFactory)) _todaysDate
    ...
    let _bondEngine = Fun.DiscountingBondEngine (triv (fun () -> toHandle (_bondDiscountingTermStructure.Value :> QLNet.YieldTermStructure))) (triv (fun () -> toNullable (True))) _todaysDate //  _settlementDateAdjusted
    let _swFloatingLegIndex = Fun.Euribor6M1()
    
    let _zeroCouponBond = Fun.ZeroCouponBond _settlementDays (triv (fun () -> _calendar.Value :> QLNet.Calendar)) _faceAmount _ZeroSettlementDate (value BusinessDayConvention.Following) _RemptionAmount _ZeroIssueDate  (triv (fun () -> _bondEngine .Value :> QLNet.IPricingEngine)) _todaysDate   
