...
let FloatingRateBond                            settlementDays faceAmount schedule index paymentDayCounter pricingEngine evaluationDate CouponPricer
                                                = new FloatingRateBondModel (settlementDays, faceAmount, schedule, index, paymentDayCounter, pricingEngine, evaluationDate, CouponPricer)
let FloatingRateBond1                           settlementDays faceAmount schedule index paymentDayCounter paymentConvention fixingDays gearings spreads pricingEngine evaluationDate CouponPricer
                                                = new FloatingRateBondModel1 (settlementDays, faceAmount, schedule, index, paymentDayCounter, paymentConvention, fixingDays, gearings, spreads, pricingEngine, evaluationDate, CouponPricer)
let FloatingRateBond2                           settlementDays faceAmount schedule index paymentDayCounter paymentConvention fixingDays gearings spreads caps floors inArrears redemption issueDate pricingEngine evaluationDate CouponPricer
                                                = new FloatingRateBondModel2 (settlementDays, faceAmount, schedule, index, paymentDayCounter, paymentConvention, fixingDays, gearings, spreads, caps, floors, inArrears, redemption, issueDate, pricingEngine, evaluationDate, CouponPricer)
let FloatingRateBond3                           settlementDays faceAmount startDate maturityDate couponFrequency calendar index accrualDayCounter accrualConvention paymentConvention fixingDays gearings spreads caps floors inArrears redemption issueDate stubDate rule endOfMonth pricingEngine evaluationDate CouponPricer
                                                = new FloatingRateBondModel3 (settlementDays, faceAmount, startDate, maturityDate, couponFrequency, calendar, index, accrualDayCounter, accrualConvention, paymentConvention, fixingDays, gearings, spreads, caps, floors, inArrears, redemption, issueDate, stubDate, rule, endOfMonth, pricingEngine, evaluationDate, CouponPricer)
