...
*)
    ...
    let _baseDate                                  = cell (fun () -> _InterpolatedYoYInflationCurve.Value.baseDate())
    let _Clone                                     = cell (fun () -> _InterpolatedYoYInflationCurve.Value.Clone())
    let _data                                      = cell (fun () -> _InterpolatedYoYInflationCurve.Value.data())
    let _data_                                     = cell (fun () -> _InterpolatedYoYInflationCurve.Value.data_)
    let _dates                                     = cell (fun () -> _InterpolatedYoYInflationCurve.Value.dates())
    let _dates_                                    = cell (fun () -> _InterpolatedYoYInflationCurve.Value.dates_)
    let _forwards                                  = cell (fun () -> _InterpolatedYoYInflationCurve.Value.forwards())
    let _interpolation_                            = cell (fun () -> _InterpolatedYoYInflationCurve.Value.interpolation_)
    let _interpolator_                             = cell (fun () -> _InterpolatedYoYInflationCurve.Value.interpolator_)
    let _maxDate                                   = cell (fun () -> _InterpolatedYoYInflationCurve.Value.maxDate())
    let _maxDate_                                  = cell (fun () -> _InterpolatedYoYInflationCurve.Value.maxDate_)
    let _nodes                                     = cell (fun () -> _InterpolatedYoYInflationCurve.Value.nodes())
    let _rates                                     = cell (fun () -> _InterpolatedYoYInflationCurve.Value.rates())
    let _setupInterpolation                        = cell (fun () -> _InterpolatedYoYInflationCurve.Value.setupInterpolation()
                                                                     _InterpolatedYoYInflationCurve.Value)
    let _times                                     = cell (fun () -> _InterpolatedYoYInflationCurve.Value.times())
    let _times_                                    = cell (fun () -> _InterpolatedYoYInflationCurve.Value.times_)
    let _yoyRate                                   (d : ICell<Date>)   
                                                   = cell (fun () -> _InterpolatedYoYInflationCurve.Value.yoyRate(d.Value))
    let _yoyRate1                                  (d : ICell<Date>) (instObsLag : ICell<Period>) (forceLinearInterpolation : ICell<bool>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _InterpolatedYoYInflationCurve.Value.yoyRate(d.Value, instObsLag.Value, forceLinearInterpolation.Value, extrapolate.Value))
    let _yoyRate2                                  (d : ICell<Date>) (instObsLag : ICell<Period>)   
                                                   = cell (fun () -> _InterpolatedYoYInflationCurve.Value.yoyRate(d.Value, instObsLag.Value))
    let _yoyRate3                                  (d : ICell<Date>) (instObsLag : ICell<Period>) (forceLinearInterpolation : ICell<bool>)   
                                                   = cell (fun () -> _InterpolatedYoYInflationCurve.Value.yoyRate(d.Value, instObsLag.Value, forceLinearInterpolation.Value))
    let _baseRate                                  = cell (fun () -> _InterpolatedYoYInflationCurve.Value.baseRate())
    let _frequency                                 = cell (fun () -> _InterpolatedYoYInflationCurve.Value.frequency())
    let _hasSeasonality                            = cell (fun () -> _InterpolatedYoYInflationCurve.Value.hasSeasonality())
    let _indexIsInterpolated                       = cell (fun () -> _InterpolatedYoYInflationCurve.Value.indexIsInterpolated())
    let _nominalTermStructure                      = cell (fun () -> _InterpolatedYoYInflationCurve.Value.nominalTermStructure())
    let _observationLag                            = cell (fun () -> _InterpolatedYoYInflationCurve.Value.observationLag())
    let _seasonality                               = cell (fun () -> _InterpolatedYoYInflationCurve.Value.seasonality())
    let _setSeasonality                            (seasonality : ICell<Seasonality>)   
                                                   = cell (fun () -> _InterpolatedYoYInflationCurve.Value.setSeasonality(seasonality.Value)
                                                                     _InterpolatedYoYInflationCurve.Value)
    let _calendar                                  = cell (fun () -> _InterpolatedYoYInflationCurve.Value.calendar())
    let _dayCounter                                = cell (fun () -> _InterpolatedYoYInflationCurve.Value.dayCounter())
    let _maxTime                                   = cell (fun () -> _InterpolatedYoYInflationCurve.Value.maxTime())
    let _referenceDate                             = cell (fun () -> _InterpolatedYoYInflationCurve.Value.referenceDate())
    let _settlementDays                            = cell (fun () -> _InterpolatedYoYInflationCurve.Value.settlementDays())
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = cell (fun () -> _InterpolatedYoYInflationCurve.Value.timeFromReference(date.Value))
    let _update                                    = cell (fun () -> _InterpolatedYoYInflationCurve.Value.update()
                                                                     _InterpolatedYoYInflationCurve.Value)
    let _allowsExtrapolation                       = cell (fun () -> _InterpolatedYoYInflationCurve.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _InterpolatedYoYInflationCurve.Value.disableExtrapolation(b.Value)
                                                                     _InterpolatedYoYInflationCurve.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _InterpolatedYoYInflationCurve.Value.enableExtrapolation(b.Value)
                                                                     _InterpolatedYoYInflationCurve.Value)
    let _extrapolate                               = cell (fun () -> _InterpolatedYoYInflationCurve.Value.extrapolate)
