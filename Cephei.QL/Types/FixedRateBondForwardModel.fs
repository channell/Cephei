...
*)
    let mutable
        _FixedRateBondForward                      = make (fun () -> withEngine pricingEngine evaluationDate (new FixedRateBondForward (valueDate.Value, maturityDate.Value, Type.Value, strike.Value, settlementDays.Value, dayCounter.Value, calendar.Value, businessDayConvention.Value, fixedCouponBond.Value, discountCurve.Value, incomeDiscountCurve.Value)))
    let _cleanForwardPrice                         = triv _FixedRateBondForward (fun () -> (withEvaluationDate _evaluationDate _FixedRateBondForward).cleanForwardPrice())
    let _forwardPrice                              = triv _FixedRateBondForward (fun () -> (withEvaluationDate _evaluationDate _FixedRateBondForward).forwardPrice())
    let _spotIncome                                (incomeDiscountCurve : ICell<Handle<YieldTermStructure>>)   
                                                   = triv _FixedRateBondForward (fun () -> (withEvaluationDate _evaluationDate _FixedRateBondForward).spotIncome(incomeDiscountCurve.Value))
    let _spotValue                                 = triv _FixedRateBondForward (fun () -> (withEvaluationDate _evaluationDate _FixedRateBondForward).spotValue())
    let _forwardValue                              = triv _FixedRateBondForward (fun () -> (withEvaluationDate _evaluationDate _FixedRateBondForward).forwardValue())
    let _impliedYield                              (underlyingSpotValue : ICell<double>) (forwardValue : ICell<double>) (settlementDate : ICell<Date>) (compoundingConvention : ICell<Compounding>) (dayCounter : ICell<DayCounter>)   
                                                   = triv _FixedRateBondForward (fun () -> (withEvaluationDate _evaluationDate _FixedRateBondForward).impliedYield(underlyingSpotValue.Value, forwardValue.Value, settlementDate.Value, compoundingConvention.Value, dayCounter.Value))
    let _isExpired                                 = triv _FixedRateBondForward (fun () -> (withEvaluationDate _evaluationDate _FixedRateBondForward).isExpired())
    let _settlementDate                            = triv _FixedRateBondForward (fun () -> (withEvaluationDate _evaluationDate _FixedRateBondForward).settlementDate())
    let _CASH                                      = cell _FixedRateBondForward (fun () -> (withEvaluationDate _evaluationDate _FixedRateBondForward).CASH())
    let _errorEstimate                             = triv _FixedRateBondForward (fun () -> (withEvaluationDate _evaluationDate _FixedRateBondForward).errorEstimate())
    let _NPV                                       = cell _FixedRateBondForward (fun () -> (withEvaluationDate _evaluationDate _FixedRateBondForward).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = triv _FixedRateBondForward (fun () -> (withEvaluationDate _evaluationDate _FixedRateBondForward).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = triv _FixedRateBondForward (fun () -> (withEvaluationDate _evaluationDate _FixedRateBondForward).setPricingEngine(e.Value)
                                                                                           _FixedRateBondForward.Value)
    let _valuationDate                             = triv _FixedRateBondForward (fun () -> (withEvaluationDate _evaluationDate _FixedRateBondForward).valuationDate())
