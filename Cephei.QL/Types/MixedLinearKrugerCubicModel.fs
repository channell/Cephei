...
*)
    ...
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearKrugerCubic.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearKrugerCubic.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = triv (fun () -> _MixedLinearKrugerCubic.Value.update()
                                                                     _MixedLinearKrugerCubic.Value)
    let _value                                     (x : ICell<double>)   
                                                   = triv (fun () -> _MixedLinearKrugerCubic.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearKrugerCubic.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = triv (fun () -> _MixedLinearKrugerCubic.Value.xMax())
    let _xMin                                      = triv (fun () -> _MixedLinearKrugerCubic.Value.xMin())
    let _allowsExtrapolation                       = triv (fun () -> _MixedLinearKrugerCubic.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearKrugerCubic.Value.disableExtrapolation(b.Value)
                                                                     _MixedLinearKrugerCubic.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearKrugerCubic.Value.enableExtrapolation(b.Value)
                                                                     _MixedLinearKrugerCubic.Value)
