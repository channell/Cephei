...
*)
    ...
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _MixedLinearKrugerCubic.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = cell (fun () -> _MixedLinearKrugerCubic.Value.empty())
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _MixedLinearKrugerCubic.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _MixedLinearKrugerCubic.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = cell (fun () -> _MixedLinearKrugerCubic.Value.update()
                                                                     _MixedLinearKrugerCubic.Value)
    let _value                                     (x : ICell<double>)   
                                                   = cell (fun () -> _MixedLinearKrugerCubic.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _MixedLinearKrugerCubic.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = cell (fun () -> _MixedLinearKrugerCubic.Value.xMax())
    let _xMin                                      = cell (fun () -> _MixedLinearKrugerCubic.Value.xMin())
    let _allowsExtrapolation                       = cell (fun () -> _MixedLinearKrugerCubic.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _MixedLinearKrugerCubic.Value.disableExtrapolation(b.Value)
                                                                     _MixedLinearKrugerCubic.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _MixedLinearKrugerCubic.Value.enableExtrapolation(b.Value)
                                                                     _MixedLinearKrugerCubic.Value)
    let _extrapolate                               = cell (fun () -> _MixedLinearKrugerCubic.Value.extrapolate)
