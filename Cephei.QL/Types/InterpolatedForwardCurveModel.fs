...
*)
    ...
    let _Clone                                     = cell (fun () -> _InterpolatedForwardCurve.Value.Clone())
    let _data                                      = cell (fun () -> _InterpolatedForwardCurve.Value.data())
    let _data_                                     = cell (fun () -> _InterpolatedForwardCurve.Value.data_)
    let _dates                                     = cell (fun () -> _InterpolatedForwardCurve.Value.dates())
    let _dates_                                    = cell (fun () -> _InterpolatedForwardCurve.Value.dates_)
    let _forwards                                  = cell (fun () -> _InterpolatedForwardCurve.Value.forwards())
    let _interpolation_                            = cell (fun () -> _InterpolatedForwardCurve.Value.interpolation_)
    let _interpolator_                             = cell (fun () -> _InterpolatedForwardCurve.Value.interpolator_)
    let _maxDate                                   = cell (fun () -> _InterpolatedForwardCurve.Value.maxDate())
    let _maxDate_                                  = cell (fun () -> _InterpolatedForwardCurve.Value.maxDate_)
    let _nodes                                     = cell (fun () -> _InterpolatedForwardCurve.Value.nodes())
    let _setupInterpolation                        = cell (fun () -> _InterpolatedForwardCurve.Value.setupInterpolation()
                                                                     _InterpolatedForwardCurve.Value)
    let _times                                     = cell (fun () -> _InterpolatedForwardCurve.Value.times())
    let _times_                                    = cell (fun () -> _InterpolatedForwardCurve.Value.times_)
