...
*)
    ...
    let _adjustedFixing                            = cell (fun () -> _YoYInflationCoupon.Value.adjustedFixing())
    let _gearing                                   = cell (fun () -> _YoYInflationCoupon.Value.gearing())
    let _spread                                    = cell (fun () -> _YoYInflationCoupon.Value.spread())
    let _yoyIndex                                  = cell (fun () -> _YoYInflationCoupon.Value.yoyIndex())
    let _accruedAmount                             (d : ICell<Date>)   
                                                   = cell (fun () -> _YoYInflationCoupon.Value.accruedAmount(d.Value))
    let _amount                                    = cell (fun () -> _YoYInflationCoupon.Value.amount())
    let _dayCounter                                = cell (fun () -> _YoYInflationCoupon.Value.dayCounter())
    let _fixingDate                                = cell (fun () -> _YoYInflationCoupon.Value.fixingDate())
    let _fixingDays                                = cell (fun () -> _YoYInflationCoupon.Value.fixingDays())
    let _index                                     = cell (fun () -> _YoYInflationCoupon.Value.index())
    let _indexFixing                               = cell (fun () -> _YoYInflationCoupon.Value.indexFixing())
    let _observationLag                            = cell (fun () -> _YoYInflationCoupon.Value.observationLag())
    let _price                                     (discountingCurve : ICell<Handle<YieldTermStructure>>)   
                                                   = cell (fun () -> _YoYInflationCoupon.Value.price(discountingCurve.Value))
    let _pricer                                    = cell (fun () -> _YoYInflationCoupon.Value.pricer())
    let _rate                                      = cell (fun () -> _YoYInflationCoupon.Value.rate())
    let _setPricer                                 (pricer : ICell<InflationCouponPricer>)   
                                                   = cell (fun () -> _YoYInflationCoupon.Value.setPricer(pricer.Value)
                                                                     _YoYInflationCoupon.Value)
    let _update                                    = cell (fun () -> _YoYInflationCoupon.Value.update()
                                                                     _YoYInflationCoupon.Value)
    let _accrualDays                               = cell (fun () -> _YoYInflationCoupon.Value.accrualDays())
    let _accrualEndDate                            = cell (fun () -> _YoYInflationCoupon.Value.accrualEndDate())
    let _accrualPeriod                             = cell (fun () -> _YoYInflationCoupon.Value.accrualPeriod())
    let _accrualStartDate                          = cell (fun () -> _YoYInflationCoupon.Value.accrualStartDate())
    let _accruedDays                               (d : ICell<Date>)   
                                                   = cell (fun () -> _YoYInflationCoupon.Value.accruedDays(d.Value))
    let _accruedPeriod                             (d : ICell<Date>)   
                                                   = cell (fun () -> _YoYInflationCoupon.Value.accruedPeriod(d.Value))
    let _date                                      = cell (fun () -> _YoYInflationCoupon.Value.date())
    let _exCouponDate                              = cell (fun () -> _YoYInflationCoupon.Value.exCouponDate())
    let _nominal                                   = cell (fun () -> _YoYInflationCoupon.Value.nominal())
    let _referencePeriodEnd                        = cell (fun () -> _YoYInflationCoupon.Value.referencePeriodEnd)
    let _referencePeriodStart                      = cell (fun () -> _YoYInflationCoupon.Value.referencePeriodStart)
    let _CompareTo                                 (cf : ICell<CashFlow>)   
                                                   = cell (fun () -> _YoYInflationCoupon.Value.CompareTo(cf.Value))
    let _Equals                                    (cf : ICell<Object>)   
                                                   = cell (fun () -> _YoYInflationCoupon.Value.Equals(cf.Value))
    let _hasOccurred                               (refDate : ICell<Date>) (includeRefDate : ICell<Nullable<bool>>)   
                                                   = cell (fun () -> _YoYInflationCoupon.Value.hasOccurred(refDate.Value, includeRefDate.Value))
    let _tradingExCoupon                           (refDate : ICell<Date>)   
                                                   = cell (fun () -> _YoYInflationCoupon.Value.tradingExCoupon(refDate.Value))
    let _accept                                    (v : ICell<IAcyclicVisitor>)   
                                                   = cell (fun () -> _YoYInflationCoupon.Value.accept(v.Value)
                                                                     _YoYInflationCoupon.Value)
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _YoYInflationCoupon.Value.registerWith(handler.Value)
                                                                     _YoYInflationCoupon.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _YoYInflationCoupon.Value.unregisterWith(handler.Value)
                                                                     _YoYInflationCoupon.Value)
