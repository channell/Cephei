...
*)
    ...
    let _a                                         = cell (fun () -> _AbcdInterpolation.Value.a())
    let _b                                         = cell (fun () -> _AbcdInterpolation.Value.b())
    let _c                                         = cell (fun () -> _AbcdInterpolation.Value.c())
    let _d                                         = cell (fun () -> _AbcdInterpolation.Value.d())
    let _endCriteria                               = cell (fun () -> _AbcdInterpolation.Value.endCriteria())
    let _k                                         (t : ICell<double>) (xBegin : ICell<Generic.List<double>>) (size : ICell<int>)   
                                                   = cell (fun () -> _AbcdInterpolation.Value.k(t.Value, xBegin.Value, size.Value))
    let _k1                                        = cell (fun () -> _AbcdInterpolation.Value.k())
    let _maxError                                  = cell (fun () -> _AbcdInterpolation.Value.maxError())
    let _rmsError                                  = cell (fun () -> _AbcdInterpolation.Value.rmsError())
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _AbcdInterpolation.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = cell (fun () -> _AbcdInterpolation.Value.empty())
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _AbcdInterpolation.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _AbcdInterpolation.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = cell (fun () -> _AbcdInterpolation.Value.update()
                                                                     _AbcdInterpolation.Value)
    let _value                                     (x : ICell<double>)   
                                                   = cell (fun () -> _AbcdInterpolation.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _AbcdInterpolation.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = cell (fun () -> _AbcdInterpolation.Value.xMax())
    let _xMin                                      = cell (fun () -> _AbcdInterpolation.Value.xMin())
    let _allowsExtrapolation                       = cell (fun () -> _AbcdInterpolation.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _AbcdInterpolation.Value.disableExtrapolation(b.Value)
                                                                     _AbcdInterpolation.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _AbcdInterpolation.Value.enableExtrapolation(b.Value)
                                                                     _AbcdInterpolation.Value)
    let _extrapolate                               = cell (fun () -> _AbcdInterpolation.Value.extrapolate)
