...
*)
    ...
    let _mandatoryTimes                            = cell (fun () -> _DiscretizedCallableFixedRateBond.Value.mandatoryTimes())
    let _reset                                     (size : ICell<int>)   
                                                   = cell (fun () -> _DiscretizedCallableFixedRateBond.Value.reset(size.Value)
                                                                     _DiscretizedCallableFixedRateBond.Value)
    let _adjustValues                              = cell (fun () -> _DiscretizedCallableFixedRateBond.Value.adjustValues()
                                                                     _DiscretizedCallableFixedRateBond.Value)
    let _initialize                                (Method : ICell<Lattice>) (t : ICell<double>)   
                                                   = cell (fun () -> _DiscretizedCallableFixedRateBond.Value.initialize(Method.Value, t.Value)
                                                                     _DiscretizedCallableFixedRateBond.Value)
    let _method                                    = cell (fun () -> _DiscretizedCallableFixedRateBond.Value.METHOD())
    let _partialRollback                           (To : ICell<double>)   
                                                   = cell (fun () -> _DiscretizedCallableFixedRateBond.Value.partialRollback(To.Value)
                                                                     _DiscretizedCallableFixedRateBond.Value)
    let _postAdjustValues                          = cell (fun () -> _DiscretizedCallableFixedRateBond.Value.postAdjustValues()
                                                                     _DiscretizedCallableFixedRateBond.Value)
    let _preAdjustValues                           = cell (fun () -> _DiscretizedCallableFixedRateBond.Value.preAdjustValues()
                                                                     _DiscretizedCallableFixedRateBond.Value)
    let _presentValue                              = cell (fun () -> _DiscretizedCallableFixedRateBond.Value.presentValue())
    let _rollback                                  (To : ICell<double>)   
                                                   = cell (fun () -> _DiscretizedCallableFixedRateBond.Value.rollback(To.Value)
                                                                     _DiscretizedCallableFixedRateBond.Value)
    let _setTime                                   (t : ICell<double>)   
                                                   = cell (fun () -> _DiscretizedCallableFixedRateBond.Value.setTime(t.Value)
                                                                     _DiscretizedCallableFixedRateBond.Value)
    let _setValues                                 (v : ICell<Vector>)   
                                                   = cell (fun () -> _DiscretizedCallableFixedRateBond.Value.setValues(v.Value)
                                                                     _DiscretizedCallableFixedRateBond.Value)
    let _time                                      = cell (fun () -> _DiscretizedCallableFixedRateBond.Value.time())
    let _values                                    = cell (fun () -> _DiscretizedCallableFixedRateBond.Value.values())
