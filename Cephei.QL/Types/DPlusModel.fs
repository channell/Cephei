...
*)
    let mutable
        _DPlus                                     = make (fun () -> new DPlus (gridPoints.Value, h.Value))
    let _add                                       (A : ICell<IOperator>) (B : ICell<IOperator>)   
                                                   = triv _DPlus (fun () -> _DPlus.Value.add(A.Value, B.Value))
    let _applyTo                                   (v : ICell<Vector>)   
                                                   = triv _DPlus (fun () -> _DPlus.Value.applyTo(v.Value))
    let _Clone                                     = triv _DPlus (fun () -> _DPlus.Value.Clone())
    let _diagonal                                  = triv _DPlus (fun () -> _DPlus.Value.diagonal())
    let _identity                                  (size : ICell<int>)   
                                                   = triv _DPlus (fun () -> _DPlus.Value.identity(size.Value))
    let _isTimeDependent                           = triv _DPlus (fun () -> _DPlus.Value.isTimeDependent())
    let _lowerDiagonal                             = triv _DPlus (fun () -> _DPlus.Value.lowerDiagonal())
    let _multiply                                  (a : ICell<double>) (o : ICell<IOperator>)   
                                                   = triv _DPlus (fun () -> _DPlus.Value.multiply(a.Value, o.Value))
    let _setFirstRow                               (valB : ICell<double>) (valC : ICell<double>)   
                                                   = triv _DPlus (fun () -> _DPlus.Value.setFirstRow(valB.Value, valC.Value)
                                                                            _DPlus.Value)
    let _setLastRow                                (valA : ICell<double>) (valB : ICell<double>)   
                                                   = triv _DPlus (fun () -> _DPlus.Value.setLastRow(valA.Value, valB.Value)
                                                                            _DPlus.Value)
    let _setMidRow                                 (i : ICell<int>) (valA : ICell<double>) (valB : ICell<double>) (valC : ICell<double>)   
                                                   = triv _DPlus (fun () -> _DPlus.Value.setMidRow(i.Value, valA.Value, valB.Value, valC.Value)
                                                                            _DPlus.Value)
    let _setMidRows                                (valA : ICell<double>) (valB : ICell<double>) (valC : ICell<double>)   
                                                   = triv _DPlus (fun () -> _DPlus.Value.setMidRows(valA.Value, valB.Value, valC.Value)
                                                                            _DPlus.Value)
    let _setTime                                   (t : ICell<double>)   
                                                   = triv _DPlus (fun () -> _DPlus.Value.setTime(t.Value)
                                                                            _DPlus.Value)
    let _size                                      = triv _DPlus (fun () -> _DPlus.Value.size())
    let _solveFor                                  (rhs : ICell<Vector>)   
                                                   = triv _DPlus (fun () -> _DPlus.Value.solveFor(rhs.Value))
    let _SOR                                       (rhs : ICell<Vector>) (tol : ICell<double>)   
                                                   = triv _DPlus (fun () -> _DPlus.Value.SOR(rhs.Value, tol.Value))
    let _subtract                                  (A : ICell<IOperator>) (B : ICell<IOperator>)   
                                                   = triv _DPlus (fun () -> _DPlus.Value.subtract(A.Value, B.Value))
    let _upperDiagonal                             = triv _DPlus (fun () -> _DPlus.Value.upperDiagonal())
    do this.Bind(_DPlus)
(* 
    casting 
*)
