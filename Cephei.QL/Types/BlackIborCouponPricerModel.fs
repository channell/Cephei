...
*)
    ...
    let _capletPrice                               (effectiveCap : ICell<double>)   
                                                   = cell (fun () -> _BlackIborCouponPricer.Value.capletPrice(effectiveCap.Value))
    let _capletRate                                (effectiveCap : ICell<double>)   
                                                   = cell (fun () -> _BlackIborCouponPricer.Value.capletRate(effectiveCap.Value))
    let _floorletPrice                             (effectiveFloor : ICell<double>)   
                                                   = cell (fun () -> _BlackIborCouponPricer.Value.floorletPrice(effectiveFloor.Value))
    let _floorletRate                              (effectiveFloor : ICell<double>)   
                                                   = cell (fun () -> _BlackIborCouponPricer.Value.floorletRate(effectiveFloor.Value))
    let _initialize                                (coupon : ICell<FloatingRateCoupon>)   
                                                   = cell (fun () -> _BlackIborCouponPricer.Value.initialize(coupon.Value)
                                                                     _BlackIborCouponPricer.Value)
    let _swapletPrice                              = cell (fun () -> _BlackIborCouponPricer.Value.swapletPrice())
    let _swapletRate                               = cell (fun () -> _BlackIborCouponPricer.Value.swapletRate())
    let _capletVolatility                          = cell (fun () -> _BlackIborCouponPricer.Value.capletVolatility())
    let _setCapletVolatility                       (v : ICell<Handle<OptionletVolatilityStructure>>)   
                                                   = cell (fun () -> _BlackIborCouponPricer.Value.setCapletVolatility(v.Value)
                                                                     _BlackIborCouponPricer.Value)
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _BlackIborCouponPricer.Value.registerWith(handler.Value)
                                                                     _BlackIborCouponPricer.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _BlackIborCouponPricer.Value.unregisterWith(handler.Value)
                                                                     _BlackIborCouponPricer.Value)
    let _update                                    = cell (fun () -> _BlackIborCouponPricer.Value.update()
                                                                     _BlackIborCouponPricer.Value)
