...
*)
    let mutable
        _BlackIborCouponPricer                     = make (fun () -> (createEvaluationDate _evaluationDate (fun () ->new BlackIborCouponPricer (v.Value, timingAdjustment.Value, correlation.Value))))
    let _capletPrice                               (effectiveCap : ICell<double>)   
                                                   = triv _BlackIborCouponPricer (fun () -> (curryEvaluationDate _evaluationDate _BlackIborCouponPricer).Value.capletPrice(effectiveCap.Value))
    let _capletRate                                (effectiveCap : ICell<double>)   
                                                   = triv _BlackIborCouponPricer (fun () -> (curryEvaluationDate _evaluationDate _BlackIborCouponPricer).Value.capletRate(effectiveCap.Value))
    let _floorletPrice                             (effectiveFloor : ICell<double>)   
                                                   = triv _BlackIborCouponPricer (fun () -> (curryEvaluationDate _evaluationDate _BlackIborCouponPricer).Value.floorletPrice(effectiveFloor.Value))
    let _floorletRate                              (effectiveFloor : ICell<double>)   
                                                   = triv _BlackIborCouponPricer (fun () -> (curryEvaluationDate _evaluationDate _BlackIborCouponPricer).Value.floorletRate(effectiveFloor.Value))
    let _initialize                                (coupon : ICell<FloatingRateCoupon>)   
                                                   = triv _BlackIborCouponPricer (fun () -> (curryEvaluationDate _evaluationDate _BlackIborCouponPricer).Value.initialize(coupon.Value)
                                                                                            _BlackIborCouponPricer.Value)
    let _swapletPrice                              = triv _BlackIborCouponPricer (fun () -> (curryEvaluationDate _evaluationDate _BlackIborCouponPricer).Value.swapletPrice())
    let _swapletRate                               = triv _BlackIborCouponPricer (fun () -> (curryEvaluationDate _evaluationDate _BlackIborCouponPricer).Value.swapletRate())
    let _capletVolatility                          = triv _BlackIborCouponPricer (fun () -> (curryEvaluationDate _evaluationDate _BlackIborCouponPricer).Value.capletVolatility())
    let _setCapletVolatility                       (v : ICell<Handle<OptionletVolatilityStructure>>)   
                                                   = triv _BlackIborCouponPricer (fun () -> (curryEvaluationDate _evaluationDate _BlackIborCouponPricer).Value.setCapletVolatility(v.Value)
                                                                                            _BlackIborCouponPricer.Value)
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv _BlackIborCouponPricer (fun () -> (curryEvaluationDate _evaluationDate _BlackIborCouponPricer).Value.registerWith(handler.Value)
                                                                                            _BlackIborCouponPricer.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = triv _BlackIborCouponPricer (fun () -> (curryEvaluationDate _evaluationDate _BlackIborCouponPricer).Value.unregisterWith(handler.Value)
                                                                                            _BlackIborCouponPricer.Value)
    let _update                                    = triv _BlackIborCouponPricer (fun () -> (curryEvaluationDate _evaluationDate _BlackIborCouponPricer).Value.update()
                                                                                            _BlackIborCouponPricer.Value)
