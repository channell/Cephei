...
*)
    ...
    let _alpha                                     (i : ICell<int>)   
                                                   = cell (fun () -> _GaussHermitePolynomial.Value.alpha(i.Value))
    let _beta                                      (i : ICell<int>)   
                                                   = cell (fun () -> _GaussHermitePolynomial.Value.beta(i.Value))
    let _mu_0                                      = cell (fun () -> _GaussHermitePolynomial.Value.mu_0())
    let _w                                         (x : ICell<double>)   
                                                   = cell (fun () -> _GaussHermitePolynomial.Value.w(x.Value))
    let _value                                     (n : ICell<int>) (x : ICell<double>)   
                                                   = cell (fun () -> _GaussHermitePolynomial.Value.value(n.Value, x.Value))
    let _weightedValue                             (n : ICell<int>) (x : ICell<double>)   
                                                   = cell (fun () -> _GaussHermitePolynomial.Value.weightedValue(n.Value, x.Value))
