...
*)
    ...
    let _Equals                                    (o : ICell<Object>)   
                                                   = triv (fun () -> _EEKCurrency.Value.Equals(o.Value))
    let _format                                    = triv (fun () -> _EEKCurrency.Value.format)
    let _fractionsPerUnit                          = triv (fun () -> _EEKCurrency.Value.fractionsPerUnit)
    let _fractionSymbol                            = triv (fun () -> _EEKCurrency.Value.fractionSymbol)
    let _name                                      = triv (fun () -> _EEKCurrency.Value.name)
    let _numericCode                               = triv (fun () -> _EEKCurrency.Value.numericCode)
    let _rounding                                  = triv (fun () -> _EEKCurrency.Value.rounding)
    let _symbol                                    = triv (fun () -> _EEKCurrency.Value.symbol)
    let _ToString                                  = triv (fun () -> _EEKCurrency.Value.ToString())
    let _triangulationCurrency                     = triv (fun () -> _EEKCurrency.Value.triangulationCurrency)
