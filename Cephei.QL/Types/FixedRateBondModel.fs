...
*)
    let mutable
        _FixedRateBond                             = make (fun () -> withEngine pricingEngine evaluationDate (new FixedRateBond (settlementDays.Value, faceAmount.Value, schedule.Value, coupons.Value, accrualDayCounter.Value, paymentConvention.Value, redemption.Value, issueDate.Value, paymentCalendar.Value, exCouponPeriod.Value, exCouponCalendar.Value, exCouponConvention.Value, exCouponEndOfMonth.Value)))
    let _dayCounter                                = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).dayCounter())
    let _frequency                                 = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).frequency())
    let _accruedAmount                             (settlement : ICell<Date>)   
                                                   = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).accruedAmount(settlement.Value))
    let _calendar                                  = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).calendar())
    let _cashflows                                 = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).cashflows())
    let _cleanPrice                                = cell _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).cleanPrice())
    let _cleanPrice1                               (Yield : ICell<double>) (dc : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (settlement : ICell<Date>)   
                                                   = cell _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).cleanPrice(Yield.Value, dc.Value, comp.Value, freq.Value, settlement.Value))
    let _dirtyPrice                                = cell _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).dirtyPrice())
    let _dirtyPrice1                               (Yield : ICell<double>) (dc : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (settlement : ICell<Date>)   
                                                   = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).dirtyPrice(Yield.Value, dc.Value, comp.Value, freq.Value, settlement.Value))
    let _isExpired                                 = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).isExpired())
    let _issueDate                                 = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).issueDate())
    let _isTradable                                (d : ICell<Date>)   
                                                   = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).isTradable(d.Value))
    let _maturityDate                              = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).maturityDate())
    let _nextCashFlowDate                          (settlement : ICell<Date>)   
                                                   = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).nextCashFlowDate(settlement.Value))
    let _nextCouponRate                            (settlement : ICell<Date>)   
                                                   = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).nextCouponRate(settlement.Value))
    let _notional                                  (d : ICell<Date>)   
                                                   = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).notional(d.Value))
    let _notionals                                 = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).notionals())
    let _previousCashFlowDate                      (settlement : ICell<Date>)   
                                                   = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).previousCashFlowDate(settlement.Value))
    let _previousCouponRate                        (settlement : ICell<Date>)   
                                                   = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).previousCouponRate(settlement.Value))
    let _redemption                                = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).redemption())
    let _redemptions                               = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).redemptions())
    let _settlementDate                            (date : ICell<Date>)   
                                                   = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).settlementDate(date.Value))
    let _settlementDays                            = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).settlementDays())
    let _settlementValue                           (cleanPrice : ICell<double>)   
                                                   = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).settlementValue(cleanPrice.Value))
    let _settlementValue1                          = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).settlementValue())
    let _startDate                                 = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).startDate())
    let _yield                                     (dc : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (accuracy : ICell<double>) (maxEvaluations : ICell<int>)   
                                                   = cell _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).YIELD(dc.Value, comp.Value, freq.Value, accuracy.Value, maxEvaluations.Value))
    let _yield1                                    (cleanPrice : ICell<double>) (dc : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (settlement : ICell<Date>) (accuracy : ICell<double>) (maxEvaluations : ICell<int>)   
                                                   = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).YIELD(cleanPrice.Value, dc.Value, comp.Value, freq.Value, settlement.Value, accuracy.Value, maxEvaluations.Value))
    let _CASH                                      = cell _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).CASH())
    let _errorEstimate                             = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).errorEstimate())
    let _NPV                                       = cell _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).setPricingEngine(e.Value)
                                                                                    _FixedRateBond.Value)
    let _valuationDate                             = triv _FixedRateBond (fun () -> (withEvaluationDate _evaluationDate _FixedRateBond).valuationDate())
