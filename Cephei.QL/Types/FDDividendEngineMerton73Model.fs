...
*)
    ...
    let _factory2                                  (Process : ICell<GeneralizedBlackScholesProcess>) (timeSteps : ICell<int>) (gridPoints : ICell<int>) (timeDependent : ICell<bool>)   
                                                   = cell (fun () -> _FDDividendEngineMerton73.Value.factory2(Process.Value, timeSteps.Value, gridPoints.Value, timeDependent.Value))
    let _factory                                   (Process : ICell<GeneralizedBlackScholesProcess>) (timeSteps : ICell<int>) (gridPoints : ICell<int>) (timeDependent : ICell<bool>)   
                                                   = cell (fun () -> _FDDividendEngineMerton73.Value.factory(Process.Value, timeSteps.Value, gridPoints.Value, timeDependent.Value))
    let _calculate                                 (r : ICell<IPricingEngineResults>)   
                                                   = cell (fun () -> _FDDividendEngineMerton73.Value.calculate(r.Value)
                                                                     _FDDividendEngineMerton73.Value)
    let _setStepCondition                          (impl : ICell<Func<IStepCondition<Vector>>>)   
                                                   = cell (fun () -> _FDDividendEngineMerton73.Value.setStepCondition(impl.Value)
                                                                     _FDDividendEngineMerton73.Value)
    let _ensureStrikeInGrid                        = cell (fun () -> _FDDividendEngineMerton73.Value.ensureStrikeInGrid()
                                                                     _FDDividendEngineMerton73.Value)
    let _getResidualTime                           = cell (fun () -> _FDDividendEngineMerton73.Value.getResidualTime())
    let _grid                                      = cell (fun () -> _FDDividendEngineMerton73.Value.grid())
    let _intrinsicValues_                          = cell (fun () -> _FDDividendEngineMerton73.Value.intrinsicValues_)
