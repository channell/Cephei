...
*)
    let mutable
        _FDDividendEngineMerton73                  = make (fun () -> new FDDividendEngineMerton73 (Process.Value, timeSteps.Value, gridPoints.Value, timeDependent.Value))
    let _factory2                                  (Process : ICell<GeneralizedBlackScholesProcess>) (timeSteps : ICell<int>) (gridPoints : ICell<int>) (timeDependent : ICell<bool>)   
                                                   = triv _FDDividendEngineMerton73 (fun () -> _FDDividendEngineMerton73.Value.factory2(Process.Value, timeSteps.Value, gridPoints.Value, timeDependent.Value))
    let _factory                                   (Process : ICell<GeneralizedBlackScholesProcess>) (timeSteps : ICell<int>) (gridPoints : ICell<int>) (timeDependent : ICell<bool>)   
                                                   = triv _FDDividendEngineMerton73 (fun () -> _FDDividendEngineMerton73.Value.factory(Process.Value, timeSteps.Value, gridPoints.Value, timeDependent.Value))
    let _calculate                                 (r : ICell<IPricingEngineResults>)   
                                                   = triv _FDDividendEngineMerton73 (fun () -> _FDDividendEngineMerton73.Value.calculate(r.Value)
                                                                                               _FDDividendEngineMerton73.Value)
    let _setStepCondition                          (impl : ICell<Func<IStepCondition<Vector>>>)   
                                                   = triv _FDDividendEngineMerton73 (fun () -> _FDDividendEngineMerton73.Value.setStepCondition(impl.Value)
                                                                                               _FDDividendEngineMerton73.Value)
    let _ensureStrikeInGrid                        = triv _FDDividendEngineMerton73 (fun () -> _FDDividendEngineMerton73.Value.ensureStrikeInGrid()
                                                                                               _FDDividendEngineMerton73.Value)
    let _getResidualTime                           = triv _FDDividendEngineMerton73 (fun () -> _FDDividendEngineMerton73.Value.getResidualTime())
    let _grid                                      = triv _FDDividendEngineMerton73 (fun () -> _FDDividendEngineMerton73.Value.grid())
    let _intrinsicValues_                          = triv _FDDividendEngineMerton73 (fun () -> _FDDividendEngineMerton73.Value.intrinsicValues_)
...
*)
    let mutable
        _FDDividendEngineMerton73                  = make (fun () -> new FDDividendEngineMerton73 ())
    let _factory2                                  (Process : ICell<GeneralizedBlackScholesProcess>) (timeSteps : ICell<int>) (gridPoints : ICell<int>) (timeDependent : ICell<bool>)   
                                                   = triv _FDDividendEngineMerton73 (fun () -> _FDDividendEngineMerton73.Value.factory2(Process.Value, timeSteps.Value, gridPoints.Value, timeDependent.Value))
    let _factory                                   (Process : ICell<GeneralizedBlackScholesProcess>) (timeSteps : ICell<int>) (gridPoints : ICell<int>) (timeDependent : ICell<bool>)   
                                                   = triv _FDDividendEngineMerton73 (fun () -> _FDDividendEngineMerton73.Value.factory(Process.Value, timeSteps.Value, gridPoints.Value, timeDependent.Value))
