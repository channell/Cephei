...
*)
    let mutable
        _Israel                                    = make (fun () -> new Israel (m.Value))
    let _addedHolidays                             = triv _Israel (fun () -> _Israel.Value.addedHolidays)
    let _addHoliday                                (d : ICell<Date>)   
                                                   = triv _Israel (fun () -> _Israel.Value.addHoliday(d.Value)
                                                                             _Israel.Value)
    let _adjust                                    (d : ICell<Date>) (c : ICell<BusinessDayConvention>)   
                                                   = triv _Israel (fun () -> _Israel.Value.adjust(d.Value, c.Value))
    let _advance                                   (d : ICell<Date>) (p : ICell<Period>) (c : ICell<BusinessDayConvention>) (endOfMonth : ICell<bool>)   
                                                   = triv _Israel (fun () -> _Israel.Value.advance(d.Value, p.Value, c.Value, endOfMonth.Value))
    let _advance1                                  (d : ICell<Date>) (n : ICell<int>) (unit : ICell<TimeUnit>) (c : ICell<BusinessDayConvention>) (endOfMonth : ICell<bool>)   
                                                   = triv _Israel (fun () -> _Israel.Value.advance(d.Value, n.Value, unit.Value, c.Value, endOfMonth.Value))
    let _businessDaysBetween                       (from : ICell<Date>) (To : ICell<Date>) (includeFirst : ICell<bool>) (includeLast : ICell<bool>)   
                                                   = triv _Israel (fun () -> _Israel.Value.businessDaysBetween(from.Value, To.Value, includeFirst.Value, includeLast.Value))
    let _calendar                                  = triv _Israel (fun () -> _Israel.Value.calendar)
    let _empty                                     = triv _Israel (fun () -> _Israel.Value.empty())
    let _endOfMonth                                (d : ICell<Date>)   
                                                   = triv _Israel (fun () -> _Israel.Value.endOfMonth(d.Value))
    let _Equals                                    (o : ICell<Object>)   
                                                   = triv _Israel (fun () -> _Israel.Value.Equals(o.Value))
    let _isBusinessDay                             (d : ICell<Date>)   
                                                   = triv _Israel (fun () -> _Israel.Value.isBusinessDay(d.Value))
    let _isEndOfMonth                              (d : ICell<Date>)   
                                                   = triv _Israel (fun () -> _Israel.Value.isEndOfMonth(d.Value))
    let _isHoliday                                 (d : ICell<Date>)   
                                                   = triv _Israel (fun () -> _Israel.Value.isHoliday(d.Value))
    let _isWeekend                                 (w : ICell<DayOfWeek>)   
                                                   = triv _Israel (fun () -> _Israel.Value.isWeekend(w.Value))
    let _name                                      = triv _Israel (fun () -> _Israel.Value.name())
    let _removedHolidays                           = triv _Israel (fun () -> _Israel.Value.removedHolidays)
    let _removeHoliday                             (d : ICell<Date>)   
                                                   = triv _Israel (fun () -> _Israel.Value.removeHoliday(d.Value)
                                                                             _Israel.Value)
