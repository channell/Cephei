...
*)
    let mutable
        _VoluntaryPrepay                           = make (fun () -> new VoluntaryPrepay (amount.Value, date.Value))
    let _amount                                    = triv _VoluntaryPrepay (fun () -> _VoluntaryPrepay.Value.amount())
    let _date                                      = triv _VoluntaryPrepay (fun () -> _VoluntaryPrepay.Value.date())
    let _CompareTo                                 (cf : ICell<CashFlow>)   
                                                   = triv _VoluntaryPrepay (fun () -> _VoluntaryPrepay.Value.CompareTo(cf.Value))
    let _Equals                                    (cf : ICell<Object>)   
                                                   = triv _VoluntaryPrepay (fun () -> _VoluntaryPrepay.Value.Equals(cf.Value))
    let _exCouponDate                              = triv _VoluntaryPrepay (fun () -> _VoluntaryPrepay.Value.exCouponDate())
    let _hasOccurred                               (refDate : ICell<Date>) (includeRefDate : ICell<Nullable<bool>>)   
                                                   = triv _VoluntaryPrepay (fun () -> _VoluntaryPrepay.Value.hasOccurred(refDate.Value, includeRefDate.Value))
    let _tradingExCoupon                           (refDate : ICell<Date>)   
                                                   = triv _VoluntaryPrepay (fun () -> _VoluntaryPrepay.Value.tradingExCoupon(refDate.Value))
    let _accept                                    (v : ICell<IAcyclicVisitor>)   
                                                   = triv _VoluntaryPrepay (fun () -> _VoluntaryPrepay.Value.accept(v.Value)
                                                                                      _VoluntaryPrepay.Value)
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv _VoluntaryPrepay (fun () -> _VoluntaryPrepay.Value.registerWith(handler.Value)
                                                                                      _VoluntaryPrepay.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = triv _VoluntaryPrepay (fun () -> _VoluntaryPrepay.Value.unregisterWith(handler.Value)
                                                                                      _VoluntaryPrepay.Value)
