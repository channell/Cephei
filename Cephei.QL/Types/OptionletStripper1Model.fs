...
*)
    ...
    let _capFloorPrices                            = cell (fun () -> _OptionletStripper1.Value.capFloorPrices())
    let _capFloorVolatilities                      = cell (fun () -> _OptionletStripper1.Value.capFloorVolatilities())
    let _optionletPrices                           = cell (fun () -> _OptionletStripper1.Value.optionletPrices())
    let _switchStrike                              = cell (fun () -> _OptionletStripper1.Value.switchStrike())
    let _atmOptionletRates                         = cell (fun () -> _OptionletStripper1.Value.atmOptionletRates())
    let _businessDayConvention                     = cell (fun () -> _OptionletStripper1.Value.businessDayConvention())
    let _calendar                                  = cell (fun () -> _OptionletStripper1.Value.calendar())
    let _dayCounter                                = cell (fun () -> _OptionletStripper1.Value.dayCounter())
    let _displacement                              = cell (fun () -> _OptionletStripper1.Value.displacement())
    let _iborIndex                                 = cell (fun () -> _OptionletStripper1.Value.iborIndex())
    let _optionletAccrualPeriods                   = cell (fun () -> _OptionletStripper1.Value.optionletAccrualPeriods())
    let _optionletFixingDates                      = cell (fun () -> _OptionletStripper1.Value.optionletFixingDates())
    let _optionletFixingTenors                     = cell (fun () -> _OptionletStripper1.Value.optionletFixingTenors())
    let _optionletFixingTimes                      = cell (fun () -> _OptionletStripper1.Value.optionletFixingTimes())
    let _optionletMaturities                       = cell (fun () -> _OptionletStripper1.Value.optionletMaturities())
    let _optionletPaymentDates                     = cell (fun () -> _OptionletStripper1.Value.optionletPaymentDates())
    let _optionletStrikes                          (i : ICell<int>)   
                                                   = cell (fun () -> _OptionletStripper1.Value.optionletStrikes(i.Value))
    let _optionletVolatilities                     (i : ICell<int>)   
                                                   = cell (fun () -> _OptionletStripper1.Value.optionletVolatilities(i.Value))
    let _settlementDays                            = cell (fun () -> _OptionletStripper1.Value.settlementDays())
    let _termVolSurface                            = cell (fun () -> _OptionletStripper1.Value.termVolSurface())
    let _volatilityType                            = cell (fun () -> _OptionletStripper1.Value.volatilityType())
