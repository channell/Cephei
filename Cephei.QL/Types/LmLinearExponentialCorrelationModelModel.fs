...
(*
    Functions
*)
    let _LmLinearExponentialCorrelationModel       = cell (fun () -> new LmLinearExponentialCorrelationModel (size.Value, rho.Value, beta.Value, factors.Value))
    let _correlation                               (i : ICell<int>) (j : ICell<int>) (t : ICell<double>) (x : ICell<Vector>)   
                                                   = cell (fun () -> _LmLinearExponentialCorrelationModel.Value.correlation(i.Value, j.Value, t.Value, x.Value))
    let _correlation1                              (t : ICell<double>) (x : ICell<Vector>)   
                                                   = cell (fun () -> _LmLinearExponentialCorrelationModel.Value.correlation(t.Value, x.Value))
    let _factors                                   = cell (fun () -> _LmLinearExponentialCorrelationModel.Value.factors())
    let _isTimeIndependent                         = cell (fun () -> _LmLinearExponentialCorrelationModel.Value.isTimeIndependent())
    let _pseudoSqrt                                (t : ICell<double>) (x : ICell<Vector>)   
                                                   = cell (fun () -> _LmLinearExponentialCorrelationModel.Value.pseudoSqrt(t.Value, x.Value))
    let _parameters                                = cell (fun () -> _LmLinearExponentialCorrelationModel.Value.parameters())
    let _setParams                                 (arguments : ICell<Generic.List<Parameter>>)   
                                                   = cell (fun () -> _LmLinearExponentialCorrelationModel.Value.setParams(arguments.Value)
                                                                     _LmLinearExponentialCorrelationModel.Value)
    let _size                                      = cell (fun () -> _LmLinearExponentialCorrelationModel.Value.size())
