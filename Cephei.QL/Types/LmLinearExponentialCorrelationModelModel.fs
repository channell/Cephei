...
*)
    let mutable
        _LmLinearExponentialCorrelationModel       = make (fun () -> new LmLinearExponentialCorrelationModel (size.Value, rho.Value, beta.Value, factors.Value))
    let _correlation                               (i : ICell<int>) (j : ICell<int>) (t : ICell<double>) (x : ICell<Vector>)   
                                                   = triv _LmLinearExponentialCorrelationModel (fun () -> _LmLinearExponentialCorrelationModel.Value.correlation(i.Value, j.Value, t.Value, x.Value))
    let _correlation1                              (t : ICell<double>) (x : ICell<Vector>)   
                                                   = triv _LmLinearExponentialCorrelationModel (fun () -> _LmLinearExponentialCorrelationModel.Value.correlation(t.Value, x.Value))
    let _factors                                   = triv _LmLinearExponentialCorrelationModel (fun () -> _LmLinearExponentialCorrelationModel.Value.factors())
    let _isTimeIndependent                         = triv _LmLinearExponentialCorrelationModel (fun () -> _LmLinearExponentialCorrelationModel.Value.isTimeIndependent())
    let _pseudoSqrt                                (t : ICell<double>) (x : ICell<Vector>)   
                                                   = triv _LmLinearExponentialCorrelationModel (fun () -> _LmLinearExponentialCorrelationModel.Value.pseudoSqrt(t.Value, x.Value))
    let _parameters                                = triv _LmLinearExponentialCorrelationModel (fun () -> _LmLinearExponentialCorrelationModel.Value.parameters())
    let _setParams                                 (arguments : ICell<Generic.List<Parameter>>)   
                                                   = triv _LmLinearExponentialCorrelationModel (fun () -> _LmLinearExponentialCorrelationModel.Value.setParams(arguments.Value)
                                                                                                          _LmLinearExponentialCorrelationModel.Value)
    let _size                                      = triv _LmLinearExponentialCorrelationModel (fun () -> _LmLinearExponentialCorrelationModel.Value.size())
