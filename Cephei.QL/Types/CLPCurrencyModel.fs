...
*)
    ...
    let _Equals                                    (o : ICell<Object>)   
                                                   = triv (fun () -> _CLPCurrency.Value.Equals(o.Value))
    let _format                                    = triv (fun () -> _CLPCurrency.Value.format)
    let _fractionsPerUnit                          = triv (fun () -> _CLPCurrency.Value.fractionsPerUnit)
    let _fractionSymbol                            = triv (fun () -> _CLPCurrency.Value.fractionSymbol)
    let _name                                      = triv (fun () -> _CLPCurrency.Value.name)
    let _numericCode                               = triv (fun () -> _CLPCurrency.Value.numericCode)
    let _rounding                                  = triv (fun () -> _CLPCurrency.Value.rounding)
    let _symbol                                    = triv (fun () -> _CLPCurrency.Value.symbol)
    let _ToString                                  = triv (fun () -> _CLPCurrency.Value.ToString())
    let _triangulationCurrency                     = triv (fun () -> _CLPCurrency.Value.triangulationCurrency)
