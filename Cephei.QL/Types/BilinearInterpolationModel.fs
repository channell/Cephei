...
*)
    ...
    let _locateX                                   (x : ICell<double>)   
                                                   = triv (fun () -> _BilinearInterpolation.Value.locateX(x.Value))
    let _locateY                                   (y : ICell<double>)   
                                                   = triv (fun () -> _BilinearInterpolation.Value.locateY(y.Value))
    let _update                                    = triv (fun () -> _BilinearInterpolation.Value.update()
                                                                     _BilinearInterpolation.Value)
    let _value                                     (x : ICell<double>) (y : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _BilinearInterpolation.Value.value(x.Value, y.Value, allowExtrapolation.Value))
    let _value1                                    (x : ICell<double>) (y : ICell<double>)   
                                                   = triv (fun () -> _BilinearInterpolation.Value.value(x.Value, y.Value))
    let _xMax                                      = triv (fun () -> _BilinearInterpolation.Value.xMax())
    let _xMin                                      = triv (fun () -> _BilinearInterpolation.Value.xMin())
    let _xValues                                   = triv (fun () -> _BilinearInterpolation.Value.xValues())
    let _yMax                                      = triv (fun () -> _BilinearInterpolation.Value.yMax())
    let _yMin                                      = triv (fun () -> _BilinearInterpolation.Value.yMin())
    let _yValues                                   = triv (fun () -> _BilinearInterpolation.Value.yValues())
    let _zData                                     = triv (fun () -> _BilinearInterpolation.Value.zData())
    let _allowsExtrapolation                       = triv (fun () -> _BilinearInterpolation.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv (fun () -> _BilinearInterpolation.Value.disableExtrapolation(b.Value)
                                                                     _BilinearInterpolation.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv (fun () -> _BilinearInterpolation.Value.enableExtrapolation(b.Value)
                                                                     _BilinearInterpolation.Value)
