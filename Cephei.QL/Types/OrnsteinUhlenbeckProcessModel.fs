...
*)
    let mutable
        _OrnsteinUhlenbeckProcess                  = make (fun () -> new OrnsteinUhlenbeckProcess (speed.Value, vol.Value, x0.Value, level.Value))
    let _diffusion                                 (UnnamedParameter1 : ICell<double>) (UnnamedParameter2 : ICell<double>)   
                                                   = triv _OrnsteinUhlenbeckProcess (fun () -> _OrnsteinUhlenbeckProcess.Value.diffusion(UnnamedParameter1.Value, UnnamedParameter2.Value))
    let _drift                                     (UnnamedParameter1 : ICell<double>) (x : ICell<double>)   
                                                   = triv _OrnsteinUhlenbeckProcess (fun () -> _OrnsteinUhlenbeckProcess.Value.drift(UnnamedParameter1.Value, x.Value))
    let _expectation                               (UnnamedParameter1 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = triv _OrnsteinUhlenbeckProcess (fun () -> _OrnsteinUhlenbeckProcess.Value.expectation(UnnamedParameter1.Value, x0.Value, dt.Value))
    let _level                                     = triv _OrnsteinUhlenbeckProcess (fun () -> _OrnsteinUhlenbeckProcess.Value.level())
    let _speed                                     = triv _OrnsteinUhlenbeckProcess (fun () -> _OrnsteinUhlenbeckProcess.Value.speed())
    let _stdDeviation                              (t : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = triv _OrnsteinUhlenbeckProcess (fun () -> _OrnsteinUhlenbeckProcess.Value.stdDeviation(t.Value, x0.Value, dt.Value))
    let _variance                                  (UnnamedParameter1 : ICell<double>) (UnnamedParameter2 : ICell<double>) (dt : ICell<double>)   
                                                   = triv _OrnsteinUhlenbeckProcess (fun () -> _OrnsteinUhlenbeckProcess.Value.variance(UnnamedParameter1.Value, UnnamedParameter2.Value, dt.Value))
    let _volatility                                = triv _OrnsteinUhlenbeckProcess (fun () -> _OrnsteinUhlenbeckProcess.Value.volatility())
    let _x0                                        = triv _OrnsteinUhlenbeckProcess (fun () -> _OrnsteinUhlenbeckProcess.Value.x0())
    let _apply                                     (x0 : ICell<double>) (dx : ICell<double>)   
                                                   = triv _OrnsteinUhlenbeckProcess (fun () -> _OrnsteinUhlenbeckProcess.Value.apply(x0.Value, dx.Value))
    let _apply1                                    (x0 : ICell<Vector>) (dx : ICell<Vector>)   
                                                   = triv _OrnsteinUhlenbeckProcess (fun () -> _OrnsteinUhlenbeckProcess.Value.apply(x0.Value, dx.Value))
    let _evolve                                    (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>) (dw : ICell<Vector>)   
                                                   = triv _OrnsteinUhlenbeckProcess (fun () -> _OrnsteinUhlenbeckProcess.Value.evolve(t0.Value, x0.Value, dt.Value, dw.Value))
    let _evolve1                                   (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>) (dw : ICell<double>)   
                                                   = triv _OrnsteinUhlenbeckProcess (fun () -> _OrnsteinUhlenbeckProcess.Value.evolve(t0.Value, x0.Value, dt.Value, dw.Value))
    let _initialValues                             = triv _OrnsteinUhlenbeckProcess (fun () -> _OrnsteinUhlenbeckProcess.Value.initialValues())
    let _size                                      = triv _OrnsteinUhlenbeckProcess (fun () -> _OrnsteinUhlenbeckProcess.Value.size())
    let _covariance                                (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>)   
                                                   = triv _OrnsteinUhlenbeckProcess (fun () -> _OrnsteinUhlenbeckProcess.Value.covariance(t0.Value, x0.Value, dt.Value))
    let _factors                                   = triv _OrnsteinUhlenbeckProcess (fun () -> _OrnsteinUhlenbeckProcess.Value.factors())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv _OrnsteinUhlenbeckProcess (fun () -> _OrnsteinUhlenbeckProcess.Value.registerWith(handler.Value)
                                                                                               _OrnsteinUhlenbeckProcess.Value)
    let _time                                      (d : ICell<Date>)   
                                                   = triv _OrnsteinUhlenbeckProcess (fun () -> _OrnsteinUhlenbeckProcess.Value.time(d.Value))
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = triv _OrnsteinUhlenbeckProcess (fun () -> _OrnsteinUhlenbeckProcess.Value.unregisterWith(handler.Value)
                                                                                               _OrnsteinUhlenbeckProcess.Value)
    let _update                                    = triv _OrnsteinUhlenbeckProcess (fun () -> _OrnsteinUhlenbeckProcess.Value.update()
                                                                                               _OrnsteinUhlenbeckProcess.Value)
