...
*)
    ...
    let _drift                                     (UnnamedParameter1 : ICell<double>) (x : ICell<double>)   
                                                   = triv (fun () -> _OrnsteinUhlenbeckProcess.Value.drift(UnnamedParameter1.Value, x.Value))
    let _expectation                               (UnnamedParameter1 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = triv (fun () -> _OrnsteinUhlenbeckProcess.Value.expectation(UnnamedParameter1.Value, x0.Value, dt.Value))
    let _level                                     = triv (fun () -> _OrnsteinUhlenbeckProcess.Value.level())
    let _speed                                     = triv (fun () -> _OrnsteinUhlenbeckProcess.Value.speed())
    let _stdDeviation                              (t : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = triv (fun () -> _OrnsteinUhlenbeckProcess.Value.stdDeviation(t.Value, x0.Value, dt.Value))
    let _variance                                  (UnnamedParameter1 : ICell<double>) (UnnamedParameter2 : ICell<double>) (dt : ICell<double>)   
                                                   = triv (fun () -> _OrnsteinUhlenbeckProcess.Value.variance(UnnamedParameter1.Value, UnnamedParameter2.Value, dt.Value))
    let _volatility                                = triv (fun () -> _OrnsteinUhlenbeckProcess.Value.volatility())
    let _x0                                        = triv (fun () -> _OrnsteinUhlenbeckProcess.Value.x0())
    let _apply                                     (x0 : ICell<double>) (dx : ICell<double>)   
                                                   = triv (fun () -> _OrnsteinUhlenbeckProcess.Value.apply(x0.Value, dx.Value))
    let _apply1                                    (x0 : ICell<Vector>) (dx : ICell<Vector>)   
                                                   = triv (fun () -> _OrnsteinUhlenbeckProcess.Value.apply(x0.Value, dx.Value))
    let _evolve                                    (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>) (dw : ICell<Vector>)   
                                                   = triv (fun () -> _OrnsteinUhlenbeckProcess.Value.evolve(t0.Value, x0.Value, dt.Value, dw.Value))
    let _evolve1                                   (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>) (dw : ICell<double>)   
                                                   = triv (fun () -> _OrnsteinUhlenbeckProcess.Value.evolve(t0.Value, x0.Value, dt.Value, dw.Value))
    let _initialValues                             = triv (fun () -> _OrnsteinUhlenbeckProcess.Value.initialValues())
    let _size                                      = triv (fun () -> _OrnsteinUhlenbeckProcess.Value.size())
    let _covariance                                (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>)   
                                                   = triv (fun () -> _OrnsteinUhlenbeckProcess.Value.covariance(t0.Value, x0.Value, dt.Value))
    let _factors                                   = triv (fun () -> _OrnsteinUhlenbeckProcess.Value.factors())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv (fun () -> _OrnsteinUhlenbeckProcess.Value.registerWith(handler.Value)
                                                                     _OrnsteinUhlenbeckProcess.Value)
    let _time                                      (d : ICell<Date>)   
                                                   = triv (fun () -> _OrnsteinUhlenbeckProcess.Value.time(d.Value))
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = triv (fun () -> _OrnsteinUhlenbeckProcess.Value.unregisterWith(handler.Value)
                                                                     _OrnsteinUhlenbeckProcess.Value)
