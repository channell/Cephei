...
*)
    ...
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearCubicNaturalSpline.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = triv (fun () -> _MixedLinearCubicNaturalSpline.Value.empty())
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearCubicNaturalSpline.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearCubicNaturalSpline.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = triv (fun () -> _MixedLinearCubicNaturalSpline.Value.update()
                                                                     _MixedLinearCubicNaturalSpline.Value)
    let _value                                     (x : ICell<double>)   
                                                   = triv (fun () -> _MixedLinearCubicNaturalSpline.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearCubicNaturalSpline.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = triv (fun () -> _MixedLinearCubicNaturalSpline.Value.xMax())
    let _xMin                                      = triv (fun () -> _MixedLinearCubicNaturalSpline.Value.xMin())
    let _allowsExtrapolation                       = triv (fun () -> _MixedLinearCubicNaturalSpline.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearCubicNaturalSpline.Value.disableExtrapolation(b.Value)
                                                                     _MixedLinearCubicNaturalSpline.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearCubicNaturalSpline.Value.enableExtrapolation(b.Value)
                                                                     _MixedLinearCubicNaturalSpline.Value)
