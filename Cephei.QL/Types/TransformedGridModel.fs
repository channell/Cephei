...
*)
    ...
    let _dx                                        (i : ICell<int>)   
                                                   = cell (fun () -> _TransformedGrid.Value.dx(i.Value))
    let _dxArray                                   = cell (fun () -> _TransformedGrid.Value.dxArray())
    let _dxm                                       (i : ICell<int>)   
                                                   = cell (fun () -> _TransformedGrid.Value.dxm(i.Value))
    let _dxmArray                                  = cell (fun () -> _TransformedGrid.Value.dxmArray())
    let _dxp                                       (i : ICell<int>)   
                                                   = cell (fun () -> _TransformedGrid.Value.dxp(i.Value))
    let _dxpArray                                  = cell (fun () -> _TransformedGrid.Value.dxpArray())
    let _grid                                      (i : ICell<int>)   
                                                   = cell (fun () -> _TransformedGrid.Value.grid(i.Value))
    let _gridArray                                 = cell (fun () -> _TransformedGrid.Value.gridArray())
    let _size                                      = cell (fun () -> _TransformedGrid.Value.size())
    let _transformedGrid                           (i : ICell<int>)   
                                                   = cell (fun () -> _TransformedGrid.Value.transformedGrid(i.Value))
    let _transformedGridArray                      = cell (fun () -> _TransformedGrid.Value.transformedGridArray())
