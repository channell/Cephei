...
*)
    ...
    let _atmLevel                                  = cell (fun () -> _InterpolatedSmileSection.Value.atmLevel())
    let _Clone                                     = cell (fun () -> _InterpolatedSmileSection.Value.Clone())
    let _data                                      = cell (fun () -> _InterpolatedSmileSection.Value.data())
    let _data_                                     = cell (fun () -> _InterpolatedSmileSection.Value.data_)
    let _dates                                     = cell (fun () -> _InterpolatedSmileSection.Value.dates())
    let _dates_                                    = cell (fun () -> _InterpolatedSmileSection.Value.dates_)
    let _discounts                                 = cell (fun () -> _InterpolatedSmileSection.Value.discounts())
    let _interpolation_                            = cell (fun () -> _InterpolatedSmileSection.Value.interpolation_)
    let _interpolator_                             = cell (fun () -> _InterpolatedSmileSection.Value.interpolator_)
    let _maxDate                                   = cell (fun () -> _InterpolatedSmileSection.Value.maxDate())
    let _maxDate_                                  = cell (fun () -> _InterpolatedSmileSection.Value.maxDate_)
    let _maxStrike                                 = cell (fun () -> _InterpolatedSmileSection.Value.maxStrike())
    let _minStrike                                 = cell (fun () -> _InterpolatedSmileSection.Value.minStrike())
    let _nodes                                     = cell (fun () -> _InterpolatedSmileSection.Value.nodes())
    let _setupInterpolation                        = cell (fun () -> _InterpolatedSmileSection.Value.setupInterpolation()
                                                                     _InterpolatedSmileSection.Value)
    let _times                                     = cell (fun () -> _InterpolatedSmileSection.Value.times())
    let _times_                                    = cell (fun () -> _InterpolatedSmileSection.Value.times_)
    let _update                                    = cell (fun () -> _InterpolatedSmileSection.Value.update()
                                                                     _InterpolatedSmileSection.Value)
    let _dayCounter                                = cell (fun () -> _InterpolatedSmileSection.Value.dayCounter())
    let _density                                   (strike : ICell<double>) (discount : ICell<double>) (gap : ICell<double>)   
                                                   = cell (fun () -> _InterpolatedSmileSection.Value.density(strike.Value, discount.Value, gap.Value))
    let _digitalOptionPrice                        (strike : ICell<double>) (Type : ICell<Option.Type>) (discount : ICell<double>) (gap : ICell<double>)   
                                                   = cell (fun () -> _InterpolatedSmileSection.Value.digitalOptionPrice(strike.Value, Type.Value, discount.Value, gap.Value))
    let _exerciseDate                              = cell (fun () -> _InterpolatedSmileSection.Value.exerciseDate())
    let _exerciseTime                              = cell (fun () -> _InterpolatedSmileSection.Value.exerciseTime())
    let _optionPrice                               (strike : ICell<double>) (Type : ICell<Option.Type>) (discount : ICell<double>)   
                                                   = cell (fun () -> _InterpolatedSmileSection.Value.optionPrice(strike.Value, Type.Value, discount.Value))
    let _referenceDate                             = cell (fun () -> _InterpolatedSmileSection.Value.referenceDate())
    let _shift                                     = cell (fun () -> _InterpolatedSmileSection.Value.shift())
    let _variance                                  (strike : ICell<double>)   
                                                   = cell (fun () -> _InterpolatedSmileSection.Value.variance(strike.Value))
    let _vega                                      (strike : ICell<double>) (discount : ICell<double>)   
                                                   = cell (fun () -> _InterpolatedSmileSection.Value.vega(strike.Value, discount.Value))
    let _volatility                                (strike : ICell<double>) (volatilityType : ICell<VolatilityType>) (shift : ICell<double>)   
                                                   = cell (fun () -> _InterpolatedSmileSection.Value.volatility(strike.Value, volatilityType.Value, shift.Value))
    let _volatility1                               (strike : ICell<double>)   
                                                   = cell (fun () -> _InterpolatedSmileSection.Value.volatility(strike.Value))
    let _volatilityType                            = cell (fun () -> _InterpolatedSmileSection.Value.volatilityType())
