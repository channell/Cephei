...
*)
    ...
    let _capletPrice                               (effectiveCap : ICell<double>)   
                                                   = cell (fun () -> _LinearTsrPricer.Value.capletPrice(effectiveCap.Value))
    let _capletRate                                (effectiveCap : ICell<double>)   
                                                   = cell (fun () -> _LinearTsrPricer.Value.capletRate(effectiveCap.Value))
    let _floorletPrice                             (effectiveFloor : ICell<double>)   
                                                   = cell (fun () -> _LinearTsrPricer.Value.floorletPrice(effectiveFloor.Value))
    let _floorletRate                              (effectiveFloor : ICell<double>)   
                                                   = cell (fun () -> _LinearTsrPricer.Value.floorletRate(effectiveFloor.Value))
    let _initialize                                (coupon : ICell<FloatingRateCoupon>)   
                                                   = cell (fun () -> _LinearTsrPricer.Value.initialize(coupon.Value)
                                                                     _LinearTsrPricer.Value)
    let _meanReversion                             = cell (fun () -> _LinearTsrPricer.Value.meanReversion())
    let _setMeanReversion                          (meanReversion : ICell<Handle<Quote>>)   
                                                   = cell (fun () -> _LinearTsrPricer.Value.setMeanReversion(meanReversion.Value)
                                                                     _LinearTsrPricer.Value)
    let _swapletPrice                              = cell (fun () -> _LinearTsrPricer.Value.swapletPrice())
    let _swapletRate                               = cell (fun () -> _LinearTsrPricer.Value.swapletRate())
    let _setSwaptionVolatility                     (v : ICell<Handle<SwaptionVolatilityStructure>>)   
                                                   = cell (fun () -> _LinearTsrPricer.Value.setSwaptionVolatility(v.Value)
                                                                     _LinearTsrPricer.Value)
    let _swaptionVolatility                        = cell (fun () -> _LinearTsrPricer.Value.swaptionVolatility())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _LinearTsrPricer.Value.registerWith(handler.Value)
                                                                     _LinearTsrPricer.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _LinearTsrPricer.Value.unregisterWith(handler.Value)
                                                                     _LinearTsrPricer.Value)
    let _update                                    = cell (fun () -> _LinearTsrPricer.Value.update()
                                                                     _LinearTsrPricer.Value)
