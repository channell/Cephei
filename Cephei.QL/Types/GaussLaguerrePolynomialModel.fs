...
*)
    ...
    let _alpha                                     (i : ICell<int>)   
                                                   = cell (fun () -> _GaussLaguerrePolynomial.Value.alpha(i.Value))
    let _beta                                      (i : ICell<int>)   
                                                   = cell (fun () -> _GaussLaguerrePolynomial.Value.beta(i.Value))
    let _mu_0                                      = cell (fun () -> _GaussLaguerrePolynomial.Value.mu_0())
    let _w                                         (x : ICell<double>)   
                                                   = cell (fun () -> _GaussLaguerrePolynomial.Value.w(x.Value))
    let _value                                     (n : ICell<int>) (x : ICell<double>)   
                                                   = cell (fun () -> _GaussLaguerrePolynomial.Value.value(n.Value, x.Value))
    let _weightedValue                             (n : ICell<int>) (x : ICell<double>)   
                                                   = cell (fun () -> _GaussLaguerrePolynomial.Value.weightedValue(n.Value, x.Value))
