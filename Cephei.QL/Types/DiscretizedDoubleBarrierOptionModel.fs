...
*)
    ...
    let _checkBarrier                              (optvalues : ICell<Vector>) (grid : ICell<Vector>)   
                                                   = cell (fun () -> _DiscretizedDoubleBarrierOption.Value.checkBarrier(optvalues.Value, grid.Value)
                                                                     _DiscretizedDoubleBarrierOption.Value)
    let _mandatoryTimes                            = cell (fun () -> _DiscretizedDoubleBarrierOption.Value.mandatoryTimes())
    let _reset                                     (size : ICell<int>)   
                                                   = cell (fun () -> _DiscretizedDoubleBarrierOption.Value.reset(size.Value)
                                                                     _DiscretizedDoubleBarrierOption.Value)
    let _vanilla                                   = cell (fun () -> _DiscretizedDoubleBarrierOption.Value.vanilla())
    let _adjustValues                              = cell (fun () -> _DiscretizedDoubleBarrierOption.Value.adjustValues()
                                                                     _DiscretizedDoubleBarrierOption.Value)
    let _initialize                                (Method : ICell<Lattice>) (t : ICell<double>)   
                                                   = cell (fun () -> _DiscretizedDoubleBarrierOption.Value.initialize(Method.Value, t.Value)
                                                                     _DiscretizedDoubleBarrierOption.Value)
    let _method                                    = cell (fun () -> _DiscretizedDoubleBarrierOption.Value.METHOD())
    let _partialRollback                           (To : ICell<double>)   
                                                   = cell (fun () -> _DiscretizedDoubleBarrierOption.Value.partialRollback(To.Value)
                                                                     _DiscretizedDoubleBarrierOption.Value)
    let _postAdjustValues                          = cell (fun () -> _DiscretizedDoubleBarrierOption.Value.postAdjustValues()
                                                                     _DiscretizedDoubleBarrierOption.Value)
    let _preAdjustValues                           = cell (fun () -> _DiscretizedDoubleBarrierOption.Value.preAdjustValues()
                                                                     _DiscretizedDoubleBarrierOption.Value)
    let _presentValue                              = cell (fun () -> _DiscretizedDoubleBarrierOption.Value.presentValue())
    let _rollback                                  (To : ICell<double>)   
                                                   = cell (fun () -> _DiscretizedDoubleBarrierOption.Value.rollback(To.Value)
                                                                     _DiscretizedDoubleBarrierOption.Value)
    let _setTime                                   (t : ICell<double>)   
                                                   = cell (fun () -> _DiscretizedDoubleBarrierOption.Value.setTime(t.Value)
                                                                     _DiscretizedDoubleBarrierOption.Value)
    let _setValues                                 (v : ICell<Vector>)   
                                                   = cell (fun () -> _DiscretizedDoubleBarrierOption.Value.setValues(v.Value)
                                                                     _DiscretizedDoubleBarrierOption.Value)
    let _time                                      = cell (fun () -> _DiscretizedDoubleBarrierOption.Value.time())
    let _values                                    = cell (fun () -> _DiscretizedDoubleBarrierOption.Value.values())
