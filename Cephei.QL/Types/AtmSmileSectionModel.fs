...
*)
    ...
    let _atmLevel                                  = cell (fun () -> _AtmSmileSection.Value.atmLevel())
    let _dayCounter                                = cell (fun () -> _AtmSmileSection.Value.dayCounter())
    let _exerciseDate                              = cell (fun () -> _AtmSmileSection.Value.exerciseDate())
    let _exerciseTime                              = cell (fun () -> _AtmSmileSection.Value.exerciseTime())
    let _maxStrike                                 = cell (fun () -> _AtmSmileSection.Value.maxStrike())
    let _minStrike                                 = cell (fun () -> _AtmSmileSection.Value.minStrike())
    let _referenceDate                             = cell (fun () -> _AtmSmileSection.Value.referenceDate())
    let _shift                                     = cell (fun () -> _AtmSmileSection.Value.shift())
    let _volatilityType                            = cell (fun () -> _AtmSmileSection.Value.volatilityType())
    let _density                                   (strike : ICell<double>) (discount : ICell<double>) (gap : ICell<double>)   
                                                   = cell (fun () -> _AtmSmileSection.Value.density(strike.Value, discount.Value, gap.Value))
    let _digitalOptionPrice                        (strike : ICell<double>) (Type : ICell<Option.Type>) (discount : ICell<double>) (gap : ICell<double>)   
                                                   = cell (fun () -> _AtmSmileSection.Value.digitalOptionPrice(strike.Value, Type.Value, discount.Value, gap.Value))
    let _optionPrice                               (strike : ICell<double>) (Type : ICell<Option.Type>) (discount : ICell<double>)   
                                                   = cell (fun () -> _AtmSmileSection.Value.optionPrice(strike.Value, Type.Value, discount.Value))
    let _update                                    = cell (fun () -> _AtmSmileSection.Value.update()
                                                                     _AtmSmileSection.Value)
    let _variance                                  (strike : ICell<double>)   
                                                   = cell (fun () -> _AtmSmileSection.Value.variance(strike.Value))
    let _vega                                      (strike : ICell<double>) (discount : ICell<double>)   
                                                   = cell (fun () -> _AtmSmileSection.Value.vega(strike.Value, discount.Value))
    let _volatility                                (strike : ICell<double>) (volatilityType : ICell<VolatilityType>) (shift : ICell<double>)   
                                                   = cell (fun () -> _AtmSmileSection.Value.volatility(strike.Value, volatilityType.Value, shift.Value))
    let _volatility1                               (strike : ICell<double>)   
                                                   = cell (fun () -> _AtmSmileSection.Value.volatility(strike.Value))
