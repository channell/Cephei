...
*)
    ...
    let _blackForwardVariance                      (time1 : ICell<double>) (time2 : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _HestonBlackVolSurface.Value.blackForwardVariance(time1.Value, time2.Value, strike.Value, extrapolate.Value))
    let _blackForwardVariance1                     (date1 : ICell<Date>) (date2 : ICell<Date>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _HestonBlackVolSurface.Value.blackForwardVariance(date1.Value, date2.Value, strike.Value, extrapolate.Value))
    let _blackForwardVol                           (time1 : ICell<double>) (time2 : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _HestonBlackVolSurface.Value.blackForwardVol(time1.Value, time2.Value, strike.Value, extrapolate.Value))
    let _blackForwardVol1                          (date1 : ICell<Date>) (date2 : ICell<Date>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _HestonBlackVolSurface.Value.blackForwardVol(date1.Value, date2.Value, strike.Value, extrapolate.Value))
    let _blackVariance                             (maturity : ICell<Date>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _HestonBlackVolSurface.Value.blackVariance(maturity.Value, strike.Value, extrapolate.Value))
    ...
    let _blackVol                                  (maturity : ICell<Date>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _HestonBlackVolSurface.Value.blackVol(maturity.Value, strike.Value, extrapolate.Value))
    let _blackVol1                                 (maturity : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _HestonBlackVolSurface.Value.blackVol(maturity.Value, strike.Value, extrapolate.Value))
    let _businessDayConvention                     = triv (fun () -> _HestonBlackVolSurface.Value.businessDayConvention())
    let _optionDateFromTenor                       (p : ICell<Period>)   
                                                   = triv (fun () -> _HestonBlackVolSurface.Value.optionDateFromTenor(p.Value))
    let _calendar                                  = triv (fun () -> _HestonBlackVolSurface.Value.calendar())
    let _dayCounter                                = triv (fun () -> _HestonBlackVolSurface.Value.dayCounter())
    let _maxTime                                   = triv (fun () -> _HestonBlackVolSurface.Value.maxTime())
    let _referenceDate                             = triv (fun () -> _HestonBlackVolSurface.Value.referenceDate())
    let _settlementDays                            = triv (fun () -> _HestonBlackVolSurface.Value.settlementDays())
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = triv (fun () -> _HestonBlackVolSurface.Value.timeFromReference(date.Value))
    let _update                                    = triv (fun () -> _HestonBlackVolSurface.Value.update()
                                                                     _HestonBlackVolSurface.Value)
    let _allowsExtrapolation                       = triv (fun () -> _HestonBlackVolSurface.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv (fun () -> _HestonBlackVolSurface.Value.disableExtrapolation(b.Value)
                                                                     _HestonBlackVolSurface.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv (fun () -> _HestonBlackVolSurface.Value.enableExtrapolation(b.Value)
                                                                     _HestonBlackVolSurface.Value)
