...
*)
    ...
    let _floor                                     = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.floor())
    let _isCapped                                  = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.isCapped())
    let _isFloored                                 = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.isFloored())
    let _rate                                      = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.rate())
    let _setPricer                                 (pricer : ICell<YoYInflationCouponPricer>)   
                                                   = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.setPricer(pricer.Value)
                                                                     _CappedFlooredYoYInflationCoupon.Value)
    let _adjustedFixing                            = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.adjustedFixing())
    let _gearing                                   = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.gearing())
    let _spread                                    = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.spread())
    let _yoyIndex                                  = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.yoyIndex())
    let _accruedAmount                             (d : ICell<Date>)   
                                                   = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.accruedAmount(d.Value))
    let _amount                                    = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.amount())
    let _dayCounter                                = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.dayCounter())
    let _fixingDate                                = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.fixingDate())
    let _fixingDays                                = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.fixingDays())
    let _index                                     = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.index())
    let _indexFixing                               = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.indexFixing())
    let _observationLag                            = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.observationLag())
    let _price                                     (discountingCurve : ICell<Handle<YieldTermStructure>>)   
                                                   = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.price(discountingCurve.Value))
    let _pricer                                    = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.pricer())
    let _update                                    = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.update()
                                                                     _CappedFlooredYoYInflationCoupon.Value)
    let _accrualDays                               = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.accrualDays())
    let _accrualEndDate                            = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.accrualEndDate())
    let _accrualPeriod                             = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.accrualPeriod())
    let _accrualStartDate                          = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.accrualStartDate())
    let _accruedDays                               (d : ICell<Date>)   
                                                   = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.accruedDays(d.Value))
    let _accruedPeriod                             (d : ICell<Date>)   
                                                   = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.accruedPeriod(d.Value))
    let _date                                      = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.date())
    let _exCouponDate                              = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.exCouponDate())
    let _nominal                                   = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.nominal())
    let _referencePeriodEnd                        = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.referencePeriodEnd)
    let _referencePeriodStart                      = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.referencePeriodStart)
    let _CompareTo                                 (cf : ICell<CashFlow>)   
                                                   = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.CompareTo(cf.Value))
    let _Equals                                    (cf : ICell<Object>)   
                                                   = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.Equals(cf.Value))
    let _hasOccurred                               (refDate : ICell<Date>) (includeRefDate : ICell<Nullable<bool>>)   
                                                   = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.hasOccurred(refDate.Value, includeRefDate.Value))
    let _tradingExCoupon                           (refDate : ICell<Date>)   
                                                   = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.tradingExCoupon(refDate.Value))
    let _accept                                    (v : ICell<IAcyclicVisitor>)   
                                                   = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.accept(v.Value)
                                                                     _CappedFlooredYoYInflationCoupon.Value)
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv (fun () -> _CappedFlooredYoYInflationCoupon.Value.registerWith(handler.Value)
                                                                     _CappedFlooredYoYInflationCoupon.Value)
