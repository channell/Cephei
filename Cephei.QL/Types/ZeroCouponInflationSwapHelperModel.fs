...
*)
    ...
    let _impliedQuote                              = cell (fun () -> _ZeroCouponInflationSwapHelper.Value.impliedQuote())
    let _setTermStructure                          (z : ICell<ZeroInflationTermStructure>)   
                                                   = cell (fun () -> _ZeroCouponInflationSwapHelper.Value.setTermStructure(z.Value)
                                                                     _ZeroCouponInflationSwapHelper.Value)
    let _earliestDate                              = cell (fun () -> _ZeroCouponInflationSwapHelper.Value.earliestDate())
    let _latestDate                                = cell (fun () -> _ZeroCouponInflationSwapHelper.Value.latestDate())
    let _latestRelevantDate                        = cell (fun () -> _ZeroCouponInflationSwapHelper.Value.latestRelevantDate())
    let _maturityDate                              = cell (fun () -> _ZeroCouponInflationSwapHelper.Value.maturityDate())
    let _pillarDate                                = cell (fun () -> _ZeroCouponInflationSwapHelper.Value.pillarDate())
    let _quote                                     = cell (fun () -> _ZeroCouponInflationSwapHelper.Value.quote())
    let _quoteError                                = cell (fun () -> _ZeroCouponInflationSwapHelper.Value.quoteError())
    let _quoteIsValid                              = cell (fun () -> _ZeroCouponInflationSwapHelper.Value.quoteIsValid())
    let _quoteValue                                = cell (fun () -> _ZeroCouponInflationSwapHelper.Value.quoteValue())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _ZeroCouponInflationSwapHelper.Value.registerWith(handler.Value)
                                                                     _ZeroCouponInflationSwapHelper.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _ZeroCouponInflationSwapHelper.Value.unregisterWith(handler.Value)
                                                                     _ZeroCouponInflationSwapHelper.Value)
    let _update                                    = cell (fun () -> _ZeroCouponInflationSwapHelper.Value.update()
                                                                     _ZeroCouponInflationSwapHelper.Value)
