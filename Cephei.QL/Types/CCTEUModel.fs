...
(*
    Functions
*)
    let _CCTEU                                     = cell (fun () -> withEngine _pricingEngine.Value (new CCTEU (maturityDate.Value, spread.Value, fwdCurve.Value, startDate.Value, issueDate.Value)))
    let _accruedAmount                             (d : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).accruedAmount(d.Value))
    let _calendar                                  = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).calendar())
    let _cashflows                                 = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).cashflows())
    ...
    let _dirtyPrice1                               (Yield : ICell<double>) (dc : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).dirtyPrice(Yield.Value, dc.Value, comp.Value, freq.Value, settlement.Value))
    let _isExpired                                 = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).isExpired())
    let _issueDate                                 = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).issueDate())
    let _isTradable                                (d : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).isTradable(d.Value))
    let _maturityDate                              = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).maturityDate())
    let _nextCashFlowDate                          (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).nextCashFlowDate(settlement.Value))
    let _nextCouponRate                            (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).nextCouponRate(settlement.Value))
    let _notional                                  (d : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).notional(d.Value))
    let _notionals                                 = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).notionals())
    let _previousCashFlowDate                      (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).previousCashFlowDate(settlement.Value))
    let _previousCouponRate                        (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).previousCouponRate(settlement.Value))
    let _redemption                                = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).redemption())
    let _redemptions                               = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).redemptions())
    let _settlementDate                            (date : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).settlementDate(date.Value))
    let _settlementDays                            = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).settlementDays())
    let _settlementValue                           (cleanPrice : ICell<double>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).settlementValue(cleanPrice.Value))
    let _settlementValue1                          = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).settlementValue())
    let _startDate                                 = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).startDate())
    ...
    let _errorEstimate                             = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).errorEstimate())
    let _NPV                                       = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).setPricingEngine(e.Value)
                                                                     _CCTEU.Value)
    let _valuationDate                             = cell (fun () -> (withEvaluationDate _evaluationDate _CCTEU).valuationDate())
    do this.Bind(_CCTEU)
