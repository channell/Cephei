...
*)
    ...
    let _CompareTo                                 (obj : ICell<Object>)   
                                                   = cell (fun () -> _Period.Value.CompareTo(obj.Value))
    let _Equals                                    (o : ICell<Object>)   
                                                   = cell (fun () -> _Period.Value.Equals(o.Value))
    let _frequency                                 = cell (fun () -> _Period.Value.frequency())
    let _length                                    = cell (fun () -> _Period.Value.length())
    let _normalize                                 = cell (fun () -> _Period.Value.normalize()
                                                                     _Period.Value)
    let _ToShortString                             = cell (fun () -> _Period.Value.ToShortString())
    let _ToString                                  = cell (fun () -> _Period.Value.ToString())
    let _units                                     = cell (fun () -> _Period.Value.units())
