...
(*
    Functions
*)
    let _FloatFloatSwap                            = cell (fun () -> withEngine _pricingEngine.Value (new FloatFloatSwap (Type.Value, nominal1.Value, nominal2.Value, schedule1.Value, index1.Value, dayCount1.Value, schedule2.Value, index2.Value, dayCount2.Value, intermediateCapitalExchange.Value, finalCapitalExchange.Value, gearing1.Value, spread1.Value, cappedRate1.Value, flooredRate1.Value, gearing2.Value, spread2.Value, cappedRate2.Value, flooredRate2.Value, paymentConvention1.Value, paymentConvention2.Value)))
    let _cappedRate1                               = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).cappedRate1())
    let _cappedRate2                               = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).cappedRate2())
    let _dayCount1                                 = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).dayCount1())
    let _dayCount2                                 = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).dayCount2())
    let _flooredRate1                              = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).flooredRate1())
    let _flooredRate2                              = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).flooredRate2())
    let _gearing1                                  = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).gearing1())
    let _gearing2                                  = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).gearing2())
    let _index1                                    = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).index1())
    let _index2                                    = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).index2())
    let _leg1                                      = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).leg1())
    let _leg2                                      = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).leg2())
    let _nominal1                                  = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).nominal1())
    let _nominal2                                  = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).nominal2())
    let _paymentConvention1                        = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).paymentConvention1())
    let _paymentConvention2                        = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).paymentConvention2())
    let _schedule1                                 = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).schedule1())
    let _schedule2                                 = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).schedule2())
    let _spread1                                   = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).spread1())
    let _spread2                                   = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).spread2())
    let _type                                      = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).TYPE())
    let _endDiscounts                              (j : ICell<int>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).endDiscounts(j.Value))
    let _engine                                    = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).engine)
    let _isExpired                                 = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).isExpired())
    let _leg                                       (j : ICell<int>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).leg(j.Value))
    let _legBPS                                    (j : ICell<int>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).legBPS(j.Value))
    let _legNPV                                    (j : ICell<int>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).legNPV(j.Value))
    let _maturityDate                              = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).maturityDate())
    let _npvDateDiscount                           = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).npvDateDiscount())
    let _payer                                     (j : ICell<int>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).payer(j.Value))
    let _startDate                                 = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).startDate())
    let _startDiscounts                            (j : ICell<int>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).startDiscounts(j.Value))
    let _CASH                                      = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).CASH())
    let _errorEstimate                             = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).errorEstimate())
    let _NPV                                       = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).setPricingEngine(e.Value)
                                                                     _FloatFloatSwap.Value)
    let _valuationDate                             = cell (fun () -> (withEvaluationDate _evaluationDate _FloatFloatSwap).valuationDate())
