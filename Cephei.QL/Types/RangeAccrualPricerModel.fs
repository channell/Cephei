...
*)
    let mutable
        _RangeAccrualPricer                        = make (fun () -> new RangeAccrualPricer ())
    let _capletPrice                               (effectiveCap : ICell<double>)   
                                                   = triv _RangeAccrualPricer (fun () -> _RangeAccrualPricer.Value.capletPrice(effectiveCap.Value))
    let _capletRate                                (effectiveCap : ICell<double>)   
                                                   = triv _RangeAccrualPricer (fun () -> _RangeAccrualPricer.Value.capletRate(effectiveCap.Value))
    let _floorletPrice                             (effectiveFloor : ICell<double>)   
                                                   = triv _RangeAccrualPricer (fun () -> _RangeAccrualPricer.Value.floorletPrice(effectiveFloor.Value))
    let _floorletRate                              (effectiveFloor : ICell<double>)   
                                                   = triv _RangeAccrualPricer (fun () -> _RangeAccrualPricer.Value.floorletRate(effectiveFloor.Value))
    let _initialize                                (coupon : ICell<FloatingRateCoupon>)   
                                                   = triv _RangeAccrualPricer (fun () -> _RangeAccrualPricer.Value.initialize(coupon.Value)
                                                                                         _RangeAccrualPricer.Value)
    let _swapletPrice                              = triv _RangeAccrualPricer (fun () -> _RangeAccrualPricer.Value.swapletPrice())
    let _swapletRate                               = triv _RangeAccrualPricer (fun () -> _RangeAccrualPricer.Value.swapletRate())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv _RangeAccrualPricer (fun () -> _RangeAccrualPricer.Value.registerWith(handler.Value)
                                                                                         _RangeAccrualPricer.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = triv _RangeAccrualPricer (fun () -> _RangeAccrualPricer.Value.unregisterWith(handler.Value)
                                                                                         _RangeAccrualPricer.Value)
    let _update                                    = triv _RangeAccrualPricer (fun () -> _RangeAccrualPricer.Value.update()
                                                                                         _RangeAccrualPricer.Value)
