...
*)
    let mutable
        _CPIBond                                   = make (fun () -> withEngine pricingEngine evaluationDate (new CPIBond (settlementDays.Value, faceAmount.Value, growthOnly.Value, baseCPI.Value, observationLag.Value, cpiIndex.Value, observationInterpolation.Value, schedule.Value, fixedRate.Value, accrualDayCounter.Value, paymentConvention.Value, issueDate.Value, paymentCalendar.Value, exCouponPeriod.Value, exCouponCalendar.Value, exCouponConvention.Value, exCouponEndOfMonth.Value)))
    let _baseCPI                                   = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).baseCPI())
    let _cpiIndex                                  = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).cpiIndex())
    let _dayCounter                                = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).dayCounter())
    let _frequency                                 = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).frequency())
    let _growthOnly                                = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).growthOnly())
    let _observationInterpolation                  = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).observationInterpolation())
    let _observationLag                            = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).observationLag())
    let _accruedAmount                             (settlement : ICell<Date>)   
                                                   = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).accruedAmount(settlement.Value))
    let _calendar                                  = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).calendar())
    let _cashflows                                 = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).cashflows())
    let _cleanPrice                                = cell _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).cleanPrice())
    let _cleanPrice1                               (Yield : ICell<double>) (dc : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (settlement : ICell<Date>)   
                                                   = cell _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).cleanPrice(Yield.Value, dc.Value, comp.Value, freq.Value, settlement.Value))
    let _dirtyPrice                                = cell _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).dirtyPrice())
    let _dirtyPrice1                               (Yield : ICell<double>) (dc : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (settlement : ICell<Date>)   
                                                   = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).dirtyPrice(Yield.Value, dc.Value, comp.Value, freq.Value, settlement.Value))
    let _isExpired                                 = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).isExpired())
    let _issueDate                                 = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).issueDate())
    let _isTradable                                (d : ICell<Date>)   
                                                   = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).isTradable(d.Value))
    let _maturityDate                              = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).maturityDate())
    let _nextCashFlowDate                          (settlement : ICell<Date>)   
                                                   = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).nextCashFlowDate(settlement.Value))
    let _nextCouponRate                            (settlement : ICell<Date>)   
                                                   = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).nextCouponRate(settlement.Value))
    let _notional                                  (d : ICell<Date>)   
                                                   = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).notional(d.Value))
    let _notionals                                 = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).notionals())
    let _previousCashFlowDate                      (settlement : ICell<Date>)   
                                                   = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).previousCashFlowDate(settlement.Value))
    let _previousCouponRate                        (settlement : ICell<Date>)   
                                                   = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).previousCouponRate(settlement.Value))
    let _redemption                                = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).redemption())
    let _redemptions                               = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).redemptions())
    let _settlementDate                            (date : ICell<Date>)   
                                                   = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).settlementDate(date.Value))
    let _settlementDays                            = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).settlementDays())
    let _settlementValue                           (cleanPrice : ICell<double>)   
                                                   = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).settlementValue(cleanPrice.Value))
    let _settlementValue1                          = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).settlementValue())
    let _startDate                                 = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).startDate())
    let _yield                                     (dc : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (accuracy : ICell<double>) (maxEvaluations : ICell<int>)   
                                                   = cell _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).YIELD(dc.Value, comp.Value, freq.Value, accuracy.Value, maxEvaluations.Value))
    let _yield1                                    (cleanPrice : ICell<double>) (dc : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (settlement : ICell<Date>) (accuracy : ICell<double>) (maxEvaluations : ICell<int>)   
                                                   = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).YIELD(cleanPrice.Value, dc.Value, comp.Value, freq.Value, settlement.Value, accuracy.Value, maxEvaluations.Value))
    let _CASH                                      = cell _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).CASH())
    let _errorEstimate                             = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).errorEstimate())
    let _NPV                                       = cell _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).setPricingEngine(e.Value)
                                                                              _CPIBond.Value)
    let _valuationDate                             = triv _CPIBond (fun () -> (withEvaluationDate _evaluationDate _CPIBond).valuationDate())
