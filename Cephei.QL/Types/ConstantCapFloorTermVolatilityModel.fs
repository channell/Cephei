...
*)
    ...
    let _volatility                                (length : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _ConstantCapFloorTermVolatility.Value.volatility(length.Value, strike.Value, extrapolate.Value))
    let _volatility1                               (t : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _ConstantCapFloorTermVolatility.Value.volatility(t.Value, strike.Value, extrapolate.Value))
    let _volatility2                               (End : ICell<Date>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _ConstantCapFloorTermVolatility.Value.volatility(End.Value, strike.Value, extrapolate.Value))
    let _businessDayConvention                     = triv (fun () -> _ConstantCapFloorTermVolatility.Value.businessDayConvention())
    let _optionDateFromTenor                       (p : ICell<Period>)   
                                                   = triv (fun () -> _ConstantCapFloorTermVolatility.Value.optionDateFromTenor(p.Value))
    let _calendar                                  = triv (fun () -> _ConstantCapFloorTermVolatility.Value.calendar())
    let _dayCounter                                = triv (fun () -> _ConstantCapFloorTermVolatility.Value.dayCounter())
    let _maxTime                                   = triv (fun () -> _ConstantCapFloorTermVolatility.Value.maxTime())
    let _referenceDate                             = triv (fun () -> _ConstantCapFloorTermVolatility.Value.referenceDate())
    let _settlementDays                            = triv (fun () -> _ConstantCapFloorTermVolatility.Value.settlementDays())
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = triv (fun () -> _ConstantCapFloorTermVolatility.Value.timeFromReference(date.Value))
    let _update                                    = triv (fun () -> _ConstantCapFloorTermVolatility.Value.update()
                                                                     _ConstantCapFloorTermVolatility.Value)
    let _allowsExtrapolation                       = triv (fun () -> _ConstantCapFloorTermVolatility.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv (fun () -> _ConstantCapFloorTermVolatility.Value.disableExtrapolation(b.Value)
                                                                     _ConstantCapFloorTermVolatility.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv (fun () -> _ConstantCapFloorTermVolatility.Value.enableExtrapolation(b.Value)
                                                                     _ConstantCapFloorTermVolatility.Value)
