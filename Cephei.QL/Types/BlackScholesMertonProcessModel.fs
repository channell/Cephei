...
*)
    ...
    let _diffusion                                 (t : ICell<double>) (x : ICell<double>)   
                                                   = triv (fun () -> _BlackScholesMertonProcess.Value.diffusion(t.Value, x.Value))
    let _dividendYield                             = triv (fun () -> _BlackScholesMertonProcess.Value.dividendYield())
    let _drift                                     (t : ICell<double>) (x : ICell<double>)   
                                                   = triv (fun () -> _BlackScholesMertonProcess.Value.drift(t.Value, x.Value))
    let _evolve                                    (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>) (dw : ICell<double>)   
                                                   = triv (fun () -> _BlackScholesMertonProcess.Value.evolve(t0.Value, x0.Value, dt.Value, dw.Value))
    let _expectation                               (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = triv (fun () -> _BlackScholesMertonProcess.Value.expectation(t0.Value, x0.Value, dt.Value))
    let _localVolatility                           = triv (fun () -> _BlackScholesMertonProcess.Value.localVolatility())
    let _riskFreeRate                              = triv (fun () -> _BlackScholesMertonProcess.Value.riskFreeRate())
    let _stateVariable                             = triv (fun () -> _BlackScholesMertonProcess.Value.stateVariable())
    let _stdDeviation                              (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = triv (fun () -> _BlackScholesMertonProcess.Value.stdDeviation(t0.Value, x0.Value, dt.Value))
    let _time                                      (d : ICell<Date>)   
                                                   = triv (fun () -> _BlackScholesMertonProcess.Value.time(d.Value))
    let _update                                    = triv (fun () -> _BlackScholesMertonProcess.Value.update()
                                                                     _BlackScholesMertonProcess.Value)
    let _variance                                  (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = triv (fun () -> _BlackScholesMertonProcess.Value.variance(t0.Value, x0.Value, dt.Value))
    let _x0                                        = triv (fun () -> _BlackScholesMertonProcess.Value.x0())
    let _initialValues                             = triv (fun () -> _BlackScholesMertonProcess.Value.initialValues())
    let _size                                      = triv (fun () -> _BlackScholesMertonProcess.Value.size())
    let _covariance                                (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>)   
                                                   = triv (fun () -> _BlackScholesMertonProcess.Value.covariance(t0.Value, x0.Value, dt.Value))
    let _factors                                   = triv (fun () -> _BlackScholesMertonProcess.Value.factors())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv (fun () -> _BlackScholesMertonProcess.Value.registerWith(handler.Value)
                                                                     _BlackScholesMertonProcess.Value)
