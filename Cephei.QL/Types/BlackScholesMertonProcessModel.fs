...
*)
    ...
    let _apply                                     (x0 : ICell<double>) (dx : ICell<double>)   
                                                   = cell (fun () -> _BlackScholesMertonProcess.Value.apply(x0.Value, dx.Value))
    let _blackVolatility                           = cell (fun () -> _BlackScholesMertonProcess.Value.blackVolatility())
    let _diffusion                                 (t : ICell<double>) (x : ICell<double>)   
                                                   = cell (fun () -> _BlackScholesMertonProcess.Value.diffusion(t.Value, x.Value))
    let _dividendYield                             = cell (fun () -> _BlackScholesMertonProcess.Value.dividendYield())
    let _drift                                     (t : ICell<double>) (x : ICell<double>)   
                                                   = cell (fun () -> _BlackScholesMertonProcess.Value.drift(t.Value, x.Value))
    let _evolve                                    (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>) (dw : ICell<double>)   
                                                   = cell (fun () -> _BlackScholesMertonProcess.Value.evolve(t0.Value, x0.Value, dt.Value, dw.Value))
    let _expectation                               (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = cell (fun () -> _BlackScholesMertonProcess.Value.expectation(t0.Value, x0.Value, dt.Value))
    let _localVolatility                           = cell (fun () -> _BlackScholesMertonProcess.Value.localVolatility())
    let _riskFreeRate                              = cell (fun () -> _BlackScholesMertonProcess.Value.riskFreeRate())
    let _stateVariable                             = cell (fun () -> _BlackScholesMertonProcess.Value.stateVariable())
    let _stdDeviation                              (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = cell (fun () -> _BlackScholesMertonProcess.Value.stdDeviation(t0.Value, x0.Value, dt.Value))
    let _time                                      (d : ICell<Date>)   
                                                   = cell (fun () -> _BlackScholesMertonProcess.Value.time(d.Value))
    let _update                                    = cell (fun () -> _BlackScholesMertonProcess.Value.update()
                                                                     _BlackScholesMertonProcess.Value)
    let _variance                                  (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = cell (fun () -> _BlackScholesMertonProcess.Value.variance(t0.Value, x0.Value, dt.Value))
    let _x0                                        = cell (fun () -> _BlackScholesMertonProcess.Value.x0())
    let _initialValues                             = cell (fun () -> _BlackScholesMertonProcess.Value.initialValues())
    let _size                                      = cell (fun () -> _BlackScholesMertonProcess.Value.size())
    let _covariance                                (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>)   
                                                   = cell (fun () -> _BlackScholesMertonProcess.Value.covariance(t0.Value, x0.Value, dt.Value))
    let _factors                                   = cell (fun () -> _BlackScholesMertonProcess.Value.factors())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _BlackScholesMertonProcess.Value.registerWith(handler.Value)
                                                                     _BlackScholesMertonProcess.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _BlackScholesMertonProcess.Value.unregisterWith(handler.Value)
                                                                     _BlackScholesMertonProcess.Value)
