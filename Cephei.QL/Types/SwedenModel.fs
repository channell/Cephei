...
*)
    let mutable
        _Sweden                                    = make (fun () -> new Sweden ())
    let _addedHolidays                             = triv _Sweden (fun () -> _Sweden.Value.addedHolidays)
    let _addHoliday                                (d : ICell<Date>)   
                                                   = triv _Sweden (fun () -> _Sweden.Value.addHoliday(d.Value)
                                                                             _Sweden.Value)
    let _adjust                                    (d : ICell<Date>) (c : ICell<BusinessDayConvention>)   
                                                   = triv _Sweden (fun () -> _Sweden.Value.adjust(d.Value, c.Value))
    let _advance                                   (d : ICell<Date>) (p : ICell<Period>) (c : ICell<BusinessDayConvention>) (endOfMonth : ICell<bool>)   
                                                   = triv _Sweden (fun () -> _Sweden.Value.advance(d.Value, p.Value, c.Value, endOfMonth.Value))
    let _advance1                                  (d : ICell<Date>) (n : ICell<int>) (unit : ICell<TimeUnit>) (c : ICell<BusinessDayConvention>) (endOfMonth : ICell<bool>)   
                                                   = triv _Sweden (fun () -> _Sweden.Value.advance(d.Value, n.Value, unit.Value, c.Value, endOfMonth.Value))
    let _businessDaysBetween                       (from : ICell<Date>) (To : ICell<Date>) (includeFirst : ICell<bool>) (includeLast : ICell<bool>)   
                                                   = triv _Sweden (fun () -> _Sweden.Value.businessDaysBetween(from.Value, To.Value, includeFirst.Value, includeLast.Value))
    let _calendar                                  = triv _Sweden (fun () -> _Sweden.Value.calendar)
    let _empty                                     = triv _Sweden (fun () -> _Sweden.Value.empty())
    let _endOfMonth                                (d : ICell<Date>)   
                                                   = triv _Sweden (fun () -> _Sweden.Value.endOfMonth(d.Value))
    let _Equals                                    (o : ICell<Object>)   
                                                   = triv _Sweden (fun () -> _Sweden.Value.Equals(o.Value))
    let _isBusinessDay                             (d : ICell<Date>)   
                                                   = triv _Sweden (fun () -> _Sweden.Value.isBusinessDay(d.Value))
    let _isEndOfMonth                              (d : ICell<Date>)   
                                                   = triv _Sweden (fun () -> _Sweden.Value.isEndOfMonth(d.Value))
    let _isHoliday                                 (d : ICell<Date>)   
                                                   = triv _Sweden (fun () -> _Sweden.Value.isHoliday(d.Value))
    let _isWeekend                                 (w : ICell<DayOfWeek>)   
                                                   = triv _Sweden (fun () -> _Sweden.Value.isWeekend(w.Value))
    let _name                                      = triv _Sweden (fun () -> _Sweden.Value.name())
    let _removedHolidays                           = triv _Sweden (fun () -> _Sweden.Value.removedHolidays)
    let _removeHoliday                             (d : ICell<Date>)   
                                                   = triv _Sweden (fun () -> _Sweden.Value.removeHoliday(d.Value)
                                                                             _Sweden.Value)
