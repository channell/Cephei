...
*)
    ...
    let _factory                                   (L : ICell<Object>) (bcs : ICell<Object>) (additionalInputs : ICell<Object[]>)   
                                                   = cell (fun () -> _ModifiedCraigSneydScheme.Value.factory(L.Value, bcs.Value, additionalInputs.Value))
    let _setStep                                   (dt : ICell<double>)   
                                                   = cell (fun () -> _ModifiedCraigSneydScheme.Value.setStep(dt.Value)
                                                                     _ModifiedCraigSneydScheme.Value)
    let _step                                      (a : ICell<Object ref>) (t : ICell<double>) (theta : ICell<double>)   
                                                   = cell (fun () -> _ModifiedCraigSneydScheme.Value.step(a.Value, t.Value, theta.Value)
                                                                     _ModifiedCraigSneydScheme.Value)
