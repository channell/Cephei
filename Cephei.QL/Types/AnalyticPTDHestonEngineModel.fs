...
*)
    let mutable
        _AnalyticPTDHestonEngine                   = make (fun () -> (createEvaluationDate _evaluationDate (fun () ->new AnalyticPTDHestonEngine (model.Value, relTolerance.Value, maxEvaluations.Value))))
    let _setModel                                  (model : ICell<Handle<PiecewiseTimeDependentHestonModel>>)   
                                                   = triv _AnalyticPTDHestonEngine (fun () -> (curryEvaluationDate _evaluationDate _AnalyticPTDHestonEngine).Value.setModel(model.Value)
                                                                                              _AnalyticPTDHestonEngine.Value)
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv _AnalyticPTDHestonEngine (fun () -> (curryEvaluationDate _evaluationDate _AnalyticPTDHestonEngine).Value.registerWith(handler.Value)
                                                                                              _AnalyticPTDHestonEngine.Value)
    let _reset                                     = triv _AnalyticPTDHestonEngine (fun () -> (curryEvaluationDate _evaluationDate _AnalyticPTDHestonEngine).Value.reset()
                                                                                              _AnalyticPTDHestonEngine.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = triv _AnalyticPTDHestonEngine (fun () -> (curryEvaluationDate _evaluationDate _AnalyticPTDHestonEngine).Value.unregisterWith(handler.Value)
                                                                                              _AnalyticPTDHestonEngine.Value)
    let _update                                    = triv _AnalyticPTDHestonEngine (fun () -> (curryEvaluationDate _evaluationDate _AnalyticPTDHestonEngine).Value.update()
                                                                                              _AnalyticPTDHestonEngine.Value)
...
*)
    let mutable
        _AnalyticPTDHestonEngine                   = make (fun () -> (createEvaluationDate _evaluationDate (fun () ->new AnalyticPTDHestonEngine (model.Value, integrationOrder.Value))))
    let _setModel                                  (model : ICell<Handle<PiecewiseTimeDependentHestonModel>>)   
                                                   = triv _AnalyticPTDHestonEngine (fun () -> (curryEvaluationDate _evaluationDate _AnalyticPTDHestonEngine).Value.setModel(model.Value)
                                                                                              _AnalyticPTDHestonEngine.Value)
    let _registerWith                              (handler : ICell<Callback>)   
