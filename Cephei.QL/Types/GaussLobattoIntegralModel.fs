...
*)
    ...
    let _absoluteAccuracy                          = cell (fun () -> _GaussLobattoIntegral.Value.absoluteAccuracy())
    let _absoluteError                             = cell (fun () -> _GaussLobattoIntegral.Value.absoluteError())
    let _integrationSuccess                        = cell (fun () -> _GaussLobattoIntegral.Value.integrationSuccess())
    let _maxEvaluations                            = cell (fun () -> _GaussLobattoIntegral.Value.maxEvaluations())
    let _numberOfEvaluations                       = cell (fun () -> _GaussLobattoIntegral.Value.numberOfEvaluations())
    let _setAbsoluteAccuracy                       (accuracy : ICell<double>)   
                                                   = cell (fun () -> _GaussLobattoIntegral.Value.setAbsoluteAccuracy(accuracy.Value)
                                                                     _GaussLobattoIntegral.Value)
    let _setMaxEvaluations                         (maxEvaluations : ICell<int>)   
                                                   = cell (fun () -> _GaussLobattoIntegral.Value.setMaxEvaluations(maxEvaluations.Value)
                                                                     _GaussLobattoIntegral.Value)
    let _value                                     (f : ICell<Func<double,double>>) (a : ICell<double>) (b : ICell<double>)   
                                                   = cell (fun () -> _GaussLobattoIntegral.Value.value(f.Value, a.Value, b.Value))
