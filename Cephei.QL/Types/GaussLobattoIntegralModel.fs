...
*)
    let mutable
        _GaussLobattoIntegral                      = make (fun () -> new GaussLobattoIntegral (maxIterations.Value, absAccuracy.Value, relAccuracy.Value, useConvergenceEstimate.Value))
    let _absoluteAccuracy                          = triv _GaussLobattoIntegral (fun () -> _GaussLobattoIntegral.Value.absoluteAccuracy())
    let _absoluteError                             = triv _GaussLobattoIntegral (fun () -> _GaussLobattoIntegral.Value.absoluteError())
    let _integrationSuccess                        = triv _GaussLobattoIntegral (fun () -> _GaussLobattoIntegral.Value.integrationSuccess())
    let _maxEvaluations                            = triv _GaussLobattoIntegral (fun () -> _GaussLobattoIntegral.Value.maxEvaluations())
    let _numberOfEvaluations                       = triv _GaussLobattoIntegral (fun () -> _GaussLobattoIntegral.Value.numberOfEvaluations())
    let _setAbsoluteAccuracy                       (accuracy : ICell<double>)   
                                                   = triv _GaussLobattoIntegral (fun () -> _GaussLobattoIntegral.Value.setAbsoluteAccuracy(accuracy.Value)
                                                                                           _GaussLobattoIntegral.Value)
    let _setMaxEvaluations                         (maxEvaluations : ICell<int>)   
                                                   = triv _GaussLobattoIntegral (fun () -> _GaussLobattoIntegral.Value.setMaxEvaluations(maxEvaluations.Value)
                                                                                           _GaussLobattoIntegral.Value)
    let _value                                     (f : ICell<Func<double,double>>) (a : ICell<double>) (b : ICell<double>)   
                                                   = triv _GaussLobattoIntegral (fun () -> _GaussLobattoIntegral.Value.value(f.Value, a.Value, b.Value))
