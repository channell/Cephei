...
*)
    let mutable
        _ContinuousPartialFixedLookbackOption      = cell (fun () -> withEngine pricingEngine evaluationDate (new ContinuousPartialFixedLookbackOption (lookbackPeriodStart.Value, payoff.Value, exercise.Value)))
