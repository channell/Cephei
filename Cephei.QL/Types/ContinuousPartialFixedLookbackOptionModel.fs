...
(*
    Functions
*)
    let _ContinuousPartialFixedLookbackOption      = triv (fun () -> withEngine _pricingEngine.Value (new ContinuousPartialFixedLookbackOption (lookbackPeriodStart.Value, payoff.Value, exercise.Value)))
