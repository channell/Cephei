...
*)
    ...
    let _delta                                     = cell (fun () -> (withEvaluationDate _evaluationDate _ContinuousPartialFixedLookbackOption).delta())
    let _deltaForward                              = cell (fun () -> (withEvaluationDate _evaluationDate _ContinuousPartialFixedLookbackOption).deltaForward())
    let _dividendRho                               = cell (fun () -> (withEvaluationDate _evaluationDate _ContinuousPartialFixedLookbackOption).dividendRho())
    let _elasticity                                = cell (fun () -> (withEvaluationDate _evaluationDate _ContinuousPartialFixedLookbackOption).elasticity())
    let _gamma                                     = cell (fun () -> (withEvaluationDate _evaluationDate _ContinuousPartialFixedLookbackOption).gamma())
    let _isExpired                                 = cell (fun () -> (withEvaluationDate _evaluationDate _ContinuousPartialFixedLookbackOption).isExpired())
    let _itmCashProbability                        = cell (fun () -> (withEvaluationDate _evaluationDate _ContinuousPartialFixedLookbackOption).itmCashProbability())
    let _rho                                       = cell (fun () -> (withEvaluationDate _evaluationDate _ContinuousPartialFixedLookbackOption).rho())
    let _strikeSensitivity                         = cell (fun () -> (withEvaluationDate _evaluationDate _ContinuousPartialFixedLookbackOption).strikeSensitivity())
    let _theta                                     = cell (fun () -> (withEvaluationDate _evaluationDate _ContinuousPartialFixedLookbackOption).theta())
    let _thetaPerDay                               = cell (fun () -> (withEvaluationDate _evaluationDate _ContinuousPartialFixedLookbackOption).thetaPerDay())
    let _vega                                      = cell (fun () -> (withEvaluationDate _evaluationDate _ContinuousPartialFixedLookbackOption).vega())
    ...
    let _errorEstimate                             = cell (fun () -> (withEvaluationDate _evaluationDate _ContinuousPartialFixedLookbackOption).errorEstimate())
    let _NPV                                       = cell (fun () -> (withEvaluationDate _evaluationDate _ContinuousPartialFixedLookbackOption).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ContinuousPartialFixedLookbackOption).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ContinuousPartialFixedLookbackOption).setPricingEngine(e.Value)
                                                                     _ContinuousPartialFixedLookbackOption.Value)
    let _valuationDate                             = cell (fun () -> (withEvaluationDate _evaluationDate _ContinuousPartialFixedLookbackOption).valuationDate())
