...
*)
    ...
    let _Equals                                    (o : ICell<Object>)   
                                                   = triv (fun () -> _TTDCurrency.Value.Equals(o.Value))
    let _format                                    = triv (fun () -> _TTDCurrency.Value.format)
    let _fractionsPerUnit                          = triv (fun () -> _TTDCurrency.Value.fractionsPerUnit)
    let _fractionSymbol                            = triv (fun () -> _TTDCurrency.Value.fractionSymbol)
    let _name                                      = triv (fun () -> _TTDCurrency.Value.name)
    let _numericCode                               = triv (fun () -> _TTDCurrency.Value.numericCode)
    let _rounding                                  = triv (fun () -> _TTDCurrency.Value.rounding)
    let _symbol                                    = triv (fun () -> _TTDCurrency.Value.symbol)
    let _ToString                                  = triv (fun () -> _TTDCurrency.Value.ToString())
    let _triangulationCurrency                     = triv (fun () -> _TTDCurrency.Value.triangulationCurrency)
