...
*)
    let mutable
        _FdmLogInnerValue                          = make (fun () -> new FdmLogInnerValue (payoff.Value, mesher.Value, direction.Value))
    let _avgInnerValue                             (iter : ICell<FdmLinearOpIterator>) (t : ICell<double>)   
                                                   = triv _FdmLogInnerValue (fun () -> _FdmLogInnerValue.Value.avgInnerValue(iter.Value, t.Value))
    let _innerValue                                (iter : ICell<FdmLinearOpIterator>) (t : ICell<double>)   
                                                   = triv _FdmLogInnerValue (fun () -> _FdmLogInnerValue.Value.innerValue(iter.Value, t.Value))
