...
*)
    ...
    let _calendar                                  = cell (fun () -> _CompositeZeroYieldStructure.Value.calendar())
    let _dayCounter                                = cell (fun () -> _CompositeZeroYieldStructure.Value.dayCounter())
    let _maxDate                                   = cell (fun () -> _CompositeZeroYieldStructure.Value.maxDate())
    let _maxTime                                   = cell (fun () -> _CompositeZeroYieldStructure.Value.maxTime())
    let _referenceDate                             = cell (fun () -> _CompositeZeroYieldStructure.Value.referenceDate())
    let _settlementDays                            = cell (fun () -> _CompositeZeroYieldStructure.Value.settlementDays())
    let _update                                    = cell (fun () -> _CompositeZeroYieldStructure.Value.update()
