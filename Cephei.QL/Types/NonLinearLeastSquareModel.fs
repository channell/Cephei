...
*)
    ...
    let _exitFlag                                  = cell (fun () -> _NonLinearLeastSquare.Value.exitFlag())
    let _lastValue                                 = cell (fun () -> _NonLinearLeastSquare.Value.lastValue())
    let _perform                                   (lsProblem : ICell<LeastSquareProblem>)   
                                                   = cell (fun () -> _NonLinearLeastSquare.Value.perform(ref lsProblem.Value))
    let _residualNorm                              = cell (fun () -> _NonLinearLeastSquare.Value.residualNorm())
    let _setInitialValue                           (initialValue : ICell<Vector>)   
                                                   = cell (fun () -> _NonLinearLeastSquare.Value.setInitialValue(initialValue.Value)
...
*)
    ...
    let _exitFlag                                  = cell (fun () -> _NonLinearLeastSquare.Value.exitFlag())
    let _lastValue                                 = cell (fun () -> _NonLinearLeastSquare.Value.lastValue())
    let _perform                                   (lsProblem : ICell<LeastSquareProblem ref>)   
                                                   = cell (fun () -> _NonLinearLeastSquare.Value.perform(lsProblem.Value))
    let _residualNorm                              = cell (fun () -> _NonLinearLeastSquare.Value.residualNorm())
    let _setInitialValue                           (initialValue : ICell<Vector>)   
                                                   = cell (fun () -> _NonLinearLeastSquare.Value.setInitialValue(initialValue.Value)
                                                                     _NonLinearLeastSquare.Value)
