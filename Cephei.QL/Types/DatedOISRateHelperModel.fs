...
*)
    ...
    let _earliestDate                              = triv (fun () -> _DatedOISRateHelper.Value.earliestDate())
    let _latestDate                                = triv (fun () -> _DatedOISRateHelper.Value.latestDate())
    let _latestRelevantDate                        = triv (fun () -> _DatedOISRateHelper.Value.latestRelevantDate())
    let _maturityDate                              = triv (fun () -> _DatedOISRateHelper.Value.maturityDate())
    let _pillarDate                                = triv (fun () -> _DatedOISRateHelper.Value.pillarDate())
    let _quote                                     = triv (fun () -> _DatedOISRateHelper.Value.quote())
    let _quoteError                                = triv (fun () -> _DatedOISRateHelper.Value.quoteError())
    let _quoteIsValid                              = triv (fun () -> _DatedOISRateHelper.Value.quoteIsValid())
    let _quoteValue                                = triv (fun () -> _DatedOISRateHelper.Value.quoteValue())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv (fun () -> _DatedOISRateHelper.Value.registerWith(handler.Value)
                                                                     _DatedOISRateHelper.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = triv (fun () -> _DatedOISRateHelper.Value.unregisterWith(handler.Value)
                                                                     _DatedOISRateHelper.Value)
