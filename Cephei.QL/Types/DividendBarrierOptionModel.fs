...
(*
    Functions
*)
    let _DividendBarrierOption                     = cell (fun () -> withEngine evaluationDate pricingEngine (new DividendBarrierOption (barrierType.Value, barrier.Value, rebate.Value, payoff.Value, exercise.Value, dividendDates.Value, dividends.Value)))
    let _impliedVolatility                         (targetValue : ICell<double>) (Process : ICell<GeneralizedBlackScholesProcess>) (accuracy : ICell<double>) (maxEvaluations : ICell<int>) (minVol : ICell<double>) (maxVol : ICell<double>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _DividendBarrierOption).impliedVolatility(targetValue.Value, Process.Value, accuracy.Value, maxEvaluations.Value, minVol.Value, maxVol.Value))
    let _delta                                     = triv (fun () -> (withEvaluationDate _evaluationDate _DividendBarrierOption).delta())
    let _deltaForward                              = triv (fun () -> (withEvaluationDate _evaluationDate _DividendBarrierOption).deltaForward())
    let _dividendRho                               = triv (fun () -> (withEvaluationDate _evaluationDate _DividendBarrierOption).dividendRho())
    let _elasticity                                = triv (fun () -> (withEvaluationDate _evaluationDate _DividendBarrierOption).elasticity())
    let _gamma                                     = triv (fun () -> (withEvaluationDate _evaluationDate _DividendBarrierOption).gamma())
    let _isExpired                                 = triv (fun () -> (withEvaluationDate _evaluationDate _DividendBarrierOption).isExpired())
    let _itmCashProbability                        = triv (fun () -> (withEvaluationDate _evaluationDate _DividendBarrierOption).itmCashProbability())
    let _rho                                       = triv (fun () -> (withEvaluationDate _evaluationDate _DividendBarrierOption).rho())
    let _strikeSensitivity                         = triv (fun () -> (withEvaluationDate _evaluationDate _DividendBarrierOption).strikeSensitivity())
    let _theta                                     = triv (fun () -> (withEvaluationDate _evaluationDate _DividendBarrierOption).theta())
    let _thetaPerDay                               = triv (fun () -> (withEvaluationDate _evaluationDate _DividendBarrierOption).thetaPerDay())
    let _vega                                      = triv (fun () -> (withEvaluationDate _evaluationDate _DividendBarrierOption).vega())
    ...
    let _errorEstimate                             = triv (fun () -> (withEvaluationDate _evaluationDate _DividendBarrierOption).errorEstimate())
    let _NPV                                       = cell (fun () -> (withEvaluationDate _evaluationDate _DividendBarrierOption).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _DividendBarrierOption).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _DividendBarrierOption).setPricingEngine(e.Value)
