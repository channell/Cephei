...
*)
    let mutable
        _FDAmericanCondition                       = make (fun () -> new FDAmericanCondition<'baseEngine> ())
    let _factory                                   (Process : ICell<GeneralizedBlackScholesProcess>) (timeSteps : ICell<int>) (gridPoints : ICell<int>) (timeDependent : ICell<bool>)   
                                                   = triv _FDAmericanCondition (fun () -> _FDAmericanCondition.Value.factory(Process.Value, timeSteps.Value, gridPoints.Value, timeDependent.Value))
    let _calculate                                 (r : ICell<IPricingEngineResults>)   
                                                   = triv _FDAmericanCondition (fun () -> _FDAmericanCondition.Value.calculate(r.Value)
                                                                                          _FDAmericanCondition.Value)
    let _setStepCondition                          (impl : ICell<Func<IStepCondition<Vector>>>)   
                                                   = triv _FDAmericanCondition (fun () -> _FDAmericanCondition.Value.setStepCondition(impl.Value)
                                                                                          _FDAmericanCondition.Value)
    let _ensureStrikeInGrid                        = triv _FDAmericanCondition (fun () -> _FDAmericanCondition.Value.ensureStrikeInGrid()
                                                                                          _FDAmericanCondition.Value)
    let _getResidualTime                           = triv _FDAmericanCondition (fun () -> _FDAmericanCondition.Value.getResidualTime())
    let _grid                                      = triv _FDAmericanCondition (fun () -> _FDAmericanCondition.Value.grid())
    let _intrinsicValues_                          = triv _FDAmericanCondition (fun () -> _FDAmericanCondition.Value.intrinsicValues_)
...
*)
    let mutable
        _FDAmericanCondition                       = make (fun () -> new FDAmericanCondition<'baseEngine> (Process.Value, timeSteps.Value, gridPoints.Value, timeDependent.Value))
    let _factory                                   (Process : ICell<GeneralizedBlackScholesProcess>) (timeSteps : ICell<int>) (gridPoints : ICell<int>) (timeDependent : ICell<bool>)   
                                                   = triv _FDAmericanCondition (fun () -> _FDAmericanCondition.Value.factory(Process.Value, timeSteps.Value, gridPoints.Value, timeDependent.Value))
    let _calculate                                 (r : ICell<IPricingEngineResults>)   
                                                   = triv _FDAmericanCondition (fun () -> _FDAmericanCondition.Value.calculate(r.Value)
