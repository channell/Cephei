...
*)
    ...
    let _impliedQuote                              = cell (fun () -> _BMASwapRateHelper.Value.impliedQuote())
    let _setTermStructure                          (t : ICell<YieldTermStructure>)   
                                                   = cell (fun () -> _BMASwapRateHelper.Value.setTermStructure(t.Value)
                                                                     _BMASwapRateHelper.Value)
    let _update                                    = cell (fun () -> _BMASwapRateHelper.Value.update()
                                                                     _BMASwapRateHelper.Value)
    let _earliestDate                              = cell (fun () -> _BMASwapRateHelper.Value.earliestDate())
    let _latestDate                                = cell (fun () -> _BMASwapRateHelper.Value.latestDate())
    let _latestRelevantDate                        = cell (fun () -> _BMASwapRateHelper.Value.latestRelevantDate())
    let _maturityDate                              = cell (fun () -> _BMASwapRateHelper.Value.maturityDate())
    let _pillarDate                                = cell (fun () -> _BMASwapRateHelper.Value.pillarDate())
    let _quote                                     = cell (fun () -> _BMASwapRateHelper.Value.quote())
    let _quoteError                                = cell (fun () -> _BMASwapRateHelper.Value.quoteError())
    let _quoteIsValid                              = cell (fun () -> _BMASwapRateHelper.Value.quoteIsValid())
    let _quoteValue                                = cell (fun () -> _BMASwapRateHelper.Value.quoteValue())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _BMASwapRateHelper.Value.registerWith(handler.Value)
                                                                     _BMASwapRateHelper.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _BMASwapRateHelper.Value.unregisterWith(handler.Value)
                                                                     _BMASwapRateHelper.Value)
