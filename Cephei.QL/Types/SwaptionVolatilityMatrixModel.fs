...
*)
    let mutable
        _SwaptionVolatilityMatrix                  = make (fun () -> new SwaptionVolatilityMatrix (today.Value, optionDates.Value, swapTenors.Value, vols.Value, dayCounter.Value, flatExtrapolation.Value, Type.Value, shifts.Value))
    let _locate                                    (optionTime : ICell<double>) (swapLength : ICell<double>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.locate(optionTime.Value, swapLength.Value))
    let _locate1                                   (optionDate : ICell<Date>) (swapTenor : ICell<Period>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.locate(optionDate.Value, swapTenor.Value))
    let _maxDate                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.maxDate())
    let _maxStrike                                 = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.maxStrike())
    let _maxSwapTenor                              = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.maxSwapTenor())
    let _minStrike                                 = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.minStrike())
    let _volatilityType                            = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.volatilityType())
    let _optionDateFromTime                        (optionTime : ICell<double>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.optionDateFromTime(optionTime.Value))
    let _optionDates                               = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.optionDates())
    let _optionTenors                              = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.optionTenors())
    let _optionTimes                               = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.optionTimes())
    let _swapLengths                               = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.swapLengths())
    let _swapTenors                                = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.swapTenors())
    let _update                                    = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.update()
    ...
    let _blackVariance                             (optionTenor : ICell<Period>) (swapTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.blackVariance(optionTenor.Value, swapTenor.Value, strike.Value, extrapolate.Value))
    let _blackVariance1                            (optionDate : ICell<Date>) (swapTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.blackVariance(optionDate.Value, swapTenor.Value, strike.Value, extrapolate.Value))
    let _blackVariance2                            (optionTime : ICell<double>) (swapTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.blackVariance(optionTime.Value, swapTenor.Value, strike.Value, extrapolate.Value))
    let _blackVariance3                            (optionTenor : ICell<Period>) (swapLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.blackVariance(optionTenor.Value, swapLength.Value, strike.Value, extrapolate.Value))
    let _blackVariance4                            (optionTime : ICell<double>) (swapLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.blackVariance(optionTime.Value, swapLength.Value, strike.Value, extrapolate.Value))
    let _blackVariance5                            (optionDate : ICell<Date>) (swapLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.blackVariance(optionDate.Value, swapLength.Value, strike.Value, extrapolate.Value))
    let _maxSwapLength                             = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.maxSwapLength())
    let _shift                                     (optionTime : ICell<double>) (swapLength : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.shift(optionTime.Value, swapLength.Value, extrapolate.Value))
    let _shift1                                    (optionDate : ICell<Date>) (swapLength : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.shift(optionDate.Value, swapLength.Value, extrapolate.Value))
    let _shift2                                    (optionTenor : ICell<Period>) (swapTenor : ICell<Period>) (extrapolate : ICell<bool>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.shift(optionTenor.Value, swapTenor.Value, extrapolate.Value))
    let _shift3                                    (optionTenor : ICell<Period>) (swapLength : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.shift(optionTenor.Value, swapLength.Value, extrapolate.Value))
    let _shift4                                    (optionTime : ICell<double>) (swapTenor : ICell<Period>) (extrapolate : ICell<bool>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.shift(optionTime.Value, swapTenor.Value, extrapolate.Value))
    let _shift5                                    (optionDate : ICell<Date>) (swapTenor : ICell<Period>) (extrapolate : ICell<bool>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.shift(optionDate.Value, swapTenor.Value, extrapolate.Value))
    let _smileSection                              (optionDate : ICell<Date>) (swapTenor : ICell<Period>) (extr : ICell<bool>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.smileSection(optionDate.Value, swapTenor.Value, extr.Value))
    let _smileSection1                             (optionTenor : ICell<Period>) (swapTenor : ICell<Period>) (extr : ICell<bool>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.smileSection(optionTenor.Value, swapTenor.Value, extr.Value))
    let _smileSection2                             (optionTime : ICell<double>) (swapLength : ICell<double>) (extr : ICell<bool>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.smileSection(optionTime.Value, swapLength.Value, extr.Value))
    let _swapLength                                (start : ICell<Date>) (End : ICell<Date>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.swapLength(start.Value, End.Value))
    let _swapLength1                               (swapTenor : ICell<Period>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.swapLength(swapTenor.Value))
    let _volatility                                (optionTime : ICell<double>) (swapTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.volatility(optionTime.Value, swapTenor.Value, strike.Value, extrapolate.Value))
    let _volatility1                               (optionTenor : ICell<Period>) (swapLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.volatility(optionTenor.Value, swapLength.Value, strike.Value, extrapolate.Value))
    let _volatility2                               (optionDate : ICell<Date>) (swapLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.volatility(optionDate.Value, swapLength.Value, strike.Value, extrapolate.Value))
    let _volatility3                               (optionTime : ICell<double>) (swapLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.volatility(optionTime.Value, swapLength.Value, strike.Value, extrapolate.Value))
    let _volatility4                               (optionDate : ICell<Date>) (swapTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.volatility(optionDate.Value, swapTenor.Value, strike.Value, extrapolate.Value))
    let _volatility5                               (optionTenor : ICell<Period>) (swapTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.volatility(optionTenor.Value, swapTenor.Value, strike.Value, extrapolate.Value))
    let _businessDayConvention                     = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.businessDayConvention())
    let _optionDateFromTenor                       (p : ICell<Period>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.optionDateFromTenor(p.Value))
    let _calendar                                  = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.calendar())
    let _dayCounter                                = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.dayCounter())
    let _maxTime                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.maxTime())
    let _referenceDate                             = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.referenceDate())
    let _settlementDays                            = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.settlementDays())
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.timeFromReference(date.Value))
    let _allowsExtrapolation                       = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.disableExtrapolation(b.Value)
                                                                                               _SwaptionVolatilityMatrix.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.enableExtrapolation(b.Value)
                                                                                               _SwaptionVolatilityMatrix.Value)
    let _extrapolate                               = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.extrapolate)
...
*)
    let mutable
        _SwaptionVolatilityMatrix                  = make (fun () -> new SwaptionVolatilityMatrix (referenceDate.Value, calendar.Value, bdc.Value, optionTenors.Value, swapTenors.Value, vols.Value, dayCounter.Value, flatExtrapolation.Value, Type.Value, shifts.Value))
    let _locate                                    (optionTime : ICell<double>) (swapLength : ICell<double>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.locate(optionTime.Value, swapLength.Value))
    let _locate1                                   (optionDate : ICell<Date>) (swapTenor : ICell<Period>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.locate(optionDate.Value, swapTenor.Value))
...
*)
    let mutable
        _SwaptionVolatilityMatrix                  = make (fun () -> new SwaptionVolatilityMatrix (calendar.Value, bdc.Value, optionTenors.Value, swapTenors.Value, vols.Value, dayCounter.Value, flatExtrapolation.Value, Type.Value, shifts.Value))
    let _locate                                    (optionTime : ICell<double>) (swapLength : ICell<double>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.locate(optionTime.Value, swapLength.Value))
    let _locate1                                   (optionDate : ICell<Date>) (swapTenor : ICell<Period>)   
                                                   = triv _SwaptionVolatilityMatrix (fun () -> _SwaptionVolatilityMatrix.Value.locate(optionDate.Value, swapTenor.Value))
