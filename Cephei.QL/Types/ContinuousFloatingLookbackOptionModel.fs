...
(*
    Functions
*)
    let _ContinuousFloatingLookbackOption          = triv (fun () -> withEngine _pricingEngine.Value (new ContinuousFloatingLookbackOption (minmax.Value, payoff.Value, exercise.Value)))
