...
(*
    Functions
*)
    let _ContinuousFloatingLookbackOption          = cell (fun () -> withEngine evaluationDate pricingEngine (new ContinuousFloatingLookbackOption (minmax.Value, payoff.Value, exercise.Value)))
