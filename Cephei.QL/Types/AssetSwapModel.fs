...
*)
    ...
    let _bond                                      = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).bond())
    let _bondLeg                                   = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).bondLeg())
    let _cleanPrice                                = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).cleanPrice())
    let _fairCleanPrice                            = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).fairCleanPrice())
    let _fairNonParRepayment                       = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).fairNonParRepayment())
    let _fairSpread                                = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).fairSpread())
    let _floatingLeg                               = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).floatingLeg())
    let _floatingLegBPS                            = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).floatingLegBPS())
    let _floatingLegNPV                            = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).floatingLegNPV())
    let _nonParRepayment                           = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).nonParRepayment())
    let _parSwap                                   = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).parSwap())
    let _payBondCoupon                             = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).payBondCoupon())
    let _spread                                    = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).spread())
    let _endDiscounts                              (j : ICell<int>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).endDiscounts(j.Value))
    let _engine                                    = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).engine)
    let _isExpired                                 = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).isExpired())
    let _leg                                       (j : ICell<int>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).leg(j.Value))
    let _legBPS                                    (j : ICell<int>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).legBPS(j.Value))
    let _legNPV                                    (j : ICell<int>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).legNPV(j.Value))
    let _maturityDate                              = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).maturityDate())
    let _npvDateDiscount                           = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).npvDateDiscount())
    let _payer                                     (j : ICell<int>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).payer(j.Value))
    let _startDate                                 = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).startDate())
    let _startDiscounts                            (j : ICell<int>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).startDiscounts(j.Value))
    let _CASH                                      = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).CASH())
    let _errorEstimate                             = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).errorEstimate())
    let _NPV                                       = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).setPricingEngine(e.Value)
                                                                     _AssetSwap.Value)
    let _valuationDate                             = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).valuationDate())
