...
(*
    Functions
*)
    let _AssetSwap                                 = triv (fun () -> withEngine _pricingEngine.Value (new AssetSwap (parAssetSwap.Value, bond.Value, bondCleanPrice.Value, nonParRepayment.Value, gearing.Value, iborIndex.Value, spread.Value, floatingDayCount.Value, dealMaturity.Value, payBondCoupon.Value)))
...
(*
    Functions
*)
    let _AssetSwap                                 = triv (fun () -> withEngine _pricingEngine.Value (new AssetSwap (payBondCoupon.Value, bond.Value, bondCleanPrice.Value, iborIndex.Value, spread.Value, floatSchedule.Value, floatingDayCount.Value, parAssetSwap.Value)))
    let _bond                                      = triv (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).bond())
    let _bondLeg                                   = triv (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).bondLeg())
    let _cleanPrice                                = cell (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).cleanPrice())
    let _fairCleanPrice                            = triv (fun () -> (withEvaluationDate _evaluationDate _AssetSwap).fairCleanPrice())
