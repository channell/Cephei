...
*)
    ...
    let _settlementDays                            = triv (fun () -> _ImpliedTermStructure.Value.settlementDays())
    let _discount                                  (t : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _ImpliedTermStructure.Value.discount(t.Value, extrapolate.Value))
    let _discount1                                 (d : ICell<Date>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _ImpliedTermStructure.Value.discount(d.Value, extrapolate.Value))
    let _forwardRate                               (d : ICell<Date>) (p : ICell<Period>) (dayCounter : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _ImpliedTermStructure.Value.forwardRate(d.Value, p.Value, dayCounter.Value, comp.Value, freq.Value, extrapolate.Value))
    let _forwardRate1                              (d1 : ICell<Date>) (d2 : ICell<Date>) (dayCounter : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _ImpliedTermStructure.Value.forwardRate(d1.Value, d2.Value, dayCounter.Value, comp.Value, freq.Value, extrapolate.Value))
    let _forwardRate2                              (t1 : ICell<double>) (t2 : ICell<double>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _ImpliedTermStructure.Value.forwardRate(t1.Value, t2.Value, comp.Value, freq.Value, extrapolate.Value))
    let _jumpDates                                 = triv (fun () -> _ImpliedTermStructure.Value.jumpDates())
    let _jumpTimes                                 = triv (fun () -> _ImpliedTermStructure.Value.jumpTimes())
    let _update                                    = triv (fun () -> _ImpliedTermStructure.Value.update()
    ...
    let _zeroRate                                  (t : ICell<double>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _ImpliedTermStructure.Value.zeroRate(t.Value, comp.Value, freq.Value, extrapolate.Value))
    let _zeroRate1                                 (d : ICell<Date>) (dayCounter : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _ImpliedTermStructure.Value.zeroRate(d.Value, dayCounter.Value, comp.Value, freq.Value, extrapolate.Value))
    let _maxTime                                   = triv (fun () -> _ImpliedTermStructure.Value.maxTime())
    let _referenceDate                             = triv (fun () -> _ImpliedTermStructure.Value.referenceDate())
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = triv (fun () -> _ImpliedTermStructure.Value.timeFromReference(date.Value))
    let _allowsExtrapolation                       = triv (fun () -> _ImpliedTermStructure.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv (fun () -> _ImpliedTermStructure.Value.disableExtrapolation(b.Value)
                                                                     _ImpliedTermStructure.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv (fun () -> _ImpliedTermStructure.Value.enableExtrapolation(b.Value)
                                                                     _ImpliedTermStructure.Value)
