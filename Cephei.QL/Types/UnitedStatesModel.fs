...
*)
    let mutable
        _UnitedStates                              = make (fun () -> new UnitedStates (m.Value))
    let _addedHolidays                             = triv _UnitedStates (fun () -> _UnitedStates.Value.addedHolidays)
    let _addHoliday                                (d : ICell<Date>)   
                                                   = triv _UnitedStates (fun () -> _UnitedStates.Value.addHoliday(d.Value)
                                                                                   _UnitedStates.Value)
    let _adjust                                    (d : ICell<Date>) (c : ICell<BusinessDayConvention>)   
                                                   = triv _UnitedStates (fun () -> _UnitedStates.Value.adjust(d.Value, c.Value))
    let _advance                                   (d : ICell<Date>) (p : ICell<Period>) (c : ICell<BusinessDayConvention>) (endOfMonth : ICell<bool>)   
                                                   = triv _UnitedStates (fun () -> _UnitedStates.Value.advance(d.Value, p.Value, c.Value, endOfMonth.Value))
    let _advance1                                  (d : ICell<Date>) (n : ICell<int>) (unit : ICell<TimeUnit>) (c : ICell<BusinessDayConvention>) (endOfMonth : ICell<bool>)   
                                                   = triv _UnitedStates (fun () -> _UnitedStates.Value.advance(d.Value, n.Value, unit.Value, c.Value, endOfMonth.Value))
    let _businessDaysBetween                       (from : ICell<Date>) (To : ICell<Date>) (includeFirst : ICell<bool>) (includeLast : ICell<bool>)   
                                                   = triv _UnitedStates (fun () -> _UnitedStates.Value.businessDaysBetween(from.Value, To.Value, includeFirst.Value, includeLast.Value))
    let _calendar                                  = triv _UnitedStates (fun () -> _UnitedStates.Value.calendar)
    let _empty                                     = triv _UnitedStates (fun () -> _UnitedStates.Value.empty())
    let _endOfMonth                                (d : ICell<Date>)   
                                                   = triv _UnitedStates (fun () -> _UnitedStates.Value.endOfMonth(d.Value))
    let _Equals                                    (o : ICell<Object>)   
                                                   = triv _UnitedStates (fun () -> _UnitedStates.Value.Equals(o.Value))
    let _isBusinessDay                             (d : ICell<Date>)   
                                                   = triv _UnitedStates (fun () -> _UnitedStates.Value.isBusinessDay(d.Value))
    let _isEndOfMonth                              (d : ICell<Date>)   
                                                   = triv _UnitedStates (fun () -> _UnitedStates.Value.isEndOfMonth(d.Value))
    let _isHoliday                                 (d : ICell<Date>)   
                                                   = triv _UnitedStates (fun () -> _UnitedStates.Value.isHoliday(d.Value))
    let _isWeekend                                 (w : ICell<DayOfWeek>)   
                                                   = triv _UnitedStates (fun () -> _UnitedStates.Value.isWeekend(w.Value))
    let _name                                      = triv _UnitedStates (fun () -> _UnitedStates.Value.name())
    let _removedHolidays                           = triv _UnitedStates (fun () -> _UnitedStates.Value.removedHolidays)
    let _removeHoliday                             (d : ICell<Date>)   
                                                   = triv _UnitedStates (fun () -> _UnitedStates.Value.removeHoliday(d.Value)
                                                                                   _UnitedStates.Value)
...
*)
    let mutable
        _UnitedStates                              = make (fun () -> new UnitedStates ())
    let _addedHolidays                             = triv _UnitedStates (fun () -> _UnitedStates.Value.addedHolidays)
    let _addHoliday                                (d : ICell<Date>)   
                                                   = triv _UnitedStates (fun () -> _UnitedStates.Value.addHoliday(d.Value)
                                                                                   _UnitedStates.Value)
