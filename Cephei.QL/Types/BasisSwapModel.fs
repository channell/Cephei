...
*)
    let mutable
        _BasisSwap                                 = cell (fun () -> withEngine pricingEngine evaluationDate (new BasisSwap (Type.Value, nominal.Value, float1Schedule.Value, iborIndex1.Value, spread1.Value, float1DayCount.Value, float2Schedule.Value, iborIndex2.Value, spread2.Value, float2DayCount.Value)))
    ...
    let _floating1LegBPS                           = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).floating1LegBPS())
    let _floating1LegNPV                           = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).floating1LegNPV())
    let _floating1Schedule                         = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).floating1Schedule())
    let _floating2Leg                              = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).floating2Leg())
    let _floating2LegBPS                           = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).floating2LegBPS())
    let _floating2LegNPV                           = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).floating2LegNPV())
    let _floating2Schedule                         = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).floating2Schedule())
    let _iborIndex1                                = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).iborIndex1())
    let _iborIndex2                                = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).iborIndex2())
    let _nominal                                   = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).nominal)
    let _spread1                                   = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).spread1)
    let _spread2                                   = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).spread2)
    let _swapType                                  = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).swapType)
    let _endDiscounts                              (j : ICell<int>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).endDiscounts(j.Value))
    let _engine                                    = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).engine)
    let _isExpired                                 = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).isExpired())
    let _leg                                       (j : ICell<int>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).leg(j.Value))
    let _legBPS                                    (j : ICell<int>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).legBPS(j.Value))
    let _legNPV                                    (j : ICell<int>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).legNPV(j.Value))
    let _maturityDate                              = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).maturityDate())
    let _npvDateDiscount                           = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).npvDateDiscount())
    let _payer                                     (j : ICell<int>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).payer(j.Value))
    let _startDate                                 = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).startDate())
    let _startDiscounts                            (j : ICell<int>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).startDiscounts(j.Value))
    let _CASH                                      = cell (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).CASH())
    let _errorEstimate                             = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).errorEstimate())
    let _NPV                                       = cell (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).setPricingEngine(e.Value)
                                                                     _BasisSwap.Value)
...
*)
    let mutable
        _BasisSwap                                 = cell (fun () -> withEngine pricingEngine evaluationDate (new BasisSwap (Type.Value, nominal.Value, float1Schedule.Value, iborIndex1.Value, spread1.Value, float1DayCount.Value, float2Schedule.Value, iborIndex2.Value, spread2.Value, float2DayCount.Value, paymentConvention.Value)))
    let _fairLongSpread                            = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).fairLongSpread())
    let _fairShortSpread                           = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).fairShortSpread())
    let _floating1Leg                              = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).floating1Leg())
    let _floating1LegBPS                           = triv (fun () -> (withEvaluationDate _evaluationDate _BasisSwap).floating1LegBPS())
