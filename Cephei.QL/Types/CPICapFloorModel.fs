...
(*
    Functions
*)
    let _CPICapFloor                               = cell (fun () -> withEngine _pricingEngine.Value (new CPICapFloor (Type.Value, nominal.Value, startDate.Value, baseCPI.Value, maturity.Value, fixCalendar.Value, fixConvention.Value, payCalendar.Value, payConvention.Value, strike.Value, infIndex.Value, observationLag.Value, observationInterpolation.Value)))
    let _fixingDate                                = cell (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).fixingDate())
    let _inflationIndex                            = cell (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).inflationIndex())
    let _isExpired                                 = cell (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).isExpired())
    let _nominal                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).nominal())
    let _observationLag                            = cell (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).observationLag())
    let _payDate                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).payDate())
    let _strike                                    = cell (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).strike())
    let _type                                      = cell (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).TYPE())
    let _CASH                                      = cell (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).CASH())
    let _errorEstimate                             = cell (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).errorEstimate())
    let _NPV                                       = cell (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).setPricingEngine(e.Value)
                                                                     _CPICapFloor.Value)
    let _valuationDate                             = cell (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).valuationDate())
