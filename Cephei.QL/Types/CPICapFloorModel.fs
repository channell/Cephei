...
*)
    let mutable
        _CPICapFloor                               = make (fun () -> withEngine pricingEngine evaluationDate (new CPICapFloor (Type.Value, nominal.Value, startDate.Value, baseCPI.Value, maturity.Value, fixCalendar.Value, fixConvention.Value, payCalendar.Value, payConvention.Value, strike.Value, infIndex.Value, observationLag.Value, observationInterpolation.Value)))
    let _fixingDate                                = triv _CPICapFloor (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).fixingDate())
    let _inflationIndex                            = triv _CPICapFloor (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).inflationIndex())
    let _isExpired                                 = triv _CPICapFloor (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).isExpired())
    let _nominal                                   = triv _CPICapFloor (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).nominal())
    let _observationLag                            = triv _CPICapFloor (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).observationLag())
    let _payDate                                   = triv _CPICapFloor (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).payDate())
    let _strike                                    = triv _CPICapFloor (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).strike())
    let _type                                      = triv _CPICapFloor (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).TYPE())
    let _CASH                                      = cell _CPICapFloor (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).CASH())
    let _errorEstimate                             = triv _CPICapFloor (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).errorEstimate())
    let _NPV                                       = cell _CPICapFloor (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = triv _CPICapFloor (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = triv _CPICapFloor (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).setPricingEngine(e.Value)
                                                                                  _CPICapFloor.Value)
    let _valuationDate                             = triv _CPICapFloor (fun () -> (withEvaluationDate _evaluationDate _CPICapFloor).valuationDate())
