...
*)
    let mutable
        _HestonModel                               = make (fun () -> new HestonModel (Process.Value))
    let _kappa                                     = triv _HestonModel (fun () -> _HestonModel.Value.kappa())
    let _process                                   = triv _HestonModel (fun () -> _HestonModel.Value.PROCESS())
    let _rho                                       = triv _HestonModel (fun () -> _HestonModel.Value.rho())
    let _sigma                                     = triv _HestonModel (fun () -> _HestonModel.Value.sigma())
    let _theta                                     = triv _HestonModel (fun () -> _HestonModel.Value.theta())
    let _v0                                        = triv _HestonModel (fun () -> _HestonModel.Value.v0())
    let _calibrate                                 (instruments : ICell<Generic.List<CalibrationHelper>>) (Method : ICell<OptimizationMethod>) (endCriteria : ICell<EndCriteria>) (additionalConstraint : ICell<Constraint>) (weights : ICell<Generic.List<double>>) (fixParameters : ICell<Generic.List<bool>>)   
                                                   = triv _HestonModel (fun () -> _HestonModel.Value.calibrate(instruments.Value, Method.Value, endCriteria.Value, additionalConstraint.Value, weights.Value, fixParameters.Value)
                                                                                  _HestonModel.Value)
    let _constraint                                = triv _HestonModel (fun () -> _HestonModel.Value.CONSTRAINT())
    let _endCriteria                               = triv _HestonModel (fun () -> _HestonModel.Value.endCriteria())
    let _notifyObservers                           = triv _HestonModel (fun () -> _HestonModel.Value.notifyObservers()
                                                                                  _HestonModel.Value)
    let _parameters                                = triv _HestonModel (fun () -> _HestonModel.Value.parameters())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv _HestonModel (fun () -> _HestonModel.Value.registerWith(handler.Value)
                                                                                  _HestonModel.Value)
    let _setParams                                 (parameters : ICell<Vector>)   
                                                   = triv _HestonModel (fun () -> _HestonModel.Value.setParams(parameters.Value)
                                                                                  _HestonModel.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = triv _HestonModel (fun () -> _HestonModel.Value.unregisterWith(handler.Value)
                                                                                  _HestonModel.Value)
    let _update                                    = triv _HestonModel (fun () -> _HestonModel.Value.update()
                                                                                  _HestonModel.Value)
    let _value                                     (parameters : ICell<Vector>) (instruments : ICell<Generic.List<CalibrationHelper>>)   
                                                   = triv _HestonModel (fun () -> _HestonModel.Value.value(parameters.Value, instruments.Value))
