...
*)
    ...
    let _atmType                                   = cell (fun () -> _DeltaVolQuote.Value.atmType())
    let _delta                                     = cell (fun () -> _DeltaVolQuote.Value.delta())
    let _deltaType                                 = cell (fun () -> _DeltaVolQuote.Value.deltaType())
    let _isValid                                   = cell (fun () -> _DeltaVolQuote.Value.isValid())
    let _maturity                                  = cell (fun () -> _DeltaVolQuote.Value.maturity())
    let _update                                    = cell (fun () -> _DeltaVolQuote.Value.update()
                                                                     _DeltaVolQuote.Value)
    let _value                                     = cell (fun () -> _DeltaVolQuote.Value.value())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _DeltaVolQuote.Value.registerWith(handler.Value)
                                                                     _DeltaVolQuote.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _DeltaVolQuote.Value.unregisterWith(handler.Value)
                                                                     _DeltaVolQuote.Value)
