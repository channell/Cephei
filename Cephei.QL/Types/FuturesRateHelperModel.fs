...
*)
    ...
    let _convexityAdjustment                       = cell (fun () -> _FuturesRateHelper.Value.convexityAdjustment())
    let _impliedQuote                              = cell (fun () -> _FuturesRateHelper.Value.impliedQuote())
    let _earliestDate                              = cell (fun () -> _FuturesRateHelper.Value.earliestDate())
    let _latestDate                                = cell (fun () -> _FuturesRateHelper.Value.latestDate())
    let _latestRelevantDate                        = cell (fun () -> _FuturesRateHelper.Value.latestRelevantDate())
    let _maturityDate                              = cell (fun () -> _FuturesRateHelper.Value.maturityDate())
    let _pillarDate                                = cell (fun () -> _FuturesRateHelper.Value.pillarDate())
    let _quote                                     = cell (fun () -> _FuturesRateHelper.Value.quote())
    let _quoteError                                = cell (fun () -> _FuturesRateHelper.Value.quoteError())
    let _quoteIsValid                              = cell (fun () -> _FuturesRateHelper.Value.quoteIsValid())
    let _quoteValue                                = cell (fun () -> _FuturesRateHelper.Value.quoteValue())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _FuturesRateHelper.Value.registerWith(handler.Value)
                                                                     _FuturesRateHelper.Value)
    let _setTermStructure                          (ts : ICell<'TS>)   
                                                   = cell (fun () -> _FuturesRateHelper.Value.setTermStructure(ts.Value)
                                                                     _FuturesRateHelper.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _FuturesRateHelper.Value.unregisterWith(handler.Value)
                                                                     _FuturesRateHelper.Value)
    let _update                                    = cell (fun () -> _FuturesRateHelper.Value.update()
                                                                     _FuturesRateHelper.Value)
