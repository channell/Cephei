...
*)
    let mutable
        _LmExponentialCorrelationModel             = make (fun () -> new LmExponentialCorrelationModel (size.Value, rho.Value))
    let _correlation                               (i : ICell<int>) (j : ICell<int>) (t : ICell<double>) (x : ICell<Vector>)   
                                                   = triv _LmExponentialCorrelationModel (fun () -> _LmExponentialCorrelationModel.Value.correlation(i.Value, j.Value, t.Value, x.Value))
    let _correlation1                              (t : ICell<double>) (x : ICell<Vector>)   
                                                   = triv _LmExponentialCorrelationModel (fun () -> _LmExponentialCorrelationModel.Value.correlation(t.Value, x.Value))
    let _isTimeIndependent                         = triv _LmExponentialCorrelationModel (fun () -> _LmExponentialCorrelationModel.Value.isTimeIndependent())
    let _pseudoSqrt                                (t : ICell<double>) (x : ICell<Vector>)   
                                                   = triv _LmExponentialCorrelationModel (fun () -> _LmExponentialCorrelationModel.Value.pseudoSqrt(t.Value, x.Value))
    let _factors                                   = triv _LmExponentialCorrelationModel (fun () -> _LmExponentialCorrelationModel.Value.factors())
    let _parameters                                = triv _LmExponentialCorrelationModel (fun () -> _LmExponentialCorrelationModel.Value.parameters())
    let _setParams                                 (arguments : ICell<Generic.List<Parameter>>)   
                                                   = triv _LmExponentialCorrelationModel (fun () -> _LmExponentialCorrelationModel.Value.setParams(arguments.Value)
                                                                                                    _LmExponentialCorrelationModel.Value)
    let _size                                      = triv _LmExponentialCorrelationModel (fun () -> _LmExponentialCorrelationModel.Value.size())
