...
*)
    ...
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _AkimaCubicInterpolation.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = triv (fun () -> _AkimaCubicInterpolation.Value.empty())
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _AkimaCubicInterpolation.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _AkimaCubicInterpolation.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = triv (fun () -> _AkimaCubicInterpolation.Value.update()
                                                                     _AkimaCubicInterpolation.Value)
    let _value                                     (x : ICell<double>)   
                                                   = triv (fun () -> _AkimaCubicInterpolation.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _AkimaCubicInterpolation.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = triv (fun () -> _AkimaCubicInterpolation.Value.xMax())
    let _xMin                                      = triv (fun () -> _AkimaCubicInterpolation.Value.xMin())
    let _allowsExtrapolation                       = triv (fun () -> _AkimaCubicInterpolation.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv (fun () -> _AkimaCubicInterpolation.Value.disableExtrapolation(b.Value)
                                                                     _AkimaCubicInterpolation.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv (fun () -> _AkimaCubicInterpolation.Value.enableExtrapolation(b.Value)
                                                                     _AkimaCubicInterpolation.Value)
