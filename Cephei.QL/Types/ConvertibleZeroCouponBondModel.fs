...
*)
    ...
    let _callability                               = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).callability())
    let _conversionRatio                           = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).conversionRatio())
    let _creditSpread                              = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).creditSpread())
    let _dividends                                 = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).dividends())
    let _accruedAmount                             (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).accruedAmount(settlement.Value))
    let _calendar                                  = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).calendar())
    let _cashflows                                 = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).cashflows())
    ...
    let _dirtyPrice1                               (Yield : ICell<double>) (dc : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).dirtyPrice(Yield.Value, dc.Value, comp.Value, freq.Value, settlement.Value))
    let _isExpired                                 = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).isExpired())
    let _issueDate                                 = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).issueDate())
    let _isTradable                                (d : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).isTradable(d.Value))
    let _maturityDate                              = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).maturityDate())
    let _nextCashFlowDate                          (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).nextCashFlowDate(settlement.Value))
    let _nextCouponRate                            (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).nextCouponRate(settlement.Value))
    let _notional                                  (d : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).notional(d.Value))
    let _notionals                                 = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).notionals())
    let _previousCashFlowDate                      (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).previousCashFlowDate(settlement.Value))
    let _previousCouponRate                        (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).previousCouponRate(settlement.Value))
    let _redemption                                = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).redemption())
    let _redemptions                               = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).redemptions())
    let _settlementDate                            (date : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).settlementDate(date.Value))
    let _settlementDays                            = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).settlementDays())
    let _settlementValue                           (cleanPrice : ICell<double>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).settlementValue(cleanPrice.Value))
    let _settlementValue1                          = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).settlementValue())
    let _startDate                                 = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).startDate())
    ...
    let _errorEstimate                             = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).errorEstimate())
    let _NPV                                       = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).setPricingEngine(e.Value)
                                                                     _ConvertibleZeroCouponBond.Value)
    let _valuationDate                             = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleZeroCouponBond).valuationDate())
