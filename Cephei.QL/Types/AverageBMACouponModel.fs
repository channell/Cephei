...
*)
    ...
    let _convexityAdjustment                       = cell (fun () -> _AverageBMACoupon.Value.convexityAdjustment())
    let _fixingDate                                = cell (fun () -> _AverageBMACoupon.Value.fixingDate())
    let _fixingDates                               = cell (fun () -> _AverageBMACoupon.Value.fixingDates())
    let _indexFixing                               = cell (fun () -> _AverageBMACoupon.Value.indexFixing())
    let _indexFixings                              = cell (fun () -> _AverageBMACoupon.Value.indexFixings())
    let _accruedAmount                             (d : ICell<Date>)   
                                                   = cell (fun () -> _AverageBMACoupon.Value.accruedAmount(d.Value))
    let _adjustedFixing                            = cell (fun () -> _AverageBMACoupon.Value.adjustedFixing)
    let _amount                                    = cell (fun () -> _AverageBMACoupon.Value.amount())
    let _dayCounter                                = cell (fun () -> _AverageBMACoupon.Value.dayCounter())
    let _factory                                   (nominal : ICell<double>) (paymentDate : ICell<Date>) (startDate : ICell<Date>) (endDate : ICell<Date>) (fixingDays : ICell<int>) (index : ICell<InterestRateIndex>) (gearing : ICell<double>) (spread : ICell<double>) (refPeriodStart : ICell<Date>) (refPeriodEnd : ICell<Date>) (dayCounter : ICell<DayCounter>) (isInArrears : ICell<bool>)   
                                                   = cell (fun () -> _AverageBMACoupon.Value.factory(nominal.Value, paymentDate.Value, startDate.Value, endDate.Value, fixingDays.Value, index.Value, gearing.Value, spread.Value, refPeriodStart.Value, refPeriodEnd.Value, dayCounter.Value, isInArrears.Value))
    let _fixingDays                                = cell (fun () -> _AverageBMACoupon.Value.fixingDays)
    let _gearing                                   = cell (fun () -> _AverageBMACoupon.Value.gearing())
    let _index                                     = cell (fun () -> _AverageBMACoupon.Value.index())
    let _isInArrears                               = cell (fun () -> _AverageBMACoupon.Value.isInArrears())
    let _price                                     (yts : ICell<YieldTermStructure>)   
                                                   = cell (fun () -> _AverageBMACoupon.Value.price(yts.Value))
    let _pricer                                    = cell (fun () -> _AverageBMACoupon.Value.pricer())
    let _rate                                      = cell (fun () -> _AverageBMACoupon.Value.rate())
    let _setPricer                                 (pricer : ICell<FloatingRateCouponPricer>)   
                                                   = cell (fun () -> _AverageBMACoupon.Value.setPricer(pricer.Value)
                                                                     _AverageBMACoupon.Value)
    let _spread                                    = cell (fun () -> _AverageBMACoupon.Value.spread())
    let _update                                    = cell (fun () -> _AverageBMACoupon.Value.update()
                                                                     _AverageBMACoupon.Value)
    let _accrualDays                               = cell (fun () -> _AverageBMACoupon.Value.accrualDays())
    let _accrualEndDate                            = cell (fun () -> _AverageBMACoupon.Value.accrualEndDate())
    let _accrualPeriod                             = cell (fun () -> _AverageBMACoupon.Value.accrualPeriod())
    let _accrualStartDate                          = cell (fun () -> _AverageBMACoupon.Value.accrualStartDate())
    let _accruedDays                               (d : ICell<Date>)   
                                                   = cell (fun () -> _AverageBMACoupon.Value.accruedDays(d.Value))
    let _accruedPeriod                             (d : ICell<Date>)   
                                                   = cell (fun () -> _AverageBMACoupon.Value.accruedPeriod(d.Value))
    let _date                                      = cell (fun () -> _AverageBMACoupon.Value.date())
    let _exCouponDate                              = cell (fun () -> _AverageBMACoupon.Value.exCouponDate())
    let _nominal                                   = cell (fun () -> _AverageBMACoupon.Value.nominal())
    let _referencePeriodEnd                        = cell (fun () -> _AverageBMACoupon.Value.referencePeriodEnd)
    let _referencePeriodStart                      = cell (fun () -> _AverageBMACoupon.Value.referencePeriodStart)
    let _CompareTo                                 (cf : ICell<CashFlow>)   
                                                   = cell (fun () -> _AverageBMACoupon.Value.CompareTo(cf.Value))
    let _Equals                                    (cf : ICell<Object>)   
                                                   = cell (fun () -> _AverageBMACoupon.Value.Equals(cf.Value))
    let _hasOccurred                               (refDate : ICell<Date>) (includeRefDate : ICell<Nullable<bool>>)   
                                                   = cell (fun () -> _AverageBMACoupon.Value.hasOccurred(refDate.Value, includeRefDate.Value))
    let _tradingExCoupon                           (refDate : ICell<Date>)   
                                                   = cell (fun () -> _AverageBMACoupon.Value.tradingExCoupon(refDate.Value))
    let _accept                                    (v : ICell<IAcyclicVisitor>)   
                                                   = cell (fun () -> _AverageBMACoupon.Value.accept(v.Value)
                                                                     _AverageBMACoupon.Value)
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _AverageBMACoupon.Value.registerWith(handler.Value)
                                                                     _AverageBMACoupon.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _AverageBMACoupon.Value.unregisterWith(handler.Value)
                                                                     _AverageBMACoupon.Value)
