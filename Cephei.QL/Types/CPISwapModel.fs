...
*)
    ...
    let _fairSpread                                = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).fairSpread())
    let _fixedDayCount                             = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).fixedDayCount())
    let _fixedIndex                                = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).fixedIndex())
    let _fixedLegNPV                               = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).fixedLegNPV())
    let _fixedPaymentRoll                          = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).fixedPaymentRoll())
    let _fixedRate                                 = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).fixedRate())
    let _fixedSchedule                             = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).fixedSchedule())
    let _fixingDays                                = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).fixingDays())
    let _floatDayCount                             = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).floatDayCount())
    let _floatIndex                                = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).floatIndex())
    let _floatLeg                                  = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).floatLeg())
    let _floatLegNPV                               = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).floatLegNPV())
    let _floatPaymentRoll                          = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).floatPaymentRoll())
    let _floatSchedule                             = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).floatSchedule())
    let _inflationNominal                          = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).inflationNominal())
    let _nominal                                   = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).nominal())
    let _observationInterpolation                  = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).observationInterpolation())
    let _observationLag                            = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).observationLag())
    let _spread                                    = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).spread())
    let _subtractInflationNominal                  = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).subtractInflationNominal())
    let _type                                      = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).TYPE())
    let _endDiscounts                              (j : ICell<int>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).endDiscounts(j.Value))
    let _engine                                    = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).engine)
    let _isExpired                                 = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).isExpired())
    let _leg                                       (j : ICell<int>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).leg(j.Value))
    let _legBPS                                    (j : ICell<int>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).legBPS(j.Value))
    let _legNPV                                    (j : ICell<int>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).legNPV(j.Value))
    let _maturityDate                              = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).maturityDate())
    let _npvDateDiscount                           = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).npvDateDiscount())
    let _payer                                     (j : ICell<int>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).payer(j.Value))
    let _startDate                                 = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).startDate())
    let _startDiscounts                            (j : ICell<int>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).startDiscounts(j.Value))
    let _CASH                                      = cell (fun () -> (withEvaluationDate _evaluationDate _CPISwap).CASH())
    let _errorEstimate                             = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).errorEstimate())
    let _NPV                                       = cell (fun () -> (withEvaluationDate _evaluationDate _CPISwap).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _CPISwap).setPricingEngine(e.Value)
                                                                     _CPISwap.Value)
