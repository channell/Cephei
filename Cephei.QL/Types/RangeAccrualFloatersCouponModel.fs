...
*)
    ...
    let _endTime                                   = cell (fun () -> _RangeAccrualFloatersCoupon.Value.endTime())
    let _lowerTrigger                              = cell (fun () -> _RangeAccrualFloatersCoupon.Value.lowerTrigger())
    let _observationDates                          = cell (fun () -> _RangeAccrualFloatersCoupon.Value.observationDates())
    let _observationsNo                            = cell (fun () -> _RangeAccrualFloatersCoupon.Value.observationsNo())
    let _observationsSchedule                      = cell (fun () -> _RangeAccrualFloatersCoupon.Value.observationsSchedule())
    let _observationTimes                          = cell (fun () -> _RangeAccrualFloatersCoupon.Value.observationTimes())
    let _priceWithoutOptionality                   (discountCurve : ICell<Handle<YieldTermStructure>>)   
                                                   = cell (fun () -> _RangeAccrualFloatersCoupon.Value.priceWithoutOptionality(discountCurve.Value))
    let _startTime                                 = cell (fun () -> _RangeAccrualFloatersCoupon.Value.startTime())
    let _upperTrigger                              = cell (fun () -> _RangeAccrualFloatersCoupon.Value.upperTrigger())
    let _accruedAmount                             (d : ICell<Date>)   
                                                   = cell (fun () -> _RangeAccrualFloatersCoupon.Value.accruedAmount(d.Value))
    let _adjustedFixing                            = cell (fun () -> _RangeAccrualFloatersCoupon.Value.adjustedFixing)
    let _amount                                    = cell (fun () -> _RangeAccrualFloatersCoupon.Value.amount())
    let _convexityAdjustment                       = cell (fun () -> _RangeAccrualFloatersCoupon.Value.convexityAdjustment())
    let _dayCounter                                = cell (fun () -> _RangeAccrualFloatersCoupon.Value.dayCounter())
    let _factory                                   (nominal : ICell<double>) (paymentDate : ICell<Date>) (startDate : ICell<Date>) (endDate : ICell<Date>) (fixingDays : ICell<int>) (index : ICell<InterestRateIndex>) (gearing : ICell<double>) (spread : ICell<double>) (refPeriodStart : ICell<Date>) (refPeriodEnd : ICell<Date>) (dayCounter : ICell<DayCounter>) (isInArrears : ICell<bool>)   
                                                   = cell (fun () -> _RangeAccrualFloatersCoupon.Value.factory(nominal.Value, paymentDate.Value, startDate.Value, endDate.Value, fixingDays.Value, index.Value, gearing.Value, spread.Value, refPeriodStart.Value, refPeriodEnd.Value, dayCounter.Value, isInArrears.Value))
    let _fixingDate                                = cell (fun () -> _RangeAccrualFloatersCoupon.Value.fixingDate())
    let _fixingDays                                = cell (fun () -> _RangeAccrualFloatersCoupon.Value.fixingDays)
    let _gearing                                   = cell (fun () -> _RangeAccrualFloatersCoupon.Value.gearing())
    let _index                                     = cell (fun () -> _RangeAccrualFloatersCoupon.Value.index())
    let _indexFixing                               = cell (fun () -> _RangeAccrualFloatersCoupon.Value.indexFixing())
    let _isInArrears                               = cell (fun () -> _RangeAccrualFloatersCoupon.Value.isInArrears())
    let _price                                     (yts : ICell<YieldTermStructure>)   
                                                   = cell (fun () -> _RangeAccrualFloatersCoupon.Value.price(yts.Value))
    let _pricer                                    = cell (fun () -> _RangeAccrualFloatersCoupon.Value.pricer())
    let _rate                                      = cell (fun () -> _RangeAccrualFloatersCoupon.Value.rate())
    let _setPricer                                 (pricer : ICell<FloatingRateCouponPricer>)   
                                                   = cell (fun () -> _RangeAccrualFloatersCoupon.Value.setPricer(pricer.Value)
                                                                     _RangeAccrualFloatersCoupon.Value)
    let _spread                                    = cell (fun () -> _RangeAccrualFloatersCoupon.Value.spread())
    let _update                                    = cell (fun () -> _RangeAccrualFloatersCoupon.Value.update()
                                                                     _RangeAccrualFloatersCoupon.Value)
    let _accrualDays                               = cell (fun () -> _RangeAccrualFloatersCoupon.Value.accrualDays())
    let _accrualEndDate                            = cell (fun () -> _RangeAccrualFloatersCoupon.Value.accrualEndDate())
    let _accrualPeriod                             = cell (fun () -> _RangeAccrualFloatersCoupon.Value.accrualPeriod())
    let _accrualStartDate                          = cell (fun () -> _RangeAccrualFloatersCoupon.Value.accrualStartDate())
    let _accruedDays                               (d : ICell<Date>)   
                                                   = cell (fun () -> _RangeAccrualFloatersCoupon.Value.accruedDays(d.Value))
    let _accruedPeriod                             (d : ICell<Date>)   
                                                   = cell (fun () -> _RangeAccrualFloatersCoupon.Value.accruedPeriod(d.Value))
    let _date                                      = cell (fun () -> _RangeAccrualFloatersCoupon.Value.date())
    let _exCouponDate                              = cell (fun () -> _RangeAccrualFloatersCoupon.Value.exCouponDate())
    let _nominal                                   = cell (fun () -> _RangeAccrualFloatersCoupon.Value.nominal())
    let _referencePeriodEnd                        = cell (fun () -> _RangeAccrualFloatersCoupon.Value.referencePeriodEnd)
    let _referencePeriodStart                      = cell (fun () -> _RangeAccrualFloatersCoupon.Value.referencePeriodStart)
    let _CompareTo                                 (cf : ICell<CashFlow>)   
                                                   = cell (fun () -> _RangeAccrualFloatersCoupon.Value.CompareTo(cf.Value))
    let _Equals                                    (cf : ICell<Object>)   
                                                   = cell (fun () -> _RangeAccrualFloatersCoupon.Value.Equals(cf.Value))
    let _hasOccurred                               (refDate : ICell<Date>) (includeRefDate : ICell<Nullable<bool>>)   
                                                   = cell (fun () -> _RangeAccrualFloatersCoupon.Value.hasOccurred(refDate.Value, includeRefDate.Value))
    let _tradingExCoupon                           (refDate : ICell<Date>)   
                                                   = cell (fun () -> _RangeAccrualFloatersCoupon.Value.tradingExCoupon(refDate.Value))
    let _accept                                    (v : ICell<IAcyclicVisitor>)   
                                                   = cell (fun () -> _RangeAccrualFloatersCoupon.Value.accept(v.Value)
                                                                     _RangeAccrualFloatersCoupon.Value)
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _RangeAccrualFloatersCoupon.Value.registerWith(handler.Value)
                                                                     _RangeAccrualFloatersCoupon.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _RangeAccrualFloatersCoupon.Value.unregisterWith(handler.Value)
                                                                     _RangeAccrualFloatersCoupon.Value)
