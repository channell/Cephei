...
*)
    ...
    let _a                                         = cell (fun () -> _AbcdMathFunction.Value.a())
    let _b                                         = cell (fun () -> _AbcdMathFunction.Value.b())
    let _c                                         = cell (fun () -> _AbcdMathFunction.Value.c())
    let _coefficients                              = cell (fun () -> _AbcdMathFunction.Value.coefficients())
    let _d                                         = cell (fun () -> _AbcdMathFunction.Value.d())
    let _definiteDerivativeCoefficients            (t : ICell<double>) (t2 : ICell<double>)   
                                                   = cell (fun () -> _AbcdMathFunction.Value.definiteDerivativeCoefficients(t.Value, t2.Value))
    let _definiteIntegral                          (t1 : ICell<double>) (t2 : ICell<double>)   
                                                   = cell (fun () -> _AbcdMathFunction.Value.definiteIntegral(t1.Value, t2.Value))
    let _definiteIntegralCoefficients              (t : ICell<double>) (t2 : ICell<double>)   
                                                   = cell (fun () -> _AbcdMathFunction.Value.definiteIntegralCoefficients(t.Value, t2.Value))
    let _derivative                                (t : ICell<double>)   
                                                   = cell (fun () -> _AbcdMathFunction.Value.derivative(t.Value))
    let _derivativeCoefficients                    = cell (fun () -> _AbcdMathFunction.Value.derivativeCoefficients())
    let _longTermValue                             = cell (fun () -> _AbcdMathFunction.Value.longTermValue())
    let _maximumLocation                           = cell (fun () -> _AbcdMathFunction.Value.maximumLocation())
    let _maximumValue                              = cell (fun () -> _AbcdMathFunction.Value.maximumValue())
    let _primitive                                 (t : ICell<double>)   
                                                   = cell (fun () -> _AbcdMathFunction.Value.primitive(t.Value))
    let _value                                     (t : ICell<double>)   
                                                   = cell (fun () -> _AbcdMathFunction.Value.value(t.Value))
