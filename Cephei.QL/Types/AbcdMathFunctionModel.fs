...
*)
    let mutable
        _AbcdMathFunction                          = make (fun () -> new AbcdMathFunction (abcd.Value))
    let _a                                         = triv _AbcdMathFunction (fun () -> _AbcdMathFunction.Value.a())
    let _b                                         = triv _AbcdMathFunction (fun () -> _AbcdMathFunction.Value.b())
    let _c                                         = triv _AbcdMathFunction (fun () -> _AbcdMathFunction.Value.c())
    let _coefficients                              = triv _AbcdMathFunction (fun () -> _AbcdMathFunction.Value.coefficients())
    let _d                                         = triv _AbcdMathFunction (fun () -> _AbcdMathFunction.Value.d())
    let _definiteDerivativeCoefficients            (t : ICell<double>) (t2 : ICell<double>)   
                                                   = triv _AbcdMathFunction (fun () -> _AbcdMathFunction.Value.definiteDerivativeCoefficients(t.Value, t2.Value))
    let _definiteIntegral                          (t1 : ICell<double>) (t2 : ICell<double>)   
                                                   = triv _AbcdMathFunction (fun () -> _AbcdMathFunction.Value.definiteIntegral(t1.Value, t2.Value))
    let _definiteIntegralCoefficients              (t : ICell<double>) (t2 : ICell<double>)   
                                                   = triv _AbcdMathFunction (fun () -> _AbcdMathFunction.Value.definiteIntegralCoefficients(t.Value, t2.Value))
    let _derivative                                (t : ICell<double>)   
                                                   = triv _AbcdMathFunction (fun () -> _AbcdMathFunction.Value.derivative(t.Value))
    let _derivativeCoefficients                    = triv _AbcdMathFunction (fun () -> _AbcdMathFunction.Value.derivativeCoefficients())
    let _longTermValue                             = triv _AbcdMathFunction (fun () -> _AbcdMathFunction.Value.longTermValue())
    let _maximumLocation                           = triv _AbcdMathFunction (fun () -> _AbcdMathFunction.Value.maximumLocation())
    let _maximumValue                              = triv _AbcdMathFunction (fun () -> _AbcdMathFunction.Value.maximumValue())
    let _primitive                                 (t : ICell<double>)   
                                                   = triv _AbcdMathFunction (fun () -> _AbcdMathFunction.Value.primitive(t.Value))
    let _value                                     (t : ICell<double>)   
                                                   = triv _AbcdMathFunction (fun () -> _AbcdMathFunction.Value.value(t.Value))
...
*)
    let mutable
        _AbcdMathFunction                          = make (fun () -> new AbcdMathFunction (a.Value, b.Value, c.Value, d.Value))
    let _a                                         = triv _AbcdMathFunction (fun () -> _AbcdMathFunction.Value.a())
    let _b                                         = triv _AbcdMathFunction (fun () -> _AbcdMathFunction.Value.b())
    let _c                                         = triv _AbcdMathFunction (fun () -> _AbcdMathFunction.Value.c())
    let _coefficients                              = triv _AbcdMathFunction (fun () -> _AbcdMathFunction.Value.coefficients())
