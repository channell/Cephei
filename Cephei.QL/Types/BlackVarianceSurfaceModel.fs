...
*)
    ...
    let _dates                                     = cell (fun () -> _BlackVarianceSurface.Value.dates())
    let _dayCounter                                = cell (fun () -> _BlackVarianceSurface.Value.dayCounter())
    let _maxDate                                   = cell (fun () -> _BlackVarianceSurface.Value.maxDate())
    let _maxStrike                                 = cell (fun () -> _BlackVarianceSurface.Value.maxStrike())
    let _minStrike                                 = cell (fun () -> _BlackVarianceSurface.Value.minStrike())
    let _setInterpolation                          (i : ICell<'Interpolator>)   
                                                   = cell (fun () -> _BlackVarianceSurface.Value.setInterpolation(i.Value)
                                                                     _BlackVarianceSurface.Value)
    let _strikes                                   = cell (fun () -> _BlackVarianceSurface.Value.strikes())
    let _times                                     = cell (fun () -> _BlackVarianceSurface.Value.times())
    let _variances                                 = cell (fun () -> _BlackVarianceSurface.Value.variances())
    let _volatilities                              = cell (fun () -> _BlackVarianceSurface.Value.volatilities())
