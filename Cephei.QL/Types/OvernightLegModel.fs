...
*)
    let mutable
        _OvernightLeg                              = make (fun () -> (createEvaluationDate _evaluationDate (fun () ->new OvernightLeg (schedule.Value, overnightIndex.Value))))
    let _value                                     = triv _OvernightLeg (fun () -> (curryEvaluationDate _evaluationDate _OvernightLeg).Value.value())
    let _withGearings                              (gearings : ICell<Generic.List<double>>)   
                                                   = triv _OvernightLeg (fun () -> (curryEvaluationDate _evaluationDate _OvernightLeg).Value.withGearings(gearings.Value))
    let _withGearings1                             (gearing : ICell<double>)   
                                                   = triv _OvernightLeg (fun () -> (curryEvaluationDate _evaluationDate _OvernightLeg).Value.withGearings(gearing.Value))
    let _withNotionals                             (notionals : ICell<Generic.List<double>>)   
                                                   = triv _OvernightLeg (fun () -> (curryEvaluationDate _evaluationDate _OvernightLeg).Value.withNotionals(notionals.Value))
    let _withNotionals1                            (notional : ICell<double>)   
                                                   = triv _OvernightLeg (fun () -> (curryEvaluationDate _evaluationDate _OvernightLeg).Value.withNotionals(notional.Value))
    let _withPaymentAdjustment                     (convention : ICell<BusinessDayConvention>)   
                                                   = triv _OvernightLeg (fun () -> (curryEvaluationDate _evaluationDate _OvernightLeg).Value.withPaymentAdjustment(convention.Value))
    let _withPaymentDayCounter                     (dayCounter : ICell<DayCounter>)   
                                                   = triv _OvernightLeg (fun () -> (curryEvaluationDate _evaluationDate _OvernightLeg).Value.withPaymentDayCounter(dayCounter.Value))
    let _withSpreads                               (spread : ICell<double>)   
                                                   = triv _OvernightLeg (fun () -> (curryEvaluationDate _evaluationDate _OvernightLeg).Value.withSpreads(spread.Value))
    let _withSpreads1                              (spreads : ICell<Generic.List<double>>)   
                                                   = triv _OvernightLeg (fun () -> (curryEvaluationDate _evaluationDate _OvernightLeg).Value.withSpreads(spreads.Value))
