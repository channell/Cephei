...
(*
    Functions
*)
    let _BarrierOption                             = triv (fun () -> withEngine _pricingEngine.Value (new BarrierOption (barrierType.Value, barrier.Value, rebate.Value, payoff.Value, exercise.Value)))
