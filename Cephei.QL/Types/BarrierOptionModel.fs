...
(*
    Functions
*)
    let _BarrierOption                             = cell (fun () -> withEngine evaluationDate pricingEngine (new BarrierOption (barrierType.Value, barrier.Value, rebate.Value, payoff.Value, exercise.Value)))
