...
*)
    ...
    let _mandatoryTimes                            = cell (fun () -> _DiscretizedVanillaOption.Value.mandatoryTimes())
    let _reset                                     (size : ICell<int>)   
                                                   = cell (fun () -> _DiscretizedVanillaOption.Value.reset(size.Value)
                                                                     _DiscretizedVanillaOption.Value)
    let _adjustValues                              = cell (fun () -> _DiscretizedVanillaOption.Value.adjustValues()
                                                                     _DiscretizedVanillaOption.Value)
    let _initialize                                (Method : ICell<Lattice>) (t : ICell<double>)   
                                                   = cell (fun () -> _DiscretizedVanillaOption.Value.initialize(Method.Value, t.Value)
                                                                     _DiscretizedVanillaOption.Value)
    let _method                                    = cell (fun () -> _DiscretizedVanillaOption.Value.METHOD())
    let _partialRollback                           (To : ICell<double>)   
                                                   = cell (fun () -> _DiscretizedVanillaOption.Value.partialRollback(To.Value)
                                                                     _DiscretizedVanillaOption.Value)
    let _postAdjustValues                          = cell (fun () -> _DiscretizedVanillaOption.Value.postAdjustValues()
                                                                     _DiscretizedVanillaOption.Value)
    let _preAdjustValues                           = cell (fun () -> _DiscretizedVanillaOption.Value.preAdjustValues()
                                                                     _DiscretizedVanillaOption.Value)
    let _presentValue                              = cell (fun () -> _DiscretizedVanillaOption.Value.presentValue())
    let _rollback                                  (To : ICell<double>)   
                                                   = cell (fun () -> _DiscretizedVanillaOption.Value.rollback(To.Value)
                                                                     _DiscretizedVanillaOption.Value)
    let _setTime                                   (t : ICell<double>)   
                                                   = cell (fun () -> _DiscretizedVanillaOption.Value.setTime(t.Value)
                                                                     _DiscretizedVanillaOption.Value)
    let _setValues                                 (v : ICell<Vector>)   
                                                   = cell (fun () -> _DiscretizedVanillaOption.Value.setValues(v.Value)
                                                                     _DiscretizedVanillaOption.Value)
    let _time                                      = cell (fun () -> _DiscretizedVanillaOption.Value.time())
    let _values                                    = cell (fun () -> _DiscretizedVanillaOption.Value.values())
