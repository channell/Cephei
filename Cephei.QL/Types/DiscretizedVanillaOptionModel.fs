...
*)
    ...
    let _adjustValues                              = triv (fun () -> _DiscretizedVanillaOption.Value.adjustValues()
                                                                     _DiscretizedVanillaOption.Value)
    let _initialize                                (Method : ICell<Lattice>) (t : ICell<double>)   
                                                   = triv (fun () -> _DiscretizedVanillaOption.Value.initialize(Method.Value, t.Value)
                                                                     _DiscretizedVanillaOption.Value)
    let _method                                    = triv (fun () -> _DiscretizedVanillaOption.Value.METHOD())
    let _partialRollback                           (To : ICell<double>)   
                                                   = triv (fun () -> _DiscretizedVanillaOption.Value.partialRollback(To.Value)
                                                                     _DiscretizedVanillaOption.Value)
    let _postAdjustValues                          = triv (fun () -> _DiscretizedVanillaOption.Value.postAdjustValues()
                                                                     _DiscretizedVanillaOption.Value)
    let _preAdjustValues                           = triv (fun () -> _DiscretizedVanillaOption.Value.preAdjustValues()
                                                                     _DiscretizedVanillaOption.Value)
    let _presentValue                              = triv (fun () -> _DiscretizedVanillaOption.Value.presentValue())
    let _rollback                                  (To : ICell<double>)   
                                                   = triv (fun () -> _DiscretizedVanillaOption.Value.rollback(To.Value)
                                                                     _DiscretizedVanillaOption.Value)
    let _setTime                                   (t : ICell<double>)   
                                                   = triv (fun () -> _DiscretizedVanillaOption.Value.setTime(t.Value)
                                                                     _DiscretizedVanillaOption.Value)
    let _setValues                                 (v : ICell<Vector>)   
                                                   = triv (fun () -> _DiscretizedVanillaOption.Value.setValues(v.Value)
                                                                     _DiscretizedVanillaOption.Value)
