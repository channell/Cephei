...
*)
    ...
    let _add                                       (A : ICell<IOperator>) (B : ICell<IOperator>)   
                                                   = cell (fun () -> _DPlusDMinus.Value.add(A.Value, B.Value))
    let _applyTo                                   (v : ICell<Vector>)   
                                                   = cell (fun () -> _DPlusDMinus.Value.applyTo(v.Value))
    let _Clone                                     = cell (fun () -> _DPlusDMinus.Value.Clone())
    let _diagonal                                  = cell (fun () -> _DPlusDMinus.Value.diagonal())
    let _identity                                  (size : ICell<int>)   
                                                   = cell (fun () -> _DPlusDMinus.Value.identity(size.Value))
    let _isTimeDependent                           = cell (fun () -> _DPlusDMinus.Value.isTimeDependent())
    let _lowerDiagonal                             = cell (fun () -> _DPlusDMinus.Value.lowerDiagonal())
    let _multiply                                  (a : ICell<double>) (o : ICell<IOperator>)   
                                                   = cell (fun () -> _DPlusDMinus.Value.multiply(a.Value, o.Value))
    let _setFirstRow                               (valB : ICell<double>) (valC : ICell<double>)   
                                                   = cell (fun () -> _DPlusDMinus.Value.setFirstRow(valB.Value, valC.Value)
                                                                     _DPlusDMinus.Value)
    let _setLastRow                                (valA : ICell<double>) (valB : ICell<double>)   
                                                   = cell (fun () -> _DPlusDMinus.Value.setLastRow(valA.Value, valB.Value)
                                                                     _DPlusDMinus.Value)
    let _setMidRow                                 (i : ICell<int>) (valA : ICell<double>) (valB : ICell<double>) (valC : ICell<double>)   
                                                   = cell (fun () -> _DPlusDMinus.Value.setMidRow(i.Value, valA.Value, valB.Value, valC.Value)
                                                                     _DPlusDMinus.Value)
    let _setMidRows                                (valA : ICell<double>) (valB : ICell<double>) (valC : ICell<double>)   
                                                   = cell (fun () -> _DPlusDMinus.Value.setMidRows(valA.Value, valB.Value, valC.Value)
                                                                     _DPlusDMinus.Value)
    let _setTime                                   (t : ICell<double>)   
                                                   = cell (fun () -> _DPlusDMinus.Value.setTime(t.Value)
                                                                     _DPlusDMinus.Value)
    let _size                                      = cell (fun () -> _DPlusDMinus.Value.size())
    let _solveFor                                  (rhs : ICell<Vector>)   
                                                   = cell (fun () -> _DPlusDMinus.Value.solveFor(rhs.Value))
    let _SOR                                       (rhs : ICell<Vector>) (tol : ICell<double>)   
                                                   = cell (fun () -> _DPlusDMinus.Value.SOR(rhs.Value, tol.Value))
    let _subtract                                  (A : ICell<IOperator>) (B : ICell<IOperator>)   
                                                   = cell (fun () -> _DPlusDMinus.Value.subtract(A.Value, B.Value))
    let _upperDiagonal                             = cell (fun () -> _DPlusDMinus.Value.upperDiagonal())
