...
*)
    let mutable
        _DPlusDMinus                               = make (fun () -> new DPlusDMinus (gridPoints.Value, h.Value))
    let _add                                       (A : ICell<IOperator>) (B : ICell<IOperator>)   
                                                   = triv _DPlusDMinus (fun () -> _DPlusDMinus.Value.add(A.Value, B.Value))
    let _applyTo                                   (v : ICell<Vector>)   
                                                   = triv _DPlusDMinus (fun () -> _DPlusDMinus.Value.applyTo(v.Value))
    let _Clone                                     = triv _DPlusDMinus (fun () -> _DPlusDMinus.Value.Clone())
    let _diagonal                                  = triv _DPlusDMinus (fun () -> _DPlusDMinus.Value.diagonal())
    let _identity                                  (size : ICell<int>)   
                                                   = triv _DPlusDMinus (fun () -> _DPlusDMinus.Value.identity(size.Value))
    let _isTimeDependent                           = triv _DPlusDMinus (fun () -> _DPlusDMinus.Value.isTimeDependent())
    let _lowerDiagonal                             = triv _DPlusDMinus (fun () -> _DPlusDMinus.Value.lowerDiagonal())
    let _multiply                                  (a : ICell<double>) (o : ICell<IOperator>)   
                                                   = triv _DPlusDMinus (fun () -> _DPlusDMinus.Value.multiply(a.Value, o.Value))
    let _setFirstRow                               (valB : ICell<double>) (valC : ICell<double>)   
                                                   = triv _DPlusDMinus (fun () -> _DPlusDMinus.Value.setFirstRow(valB.Value, valC.Value)
                                                                                  _DPlusDMinus.Value)
    let _setLastRow                                (valA : ICell<double>) (valB : ICell<double>)   
                                                   = triv _DPlusDMinus (fun () -> _DPlusDMinus.Value.setLastRow(valA.Value, valB.Value)
                                                                                  _DPlusDMinus.Value)
    let _setMidRow                                 (i : ICell<int>) (valA : ICell<double>) (valB : ICell<double>) (valC : ICell<double>)   
                                                   = triv _DPlusDMinus (fun () -> _DPlusDMinus.Value.setMidRow(i.Value, valA.Value, valB.Value, valC.Value)
                                                                                  _DPlusDMinus.Value)
    let _setMidRows                                (valA : ICell<double>) (valB : ICell<double>) (valC : ICell<double>)   
                                                   = triv _DPlusDMinus (fun () -> _DPlusDMinus.Value.setMidRows(valA.Value, valB.Value, valC.Value)
                                                                                  _DPlusDMinus.Value)
    let _setTime                                   (t : ICell<double>)   
                                                   = triv _DPlusDMinus (fun () -> _DPlusDMinus.Value.setTime(t.Value)
                                                                                  _DPlusDMinus.Value)
    let _size                                      = triv _DPlusDMinus (fun () -> _DPlusDMinus.Value.size())
    let _solveFor                                  (rhs : ICell<Vector>)   
                                                   = triv _DPlusDMinus (fun () -> _DPlusDMinus.Value.solveFor(rhs.Value))
    let _SOR                                       (rhs : ICell<Vector>) (tol : ICell<double>)   
                                                   = triv _DPlusDMinus (fun () -> _DPlusDMinus.Value.SOR(rhs.Value, tol.Value))
    let _subtract                                  (A : ICell<IOperator>) (B : ICell<IOperator>)   
                                                   = triv _DPlusDMinus (fun () -> _DPlusDMinus.Value.subtract(A.Value, B.Value))
    let _upperDiagonal                             = triv _DPlusDMinus (fun () -> _DPlusDMinus.Value.upperDiagonal())
    do this.Bind(_DPlusDMinus)
(* 
    casting 
*)
    internal new () = new DPlusDMinusModel(null,null)
    member internal this.Inject v = _DPlusDMinus <- v
