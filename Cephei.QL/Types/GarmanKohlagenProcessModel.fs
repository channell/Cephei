...
*)
    let mutable
        _GarmanKohlagenProcess                     = make (fun () -> new GarmanKohlagenProcess (x0.Value, foreignRiskFreeTS.Value, domesticRiskFreeTS.Value, blackVolTS.Value, localVolTS.Value, d.Value))
    let _apply                                     (x0 : ICell<double>) (dx : ICell<double>)   
                                                   = triv _GarmanKohlagenProcess (fun () -> _GarmanKohlagenProcess.Value.apply(x0.Value, dx.Value))
    let _blackVolatility                           = triv _GarmanKohlagenProcess (fun () -> _GarmanKohlagenProcess.Value.blackVolatility())
    let _diffusion                                 (t : ICell<double>) (x : ICell<double>)   
                                                   = triv _GarmanKohlagenProcess (fun () -> _GarmanKohlagenProcess.Value.diffusion(t.Value, x.Value))
    let _dividendYield                             = triv _GarmanKohlagenProcess (fun () -> _GarmanKohlagenProcess.Value.dividendYield())
    let _drift                                     (t : ICell<double>) (x : ICell<double>)   
                                                   = triv _GarmanKohlagenProcess (fun () -> _GarmanKohlagenProcess.Value.drift(t.Value, x.Value))
    let _evolve                                    (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>) (dw : ICell<double>)   
                                                   = triv _GarmanKohlagenProcess (fun () -> _GarmanKohlagenProcess.Value.evolve(t0.Value, x0.Value, dt.Value, dw.Value))
    let _expectation                               (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = triv _GarmanKohlagenProcess (fun () -> _GarmanKohlagenProcess.Value.expectation(t0.Value, x0.Value, dt.Value))
    let _localVolatility                           = triv _GarmanKohlagenProcess (fun () -> _GarmanKohlagenProcess.Value.localVolatility())
    let _riskFreeRate                              = triv _GarmanKohlagenProcess (fun () -> _GarmanKohlagenProcess.Value.riskFreeRate())
    let _stateVariable                             = triv _GarmanKohlagenProcess (fun () -> _GarmanKohlagenProcess.Value.stateVariable())
    let _stdDeviation                              (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = triv _GarmanKohlagenProcess (fun () -> _GarmanKohlagenProcess.Value.stdDeviation(t0.Value, x0.Value, dt.Value))
    let _time                                      (d : ICell<Date>)   
                                                   = triv _GarmanKohlagenProcess (fun () -> _GarmanKohlagenProcess.Value.time(d.Value))
    let _update                                    = triv _GarmanKohlagenProcess (fun () -> _GarmanKohlagenProcess.Value.update()
                                                                                            _GarmanKohlagenProcess.Value)
    let _variance                                  (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = triv _GarmanKohlagenProcess (fun () -> _GarmanKohlagenProcess.Value.variance(t0.Value, x0.Value, dt.Value))
    let _x0                                        = triv _GarmanKohlagenProcess (fun () -> _GarmanKohlagenProcess.Value.x0())
    let _initialValues                             = triv _GarmanKohlagenProcess (fun () -> _GarmanKohlagenProcess.Value.initialValues())
    let _size                                      = triv _GarmanKohlagenProcess (fun () -> _GarmanKohlagenProcess.Value.size())
    let _covariance                                (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>)   
                                                   = triv _GarmanKohlagenProcess (fun () -> _GarmanKohlagenProcess.Value.covariance(t0.Value, x0.Value, dt.Value))
    let _factors                                   = triv _GarmanKohlagenProcess (fun () -> _GarmanKohlagenProcess.Value.factors())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv _GarmanKohlagenProcess (fun () -> _GarmanKohlagenProcess.Value.registerWith(handler.Value)
                                                                                            _GarmanKohlagenProcess.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = triv _GarmanKohlagenProcess (fun () -> _GarmanKohlagenProcess.Value.unregisterWith(handler.Value)
                                                                                            _GarmanKohlagenProcess.Value)
...
*)
    let mutable
        _GarmanKohlagenProcess                     = make (fun () -> new GarmanKohlagenProcess (x0.Value, foreignRiskFreeTS.Value, domesticRiskFreeTS.Value, blackVolTS.Value, d.Value))
    let _apply                                     (x0 : ICell<double>) (dx : ICell<double>)   
                                                   = triv _GarmanKohlagenProcess (fun () -> _GarmanKohlagenProcess.Value.apply(x0.Value, dx.Value))
    let _blackVolatility                           = triv _GarmanKohlagenProcess (fun () -> _GarmanKohlagenProcess.Value.blackVolatility())
    let _diffusion                                 (t : ICell<double>) (x : ICell<double>)   
...
*)
    let mutable
        _GarmanKohlagenProcess                     = make (fun () -> new GarmanKohlagenProcess (x0.Value, foreignRiskFreeTS.Value, domesticRiskFreeTS.Value, blackVolTS.Value))
    let _apply                                     (x0 : ICell<double>) (dx : ICell<double>)   
                                                   = triv _GarmanKohlagenProcess (fun () -> _GarmanKohlagenProcess.Value.apply(x0.Value, dx.Value))
    let _blackVolatility                           = triv _GarmanKohlagenProcess (fun () -> _GarmanKohlagenProcess.Value.blackVolatility())
    let _diffusion                                 (t : ICell<double>) (x : ICell<double>)   
