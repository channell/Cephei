...
*)
    ...
    let _apply                                     (x0 : ICell<double>) (dx : ICell<double>)   
                                                   = cell (fun () -> _GarmanKohlagenProcess.Value.apply(x0.Value, dx.Value))
    let _blackVolatility                           = cell (fun () -> _GarmanKohlagenProcess.Value.blackVolatility())
    let _diffusion                                 (t : ICell<double>) (x : ICell<double>)   
                                                   = cell (fun () -> _GarmanKohlagenProcess.Value.diffusion(t.Value, x.Value))
    let _dividendYield                             = cell (fun () -> _GarmanKohlagenProcess.Value.dividendYield())
    let _drift                                     (t : ICell<double>) (x : ICell<double>)   
                                                   = cell (fun () -> _GarmanKohlagenProcess.Value.drift(t.Value, x.Value))
    let _evolve                                    (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>) (dw : ICell<double>)   
                                                   = cell (fun () -> _GarmanKohlagenProcess.Value.evolve(t0.Value, x0.Value, dt.Value, dw.Value))
    let _expectation                               (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = cell (fun () -> _GarmanKohlagenProcess.Value.expectation(t0.Value, x0.Value, dt.Value))
    let _localVolatility                           = cell (fun () -> _GarmanKohlagenProcess.Value.localVolatility())
    let _riskFreeRate                              = cell (fun () -> _GarmanKohlagenProcess.Value.riskFreeRate())
    let _stateVariable                             = cell (fun () -> _GarmanKohlagenProcess.Value.stateVariable())
    let _stdDeviation                              (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = cell (fun () -> _GarmanKohlagenProcess.Value.stdDeviation(t0.Value, x0.Value, dt.Value))
    let _time                                      (d : ICell<Date>)   
                                                   = cell (fun () -> _GarmanKohlagenProcess.Value.time(d.Value))
    let _update                                    = cell (fun () -> _GarmanKohlagenProcess.Value.update()
                                                                     _GarmanKohlagenProcess.Value)
    let _variance                                  (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = cell (fun () -> _GarmanKohlagenProcess.Value.variance(t0.Value, x0.Value, dt.Value))
    let _x0                                        = cell (fun () -> _GarmanKohlagenProcess.Value.x0())
    let _initialValues                             = cell (fun () -> _GarmanKohlagenProcess.Value.initialValues())
    let _size                                      = cell (fun () -> _GarmanKohlagenProcess.Value.size())
    let _covariance                                (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>)   
                                                   = cell (fun () -> _GarmanKohlagenProcess.Value.covariance(t0.Value, x0.Value, dt.Value))
    let _factors                                   = cell (fun () -> _GarmanKohlagenProcess.Value.factors())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _GarmanKohlagenProcess.Value.registerWith(handler.Value)
                                                                     _GarmanKohlagenProcess.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _GarmanKohlagenProcess.Value.unregisterWith(handler.Value)
                                                                     _GarmanKohlagenProcess.Value)
