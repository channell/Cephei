...
(*
    Functions
*)
    let _ContinuousPartialFloatingLookbackOption   = triv (fun () -> withEngine _pricingEngine.Value (new ContinuousPartialFloatingLookbackOption (minmax.Value, lambda.Value, lookbackPeriodEnd.Value, payoff.Value, exercise.Value)))
