...
*)
    let mutable
        _MCBarrierEngine                           = make (fun () -> (createEvaluationDate _evaluationDate (fun () ->new MCBarrierEngine<'RNG,'S> (Process.Value, timeSteps.Value, timeStepsPerYear.Value, brownianBridge.Value, antitheticVariate.Value, requiredSamples.Value, requiredTolerance.Value, maxSamples.Value, isBiased.Value, seed.Value))))
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv _MCBarrierEngine (fun () -> (curryEvaluationDate _evaluationDate _MCBarrierEngine).Value.registerWith(handler.Value)
                                                                                      _MCBarrierEngine.Value)
    let _reset                                     = triv _MCBarrierEngine (fun () -> (curryEvaluationDate _evaluationDate _MCBarrierEngine).Value.reset()
                                                                                      _MCBarrierEngine.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = triv _MCBarrierEngine (fun () -> (curryEvaluationDate _evaluationDate _MCBarrierEngine).Value.unregisterWith(handler.Value)
                                                                                      _MCBarrierEngine.Value)
    let _update                                    = triv _MCBarrierEngine (fun () -> (curryEvaluationDate _evaluationDate _MCBarrierEngine).Value.update()
                                                                                      _MCBarrierEngine.Value)
    let _errorEstimate                             = triv _MCBarrierEngine (fun () -> (curryEvaluationDate _evaluationDate _MCBarrierEngine).Value.errorEstimate())
    let _sampleAccumulator                         = triv _MCBarrierEngine (fun () -> (curryEvaluationDate _evaluationDate _MCBarrierEngine).Value.sampleAccumulator())
    let _value                                     (tolerance : ICell<double>) (maxSamples : ICell<int>) (minSamples : ICell<int>)   
                                                   = triv _MCBarrierEngine (fun () -> (curryEvaluationDate _evaluationDate _MCBarrierEngine).Value.value(tolerance.Value, maxSamples.Value, minSamples.Value))
    let _valueWithSamples                          (samples : ICell<int>)   
                                                   = triv _MCBarrierEngine (fun () -> (curryEvaluationDate _evaluationDate _MCBarrierEngine).Value.valueWithSamples(samples.Value))
