...
*)
    ...
    let _a                                         = cell (fun () -> _SviInterpolatedSmileSection.Value.a())
    let _atmLevel                                  = cell (fun () -> _SviInterpolatedSmileSection.Value.atmLevel())
    let _b                                         = cell (fun () -> _SviInterpolatedSmileSection.Value.b())
    let _endCriteria                               = cell (fun () -> _SviInterpolatedSmileSection.Value.endCriteria())
    let _m                                         = cell (fun () -> _SviInterpolatedSmileSection.Value.m())
    let _maxError                                  = cell (fun () -> _SviInterpolatedSmileSection.Value.maxError())
    let _maxStrike                                 = cell (fun () -> _SviInterpolatedSmileSection.Value.maxStrike())
    let _minStrike                                 = cell (fun () -> _SviInterpolatedSmileSection.Value.minStrike())
    let _rho                                       = cell (fun () -> _SviInterpolatedSmileSection.Value.rho())
    let _rmsError                                  = cell (fun () -> _SviInterpolatedSmileSection.Value.rmsError())
    let _sigma                                     = cell (fun () -> _SviInterpolatedSmileSection.Value.sigma())
    let _update                                    = cell (fun () -> _SviInterpolatedSmileSection.Value.update()
                                                                     _SviInterpolatedSmileSection.Value)
    let _dayCounter                                = cell (fun () -> _SviInterpolatedSmileSection.Value.dayCounter())
    let _density                                   (strike : ICell<double>) (discount : ICell<double>) (gap : ICell<double>)   
                                                   = cell (fun () -> _SviInterpolatedSmileSection.Value.density(strike.Value, discount.Value, gap.Value))
    let _digitalOptionPrice                        (strike : ICell<double>) (Type : ICell<Option.Type>) (discount : ICell<double>) (gap : ICell<double>)   
                                                   = cell (fun () -> _SviInterpolatedSmileSection.Value.digitalOptionPrice(strike.Value, Type.Value, discount.Value, gap.Value))
    let _exerciseDate                              = cell (fun () -> _SviInterpolatedSmileSection.Value.exerciseDate())
    let _exerciseTime                              = cell (fun () -> _SviInterpolatedSmileSection.Value.exerciseTime())
    let _optionPrice                               (strike : ICell<double>) (Type : ICell<Option.Type>) (discount : ICell<double>)   
                                                   = cell (fun () -> _SviInterpolatedSmileSection.Value.optionPrice(strike.Value, Type.Value, discount.Value))
    let _referenceDate                             = cell (fun () -> _SviInterpolatedSmileSection.Value.referenceDate())
    let _shift                                     = cell (fun () -> _SviInterpolatedSmileSection.Value.shift())
    let _variance                                  (strike : ICell<double>)   
                                                   = cell (fun () -> _SviInterpolatedSmileSection.Value.variance(strike.Value))
    let _vega                                      (strike : ICell<double>) (discount : ICell<double>)   
                                                   = cell (fun () -> _SviInterpolatedSmileSection.Value.vega(strike.Value, discount.Value))
    let _volatility                                (strike : ICell<double>) (volatilityType : ICell<VolatilityType>) (shift : ICell<double>)   
                                                   = cell (fun () -> _SviInterpolatedSmileSection.Value.volatility(strike.Value, volatilityType.Value, shift.Value))
    let _volatility1                               (strike : ICell<double>)   
                                                   = cell (fun () -> _SviInterpolatedSmileSection.Value.volatility(strike.Value))
    let _volatilityType                            = cell (fun () -> _SviInterpolatedSmileSection.Value.volatilityType())
