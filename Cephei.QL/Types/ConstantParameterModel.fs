...
*)
    ...
    let _constraint                                = cell (fun () -> _ConstantParameter.Value.CONSTRAINT())
    let _implementation                            = cell (fun () -> _ConstantParameter.Value.implementation())
    let _parameters                                = cell (fun () -> _ConstantParameter.Value.parameters())
    let _setParam                                  (i : ICell<int>) (x : ICell<double>)   
                                                   = cell (fun () -> _ConstantParameter.Value.setParam(i.Value, x.Value)
                                                                     _ConstantParameter.Value)
    let _size                                      = cell (fun () -> _ConstantParameter.Value.size())
    let _testParams                                (p : ICell<Vector>)   
                                                   = cell (fun () -> _ConstantParameter.Value.testParams(p.Value))
    let _value                                     (t : ICell<double>)   
                                                   = cell (fun () -> _ConstantParameter.Value.value(t.Value))
