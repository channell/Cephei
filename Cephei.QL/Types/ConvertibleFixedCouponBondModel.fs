...
*)
    ...
    let _callability                               = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).callability())
    let _conversionRatio                           = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).conversionRatio())
    let _creditSpread                              = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).creditSpread())
    let _dividends                                 = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).dividends())
    let _accruedAmount                             (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).accruedAmount(settlement.Value))
    let _calendar                                  = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).calendar())
    let _cashflows                                 = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).cashflows())
    ...
    let _dirtyPrice1                               (Yield : ICell<double>) (dc : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).dirtyPrice(Yield.Value, dc.Value, comp.Value, freq.Value, settlement.Value))
    let _isExpired                                 = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).isExpired())
    let _issueDate                                 = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).issueDate())
    let _isTradable                                (d : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).isTradable(d.Value))
    let _maturityDate                              = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).maturityDate())
    let _nextCashFlowDate                          (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).nextCashFlowDate(settlement.Value))
    let _nextCouponRate                            (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).nextCouponRate(settlement.Value))
    let _notional                                  (d : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).notional(d.Value))
    let _notionals                                 = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).notionals())
    let _previousCashFlowDate                      (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).previousCashFlowDate(settlement.Value))
    let _previousCouponRate                        (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).previousCouponRate(settlement.Value))
    let _redemption                                = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).redemption())
    let _redemptions                               = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).redemptions())
    let _settlementDate                            (date : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).settlementDate(date.Value))
    let _settlementDays                            = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).settlementDays())
    let _settlementValue                           (cleanPrice : ICell<double>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).settlementValue(cleanPrice.Value))
    let _settlementValue1                          = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).settlementValue())
    let _startDate                                 = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).startDate())
    ...
    let _errorEstimate                             = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).errorEstimate())
    let _NPV                                       = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).setPricingEngine(e.Value)
                                                                     _ConvertibleFixedCouponBond.Value)
    let _valuationDate                             = cell (fun () -> (withEvaluationDate _evaluationDate _ConvertibleFixedCouponBond).valuationDate())
