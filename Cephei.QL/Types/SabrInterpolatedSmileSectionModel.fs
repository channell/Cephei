...
*)
    ...
    let _alpha                                     = cell (fun () -> _SabrInterpolatedSmileSection.Value.alpha())
    let _atmLevel                                  = cell (fun () -> _SabrInterpolatedSmileSection.Value.atmLevel())
    let _beta                                      = cell (fun () -> _SabrInterpolatedSmileSection.Value.beta())
    let _endCriteria                               = cell (fun () -> _SabrInterpolatedSmileSection.Value.endCriteria())
    let _maxError                                  = cell (fun () -> _SabrInterpolatedSmileSection.Value.maxError())
    let _maxStrike                                 = cell (fun () -> _SabrInterpolatedSmileSection.Value.maxStrike())
    let _minStrike                                 = cell (fun () -> _SabrInterpolatedSmileSection.Value.minStrike())
    let _nu                                        = cell (fun () -> _SabrInterpolatedSmileSection.Value.nu())
    let _rho                                       = cell (fun () -> _SabrInterpolatedSmileSection.Value.rho())
    let _rmsError                                  = cell (fun () -> _SabrInterpolatedSmileSection.Value.rmsError())
    let _update                                    = cell (fun () -> _SabrInterpolatedSmileSection.Value.update()
                                                                     _SabrInterpolatedSmileSection.Value)
    let _dayCounter                                = cell (fun () -> _SabrInterpolatedSmileSection.Value.dayCounter())
    let _density                                   (strike : ICell<double>) (discount : ICell<double>) (gap : ICell<double>)   
                                                   = cell (fun () -> _SabrInterpolatedSmileSection.Value.density(strike.Value, discount.Value, gap.Value))
    let _digitalOptionPrice                        (strike : ICell<double>) (Type : ICell<Option.Type>) (discount : ICell<double>) (gap : ICell<double>)   
                                                   = cell (fun () -> _SabrInterpolatedSmileSection.Value.digitalOptionPrice(strike.Value, Type.Value, discount.Value, gap.Value))
    let _exerciseDate                              = cell (fun () -> _SabrInterpolatedSmileSection.Value.exerciseDate())
    let _exerciseTime                              = cell (fun () -> _SabrInterpolatedSmileSection.Value.exerciseTime())
    let _optionPrice                               (strike : ICell<double>) (Type : ICell<Option.Type>) (discount : ICell<double>)   
                                                   = cell (fun () -> _SabrInterpolatedSmileSection.Value.optionPrice(strike.Value, Type.Value, discount.Value))
    let _referenceDate                             = cell (fun () -> _SabrInterpolatedSmileSection.Value.referenceDate())
    let _shift                                     = cell (fun () -> _SabrInterpolatedSmileSection.Value.shift())
    let _variance                                  (strike : ICell<double>)   
                                                   = cell (fun () -> _SabrInterpolatedSmileSection.Value.variance(strike.Value))
    let _vega                                      (strike : ICell<double>) (discount : ICell<double>)   
                                                   = cell (fun () -> _SabrInterpolatedSmileSection.Value.vega(strike.Value, discount.Value))
    let _volatility                                (strike : ICell<double>) (volatilityType : ICell<VolatilityType>) (shift : ICell<double>)   
                                                   = cell (fun () -> _SabrInterpolatedSmileSection.Value.volatility(strike.Value, volatilityType.Value, shift.Value))
    let _volatility1                               (strike : ICell<double>)   
                                                   = cell (fun () -> _SabrInterpolatedSmileSection.Value.volatility(strike.Value))
    let _volatilityType                            = cell (fun () -> _SabrInterpolatedSmileSection.Value.volatilityType())
