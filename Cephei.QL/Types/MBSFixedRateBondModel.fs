...
(*
    Functions
*)
    let _MBSFixedRateBond                          = cell (fun () -> withEngine _pricingEngine.Value (new MBSFixedRateBond (settlementDays.Value, calendar.Value, faceAmount.Value, startDate.Value, bondTenor.Value, originalLength.Value, sinkingFrequency.Value, WACRate.Value, PassThroughRate.Value, accrualDayCounter.Value, prepayModel.Value, paymentConvention.Value, issueDate.Value)))
    let _BondEquivalentYield                       = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).BondEquivalentYield())
    let _BondFactors                               = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).BondFactors())
    let _expectedCashflows                         = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).expectedCashflows())
    let _MonthlyYield                              = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).MonthlyYield())
    let _SMM                                       (d : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).SMM(d.Value))
    let _dayCounter                                = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).dayCounter())
    let _frequency                                 = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).frequency())
    let _accruedAmount                             (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).accruedAmount(settlement.Value))
    let _calendar                                  = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).calendar())
    let _cashflows                                 = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).cashflows())
    ...
    let _dirtyPrice1                               (Yield : ICell<double>) (dc : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).dirtyPrice(Yield.Value, dc.Value, comp.Value, freq.Value, settlement.Value))
    let _isExpired                                 = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).isExpired())
    let _issueDate                                 = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).issueDate())
    let _isTradable                                (d : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).isTradable(d.Value))
    let _maturityDate                              = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).maturityDate())
    let _nextCashFlowDate                          (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).nextCashFlowDate(settlement.Value))
    let _nextCouponRate                            (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).nextCouponRate(settlement.Value))
    let _notional                                  (d : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).notional(d.Value))
    let _notionals                                 = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).notionals())
    let _previousCashFlowDate                      (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).previousCashFlowDate(settlement.Value))
    let _previousCouponRate                        (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).previousCouponRate(settlement.Value))
    let _redemption                                = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).redemption())
    let _redemptions                               = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).redemptions())
    let _settlementDate                            (date : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).settlementDate(date.Value))
    let _settlementDays                            = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).settlementDays())
    let _settlementValue                           (cleanPrice : ICell<double>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).settlementValue(cleanPrice.Value))
    let _settlementValue1                          = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).settlementValue())
    let _startDate                                 = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).startDate())
    ...
    let _yield1                                    (cleanPrice : ICell<double>) (dc : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (settlement : ICell<Date>) (accuracy : ICell<double>) (maxEvaluations : ICell<int>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).YIELD(cleanPrice.Value, dc.Value, comp.Value, freq.Value, settlement.Value, accuracy.Value, maxEvaluations.Value))
    let _CASH                                      = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).CASH())
    let _errorEstimate                             = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).errorEstimate())
    let _NPV                                       = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).setPricingEngine(e.Value)
                                                                     _MBSFixedRateBond.Value)
    let _valuationDate                             = cell (fun () -> (withEvaluationDate _evaluationDate _MBSFixedRateBond).valuationDate())
