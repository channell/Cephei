...
*)
    ...
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _LinearInterpolation.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _LinearInterpolation.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = triv (fun () -> _LinearInterpolation.Value.update()
                                                                     _LinearInterpolation.Value)
    let _value                                     (x : ICell<double>)   
                                                   = triv (fun () -> _LinearInterpolation.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _LinearInterpolation.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = triv (fun () -> _LinearInterpolation.Value.xMax())
    let _xMin                                      = triv (fun () -> _LinearInterpolation.Value.xMin())
    let _allowsExtrapolation                       = triv (fun () -> _LinearInterpolation.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv (fun () -> _LinearInterpolation.Value.disableExtrapolation(b.Value)
                                                                     _LinearInterpolation.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv (fun () -> _LinearInterpolation.Value.enableExtrapolation(b.Value)
                                                                     _LinearInterpolation.Value)
    let _extrapolate                               = triv (fun () -> _LinearInterpolation.Value.extrapolate)
