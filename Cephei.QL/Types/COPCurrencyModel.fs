...
*)
    ...
    let _Equals                                    (o : ICell<Object>)   
                                                   = triv (fun () -> _COPCurrency.Value.Equals(o.Value))
    let _format                                    = triv (fun () -> _COPCurrency.Value.format)
    let _fractionsPerUnit                          = triv (fun () -> _COPCurrency.Value.fractionsPerUnit)
    let _fractionSymbol                            = triv (fun () -> _COPCurrency.Value.fractionSymbol)
    let _name                                      = triv (fun () -> _COPCurrency.Value.name)
    let _numericCode                               = triv (fun () -> _COPCurrency.Value.numericCode)
    let _rounding                                  = triv (fun () -> _COPCurrency.Value.rounding)
    let _symbol                                    = triv (fun () -> _COPCurrency.Value.symbol)
    let _ToString                                  = triv (fun () -> _COPCurrency.Value.ToString())
    let _triangulationCurrency                     = triv (fun () -> _COPCurrency.Value.triangulationCurrency)
