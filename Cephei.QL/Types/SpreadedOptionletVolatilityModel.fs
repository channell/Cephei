...
*)
    ...
    let _businessDayConvention                     = cell (fun () -> _SpreadedOptionletVolatility.Value.businessDayConvention())
    let _calendar                                  = cell (fun () -> _SpreadedOptionletVolatility.Value.calendar())
    let _dayCounter                                = cell (fun () -> _SpreadedOptionletVolatility.Value.dayCounter())
    let _maxDate                                   = cell (fun () -> _SpreadedOptionletVolatility.Value.maxDate())
    let _maxStrike                                 = cell (fun () -> _SpreadedOptionletVolatility.Value.maxStrike())
    let _maxTime                                   = cell (fun () -> _SpreadedOptionletVolatility.Value.maxTime())
    let _minStrike                                 = cell (fun () -> _SpreadedOptionletVolatility.Value.minStrike())
    let _referenceDate                             = cell (fun () -> _SpreadedOptionletVolatility.Value.referenceDate())
    let _settlementDays                            = cell (fun () -> _SpreadedOptionletVolatility.Value.settlementDays())
    let _blackVariance                             (optionTime : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _SpreadedOptionletVolatility.Value.blackVariance(optionTime.Value, strike.Value, extrapolate.Value))
    let _blackVariance1                            (optionDate : ICell<Date>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _SpreadedOptionletVolatility.Value.blackVariance(optionDate.Value, strike.Value, extrapolate.Value))
    let _blackVariance2                            (optionTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _SpreadedOptionletVolatility.Value.blackVariance(optionTenor.Value, strike.Value, extrapolate.Value))
    let _displacement                              = cell (fun () -> _SpreadedOptionletVolatility.Value.displacement())
    let _smileSection                              (optionTime : ICell<double>) (extr : ICell<bool>)   
                                                   = cell (fun () -> _SpreadedOptionletVolatility.Value.smileSection(optionTime.Value, extr.Value))
    let _smileSection1                             (optionTenor : ICell<Period>) (extr : ICell<bool>)   
                                                   = cell (fun () -> _SpreadedOptionletVolatility.Value.smileSection(optionTenor.Value, extr.Value))
    let _smileSection2                             (optionDate : ICell<Date>) (extr : ICell<bool>)   
                                                   = cell (fun () -> _SpreadedOptionletVolatility.Value.smileSection(optionDate.Value, extr.Value))
    let _volatility                                (optionTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _SpreadedOptionletVolatility.Value.volatility(optionTenor.Value, strike.Value, extrapolate.Value))
    let _volatility1                               (optionDate : ICell<Date>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _SpreadedOptionletVolatility.Value.volatility(optionDate.Value, strike.Value, extrapolate.Value))
    let _volatility2                               (optionTime : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _SpreadedOptionletVolatility.Value.volatility(optionTime.Value, strike.Value, extrapolate.Value))
    let _volatilityType                            = cell (fun () -> _SpreadedOptionletVolatility.Value.volatilityType())
    let _optionDateFromTenor                       (p : ICell<Period>)   
                                                   = cell (fun () -> _SpreadedOptionletVolatility.Value.optionDateFromTenor(p.Value))
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = cell (fun () -> _SpreadedOptionletVolatility.Value.timeFromReference(date.Value))
    let _update                                    = cell (fun () -> _SpreadedOptionletVolatility.Value.update()
                                                                     _SpreadedOptionletVolatility.Value)
    let _allowsExtrapolation                       = cell (fun () -> _SpreadedOptionletVolatility.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _SpreadedOptionletVolatility.Value.disableExtrapolation(b.Value)
                                                                     _SpreadedOptionletVolatility.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _SpreadedOptionletVolatility.Value.enableExtrapolation(b.Value)
                                                                     _SpreadedOptionletVolatility.Value)
    let _extrapolate                               = cell (fun () -> _SpreadedOptionletVolatility.Value.extrapolate)
