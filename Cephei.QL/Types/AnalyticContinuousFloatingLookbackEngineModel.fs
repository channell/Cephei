...
*)
    let mutable
        _AnalyticContinuousFloatingLookbackEngine  = make (fun () -> (createEvaluationDate _evaluationDate (fun () ->new AnalyticContinuousFloatingLookbackEngine (Process.Value))))
