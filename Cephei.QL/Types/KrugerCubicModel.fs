...
*)
    ...
    let _aCoefficients                             = cell (fun () -> _KrugerCubic.Value.aCoefficients())
    let _bCoefficients                             = cell (fun () -> _KrugerCubic.Value.bCoefficients())
    let _cCoefficients                             = cell (fun () -> _KrugerCubic.Value.cCoefficients())
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _KrugerCubic.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = cell (fun () -> _KrugerCubic.Value.empty())
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _KrugerCubic.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _KrugerCubic.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = cell (fun () -> _KrugerCubic.Value.update()
                                                                     _KrugerCubic.Value)
    let _value                                     (x : ICell<double>)   
                                                   = cell (fun () -> _KrugerCubic.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _KrugerCubic.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = cell (fun () -> _KrugerCubic.Value.xMax())
    let _xMin                                      = cell (fun () -> _KrugerCubic.Value.xMin())
    let _allowsExtrapolation                       = cell (fun () -> _KrugerCubic.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _KrugerCubic.Value.disableExtrapolation(b.Value)
                                                                     _KrugerCubic.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _KrugerCubic.Value.enableExtrapolation(b.Value)
                                                                     _KrugerCubic.Value)
    let _extrapolate                               = cell (fun () -> _KrugerCubic.Value.extrapolate)
