...
*)
    ...
    let _dates                                     = triv (fun () -> _InterpolatedHazardRateCurve.Value.dates())
    let _dates_                                    = triv (fun () -> _InterpolatedHazardRateCurve.Value.dates_)
    let _discounts                                 = triv (fun () -> _InterpolatedHazardRateCurve.Value.discounts())
    let _hazardRates                               = triv (fun () -> _InterpolatedHazardRateCurve.Value.hazardRates())
    let _interpolation_                            = triv (fun () -> _InterpolatedHazardRateCurve.Value.interpolation_)
    let _interpolator_                             = triv (fun () -> _InterpolatedHazardRateCurve.Value.interpolator_)
    let _maxDate                                   = triv (fun () -> _InterpolatedHazardRateCurve.Value.maxDate())
    let _maxDate_                                  = triv (fun () -> _InterpolatedHazardRateCurve.Value.maxDate_)
    let _nodes                                     = triv (fun () -> _InterpolatedHazardRateCurve.Value.nodes())
    let _setupInterpolation                        = triv (fun () -> _InterpolatedHazardRateCurve.Value.setupInterpolation()
                                                                     _InterpolatedHazardRateCurve.Value)
    let _times                                     = triv (fun () -> _InterpolatedHazardRateCurve.Value.times())
    let _times_                                    = triv (fun () -> _InterpolatedHazardRateCurve.Value.times_)
