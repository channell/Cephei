...
*)
    let mutable
        _CreditDefaultSwap                         = make (fun () -> withEngine pricingEngine evaluationDate (new CreditDefaultSwap (side.Value, notional.Value, spread.Value, schedule.Value, convention.Value, dayCounter.Value, settlesAccrual.Value, paysAtDefaultTime.Value, protectionStart.Value, claim.Value, lastPeriodDayCounter.Value, rebatesAccrual.Value)))
    let _accrualRebateNPV                          = triv _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).accrualRebateNPV())
    let _conventionalSpread                        (conventionalRecovery : ICell<double>) (discountCurve : ICell<Handle<YieldTermStructure>>) (dayCounter : ICell<DayCounter>) (model : ICell<PricingModel>)   
                                                   = triv _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).conventionalSpread(conventionalRecovery.Value, discountCurve.Value, dayCounter.Value, model.Value))
    let _couponLegBPS                              = triv _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).couponLegBPS())
    let _couponLegNPV                              = triv _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).couponLegNPV())
    let _coupons                                   = triv _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).coupons())
    let _defaultLegNPV                             = triv _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).defaultLegNPV())
    let _fairSpread                                = triv _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).fairSpread())
    let _fairUpfront                               = triv _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).fairUpfront())
    let _impliedHazardRate                         (targetNPV : ICell<double>) (discountCurve : ICell<Handle<YieldTermStructure>>) (dayCounter : ICell<DayCounter>) (recoveryRate : ICell<double>) (accuracy : ICell<double>) (model : ICell<PricingModel>)   
                                                   = triv _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).impliedHazardRate(targetNPV.Value, discountCurve.Value, dayCounter.Value, recoveryRate.Value, accuracy.Value, model.Value))
    let _isExpired                                 = triv _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).isExpired())
    let _notional                                  = triv _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).notional())
    let _paysAtDefaultTime                         = triv _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).paysAtDefaultTime())
    let _protectionEndDate                         = triv _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).protectionEndDate())
    let _protectionStartDate                       = triv _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).protectionStartDate())
    let _rebatesAccrual                            = triv _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).rebatesAccrual())
    let _runningSpread                             = triv _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).runningSpread())
    let _settlesAccrual                            = triv _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).settlesAccrual())
    let _side                                      = triv _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).side())
    let _upfront                                   = triv _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).upfront())
    let _upfrontBPS                                = triv _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).upfrontBPS())
    let _upfrontNPV                                = triv _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).upfrontNPV())
    let _CASH                                      = cell _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).CASH())
    let _errorEstimate                             = triv _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).errorEstimate())
    let _NPV                                       = cell _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = triv _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = triv _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).setPricingEngine(e.Value)
                                                                                        _CreditDefaultSwap.Value)
    let _valuationDate                             = triv _CreditDefaultSwap (fun () -> (withEvaluationDate _evaluationDate _CreditDefaultSwap).valuationDate())
