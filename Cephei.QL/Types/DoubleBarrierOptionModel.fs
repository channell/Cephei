...
*)
    let mutable
        _DoubleBarrierOption                       = cell (fun () -> withEngine pricingEngine evaluationDate (new DoubleBarrierOption (barrierType.Value, barrier_lo.Value, barrier_hi.Value, rebate.Value, payoff.Value, exercise.Value)))
    ...
    let _deltaForward                              = triv (fun () -> (withEvaluationDate _evaluationDate _DoubleBarrierOption).deltaForward())
    let _dividendRho                               = triv (fun () -> (withEvaluationDate _evaluationDate _DoubleBarrierOption).dividendRho())
    let _elasticity                                = triv (fun () -> (withEvaluationDate _evaluationDate _DoubleBarrierOption).elasticity())
    let _gamma                                     = triv (fun () -> (withEvaluationDate _evaluationDate _DoubleBarrierOption).gamma())
    let _isExpired                                 = triv (fun () -> (withEvaluationDate _evaluationDate _DoubleBarrierOption).isExpired())
    let _itmCashProbability                        = triv (fun () -> (withEvaluationDate _evaluationDate _DoubleBarrierOption).itmCashProbability())
    let _rho                                       = triv (fun () -> (withEvaluationDate _evaluationDate _DoubleBarrierOption).rho())
    let _strikeSensitivity                         = triv (fun () -> (withEvaluationDate _evaluationDate _DoubleBarrierOption).strikeSensitivity())
    let _theta                                     = triv (fun () -> (withEvaluationDate _evaluationDate _DoubleBarrierOption).theta())
    let _thetaPerDay                               = triv (fun () -> (withEvaluationDate _evaluationDate _DoubleBarrierOption).thetaPerDay())
    let _vega                                      = triv (fun () -> (withEvaluationDate _evaluationDate _DoubleBarrierOption).vega())
    ...
    let _errorEstimate                             = triv (fun () -> (withEvaluationDate _evaluationDate _DoubleBarrierOption).errorEstimate())
    let _NPV                                       = cell (fun () -> (withEvaluationDate _evaluationDate _DoubleBarrierOption).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _DoubleBarrierOption).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _DoubleBarrierOption).setPricingEngine(e.Value)
