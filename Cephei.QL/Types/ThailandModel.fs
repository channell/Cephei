...
*)
    let mutable
        _Thailand                                  = make (fun () -> new Thailand ())
    let _addedHolidays                             = triv _Thailand (fun () -> _Thailand.Value.addedHolidays)
    let _addHoliday                                (d : ICell<Date>)   
                                                   = triv _Thailand (fun () -> _Thailand.Value.addHoliday(d.Value)
                                                                               _Thailand.Value)
    let _adjust                                    (d : ICell<Date>) (c : ICell<BusinessDayConvention>)   
                                                   = triv _Thailand (fun () -> _Thailand.Value.adjust(d.Value, c.Value))
    let _advance                                   (d : ICell<Date>) (p : ICell<Period>) (c : ICell<BusinessDayConvention>) (endOfMonth : ICell<bool>)   
                                                   = triv _Thailand (fun () -> _Thailand.Value.advance(d.Value, p.Value, c.Value, endOfMonth.Value))
    let _advance1                                  (d : ICell<Date>) (n : ICell<int>) (unit : ICell<TimeUnit>) (c : ICell<BusinessDayConvention>) (endOfMonth : ICell<bool>)   
                                                   = triv _Thailand (fun () -> _Thailand.Value.advance(d.Value, n.Value, unit.Value, c.Value, endOfMonth.Value))
    let _businessDaysBetween                       (from : ICell<Date>) (To : ICell<Date>) (includeFirst : ICell<bool>) (includeLast : ICell<bool>)   
                                                   = triv _Thailand (fun () -> _Thailand.Value.businessDaysBetween(from.Value, To.Value, includeFirst.Value, includeLast.Value))
    let _calendar                                  = triv _Thailand (fun () -> _Thailand.Value.calendar)
    let _empty                                     = triv _Thailand (fun () -> _Thailand.Value.empty())
    let _endOfMonth                                (d : ICell<Date>)   
                                                   = triv _Thailand (fun () -> _Thailand.Value.endOfMonth(d.Value))
    let _Equals                                    (o : ICell<Object>)   
                                                   = triv _Thailand (fun () -> _Thailand.Value.Equals(o.Value))
    let _isBusinessDay                             (d : ICell<Date>)   
                                                   = triv _Thailand (fun () -> _Thailand.Value.isBusinessDay(d.Value))
    let _isEndOfMonth                              (d : ICell<Date>)   
                                                   = triv _Thailand (fun () -> _Thailand.Value.isEndOfMonth(d.Value))
    let _isHoliday                                 (d : ICell<Date>)   
                                                   = triv _Thailand (fun () -> _Thailand.Value.isHoliday(d.Value))
    let _isWeekend                                 (w : ICell<DayOfWeek>)   
                                                   = triv _Thailand (fun () -> _Thailand.Value.isWeekend(w.Value))
    let _name                                      = triv _Thailand (fun () -> _Thailand.Value.name())
    let _removedHolidays                           = triv _Thailand (fun () -> _Thailand.Value.removedHolidays)
    let _removeHoliday                             (d : ICell<Date>)   
                                                   = triv _Thailand (fun () -> _Thailand.Value.removeHoliday(d.Value)
                                                                               _Thailand.Value)
