...
*)
    ...
    let _dayCounter                                = cell (fun () -> _CallableBondConstantVolatility.Value.dayCounter())
    let _maxBondLength                             = cell (fun () -> _CallableBondConstantVolatility.Value.maxBondLength())
    let _maxBondTenor                              = cell (fun () -> _CallableBondConstantVolatility.Value.maxBondTenor())
    let _maxDate                                   = cell (fun () -> _CallableBondConstantVolatility.Value.maxDate())
    let _maxStrike                                 = cell (fun () -> _CallableBondConstantVolatility.Value.maxStrike())
    let _minStrike                                 = cell (fun () -> _CallableBondConstantVolatility.Value.minStrike())
    let _blackVariance                             (optionDate : ICell<Date>) (bondTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _CallableBondConstantVolatility.Value.blackVariance(optionDate.Value, bondTenor.Value, strike.Value, extrapolate.Value))
    let _blackVariance1                            (optionTime : ICell<double>) (bondLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _CallableBondConstantVolatility.Value.blackVariance(optionTime.Value, bondLength.Value, strike.Value, extrapolate.Value))
    let _blackVariance2                            (optionTenor : ICell<Period>) (bondTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _CallableBondConstantVolatility.Value.blackVariance(optionTenor.Value, bondTenor.Value, strike.Value, extrapolate.Value))
    let _businessDayConvention                     = cell (fun () -> _CallableBondConstantVolatility.Value.businessDayConvention())
    let _convertDates                              (optionDate : ICell<Date>) (bondTenor : ICell<Period>)   
                                                   = cell (fun () -> _CallableBondConstantVolatility.Value.convertDates(optionDate.Value, bondTenor.Value))
    let _optionDateFromTenor                       (optionTenor : ICell<Period>)   
                                                   = cell (fun () -> _CallableBondConstantVolatility.Value.optionDateFromTenor(optionTenor.Value))
    let _smileSection                              (optionDate : ICell<Date>) (bondTenor : ICell<Period>)   
                                                   = cell (fun () -> _CallableBondConstantVolatility.Value.smileSection(optionDate.Value, bondTenor.Value))
    let _smileSection1                             (optionTenor : ICell<Period>) (bondTenor : ICell<Period>)   
                                                   = cell (fun () -> _CallableBondConstantVolatility.Value.smileSection(optionTenor.Value, bondTenor.Value))
    let _volatility                                (optionTenor : ICell<double>) (bondTenor : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _CallableBondConstantVolatility.Value.volatility(optionTenor.Value, bondTenor.Value, strike.Value, extrapolate.Value))
    let _volatility1                               (optionDate : ICell<Date>) (bondTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _CallableBondConstantVolatility.Value.volatility(optionDate.Value, bondTenor.Value, strike.Value, extrapolate.Value))
    let _volatility2                               (optionTenor : ICell<Period>) (bondTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _CallableBondConstantVolatility.Value.volatility(optionTenor.Value, bondTenor.Value, strike.Value, extrapolate.Value))
    let _calendar                                  = cell (fun () -> _CallableBondConstantVolatility.Value.calendar())
    let _maxTime                                   = cell (fun () -> _CallableBondConstantVolatility.Value.maxTime())
    let _referenceDate                             = cell (fun () -> _CallableBondConstantVolatility.Value.referenceDate())
    let _settlementDays                            = cell (fun () -> _CallableBondConstantVolatility.Value.settlementDays())
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = cell (fun () -> _CallableBondConstantVolatility.Value.timeFromReference(date.Value))
    let _update                                    = cell (fun () -> _CallableBondConstantVolatility.Value.update()
                                                                     _CallableBondConstantVolatility.Value)
    let _allowsExtrapolation                       = cell (fun () -> _CallableBondConstantVolatility.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _CallableBondConstantVolatility.Value.disableExtrapolation(b.Value)
                                                                     _CallableBondConstantVolatility.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _CallableBondConstantVolatility.Value.enableExtrapolation(b.Value)
                                                                     _CallableBondConstantVolatility.Value)
    let _extrapolate                               = cell (fun () -> _CallableBondConstantVolatility.Value.extrapolate)
