...
*)
    let mutable
        _CallableBondConstantVolatility            = make (fun () -> new CallableBondConstantVolatility (referenceDate.Value, volatility.Value, dayCounter.Value))
    let _dayCounter                                = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.dayCounter())
    let _maxBondLength                             = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.maxBondLength())
    let _maxBondTenor                              = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.maxBondTenor())
    let _maxDate                                   = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.maxDate())
    let _maxStrike                                 = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.maxStrike())
    let _minStrike                                 = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.minStrike())
    let _blackVariance                             (optionDate : ICell<Date>) (bondTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.blackVariance(optionDate.Value, bondTenor.Value, strike.Value, extrapolate.Value))
    let _blackVariance1                            (optionTime : ICell<double>) (bondLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.blackVariance(optionTime.Value, bondLength.Value, strike.Value, extrapolate.Value))
    let _blackVariance2                            (optionTenor : ICell<Period>) (bondTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.blackVariance(optionTenor.Value, bondTenor.Value, strike.Value, extrapolate.Value))
    let _businessDayConvention                     = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.businessDayConvention())
    let _convertDates                              (optionDate : ICell<Date>) (bondTenor : ICell<Period>)   
                                                   = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.convertDates(optionDate.Value, bondTenor.Value))
    let _optionDateFromTenor                       (optionTenor : ICell<Period>)   
                                                   = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.optionDateFromTenor(optionTenor.Value))
    let _smileSection                              (optionDate : ICell<Date>) (bondTenor : ICell<Period>)   
                                                   = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.smileSection(optionDate.Value, bondTenor.Value))
    let _smileSection1                             (optionTenor : ICell<Period>) (bondTenor : ICell<Period>)   
                                                   = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.smileSection(optionTenor.Value, bondTenor.Value))
    let _volatility                                (optionTenor : ICell<double>) (bondTenor : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.volatility(optionTenor.Value, bondTenor.Value, strike.Value, extrapolate.Value))
    let _volatility1                               (optionDate : ICell<Date>) (bondTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.volatility(optionDate.Value, bondTenor.Value, strike.Value, extrapolate.Value))
    let _volatility2                               (optionTenor : ICell<Period>) (bondTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.volatility(optionTenor.Value, bondTenor.Value, strike.Value, extrapolate.Value))
    let _calendar                                  = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.calendar())
    let _maxTime                                   = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.maxTime())
    let _referenceDate                             = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.referenceDate())
    let _settlementDays                            = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.settlementDays())
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.timeFromReference(date.Value))
    let _update                                    = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.update()
                                                                                                     _CallableBondConstantVolatility.Value)
    let _allowsExtrapolation                       = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.disableExtrapolation(b.Value)
                                                                                                     _CallableBondConstantVolatility.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.enableExtrapolation(b.Value)
                                                                                                     _CallableBondConstantVolatility.Value)
    let _extrapolate                               = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.extrapolate)
...
*)
    let mutable
        _CallableBondConstantVolatility            = make (fun () -> new CallableBondConstantVolatility (settlementDays.Value, calendar.Value, volatility.Value, dayCounter.Value))
    let _dayCounter                                = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.dayCounter())
    let _maxBondLength                             = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.maxBondLength())
    let _maxBondTenor                              = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.maxBondTenor())
    let _maxDate                                   = triv _CallableBondConstantVolatility (fun () -> _CallableBondConstantVolatility.Value.maxDate())
