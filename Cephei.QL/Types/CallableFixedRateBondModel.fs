...
(*
    Functions
*)
    let _CallableFixedRateBond                     = triv (fun () -> withEngine _pricingEngine.Value (new CallableFixedRateBond (settlementDays.Value, faceAmount.Value, schedule.Value, coupons.Value, accrualDayCounter.Value, paymentConvention.Value, redemption.Value, issueDate.Value, putCallSchedule.Value)))
