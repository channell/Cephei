...
*)
    ...
    let _correctYoYRate                            (d : ICell<Date>) (r : ICell<double>) (iTS : ICell<InflationTermStructure>)   
                                                   = cell (fun () -> _MultiplicativePriceSeasonality.Value.correctYoYRate(d.Value, r.Value, iTS.Value))
    let _correctZeroRate                           (d : ICell<Date>) (r : ICell<double>) (iTS : ICell<InflationTermStructure>)   
                                                   = cell (fun () -> _MultiplicativePriceSeasonality.Value.correctZeroRate(d.Value, r.Value, iTS.Value))
    let _frequency                                 = cell (fun () -> _MultiplicativePriceSeasonality.Value.frequency())
    let _isConsistent                              (iTS : ICell<InflationTermStructure>)   
                                                   = cell (fun () -> _MultiplicativePriceSeasonality.Value.isConsistent(iTS.Value))
    let _seasonalityBaseDate                       = cell (fun () -> _MultiplicativePriceSeasonality.Value.seasonalityBaseDate())
    let _seasonalityFactor                         (To : ICell<Date>)   
                                                   = cell (fun () -> _MultiplicativePriceSeasonality.Value.seasonalityFactor(To.Value))
    let _seasonalityFactors                        = cell (fun () -> _MultiplicativePriceSeasonality.Value.seasonalityFactors())
    let _set                                       (seasonalityBaseDate : ICell<Date>) (frequency : ICell<Frequency>) (seasonalityFactors : ICell<Generic.List<double>>)   
                                                   = cell (fun () -> _MultiplicativePriceSeasonality.Value.set(seasonalityBaseDate.Value, frequency.Value, seasonalityFactors.Value)
