...
*)
    let mutable
        _Russia                                    = make (fun () -> new Russia (m.Value))
    let _addedHolidays                             = triv _Russia (fun () -> _Russia.Value.addedHolidays)
    let _addHoliday                                (d : ICell<Date>)   
                                                   = triv _Russia (fun () -> _Russia.Value.addHoliday(d.Value)
                                                                             _Russia.Value)
    let _adjust                                    (d : ICell<Date>) (c : ICell<BusinessDayConvention>)   
                                                   = triv _Russia (fun () -> _Russia.Value.adjust(d.Value, c.Value))
    let _advance                                   (d : ICell<Date>) (p : ICell<Period>) (c : ICell<BusinessDayConvention>) (endOfMonth : ICell<bool>)   
                                                   = triv _Russia (fun () -> _Russia.Value.advance(d.Value, p.Value, c.Value, endOfMonth.Value))
    let _advance1                                  (d : ICell<Date>) (n : ICell<int>) (unit : ICell<TimeUnit>) (c : ICell<BusinessDayConvention>) (endOfMonth : ICell<bool>)   
                                                   = triv _Russia (fun () -> _Russia.Value.advance(d.Value, n.Value, unit.Value, c.Value, endOfMonth.Value))
    let _businessDaysBetween                       (from : ICell<Date>) (To : ICell<Date>) (includeFirst : ICell<bool>) (includeLast : ICell<bool>)   
                                                   = triv _Russia (fun () -> _Russia.Value.businessDaysBetween(from.Value, To.Value, includeFirst.Value, includeLast.Value))
    let _calendar                                  = triv _Russia (fun () -> _Russia.Value.calendar)
    let _empty                                     = triv _Russia (fun () -> _Russia.Value.empty())
    let _endOfMonth                                (d : ICell<Date>)   
                                                   = triv _Russia (fun () -> _Russia.Value.endOfMonth(d.Value))
    let _Equals                                    (o : ICell<Object>)   
                                                   = triv _Russia (fun () -> _Russia.Value.Equals(o.Value))
    let _isBusinessDay                             (d : ICell<Date>)   
                                                   = triv _Russia (fun () -> _Russia.Value.isBusinessDay(d.Value))
    let _isEndOfMonth                              (d : ICell<Date>)   
                                                   = triv _Russia (fun () -> _Russia.Value.isEndOfMonth(d.Value))
    let _isHoliday                                 (d : ICell<Date>)   
                                                   = triv _Russia (fun () -> _Russia.Value.isHoliday(d.Value))
    let _isWeekend                                 (w : ICell<DayOfWeek>)   
                                                   = triv _Russia (fun () -> _Russia.Value.isWeekend(w.Value))
    let _name                                      = triv _Russia (fun () -> _Russia.Value.name())
    let _removedHolidays                           = triv _Russia (fun () -> _Russia.Value.removedHolidays)
    let _removeHoliday                             (d : ICell<Date>)   
                                                   = triv _Russia (fun () -> _Russia.Value.removeHoliday(d.Value)
                                                                             _Russia.Value)
