...
*)
    ...
    let _Equals                                    (o : ICell<Object>)   
                                                   = triv (fun () -> _VEBCurrency.Value.Equals(o.Value))
    let _format                                    = triv (fun () -> _VEBCurrency.Value.format)
    let _fractionsPerUnit                          = triv (fun () -> _VEBCurrency.Value.fractionsPerUnit)
    let _fractionSymbol                            = triv (fun () -> _VEBCurrency.Value.fractionSymbol)
    let _name                                      = triv (fun () -> _VEBCurrency.Value.name)
    let _numericCode                               = triv (fun () -> _VEBCurrency.Value.numericCode)
    let _rounding                                  = triv (fun () -> _VEBCurrency.Value.rounding)
    let _symbol                                    = triv (fun () -> _VEBCurrency.Value.symbol)
    let _ToString                                  = triv (fun () -> _VEBCurrency.Value.ToString())
    let _triangulationCurrency                     = triv (fun () -> _VEBCurrency.Value.triangulationCurrency)
