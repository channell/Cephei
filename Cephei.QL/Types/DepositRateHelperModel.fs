...
*)
    ...
    let _impliedQuote                              = cell (fun () -> _DepositRateHelper.Value.impliedQuote())
    let _setTermStructure                          (t : ICell<YieldTermStructure>)   
                                                   = cell (fun () -> _DepositRateHelper.Value.setTermStructure(t.Value)
                                                                     _DepositRateHelper.Value)
    let _update                                    = cell (fun () -> _DepositRateHelper.Value.update()
                                                                     _DepositRateHelper.Value)
    let _earliestDate                              = cell (fun () -> _DepositRateHelper.Value.earliestDate())
    let _latestDate                                = cell (fun () -> _DepositRateHelper.Value.latestDate())
    let _latestRelevantDate                        = cell (fun () -> _DepositRateHelper.Value.latestRelevantDate())
    let _maturityDate                              = cell (fun () -> _DepositRateHelper.Value.maturityDate())
    let _pillarDate                                = cell (fun () -> _DepositRateHelper.Value.pillarDate())
    let _quote                                     = cell (fun () -> _DepositRateHelper.Value.quote())
    let _quoteError                                = cell (fun () -> _DepositRateHelper.Value.quoteError())
    let _quoteIsValid                              = cell (fun () -> _DepositRateHelper.Value.quoteIsValid())
    let _quoteValue                                = cell (fun () -> _DepositRateHelper.Value.quoteValue())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _DepositRateHelper.Value.registerWith(handler.Value)
                                                                     _DepositRateHelper.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _DepositRateHelper.Value.unregisterWith(handler.Value)
                                                                     _DepositRateHelper.Value)
