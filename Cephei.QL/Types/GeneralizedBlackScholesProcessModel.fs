...
*)
    ...
    let _apply                                     (x0 : ICell<double>) (dx : ICell<double>)   
                                                   = cell (fun () -> _GeneralizedBlackScholesProcess.Value.apply(x0.Value, dx.Value))
    let _blackVolatility                           = cell (fun () -> _GeneralizedBlackScholesProcess.Value.blackVolatility())
    let _diffusion                                 (t : ICell<double>) (x : ICell<double>)   
                                                   = cell (fun () -> _GeneralizedBlackScholesProcess.Value.diffusion(t.Value, x.Value))
    let _dividendYield                             = cell (fun () -> _GeneralizedBlackScholesProcess.Value.dividendYield())
    let _drift                                     (t : ICell<double>) (x : ICell<double>)   
                                                   = cell (fun () -> _GeneralizedBlackScholesProcess.Value.drift(t.Value, x.Value))
    let _evolve                                    (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>) (dw : ICell<double>)   
                                                   = cell (fun () -> _GeneralizedBlackScholesProcess.Value.evolve(t0.Value, x0.Value, dt.Value, dw.Value))
    let _expectation                               (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = cell (fun () -> _GeneralizedBlackScholesProcess.Value.expectation(t0.Value, x0.Value, dt.Value))
    let _localVolatility                           = cell (fun () -> _GeneralizedBlackScholesProcess.Value.localVolatility())
    let _riskFreeRate                              = cell (fun () -> _GeneralizedBlackScholesProcess.Value.riskFreeRate())
    let _stateVariable                             = cell (fun () -> _GeneralizedBlackScholesProcess.Value.stateVariable())
    let _stdDeviation                              (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = cell (fun () -> _GeneralizedBlackScholesProcess.Value.stdDeviation(t0.Value, x0.Value, dt.Value))
    let _time                                      (d : ICell<Date>)   
                                                   = cell (fun () -> _GeneralizedBlackScholesProcess.Value.time(d.Value))
    let _update                                    = cell (fun () -> _GeneralizedBlackScholesProcess.Value.update()
                                                                     _GeneralizedBlackScholesProcess.Value)
    let _variance                                  (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = cell (fun () -> _GeneralizedBlackScholesProcess.Value.variance(t0.Value, x0.Value, dt.Value))
    let _x0                                        = cell (fun () -> _GeneralizedBlackScholesProcess.Value.x0())
    let _initialValues                             = cell (fun () -> _GeneralizedBlackScholesProcess.Value.initialValues())
    let _size                                      = cell (fun () -> _GeneralizedBlackScholesProcess.Value.size())
    let _covariance                                (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>)   
                                                   = cell (fun () -> _GeneralizedBlackScholesProcess.Value.covariance(t0.Value, x0.Value, dt.Value))
    let _factors                                   = cell (fun () -> _GeneralizedBlackScholesProcess.Value.factors())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _GeneralizedBlackScholesProcess.Value.registerWith(handler.Value)
                                                                     _GeneralizedBlackScholesProcess.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _GeneralizedBlackScholesProcess.Value.unregisterWith(handler.Value)
                                                                     _GeneralizedBlackScholesProcess.Value)
