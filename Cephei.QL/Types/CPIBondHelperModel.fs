...
*)
    ...
    let _setTermStructure                          (t : ICell<YieldTermStructure>)   
                                                   = triv (fun () -> _CPIBondHelper.Value.setTermStructure(t.Value)
                                                                     _CPIBondHelper.Value)
    let _useCleanPrice                             = triv (fun () -> _CPIBondHelper.Value.useCleanPrice())
    let _earliestDate                              = triv (fun () -> _CPIBondHelper.Value.earliestDate())
    let _latestDate                                = triv (fun () -> _CPIBondHelper.Value.latestDate())
    let _latestRelevantDate                        = triv (fun () -> _CPIBondHelper.Value.latestRelevantDate())
    let _maturityDate                              = triv (fun () -> _CPIBondHelper.Value.maturityDate())
    let _pillarDate                                = triv (fun () -> _CPIBondHelper.Value.pillarDate())
    let _quote                                     = triv (fun () -> _CPIBondHelper.Value.quote())
    let _quoteError                                = triv (fun () -> _CPIBondHelper.Value.quoteError())
    let _quoteIsValid                              = triv (fun () -> _CPIBondHelper.Value.quoteIsValid())
    let _quoteValue                                = triv (fun () -> _CPIBondHelper.Value.quoteValue())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv (fun () -> _CPIBondHelper.Value.registerWith(handler.Value)
                                                                     _CPIBondHelper.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = triv (fun () -> _CPIBondHelper.Value.unregisterWith(handler.Value)
                                                                     _CPIBondHelper.Value)
