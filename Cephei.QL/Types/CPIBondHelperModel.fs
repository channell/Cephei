...
*)
    ...
    let _cpiBond                                   = cell (fun () -> _CPIBondHelper.Value.cpiBond())
    let _bond                                      = cell (fun () -> _CPIBondHelper.Value.bond())
    let _impliedQuote                              = cell (fun () -> _CPIBondHelper.Value.impliedQuote())
    let _setTermStructure                          (t : ICell<YieldTermStructure>)   
                                                   = cell (fun () -> _CPIBondHelper.Value.setTermStructure(t.Value)
                                                                     _CPIBondHelper.Value)
    let _useCleanPrice                             = cell (fun () -> _CPIBondHelper.Value.useCleanPrice())
    let _earliestDate                              = cell (fun () -> _CPIBondHelper.Value.earliestDate())
    let _latestDate                                = cell (fun () -> _CPIBondHelper.Value.latestDate())
    let _latestRelevantDate                        = cell (fun () -> _CPIBondHelper.Value.latestRelevantDate())
    let _maturityDate                              = cell (fun () -> _CPIBondHelper.Value.maturityDate())
    let _pillarDate                                = cell (fun () -> _CPIBondHelper.Value.pillarDate())
    let _quote                                     = cell (fun () -> _CPIBondHelper.Value.quote())
    let _quoteError                                = cell (fun () -> _CPIBondHelper.Value.quoteError())
    let _quoteIsValid                              = cell (fun () -> _CPIBondHelper.Value.quoteIsValid())
    let _quoteValue                                = cell (fun () -> _CPIBondHelper.Value.quoteValue())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _CPIBondHelper.Value.registerWith(handler.Value)
                                                                     _CPIBondHelper.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _CPIBondHelper.Value.unregisterWith(handler.Value)
                                                                     _CPIBondHelper.Value)
    let _update                                    = cell (fun () -> _CPIBondHelper.Value.update()
                                                                     _CPIBondHelper.Value)
