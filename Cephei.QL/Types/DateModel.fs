...
*)
    let mutable
        _Date                                      = make (fun () -> new Date ())
    let _CompareTo                                 (obj : ICell<Object>)   
                                                   = triv _Date (fun () -> _Date.Value.CompareTo(obj.Value))
    let _Day                                       = triv _Date (fun () -> _Date.Value.Day)
    let _DayOfWeek                                 = triv _Date (fun () -> _Date.Value.DayOfWeek)
    let _DayOfYear                                 = triv _Date (fun () -> _Date.Value.DayOfYear)
    let _Equals                                    (o : ICell<Object>)   
                                                   = triv _Date (fun () -> _Date.Value.Equals(o.Value))
    let _fractionOfDay                             = triv _Date (fun () -> _Date.Value.fractionOfDay())
    let _fractionOfSecond                          = triv _Date (fun () -> _Date.Value.fractionOfSecond)
    let _hours                                     = triv _Date (fun () -> _Date.Value.hours)
    let _milliseconds                              = triv _Date (fun () -> _Date.Value.milliseconds)
    let _minutes                                   = triv _Date (fun () -> _Date.Value.minutes)
    let _month                                     = triv _Date (fun () -> _Date.Value.month())
    let _Month                                     = triv _Date (fun () -> _Date.Value.Month)
    let _seconds                                   = triv _Date (fun () -> _Date.Value.seconds)
    let _serialNumber                              = triv _Date (fun () -> _Date.Value.serialNumber())
    let _ToLongDateString                          = triv _Date (fun () -> _Date.Value.ToLongDateString())
    let _ToShortDateString                         = triv _Date (fun () -> _Date.Value.ToShortDateString())
    let _ToString                                  = triv _Date (fun () -> _Date.Value.ToString())
    let _ToString1                                 (provider : ICell<IFormatProvider>)   
                                                   = triv _Date (fun () -> _Date.Value.ToString(provider.Value))
    let _ToString2                                 (format : ICell<string>) (provider : ICell<IFormatProvider>)   
                                                   = triv _Date (fun () -> _Date.Value.ToString(format.Value, provider.Value))
    let _ToString3                                 (format : ICell<string>)   
                                                   = triv _Date (fun () -> _Date.Value.ToString(format.Value))
    let _weekday                                   = triv _Date (fun () -> _Date.Value.weekday())
    let _year                                      = triv _Date (fun () -> _Date.Value.year())
    let _Year                                      = triv _Date (fun () -> _Date.Value.Year)
    do this.Bind(_Date)
(* 
    casting 
...
*)
    let mutable
        _Date                                      = make (fun () -> new Date (serialNumber.Value))
    let _CompareTo                                 (obj : ICell<Object>)   
                                                   = triv _Date (fun () -> _Date.Value.CompareTo(obj.Value))
    let _Day                                       = triv _Date (fun () -> _Date.Value.Day)
    let _DayOfWeek                                 = triv _Date (fun () -> _Date.Value.DayOfWeek)
...
*)
    let mutable
        _Date                                      = make (fun () -> new Date (d.Value, m.Value, y.Value, h.Value, mi.Value, s.Value, ms.Value))
    let _CompareTo                                 (obj : ICell<Object>)   
                                                   = triv _Date (fun () -> _Date.Value.CompareTo(obj.Value))
    let _Day                                       = triv _Date (fun () -> _Date.Value.Day)
    let _DayOfWeek                                 = triv _Date (fun () -> _Date.Value.DayOfWeek)
...
*)
    let mutable
        _Date                                      = make (fun () -> new Date (d.Value, m.Value, y.Value))
    let _CompareTo                                 (obj : ICell<Object>)   
                                                   = triv _Date (fun () -> _Date.Value.CompareTo(obj.Value))
    let _Day                                       = triv _Date (fun () -> _Date.Value.Day)
    let _DayOfWeek                                 = triv _Date (fun () -> _Date.Value.DayOfWeek)
...
*)
    let mutable
        _Date                                      = make (fun () -> new Date (d.Value))
    let _CompareTo                                 (obj : ICell<Object>)   
                                                   = triv _Date (fun () -> _Date.Value.CompareTo(obj.Value))
    let _Day                                       = triv _Date (fun () -> _Date.Value.Day)
    let _DayOfWeek                                 = triv _Date (fun () -> _Date.Value.DayOfWeek)
