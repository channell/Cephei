...
*)
    ...
    let _maxDate                                   = cell (fun () -> _FlatForward.Value.maxDate())
    let _discount                                  (t : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _FlatForward.Value.discount(t.Value, extrapolate.Value))
    let _discount1                                 (d : ICell<Date>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _FlatForward.Value.discount(d.Value, extrapolate.Value))
    let _forwardRate                               (d : ICell<Date>) (p : ICell<Period>) (dayCounter : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _FlatForward.Value.forwardRate(d.Value, p.Value, dayCounter.Value, comp.Value, freq.Value, extrapolate.Value))
    let _forwardRate1                              (d1 : ICell<Date>) (d2 : ICell<Date>) (dayCounter : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _FlatForward.Value.forwardRate(d1.Value, d2.Value, dayCounter.Value, comp.Value, freq.Value, extrapolate.Value))
    let _forwardRate2                              (t1 : ICell<double>) (t2 : ICell<double>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _FlatForward.Value.forwardRate(t1.Value, t2.Value, comp.Value, freq.Value, extrapolate.Value))
    let _jumpDates                                 = cell (fun () -> _FlatForward.Value.jumpDates())
    let _jumpTimes                                 = cell (fun () -> _FlatForward.Value.jumpTimes())
    let _update                                    = cell (fun () -> _FlatForward.Value.update()
                                                                     _FlatForward.Value)
    let _zeroRate                                  (t : ICell<double>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _FlatForward.Value.zeroRate(t.Value, comp.Value, freq.Value, extrapolate.Value))
    let _zeroRate1                                 (d : ICell<Date>) (dayCounter : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _FlatForward.Value.zeroRate(d.Value, dayCounter.Value, comp.Value, freq.Value, extrapolate.Value))
    let _calendar                                  = cell (fun () -> _FlatForward.Value.calendar())
    let _dayCounter                                = cell (fun () -> _FlatForward.Value.dayCounter())
    let _maxTime                                   = cell (fun () -> _FlatForward.Value.maxTime())
    let _referenceDate                             = cell (fun () -> _FlatForward.Value.referenceDate())
    let _settlementDays                            = cell (fun () -> _FlatForward.Value.settlementDays())
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = cell (fun () -> _FlatForward.Value.timeFromReference(date.Value))
    let _allowsExtrapolation                       = cell (fun () -> _FlatForward.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _FlatForward.Value.disableExtrapolation(b.Value)
                                                                     _FlatForward.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _FlatForward.Value.enableExtrapolation(b.Value)
                                                                     _FlatForward.Value)
    let _extrapolate                               = cell (fun () -> _FlatForward.Value.extrapolate)
