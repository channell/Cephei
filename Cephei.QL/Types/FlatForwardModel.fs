...
*)
    let mutable
        _FlatForward                               = make (fun () -> (createEvaluationDate _evaluationDate (fun () ->new FlatForward (referenceDate.Value, forward.Value, dayCounter.Value))))
    let _maxDate                                   = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.maxDate())
    let _discount                                  (t : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.discount(t.Value, extrapolate.Value))
    let _discount1                                 (d : ICell<Date>) (extrapolate : ICell<bool>)   
                                                   = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.discount(d.Value, extrapolate.Value))
    let _forwardRate                               (d : ICell<Date>) (p : ICell<Period>) (dayCounter : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.forwardRate(d.Value, p.Value, dayCounter.Value, comp.Value, freq.Value, extrapolate.Value))
    let _forwardRate1                              (d1 : ICell<Date>) (d2 : ICell<Date>) (dayCounter : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.forwardRate(d1.Value, d2.Value, dayCounter.Value, comp.Value, freq.Value, extrapolate.Value))
    let _forwardRate2                              (t1 : ICell<double>) (t2 : ICell<double>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.forwardRate(t1.Value, t2.Value, comp.Value, freq.Value, extrapolate.Value))
    let _jumpDates                                 = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.jumpDates())
    let _jumpTimes                                 = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.jumpTimes())
    let _update                                    = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.update()
                                                                                  _FlatForward.Value)
    let _zeroRate                                  (t : ICell<double>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.zeroRate(t.Value, comp.Value, freq.Value, extrapolate.Value))
    let _zeroRate1                                 (d : ICell<Date>) (dayCounter : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.zeroRate(d.Value, dayCounter.Value, comp.Value, freq.Value, extrapolate.Value))
    let _calendar                                  = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.calendar())
    let _dayCounter                                = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.dayCounter())
    let _maxTime                                   = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.maxTime())
    let _referenceDate                             = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.referenceDate())
    let _settlementDays                            = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.settlementDays())
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.timeFromReference(date.Value))
    let _allowsExtrapolation                       = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.disableExtrapolation(b.Value)
                                                                                  _FlatForward.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.enableExtrapolation(b.Value)
                                                                                  _FlatForward.Value)
    let _extrapolate                               = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.extrapolate)
...
*)
    let mutable
        _FlatForward                               = make (fun () -> (createEvaluationDate _evaluationDate (fun () ->new FlatForward (settlementDays.Value, calendar.Value, forward.Value, dayCounter.Value))))
    let _maxDate                                   = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.maxDate())
    let _discount                                  (t : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.discount(t.Value, extrapolate.Value))
    let _discount1                                 (d : ICell<Date>) (extrapolate : ICell<bool>)   
...
*)
    let mutable
        _FlatForward                               = make (fun () -> (createEvaluationDate _evaluationDate (fun () ->new FlatForward (settlementDays.Value, calendar.Value, forward.Value, dayCounter.Value, compounding.Value, frequency.Value))))
    let _maxDate                                   = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.maxDate())
    let _discount                                  (t : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.discount(t.Value, extrapolate.Value))
    let _discount1                                 (d : ICell<Date>) (extrapolate : ICell<bool>)   
...
*)
    let mutable
        _FlatForward                               = make (fun () -> (createEvaluationDate _evaluationDate (fun () ->new FlatForward (settlementDays.Value, calendar.Value, forward.Value, dayCounter.Value, compounding.Value))))
    let _maxDate                                   = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.maxDate())
    let _discount                                  (t : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.discount(t.Value, extrapolate.Value))
    let _discount1                                 (d : ICell<Date>) (extrapolate : ICell<bool>)   
...
*)
    let mutable
        _FlatForward                               = make (fun () -> (createEvaluationDate _evaluationDate (fun () ->new FlatForward (referenceDate.Value, forward.Value, dayCounter.Value, compounding.Value, frequency.Value))))
    let _maxDate                                   = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.maxDate())
    let _discount                                  (t : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.discount(t.Value, extrapolate.Value))
    let _discount1                                 (d : ICell<Date>) (extrapolate : ICell<bool>)   
...
*)
    let mutable
        _FlatForward                               = make (fun () -> (createEvaluationDate _evaluationDate (fun () ->new FlatForward (referenceDate.Value, forward.Value, dayCounter.Value, compounding.Value))))
    let _maxDate                                   = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.maxDate())
    let _discount                                  (t : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _FlatForward (fun () -> (curryEvaluationDate _evaluationDate _FlatForward).Value.discount(t.Value, extrapolate.Value))
    let _discount1                                 (d : ICell<Date>) (extrapolate : ICell<bool>)   
