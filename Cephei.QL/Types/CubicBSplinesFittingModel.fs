...
*)
    let mutable
        _CubicBSplinesFitting                      = make (fun () -> new CubicBSplinesFitting (knots.Value, constrainAtZero.Value, weights.Value, optimizationMethod.Value))
    let _basisFunction                             (i : ICell<int>) (t : ICell<double>)   
                                                   = triv _CubicBSplinesFitting (fun () -> _CubicBSplinesFitting.Value.basisFunction(i.Value, t.Value))
    let _clone                                     = triv _CubicBSplinesFitting (fun () -> _CubicBSplinesFitting.Value.clone())
    let _size                                      = triv _CubicBSplinesFitting (fun () -> _CubicBSplinesFitting.Value.size())
    let _constrainAtZero                           = triv _CubicBSplinesFitting (fun () -> _CubicBSplinesFitting.Value.constrainAtZero())
    let _discount                                  (x : ICell<Vector>) (t : ICell<double>)   
                                                   = triv _CubicBSplinesFitting (fun () -> _CubicBSplinesFitting.Value.discount(x.Value, t.Value))
    let _minimumCostValue                          = triv _CubicBSplinesFitting (fun () -> _CubicBSplinesFitting.Value.minimumCostValue())
    let _numberOfIterations                        = triv _CubicBSplinesFitting (fun () -> _CubicBSplinesFitting.Value.numberOfIterations())
    let _optimizationMethod                        = triv _CubicBSplinesFitting (fun () -> _CubicBSplinesFitting.Value.optimizationMethod())
    let _solution                                  = triv _CubicBSplinesFitting (fun () -> _CubicBSplinesFitting.Value.solution())
    let _weights                                   = triv _CubicBSplinesFitting (fun () -> _CubicBSplinesFitting.Value.weights())
