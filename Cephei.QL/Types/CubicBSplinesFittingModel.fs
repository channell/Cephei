...
*)
    ...
    let _basisFunction                             (i : ICell<int>) (t : ICell<double>)   
                                                   = cell (fun () -> _CubicBSplinesFitting.Value.basisFunction(i.Value, t.Value))
    let _clone                                     = cell (fun () -> _CubicBSplinesFitting.Value.clone())
    let _size                                      = cell (fun () -> _CubicBSplinesFitting.Value.size())
    let _constrainAtZero                           = cell (fun () -> _CubicBSplinesFitting.Value.constrainAtZero())
    let _discount                                  (x : ICell<Vector>) (t : ICell<double>)   
                                                   = cell (fun () -> _CubicBSplinesFitting.Value.discount(x.Value, t.Value))
    let _minimumCostValue                          = cell (fun () -> _CubicBSplinesFitting.Value.minimumCostValue())
    let _numberOfIterations                        = cell (fun () -> _CubicBSplinesFitting.Value.numberOfIterations())
    let _optimizationMethod                        = cell (fun () -> _CubicBSplinesFitting.Value.optimizationMethod())
    let _solution                                  = cell (fun () -> _CubicBSplinesFitting.Value.solution())
    let _weights                                   = cell (fun () -> _CubicBSplinesFitting.Value.weights())
