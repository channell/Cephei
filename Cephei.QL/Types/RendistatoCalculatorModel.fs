...
*)
    ...
    let _duration                                  = cell (fun () -> _RendistatoCalculator.Value.duration())
    let _durations                                 = cell (fun () -> _RendistatoCalculator.Value.durations())
    let _equivalentSwap                            = cell (fun () -> _RendistatoCalculator.Value.equivalentSwap())
    let _equivalentSwapDuration                    = cell (fun () -> _RendistatoCalculator.Value.equivalentSwapDuration())
    let _equivalentSwapLength                      = cell (fun () -> _RendistatoCalculator.Value.equivalentSwapLength())
    let _equivalentSwapRate                        = cell (fun () -> _RendistatoCalculator.Value.equivalentSwapRate())
    let _equivalentSwapSpread                      = cell (fun () -> _RendistatoCalculator.Value.equivalentSwapSpread())
    let _equivalentSwapYield                       = cell (fun () -> _RendistatoCalculator.Value.equivalentSwapYield())
    let _swapDurations                             = cell (fun () -> _RendistatoCalculator.Value.swapDurations())
    let _swapLengths                               = cell (fun () -> _RendistatoCalculator.Value.swapLengths())
    let _swapRates                                 = cell (fun () -> _RendistatoCalculator.Value.swapRates())
    let _swapYields                                = cell (fun () -> _RendistatoCalculator.Value.swapYields())
