...
*)
    let mutable
        _TreeSwaptionEngine                        = make (fun () -> (createEvaluationDate _evaluationDate (fun () ->new TreeSwaptionEngine (model.Value, timeGrid.Value, termStructure.Value))))
    let _update                                    = triv _TreeSwaptionEngine (fun () -> (curryEvaluationDate _evaluationDate _TreeSwaptionEngine).Value.update()
                                                                                         _TreeSwaptionEngine.Value)
    let _setModel                                  (model : ICell<Handle<ShortRateModel>>)   
                                                   = triv _TreeSwaptionEngine (fun () -> (curryEvaluationDate _evaluationDate _TreeSwaptionEngine).Value.setModel(model.Value)
                                                                                         _TreeSwaptionEngine.Value)
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv _TreeSwaptionEngine (fun () -> (curryEvaluationDate _evaluationDate _TreeSwaptionEngine).Value.registerWith(handler.Value)
                                                                                         _TreeSwaptionEngine.Value)
    let _reset                                     = triv _TreeSwaptionEngine (fun () -> (curryEvaluationDate _evaluationDate _TreeSwaptionEngine).Value.reset()
                                                                                         _TreeSwaptionEngine.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = triv _TreeSwaptionEngine (fun () -> (curryEvaluationDate _evaluationDate _TreeSwaptionEngine).Value.unregisterWith(handler.Value)
                                                                                         _TreeSwaptionEngine.Value)
...
*)
    ...
    internal new () = new TreeSwaptionEngineModel(null,null,null,null)
...
*)
    let mutable
        _TreeSwaptionEngine                        = make (fun () -> (createEvaluationDate _evaluationDate (fun () ->new TreeSwaptionEngine (model.Value, timeGrid.Value))))
    let _update                                    = triv _TreeSwaptionEngine (fun () -> (curryEvaluationDate _evaluationDate _TreeSwaptionEngine).Value.update()
                                                                                         _TreeSwaptionEngine.Value)
    let _setModel                                  (model : ICell<Handle<ShortRateModel>>)   
                                                   = triv _TreeSwaptionEngine (fun () -> (curryEvaluationDate _evaluationDate _TreeSwaptionEngine).Value.setModel(model.Value)
...
*)
    ...
    internal new () = new TreeSwaptionEngineModel1(null,null,null)
    member internal this.Inject v = _TreeSwaptionEngine <- v
    static member Cast (p : ICell<TreeSwaptionEngine>) = 
...
*)
    let mutable
        _TreeSwaptionEngine                        = make (fun () -> (createEvaluationDate _evaluationDate (fun () ->new TreeSwaptionEngine (model.Value, timeSteps.Value, termStructure.Value))))
    let _update                                    = triv _TreeSwaptionEngine (fun () -> (curryEvaluationDate _evaluationDate _TreeSwaptionEngine).Value.update()
                                                                                         _TreeSwaptionEngine.Value)
    let _setModel                                  (model : ICell<Handle<ShortRateModel>>)   
                                                   = triv _TreeSwaptionEngine (fun () -> (curryEvaluationDate _evaluationDate _TreeSwaptionEngine).Value.setModel(model.Value)
...
*)
    ...
    internal new () = new TreeSwaptionEngineModel2(null,null,null,null)
    member internal this.Inject v = _TreeSwaptionEngine <- v
    static member Cast (p : ICell<TreeSwaptionEngine>) = 
...
*)
    let mutable
        _TreeSwaptionEngine                        = make (fun () -> (createEvaluationDate _evaluationDate (fun () ->new TreeSwaptionEngine (model.Value, timeSteps.Value))))
    let _update                                    = triv _TreeSwaptionEngine (fun () -> (curryEvaluationDate _evaluationDate _TreeSwaptionEngine).Value.update()
                                                                                         _TreeSwaptionEngine.Value)
    let _setModel                                  (model : ICell<Handle<ShortRateModel>>)   
                                                   = triv _TreeSwaptionEngine (fun () -> (curryEvaluationDate _evaluationDate _TreeSwaptionEngine).Value.setModel(model.Value)
...
*)
    ...
    internal new () = new TreeSwaptionEngineModel3(null,null,null)
    member internal this.Inject v = _TreeSwaptionEngine <- v
    static member Cast (p : ICell<TreeSwaptionEngine>) = 
