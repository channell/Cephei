...
*)
    ...
    let _getExistingHelpers                        = cell (fun () -> _ConvexMonotoneInterpolation.Value.getExistingHelpers())
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _ConvexMonotoneInterpolation.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = cell (fun () -> _ConvexMonotoneInterpolation.Value.empty())
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _ConvexMonotoneInterpolation.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _ConvexMonotoneInterpolation.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = cell (fun () -> _ConvexMonotoneInterpolation.Value.update()
                                                                     _ConvexMonotoneInterpolation.Value)
    let _value                                     (x : ICell<double>)   
                                                   = cell (fun () -> _ConvexMonotoneInterpolation.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _ConvexMonotoneInterpolation.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = cell (fun () -> _ConvexMonotoneInterpolation.Value.xMax())
    let _xMin                                      = cell (fun () -> _ConvexMonotoneInterpolation.Value.xMin())
    let _allowsExtrapolation                       = cell (fun () -> _ConvexMonotoneInterpolation.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _ConvexMonotoneInterpolation.Value.disableExtrapolation(b.Value)
                                                                     _ConvexMonotoneInterpolation.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _ConvexMonotoneInterpolation.Value.enableExtrapolation(b.Value)
                                                                     _ConvexMonotoneInterpolation.Value)
    let _extrapolate                               = cell (fun () -> _ConvexMonotoneInterpolation.Value.extrapolate)
