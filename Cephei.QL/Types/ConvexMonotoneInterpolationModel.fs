...
*)
    let mutable
        _ConvexMonotoneInterpolation               = make (fun () -> new ConvexMonotoneInterpolation (xBegin.Value, size.Value, yBegin.Value, quadraticity.Value, monotonicity.Value, forcePositive.Value, flatFinalPeriod.Value, preExistingHelpers.Value))
    let _getExistingHelpers                        = triv _ConvexMonotoneInterpolation (fun () -> _ConvexMonotoneInterpolation.Value.getExistingHelpers())
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv _ConvexMonotoneInterpolation (fun () -> _ConvexMonotoneInterpolation.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = triv _ConvexMonotoneInterpolation (fun () -> _ConvexMonotoneInterpolation.Value.empty())
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv _ConvexMonotoneInterpolation (fun () -> _ConvexMonotoneInterpolation.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv _ConvexMonotoneInterpolation (fun () -> _ConvexMonotoneInterpolation.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = triv _ConvexMonotoneInterpolation (fun () -> _ConvexMonotoneInterpolation.Value.update()
                                                                                                  _ConvexMonotoneInterpolation.Value)
    let _value                                     (x : ICell<double>)   
                                                   = triv _ConvexMonotoneInterpolation (fun () -> _ConvexMonotoneInterpolation.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv _ConvexMonotoneInterpolation (fun () -> _ConvexMonotoneInterpolation.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = triv _ConvexMonotoneInterpolation (fun () -> _ConvexMonotoneInterpolation.Value.xMax())
    let _xMin                                      = triv _ConvexMonotoneInterpolation (fun () -> _ConvexMonotoneInterpolation.Value.xMin())
    let _allowsExtrapolation                       = triv _ConvexMonotoneInterpolation (fun () -> _ConvexMonotoneInterpolation.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv _ConvexMonotoneInterpolation (fun () -> _ConvexMonotoneInterpolation.Value.disableExtrapolation(b.Value)
                                                                                                  _ConvexMonotoneInterpolation.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv _ConvexMonotoneInterpolation (fun () -> _ConvexMonotoneInterpolation.Value.enableExtrapolation(b.Value)
                                                                                                  _ConvexMonotoneInterpolation.Value)
    let _extrapolate                               = triv _ConvexMonotoneInterpolation (fun () -> _ConvexMonotoneInterpolation.Value.extrapolate)
...
*)
    let mutable
        _ConvexMonotoneInterpolation               = make (fun () -> new ConvexMonotoneInterpolation (xBegin.Value, size.Value, yBegin.Value, quadraticity.Value, monotonicity.Value, forcePositive.Value, flatFinalPeriod.Value))
    let _getExistingHelpers                        = triv _ConvexMonotoneInterpolation (fun () -> _ConvexMonotoneInterpolation.Value.getExistingHelpers())
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv _ConvexMonotoneInterpolation (fun () -> _ConvexMonotoneInterpolation.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = triv _ConvexMonotoneInterpolation (fun () -> _ConvexMonotoneInterpolation.Value.empty())
