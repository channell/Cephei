...
(*
    Functions
*)
    let _ForwardRateAgreement                      = cell (fun () -> withEngine evaluationDate pricingEngine (new ForwardRateAgreement (valueDate.Value, maturityDate.Value, Type.Value, strikeForwardRate.Value, notionalAmount.Value, index.Value, discountCurve.Value)))
