...
*)
    let mutable
        _ForwardRateAgreement                      = make (fun () -> withEngine pricingEngine evaluationDate (new ForwardRateAgreement (valueDate.Value, maturityDate.Value, Type.Value, strikeForwardRate.Value, notionalAmount.Value, index.Value, discountCurve.Value)))
    let _forwardRate                               = triv _ForwardRateAgreement (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).forwardRate())
    let _isExpired                                 = triv _ForwardRateAgreement (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).isExpired())
    let _settlementDate                            = triv _ForwardRateAgreement (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).settlementDate())
    let _spotIncome                                (t : ICell<Handle<YieldTermStructure>>)   
                                                   = triv _ForwardRateAgreement (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).spotIncome(t.Value))
    let _spotValue                                 = triv _ForwardRateAgreement (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).spotValue())
    let _forwardValue                              = triv _ForwardRateAgreement (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).forwardValue())
    let _impliedYield                              (underlyingSpotValue : ICell<double>) (forwardValue : ICell<double>) (settlementDate : ICell<Date>) (compoundingConvention : ICell<Compounding>) (dayCounter : ICell<DayCounter>)   
                                                   = triv _ForwardRateAgreement (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).impliedYield(underlyingSpotValue.Value, forwardValue.Value, settlementDate.Value, compoundingConvention.Value, dayCounter.Value))
    let _CASH                                      = cell _ForwardRateAgreement (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).CASH())
    let _errorEstimate                             = triv _ForwardRateAgreement (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).errorEstimate())
    let _NPV                                       = cell _ForwardRateAgreement (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = triv _ForwardRateAgreement (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = triv _ForwardRateAgreement (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).setPricingEngine(e.Value)
                                                                                           _ForwardRateAgreement.Value)
    let _valuationDate                             = triv _ForwardRateAgreement (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).valuationDate())
