...
(*
    Functions
*)
    let _ForwardRateAgreement                      = cell (fun () -> withEngine _pricingEngine.Value (new ForwardRateAgreement (valueDate.Value, maturityDate.Value, Type.Value, strikeForwardRate.Value, notionalAmount.Value, index.Value, discountCurve.Value)))
    let _forwardRate                               = cell (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).forwardRate())
    let _isExpired                                 = cell (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).isExpired())
    let _settlementDate                            = cell (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).settlementDate())
    let _spotIncome                                (t : ICell<Handle<YieldTermStructure>>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).spotIncome(t.Value))
    let _spotValue                                 = cell (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).spotValue())
    let _forwardValue                              = cell (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).forwardValue())
    let _impliedYield                              (underlyingSpotValue : ICell<double>) (forwardValue : ICell<double>) (settlementDate : ICell<Date>) (compoundingConvention : ICell<Compounding>) (dayCounter : ICell<DayCounter>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).impliedYield(underlyingSpotValue.Value, forwardValue.Value, settlementDate.Value, compoundingConvention.Value, dayCounter.Value))
    let _CASH                                      = cell (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).CASH())
    let _errorEstimate                             = cell (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).errorEstimate())
    let _NPV                                       = cell (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).setPricingEngine(e.Value)
                                                                     _ForwardRateAgreement.Value)
    let _valuationDate                             = cell (fun () -> (withEvaluationDate _evaluationDate _ForwardRateAgreement).valuationDate())
