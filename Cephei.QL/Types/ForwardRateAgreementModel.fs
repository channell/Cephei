...
(*
    Functions
*)
    let _ForwardRateAgreement                      = triv (fun () -> withEngine _pricingEngine.Value (new ForwardRateAgreement (valueDate.Value, maturityDate.Value, Type.Value, strikeForwardRate.Value, notionalAmount.Value, index.Value, discountCurve.Value)))
