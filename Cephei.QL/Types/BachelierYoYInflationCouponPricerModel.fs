...
*)
    ...
    let _capletPrice                               (effectiveCap : ICell<double>)   
                                                   = cell (fun () -> _BachelierYoYInflationCouponPricer.Value.capletPrice(effectiveCap.Value))
    let _capletRate                                (effectiveCap : ICell<double>)   
                                                   = cell (fun () -> _BachelierYoYInflationCouponPricer.Value.capletRate(effectiveCap.Value))
    let _capletVolatility                          = cell (fun () -> _BachelierYoYInflationCouponPricer.Value.capletVolatility())
    let _floorletPrice                             (effectiveFloor : ICell<double>)   
                                                   = cell (fun () -> _BachelierYoYInflationCouponPricer.Value.floorletPrice(effectiveFloor.Value))
    let _floorletRate                              (effectiveFloor : ICell<double>)   
                                                   = cell (fun () -> _BachelierYoYInflationCouponPricer.Value.floorletRate(effectiveFloor.Value))
    let _initialize                                (coupon : ICell<InflationCoupon>)   
                                                   = cell (fun () -> _BachelierYoYInflationCouponPricer.Value.initialize(coupon.Value)
                                                                     _BachelierYoYInflationCouponPricer.Value)
    let _setCapletVolatility                       (capletVol : ICell<Handle<YoYOptionletVolatilitySurface>>)   
                                                   = cell (fun () -> _BachelierYoYInflationCouponPricer.Value.setCapletVolatility(capletVol.Value)
                                                                     _BachelierYoYInflationCouponPricer.Value)
    let _swapletPrice                              = cell (fun () -> _BachelierYoYInflationCouponPricer.Value.swapletPrice())
    let _swapletRate                               = cell (fun () -> _BachelierYoYInflationCouponPricer.Value.swapletRate())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _BachelierYoYInflationCouponPricer.Value.registerWith(handler.Value)
                                                                     _BachelierYoYInflationCouponPricer.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _BachelierYoYInflationCouponPricer.Value.unregisterWith(handler.Value)
                                                                     _BachelierYoYInflationCouponPricer.Value)
    let _update                                    = cell (fun () -> _BachelierYoYInflationCouponPricer.Value.update()
                                                                     _BachelierYoYInflationCouponPricer.Value)
