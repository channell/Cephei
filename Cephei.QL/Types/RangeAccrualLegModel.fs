...
*)
    let mutable
        _RangeAccrualLeg                           = make (fun () -> new RangeAccrualLeg (schedule.Value, index.Value))
    let _Leg                                       = triv _RangeAccrualLeg (fun () -> _RangeAccrualLeg.Value.Leg())
    let _withFixingDays                            (fixingDays : ICell<int>)   
                                                   = triv _RangeAccrualLeg (fun () -> _RangeAccrualLeg.Value.withFixingDays(fixingDays.Value))
    let _withFixingDays1                           (fixingDays : ICell<Generic.List<int>>)   
                                                   = triv _RangeAccrualLeg (fun () -> _RangeAccrualLeg.Value.withFixingDays(fixingDays.Value))
    let _withGearings                              (gearings : ICell<Generic.List<double>>)   
                                                   = triv _RangeAccrualLeg (fun () -> _RangeAccrualLeg.Value.withGearings(gearings.Value))
    let _withGearings1                             (gearing : ICell<double>)   
                                                   = triv _RangeAccrualLeg (fun () -> _RangeAccrualLeg.Value.withGearings(gearing.Value))
    let _withLowerTriggers                         (triggers : ICell<Generic.List<double>>)   
                                                   = triv _RangeAccrualLeg (fun () -> _RangeAccrualLeg.Value.withLowerTriggers(triggers.Value))
    let _withLowerTriggers1                        (trigger : ICell<double>)   
                                                   = triv _RangeAccrualLeg (fun () -> _RangeAccrualLeg.Value.withLowerTriggers(trigger.Value))
    let _withNotionals                             (notional : ICell<double>)   
                                                   = triv _RangeAccrualLeg (fun () -> _RangeAccrualLeg.Value.withNotionals(notional.Value))
    let _withNotionals1                            (notionals : ICell<Generic.List<double>>)   
                                                   = triv _RangeAccrualLeg (fun () -> _RangeAccrualLeg.Value.withNotionals(notionals.Value))
    let _withObservationConvention                 (convention : ICell<BusinessDayConvention>)   
                                                   = triv _RangeAccrualLeg (fun () -> _RangeAccrualLeg.Value.withObservationConvention(convention.Value))
    let _withObservationTenor                      (tenor : ICell<Period>)   
                                                   = triv _RangeAccrualLeg (fun () -> _RangeAccrualLeg.Value.withObservationTenor(tenor.Value))
    let _withPaymentAdjustment                     (convention : ICell<BusinessDayConvention>)   
                                                   = triv _RangeAccrualLeg (fun () -> _RangeAccrualLeg.Value.withPaymentAdjustment(convention.Value))
    let _withPaymentDayCounter                     (dayCounter : ICell<DayCounter>)   
                                                   = triv _RangeAccrualLeg (fun () -> _RangeAccrualLeg.Value.withPaymentDayCounter(dayCounter.Value))
    let _withSpreads                               (spreads : ICell<Generic.List<double>>)   
                                                   = triv _RangeAccrualLeg (fun () -> _RangeAccrualLeg.Value.withSpreads(spreads.Value))
    let _withSpreads1                              (spread : ICell<double>)   
                                                   = triv _RangeAccrualLeg (fun () -> _RangeAccrualLeg.Value.withSpreads(spread.Value))
    let _withUpperTriggers                         (trigger : ICell<double>)   
                                                   = triv _RangeAccrualLeg (fun () -> _RangeAccrualLeg.Value.withUpperTriggers(trigger.Value))
    let _withUpperTriggers1                        (triggers : ICell<Generic.List<double>>)   
                                                   = triv _RangeAccrualLeg (fun () -> _RangeAccrualLeg.Value.withUpperTriggers(triggers.Value))
