...
*)
    ...
    let _atmRate                                   (discountCurve : ICell<YieldTermStructure>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CapFloor).atmRate(discountCurve.Value))
    let _capRates                                  = cell (fun () -> (withEvaluationDate _evaluationDate _CapFloor).capRates())
    let _floatingLeg                               = cell (fun () -> (withEvaluationDate _evaluationDate _CapFloor).floatingLeg())
    let _floorRates                                = cell (fun () -> (withEvaluationDate _evaluationDate _CapFloor).floorRates())
    let _getType                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CapFloor).getType())
    let _impliedVolatility                         (targetValue : ICell<double>) (discountCurve : ICell<Handle<YieldTermStructure>>) (guess : ICell<double>) (accuracy : ICell<double>) (maxEvaluations : ICell<int>) (minVol : ICell<double>) (maxVol : ICell<double>) (Type : ICell<VolatilityType>) (displacement : ICell<double>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CapFloor).impliedVolatility(targetValue.Value, discountCurve.Value, guess.Value, accuracy.Value, maxEvaluations.Value, minVol.Value, maxVol.Value, Type.Value, displacement.Value))
    let _impliedVolatility1                        (targetValue : ICell<double>) (discountCurve : ICell<Handle<YieldTermStructure>>) (guess : ICell<double>) (accuracy : ICell<double>) (maxEvaluations : ICell<int>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CapFloor).impliedVolatility(targetValue.Value, discountCurve.Value, guess.Value, accuracy.Value, maxEvaluations.Value))
    let _isExpired                                 = cell (fun () -> (withEvaluationDate _evaluationDate _CapFloor).isExpired())
    let _lastFloatingRateCoupon                    = cell (fun () -> (withEvaluationDate _evaluationDate _CapFloor).lastFloatingRateCoupon())
    let _maturityDate                              = cell (fun () -> (withEvaluationDate _evaluationDate _CapFloor).maturityDate())
    let _optionlet                                 (i : ICell<int>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CapFloor).optionlet(i.Value))
    let _startDate                                 = cell (fun () -> (withEvaluationDate _evaluationDate _CapFloor).startDate())
    let _CASH                                      = cell (fun () -> (withEvaluationDate _evaluationDate _CapFloor).CASH())
    let _errorEstimate                             = cell (fun () -> (withEvaluationDate _evaluationDate _CapFloor).errorEstimate())
    let _NPV                                       = cell (fun () -> (withEvaluationDate _evaluationDate _CapFloor).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CapFloor).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CapFloor).setPricingEngine(e.Value)
                                                                     _CapFloor.Value)
    let _valuationDate                             = cell (fun () -> (withEvaluationDate _evaluationDate _CapFloor).valuationDate())
