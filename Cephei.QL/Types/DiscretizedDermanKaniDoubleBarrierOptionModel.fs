...
*)
    ...
    let _mandatoryTimes                            = cell (fun () -> _DiscretizedDermanKaniDoubleBarrierOption.Value.mandatoryTimes())
    let _reset                                     (size : ICell<int>)   
                                                   = cell (fun () -> _DiscretizedDermanKaniDoubleBarrierOption.Value.reset(size.Value)
                                                                     _DiscretizedDermanKaniDoubleBarrierOption.Value)
    let _adjustValues                              = cell (fun () -> _DiscretizedDermanKaniDoubleBarrierOption.Value.adjustValues()
                                                                     _DiscretizedDermanKaniDoubleBarrierOption.Value)
    let _initialize                                (Method : ICell<Lattice>) (t : ICell<double>)   
                                                   = cell (fun () -> _DiscretizedDermanKaniDoubleBarrierOption.Value.initialize(Method.Value, t.Value)
                                                                     _DiscretizedDermanKaniDoubleBarrierOption.Value)
    let _method                                    = cell (fun () -> _DiscretizedDermanKaniDoubleBarrierOption.Value.METHOD())
    let _partialRollback                           (To : ICell<double>)   
                                                   = cell (fun () -> _DiscretizedDermanKaniDoubleBarrierOption.Value.partialRollback(To.Value)
                                                                     _DiscretizedDermanKaniDoubleBarrierOption.Value)
    let _postAdjustValues                          = cell (fun () -> _DiscretizedDermanKaniDoubleBarrierOption.Value.postAdjustValues()
                                                                     _DiscretizedDermanKaniDoubleBarrierOption.Value)
    let _preAdjustValues                           = cell (fun () -> _DiscretizedDermanKaniDoubleBarrierOption.Value.preAdjustValues()
                                                                     _DiscretizedDermanKaniDoubleBarrierOption.Value)
    let _presentValue                              = cell (fun () -> _DiscretizedDermanKaniDoubleBarrierOption.Value.presentValue())
    let _rollback                                  (To : ICell<double>)   
                                                   = cell (fun () -> _DiscretizedDermanKaniDoubleBarrierOption.Value.rollback(To.Value)
                                                                     _DiscretizedDermanKaniDoubleBarrierOption.Value)
    let _setTime                                   (t : ICell<double>)   
                                                   = cell (fun () -> _DiscretizedDermanKaniDoubleBarrierOption.Value.setTime(t.Value)
                                                                     _DiscretizedDermanKaniDoubleBarrierOption.Value)
    let _setValues                                 (v : ICell<Vector>)   
                                                   = cell (fun () -> _DiscretizedDermanKaniDoubleBarrierOption.Value.setValues(v.Value)
                                                                     _DiscretizedDermanKaniDoubleBarrierOption.Value)
    let _time                                      = cell (fun () -> _DiscretizedDermanKaniDoubleBarrierOption.Value.time())
    let _values                                    = cell (fun () -> _DiscretizedDermanKaniDoubleBarrierOption.Value.values())
