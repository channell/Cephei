...
*)
    ...
    let _dayCounter                                = cell (fun () -> _LocalConstantVol.Value.dayCounter())
    let _maxDate                                   = cell (fun () -> _LocalConstantVol.Value.maxDate())
    let _maxStrike                                 = cell (fun () -> _LocalConstantVol.Value.maxStrike())
    let _minStrike                                 = cell (fun () -> _LocalConstantVol.Value.minStrike())
    let _localVol                                  (t : ICell<double>) (underlyingLevel : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _LocalConstantVol.Value.localVol(t.Value, underlyingLevel.Value, extrapolate.Value))
    let _localVol1                                 (d : ICell<Date>) (underlyingLevel : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _LocalConstantVol.Value.localVol(d.Value, underlyingLevel.Value, extrapolate.Value))
    let _businessDayConvention                     = cell (fun () -> _LocalConstantVol.Value.businessDayConvention())
    let _optionDateFromTenor                       (p : ICell<Period>)   
                                                   = cell (fun () -> _LocalConstantVol.Value.optionDateFromTenor(p.Value))
    let _calendar                                  = cell (fun () -> _LocalConstantVol.Value.calendar())
    let _maxTime                                   = cell (fun () -> _LocalConstantVol.Value.maxTime())
    let _referenceDate                             = cell (fun () -> _LocalConstantVol.Value.referenceDate())
    let _settlementDays                            = cell (fun () -> _LocalConstantVol.Value.settlementDays())
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = cell (fun () -> _LocalConstantVol.Value.timeFromReference(date.Value))
    let _update                                    = cell (fun () -> _LocalConstantVol.Value.update()
                                                                     _LocalConstantVol.Value)
    let _allowsExtrapolation                       = cell (fun () -> _LocalConstantVol.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _LocalConstantVol.Value.disableExtrapolation(b.Value)
                                                                     _LocalConstantVol.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _LocalConstantVol.Value.enableExtrapolation(b.Value)
                                                                     _LocalConstantVol.Value)
    let _extrapolate                               = cell (fun () -> _LocalConstantVol.Value.extrapolate)
