...
*)
    let mutable
        _LocalConstantVol                          = make (fun () -> new LocalConstantVol (settlementDays.Value, calendar.Value, volatility.Value, dayCounter.Value))
    let _dayCounter                                = triv _LocalConstantVol (fun () -> _LocalConstantVol.Value.dayCounter())
    let _maxDate                                   = triv _LocalConstantVol (fun () -> _LocalConstantVol.Value.maxDate())
    let _maxStrike                                 = triv _LocalConstantVol (fun () -> _LocalConstantVol.Value.maxStrike())
    let _minStrike                                 = triv _LocalConstantVol (fun () -> _LocalConstantVol.Value.minStrike())
    let _localVol                                  (t : ICell<double>) (underlyingLevel : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _LocalConstantVol (fun () -> _LocalConstantVol.Value.localVol(t.Value, underlyingLevel.Value, extrapolate.Value))
    let _localVol1                                 (d : ICell<Date>) (underlyingLevel : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _LocalConstantVol (fun () -> _LocalConstantVol.Value.localVol(d.Value, underlyingLevel.Value, extrapolate.Value))
    let _businessDayConvention                     = triv _LocalConstantVol (fun () -> _LocalConstantVol.Value.businessDayConvention())
    let _optionDateFromTenor                       (p : ICell<Period>)   
                                                   = triv _LocalConstantVol (fun () -> _LocalConstantVol.Value.optionDateFromTenor(p.Value))
    let _calendar                                  = triv _LocalConstantVol (fun () -> _LocalConstantVol.Value.calendar())
    let _maxTime                                   = triv _LocalConstantVol (fun () -> _LocalConstantVol.Value.maxTime())
    let _referenceDate                             = triv _LocalConstantVol (fun () -> _LocalConstantVol.Value.referenceDate())
    let _settlementDays                            = triv _LocalConstantVol (fun () -> _LocalConstantVol.Value.settlementDays())
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = triv _LocalConstantVol (fun () -> _LocalConstantVol.Value.timeFromReference(date.Value))
    let _update                                    = triv _LocalConstantVol (fun () -> _LocalConstantVol.Value.update()
                                                                                       _LocalConstantVol.Value)
    let _allowsExtrapolation                       = triv _LocalConstantVol (fun () -> _LocalConstantVol.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv _LocalConstantVol (fun () -> _LocalConstantVol.Value.disableExtrapolation(b.Value)
                                                                                       _LocalConstantVol.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv _LocalConstantVol (fun () -> _LocalConstantVol.Value.enableExtrapolation(b.Value)
                                                                                       _LocalConstantVol.Value)
    let _extrapolate                               = triv _LocalConstantVol (fun () -> _LocalConstantVol.Value.extrapolate)
...
*)
    let mutable
        _LocalConstantVol                          = make (fun () -> new LocalConstantVol (referenceDate.Value, volatility.Value, dc.Value))
    let _dayCounter                                = triv _LocalConstantVol (fun () -> _LocalConstantVol.Value.dayCounter())
    let _maxDate                                   = triv _LocalConstantVol (fun () -> _LocalConstantVol.Value.maxDate())
    let _maxStrike                                 = triv _LocalConstantVol (fun () -> _LocalConstantVol.Value.maxStrike())
    let _minStrike                                 = triv _LocalConstantVol (fun () -> _LocalConstantVol.Value.minStrike())
