...
*)
    ...
    let _Equals                                    (o : ICell<Object>)   
                                                   = triv (fun () -> _BRLCurrency.Value.Equals(o.Value))
    let _format                                    = triv (fun () -> _BRLCurrency.Value.format)
    let _fractionsPerUnit                          = triv (fun () -> _BRLCurrency.Value.fractionsPerUnit)
    let _fractionSymbol                            = triv (fun () -> _BRLCurrency.Value.fractionSymbol)
    let _name                                      = triv (fun () -> _BRLCurrency.Value.name)
    let _numericCode                               = triv (fun () -> _BRLCurrency.Value.numericCode)
    let _rounding                                  = triv (fun () -> _BRLCurrency.Value.rounding)
    let _symbol                                    = triv (fun () -> _BRLCurrency.Value.symbol)
    let _ToString                                  = triv (fun () -> _BRLCurrency.Value.ToString())
    let _triangulationCurrency                     = triv (fun () -> _BRLCurrency.Value.triangulationCurrency)
