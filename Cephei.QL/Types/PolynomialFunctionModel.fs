...
*)
    let mutable
        _PolynomialFunction                        = make (fun () -> new PolynomialFunction (coeff.Value))
    let _coefficients                              = triv _PolynomialFunction (fun () -> _PolynomialFunction.Value.coefficients())
    let _definiteDerivativeCoefficients            (t : ICell<double>) (t2 : ICell<double>)   
                                                   = triv _PolynomialFunction (fun () -> _PolynomialFunction.Value.definiteDerivativeCoefficients(t.Value, t2.Value))
    let _definiteIntegral                          (t1 : ICell<double>) (t2 : ICell<double>)   
                                                   = triv _PolynomialFunction (fun () -> _PolynomialFunction.Value.definiteIntegral(t1.Value, t2.Value))
    let _definiteIntegralCoefficients              (t : ICell<double>) (t2 : ICell<double>)   
                                                   = triv _PolynomialFunction (fun () -> _PolynomialFunction.Value.definiteIntegralCoefficients(t.Value, t2.Value))
    let _derivative                                (t : ICell<double>)   
                                                   = triv _PolynomialFunction (fun () -> _PolynomialFunction.Value.derivative(t.Value))
    let _derivativeCoefficients                    = triv _PolynomialFunction (fun () -> _PolynomialFunction.Value.derivativeCoefficients())
    let _order                                     = triv _PolynomialFunction (fun () -> _PolynomialFunction.Value.order())
    let _primitive                                 (t : ICell<double>)   
                                                   = triv _PolynomialFunction (fun () -> _PolynomialFunction.Value.primitive(t.Value))
    let _primitiveCoefficients                     = triv _PolynomialFunction (fun () -> _PolynomialFunction.Value.primitiveCoefficients())
    let _value                                     (t : ICell<double>)   
                                                   = triv _PolynomialFunction (fun () -> _PolynomialFunction.Value.value(t.Value))
