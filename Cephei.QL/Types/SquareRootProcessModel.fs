...
*)
    let mutable
        _SquareRootProcess                         = make (fun () -> new SquareRootProcess (b.Value, a.Value, sigma.Value, x0.Value, disc.Value))
    let _diffusion                                 (UnnamedParameter1 : ICell<double>) (x : ICell<double>)   
                                                   = triv _SquareRootProcess (fun () -> _SquareRootProcess.Value.diffusion(UnnamedParameter1.Value, x.Value))
    let _drift                                     (UnnamedParameter1 : ICell<double>) (x : ICell<double>)   
                                                   = triv _SquareRootProcess (fun () -> _SquareRootProcess.Value.drift(UnnamedParameter1.Value, x.Value))
    let _x0                                        = triv _SquareRootProcess (fun () -> _SquareRootProcess.Value.x0())
    let _apply                                     (x0 : ICell<double>) (dx : ICell<double>)   
                                                   = triv _SquareRootProcess (fun () -> _SquareRootProcess.Value.apply(x0.Value, dx.Value))
    let _apply1                                    (x0 : ICell<Vector>) (dx : ICell<Vector>)   
                                                   = triv _SquareRootProcess (fun () -> _SquareRootProcess.Value.apply(x0.Value, dx.Value))
    let _evolve                                    (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>) (dw : ICell<Vector>)   
                                                   = triv _SquareRootProcess (fun () -> _SquareRootProcess.Value.evolve(t0.Value, x0.Value, dt.Value, dw.Value))
    ...
    let _expectation                               (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>)   
                                                   = triv _SquareRootProcess (fun () -> _SquareRootProcess.Value.expectation(t0.Value, x0.Value, dt.Value))
    let _expectation1                              (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = triv _SquareRootProcess (fun () -> _SquareRootProcess.Value.expectation(t0.Value, x0.Value, dt.Value))
    let _initialValues                             = triv _SquareRootProcess (fun () -> _SquareRootProcess.Value.initialValues())
    let _size                                      = triv _SquareRootProcess (fun () -> _SquareRootProcess.Value.size())
    let _stdDeviation                              (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>)   
                                                   = triv _SquareRootProcess (fun () -> _SquareRootProcess.Value.stdDeviation(t0.Value, x0.Value, dt.Value))
    ...
    let _variance                                  (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>)   
                                                   = triv _SquareRootProcess (fun () -> _SquareRootProcess.Value.variance(t0.Value, x0.Value, dt.Value))
    ...
    let _covariance                                (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>)   
                                                   = triv _SquareRootProcess (fun () -> _SquareRootProcess.Value.covariance(t0.Value, x0.Value, dt.Value))
    let _factors                                   = triv _SquareRootProcess (fun () -> _SquareRootProcess.Value.factors())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv _SquareRootProcess (fun () -> _SquareRootProcess.Value.registerWith(handler.Value)
                                                                                        _SquareRootProcess.Value)
    let _time                                      (d : ICell<Date>)   
                                                   = triv _SquareRootProcess (fun () -> _SquareRootProcess.Value.time(d.Value))
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = triv _SquareRootProcess (fun () -> _SquareRootProcess.Value.unregisterWith(handler.Value)
                                                                                        _SquareRootProcess.Value)
    let _update                                    = triv _SquareRootProcess (fun () -> _SquareRootProcess.Value.update()
                                                                                        _SquareRootProcess.Value)
...
*)
    let mutable
        _SquareRootProcess                         = make (fun () -> new SquareRootProcess (b.Value, a.Value, sigma.Value))
    let _diffusion                                 (UnnamedParameter1 : ICell<double>) (x : ICell<double>)   
                                                   = triv _SquareRootProcess (fun () -> _SquareRootProcess.Value.diffusion(UnnamedParameter1.Value, x.Value))
    let _drift                                     (UnnamedParameter1 : ICell<double>) (x : ICell<double>)   
                                                   = triv _SquareRootProcess (fun () -> _SquareRootProcess.Value.drift(UnnamedParameter1.Value, x.Value))
...
*)
    let mutable
        _SquareRootProcess                         = make (fun () -> new SquareRootProcess (b.Value, a.Value, sigma.Value, x0.Value))
    let _diffusion                                 (UnnamedParameter1 : ICell<double>) (x : ICell<double>)   
                                                   = triv _SquareRootProcess (fun () -> _SquareRootProcess.Value.diffusion(UnnamedParameter1.Value, x.Value))
    let _drift                                     (UnnamedParameter1 : ICell<double>) (x : ICell<double>)   
                                                   = triv _SquareRootProcess (fun () -> _SquareRootProcess.Value.drift(UnnamedParameter1.Value, x.Value))
