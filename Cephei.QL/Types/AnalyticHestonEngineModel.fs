...
*)
    let mutable
        _AnalyticHestonEngine                      = make (fun () -> (createEvaluationDate _evaluationDate (fun () ->new AnalyticHestonEngine (model.Value, relTolerance.Value, maxEvaluations.Value))))
    let _numberOfEvaluations                       = triv _AnalyticHestonEngine (fun () -> (curryEvaluationDate _evaluationDate _AnalyticHestonEngine).Value.numberOfEvaluations())
    let _setModel                                  (model : ICell<Handle<HestonModel>>)   
                                                   = triv _AnalyticHestonEngine (fun () -> (curryEvaluationDate _evaluationDate _AnalyticHestonEngine).Value.setModel(model.Value)
                                                                                           _AnalyticHestonEngine.Value)
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv _AnalyticHestonEngine (fun () -> (curryEvaluationDate _evaluationDate _AnalyticHestonEngine).Value.registerWith(handler.Value)
                                                                                           _AnalyticHestonEngine.Value)
    let _reset                                     = triv _AnalyticHestonEngine (fun () -> (curryEvaluationDate _evaluationDate _AnalyticHestonEngine).Value.reset()
                                                                                           _AnalyticHestonEngine.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = triv _AnalyticHestonEngine (fun () -> (curryEvaluationDate _evaluationDate _AnalyticHestonEngine).Value.unregisterWith(handler.Value)
                                                                                           _AnalyticHestonEngine.Value)
    let _update                                    = triv _AnalyticHestonEngine (fun () -> (curryEvaluationDate _evaluationDate _AnalyticHestonEngine).Value.update()
                                                                                           _AnalyticHestonEngine.Value)
...
*)
    let mutable
        _AnalyticHestonEngine                      = make (fun () -> (createEvaluationDate _evaluationDate (fun () ->new AnalyticHestonEngine (model.Value, integrationOrder.Value))))
    let _numberOfEvaluations                       = triv _AnalyticHestonEngine (fun () -> (curryEvaluationDate _evaluationDate _AnalyticHestonEngine).Value.numberOfEvaluations())
    let _setModel                                  (model : ICell<Handle<HestonModel>>)   
                                                   = triv _AnalyticHestonEngine (fun () -> (curryEvaluationDate _evaluationDate _AnalyticHestonEngine).Value.setModel(model.Value)
                                                                                           _AnalyticHestonEngine.Value)
...
*)
    let mutable
        _AnalyticHestonEngine                      = make (fun () -> (createEvaluationDate _evaluationDate (fun () ->new AnalyticHestonEngine (model.Value, cpxLog.Value, integration.Value))))
    let _numberOfEvaluations                       = triv _AnalyticHestonEngine (fun () -> (curryEvaluationDate _evaluationDate _AnalyticHestonEngine).Value.numberOfEvaluations())
    let _setModel                                  (model : ICell<Handle<HestonModel>>)   
                                                   = triv _AnalyticHestonEngine (fun () -> (curryEvaluationDate _evaluationDate _AnalyticHestonEngine).Value.setModel(model.Value)
                                                                                           _AnalyticHestonEngine.Value)
