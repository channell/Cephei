...
(*
    Functions
*)
    let _DividendVanillaOption                     = triv (fun () -> withEngine _pricingEngine.Value (new DividendVanillaOption (payoff.Value, exercise.Value, dividendDates.Value, dividends.Value)))
