...
*)
    ...
    let _impliedVolatility                         (targetValue : ICell<double>) (Process : ICell<GeneralizedBlackScholesProcess>) (accuracy : ICell<double>) (maxEvaluations : ICell<int>) (minVol : ICell<double>) (maxVol : ICell<double>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _DividendVanillaOption).impliedVolatility(targetValue.Value, Process.Value, accuracy.Value, maxEvaluations.Value, minVol.Value, maxVol.Value))
    let _delta                                     = cell (fun () -> (withEvaluationDate _evaluationDate _DividendVanillaOption).delta())
    let _deltaForward                              = cell (fun () -> (withEvaluationDate _evaluationDate _DividendVanillaOption).deltaForward())
    let _dividendRho                               = cell (fun () -> (withEvaluationDate _evaluationDate _DividendVanillaOption).dividendRho())
    let _elasticity                                = cell (fun () -> (withEvaluationDate _evaluationDate _DividendVanillaOption).elasticity())
    let _gamma                                     = cell (fun () -> (withEvaluationDate _evaluationDate _DividendVanillaOption).gamma())
    let _isExpired                                 = cell (fun () -> (withEvaluationDate _evaluationDate _DividendVanillaOption).isExpired())
    let _itmCashProbability                        = cell (fun () -> (withEvaluationDate _evaluationDate _DividendVanillaOption).itmCashProbability())
    let _rho                                       = cell (fun () -> (withEvaluationDate _evaluationDate _DividendVanillaOption).rho())
    let _strikeSensitivity                         = cell (fun () -> (withEvaluationDate _evaluationDate _DividendVanillaOption).strikeSensitivity())
    let _theta                                     = cell (fun () -> (withEvaluationDate _evaluationDate _DividendVanillaOption).theta())
    let _thetaPerDay                               = cell (fun () -> (withEvaluationDate _evaluationDate _DividendVanillaOption).thetaPerDay())
    let _vega                                      = cell (fun () -> (withEvaluationDate _evaluationDate _DividendVanillaOption).vega())
    ...
    let _errorEstimate                             = cell (fun () -> (withEvaluationDate _evaluationDate _DividendVanillaOption).errorEstimate())
    let _NPV                                       = cell (fun () -> (withEvaluationDate _evaluationDate _DividendVanillaOption).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _DividendVanillaOption).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _DividendVanillaOption).setPricingEngine(e.Value)
                                                                     _DividendVanillaOption.Value)
    let _valuationDate                             = cell (fun () -> (withEvaluationDate _evaluationDate _DividendVanillaOption).valuationDate())
