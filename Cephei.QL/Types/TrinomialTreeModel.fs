...
*)
    ...
    let _dx                                        (i : ICell<int>)   
                                                   = triv (fun () -> _TrinomialTree.Value.dx(i.Value))
    let _probability                               (i : ICell<int>) (index : ICell<int>) (branch : ICell<int>)   
                                                   = triv (fun () -> _TrinomialTree.Value.probability(i.Value, index.Value, branch.Value))
    let _size                                      (i : ICell<int>)   
                                                   = triv (fun () -> _TrinomialTree.Value.size(i.Value))
    let _timeGrid                                  = triv (fun () -> _TrinomialTree.Value.timeGrid())
