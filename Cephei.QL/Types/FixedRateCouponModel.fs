...
*)
    ...
    let _accruedAmount                             (d : ICell<Date>)   
                                                   = cell (fun () -> _FixedRateCoupon.Value.accruedAmount(d.Value))
    let _amount                                    = cell (fun () -> _FixedRateCoupon.Value.amount())
    let _dayCounter                                = cell (fun () -> _FixedRateCoupon.Value.dayCounter())
    let _interestRate                              = cell (fun () -> _FixedRateCoupon.Value.interestRate())
    let _rate                                      = cell (fun () -> _FixedRateCoupon.Value.rate())
    let _accrualDays                               = cell (fun () -> _FixedRateCoupon.Value.accrualDays())
    let _accrualEndDate                            = cell (fun () -> _FixedRateCoupon.Value.accrualEndDate())
    let _accrualPeriod                             = cell (fun () -> _FixedRateCoupon.Value.accrualPeriod())
    let _accrualStartDate                          = cell (fun () -> _FixedRateCoupon.Value.accrualStartDate())
    let _accruedDays                               (d : ICell<Date>)   
                                                   = cell (fun () -> _FixedRateCoupon.Value.accruedDays(d.Value))
    let _accruedPeriod                             (d : ICell<Date>)   
                                                   = cell (fun () -> _FixedRateCoupon.Value.accruedPeriod(d.Value))
    let _date                                      = cell (fun () -> _FixedRateCoupon.Value.date())
    let _exCouponDate                              = cell (fun () -> _FixedRateCoupon.Value.exCouponDate())
    let _nominal                                   = cell (fun () -> _FixedRateCoupon.Value.nominal())
    let _referencePeriodEnd                        = cell (fun () -> _FixedRateCoupon.Value.referencePeriodEnd)
    let _referencePeriodStart                      = cell (fun () -> _FixedRateCoupon.Value.referencePeriodStart)
    let _CompareTo                                 (cf : ICell<CashFlow>)   
                                                   = cell (fun () -> _FixedRateCoupon.Value.CompareTo(cf.Value))
    let _Equals                                    (cf : ICell<Object>)   
                                                   = cell (fun () -> _FixedRateCoupon.Value.Equals(cf.Value))
    let _hasOccurred                               (refDate : ICell<Date>) (includeRefDate : ICell<Nullable<bool>>)   
                                                   = cell (fun () -> _FixedRateCoupon.Value.hasOccurred(refDate.Value, includeRefDate.Value))
    let _tradingExCoupon                           (refDate : ICell<Date>)   
                                                   = cell (fun () -> _FixedRateCoupon.Value.tradingExCoupon(refDate.Value))
    let _accept                                    (v : ICell<IAcyclicVisitor>)   
                                                   = cell (fun () -> _FixedRateCoupon.Value.accept(v.Value)
                                                                     _FixedRateCoupon.Value)
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _FixedRateCoupon.Value.registerWith(handler.Value)
                                                                     _FixedRateCoupon.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _FixedRateCoupon.Value.unregisterWith(handler.Value)
                                                                     _FixedRateCoupon.Value)
