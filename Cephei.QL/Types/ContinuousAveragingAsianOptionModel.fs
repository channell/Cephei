...
(*
    Functions
*)
    let _ContinuousAveragingAsianOption            = cell (fun () -> withEngine evaluationDate pricingEngine (new ContinuousAveragingAsianOption (averageType.Value, payoff.Value, exercise.Value)))
