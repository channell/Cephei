...
*)
    let mutable
        _ContinuousAveragingAsianOption            = cell (fun () -> withEngine pricingEngine evaluationDate (new ContinuousAveragingAsianOption (averageType.Value, payoff.Value, exercise.Value)))
