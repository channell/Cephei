...
*)
    ...
    let _covariance                                (t : ICell<double>) (T2 : ICell<double>) (S : ICell<double>)   
                                                   = cell (fun () -> _AbcdFunction.Value.covariance(t.Value, T2.Value, S.Value))
    let _covariance1                               (t1 : ICell<double>) (t2 : ICell<double>) (T : ICell<double>) (S : ICell<double>)   
                                                   = cell (fun () -> _AbcdFunction.Value.covariance(t1.Value, t2.Value, T.Value, S.Value))
    let _instantaneousCovariance                   (u : ICell<double>) (T : ICell<double>) (S : ICell<double>)   
                                                   = cell (fun () -> _AbcdFunction.Value.instantaneousCovariance(u.Value, T.Value, S.Value))
    let _instantaneousVariance                     (u : ICell<double>) (T : ICell<double>)   
                                                   = cell (fun () -> _AbcdFunction.Value.instantaneousVariance(u.Value, T.Value))
    let _instantaneousVolatility                   (u : ICell<double>) (T : ICell<double>)   
                                                   = cell (fun () -> _AbcdFunction.Value.instantaneousVolatility(u.Value, T.Value))
    let _longTermVolatility                        = cell (fun () -> _AbcdFunction.Value.longTermVolatility())
    let _maximumVolatility                         = cell (fun () -> _AbcdFunction.Value.maximumVolatility())
    let _primitive                                 (t : ICell<double>) (T2 : ICell<double>) (S : ICell<double>)   
                                                   = cell (fun () -> _AbcdFunction.Value.primitive(t.Value, T2.Value, S.Value))
    let _shortTermVolatility                       = cell (fun () -> _AbcdFunction.Value.shortTermVolatility())
    let _variance                                  (tMin : ICell<double>) (tMax : ICell<double>) (T : ICell<double>)   
                                                   = cell (fun () -> _AbcdFunction.Value.variance(tMin.Value, tMax.Value, T.Value))
    let _volatility                                (tMin : ICell<double>) (tMax : ICell<double>) (T : ICell<double>)   
                                                   = cell (fun () -> _AbcdFunction.Value.volatility(tMin.Value, tMax.Value, T.Value))
    let _a                                         = cell (fun () -> _AbcdFunction.Value.a())
    let _b                                         = cell (fun () -> _AbcdFunction.Value.b())
    let _c                                         = cell (fun () -> _AbcdFunction.Value.c())
    let _coefficients                              = cell (fun () -> _AbcdFunction.Value.coefficients())
    let _d                                         = cell (fun () -> _AbcdFunction.Value.d())
    let _definiteDerivativeCoefficients            (t : ICell<double>) (t2 : ICell<double>)   
                                                   = cell (fun () -> _AbcdFunction.Value.definiteDerivativeCoefficients(t.Value, t2.Value))
    let _definiteIntegral                          (t1 : ICell<double>) (t2 : ICell<double>)   
                                                   = cell (fun () -> _AbcdFunction.Value.definiteIntegral(t1.Value, t2.Value))
    let _definiteIntegralCoefficients              (t : ICell<double>) (t2 : ICell<double>)   
                                                   = cell (fun () -> _AbcdFunction.Value.definiteIntegralCoefficients(t.Value, t2.Value))
    let _derivative                                (t : ICell<double>)   
                                                   = cell (fun () -> _AbcdFunction.Value.derivative(t.Value))
    let _derivativeCoefficients                    = cell (fun () -> _AbcdFunction.Value.derivativeCoefficients())
    let _longTermValue                             = cell (fun () -> _AbcdFunction.Value.longTermValue())
    let _maximumLocation                           = cell (fun () -> _AbcdFunction.Value.maximumLocation())
    let _maximumValue                              = cell (fun () -> _AbcdFunction.Value.maximumValue())
    let _value                                     (t : ICell<double>)   
                                                   = cell (fun () -> _AbcdFunction.Value.value(t.Value))
