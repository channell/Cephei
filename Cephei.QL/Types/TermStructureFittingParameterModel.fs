...
*)
    let mutable
        _TermStructureFittingParameter             = make (fun () -> new TermStructureFittingParameter (impl.Value))
    let _constraint                                = triv _TermStructureFittingParameter (fun () -> _TermStructureFittingParameter.Value.CONSTRAINT())
    let _implementation                            = triv _TermStructureFittingParameter (fun () -> _TermStructureFittingParameter.Value.implementation())
    let _parameters                                = triv _TermStructureFittingParameter (fun () -> _TermStructureFittingParameter.Value.parameters())
    let _setParam                                  (i : ICell<int>) (x : ICell<double>)   
                                                   = triv _TermStructureFittingParameter (fun () -> _TermStructureFittingParameter.Value.setParam(i.Value, x.Value)
                                                                                                    _TermStructureFittingParameter.Value)
    let _size                                      = triv _TermStructureFittingParameter (fun () -> _TermStructureFittingParameter.Value.size())
    let _testParams                                (p : ICell<Vector>)   
                                                   = triv _TermStructureFittingParameter (fun () -> _TermStructureFittingParameter.Value.testParams(p.Value))
    let _value                                     (t : ICell<double>)   
                                                   = triv _TermStructureFittingParameter (fun () -> _TermStructureFittingParameter.Value.value(t.Value))
...
*)
    let mutable
        _TermStructureFittingParameter             = make (fun () -> new TermStructureFittingParameter (term.Value))
    let _constraint                                = triv _TermStructureFittingParameter (fun () -> _TermStructureFittingParameter.Value.CONSTRAINT())
    let _implementation                            = triv _TermStructureFittingParameter (fun () -> _TermStructureFittingParameter.Value.implementation())
    let _parameters                                = triv _TermStructureFittingParameter (fun () -> _TermStructureFittingParameter.Value.parameters())
    let _setParam                                  (i : ICell<int>) (x : ICell<double>)   
