...
*)
    ...
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _MixedLinearParabolic.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = cell (fun () -> _MixedLinearParabolic.Value.empty())
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _MixedLinearParabolic.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _MixedLinearParabolic.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = cell (fun () -> _MixedLinearParabolic.Value.update()
                                                                     _MixedLinearParabolic.Value)
    let _value                                     (x : ICell<double>)   
                                                   = cell (fun () -> _MixedLinearParabolic.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _MixedLinearParabolic.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = cell (fun () -> _MixedLinearParabolic.Value.xMax())
    let _xMin                                      = cell (fun () -> _MixedLinearParabolic.Value.xMin())
    let _allowsExtrapolation                       = cell (fun () -> _MixedLinearParabolic.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _MixedLinearParabolic.Value.disableExtrapolation(b.Value)
                                                                     _MixedLinearParabolic.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _MixedLinearParabolic.Value.enableExtrapolation(b.Value)
                                                                     _MixedLinearParabolic.Value)
    let _extrapolate                               = cell (fun () -> _MixedLinearParabolic.Value.extrapolate)
