...
*)
    let mutable
        _LogCubicInterpolation                     = make (fun () -> new LogCubicInterpolation (xBegin.Value, size.Value, yBegin.Value, da.Value, monotonic.Value, leftC.Value, leftConditionValue.Value, rightC.Value, rightConditionValue.Value))
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv _LogCubicInterpolation (fun () -> _LogCubicInterpolation.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = triv _LogCubicInterpolation (fun () -> _LogCubicInterpolation.Value.empty())
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv _LogCubicInterpolation (fun () -> _LogCubicInterpolation.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv _LogCubicInterpolation (fun () -> _LogCubicInterpolation.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = triv _LogCubicInterpolation (fun () -> _LogCubicInterpolation.Value.update()
                                                                                            _LogCubicInterpolation.Value)
    let _value                                     (x : ICell<double>)   
                                                   = triv _LogCubicInterpolation (fun () -> _LogCubicInterpolation.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv _LogCubicInterpolation (fun () -> _LogCubicInterpolation.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = triv _LogCubicInterpolation (fun () -> _LogCubicInterpolation.Value.xMax())
    let _xMin                                      = triv _LogCubicInterpolation (fun () -> _LogCubicInterpolation.Value.xMin())
    let _allowsExtrapolation                       = triv _LogCubicInterpolation (fun () -> _LogCubicInterpolation.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv _LogCubicInterpolation (fun () -> _LogCubicInterpolation.Value.disableExtrapolation(b.Value)
                                                                                            _LogCubicInterpolation.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv _LogCubicInterpolation (fun () -> _LogCubicInterpolation.Value.enableExtrapolation(b.Value)
                                                                                            _LogCubicInterpolation.Value)
    let _extrapolate                               = triv _LogCubicInterpolation (fun () -> _LogCubicInterpolation.Value.extrapolate)
