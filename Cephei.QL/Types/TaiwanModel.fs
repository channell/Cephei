...
*)
    let mutable
        _Taiwan                                    = make (fun () -> new Taiwan ())
    let _addedHolidays                             = triv _Taiwan (fun () -> _Taiwan.Value.addedHolidays)
    let _addHoliday                                (d : ICell<Date>)   
                                                   = triv _Taiwan (fun () -> _Taiwan.Value.addHoliday(d.Value)
                                                                             _Taiwan.Value)
    let _adjust                                    (d : ICell<Date>) (c : ICell<BusinessDayConvention>)   
                                                   = triv _Taiwan (fun () -> _Taiwan.Value.adjust(d.Value, c.Value))
    let _advance                                   (d : ICell<Date>) (p : ICell<Period>) (c : ICell<BusinessDayConvention>) (endOfMonth : ICell<bool>)   
                                                   = triv _Taiwan (fun () -> _Taiwan.Value.advance(d.Value, p.Value, c.Value, endOfMonth.Value))
    let _advance1                                  (d : ICell<Date>) (n : ICell<int>) (unit : ICell<TimeUnit>) (c : ICell<BusinessDayConvention>) (endOfMonth : ICell<bool>)   
                                                   = triv _Taiwan (fun () -> _Taiwan.Value.advance(d.Value, n.Value, unit.Value, c.Value, endOfMonth.Value))
    let _businessDaysBetween                       (from : ICell<Date>) (To : ICell<Date>) (includeFirst : ICell<bool>) (includeLast : ICell<bool>)   
                                                   = triv _Taiwan (fun () -> _Taiwan.Value.businessDaysBetween(from.Value, To.Value, includeFirst.Value, includeLast.Value))
    let _calendar                                  = triv _Taiwan (fun () -> _Taiwan.Value.calendar)
    let _empty                                     = triv _Taiwan (fun () -> _Taiwan.Value.empty())
    let _endOfMonth                                (d : ICell<Date>)   
                                                   = triv _Taiwan (fun () -> _Taiwan.Value.endOfMonth(d.Value))
    let _Equals                                    (o : ICell<Object>)   
                                                   = triv _Taiwan (fun () -> _Taiwan.Value.Equals(o.Value))
    let _isBusinessDay                             (d : ICell<Date>)   
                                                   = triv _Taiwan (fun () -> _Taiwan.Value.isBusinessDay(d.Value))
    let _isEndOfMonth                              (d : ICell<Date>)   
                                                   = triv _Taiwan (fun () -> _Taiwan.Value.isEndOfMonth(d.Value))
    let _isHoliday                                 (d : ICell<Date>)   
                                                   = triv _Taiwan (fun () -> _Taiwan.Value.isHoliday(d.Value))
    let _isWeekend                                 (w : ICell<DayOfWeek>)   
                                                   = triv _Taiwan (fun () -> _Taiwan.Value.isWeekend(w.Value))
    let _name                                      = triv _Taiwan (fun () -> _Taiwan.Value.name())
    let _removedHolidays                           = triv _Taiwan (fun () -> _Taiwan.Value.removedHolidays)
    let _removeHoliday                             (d : ICell<Date>)   
                                                   = triv _Taiwan (fun () -> _Taiwan.Value.removeHoliday(d.Value)
                                                                             _Taiwan.Value)
