...
*)
    let mutable
        _DiscretizedOption                         = make (fun () -> new DiscretizedOption (underlying.Value, exerciseType.Value, exerciseTimes.Value))
    let _mandatoryTimes                            = triv _DiscretizedOption (fun () -> _DiscretizedOption.Value.mandatoryTimes())
    let _reset                                     (size : ICell<int>)   
                                                   = triv _DiscretizedOption (fun () -> _DiscretizedOption.Value.reset(size.Value)
                                                                                        _DiscretizedOption.Value)
    let _adjustValues                              = triv _DiscretizedOption (fun () -> _DiscretizedOption.Value.adjustValues()
                                                                                        _DiscretizedOption.Value)
    let _initialize                                (Method : ICell<Lattice>) (t : ICell<double>)   
                                                   = triv _DiscretizedOption (fun () -> _DiscretizedOption.Value.initialize(Method.Value, t.Value)
                                                                                        _DiscretizedOption.Value)
    let _method                                    = triv _DiscretizedOption (fun () -> _DiscretizedOption.Value.METHOD())
    let _partialRollback                           (To : ICell<double>)   
                                                   = triv _DiscretizedOption (fun () -> _DiscretizedOption.Value.partialRollback(To.Value)
                                                                                        _DiscretizedOption.Value)
    let _postAdjustValues                          = triv _DiscretizedOption (fun () -> _DiscretizedOption.Value.postAdjustValues()
                                                                                        _DiscretizedOption.Value)
    let _preAdjustValues                           = triv _DiscretizedOption (fun () -> _DiscretizedOption.Value.preAdjustValues()
                                                                                        _DiscretizedOption.Value)
    let _presentValue                              = triv _DiscretizedOption (fun () -> _DiscretizedOption.Value.presentValue())
    let _rollback                                  (To : ICell<double>)   
                                                   = triv _DiscretizedOption (fun () -> _DiscretizedOption.Value.rollback(To.Value)
                                                                                        _DiscretizedOption.Value)
    let _setTime                                   (t : ICell<double>)   
                                                   = triv _DiscretizedOption (fun () -> _DiscretizedOption.Value.setTime(t.Value)
                                                                                        _DiscretizedOption.Value)
    let _setValues                                 (v : ICell<Vector>)   
                                                   = triv _DiscretizedOption (fun () -> _DiscretizedOption.Value.setValues(v.Value)
                                                                                        _DiscretizedOption.Value)
    let _time                                      = triv _DiscretizedOption (fun () -> _DiscretizedOption.Value.time())
    let _values                                    = triv _DiscretizedOption (fun () -> _DiscretizedOption.Value.values())
