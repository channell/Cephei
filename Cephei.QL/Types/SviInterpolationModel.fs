...
*)
    let mutable
        _SviInterpolation                          = make (fun () -> new SviInterpolation (xBegin.Value, size.Value, yBegin.Value, t.Value, forward.Value, a.Value, b.Value, sigma.Value, rho.Value, m.Value, aIsFixed.Value, bIsFixed.Value, sigmaIsFixed.Value, rhoIsFixed.Value, mIsFixed.Value, vegaWeighted.Value, endCriteria.Value, optMethod.Value, errorAccept.Value, useMaxError.Value, maxGuesses.Value, addParams.Value))
    let _a                                         = triv _SviInterpolation (fun () -> _SviInterpolation.Value.a())
    let _b                                         = triv _SviInterpolation (fun () -> _SviInterpolation.Value.b())
    let _endCriteria                               = triv _SviInterpolation (fun () -> _SviInterpolation.Value.endCriteria())
    let _expiry                                    = triv _SviInterpolation (fun () -> _SviInterpolation.Value.expiry())
    let _forward                                   = triv _SviInterpolation (fun () -> _SviInterpolation.Value.forward())
    let _interpolationWeights                      = triv _SviInterpolation (fun () -> _SviInterpolation.Value.interpolationWeights())
    let _m                                         = triv _SviInterpolation (fun () -> _SviInterpolation.Value.m())
    let _maxError                                  = triv _SviInterpolation (fun () -> _SviInterpolation.Value.maxError())
    let _rho                                       = triv _SviInterpolation (fun () -> _SviInterpolation.Value.rho())
    let _rmsError                                  = triv _SviInterpolation (fun () -> _SviInterpolation.Value.rmsError())
    let _sigma                                     = triv _SviInterpolation (fun () -> _SviInterpolation.Value.sigma())
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv _SviInterpolation (fun () -> _SviInterpolation.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = triv _SviInterpolation (fun () -> _SviInterpolation.Value.empty())
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv _SviInterpolation (fun () -> _SviInterpolation.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv _SviInterpolation (fun () -> _SviInterpolation.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = triv _SviInterpolation (fun () -> _SviInterpolation.Value.update()
                                                                                       _SviInterpolation.Value)
    let _value                                     (x : ICell<double>)   
                                                   = triv _SviInterpolation (fun () -> _SviInterpolation.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv _SviInterpolation (fun () -> _SviInterpolation.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = triv _SviInterpolation (fun () -> _SviInterpolation.Value.xMax())
    let _xMin                                      = triv _SviInterpolation (fun () -> _SviInterpolation.Value.xMin())
    let _allowsExtrapolation                       = triv _SviInterpolation (fun () -> _SviInterpolation.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv _SviInterpolation (fun () -> _SviInterpolation.Value.disableExtrapolation(b.Value)
                                                                                       _SviInterpolation.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv _SviInterpolation (fun () -> _SviInterpolation.Value.enableExtrapolation(b.Value)
                                                                                       _SviInterpolation.Value)
    let _extrapolate                               = triv _SviInterpolation (fun () -> _SviInterpolation.Value.extrapolate)
