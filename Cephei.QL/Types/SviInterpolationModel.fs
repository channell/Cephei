...
*)
    ...
    let _a                                         = cell (fun () -> _SviInterpolation.Value.a())
    let _b                                         = cell (fun () -> _SviInterpolation.Value.b())
    let _endCriteria                               = cell (fun () -> _SviInterpolation.Value.endCriteria())
    let _expiry                                    = cell (fun () -> _SviInterpolation.Value.expiry())
    let _forward                                   = cell (fun () -> _SviInterpolation.Value.forward())
    let _interpolationWeights                      = cell (fun () -> _SviInterpolation.Value.interpolationWeights())
    let _m                                         = cell (fun () -> _SviInterpolation.Value.m())
    let _maxError                                  = cell (fun () -> _SviInterpolation.Value.maxError())
    let _rho                                       = cell (fun () -> _SviInterpolation.Value.rho())
    let _rmsError                                  = cell (fun () -> _SviInterpolation.Value.rmsError())
    let _sigma                                     = cell (fun () -> _SviInterpolation.Value.sigma())
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _SviInterpolation.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = cell (fun () -> _SviInterpolation.Value.empty())
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _SviInterpolation.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _SviInterpolation.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = cell (fun () -> _SviInterpolation.Value.update()
                                                                     _SviInterpolation.Value)
    let _value                                     (x : ICell<double>)   
                                                   = cell (fun () -> _SviInterpolation.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _SviInterpolation.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = cell (fun () -> _SviInterpolation.Value.xMax())
    let _xMin                                      = cell (fun () -> _SviInterpolation.Value.xMin())
    let _allowsExtrapolation                       = cell (fun () -> _SviInterpolation.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _SviInterpolation.Value.disableExtrapolation(b.Value)
                                                                     _SviInterpolation.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _SviInterpolation.Value.enableExtrapolation(b.Value)
                                                                     _SviInterpolation.Value)
    let _extrapolate                               = cell (fun () -> _SviInterpolation.Value.extrapolate)
