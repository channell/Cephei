...
(*
    Functions
*)
    let _CommercialPaper                           = cell (fun () -> withEngine evaluationDate pricingEngine (new CommercialPaper (Type.Value, nominal.Value, fixedSchedule.Value, fixedRate.Value, fixedDayCount.Value, principalSchedule.Value, paymentConvention.Value)))
