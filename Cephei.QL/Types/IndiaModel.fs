...
*)
    let mutable
        _India                                     = make (fun () -> new India ())
    let _addedHolidays                             = triv _India (fun () -> _India.Value.addedHolidays)
    let _addHoliday                                (d : ICell<Date>)   
                                                   = triv _India (fun () -> _India.Value.addHoliday(d.Value)
                                                                            _India.Value)
    let _adjust                                    (d : ICell<Date>) (c : ICell<BusinessDayConvention>)   
                                                   = triv _India (fun () -> _India.Value.adjust(d.Value, c.Value))
    let _advance                                   (d : ICell<Date>) (p : ICell<Period>) (c : ICell<BusinessDayConvention>) (endOfMonth : ICell<bool>)   
                                                   = triv _India (fun () -> _India.Value.advance(d.Value, p.Value, c.Value, endOfMonth.Value))
    let _advance1                                  (d : ICell<Date>) (n : ICell<int>) (unit : ICell<TimeUnit>) (c : ICell<BusinessDayConvention>) (endOfMonth : ICell<bool>)   
                                                   = triv _India (fun () -> _India.Value.advance(d.Value, n.Value, unit.Value, c.Value, endOfMonth.Value))
    let _businessDaysBetween                       (from : ICell<Date>) (To : ICell<Date>) (includeFirst : ICell<bool>) (includeLast : ICell<bool>)   
                                                   = triv _India (fun () -> _India.Value.businessDaysBetween(from.Value, To.Value, includeFirst.Value, includeLast.Value))
    let _calendar                                  = triv _India (fun () -> _India.Value.calendar)
    let _empty                                     = triv _India (fun () -> _India.Value.empty())
    let _endOfMonth                                (d : ICell<Date>)   
                                                   = triv _India (fun () -> _India.Value.endOfMonth(d.Value))
    let _Equals                                    (o : ICell<Object>)   
                                                   = triv _India (fun () -> _India.Value.Equals(o.Value))
    let _isBusinessDay                             (d : ICell<Date>)   
                                                   = triv _India (fun () -> _India.Value.isBusinessDay(d.Value))
    let _isEndOfMonth                              (d : ICell<Date>)   
                                                   = triv _India (fun () -> _India.Value.isEndOfMonth(d.Value))
    let _isHoliday                                 (d : ICell<Date>)   
                                                   = triv _India (fun () -> _India.Value.isHoliday(d.Value))
    let _isWeekend                                 (w : ICell<DayOfWeek>)   
                                                   = triv _India (fun () -> _India.Value.isWeekend(w.Value))
    let _name                                      = triv _India (fun () -> _India.Value.name())
    let _removedHolidays                           = triv _India (fun () -> _India.Value.removedHolidays)
    let _removeHoliday                             (d : ICell<Date>)   
                                                   = triv _India (fun () -> _India.Value.removeHoliday(d.Value)
                                                                            _India.Value)
    do this.Bind(_India)
(* 
    casting 
