...
*)
    ...
    let _aCoefficients                             = cell (fun () -> _CubicInterpolation.Value.aCoefficients())
    let _bCoefficients                             = cell (fun () -> _CubicInterpolation.Value.bCoefficients())
    let _cCoefficients                             = cell (fun () -> _CubicInterpolation.Value.cCoefficients())
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _CubicInterpolation.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = cell (fun () -> _CubicInterpolation.Value.empty())
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _CubicInterpolation.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _CubicInterpolation.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = cell (fun () -> _CubicInterpolation.Value.update()
                                                                     _CubicInterpolation.Value)
    let _value                                     (x : ICell<double>)   
                                                   = cell (fun () -> _CubicInterpolation.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _CubicInterpolation.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = cell (fun () -> _CubicInterpolation.Value.xMax())
    let _xMin                                      = cell (fun () -> _CubicInterpolation.Value.xMin())
    let _allowsExtrapolation                       = cell (fun () -> _CubicInterpolation.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _CubicInterpolation.Value.disableExtrapolation(b.Value)
                                                                     _CubicInterpolation.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _CubicInterpolation.Value.enableExtrapolation(b.Value)
                                                                     _CubicInterpolation.Value)
    let _extrapolate                               = cell (fun () -> _CubicInterpolation.Value.extrapolate)
