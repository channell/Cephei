...
*)
    let mutable
        _CubicInterpolation                        = make (fun () -> new CubicInterpolation (xBegin.Value, size.Value, yBegin.Value, da.Value, monotonic.Value, leftCond.Value, leftConditionValue.Value, rightCond.Value, rightConditionValue.Value))
    let _aCoefficients                             = triv _CubicInterpolation (fun () -> _CubicInterpolation.Value.aCoefficients())
    let _bCoefficients                             = triv _CubicInterpolation (fun () -> _CubicInterpolation.Value.bCoefficients())
    let _cCoefficients                             = triv _CubicInterpolation (fun () -> _CubicInterpolation.Value.cCoefficients())
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv _CubicInterpolation (fun () -> _CubicInterpolation.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = triv _CubicInterpolation (fun () -> _CubicInterpolation.Value.empty())
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv _CubicInterpolation (fun () -> _CubicInterpolation.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv _CubicInterpolation (fun () -> _CubicInterpolation.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = triv _CubicInterpolation (fun () -> _CubicInterpolation.Value.update()
                                                                                         _CubicInterpolation.Value)
    let _value                                     (x : ICell<double>)   
                                                   = triv _CubicInterpolation (fun () -> _CubicInterpolation.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv _CubicInterpolation (fun () -> _CubicInterpolation.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = triv _CubicInterpolation (fun () -> _CubicInterpolation.Value.xMax())
    let _xMin                                      = triv _CubicInterpolation (fun () -> _CubicInterpolation.Value.xMin())
    let _allowsExtrapolation                       = triv _CubicInterpolation (fun () -> _CubicInterpolation.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv _CubicInterpolation (fun () -> _CubicInterpolation.Value.disableExtrapolation(b.Value)
                                                                                         _CubicInterpolation.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv _CubicInterpolation (fun () -> _CubicInterpolation.Value.enableExtrapolation(b.Value)
                                                                                         _CubicInterpolation.Value)
    let _extrapolate                               = triv _CubicInterpolation (fun () -> _CubicInterpolation.Value.extrapolate)
