...
*)
    let mutable
        _ActualActual                              = make (fun () -> new ActualActual ())
    let _dayCount                                  (d1 : ICell<Date>) (d2 : ICell<Date>)   
                                                   = triv _ActualActual (fun () -> _ActualActual.Value.dayCount(d1.Value, d2.Value))
    let _dayCounter                                = triv _ActualActual (fun () -> _ActualActual.Value.dayCounter)
    let _empty                                     = triv _ActualActual (fun () -> _ActualActual.Value.empty())
    let _Equals                                    (o : ICell<Object>)   
                                                   = triv _ActualActual (fun () -> _ActualActual.Value.Equals(o.Value))
    let _name                                      = triv _ActualActual (fun () -> _ActualActual.Value.name())
    let _ToString                                  = triv _ActualActual (fun () -> _ActualActual.Value.ToString())
    let _yearFraction                              (d1 : ICell<Date>) (d2 : ICell<Date>) (refPeriodStart : ICell<Date>) (refPeriodEnd : ICell<Date>)   
                                                   = triv _ActualActual (fun () -> _ActualActual.Value.yearFraction(d1.Value, d2.Value, refPeriodStart.Value, refPeriodEnd.Value))
    let _yearFraction1                             (d1 : ICell<Date>) (d2 : ICell<Date>)   
                                                   = triv _ActualActual (fun () -> _ActualActual.Value.yearFraction(d1.Value, d2.Value))
...
*)
    let mutable
        _ActualActual                              = make (fun () -> new ActualActual (c.Value, schedule.Value))
    let _dayCount                                  (d1 : ICell<Date>) (d2 : ICell<Date>)   
                                                   = triv _ActualActual (fun () -> _ActualActual.Value.dayCount(d1.Value, d2.Value))
    let _dayCounter                                = triv _ActualActual (fun () -> _ActualActual.Value.dayCounter)
    let _empty                                     = triv _ActualActual (fun () -> _ActualActual.Value.empty())
