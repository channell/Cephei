...
*)
    ...
    let _apply                                     (x0 : ICell<Vector>) (dx : ICell<Vector>)   
                                                   = cell (fun () -> _HybridHestonHullWhiteProcess.Value.apply(x0.Value, dx.Value))
    let _diffusion                                 (t : ICell<double>) (x : ICell<Vector>)   
                                                   = cell (fun () -> _HybridHestonHullWhiteProcess.Value.diffusion(t.Value, x.Value))
    let _discretization                            = cell (fun () -> _HybridHestonHullWhiteProcess.Value.discretization())
    let _drift                                     (t : ICell<double>) (x : ICell<Vector>)   
                                                   = cell (fun () -> _HybridHestonHullWhiteProcess.Value.drift(t.Value, x.Value))
    let _eta                                       = cell (fun () -> _HybridHestonHullWhiteProcess.Value.eta())
    let _evolve                                    (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>) (dw : ICell<Vector>)   
                                                   = cell (fun () -> _HybridHestonHullWhiteProcess.Value.evolve(t0.Value, x0.Value, dt.Value, dw.Value))
    let _hestonProcess                             = cell (fun () -> _HybridHestonHullWhiteProcess.Value.hestonProcess())
    let _hullWhiteProcess                          = cell (fun () -> _HybridHestonHullWhiteProcess.Value.hullWhiteProcess())
    let _initialValues                             = cell (fun () -> _HybridHestonHullWhiteProcess.Value.initialValues())
    let _numeraire                                 (t : ICell<double>) (x : ICell<Vector>)   
                                                   = cell (fun () -> _HybridHestonHullWhiteProcess.Value.numeraire(t.Value, x.Value))
    let _size                                      = cell (fun () -> _HybridHestonHullWhiteProcess.Value.size())
    let _time                                      (date : ICell<Date>)   
                                                   = cell (fun () -> _HybridHestonHullWhiteProcess.Value.time(date.Value))
    let _update                                    = cell (fun () -> _HybridHestonHullWhiteProcess.Value.update()
                                                                     _HybridHestonHullWhiteProcess.Value)
    let _covariance                                (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>)   
                                                   = cell (fun () -> _HybridHestonHullWhiteProcess.Value.covariance(t0.Value, x0.Value, dt.Value))
    let _expectation                               (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>)   
                                                   = cell (fun () -> _HybridHestonHullWhiteProcess.Value.expectation(t0.Value, x0.Value, dt.Value))
    let _factors                                   = cell (fun () -> _HybridHestonHullWhiteProcess.Value.factors())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _HybridHestonHullWhiteProcess.Value.registerWith(handler.Value)
                                                                     _HybridHestonHullWhiteProcess.Value)
    let _stdDeviation                              (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>)   
                                                   = cell (fun () -> _HybridHestonHullWhiteProcess.Value.stdDeviation(t0.Value, x0.Value, dt.Value))
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _HybridHestonHullWhiteProcess.Value.unregisterWith(handler.Value)
                                                                     _HybridHestonHullWhiteProcess.Value)
