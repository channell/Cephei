...
*)
    ...
    let _diffusion                                 (t : ICell<double>) (x : ICell<double>)   
                                                   = triv (fun () -> _BlackProcess.Value.diffusion(t.Value, x.Value))
    let _dividendYield                             = triv (fun () -> _BlackProcess.Value.dividendYield())
    let _drift                                     (t : ICell<double>) (x : ICell<double>)   
                                                   = triv (fun () -> _BlackProcess.Value.drift(t.Value, x.Value))
    let _evolve                                    (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>) (dw : ICell<double>)   
                                                   = triv (fun () -> _BlackProcess.Value.evolve(t0.Value, x0.Value, dt.Value, dw.Value))
    let _expectation                               (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = triv (fun () -> _BlackProcess.Value.expectation(t0.Value, x0.Value, dt.Value))
    let _localVolatility                           = triv (fun () -> _BlackProcess.Value.localVolatility())
    let _riskFreeRate                              = triv (fun () -> _BlackProcess.Value.riskFreeRate())
    let _stateVariable                             = triv (fun () -> _BlackProcess.Value.stateVariable())
    let _stdDeviation                              (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = triv (fun () -> _BlackProcess.Value.stdDeviation(t0.Value, x0.Value, dt.Value))
    let _time                                      (d : ICell<Date>)   
                                                   = triv (fun () -> _BlackProcess.Value.time(d.Value))
    let _update                                    = triv (fun () -> _BlackProcess.Value.update()
                                                                     _BlackProcess.Value)
    let _variance                                  (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = triv (fun () -> _BlackProcess.Value.variance(t0.Value, x0.Value, dt.Value))
    let _x0                                        = triv (fun () -> _BlackProcess.Value.x0())
    let _initialValues                             = triv (fun () -> _BlackProcess.Value.initialValues())
    let _size                                      = triv (fun () -> _BlackProcess.Value.size())
    let _covariance                                (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>)   
                                                   = triv (fun () -> _BlackProcess.Value.covariance(t0.Value, x0.Value, dt.Value))
    let _factors                                   = triv (fun () -> _BlackProcess.Value.factors())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv (fun () -> _BlackProcess.Value.registerWith(handler.Value)
                                                                     _BlackProcess.Value)
