...
*)
    ...
    let _aCoefficients                             = triv (fun () -> _CubicNaturalSpline.Value.aCoefficients())
    let _bCoefficients                             = triv (fun () -> _CubicNaturalSpline.Value.bCoefficients())
    let _cCoefficients                             = triv (fun () -> _CubicNaturalSpline.Value.cCoefficients())
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _CubicNaturalSpline.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = triv (fun () -> _CubicNaturalSpline.Value.empty())
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _CubicNaturalSpline.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _CubicNaturalSpline.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = triv (fun () -> _CubicNaturalSpline.Value.update()
                                                                     _CubicNaturalSpline.Value)
    let _value                                     (x : ICell<double>)   
                                                   = triv (fun () -> _CubicNaturalSpline.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _CubicNaturalSpline.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = triv (fun () -> _CubicNaturalSpline.Value.xMax())
    let _xMin                                      = triv (fun () -> _CubicNaturalSpline.Value.xMin())
    let _allowsExtrapolation                       = triv (fun () -> _CubicNaturalSpline.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv (fun () -> _CubicNaturalSpline.Value.disableExtrapolation(b.Value)
                                                                     _CubicNaturalSpline.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv (fun () -> _CubicNaturalSpline.Value.enableExtrapolation(b.Value)
                                                                     _CubicNaturalSpline.Value)
    let _extrapolate                               = triv (fun () -> _CubicNaturalSpline.Value.extrapolate)
