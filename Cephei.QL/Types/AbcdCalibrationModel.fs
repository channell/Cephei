...
*)
    ...
    let _a                                         = cell (fun () -> _AbcdCalibration.Value.a())
    let _abcdBlackVolatility                       (u : ICell<double>) (a : ICell<double>) (b : ICell<double>) (c : ICell<double>) (d : ICell<double>)   
                                                   = cell (fun () -> _AbcdCalibration.Value.abcdBlackVolatility(u.Value, a.Value, b.Value, c.Value, d.Value))
    let _aIsFixed_                                 = cell (fun () -> _AbcdCalibration.Value.aIsFixed_)
    let _b                                         = cell (fun () -> _AbcdCalibration.Value.b())
    let _bIsFixed_                                 = cell (fun () -> _AbcdCalibration.Value.bIsFixed_)
    let _c                                         = cell (fun () -> _AbcdCalibration.Value.c())
    let _cIsFixed_                                 = cell (fun () -> _AbcdCalibration.Value.cIsFixed_)
    let _compute                                   = cell (fun () -> _AbcdCalibration.Value.compute()
                                                                     _AbcdCalibration.Value)
    let _d                                         = cell (fun () -> _AbcdCalibration.Value.d())
    let _dIsFixed_                                 = cell (fun () -> _AbcdCalibration.Value.dIsFixed_)
    let _endCriteria                               = cell (fun () -> _AbcdCalibration.Value.endCriteria())
    let _error                                     = cell (fun () -> _AbcdCalibration.Value.error())
    let _errors                                    = cell (fun () -> _AbcdCalibration.Value.errors())
    let _k                                         (t : ICell<Generic.List<double>>) (blackVols : ICell<Generic.List<double>>)   
                                                   = cell (fun () -> _AbcdCalibration.Value.k(t.Value, blackVols.Value))
    let _maxError                                  = cell (fun () -> _AbcdCalibration.Value.maxError())
    let _transformation_                           = cell (fun () -> _AbcdCalibration.Value.transformation_)
    let _value                                     (x : ICell<double>)   
                                                   = cell (fun () -> _AbcdCalibration.Value.value(x.Value))
