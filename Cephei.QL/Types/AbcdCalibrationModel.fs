...
*)
    let mutable
        _AbcdCalibration                           = make (fun () -> new AbcdCalibration ())
    let _a                                         = triv _AbcdCalibration (fun () -> _AbcdCalibration.Value.a())
    let _abcdBlackVolatility                       (u : ICell<double>) (a : ICell<double>) (b : ICell<double>) (c : ICell<double>) (d : ICell<double>)   
                                                   = triv _AbcdCalibration (fun () -> _AbcdCalibration.Value.abcdBlackVolatility(u.Value, a.Value, b.Value, c.Value, d.Value))
    let _aIsFixed_                                 = triv _AbcdCalibration (fun () -> _AbcdCalibration.Value.aIsFixed_)
    let _b                                         = triv _AbcdCalibration (fun () -> _AbcdCalibration.Value.b())
    let _bIsFixed_                                 = triv _AbcdCalibration (fun () -> _AbcdCalibration.Value.bIsFixed_)
    let _c                                         = triv _AbcdCalibration (fun () -> _AbcdCalibration.Value.c())
    let _cIsFixed_                                 = triv _AbcdCalibration (fun () -> _AbcdCalibration.Value.cIsFixed_)
    let _compute                                   = triv _AbcdCalibration (fun () -> _AbcdCalibration.Value.compute()
                                                                                      _AbcdCalibration.Value)
    let _d                                         = triv _AbcdCalibration (fun () -> _AbcdCalibration.Value.d())
    let _dIsFixed_                                 = triv _AbcdCalibration (fun () -> _AbcdCalibration.Value.dIsFixed_)
    let _endCriteria                               = triv _AbcdCalibration (fun () -> _AbcdCalibration.Value.endCriteria())
    let _error                                     = triv _AbcdCalibration (fun () -> _AbcdCalibration.Value.error())
    let _errors                                    = triv _AbcdCalibration (fun () -> _AbcdCalibration.Value.errors())
    let _k                                         (t : ICell<Generic.List<double>>) (blackVols : ICell<Generic.List<double>>)   
                                                   = triv _AbcdCalibration (fun () -> _AbcdCalibration.Value.k(t.Value, blackVols.Value))
    let _maxError                                  = triv _AbcdCalibration (fun () -> _AbcdCalibration.Value.maxError())
    let _transformation_                           = triv _AbcdCalibration (fun () -> _AbcdCalibration.Value.transformation_)
    let _value                                     (x : ICell<double>)   
                                                   = triv _AbcdCalibration (fun () -> _AbcdCalibration.Value.value(x.Value))
...
*)
    let mutable
        _AbcdCalibration                           = make (fun () -> new AbcdCalibration (t.Value, blackVols.Value, aGuess.Value, bGuess.Value, cGuess.Value, dGuess.Value, aIsFixed.Value, bIsFixed.Value, cIsFixed.Value, dIsFixed.Value, vegaWeighted.Value, endCriteria.Value, Method.Value))
    let _a                                         = triv _AbcdCalibration (fun () -> _AbcdCalibration.Value.a())
    let _abcdBlackVolatility                       (u : ICell<double>) (a : ICell<double>) (b : ICell<double>) (c : ICell<double>) (d : ICell<double>)   
                                                   = triv _AbcdCalibration (fun () -> _AbcdCalibration.Value.abcdBlackVolatility(u.Value, a.Value, b.Value, c.Value, d.Value))
    let _aIsFixed_                                 = triv _AbcdCalibration (fun () -> _AbcdCalibration.Value.aIsFixed_)
