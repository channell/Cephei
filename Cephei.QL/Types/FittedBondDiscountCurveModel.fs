...
*)
    let mutable
        _FittedBondDiscountCurve                   = make (fun () -> new FittedBondDiscountCurve (settlementDays.Value, calendar.Value, bondHelpers.Value, dayCounter.Value, fittingMethod.Value, accuracy.Value, maxEvaluations.Value, guess.Value, simplexLambda.Value, maxStationaryStateIterations.Value))
    let _maxDate                                   = triv _FittedBondDiscountCurve (fun () -> _FittedBondDiscountCurve.Value.maxDate())
    let _numberOfBonds                             = triv _FittedBondDiscountCurve (fun () -> _FittedBondDiscountCurve.Value.numberOfBonds())
    let _discount                                  (t : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _FittedBondDiscountCurve (fun () -> _FittedBondDiscountCurve.Value.discount(t.Value, extrapolate.Value))
    let _discount1                                 (d : ICell<Date>) (extrapolate : ICell<bool>)   
                                                   = triv _FittedBondDiscountCurve (fun () -> _FittedBondDiscountCurve.Value.discount(d.Value, extrapolate.Value))
    let _forwardRate                               (d : ICell<Date>) (p : ICell<Period>) (dayCounter : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = triv _FittedBondDiscountCurve (fun () -> _FittedBondDiscountCurve.Value.forwardRate(d.Value, p.Value, dayCounter.Value, comp.Value, freq.Value, extrapolate.Value))
    let _forwardRate1                              (d1 : ICell<Date>) (d2 : ICell<Date>) (dayCounter : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = triv _FittedBondDiscountCurve (fun () -> _FittedBondDiscountCurve.Value.forwardRate(d1.Value, d2.Value, dayCounter.Value, comp.Value, freq.Value, extrapolate.Value))
    let _forwardRate2                              (t1 : ICell<double>) (t2 : ICell<double>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = triv _FittedBondDiscountCurve (fun () -> _FittedBondDiscountCurve.Value.forwardRate(t1.Value, t2.Value, comp.Value, freq.Value, extrapolate.Value))
    let _jumpDates                                 = triv _FittedBondDiscountCurve (fun () -> _FittedBondDiscountCurve.Value.jumpDates())
    let _jumpTimes                                 = triv _FittedBondDiscountCurve (fun () -> _FittedBondDiscountCurve.Value.jumpTimes())
    let _update                                    = triv _FittedBondDiscountCurve (fun () -> _FittedBondDiscountCurve.Value.update()
    ...
    let _zeroRate                                  (t : ICell<double>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = triv _FittedBondDiscountCurve (fun () -> _FittedBondDiscountCurve.Value.zeroRate(t.Value, comp.Value, freq.Value, extrapolate.Value))
    let _zeroRate1                                 (d : ICell<Date>) (dayCounter : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = triv _FittedBondDiscountCurve (fun () -> _FittedBondDiscountCurve.Value.zeroRate(d.Value, dayCounter.Value, comp.Value, freq.Value, extrapolate.Value))
    let _calendar                                  = triv _FittedBondDiscountCurve (fun () -> _FittedBondDiscountCurve.Value.calendar())
    let _dayCounter                                = triv _FittedBondDiscountCurve (fun () -> _FittedBondDiscountCurve.Value.dayCounter())
    let _maxTime                                   = triv _FittedBondDiscountCurve (fun () -> _FittedBondDiscountCurve.Value.maxTime())
    let _referenceDate                             = triv _FittedBondDiscountCurve (fun () -> _FittedBondDiscountCurve.Value.referenceDate())
    let _settlementDays                            = triv _FittedBondDiscountCurve (fun () -> _FittedBondDiscountCurve.Value.settlementDays())
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = triv _FittedBondDiscountCurve (fun () -> _FittedBondDiscountCurve.Value.timeFromReference(date.Value))
    let _allowsExtrapolation                       = triv _FittedBondDiscountCurve (fun () -> _FittedBondDiscountCurve.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv _FittedBondDiscountCurve (fun () -> _FittedBondDiscountCurve.Value.disableExtrapolation(b.Value)
                                                                                              _FittedBondDiscountCurve.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv _FittedBondDiscountCurve (fun () -> _FittedBondDiscountCurve.Value.enableExtrapolation(b.Value)
                                                                                              _FittedBondDiscountCurve.Value)
    let _extrapolate                               = triv _FittedBondDiscountCurve (fun () -> _FittedBondDiscountCurve.Value.extrapolate)
...
*)
    let mutable
        _FittedBondDiscountCurve                   = make (fun () -> new FittedBondDiscountCurve (referenceDate.Value, bondHelpers.Value, dayCounter.Value, fittingMethod.Value, accuracy.Value, maxEvaluations.Value, guess.Value, simplexLambda.Value, maxStationaryStateIterations.Value))
    let _maxDate                                   = triv _FittedBondDiscountCurve (fun () -> _FittedBondDiscountCurve.Value.maxDate())
    let _numberOfBonds                             = triv _FittedBondDiscountCurve (fun () -> _FittedBondDiscountCurve.Value.numberOfBonds())
    let _discount                                  (t : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _FittedBondDiscountCurve (fun () -> _FittedBondDiscountCurve.Value.discount(t.Value, extrapolate.Value))
