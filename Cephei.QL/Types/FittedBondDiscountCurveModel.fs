...
*)
    ...
    let _maxDate                                   = cell (fun () -> _FittedBondDiscountCurve.Value.maxDate())
    let _numberOfBonds                             = cell (fun () -> _FittedBondDiscountCurve.Value.numberOfBonds())
    let _discount                                  (t : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _FittedBondDiscountCurve.Value.discount(t.Value, extrapolate.Value))
    let _discount1                                 (d : ICell<Date>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _FittedBondDiscountCurve.Value.discount(d.Value, extrapolate.Value))
    let _forwardRate                               (d : ICell<Date>) (p : ICell<Period>) (dayCounter : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _FittedBondDiscountCurve.Value.forwardRate(d.Value, p.Value, dayCounter.Value, comp.Value, freq.Value, extrapolate.Value))
    let _forwardRate1                              (d1 : ICell<Date>) (d2 : ICell<Date>) (dayCounter : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _FittedBondDiscountCurve.Value.forwardRate(d1.Value, d2.Value, dayCounter.Value, comp.Value, freq.Value, extrapolate.Value))
    let _forwardRate2                              (t1 : ICell<double>) (t2 : ICell<double>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _FittedBondDiscountCurve.Value.forwardRate(t1.Value, t2.Value, comp.Value, freq.Value, extrapolate.Value))
    let _jumpDates                                 = cell (fun () -> _FittedBondDiscountCurve.Value.jumpDates())
    let _jumpTimes                                 = cell (fun () -> _FittedBondDiscountCurve.Value.jumpTimes())
    let _update                                    = cell (fun () -> _FittedBondDiscountCurve.Value.update()
    ...
    let _zeroRate                                  (t : ICell<double>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _FittedBondDiscountCurve.Value.zeroRate(t.Value, comp.Value, freq.Value, extrapolate.Value))
    let _zeroRate1                                 (d : ICell<Date>) (dayCounter : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _FittedBondDiscountCurve.Value.zeroRate(d.Value, dayCounter.Value, comp.Value, freq.Value, extrapolate.Value))
    let _calendar                                  = cell (fun () -> _FittedBondDiscountCurve.Value.calendar())
    let _dayCounter                                = cell (fun () -> _FittedBondDiscountCurve.Value.dayCounter())
    let _maxTime                                   = cell (fun () -> _FittedBondDiscountCurve.Value.maxTime())
    let _referenceDate                             = cell (fun () -> _FittedBondDiscountCurve.Value.referenceDate())
    let _settlementDays                            = cell (fun () -> _FittedBondDiscountCurve.Value.settlementDays())
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = cell (fun () -> _FittedBondDiscountCurve.Value.timeFromReference(date.Value))
    let _allowsExtrapolation                       = cell (fun () -> _FittedBondDiscountCurve.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _FittedBondDiscountCurve.Value.disableExtrapolation(b.Value)
                                                                     _FittedBondDiscountCurve.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _FittedBondDiscountCurve.Value.enableExtrapolation(b.Value)
                                                                     _FittedBondDiscountCurve.Value)
    let _extrapolate                               = cell (fun () -> _FittedBondDiscountCurve.Value.extrapolate)
