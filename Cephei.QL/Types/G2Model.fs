...
*)
    let mutable
        _G2                                        = make (fun () -> new G2 (termStructure.Value, a.Value, sigma.Value, b.Value))
    let _discount                                  (t : ICell<double>)   
                                                   = triv _G2 (fun () -> _G2.Value.discount(t.Value))
    let _discountBond                              (now : ICell<double>) (maturity : ICell<double>) (factors : ICell<Vector>)   
                                                   = triv _G2 (fun () -> _G2.Value.discountBond(now.Value, maturity.Value, factors.Value))
    let _discountBond1                             (t : ICell<double>) (T2 : ICell<double>) (x : ICell<double>) (y : ICell<double>)   
                                                   = triv _G2 (fun () -> _G2.Value.discountBond(t.Value, T2.Value, x.Value, y.Value))
    let _discountBondOption                        (Type : ICell<Option.Type>) (strike : ICell<double>) (maturity : ICell<double>) (bondMaturity : ICell<double>)   
                                                   = triv _G2 (fun () -> _G2.Value.discountBondOption(Type.Value, strike.Value, maturity.Value, bondMaturity.Value))
    let _dynamics                                  = triv _G2 (fun () -> _G2.Value.dynamics())
    let _swaption                                  (arguments : ICell<Swaption.Arguments>) (fixedRate : ICell<double>) (range : ICell<double>) (intervals : ICell<int>)   
                                                   = triv _G2 (fun () -> _G2.Value.swaption(arguments.Value, fixedRate.Value, range.Value, intervals.Value))
    let _termStructure                             = triv _G2 (fun () -> _G2.Value.termStructure())
    let _termStructure_                            = triv _G2 (fun () -> _G2.Value.termStructure_)
    let _tree                                      (grid : ICell<TimeGrid>)   
                                                   = triv _G2 (fun () -> _G2.Value.tree(grid.Value))
    let _calibrate                                 (instruments : ICell<Generic.List<CalibrationHelper>>) (Method : ICell<OptimizationMethod>) (endCriteria : ICell<EndCriteria>) (additionalConstraint : ICell<Constraint>) (weights : ICell<Generic.List<double>>) (fixParameters : ICell<Generic.List<bool>>)   
                                                   = triv _G2 (fun () -> _G2.Value.calibrate(instruments.Value, Method.Value, endCriteria.Value, additionalConstraint.Value, weights.Value, fixParameters.Value)
                                                                         _G2.Value)
    let _constraint                                = triv _G2 (fun () -> _G2.Value.CONSTRAINT())
    let _endCriteria                               = triv _G2 (fun () -> _G2.Value.endCriteria())
    let _notifyObservers                           = triv _G2 (fun () -> _G2.Value.notifyObservers()
                                                                         _G2.Value)
    let _parameters                                = triv _G2 (fun () -> _G2.Value.parameters())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv _G2 (fun () -> _G2.Value.registerWith(handler.Value)
                                                                         _G2.Value)
    let _setParams                                 (parameters : ICell<Vector>)   
                                                   = triv _G2 (fun () -> _G2.Value.setParams(parameters.Value)
                                                                         _G2.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = triv _G2 (fun () -> _G2.Value.unregisterWith(handler.Value)
                                                                         _G2.Value)
    let _update                                    = triv _G2 (fun () -> _G2.Value.update()
                                                                         _G2.Value)
    let _value                                     (parameters : ICell<Vector>) (instruments : ICell<Generic.List<CalibrationHelper>>)   
                                                   = triv _G2 (fun () -> _G2.Value.value(parameters.Value, instruments.Value))
    do this.Bind(_G2)
(* 
    casting 
*)
...
*)
    let mutable
        _G2                                        = make (fun () -> new G2 (termStructure.Value))
    let _discount                                  (t : ICell<double>)   
                                                   = triv _G2 (fun () -> _G2.Value.discount(t.Value))
    let _discountBond                              (now : ICell<double>) (maturity : ICell<double>) (factors : ICell<Vector>)   
                                                   = triv _G2 (fun () -> _G2.Value.discountBond(now.Value, maturity.Value, factors.Value))
...
*)
    let mutable
        _G2                                        = make (fun () -> new G2 (termStructure.Value, a.Value, sigma.Value))
    let _discount                                  (t : ICell<double>)   
                                                   = triv _G2 (fun () -> _G2.Value.discount(t.Value))
    let _discountBond                              (now : ICell<double>) (maturity : ICell<double>) (factors : ICell<Vector>)   
                                                   = triv _G2 (fun () -> _G2.Value.discountBond(now.Value, maturity.Value, factors.Value))
...
*)
    let mutable
        _G2                                        = make (fun () -> new G2 (termStructure.Value, a.Value, sigma.Value, b.Value, eta.Value))
    let _discount                                  (t : ICell<double>)   
                                                   = triv _G2 (fun () -> _G2.Value.discount(t.Value))
    let _discountBond                              (now : ICell<double>) (maturity : ICell<double>) (factors : ICell<Vector>)   
                                                   = triv _G2 (fun () -> _G2.Value.discountBond(now.Value, maturity.Value, factors.Value))
...
*)
    let mutable
        _G2                                        = make (fun () -> new G2 (termStructure.Value, a.Value, sigma.Value, b.Value, eta.Value, rho.Value))
    let _discount                                  (t : ICell<double>)   
                                                   = triv _G2 (fun () -> _G2.Value.discount(t.Value))
    let _discountBond                              (now : ICell<double>) (maturity : ICell<double>) (factors : ICell<Vector>)   
                                                   = triv _G2 (fun () -> _G2.Value.discountBond(now.Value, maturity.Value, factors.Value))
...
*)
    let mutable
        _G2                                        = make (fun () -> new G2 (termStructure.Value, a.Value))
    let _discount                                  (t : ICell<double>)   
                                                   = triv _G2 (fun () -> _G2.Value.discount(t.Value))
    let _discountBond                              (now : ICell<double>) (maturity : ICell<double>) (factors : ICell<Vector>)   
                                                   = triv _G2 (fun () -> _G2.Value.discountBond(now.Value, maturity.Value, factors.Value))
