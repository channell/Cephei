...
*)
    ...
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _MixedLinearFritschButlandCubic.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = cell (fun () -> _MixedLinearFritschButlandCubic.Value.empty())
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _MixedLinearFritschButlandCubic.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _MixedLinearFritschButlandCubic.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = cell (fun () -> _MixedLinearFritschButlandCubic.Value.update()
                                                                     _MixedLinearFritschButlandCubic.Value)
    let _value                                     (x : ICell<double>)   
                                                   = cell (fun () -> _MixedLinearFritschButlandCubic.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _MixedLinearFritschButlandCubic.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = cell (fun () -> _MixedLinearFritschButlandCubic.Value.xMax())
    let _xMin                                      = cell (fun () -> _MixedLinearFritschButlandCubic.Value.xMin())
    let _allowsExtrapolation                       = cell (fun () -> _MixedLinearFritschButlandCubic.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _MixedLinearFritschButlandCubic.Value.disableExtrapolation(b.Value)
                                                                     _MixedLinearFritschButlandCubic.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _MixedLinearFritschButlandCubic.Value.enableExtrapolation(b.Value)
                                                                     _MixedLinearFritschButlandCubic.Value)
    let _extrapolate                               = cell (fun () -> _MixedLinearFritschButlandCubic.Value.extrapolate)
