...
*)
    ...
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearFritschButlandCubic.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearFritschButlandCubic.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = triv (fun () -> _MixedLinearFritschButlandCubic.Value.update()
                                                                     _MixedLinearFritschButlandCubic.Value)
    let _value                                     (x : ICell<double>)   
                                                   = triv (fun () -> _MixedLinearFritschButlandCubic.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearFritschButlandCubic.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = triv (fun () -> _MixedLinearFritschButlandCubic.Value.xMax())
    let _xMin                                      = triv (fun () -> _MixedLinearFritschButlandCubic.Value.xMin())
    let _allowsExtrapolation                       = triv (fun () -> _MixedLinearFritschButlandCubic.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearFritschButlandCubic.Value.disableExtrapolation(b.Value)
                                                                     _MixedLinearFritschButlandCubic.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearFritschButlandCubic.Value.enableExtrapolation(b.Value)
                                                                     _MixedLinearFritschButlandCubic.Value)
