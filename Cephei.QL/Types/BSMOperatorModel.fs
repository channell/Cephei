...
*)
    let mutable
        _BSMOperator                               = make (fun () -> new BSMOperator (size.Value, dx.Value, r.Value, q.Value, sigma.Value))
    let _add                                       (A : ICell<IOperator>) (B : ICell<IOperator>)   
                                                   = triv _BSMOperator (fun () -> _BSMOperator.Value.add(A.Value, B.Value))
    let _applyTo                                   (v : ICell<Vector>)   
                                                   = triv _BSMOperator (fun () -> _BSMOperator.Value.applyTo(v.Value))
    let _Clone                                     = triv _BSMOperator (fun () -> _BSMOperator.Value.Clone())
    let _diagonal                                  = triv _BSMOperator (fun () -> _BSMOperator.Value.diagonal())
    let _identity                                  (size : ICell<int>)   
                                                   = triv _BSMOperator (fun () -> _BSMOperator.Value.identity(size.Value))
    let _isTimeDependent                           = triv _BSMOperator (fun () -> _BSMOperator.Value.isTimeDependent())
    let _lowerDiagonal                             = triv _BSMOperator (fun () -> _BSMOperator.Value.lowerDiagonal())
    let _multiply                                  (a : ICell<double>) (o : ICell<IOperator>)   
                                                   = triv _BSMOperator (fun () -> _BSMOperator.Value.multiply(a.Value, o.Value))
    let _setFirstRow                               (valB : ICell<double>) (valC : ICell<double>)   
                                                   = triv _BSMOperator (fun () -> _BSMOperator.Value.setFirstRow(valB.Value, valC.Value)
                                                                                  _BSMOperator.Value)
    let _setLastRow                                (valA : ICell<double>) (valB : ICell<double>)   
                                                   = triv _BSMOperator (fun () -> _BSMOperator.Value.setLastRow(valA.Value, valB.Value)
                                                                                  _BSMOperator.Value)
    let _setMidRow                                 (i : ICell<int>) (valA : ICell<double>) (valB : ICell<double>) (valC : ICell<double>)   
                                                   = triv _BSMOperator (fun () -> _BSMOperator.Value.setMidRow(i.Value, valA.Value, valB.Value, valC.Value)
                                                                                  _BSMOperator.Value)
    let _setMidRows                                (valA : ICell<double>) (valB : ICell<double>) (valC : ICell<double>)   
                                                   = triv _BSMOperator (fun () -> _BSMOperator.Value.setMidRows(valA.Value, valB.Value, valC.Value)
                                                                                  _BSMOperator.Value)
    let _setTime                                   (t : ICell<double>)   
                                                   = triv _BSMOperator (fun () -> _BSMOperator.Value.setTime(t.Value)
                                                                                  _BSMOperator.Value)
    let _size                                      = triv _BSMOperator (fun () -> _BSMOperator.Value.size())
    let _solveFor                                  (rhs : ICell<Vector>)   
                                                   = triv _BSMOperator (fun () -> _BSMOperator.Value.solveFor(rhs.Value))
    let _SOR                                       (rhs : ICell<Vector>) (tol : ICell<double>)   
                                                   = triv _BSMOperator (fun () -> _BSMOperator.Value.SOR(rhs.Value, tol.Value))
    let _subtract                                  (A : ICell<IOperator>) (B : ICell<IOperator>)   
                                                   = triv _BSMOperator (fun () -> _BSMOperator.Value.subtract(A.Value, B.Value))
    let _upperDiagonal                             = triv _BSMOperator (fun () -> _BSMOperator.Value.upperDiagonal())
...
*)
    let mutable
        _BSMOperator                               = make (fun () -> new BSMOperator (grid.Value, Process.Value, residualTime.Value))
    let _add                                       (A : ICell<IOperator>) (B : ICell<IOperator>)   
                                                   = triv _BSMOperator (fun () -> _BSMOperator.Value.add(A.Value, B.Value))
    let _applyTo                                   (v : ICell<Vector>)   
                                                   = triv _BSMOperator (fun () -> _BSMOperator.Value.applyTo(v.Value))
...
*)
    let mutable
        _BSMOperator                               = make (fun () -> new BSMOperator ())
    let _add                                       (A : ICell<IOperator>) (B : ICell<IOperator>)   
                                                   = triv _BSMOperator (fun () -> _BSMOperator.Value.add(A.Value, B.Value))
    let _applyTo                                   (v : ICell<Vector>)   
                                                   = triv _BSMOperator (fun () -> _BSMOperator.Value.applyTo(v.Value))
