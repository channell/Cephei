...
*)
    ...
    let _add                                       (A : ICell<IOperator>) (B : ICell<IOperator>)   
                                                   = cell (fun () -> _BSMOperator.Value.add(A.Value, B.Value))
    let _applyTo                                   (v : ICell<Vector>)   
                                                   = cell (fun () -> _BSMOperator.Value.applyTo(v.Value))
    let _Clone                                     = cell (fun () -> _BSMOperator.Value.Clone())
    let _diagonal                                  = cell (fun () -> _BSMOperator.Value.diagonal())
    let _identity                                  (size : ICell<int>)   
                                                   = cell (fun () -> _BSMOperator.Value.identity(size.Value))
    let _isTimeDependent                           = cell (fun () -> _BSMOperator.Value.isTimeDependent())
    let _lowerDiagonal                             = cell (fun () -> _BSMOperator.Value.lowerDiagonal())
    let _multiply                                  (a : ICell<double>) (o : ICell<IOperator>)   
                                                   = cell (fun () -> _BSMOperator.Value.multiply(a.Value, o.Value))
    let _setFirstRow                               (valB : ICell<double>) (valC : ICell<double>)   
                                                   = cell (fun () -> _BSMOperator.Value.setFirstRow(valB.Value, valC.Value)
                                                                     _BSMOperator.Value)
    let _setLastRow                                (valA : ICell<double>) (valB : ICell<double>)   
                                                   = cell (fun () -> _BSMOperator.Value.setLastRow(valA.Value, valB.Value)
                                                                     _BSMOperator.Value)
    let _setMidRow                                 (i : ICell<int>) (valA : ICell<double>) (valB : ICell<double>) (valC : ICell<double>)   
                                                   = cell (fun () -> _BSMOperator.Value.setMidRow(i.Value, valA.Value, valB.Value, valC.Value)
                                                                     _BSMOperator.Value)
    let _setMidRows                                (valA : ICell<double>) (valB : ICell<double>) (valC : ICell<double>)   
                                                   = cell (fun () -> _BSMOperator.Value.setMidRows(valA.Value, valB.Value, valC.Value)
                                                                     _BSMOperator.Value)
    let _setTime                                   (t : ICell<double>)   
                                                   = cell (fun () -> _BSMOperator.Value.setTime(t.Value)
                                                                     _BSMOperator.Value)
    let _size                                      = cell (fun () -> _BSMOperator.Value.size())
    let _solveFor                                  (rhs : ICell<Vector>)   
                                                   = cell (fun () -> _BSMOperator.Value.solveFor(rhs.Value))
    let _SOR                                       (rhs : ICell<Vector>) (tol : ICell<double>)   
                                                   = cell (fun () -> _BSMOperator.Value.SOR(rhs.Value, tol.Value))
    let _subtract                                  (A : ICell<IOperator>) (B : ICell<IOperator>)   
                                                   = cell (fun () -> _BSMOperator.Value.subtract(A.Value, B.Value))
    let _upperDiagonal                             = cell (fun () -> _BSMOperator.Value.upperDiagonal())
