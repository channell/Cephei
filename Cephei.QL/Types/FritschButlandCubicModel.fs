...
*)
    ...
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _FritschButlandCubic.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = triv (fun () -> _FritschButlandCubic.Value.empty())
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _FritschButlandCubic.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _FritschButlandCubic.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = triv (fun () -> _FritschButlandCubic.Value.update()
                                                                     _FritschButlandCubic.Value)
    let _value                                     (x : ICell<double>)   
                                                   = triv (fun () -> _FritschButlandCubic.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _FritschButlandCubic.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = triv (fun () -> _FritschButlandCubic.Value.xMax())
    let _xMin                                      = triv (fun () -> _FritschButlandCubic.Value.xMin())
    let _allowsExtrapolation                       = triv (fun () -> _FritschButlandCubic.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv (fun () -> _FritschButlandCubic.Value.disableExtrapolation(b.Value)
                                                                     _FritschButlandCubic.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv (fun () -> _FritschButlandCubic.Value.enableExtrapolation(b.Value)
                                                                     _FritschButlandCubic.Value)
    let _extrapolate                               = triv (fun () -> _FritschButlandCubic.Value.extrapolate)
