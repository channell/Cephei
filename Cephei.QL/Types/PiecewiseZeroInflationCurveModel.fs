...
*)
    ...
    let _accuracy_                                 = cell (fun () -> _PiecewiseZeroInflationCurve.Value.accuracy_)
    let _baseDate                                  = cell (fun () -> _PiecewiseZeroInflationCurve.Value.baseDate())
    let _Clone                                     = cell (fun () -> _PiecewiseZeroInflationCurve.Value.Clone())
    let _data                                      = cell (fun () -> _PiecewiseZeroInflationCurve.Value.data())
    let _data_                                     = cell (fun () -> _PiecewiseZeroInflationCurve.Value.data_)
    let _dates                                     = cell (fun () -> _PiecewiseZeroInflationCurve.Value.dates())
    let _dates_                                    = cell (fun () -> _PiecewiseZeroInflationCurve.Value.dates_)
    let _discountImpl                              (i : ICell<Interpolation>) (t : ICell<double>)   
                                                   = cell (fun () -> _PiecewiseZeroInflationCurve.Value.discountImpl(i.Value, t.Value))
    let _forwardImpl                               (i : ICell<Interpolation>) (t : ICell<double>)   
                                                   = cell (fun () -> _PiecewiseZeroInflationCurve.Value.forwardImpl(i.Value, t.Value))
    let _forwards                                  = cell (fun () -> _PiecewiseZeroInflationCurve.Value.forwards())
    let _guess                                     (i : ICell<int>) (c : ICell<InterpolatedCurve>) (validData : ICell<bool>) (first : ICell<int>)   
                                                   = cell (fun () -> _PiecewiseZeroInflationCurve.Value.guess(i.Value, c.Value, validData.Value, first.Value))
    let _initialDate                               (c : ICell<ZeroInflationTermStructure>)   
                                                   = cell (fun () -> _PiecewiseZeroInflationCurve.Value.initialDate(c.Value))
    let _initialDate1                              = cell (fun () -> _PiecewiseZeroInflationCurve.Value.initialDate())
    let _initialValue                              = cell (fun () -> _PiecewiseZeroInflationCurve.Value.initialValue())
    let _initialValue1                             (c : ICell<ZeroInflationTermStructure>)   
                                                   = cell (fun () -> _PiecewiseZeroInflationCurve.Value.initialValue(c.Value))
    let _instruments_                              = cell (fun () -> _PiecewiseZeroInflationCurve.Value.instruments_)
    let _interpolation_                            = cell (fun () -> _PiecewiseZeroInflationCurve.Value.interpolation_)
    let _interpolator_                             = cell (fun () -> _PiecewiseZeroInflationCurve.Value.interpolator_)
    let _maxDate                                   = cell (fun () -> _PiecewiseZeroInflationCurve.Value.maxDate())
    let _maxDate_                                  = cell (fun () -> _PiecewiseZeroInflationCurve.Value.maxDate_)
    let _maxIterations                             = cell (fun () -> _PiecewiseZeroInflationCurve.Value.maxIterations())
    let _maxValueAfter                             (i : ICell<int>) (c : ICell<InterpolatedCurve>) (validData : ICell<bool>) (first : ICell<int>)   
                                                   = cell (fun () -> _PiecewiseZeroInflationCurve.Value.maxValueAfter(i.Value, c.Value, validData.Value, first.Value))
    let _minValueAfter                             (i : ICell<int>) (c : ICell<InterpolatedCurve>) (validData : ICell<bool>) (first : ICell<int>)   
                                                   = cell (fun () -> _PiecewiseZeroInflationCurve.Value.minValueAfter(i.Value, c.Value, validData.Value, first.Value))
    let _moving_                                   = cell (fun () -> _PiecewiseZeroInflationCurve.Value.moving_)
    let _nodes                                     = cell (fun () -> _PiecewiseZeroInflationCurve.Value.nodes())
    let _rates                                     = cell (fun () -> _PiecewiseZeroInflationCurve.Value.rates())
    let _registerWith                              (helper : ICell<BootstrapHelper<ZeroInflationTermStructure>>)   
                                                   = cell (fun () -> _PiecewiseZeroInflationCurve.Value.registerWith(helper.Value)
                                                                     _PiecewiseZeroInflationCurve.Value)
    let _setTermStructure                          (helper : ICell<BootstrapHelper<ZeroInflationTermStructure>>)   
                                                   = cell (fun () -> _PiecewiseZeroInflationCurve.Value.setTermStructure(helper.Value)
                                                                     _PiecewiseZeroInflationCurve.Value)
    let _setupInterpolation                        = cell (fun () -> _PiecewiseZeroInflationCurve.Value.setupInterpolation()
                                                                     _PiecewiseZeroInflationCurve.Value)
    let _times                                     = cell (fun () -> _PiecewiseZeroInflationCurve.Value.times())
    let _times_                                    = cell (fun () -> _PiecewiseZeroInflationCurve.Value.times_)
    let _traits_                                   = cell (fun () -> _PiecewiseZeroInflationCurve.Value.traits_)
    let _updateGuess                               (data : ICell<Generic.List<double>>) (discount : ICell<double>) (i : ICell<int>)   
                                                   = cell (fun () -> _PiecewiseZeroInflationCurve.Value.updateGuess(data.Value, discount.Value, i.Value)
                                                                     _PiecewiseZeroInflationCurve.Value)
    let _zeroYieldImpl                             (i : ICell<Interpolation>) (t : ICell<double>)   
                                                   = cell (fun () -> _PiecewiseZeroInflationCurve.Value.zeroYieldImpl(i.Value, t.Value))
    let _zeroRate                                  (d : ICell<Date>) (instObsLag : ICell<Period>) (forceLinearInterpolation : ICell<bool>)   
                                                   = cell (fun () -> _PiecewiseZeroInflationCurve.Value.zeroRate(d.Value, instObsLag.Value, forceLinearInterpolation.Value))
    let _zeroRate1                                 (d : ICell<Date>) (instObsLag : ICell<Period>)   
                                                   = cell (fun () -> _PiecewiseZeroInflationCurve.Value.zeroRate(d.Value, instObsLag.Value))
    let _zeroRate2                                 (d : ICell<Date>)   
                                                   = cell (fun () -> _PiecewiseZeroInflationCurve.Value.zeroRate(d.Value))
    let _zeroRate3                                 (d : ICell<Date>) (instObsLag : ICell<Period>) (forceLinearInterpolation : ICell<bool>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _PiecewiseZeroInflationCurve.Value.zeroRate(d.Value, instObsLag.Value, forceLinearInterpolation.Value, extrapolate.Value))
    let _baseRate                                  = cell (fun () -> _PiecewiseZeroInflationCurve.Value.baseRate())
    let _frequency                                 = cell (fun () -> _PiecewiseZeroInflationCurve.Value.frequency())
    let _hasSeasonality                            = cell (fun () -> _PiecewiseZeroInflationCurve.Value.hasSeasonality())
    let _indexIsInterpolated                       = cell (fun () -> _PiecewiseZeroInflationCurve.Value.indexIsInterpolated())
    let _nominalTermStructure                      = cell (fun () -> _PiecewiseZeroInflationCurve.Value.nominalTermStructure())
    let _observationLag                            = cell (fun () -> _PiecewiseZeroInflationCurve.Value.observationLag())
    let _seasonality                               = cell (fun () -> _PiecewiseZeroInflationCurve.Value.seasonality())
    let _setSeasonality                            (seasonality : ICell<Seasonality>)   
                                                   = cell (fun () -> _PiecewiseZeroInflationCurve.Value.setSeasonality(seasonality.Value)
                                                                     _PiecewiseZeroInflationCurve.Value)
    let _calendar                                  = cell (fun () -> _PiecewiseZeroInflationCurve.Value.calendar())
    let _dayCounter                                = cell (fun () -> _PiecewiseZeroInflationCurve.Value.dayCounter())
    let _maxTime                                   = cell (fun () -> _PiecewiseZeroInflationCurve.Value.maxTime())
    let _referenceDate                             = cell (fun () -> _PiecewiseZeroInflationCurve.Value.referenceDate())
    let _settlementDays                            = cell (fun () -> _PiecewiseZeroInflationCurve.Value.settlementDays())
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = cell (fun () -> _PiecewiseZeroInflationCurve.Value.timeFromReference(date.Value))
    let _update                                    = cell (fun () -> _PiecewiseZeroInflationCurve.Value.update()
                                                                     _PiecewiseZeroInflationCurve.Value)
    let _allowsExtrapolation                       = cell (fun () -> _PiecewiseZeroInflationCurve.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _PiecewiseZeroInflationCurve.Value.disableExtrapolation(b.Value)
                                                                     _PiecewiseZeroInflationCurve.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _PiecewiseZeroInflationCurve.Value.enableExtrapolation(b.Value)
                                                                     _PiecewiseZeroInflationCurve.Value)
    let _extrapolate                               = cell (fun () -> _PiecewiseZeroInflationCurve.Value.extrapolate)
