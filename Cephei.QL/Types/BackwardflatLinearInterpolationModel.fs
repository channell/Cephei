...
*)
    ...
    let _locateX                                   (x : ICell<double>)   
                                                   = triv (fun () -> _BackwardflatLinearInterpolation.Value.locateX(x.Value))
    let _locateY                                   (y : ICell<double>)   
                                                   = triv (fun () -> _BackwardflatLinearInterpolation.Value.locateY(y.Value))
    let _update                                    = triv (fun () -> _BackwardflatLinearInterpolation.Value.update()
                                                                     _BackwardflatLinearInterpolation.Value)
    let _value                                     (x : ICell<double>) (y : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _BackwardflatLinearInterpolation.Value.value(x.Value, y.Value, allowExtrapolation.Value))
    let _value1                                    (x : ICell<double>) (y : ICell<double>)   
                                                   = triv (fun () -> _BackwardflatLinearInterpolation.Value.value(x.Value, y.Value))
    let _xMax                                      = triv (fun () -> _BackwardflatLinearInterpolation.Value.xMax())
    let _xMin                                      = triv (fun () -> _BackwardflatLinearInterpolation.Value.xMin())
    let _xValues                                   = triv (fun () -> _BackwardflatLinearInterpolation.Value.xValues())
    let _yMax                                      = triv (fun () -> _BackwardflatLinearInterpolation.Value.yMax())
    let _yMin                                      = triv (fun () -> _BackwardflatLinearInterpolation.Value.yMin())
    let _yValues                                   = triv (fun () -> _BackwardflatLinearInterpolation.Value.yValues())
    let _zData                                     = triv (fun () -> _BackwardflatLinearInterpolation.Value.zData())
    let _allowsExtrapolation                       = triv (fun () -> _BackwardflatLinearInterpolation.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv (fun () -> _BackwardflatLinearInterpolation.Value.disableExtrapolation(b.Value)
                                                                     _BackwardflatLinearInterpolation.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv (fun () -> _BackwardflatLinearInterpolation.Value.enableExtrapolation(b.Value)
                                                                     _BackwardflatLinearInterpolation.Value)
