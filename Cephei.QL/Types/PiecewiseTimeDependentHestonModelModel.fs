...
*)
    ...
    let _rho                                       (t : ICell<double>)   
                                                   = triv (fun () -> _PiecewiseTimeDependentHestonModel.Value.rho(t.Value))
    let _riskFreeRate                              = triv (fun () -> _PiecewiseTimeDependentHestonModel.Value.riskFreeRate())
    let _s0                                        = triv (fun () -> _PiecewiseTimeDependentHestonModel.Value.s0())
    let _sigma                                     (t : ICell<double>)   
                                                   = triv (fun () -> _PiecewiseTimeDependentHestonModel.Value.sigma(t.Value))
    let _theta                                     (t : ICell<double>)   
                                                   = triv (fun () -> _PiecewiseTimeDependentHestonModel.Value.theta(t.Value))
    let _timeGrid                                  = triv (fun () -> _PiecewiseTimeDependentHestonModel.Value.timeGrid())
    let _v0                                        = triv (fun () -> _PiecewiseTimeDependentHestonModel.Value.v0())
    let _calibrate                                 (instruments : ICell<Generic.List<CalibrationHelper>>) (Method : ICell<OptimizationMethod>) (endCriteria : ICell<EndCriteria>) (additionalConstraint : ICell<Constraint>) (weights : ICell<Generic.List<double>>) (fixParameters : ICell<Generic.List<bool>>)   
                                                   = triv (fun () -> _PiecewiseTimeDependentHestonModel.Value.calibrate(instruments.Value, Method.Value, endCriteria.Value, additionalConstraint.Value, weights.Value, fixParameters.Value)
                                                                     _PiecewiseTimeDependentHestonModel.Value)
    let _constraint                                = triv (fun () -> _PiecewiseTimeDependentHestonModel.Value.CONSTRAINT())
    let _endCriteria                               = triv (fun () -> _PiecewiseTimeDependentHestonModel.Value.endCriteria())
    let _notifyObservers                           = triv (fun () -> _PiecewiseTimeDependentHestonModel.Value.notifyObservers()
                                                                     _PiecewiseTimeDependentHestonModel.Value)
    let _parameters                                = triv (fun () -> _PiecewiseTimeDependentHestonModel.Value.parameters())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv (fun () -> _PiecewiseTimeDependentHestonModel.Value.registerWith(handler.Value)
                                                                     _PiecewiseTimeDependentHestonModel.Value)
    let _setParams                                 (parameters : ICell<Vector>)   
                                                   = triv (fun () -> _PiecewiseTimeDependentHestonModel.Value.setParams(parameters.Value)
                                                                     _PiecewiseTimeDependentHestonModel.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = triv (fun () -> _PiecewiseTimeDependentHestonModel.Value.unregisterWith(handler.Value)
                                                                     _PiecewiseTimeDependentHestonModel.Value)
    let _update                                    = triv (fun () -> _PiecewiseTimeDependentHestonModel.Value.update()
                                                                     _PiecewiseTimeDependentHestonModel.Value)
