...
*)
    ...
    let _denseSabrParameters                       = cell (fun () -> _SwaptionVolCube1x.Value.denseSabrParameters())
    let _marketVolCube                             = cell (fun () -> _SwaptionVolCube1x.Value.marketVolCube())
    let _marketVolCube1                            (i : ICell<int>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.marketVolCube(i.Value))
    let _recalibration                             (beta : ICell<double>) (swapTenor : ICell<Period>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.recalibration(beta.Value, swapTenor.Value)
    ...
    let _recalibration1                            (swapLengths : ICell<Generic.List<Period>>) (beta : ICell<Generic.List<double>>) (swapTenor : ICell<Period>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.recalibration(swapLengths.Value, beta.Value, swapTenor.Value)
                                                                     _SwaptionVolCube1x.Value)
    ...
    let _sabrCalibrationSection                    (marketVolCube : ICell<SwaptionVolCube1x.Cube>) (parametersCube : ICell<SwaptionVolCube1x.Cube>) (swapTenor : ICell<Period>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.sabrCalibrationSection(marketVolCube.Value, parametersCube.Value, swapTenor.Value)
                                                                     _SwaptionVolCube1x.Value)
    let _sparseSabrParameters                      = cell (fun () -> _SwaptionVolCube1x.Value.sparseSabrParameters())
    let _updateAfterRecalibration                  = cell (fun () -> _SwaptionVolCube1x.Value.updateAfterRecalibration()
                                                                     _SwaptionVolCube1x.Value)
    let _volCubeAtmCalibrated                      = cell (fun () -> _SwaptionVolCube1x.Value.volCubeAtmCalibrated())
    let _atmStrike                                 (optionDate : ICell<Date>) (swapTenor : ICell<Period>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.atmStrike(optionDate.Value, swapTenor.Value))
    let _atmStrike1                                (optionTenor : ICell<Period>) (swapTenor : ICell<Period>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.atmStrike(optionTenor.Value, swapTenor.Value))
    let _atmVol                                    = cell (fun () -> _SwaptionVolCube1x.Value.atmVol())
    let _calendar                                  = cell (fun () -> _SwaptionVolCube1x.Value.calendar())
    let _dayCounter                                = cell (fun () -> _SwaptionVolCube1x.Value.dayCounter())
    let _maxDate                                   = cell (fun () -> _SwaptionVolCube1x.Value.maxDate())
    let _maxStrike                                 = cell (fun () -> _SwaptionVolCube1x.Value.maxStrike())
    let _maxSwapTenor                              = cell (fun () -> _SwaptionVolCube1x.Value.maxSwapTenor())
    let _maxTime                                   = cell (fun () -> _SwaptionVolCube1x.Value.maxTime())
    let _minStrike                                 = cell (fun () -> _SwaptionVolCube1x.Value.minStrike())
    let _referenceDate                             = cell (fun () -> _SwaptionVolCube1x.Value.referenceDate())
    let _settlementDays                            = cell (fun () -> _SwaptionVolCube1x.Value.settlementDays())
    let _shortSwapIndexBase                        = cell (fun () -> _SwaptionVolCube1x.Value.shortSwapIndexBase())
    let _strikeSpreads                             = cell (fun () -> _SwaptionVolCube1x.Value.strikeSpreads())
    let _swapIndexBase                             = cell (fun () -> _SwaptionVolCube1x.Value.swapIndexBase())
    let _vegaWeightedSmileFit                      = cell (fun () -> _SwaptionVolCube1x.Value.vegaWeightedSmileFit())
    let _volatilityType                            = cell (fun () -> _SwaptionVolCube1x.Value.volatilityType())
    let _volSpreads                                = cell (fun () -> _SwaptionVolCube1x.Value.volSpreads())
    let _optionDateFromTime                        (optionTime : ICell<double>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.optionDateFromTime(optionTime.Value))
    let _optionDates                               = cell (fun () -> _SwaptionVolCube1x.Value.optionDates())
    let _optionTenors                              = cell (fun () -> _SwaptionVolCube1x.Value.optionTenors())
    let _optionTimes                               = cell (fun () -> _SwaptionVolCube1x.Value.optionTimes())
    let _swapLengths                               = cell (fun () -> _SwaptionVolCube1x.Value.swapLengths())
    let _swapTenors                                = cell (fun () -> _SwaptionVolCube1x.Value.swapTenors())
    let _update                                    = cell (fun () -> _SwaptionVolCube1x.Value.update()
                                                                     _SwaptionVolCube1x.Value)
    let _blackVariance                             (optionTenor : ICell<Period>) (swapTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.blackVariance(optionTenor.Value, swapTenor.Value, strike.Value, extrapolate.Value))
    let _blackVariance1                            (optionDate : ICell<Date>) (swapTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.blackVariance(optionDate.Value, swapTenor.Value, strike.Value, extrapolate.Value))
    let _blackVariance2                            (optionTime : ICell<double>) (swapTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.blackVariance(optionTime.Value, swapTenor.Value, strike.Value, extrapolate.Value))
    let _blackVariance3                            (optionTenor : ICell<Period>) (swapLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.blackVariance(optionTenor.Value, swapLength.Value, strike.Value, extrapolate.Value))
    let _blackVariance4                            (optionTime : ICell<double>) (swapLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.blackVariance(optionTime.Value, swapLength.Value, strike.Value, extrapolate.Value))
    let _blackVariance5                            (optionDate : ICell<Date>) (swapLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.blackVariance(optionDate.Value, swapLength.Value, strike.Value, extrapolate.Value))
    let _maxSwapLength                             = cell (fun () -> _SwaptionVolCube1x.Value.maxSwapLength())
    let _shift                                     (optionTime : ICell<double>) (swapLength : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.shift(optionTime.Value, swapLength.Value, extrapolate.Value))
    let _shift1                                    (optionDate : ICell<Date>) (swapLength : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.shift(optionDate.Value, swapLength.Value, extrapolate.Value))
    let _shift2                                    (optionTenor : ICell<Period>) (swapTenor : ICell<Period>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.shift(optionTenor.Value, swapTenor.Value, extrapolate.Value))
    let _shift3                                    (optionTenor : ICell<Period>) (swapLength : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.shift(optionTenor.Value, swapLength.Value, extrapolate.Value))
    let _shift4                                    (optionTime : ICell<double>) (swapTenor : ICell<Period>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.shift(optionTime.Value, swapTenor.Value, extrapolate.Value))
    let _shift5                                    (optionDate : ICell<Date>) (swapTenor : ICell<Period>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.shift(optionDate.Value, swapTenor.Value, extrapolate.Value))
    let _smileSection                              (optionDate : ICell<Date>) (swapTenor : ICell<Period>) (extr : ICell<bool>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.smileSection(optionDate.Value, swapTenor.Value, extr.Value))
    let _smileSection1                             (optionTenor : ICell<Period>) (swapTenor : ICell<Period>) (extr : ICell<bool>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.smileSection(optionTenor.Value, swapTenor.Value, extr.Value))
    let _smileSection2                             (optionTime : ICell<double>) (swapLength : ICell<double>) (extr : ICell<bool>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.smileSection(optionTime.Value, swapLength.Value, extr.Value))
    let _swapLength                                (start : ICell<Date>) (End : ICell<Date>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.swapLength(start.Value, End.Value))
    let _swapLength1                               (swapTenor : ICell<Period>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.swapLength(swapTenor.Value))
    let _volatility                                (optionTime : ICell<double>) (swapTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.volatility(optionTime.Value, swapTenor.Value, strike.Value, extrapolate.Value))
    let _volatility1                               (optionTenor : ICell<Period>) (swapLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.volatility(optionTenor.Value, swapLength.Value, strike.Value, extrapolate.Value))
    let _volatility2                               (optionDate : ICell<Date>) (swapLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.volatility(optionDate.Value, swapLength.Value, strike.Value, extrapolate.Value))
    let _volatility3                               (optionTime : ICell<double>) (swapLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.volatility(optionTime.Value, swapLength.Value, strike.Value, extrapolate.Value))
    let _volatility4                               (optionDate : ICell<Date>) (swapTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.volatility(optionDate.Value, swapTenor.Value, strike.Value, extrapolate.Value))
    let _volatility5                               (optionTenor : ICell<Period>) (swapTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.volatility(optionTenor.Value, swapTenor.Value, strike.Value, extrapolate.Value))
    let _businessDayConvention                     = cell (fun () -> _SwaptionVolCube1x.Value.businessDayConvention())
    let _optionDateFromTenor                       (p : ICell<Period>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.optionDateFromTenor(p.Value))
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.timeFromReference(date.Value))
    let _allowsExtrapolation                       = cell (fun () -> _SwaptionVolCube1x.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.disableExtrapolation(b.Value)
                                                                     _SwaptionVolCube1x.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _SwaptionVolCube1x.Value.enableExtrapolation(b.Value)
                                                                     _SwaptionVolCube1x.Value)
    let _extrapolate                               = cell (fun () -> _SwaptionVolCube1x.Value.extrapolate)
