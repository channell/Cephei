...
*)
    ...
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearMonotonicParabolic.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearMonotonicParabolic.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = triv (fun () -> _MixedLinearMonotonicParabolic.Value.update()
                                                                     _MixedLinearMonotonicParabolic.Value)
    let _value                                     (x : ICell<double>)   
                                                   = triv (fun () -> _MixedLinearMonotonicParabolic.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearMonotonicParabolic.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = triv (fun () -> _MixedLinearMonotonicParabolic.Value.xMax())
    let _xMin                                      = triv (fun () -> _MixedLinearMonotonicParabolic.Value.xMin())
    let _allowsExtrapolation                       = triv (fun () -> _MixedLinearMonotonicParabolic.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearMonotonicParabolic.Value.disableExtrapolation(b.Value)
                                                                     _MixedLinearMonotonicParabolic.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearMonotonicParabolic.Value.enableExtrapolation(b.Value)
                                                                     _MixedLinearMonotonicParabolic.Value)
    let _extrapolate                               = triv (fun () -> _MixedLinearMonotonicParabolic.Value.extrapolate)
    do this.Bind(_MixedLinearMonotonicParabolic)
(* 
    casting 
*)
    internal new () = MixedLinearMonotonicParabolicModel(null,null,null,null,null)
