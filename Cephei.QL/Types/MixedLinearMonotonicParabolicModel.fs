...
*)
    ...
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _MixedLinearMonotonicParabolic.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = cell (fun () -> _MixedLinearMonotonicParabolic.Value.empty())
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _MixedLinearMonotonicParabolic.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _MixedLinearMonotonicParabolic.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = cell (fun () -> _MixedLinearMonotonicParabolic.Value.update()
                                                                     _MixedLinearMonotonicParabolic.Value)
    let _value                                     (x : ICell<double>)   
                                                   = cell (fun () -> _MixedLinearMonotonicParabolic.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _MixedLinearMonotonicParabolic.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = cell (fun () -> _MixedLinearMonotonicParabolic.Value.xMax())
    let _xMin                                      = cell (fun () -> _MixedLinearMonotonicParabolic.Value.xMin())
    let _allowsExtrapolation                       = cell (fun () -> _MixedLinearMonotonicParabolic.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _MixedLinearMonotonicParabolic.Value.disableExtrapolation(b.Value)
                                                                     _MixedLinearMonotonicParabolic.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _MixedLinearMonotonicParabolic.Value.enableExtrapolation(b.Value)
                                                                     _MixedLinearMonotonicParabolic.Value)
    let _extrapolate                               = cell (fun () -> _MixedLinearMonotonicParabolic.Value.extrapolate)
