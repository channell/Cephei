...
*)
    ...
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _HarmonicCubic.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = triv (fun () -> _HarmonicCubic.Value.empty())
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _HarmonicCubic.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _HarmonicCubic.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = triv (fun () -> _HarmonicCubic.Value.update()
                                                                     _HarmonicCubic.Value)
    let _value                                     (x : ICell<double>)   
                                                   = triv (fun () -> _HarmonicCubic.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _HarmonicCubic.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = triv (fun () -> _HarmonicCubic.Value.xMax())
    let _xMin                                      = triv (fun () -> _HarmonicCubic.Value.xMin())
    let _allowsExtrapolation                       = triv (fun () -> _HarmonicCubic.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv (fun () -> _HarmonicCubic.Value.disableExtrapolation(b.Value)
                                                                     _HarmonicCubic.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv (fun () -> _HarmonicCubic.Value.enableExtrapolation(b.Value)
                                                                     _HarmonicCubic.Value)
    let _extrapolate                               = triv (fun () -> _HarmonicCubic.Value.extrapolate)
