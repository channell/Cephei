...
*)
    ...
    let _aCoefficients                             = cell (fun () -> _HarmonicCubic.Value.aCoefficients())
    let _bCoefficients                             = cell (fun () -> _HarmonicCubic.Value.bCoefficients())
    let _cCoefficients                             = cell (fun () -> _HarmonicCubic.Value.cCoefficients())
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _HarmonicCubic.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = cell (fun () -> _HarmonicCubic.Value.empty())
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _HarmonicCubic.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _HarmonicCubic.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = cell (fun () -> _HarmonicCubic.Value.update()
                                                                     _HarmonicCubic.Value)
    let _value                                     (x : ICell<double>)   
                                                   = cell (fun () -> _HarmonicCubic.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _HarmonicCubic.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = cell (fun () -> _HarmonicCubic.Value.xMax())
    let _xMin                                      = cell (fun () -> _HarmonicCubic.Value.xMin())
    let _allowsExtrapolation                       = cell (fun () -> _HarmonicCubic.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _HarmonicCubic.Value.disableExtrapolation(b.Value)
                                                                     _HarmonicCubic.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _HarmonicCubic.Value.enableExtrapolation(b.Value)
                                                                     _HarmonicCubic.Value)
    let _extrapolate                               = cell (fun () -> _HarmonicCubic.Value.extrapolate)
