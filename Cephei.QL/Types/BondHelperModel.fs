...
*)
    ...
    let _bond                                      = cell (fun () -> _BondHelper.Value.bond())
    let _impliedQuote                              = cell (fun () -> _BondHelper.Value.impliedQuote())
    let _setTermStructure                          (t : ICell<YieldTermStructure>)   
                                                   = cell (fun () -> _BondHelper.Value.setTermStructure(t.Value)
                                                                     _BondHelper.Value)
    let _useCleanPrice                             = cell (fun () -> _BondHelper.Value.useCleanPrice())
    let _earliestDate                              = cell (fun () -> _BondHelper.Value.earliestDate())
    let _latestDate                                = cell (fun () -> _BondHelper.Value.latestDate())
    let _latestRelevantDate                        = cell (fun () -> _BondHelper.Value.latestRelevantDate())
    let _maturityDate                              = cell (fun () -> _BondHelper.Value.maturityDate())
    let _pillarDate                                = cell (fun () -> _BondHelper.Value.pillarDate())
    let _quote                                     = cell (fun () -> _BondHelper.Value.quote())
    let _quoteError                                = cell (fun () -> _BondHelper.Value.quoteError())
    let _quoteIsValid                              = cell (fun () -> _BondHelper.Value.quoteIsValid())
    let _quoteValue                                = cell (fun () -> _BondHelper.Value.quoteValue())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _BondHelper.Value.registerWith(handler.Value)
                                                                     _BondHelper.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _BondHelper.Value.unregisterWith(handler.Value)
                                                                     _BondHelper.Value)
    let _update                                    = cell (fun () -> _BondHelper.Value.update()
                                                                     _BondHelper.Value)
