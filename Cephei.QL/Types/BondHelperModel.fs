...
*)
    let mutable
        _BondHelper                                = make (fun () -> new BondHelper (price.Value, bond.Value, useCleanPrice.Value))
    let _bond                                      = triv _BondHelper (fun () -> _BondHelper.Value.bond())
    let _impliedQuote                              = triv _BondHelper (fun () -> _BondHelper.Value.impliedQuote())
    let _setTermStructure                          (t : ICell<YieldTermStructure>)   
                                                   = triv _BondHelper (fun () -> _BondHelper.Value.setTermStructure(t.Value)
                                                                                 _BondHelper.Value)
    let _useCleanPrice                             = triv _BondHelper (fun () -> _BondHelper.Value.useCleanPrice())
    let _earliestDate                              = triv _BondHelper (fun () -> _BondHelper.Value.earliestDate())
    let _latestDate                                = triv _BondHelper (fun () -> _BondHelper.Value.latestDate())
    let _latestRelevantDate                        = triv _BondHelper (fun () -> _BondHelper.Value.latestRelevantDate())
    let _maturityDate                              = triv _BondHelper (fun () -> _BondHelper.Value.maturityDate())
    let _pillarDate                                = triv _BondHelper (fun () -> _BondHelper.Value.pillarDate())
    let _quote                                     = triv _BondHelper (fun () -> _BondHelper.Value.quote())
    let _quoteError                                = triv _BondHelper (fun () -> _BondHelper.Value.quoteError())
    let _quoteIsValid                              = triv _BondHelper (fun () -> _BondHelper.Value.quoteIsValid())
    let _quoteValue                                = triv _BondHelper (fun () -> _BondHelper.Value.quoteValue())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv _BondHelper (fun () -> _BondHelper.Value.registerWith(handler.Value)
                                                                                 _BondHelper.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = triv _BondHelper (fun () -> _BondHelper.Value.unregisterWith(handler.Value)
                                                                                 _BondHelper.Value)
    let _update                                    = triv _BondHelper (fun () -> _BondHelper.Value.update()
                                                                                 _BondHelper.Value)
