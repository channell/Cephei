...
*)
    ...
    let _Clone                                     = cell (fun () -> _InterpolatedDiscountCurve.Value.Clone())
    let _data                                      = cell (fun () -> _InterpolatedDiscountCurve.Value.data())
    let _data_                                     = cell (fun () -> _InterpolatedDiscountCurve.Value.data_)
    let _dates                                     = cell (fun () -> _InterpolatedDiscountCurve.Value.dates())
    let _dates_                                    = cell (fun () -> _InterpolatedDiscountCurve.Value.dates_)
    let _discounts                                 = cell (fun () -> _InterpolatedDiscountCurve.Value.discounts())
    let _interpolation_                            = cell (fun () -> _InterpolatedDiscountCurve.Value.interpolation_)
    let _interpolator_                             = cell (fun () -> _InterpolatedDiscountCurve.Value.interpolator_)
    let _maxDate                                   = cell (fun () -> _InterpolatedDiscountCurve.Value.maxDate())
    let _maxDate_                                  = cell (fun () -> _InterpolatedDiscountCurve.Value.maxDate_)
    let _nodes                                     = cell (fun () -> _InterpolatedDiscountCurve.Value.nodes())
    let _setupInterpolation                        = cell (fun () -> _InterpolatedDiscountCurve.Value.setupInterpolation()
                                                                     _InterpolatedDiscountCurve.Value)
    let _times                                     = cell (fun () -> _InterpolatedDiscountCurve.Value.times())
    let _times_                                    = cell (fun () -> _InterpolatedDiscountCurve.Value.times_)
    let _discount                                  (t : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _InterpolatedDiscountCurve.Value.discount(t.Value, extrapolate.Value))
    let _discount1                                 (d : ICell<Date>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _InterpolatedDiscountCurve.Value.discount(d.Value, extrapolate.Value))
    let _forwardRate                               (d : ICell<Date>) (p : ICell<Period>) (dayCounter : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _InterpolatedDiscountCurve.Value.forwardRate(d.Value, p.Value, dayCounter.Value, comp.Value, freq.Value, extrapolate.Value))
    let _forwardRate1                              (d1 : ICell<Date>) (d2 : ICell<Date>) (dayCounter : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _InterpolatedDiscountCurve.Value.forwardRate(d1.Value, d2.Value, dayCounter.Value, comp.Value, freq.Value, extrapolate.Value))
    let _forwardRate2                              (t1 : ICell<double>) (t2 : ICell<double>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _InterpolatedDiscountCurve.Value.forwardRate(t1.Value, t2.Value, comp.Value, freq.Value, extrapolate.Value))
    let _jumpDates                                 = cell (fun () -> _InterpolatedDiscountCurve.Value.jumpDates())
    let _jumpTimes                                 = cell (fun () -> _InterpolatedDiscountCurve.Value.jumpTimes())
    let _update                                    = cell (fun () -> _InterpolatedDiscountCurve.Value.update()
                                                                     _InterpolatedDiscountCurve.Value)
    let _zeroRate                                  (t : ICell<double>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _InterpolatedDiscountCurve.Value.zeroRate(t.Value, comp.Value, freq.Value, extrapolate.Value))
    let _zeroRate1                                 (d : ICell<Date>) (dayCounter : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _InterpolatedDiscountCurve.Value.zeroRate(d.Value, dayCounter.Value, comp.Value, freq.Value, extrapolate.Value))
    let _calendar                                  = cell (fun () -> _InterpolatedDiscountCurve.Value.calendar())
    let _dayCounter                                = cell (fun () -> _InterpolatedDiscountCurve.Value.dayCounter())
    let _maxTime                                   = cell (fun () -> _InterpolatedDiscountCurve.Value.maxTime())
    let _referenceDate                             = cell (fun () -> _InterpolatedDiscountCurve.Value.referenceDate())
    let _settlementDays                            = cell (fun () -> _InterpolatedDiscountCurve.Value.settlementDays())
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = cell (fun () -> _InterpolatedDiscountCurve.Value.timeFromReference(date.Value))
    let _allowsExtrapolation                       = cell (fun () -> _InterpolatedDiscountCurve.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _InterpolatedDiscountCurve.Value.disableExtrapolation(b.Value)
                                                                     _InterpolatedDiscountCurve.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _InterpolatedDiscountCurve.Value.enableExtrapolation(b.Value)
                                                                     _InterpolatedDiscountCurve.Value)
    let _extrapolate                               = cell (fun () -> _InterpolatedDiscountCurve.Value.extrapolate)
