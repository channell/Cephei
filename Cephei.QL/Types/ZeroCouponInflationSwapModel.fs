...
*)
    ...
    let _fixedCalendar                             = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).fixedCalendar())
    let _fixedConvention                           = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).fixedConvention())
    let _fixedLeg                                  = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).fixedLeg())
    let _fixedLegNPV                               = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).fixedLegNPV())
    let _fixedRate                                 = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).fixedRate())
    let _inflationCalendar                         = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).inflationCalendar())
    let _inflationConvention                       = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).inflationConvention())
    let _inflationIndex                            = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).inflationIndex())
    let _inflationLeg                              = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).inflationLeg())
    let _inflationLegNPV                           = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).inflationLegNPV())
    let _maturityDate                              = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).maturityDate())
    let _nominal                                   = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).nominal())
    let _observationLag                            = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).observationLag())
    let _startDate                                 = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).startDate())
    let _type                                      = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).TYPE())
    let _endDiscounts                              (j : ICell<int>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).endDiscounts(j.Value))
    let _engine                                    = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).engine)
    let _isExpired                                 = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).isExpired())
    let _leg                                       (j : ICell<int>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).leg(j.Value))
    let _legBPS                                    (j : ICell<int>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).legBPS(j.Value))
    let _legNPV                                    (j : ICell<int>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).legNPV(j.Value))
    let _npvDateDiscount                           = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).npvDateDiscount())
    let _payer                                     (j : ICell<int>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).payer(j.Value))
    let _startDiscounts                            (j : ICell<int>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).startDiscounts(j.Value))
    let _CASH                                      = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).CASH())
    let _errorEstimate                             = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).errorEstimate())
    let _NPV                                       = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).setPricingEngine(e.Value)
                                                                     _ZeroCouponInflationSwap.Value)
    let _valuationDate                             = triv (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).valuationDate())
