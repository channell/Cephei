...
*)
    ...
    let _adjustObservationDates                    = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).adjustObservationDates())
    let _dayCounter                                = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).dayCounter())
    let _fairRate                                  = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).fairRate())
    let _fixedCalendar                             = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).fixedCalendar())
    let _fixedConvention                           = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).fixedConvention())
    let _fixedLeg                                  = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).fixedLeg())
    let _fixedLegNPV                               = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).fixedLegNPV())
    let _fixedRate                                 = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).fixedRate())
    let _inflationCalendar                         = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).inflationCalendar())
    let _inflationConvention                       = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).inflationConvention())
    let _inflationIndex                            = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).inflationIndex())
    let _inflationLeg                              = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).inflationLeg())
    let _inflationLegNPV                           = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).inflationLegNPV())
    let _maturityDate                              = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).maturityDate())
    let _nominal                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).nominal())
    let _observationLag                            = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).observationLag())
    let _startDate                                 = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).startDate())
    let _type                                      = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).TYPE())
    let _endDiscounts                              (j : ICell<int>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).endDiscounts(j.Value))
    let _engine                                    = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).engine)
    let _isExpired                                 = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).isExpired())
    let _leg                                       (j : ICell<int>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).leg(j.Value))
    let _legBPS                                    (j : ICell<int>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).legBPS(j.Value))
    let _legNPV                                    (j : ICell<int>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).legNPV(j.Value))
    let _npvDateDiscount                           = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).npvDateDiscount())
    let _payer                                     (j : ICell<int>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).payer(j.Value))
    let _startDiscounts                            (j : ICell<int>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).startDiscounts(j.Value))
    let _CASH                                      = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).CASH())
    let _errorEstimate                             = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).errorEstimate())
    let _NPV                                       = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).setPricingEngine(e.Value)
                                                                     _ZeroCouponInflationSwap.Value)
    let _valuationDate                             = cell (fun () -> (withEvaluationDate _evaluationDate _ZeroCouponInflationSwap).valuationDate())
