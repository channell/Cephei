...
*)
    ...
    let _maxDate                                   = cell (fun () -> _ConstantOptionletVolatility.Value.maxDate())
    let _maxStrike                                 = cell (fun () -> _ConstantOptionletVolatility.Value.maxStrike())
    let _minStrike                                 = cell (fun () -> _ConstantOptionletVolatility.Value.minStrike())
    let _blackVariance                             (optionTime : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantOptionletVolatility.Value.blackVariance(optionTime.Value, strike.Value, extrapolate.Value))
    let _blackVariance1                            (optionDate : ICell<Date>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantOptionletVolatility.Value.blackVariance(optionDate.Value, strike.Value, extrapolate.Value))
    let _blackVariance2                            (optionTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantOptionletVolatility.Value.blackVariance(optionTenor.Value, strike.Value, extrapolate.Value))
    let _displacement                              = cell (fun () -> _ConstantOptionletVolatility.Value.displacement())
    let _smileSection                              (optionTime : ICell<double>) (extr : ICell<bool>)   
                                                   = cell (fun () -> _ConstantOptionletVolatility.Value.smileSection(optionTime.Value, extr.Value))
    let _smileSection1                             (optionTenor : ICell<Period>) (extr : ICell<bool>)   
                                                   = cell (fun () -> _ConstantOptionletVolatility.Value.smileSection(optionTenor.Value, extr.Value))
    let _smileSection2                             (optionDate : ICell<Date>) (extr : ICell<bool>)   
                                                   = cell (fun () -> _ConstantOptionletVolatility.Value.smileSection(optionDate.Value, extr.Value))
    let _volatility                                (optionTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantOptionletVolatility.Value.volatility(optionTenor.Value, strike.Value, extrapolate.Value))
    let _volatility1                               (optionDate : ICell<Date>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantOptionletVolatility.Value.volatility(optionDate.Value, strike.Value, extrapolate.Value))
    let _volatility2                               (optionTime : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantOptionletVolatility.Value.volatility(optionTime.Value, strike.Value, extrapolate.Value))
    let _volatilityType                            = cell (fun () -> _ConstantOptionletVolatility.Value.volatilityType())
    let _businessDayConvention                     = cell (fun () -> _ConstantOptionletVolatility.Value.businessDayConvention())
    let _optionDateFromTenor                       (p : ICell<Period>)   
                                                   = cell (fun () -> _ConstantOptionletVolatility.Value.optionDateFromTenor(p.Value))
    let _calendar                                  = cell (fun () -> _ConstantOptionletVolatility.Value.calendar())
    let _dayCounter                                = cell (fun () -> _ConstantOptionletVolatility.Value.dayCounter())
    let _maxTime                                   = cell (fun () -> _ConstantOptionletVolatility.Value.maxTime())
    let _referenceDate                             = cell (fun () -> _ConstantOptionletVolatility.Value.referenceDate())
    let _settlementDays                            = cell (fun () -> _ConstantOptionletVolatility.Value.settlementDays())
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = cell (fun () -> _ConstantOptionletVolatility.Value.timeFromReference(date.Value))
    let _update                                    = cell (fun () -> _ConstantOptionletVolatility.Value.update()
                                                                     _ConstantOptionletVolatility.Value)
    let _allowsExtrapolation                       = cell (fun () -> _ConstantOptionletVolatility.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _ConstantOptionletVolatility.Value.disableExtrapolation(b.Value)
                                                                     _ConstantOptionletVolatility.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _ConstantOptionletVolatility.Value.enableExtrapolation(b.Value)
                                                                     _ConstantOptionletVolatility.Value)
    let _extrapolate                               = cell (fun () -> _ConstantOptionletVolatility.Value.extrapolate)
