...
*)
    ...
    let _relativeAccuracy                          = cell (fun () -> _GaussKronrodNonAdaptive.Value.relativeAccuracy())
    let _absoluteAccuracy                          = cell (fun () -> _GaussKronrodNonAdaptive.Value.absoluteAccuracy())
    let _absoluteError                             = cell (fun () -> _GaussKronrodNonAdaptive.Value.absoluteError())
    let _integrationSuccess                        = cell (fun () -> _GaussKronrodNonAdaptive.Value.integrationSuccess())
    let _maxEvaluations                            = cell (fun () -> _GaussKronrodNonAdaptive.Value.maxEvaluations())
    let _numberOfEvaluations                       = cell (fun () -> _GaussKronrodNonAdaptive.Value.numberOfEvaluations())
    let _setAbsoluteAccuracy                       (accuracy : ICell<double>)   
                                                   = cell (fun () -> _GaussKronrodNonAdaptive.Value.setAbsoluteAccuracy(accuracy.Value)
                                                                     _GaussKronrodNonAdaptive.Value)
    let _setMaxEvaluations                         (maxEvaluations : ICell<int>)   
                                                   = cell (fun () -> _GaussKronrodNonAdaptive.Value.setMaxEvaluations(maxEvaluations.Value)
                                                                     _GaussKronrodNonAdaptive.Value)
    let _value                                     (f : ICell<Func<double,double>>) (a : ICell<double>) (b : ICell<double>)   
                                                   = cell (fun () -> _GaussKronrodNonAdaptive.Value.value(f.Value, a.Value, b.Value))
