...
*)
    ...
    let _delta                                     = cell (fun () -> (withEvaluationDate _evaluationDate _CliquetOption).delta())
    let _deltaForward                              = cell (fun () -> (withEvaluationDate _evaluationDate _CliquetOption).deltaForward())
    let _dividendRho                               = cell (fun () -> (withEvaluationDate _evaluationDate _CliquetOption).dividendRho())
    let _elasticity                                = cell (fun () -> (withEvaluationDate _evaluationDate _CliquetOption).elasticity())
    let _gamma                                     = cell (fun () -> (withEvaluationDate _evaluationDate _CliquetOption).gamma())
    let _isExpired                                 = cell (fun () -> (withEvaluationDate _evaluationDate _CliquetOption).isExpired())
    let _itmCashProbability                        = cell (fun () -> (withEvaluationDate _evaluationDate _CliquetOption).itmCashProbability())
    let _rho                                       = cell (fun () -> (withEvaluationDate _evaluationDate _CliquetOption).rho())
    let _strikeSensitivity                         = cell (fun () -> (withEvaluationDate _evaluationDate _CliquetOption).strikeSensitivity())
    let _theta                                     = cell (fun () -> (withEvaluationDate _evaluationDate _CliquetOption).theta())
    let _thetaPerDay                               = cell (fun () -> (withEvaluationDate _evaluationDate _CliquetOption).thetaPerDay())
    let _vega                                      = cell (fun () -> (withEvaluationDate _evaluationDate _CliquetOption).vega())
    ...
    let _errorEstimate                             = cell (fun () -> (withEvaluationDate _evaluationDate _CliquetOption).errorEstimate())
    let _NPV                                       = cell (fun () -> (withEvaluationDate _evaluationDate _CliquetOption).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CliquetOption).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CliquetOption).setPricingEngine(e.Value)
                                                                     _CliquetOption.Value)
    let _valuationDate                             = cell (fun () -> (withEvaluationDate _evaluationDate _CliquetOption).valuationDate())
