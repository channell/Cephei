...
*)
    ...
    let _at                                        (i : ICell<int>)   
                                                   = cell (fun () -> _Schedule.Value.at(i.Value))
    let _businessDayConvention                     = cell (fun () -> _Schedule.Value.businessDayConvention())
    let _calendar                                  = cell (fun () -> _Schedule.Value.calendar())
    let _Count                                     = cell (fun () -> _Schedule.Value.Count)
    let _date                                      (i : ICell<int>)   
                                                   = cell (fun () -> _Schedule.Value.date(i.Value))
    let _dates                                     = cell (fun () -> _Schedule.Value.dates())
    let _empty                                     = cell (fun () -> _Schedule.Value.empty())
    let _endDate                                   = cell (fun () -> _Schedule.Value.endDate())
    let _endOfMonth                                = cell (fun () -> _Schedule.Value.endOfMonth())
    let _isRegular                                 = cell (fun () -> _Schedule.Value.isRegular())
    let _isRegular1                                (i : ICell<int>)   
                                                   = cell (fun () -> _Schedule.Value.isRegular(i.Value))
    let _nextDate                                  (d : ICell<Date>)   
                                                   = cell (fun () -> _Schedule.Value.nextDate(d.Value))
    let _previousDate                              (d : ICell<Date>)   
                                                   = cell (fun () -> _Schedule.Value.previousDate(d.Value))
    let _rule                                      = cell (fun () -> _Schedule.Value.rule())
    let _size                                      = cell (fun () -> _Schedule.Value.size())
    let _startDate                                 = cell (fun () -> _Schedule.Value.startDate())
    let _tenor                                     = cell (fun () -> _Schedule.Value.tenor())
    let _terminationDateBusinessDayConvention      = cell (fun () -> _Schedule.Value.terminationDateBusinessDayConvention())
    let _this                                      (i : ICell<int>)   
                                                   = cell (fun () -> _Schedule.Value.[i.Value])
    let _until                                     (truncationDate : ICell<Date>)   
                                                   = cell (fun () -> _Schedule.Value.until(truncationDate.Value))
