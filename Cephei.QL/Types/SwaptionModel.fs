...
*)
    let mutable
        _Swaption                                  = make (fun () -> withEngine pricingEngine evaluationDate (new Swaption (swap.Value, exercise.Value, delivery.Value, settlementMethod.Value)))
    let _engine                                    = triv _Swaption (fun () -> (withEvaluationDate _evaluationDate _Swaption).engine)
    let _impliedVolatility                         (targetValue : ICell<double>) (discountCurve : ICell<Handle<YieldTermStructure>>) (guess : ICell<double>) (accuracy : ICell<double>) (maxEvaluations : ICell<int>) (minVol : ICell<double>) (maxVol : ICell<double>) (Type : ICell<VolatilityType>) (displacement : ICell<Nullable<double>>)   
                                                   = triv _Swaption (fun () -> (withEvaluationDate _evaluationDate _Swaption).impliedVolatility(targetValue.Value, discountCurve.Value, guess.Value, accuracy.Value, maxEvaluations.Value, minVol.Value, maxVol.Value, Type.Value, displacement.Value))
    let _isExpired                                 = triv _Swaption (fun () -> (withEvaluationDate _evaluationDate _Swaption).isExpired())
    let _settlementMethod                          = triv _Swaption (fun () -> (withEvaluationDate _evaluationDate _Swaption).settlementMethod())
    let _settlementType                            = triv _Swaption (fun () -> (withEvaluationDate _evaluationDate _Swaption).settlementType())
    let _type                                      = triv _Swaption (fun () -> (withEvaluationDate _evaluationDate _Swaption).TYPE())
    let _underlyingSwap                            = triv _Swaption (fun () -> (withEvaluationDate _evaluationDate _Swaption).underlyingSwap())
    let _validate                                  = triv _Swaption (fun () -> (withEvaluationDate _evaluationDate _Swaption).validate()
                                                                               _Swaption.Value)
    let _exercise                                  = cell _Swaption (fun () -> (withEvaluationDate _evaluationDate _Swaption).exercise())
    let _payoff                                    = cell _Swaption (fun () -> (withEvaluationDate _evaluationDate _Swaption).payoff())
    let _CASH                                      = cell _Swaption (fun () -> (withEvaluationDate _evaluationDate _Swaption).CASH())
    let _errorEstimate                             = triv _Swaption (fun () -> (withEvaluationDate _evaluationDate _Swaption).errorEstimate())
    let _NPV                                       = cell _Swaption (fun () -> (withEvaluationDate _evaluationDate _Swaption).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = triv _Swaption (fun () -> (withEvaluationDate _evaluationDate _Swaption).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = triv _Swaption (fun () -> (withEvaluationDate _evaluationDate _Swaption).setPricingEngine(e.Value)
                                                                               _Swaption.Value)
    let _valuationDate                             = triv _Swaption (fun () -> (withEvaluationDate _evaluationDate _Swaption).valuationDate())
