...
(*
    Functions
*)
    let _Swaption                                  = cell (fun () -> withEngine _pricingEngine.Value (new Swaption (swap.Value, exercise.Value, delivery.Value, settlementMethod.Value)))
    let _engine                                    = cell (fun () -> (withEvaluationDate _evaluationDate _Swaption).engine)
    let _impliedVolatility                         (targetValue : ICell<double>) (discountCurve : ICell<Handle<YieldTermStructure>>) (guess : ICell<double>) (accuracy : ICell<double>) (maxEvaluations : ICell<int>) (minVol : ICell<double>) (maxVol : ICell<double>) (Type : ICell<VolatilityType>) (displacement : ICell<Nullable<double>>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _Swaption).impliedVolatility(targetValue.Value, discountCurve.Value, guess.Value, accuracy.Value, maxEvaluations.Value, minVol.Value, maxVol.Value, Type.Value, displacement.Value))
    let _isExpired                                 = cell (fun () -> (withEvaluationDate _evaluationDate _Swaption).isExpired())
    let _settlementMethod                          = cell (fun () -> (withEvaluationDate _evaluationDate _Swaption).settlementMethod())
    let _settlementType                            = cell (fun () -> (withEvaluationDate _evaluationDate _Swaption).settlementType())
    let _type                                      = cell (fun () -> (withEvaluationDate _evaluationDate _Swaption).TYPE())
    let _underlyingSwap                            = cell (fun () -> (withEvaluationDate _evaluationDate _Swaption).underlyingSwap())
    let _validate                                  = cell (fun () -> (withEvaluationDate _evaluationDate _Swaption).validate()
                                                                     _Swaption.Value)
    ...
    let _errorEstimate                             = cell (fun () -> (withEvaluationDate _evaluationDate _Swaption).errorEstimate())
    let _NPV                                       = cell (fun () -> (withEvaluationDate _evaluationDate _Swaption).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _Swaption).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _Swaption).setPricingEngine(e.Value)
                                                                     _Swaption.Value)
    let _valuationDate                             = cell (fun () -> (withEvaluationDate _evaluationDate _Swaption).valuationDate())
