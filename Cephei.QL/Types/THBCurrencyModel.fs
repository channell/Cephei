...
*)
    ...
    let _Equals                                    (o : ICell<Object>)   
                                                   = triv (fun () -> _THBCurrency.Value.Equals(o.Value))
    let _format                                    = triv (fun () -> _THBCurrency.Value.format)
    let _fractionsPerUnit                          = triv (fun () -> _THBCurrency.Value.fractionsPerUnit)
    let _fractionSymbol                            = triv (fun () -> _THBCurrency.Value.fractionSymbol)
    let _name                                      = triv (fun () -> _THBCurrency.Value.name)
    let _numericCode                               = triv (fun () -> _THBCurrency.Value.numericCode)
    let _rounding                                  = triv (fun () -> _THBCurrency.Value.rounding)
    let _symbol                                    = triv (fun () -> _THBCurrency.Value.symbol)
    let _ToString                                  = triv (fun () -> _THBCurrency.Value.ToString())
    let _triangulationCurrency                     = triv (fun () -> _THBCurrency.Value.triangulationCurrency)
