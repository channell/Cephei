...
*)
    let mutable
        _RangeAccrualPricerByBgm                   = make (fun () -> new RangeAccrualPricerByBgm (correlation.Value, smilesOnExpiry.Value, smilesOnPayment.Value, withSmile.Value, byCallSpread.Value))
    let _swapletPrice                              = triv _RangeAccrualPricerByBgm (fun () -> _RangeAccrualPricerByBgm.Value.swapletPrice())
    let _capletPrice                               (effectiveCap : ICell<double>)   
                                                   = triv _RangeAccrualPricerByBgm (fun () -> _RangeAccrualPricerByBgm.Value.capletPrice(effectiveCap.Value))
    let _capletRate                                (effectiveCap : ICell<double>)   
                                                   = triv _RangeAccrualPricerByBgm (fun () -> _RangeAccrualPricerByBgm.Value.capletRate(effectiveCap.Value))
    let _floorletPrice                             (effectiveFloor : ICell<double>)   
                                                   = triv _RangeAccrualPricerByBgm (fun () -> _RangeAccrualPricerByBgm.Value.floorletPrice(effectiveFloor.Value))
    let _floorletRate                              (effectiveFloor : ICell<double>)   
                                                   = triv _RangeAccrualPricerByBgm (fun () -> _RangeAccrualPricerByBgm.Value.floorletRate(effectiveFloor.Value))
    let _initialize                                (coupon : ICell<FloatingRateCoupon>)   
                                                   = triv _RangeAccrualPricerByBgm (fun () -> _RangeAccrualPricerByBgm.Value.initialize(coupon.Value)
                                                                                              _RangeAccrualPricerByBgm.Value)
    let _swapletRate                               = triv _RangeAccrualPricerByBgm (fun () -> _RangeAccrualPricerByBgm.Value.swapletRate())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv _RangeAccrualPricerByBgm (fun () -> _RangeAccrualPricerByBgm.Value.registerWith(handler.Value)
                                                                                              _RangeAccrualPricerByBgm.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = triv _RangeAccrualPricerByBgm (fun () -> _RangeAccrualPricerByBgm.Value.unregisterWith(handler.Value)
                                                                                              _RangeAccrualPricerByBgm.Value)
    let _update                                    = triv _RangeAccrualPricerByBgm (fun () -> _RangeAccrualPricerByBgm.Value.update()
                                                                                              _RangeAccrualPricerByBgm.Value)
