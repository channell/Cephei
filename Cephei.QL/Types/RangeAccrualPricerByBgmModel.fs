...
*)
    ...
    let _swapletPrice                              = cell (fun () -> _RangeAccrualPricerByBgm.Value.swapletPrice())
    let _capletPrice                               (effectiveCap : ICell<double>)   
                                                   = cell (fun () -> _RangeAccrualPricerByBgm.Value.capletPrice(effectiveCap.Value))
    let _capletRate                                (effectiveCap : ICell<double>)   
                                                   = cell (fun () -> _RangeAccrualPricerByBgm.Value.capletRate(effectiveCap.Value))
    let _floorletPrice                             (effectiveFloor : ICell<double>)   
                                                   = cell (fun () -> _RangeAccrualPricerByBgm.Value.floorletPrice(effectiveFloor.Value))
    let _floorletRate                              (effectiveFloor : ICell<double>)   
                                                   = cell (fun () -> _RangeAccrualPricerByBgm.Value.floorletRate(effectiveFloor.Value))
    let _initialize                                (coupon : ICell<FloatingRateCoupon>)   
                                                   = cell (fun () -> _RangeAccrualPricerByBgm.Value.initialize(coupon.Value)
                                                                     _RangeAccrualPricerByBgm.Value)
    let _swapletRate                               = cell (fun () -> _RangeAccrualPricerByBgm.Value.swapletRate())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _RangeAccrualPricerByBgm.Value.registerWith(handler.Value)
                                                                     _RangeAccrualPricerByBgm.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _RangeAccrualPricerByBgm.Value.unregisterWith(handler.Value)
                                                                     _RangeAccrualPricerByBgm.Value)
    let _update                                    = cell (fun () -> _RangeAccrualPricerByBgm.Value.update()
                                                                     _RangeAccrualPricerByBgm.Value)
