...
*)
    ...
    let _a                                         = cell (fun () -> _HullWhiteForwardProcess.Value.a())
    let _alpha                                     (t : ICell<double>)   
                                                   = cell (fun () -> _HullWhiteForwardProcess.Value.alpha(t.Value))
    let _B                                         (t : ICell<double>) (T2 : ICell<double>)   
                                                   = cell (fun () -> _HullWhiteForwardProcess.Value.B(t.Value, T2.Value))
    let _diffusion                                 (t : ICell<double>) (x : ICell<double>)   
                                                   = cell (fun () -> _HullWhiteForwardProcess.Value.diffusion(t.Value, x.Value))
    let _drift                                     (t : ICell<double>) (x : ICell<double>)   
                                                   = cell (fun () -> _HullWhiteForwardProcess.Value.drift(t.Value, x.Value))
    let _expectation                               (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = cell (fun () -> _HullWhiteForwardProcess.Value.expectation(t0.Value, x0.Value, dt.Value))
    let _M_T                                       (s : ICell<double>) (t : ICell<double>) (T2 : ICell<double>)   
                                                   = cell (fun () -> _HullWhiteForwardProcess.Value.M_T(s.Value, t.Value, T2.Value))
    let _sigma                                     = cell (fun () -> _HullWhiteForwardProcess.Value.sigma())
    let _stdDeviation                              (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = cell (fun () -> _HullWhiteForwardProcess.Value.stdDeviation(t0.Value, x0.Value, dt.Value))
    let _variance                                  (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = cell (fun () -> _HullWhiteForwardProcess.Value.variance(t0.Value, x0.Value, dt.Value))
    let _x0                                        = cell (fun () -> _HullWhiteForwardProcess.Value.x0())
    let _getForwardMeasureTime                     = cell (fun () -> _HullWhiteForwardProcess.Value.getForwardMeasureTime())
    let _setForwardMeasureTime                     (T : ICell<double>)   
                                                   = cell (fun () -> _HullWhiteForwardProcess.Value.setForwardMeasureTime(T.Value)
                                                                     _HullWhiteForwardProcess.Value)
    let _apply                                     (x0 : ICell<double>) (dx : ICell<double>)   
                                                   = cell (fun () -> _HullWhiteForwardProcess.Value.apply(x0.Value, dx.Value))
    let _apply1                                    (x0 : ICell<Vector>) (dx : ICell<Vector>)   
                                                   = cell (fun () -> _HullWhiteForwardProcess.Value.apply(x0.Value, dx.Value))
    let _evolve                                    (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>) (dw : ICell<Vector>)   
                                                   = cell (fun () -> _HullWhiteForwardProcess.Value.evolve(t0.Value, x0.Value, dt.Value, dw.Value))
    let _evolve1                                   (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>) (dw : ICell<double>)   
                                                   = cell (fun () -> _HullWhiteForwardProcess.Value.evolve(t0.Value, x0.Value, dt.Value, dw.Value))
    let _initialValues                             = cell (fun () -> _HullWhiteForwardProcess.Value.initialValues())
    let _size                                      = cell (fun () -> _HullWhiteForwardProcess.Value.size())
    let _covariance                                (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>)   
                                                   = cell (fun () -> _HullWhiteForwardProcess.Value.covariance(t0.Value, x0.Value, dt.Value))
    let _factors                                   = cell (fun () -> _HullWhiteForwardProcess.Value.factors())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _HullWhiteForwardProcess.Value.registerWith(handler.Value)
                                                                     _HullWhiteForwardProcess.Value)
    let _time                                      (d : ICell<Date>)   
                                                   = cell (fun () -> _HullWhiteForwardProcess.Value.time(d.Value))
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _HullWhiteForwardProcess.Value.unregisterWith(handler.Value)
                                                                     _HullWhiteForwardProcess.Value)
    let _update                                    = cell (fun () -> _HullWhiteForwardProcess.Value.update()
                                                                     _HullWhiteForwardProcess.Value)
