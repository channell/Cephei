...
*)
    ...
    let _isInRange                                 (x : ICell<double>) (y : ICell<double>)   
                                                   = cell (fun () -> _KernelInterpolation2D.Value.isInRange(x.Value, y.Value))
    let _locateX                                   (x : ICell<double>)   
                                                   = cell (fun () -> _KernelInterpolation2D.Value.locateX(x.Value))
    let _locateY                                   (y : ICell<double>)   
                                                   = cell (fun () -> _KernelInterpolation2D.Value.locateY(y.Value))
    let _update                                    = cell (fun () -> _KernelInterpolation2D.Value.update()
                                                                     _KernelInterpolation2D.Value)
    let _value                                     (x : ICell<double>) (y : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _KernelInterpolation2D.Value.value(x.Value, y.Value, allowExtrapolation.Value))
    let _value1                                    (x : ICell<double>) (y : ICell<double>)   
                                                   = cell (fun () -> _KernelInterpolation2D.Value.value(x.Value, y.Value))
    let _xMax                                      = cell (fun () -> _KernelInterpolation2D.Value.xMax())
    let _xMin                                      = cell (fun () -> _KernelInterpolation2D.Value.xMin())
    let _xValues                                   = cell (fun () -> _KernelInterpolation2D.Value.xValues())
    let _yMax                                      = cell (fun () -> _KernelInterpolation2D.Value.yMax())
    let _yMin                                      = cell (fun () -> _KernelInterpolation2D.Value.yMin())
    let _yValues                                   = cell (fun () -> _KernelInterpolation2D.Value.yValues())
    let _zData                                     = cell (fun () -> _KernelInterpolation2D.Value.zData())
    let _allowsExtrapolation                       = cell (fun () -> _KernelInterpolation2D.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _KernelInterpolation2D.Value.disableExtrapolation(b.Value)
                                                                     _KernelInterpolation2D.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _KernelInterpolation2D.Value.enableExtrapolation(b.Value)
                                                                     _KernelInterpolation2D.Value)
    let _extrapolate                               = cell (fun () -> _KernelInterpolation2D.Value.extrapolate)
