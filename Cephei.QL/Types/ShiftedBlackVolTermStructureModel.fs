...
*)
    ...
    let _maxDate                                   = cell (fun () -> _ShiftedBlackVolTermStructure.Value.maxDate())
    let _maxStrike                                 = cell (fun () -> _ShiftedBlackVolTermStructure.Value.maxStrike())
    let _minStrike                                 = cell (fun () -> _ShiftedBlackVolTermStructure.Value.minStrike())
    let _blackForwardVariance                      (time1 : ICell<double>) (time2 : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ShiftedBlackVolTermStructure.Value.blackForwardVariance(time1.Value, time2.Value, strike.Value, extrapolate.Value))
    let _blackForwardVariance1                     (date1 : ICell<Date>) (date2 : ICell<Date>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ShiftedBlackVolTermStructure.Value.blackForwardVariance(date1.Value, date2.Value, strike.Value, extrapolate.Value))
    let _blackForwardVol                           (time1 : ICell<double>) (time2 : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ShiftedBlackVolTermStructure.Value.blackForwardVol(time1.Value, time2.Value, strike.Value, extrapolate.Value))
    let _blackForwardVol1                          (date1 : ICell<Date>) (date2 : ICell<Date>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ShiftedBlackVolTermStructure.Value.blackForwardVol(date1.Value, date2.Value, strike.Value, extrapolate.Value))
    let _blackVariance                             (maturity : ICell<Date>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ShiftedBlackVolTermStructure.Value.blackVariance(maturity.Value, strike.Value, extrapolate.Value))
    ...
    let _blackVol                                  (maturity : ICell<Date>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ShiftedBlackVolTermStructure.Value.blackVol(maturity.Value, strike.Value, extrapolate.Value))
    let _blackVol1                                 (maturity : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ShiftedBlackVolTermStructure.Value.blackVol(maturity.Value, strike.Value, extrapolate.Value))
    let _businessDayConvention                     = cell (fun () -> _ShiftedBlackVolTermStructure.Value.businessDayConvention())
    let _optionDateFromTenor                       (p : ICell<Period>)   
                                                   = cell (fun () -> _ShiftedBlackVolTermStructure.Value.optionDateFromTenor(p.Value))
    let _calendar                                  = cell (fun () -> _ShiftedBlackVolTermStructure.Value.calendar())
    let _dayCounter                                = cell (fun () -> _ShiftedBlackVolTermStructure.Value.dayCounter())
    let _maxTime                                   = cell (fun () -> _ShiftedBlackVolTermStructure.Value.maxTime())
    let _referenceDate                             = cell (fun () -> _ShiftedBlackVolTermStructure.Value.referenceDate())
    let _settlementDays                            = cell (fun () -> _ShiftedBlackVolTermStructure.Value.settlementDays())
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = cell (fun () -> _ShiftedBlackVolTermStructure.Value.timeFromReference(date.Value))
    let _update                                    = cell (fun () -> _ShiftedBlackVolTermStructure.Value.update()
                                                                     _ShiftedBlackVolTermStructure.Value)
    let _allowsExtrapolation                       = cell (fun () -> _ShiftedBlackVolTermStructure.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _ShiftedBlackVolTermStructure.Value.disableExtrapolation(b.Value)
                                                                     _ShiftedBlackVolTermStructure.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _ShiftedBlackVolTermStructure.Value.enableExtrapolation(b.Value)
                                                                     _ShiftedBlackVolTermStructure.Value)
    let _extrapolate                               = cell (fun () -> _ShiftedBlackVolTermStructure.Value.extrapolate)
