...
*)
    ...
    let _mandatoryTimes                            = cell (fun () -> _DiscretizedDermanKaniBarrierOption.Value.mandatoryTimes())
    let _reset                                     (size : ICell<int>)   
                                                   = cell (fun () -> _DiscretizedDermanKaniBarrierOption.Value.reset(size.Value)
                                                                     _DiscretizedDermanKaniBarrierOption.Value)
    let _adjustValues                              = cell (fun () -> _DiscretizedDermanKaniBarrierOption.Value.adjustValues()
                                                                     _DiscretizedDermanKaniBarrierOption.Value)
    let _initialize                                (Method : ICell<Lattice>) (t : ICell<double>)   
                                                   = cell (fun () -> _DiscretizedDermanKaniBarrierOption.Value.initialize(Method.Value, t.Value)
                                                                     _DiscretizedDermanKaniBarrierOption.Value)
    let _method                                    = cell (fun () -> _DiscretizedDermanKaniBarrierOption.Value.METHOD())
    let _partialRollback                           (To : ICell<double>)   
                                                   = cell (fun () -> _DiscretizedDermanKaniBarrierOption.Value.partialRollback(To.Value)
                                                                     _DiscretizedDermanKaniBarrierOption.Value)
    let _postAdjustValues                          = cell (fun () -> _DiscretizedDermanKaniBarrierOption.Value.postAdjustValues()
                                                                     _DiscretizedDermanKaniBarrierOption.Value)
    let _preAdjustValues                           = cell (fun () -> _DiscretizedDermanKaniBarrierOption.Value.preAdjustValues()
                                                                     _DiscretizedDermanKaniBarrierOption.Value)
    let _presentValue                              = cell (fun () -> _DiscretizedDermanKaniBarrierOption.Value.presentValue())
    let _rollback                                  (To : ICell<double>)   
                                                   = cell (fun () -> _DiscretizedDermanKaniBarrierOption.Value.rollback(To.Value)
                                                                     _DiscretizedDermanKaniBarrierOption.Value)
    let _setTime                                   (t : ICell<double>)   
                                                   = cell (fun () -> _DiscretizedDermanKaniBarrierOption.Value.setTime(t.Value)
                                                                     _DiscretizedDermanKaniBarrierOption.Value)
    let _setValues                                 (v : ICell<Vector>)   
                                                   = cell (fun () -> _DiscretizedDermanKaniBarrierOption.Value.setValues(v.Value)
                                                                     _DiscretizedDermanKaniBarrierOption.Value)
    let _time                                      = cell (fun () -> _DiscretizedDermanKaniBarrierOption.Value.time())
    let _values                                    = cell (fun () -> _DiscretizedDermanKaniBarrierOption.Value.values())
