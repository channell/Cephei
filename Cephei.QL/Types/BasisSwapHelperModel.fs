...
*)
    let mutable
        _BasisSwapHelper                           = make (fun () -> new BasisSwapHelper (spreadQuote.Value, settlementDays.Value, swapTenor.Value, settlementCalendar.Value, rollConvention.Value, shortIndex.Value, longIndex.Value, discount.Value, eom.Value, spreadOnShort.Value))
    let _impliedQuote                              = triv _BasisSwapHelper (fun () -> _BasisSwapHelper.Value.impliedQuote())
    let _setTermStructure                          (t : ICell<YieldTermStructure>)   
                                                   = triv _BasisSwapHelper (fun () -> _BasisSwapHelper.Value.setTermStructure(t.Value)
                                                                                      _BasisSwapHelper.Value)
    let _swap                                      = triv _BasisSwapHelper (fun () -> _BasisSwapHelper.Value.swap())
    let _update                                    = triv _BasisSwapHelper (fun () -> _BasisSwapHelper.Value.update()
                                                                                      _BasisSwapHelper.Value)
    let _earliestDate                              = triv _BasisSwapHelper (fun () -> _BasisSwapHelper.Value.earliestDate())
    let _latestDate                                = triv _BasisSwapHelper (fun () -> _BasisSwapHelper.Value.latestDate())
    let _latestRelevantDate                        = triv _BasisSwapHelper (fun () -> _BasisSwapHelper.Value.latestRelevantDate())
    let _maturityDate                              = triv _BasisSwapHelper (fun () -> _BasisSwapHelper.Value.maturityDate())
    let _pillarDate                                = triv _BasisSwapHelper (fun () -> _BasisSwapHelper.Value.pillarDate())
    let _quote                                     = triv _BasisSwapHelper (fun () -> _BasisSwapHelper.Value.quote())
    let _quoteError                                = triv _BasisSwapHelper (fun () -> _BasisSwapHelper.Value.quoteError())
    let _quoteIsValid                              = triv _BasisSwapHelper (fun () -> _BasisSwapHelper.Value.quoteIsValid())
    let _quoteValue                                = triv _BasisSwapHelper (fun () -> _BasisSwapHelper.Value.quoteValue())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv _BasisSwapHelper (fun () -> _BasisSwapHelper.Value.registerWith(handler.Value)
                                                                                      _BasisSwapHelper.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = triv _BasisSwapHelper (fun () -> _BasisSwapHelper.Value.unregisterWith(handler.Value)
                                                                                      _BasisSwapHelper.Value)
