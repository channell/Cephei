...
*)
    ...
    let _swap                                      = triv (fun () -> _BasisSwapHelper.Value.swap())
    let _update                                    = triv (fun () -> _BasisSwapHelper.Value.update()
                                                                     _BasisSwapHelper.Value)
    let _earliestDate                              = triv (fun () -> _BasisSwapHelper.Value.earliestDate())
    let _latestDate                                = triv (fun () -> _BasisSwapHelper.Value.latestDate())
    let _latestRelevantDate                        = triv (fun () -> _BasisSwapHelper.Value.latestRelevantDate())
    let _maturityDate                              = triv (fun () -> _BasisSwapHelper.Value.maturityDate())
    let _pillarDate                                = triv (fun () -> _BasisSwapHelper.Value.pillarDate())
    let _quote                                     = triv (fun () -> _BasisSwapHelper.Value.quote())
    let _quoteError                                = triv (fun () -> _BasisSwapHelper.Value.quoteError())
    let _quoteIsValid                              = triv (fun () -> _BasisSwapHelper.Value.quoteIsValid())
    let _quoteValue                                = triv (fun () -> _BasisSwapHelper.Value.quoteValue())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv (fun () -> _BasisSwapHelper.Value.registerWith(handler.Value)
                                                                     _BasisSwapHelper.Value)
