...
*)
    ...
    let _accruedAmount                             (d : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).accruedAmount(d.Value))
    ...
    let _dayCounter                                = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).dayCounter())
    let _frequency                                 = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).frequency())
    let _calendar                                  = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).calendar())
    let _cashflows                                 = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).cashflows())
    ...
    let _dirtyPrice1                               (Yield : ICell<double>) (dc : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).dirtyPrice(Yield.Value, dc.Value, comp.Value, freq.Value, settlement.Value))
    let _isExpired                                 = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).isExpired())
    let _issueDate                                 = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).issueDate())
    let _isTradable                                (d : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).isTradable(d.Value))
    let _maturityDate                              = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).maturityDate())
    let _nextCashFlowDate                          (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).nextCashFlowDate(settlement.Value))
    let _nextCouponRate                            (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).nextCouponRate(settlement.Value))
    let _notional                                  (d : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).notional(d.Value))
    let _notionals                                 = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).notionals())
    let _previousCashFlowDate                      (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).previousCashFlowDate(settlement.Value))
    let _previousCouponRate                        (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).previousCouponRate(settlement.Value))
    let _redemption                                = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).redemption())
    let _redemptions                               = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).redemptions())
    let _settlementDate                            (date : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).settlementDate(date.Value))
    let _settlementDays                            = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).settlementDays())
    let _settlementValue                           (cleanPrice : ICell<double>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).settlementValue(cleanPrice.Value))
    let _settlementValue1                          = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).settlementValue())
    let _startDate                                 = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).startDate())
    let _CASH                                      = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).CASH())
    let _errorEstimate                             = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).errorEstimate())
    let _NPV                                       = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).setPricingEngine(e.Value)
                                                                     _BTP.Value)
    let _valuationDate                             = cell (fun () -> (withEvaluationDate _evaluationDate _BTP).valuationDate())
    do this.Bind(_BTP)
