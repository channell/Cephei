...
*)
    ...
    let _atmStrike                                 (optionDate : ICell<Date>) (swapTenor : ICell<Period>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.atmStrike(optionDate.Value, swapTenor.Value))
    let _atmStrike1                                (optionTenor : ICell<Period>) (swapTenor : ICell<Period>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.atmStrike(optionTenor.Value, swapTenor.Value))
    let _atmVol                                    = triv (fun () -> _SwaptionVolCube2.Value.atmVol())
    let _calendar                                  = triv (fun () -> _SwaptionVolCube2.Value.calendar())
    let _dayCounter                                = triv (fun () -> _SwaptionVolCube2.Value.dayCounter())
    let _maxDate                                   = triv (fun () -> _SwaptionVolCube2.Value.maxDate())
    let _maxStrike                                 = triv (fun () -> _SwaptionVolCube2.Value.maxStrike())
    let _maxSwapTenor                              = triv (fun () -> _SwaptionVolCube2.Value.maxSwapTenor())
    let _maxTime                                   = triv (fun () -> _SwaptionVolCube2.Value.maxTime())
    let _minStrike                                 = triv (fun () -> _SwaptionVolCube2.Value.minStrike())
    let _referenceDate                             = triv (fun () -> _SwaptionVolCube2.Value.referenceDate())
    let _settlementDays                            = triv (fun () -> _SwaptionVolCube2.Value.settlementDays())
    let _shortSwapIndexBase                        = triv (fun () -> _SwaptionVolCube2.Value.shortSwapIndexBase())
    let _strikeSpreads                             = triv (fun () -> _SwaptionVolCube2.Value.strikeSpreads())
    let _swapIndexBase                             = triv (fun () -> _SwaptionVolCube2.Value.swapIndexBase())
    let _vegaWeightedSmileFit                      = triv (fun () -> _SwaptionVolCube2.Value.vegaWeightedSmileFit())
    let _volatilityType                            = triv (fun () -> _SwaptionVolCube2.Value.volatilityType())
    let _optionDateFromTime                        (optionTime : ICell<double>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.optionDateFromTime(optionTime.Value))
    let _optionDates                               = triv (fun () -> _SwaptionVolCube2.Value.optionDates())
    let _optionTenors                              = triv (fun () -> _SwaptionVolCube2.Value.optionTenors())
    let _optionTimes                               = triv (fun () -> _SwaptionVolCube2.Value.optionTimes())
    let _swapLengths                               = triv (fun () -> _SwaptionVolCube2.Value.swapLengths())
    let _swapTenors                                = triv (fun () -> _SwaptionVolCube2.Value.swapTenors())
    let _update                                    = triv (fun () -> _SwaptionVolCube2.Value.update()
    ...
    let _blackVariance                             (optionTenor : ICell<Period>) (swapTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.blackVariance(optionTenor.Value, swapTenor.Value, strike.Value, extrapolate.Value))
    let _blackVariance1                            (optionDate : ICell<Date>) (swapTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.blackVariance(optionDate.Value, swapTenor.Value, strike.Value, extrapolate.Value))
    let _blackVariance2                            (optionTime : ICell<double>) (swapTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.blackVariance(optionTime.Value, swapTenor.Value, strike.Value, extrapolate.Value))
    let _blackVariance3                            (optionTenor : ICell<Period>) (swapLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.blackVariance(optionTenor.Value, swapLength.Value, strike.Value, extrapolate.Value))
    let _blackVariance4                            (optionTime : ICell<double>) (swapLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.blackVariance(optionTime.Value, swapLength.Value, strike.Value, extrapolate.Value))
    let _blackVariance5                            (optionDate : ICell<Date>) (swapLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.blackVariance(optionDate.Value, swapLength.Value, strike.Value, extrapolate.Value))
    let _maxSwapLength                             = triv (fun () -> _SwaptionVolCube2.Value.maxSwapLength())
    let _shift                                     (optionTime : ICell<double>) (swapLength : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.shift(optionTime.Value, swapLength.Value, extrapolate.Value))
    let _shift1                                    (optionDate : ICell<Date>) (swapLength : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.shift(optionDate.Value, swapLength.Value, extrapolate.Value))
    let _shift2                                    (optionTenor : ICell<Period>) (swapTenor : ICell<Period>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.shift(optionTenor.Value, swapTenor.Value, extrapolate.Value))
    let _shift3                                    (optionTenor : ICell<Period>) (swapLength : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.shift(optionTenor.Value, swapLength.Value, extrapolate.Value))
    let _shift4                                    (optionTime : ICell<double>) (swapTenor : ICell<Period>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.shift(optionTime.Value, swapTenor.Value, extrapolate.Value))
    let _shift5                                    (optionDate : ICell<Date>) (swapTenor : ICell<Period>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.shift(optionDate.Value, swapTenor.Value, extrapolate.Value))
    let _smileSection                              (optionDate : ICell<Date>) (swapTenor : ICell<Period>) (extr : ICell<bool>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.smileSection(optionDate.Value, swapTenor.Value, extr.Value))
    let _smileSection1                             (optionTenor : ICell<Period>) (swapTenor : ICell<Period>) (extr : ICell<bool>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.smileSection(optionTenor.Value, swapTenor.Value, extr.Value))
    let _smileSection2                             (optionTime : ICell<double>) (swapLength : ICell<double>) (extr : ICell<bool>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.smileSection(optionTime.Value, swapLength.Value, extr.Value))
    let _swapLength                                (start : ICell<Date>) (End : ICell<Date>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.swapLength(start.Value, End.Value))
    let _swapLength1                               (swapTenor : ICell<Period>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.swapLength(swapTenor.Value))
    let _volatility                                (optionTime : ICell<double>) (swapTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.volatility(optionTime.Value, swapTenor.Value, strike.Value, extrapolate.Value))
    let _volatility1                               (optionTenor : ICell<Period>) (swapLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.volatility(optionTenor.Value, swapLength.Value, strike.Value, extrapolate.Value))
    let _volatility2                               (optionDate : ICell<Date>) (swapLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.volatility(optionDate.Value, swapLength.Value, strike.Value, extrapolate.Value))
    let _volatility3                               (optionTime : ICell<double>) (swapLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.volatility(optionTime.Value, swapLength.Value, strike.Value, extrapolate.Value))
    let _volatility4                               (optionDate : ICell<Date>) (swapTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.volatility(optionDate.Value, swapTenor.Value, strike.Value, extrapolate.Value))
    let _volatility5                               (optionTenor : ICell<Period>) (swapTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.volatility(optionTenor.Value, swapTenor.Value, strike.Value, extrapolate.Value))
    let _businessDayConvention                     = triv (fun () -> _SwaptionVolCube2.Value.businessDayConvention())
    let _optionDateFromTenor                       (p : ICell<Period>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.optionDateFromTenor(p.Value))
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.timeFromReference(date.Value))
    let _allowsExtrapolation                       = triv (fun () -> _SwaptionVolCube2.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.disableExtrapolation(b.Value)
                                                                     _SwaptionVolCube2.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv (fun () -> _SwaptionVolCube2.Value.enableExtrapolation(b.Value)
                                                                     _SwaptionVolCube2.Value)
