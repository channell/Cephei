...
*)
    ...
    let _add                                       (Begin : ICell<Generic.List<double>>) (weight : ICell<double>)   
                                                   = cell (fun () -> _GenericSequenceStatistics.Value.add(Begin.Value, weight.Value)
                                                                     _GenericSequenceStatistics.Value)
    let _add1                                      (Begin : ICell<Generic.List<double>>)   
                                                   = cell (fun () -> _GenericSequenceStatistics.Value.add(Begin.Value)
                                                                     _GenericSequenceStatistics.Value)
    let _averageShortfall                          (x : ICell<double>)   
                                                   = cell (fun () -> _GenericSequenceStatistics.Value.averageShortfall(x.Value))
    let _correlation                               = cell (fun () -> _GenericSequenceStatistics.Value.correlation())
    let _covariance                                = cell (fun () -> _GenericSequenceStatistics.Value.covariance())
    let _downsideDeviation                         = cell (fun () -> _GenericSequenceStatistics.Value.downsideDeviation())
    let _downsideVariance                          = cell (fun () -> _GenericSequenceStatistics.Value.downsideVariance())
    let _errorEstimate                             = cell (fun () -> _GenericSequenceStatistics.Value.errorEstimate())
    let _expectedShortfall                         (x : ICell<double>)   
                                                   = cell (fun () -> _GenericSequenceStatistics.Value.expectedShortfall(x.Value))
    let _gaussianAverageShortfall                  (x : ICell<double>)   
                                                   = cell (fun () -> _GenericSequenceStatistics.Value.gaussianAverageShortfall(x.Value))
    let _gaussianExpectedShortfall                 (x : ICell<double>)   
                                                   = cell (fun () -> _GenericSequenceStatistics.Value.gaussianExpectedShortfall(x.Value))
    let _gaussianPercentile                        (x : ICell<double>)   
                                                   = cell (fun () -> _GenericSequenceStatistics.Value.gaussianPercentile(x.Value))
    let _gaussianPotentialUpside                   (x : ICell<double>)   
                                                   = cell (fun () -> _GenericSequenceStatistics.Value.gaussianPotentialUpside(x.Value))
    let _gaussianShortfall                         (x : ICell<double>)   
                                                   = cell (fun () -> _GenericSequenceStatistics.Value.gaussianShortfall(x.Value))
    let _gaussianValueAtRisk                       (x : ICell<double>)   
                                                   = cell (fun () -> _GenericSequenceStatistics.Value.gaussianValueAtRisk(x.Value))
    let _kurtosis                                  = cell (fun () -> _GenericSequenceStatistics.Value.kurtosis())
    let _max                                       = cell (fun () -> _GenericSequenceStatistics.Value.max())
    let _mean                                      = cell (fun () -> _GenericSequenceStatistics.Value.mean())
    let _min                                       = cell (fun () -> _GenericSequenceStatistics.Value.min())
    let _percentile                                (x : ICell<double>)   
                                                   = cell (fun () -> _GenericSequenceStatistics.Value.percentile(x.Value))
    let _potentialUpside                           (x : ICell<double>)   
                                                   = cell (fun () -> _GenericSequenceStatistics.Value.potentialUpside(x.Value))
    let _regret                                    (x : ICell<double>)   
                                                   = cell (fun () -> _GenericSequenceStatistics.Value.regret(x.Value))
    let _reset                                     (dimension : ICell<int>)   
                                                   = cell (fun () -> _GenericSequenceStatistics.Value.reset(dimension.Value)
                                                                     _GenericSequenceStatistics.Value)
    let _samples                                   = cell (fun () -> _GenericSequenceStatistics.Value.samples())
    let _semiDeviation                             = cell (fun () -> _GenericSequenceStatistics.Value.semiDeviation())
    let _semiVariance                              = cell (fun () -> _GenericSequenceStatistics.Value.semiVariance())
    let _shortfall                                 (x : ICell<double>)   
                                                   = cell (fun () -> _GenericSequenceStatistics.Value.shortfall(x.Value))
    let _size                                      = cell (fun () -> _GenericSequenceStatistics.Value.size())
    let _skewness                                  = cell (fun () -> _GenericSequenceStatistics.Value.skewness())
    let _standardDeviation                         = cell (fun () -> _GenericSequenceStatistics.Value.standardDeviation())
    let _valueAtRisk                               (x : ICell<double>)   
                                                   = cell (fun () -> _GenericSequenceStatistics.Value.valueAtRisk(x.Value))
    let _variance                                  = cell (fun () -> _GenericSequenceStatistics.Value.variance())
    let _weightSum                                 = cell (fun () -> _GenericSequenceStatistics.Value.weightSum())
