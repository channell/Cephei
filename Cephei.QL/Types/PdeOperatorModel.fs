...
*)
    let mutable
        _PdeOperator                               = make (fun () -> new PdeOperator<'PdeClass> (grid.Value, Process.Value))
    let _add                                       (A : ICell<IOperator>) (B : ICell<IOperator>)   
                                                   = triv _PdeOperator (fun () -> _PdeOperator.Value.add(A.Value, B.Value))
    let _applyTo                                   (v : ICell<Vector>)   
                                                   = triv _PdeOperator (fun () -> _PdeOperator.Value.applyTo(v.Value))
    let _Clone                                     = triv _PdeOperator (fun () -> _PdeOperator.Value.Clone())
    let _diagonal                                  = triv _PdeOperator (fun () -> _PdeOperator.Value.diagonal())
    let _identity                                  (size : ICell<int>)   
                                                   = triv _PdeOperator (fun () -> _PdeOperator.Value.identity(size.Value))
    let _isTimeDependent                           = triv _PdeOperator (fun () -> _PdeOperator.Value.isTimeDependent())
    let _lowerDiagonal                             = triv _PdeOperator (fun () -> _PdeOperator.Value.lowerDiagonal())
    let _multiply                                  (a : ICell<double>) (o : ICell<IOperator>)   
                                                   = triv _PdeOperator (fun () -> _PdeOperator.Value.multiply(a.Value, o.Value))
    let _setFirstRow                               (valB : ICell<double>) (valC : ICell<double>)   
                                                   = triv _PdeOperator (fun () -> _PdeOperator.Value.setFirstRow(valB.Value, valC.Value)
                                                                                  _PdeOperator.Value)
    let _setLastRow                                (valA : ICell<double>) (valB : ICell<double>)   
                                                   = triv _PdeOperator (fun () -> _PdeOperator.Value.setLastRow(valA.Value, valB.Value)
                                                                                  _PdeOperator.Value)
    let _setMidRow                                 (i : ICell<int>) (valA : ICell<double>) (valB : ICell<double>) (valC : ICell<double>)   
                                                   = triv _PdeOperator (fun () -> _PdeOperator.Value.setMidRow(i.Value, valA.Value, valB.Value, valC.Value)
                                                                                  _PdeOperator.Value)
    let _setMidRows                                (valA : ICell<double>) (valB : ICell<double>) (valC : ICell<double>)   
                                                   = triv _PdeOperator (fun () -> _PdeOperator.Value.setMidRows(valA.Value, valB.Value, valC.Value)
                                                                                  _PdeOperator.Value)
    let _setTime                                   (t : ICell<double>)   
                                                   = triv _PdeOperator (fun () -> _PdeOperator.Value.setTime(t.Value)
                                                                                  _PdeOperator.Value)
    let _size                                      = triv _PdeOperator (fun () -> _PdeOperator.Value.size())
    let _solveFor                                  (rhs : ICell<Vector>)   
                                                   = triv _PdeOperator (fun () -> _PdeOperator.Value.solveFor(rhs.Value))
    let _SOR                                       (rhs : ICell<Vector>) (tol : ICell<double>)   
                                                   = triv _PdeOperator (fun () -> _PdeOperator.Value.SOR(rhs.Value, tol.Value))
    let _subtract                                  (A : ICell<IOperator>) (B : ICell<IOperator>)   
                                                   = triv _PdeOperator (fun () -> _PdeOperator.Value.subtract(A.Value, B.Value))
    let _upperDiagonal                             = triv _PdeOperator (fun () -> _PdeOperator.Value.upperDiagonal())
...
*)
    let mutable
        _PdeOperator                               = make (fun () -> new PdeOperator<'PdeClass> (grid.Value, Process.Value, residualTime.Value))
    let _add                                       (A : ICell<IOperator>) (B : ICell<IOperator>)   
                                                   = triv _PdeOperator (fun () -> _PdeOperator.Value.add(A.Value, B.Value))
    let _applyTo                                   (v : ICell<Vector>)   
                                                   = triv _PdeOperator (fun () -> _PdeOperator.Value.applyTo(v.Value))
