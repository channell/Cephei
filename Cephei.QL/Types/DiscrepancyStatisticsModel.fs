...
*)
    ...
    let _add1                                      (Begin : ICell<Generic.List<double>>)   
                                                   = triv (fun () -> _DiscrepancyStatistics.Value.add(Begin.Value)
                                                                     _DiscrepancyStatistics.Value)
    let _discrepancy                               = triv (fun () -> _DiscrepancyStatistics.Value.discrepancy())
    let _reset                                     (dimension : ICell<int>)   
                                                   = triv (fun () -> _DiscrepancyStatistics.Value.reset(dimension.Value)
                                                                     _DiscrepancyStatistics.Value)
    let _averageShortfall                          (x : ICell<double>)   
                                                   = triv (fun () -> _DiscrepancyStatistics.Value.averageShortfall(x.Value))
    let _correlation                               = triv (fun () -> _DiscrepancyStatistics.Value.correlation())
    let _covariance                                = triv (fun () -> _DiscrepancyStatistics.Value.covariance())
    let _downsideDeviation                         = triv (fun () -> _DiscrepancyStatistics.Value.downsideDeviation())
    let _downsideVariance                          = triv (fun () -> _DiscrepancyStatistics.Value.downsideVariance())
    let _errorEstimate                             = triv (fun () -> _DiscrepancyStatistics.Value.errorEstimate())
    let _expectedShortfall                         (x : ICell<double>)   
                                                   = triv (fun () -> _DiscrepancyStatistics.Value.expectedShortfall(x.Value))
    let _gaussianAverageShortfall                  (x : ICell<double>)   
                                                   = triv (fun () -> _DiscrepancyStatistics.Value.gaussianAverageShortfall(x.Value))
    let _gaussianExpectedShortfall                 (x : ICell<double>)   
                                                   = triv (fun () -> _DiscrepancyStatistics.Value.gaussianExpectedShortfall(x.Value))
    let _gaussianPercentile                        (x : ICell<double>)   
                                                   = triv (fun () -> _DiscrepancyStatistics.Value.gaussianPercentile(x.Value))
    let _gaussianPotentialUpside                   (x : ICell<double>)   
                                                   = triv (fun () -> _DiscrepancyStatistics.Value.gaussianPotentialUpside(x.Value))
    let _gaussianShortfall                         (x : ICell<double>)   
                                                   = triv (fun () -> _DiscrepancyStatistics.Value.gaussianShortfall(x.Value))
    let _gaussianValueAtRisk                       (x : ICell<double>)   
                                                   = triv (fun () -> _DiscrepancyStatistics.Value.gaussianValueAtRisk(x.Value))
    let _kurtosis                                  = triv (fun () -> _DiscrepancyStatistics.Value.kurtosis())
    let _max                                       = triv (fun () -> _DiscrepancyStatistics.Value.max())
    let _mean                                      = triv (fun () -> _DiscrepancyStatistics.Value.mean())
    let _min                                       = triv (fun () -> _DiscrepancyStatistics.Value.min())
    let _percentile                                (x : ICell<double>)   
                                                   = triv (fun () -> _DiscrepancyStatistics.Value.percentile(x.Value))
    let _potentialUpside                           (x : ICell<double>)   
                                                   = triv (fun () -> _DiscrepancyStatistics.Value.potentialUpside(x.Value))
    let _regret                                    (x : ICell<double>)   
                                                   = triv (fun () -> _DiscrepancyStatistics.Value.regret(x.Value))
    let _samples                                   = triv (fun () -> _DiscrepancyStatistics.Value.samples())
    let _semiDeviation                             = triv (fun () -> _DiscrepancyStatistics.Value.semiDeviation())
    let _semiVariance                              = triv (fun () -> _DiscrepancyStatistics.Value.semiVariance())
    let _shortfall                                 (x : ICell<double>)   
                                                   = triv (fun () -> _DiscrepancyStatistics.Value.shortfall(x.Value))
    let _size                                      = triv (fun () -> _DiscrepancyStatistics.Value.size())
    let _skewness                                  = triv (fun () -> _DiscrepancyStatistics.Value.skewness())
    let _standardDeviation                         = triv (fun () -> _DiscrepancyStatistics.Value.standardDeviation())
    let _valueAtRisk                               (x : ICell<double>)   
                                                   = triv (fun () -> _DiscrepancyStatistics.Value.valueAtRisk(x.Value))
