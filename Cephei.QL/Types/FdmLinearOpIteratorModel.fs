...
*)
    ...
    let _coordinates                               = cell (fun () -> _FdmLinearOpIterator.Value.coordinates())
    let _Equals                                    (obj : ICell<Object>)   
                                                   = cell (fun () -> _FdmLinearOpIterator.Value.Equals(obj.Value))
    let _index                                     = cell (fun () -> _FdmLinearOpIterator.Value.index())
    let _swap                                      (iter : ICell<FdmLinearOpIterator>)   
                                                   = cell (fun () -> _FdmLinearOpIterator.Value.swap(iter.Value)
