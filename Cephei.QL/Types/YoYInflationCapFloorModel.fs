...
(*
    Functions
*)
    let _YoYInflationCapFloor                      = cell (fun () -> withEngine _pricingEngine.Value (new YoYInflationCapFloor (Type.Value, yoyLeg.Value, strikes.Value)))
    let _atmRate                                   (discountCurve : ICell<YieldTermStructure>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _YoYInflationCapFloor).atmRate(discountCurve.Value))
    let _capRates                                  = cell (fun () -> (withEvaluationDate _evaluationDate _YoYInflationCapFloor).capRates())
    let _floorRates                                = cell (fun () -> (withEvaluationDate _evaluationDate _YoYInflationCapFloor).floorRates())
    let _impliedVolatility                         (price : ICell<double>) (yoyCurve : ICell<Handle<YoYInflationTermStructure>>) (guess : ICell<double>) (accuracy : ICell<double>) (maxEvaluations : ICell<int>) (minVol : ICell<double>) (maxVol : ICell<double>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _YoYInflationCapFloor).impliedVolatility(price.Value, yoyCurve.Value, guess.Value, accuracy.Value, maxEvaluations.Value, minVol.Value, maxVol.Value))
    let _isExpired                                 = cell (fun () -> (withEvaluationDate _evaluationDate _YoYInflationCapFloor).isExpired())
    let _lastYoYInflationCoupon                    = cell (fun () -> (withEvaluationDate _evaluationDate _YoYInflationCapFloor).lastYoYInflationCoupon())
    let _maturityDate                              = cell (fun () -> (withEvaluationDate _evaluationDate _YoYInflationCapFloor).maturityDate())
    let _optionlet                                 (i : ICell<int>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _YoYInflationCapFloor).optionlet(i.Value))
    let _startDate                                 = cell (fun () -> (withEvaluationDate _evaluationDate _YoYInflationCapFloor).startDate())
    let _type                                      = cell (fun () -> (withEvaluationDate _evaluationDate _YoYInflationCapFloor).TYPE())
    let _yoyLeg                                    = cell (fun () -> (withEvaluationDate _evaluationDate _YoYInflationCapFloor).yoyLeg())
    let _CASH                                      = cell (fun () -> (withEvaluationDate _evaluationDate _YoYInflationCapFloor).CASH())
    let _errorEstimate                             = cell (fun () -> (withEvaluationDate _evaluationDate _YoYInflationCapFloor).errorEstimate())
    let _NPV                                       = cell (fun () -> (withEvaluationDate _evaluationDate _YoYInflationCapFloor).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _YoYInflationCapFloor).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _YoYInflationCapFloor).setPricingEngine(e.Value)
                                                                     _YoYInflationCapFloor.Value)
    let _valuationDate                             = cell (fun () -> (withEvaluationDate _evaluationDate _YoYInflationCapFloor).valuationDate())
...
(*
    Functions
*)
    let _YoYInflationCapFloor                      = cell (fun () -> withEngine _pricingEngine.Value (new YoYInflationCapFloor (Type.Value, yoyLeg.Value, capRates.Value, floorRates.Value)))
    let _atmRate                                   (discountCurve : ICell<YieldTermStructure>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _YoYInflationCapFloor).atmRate(discountCurve.Value))
    let _capRates                                  = cell (fun () -> (withEvaluationDate _evaluationDate _YoYInflationCapFloor).capRates())
    let _floorRates                                = cell (fun () -> (withEvaluationDate _evaluationDate _YoYInflationCapFloor).floorRates())
