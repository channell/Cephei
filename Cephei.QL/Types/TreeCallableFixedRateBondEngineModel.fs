...
*)
    let mutable
        _TreeCallableFixedRateBondEngine           = make (fun () -> (createEvaluationDate _evaluationDate (fun () ->new TreeCallableFixedRateBondEngine (model.Value, timeSteps.Value, termStructure.Value))))
    let _update                                    = triv _TreeCallableFixedRateBondEngine (fun () -> (curryEvaluationDate _evaluationDate _TreeCallableFixedRateBondEngine).Value.update()
                                                                                                      _TreeCallableFixedRateBondEngine.Value)
    let _setModel                                  (model : ICell<Handle<ShortRateModel>>)   
                                                   = triv _TreeCallableFixedRateBondEngine (fun () -> (curryEvaluationDate _evaluationDate _TreeCallableFixedRateBondEngine).Value.setModel(model.Value)
                                                                                                      _TreeCallableFixedRateBondEngine.Value)
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv _TreeCallableFixedRateBondEngine (fun () -> (curryEvaluationDate _evaluationDate _TreeCallableFixedRateBondEngine).Value.registerWith(handler.Value)
                                                                                                      _TreeCallableFixedRateBondEngine.Value)
    let _reset                                     = triv _TreeCallableFixedRateBondEngine (fun () -> (curryEvaluationDate _evaluationDate _TreeCallableFixedRateBondEngine).Value.reset()
                                                                                                      _TreeCallableFixedRateBondEngine.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = triv _TreeCallableFixedRateBondEngine (fun () -> (curryEvaluationDate _evaluationDate _TreeCallableFixedRateBondEngine).Value.unregisterWith(handler.Value)
                                                                                                      _TreeCallableFixedRateBondEngine.Value)
...
*)
    let mutable
        _TreeCallableFixedRateBondEngine           = make (fun () -> (createEvaluationDate _evaluationDate (fun () ->new TreeCallableFixedRateBondEngine (model.Value, timeGrid.Value, termStructure.Value))))
    let _update                                    = triv _TreeCallableFixedRateBondEngine (fun () -> (curryEvaluationDate _evaluationDate _TreeCallableFixedRateBondEngine).Value.update()
                                                                                                      _TreeCallableFixedRateBondEngine.Value)
    let _setModel                                  (model : ICell<Handle<ShortRateModel>>)   
                                                   = triv _TreeCallableFixedRateBondEngine (fun () -> (curryEvaluationDate _evaluationDate _TreeCallableFixedRateBondEngine).Value.setModel(model.Value)
