...
*)
    let mutable
        _InflationCouponPricer                     = make (fun () -> (createEvaluationDate _evaluationDate (fun () ->new InflationCouponPricer ())))
    let _capletPrice                               (effectiveCap : ICell<double>)   
                                                   = triv _InflationCouponPricer (fun () -> (curryEvaluationDate _evaluationDate _InflationCouponPricer).Value.capletPrice(effectiveCap.Value))
    let _capletRate                                (effectiveCap : ICell<double>)   
                                                   = triv _InflationCouponPricer (fun () -> (curryEvaluationDate _evaluationDate _InflationCouponPricer).Value.capletRate(effectiveCap.Value))
    let _floorletPrice                             (effectiveFloor : ICell<double>)   
                                                   = triv _InflationCouponPricer (fun () -> (curryEvaluationDate _evaluationDate _InflationCouponPricer).Value.floorletPrice(effectiveFloor.Value))
    let _floorletRate                              (effectiveFloor : ICell<double>)   
                                                   = triv _InflationCouponPricer (fun () -> (curryEvaluationDate _evaluationDate _InflationCouponPricer).Value.floorletRate(effectiveFloor.Value))
    let _initialize                                (i : ICell<InflationCoupon>)   
                                                   = triv _InflationCouponPricer (fun () -> (curryEvaluationDate _evaluationDate _InflationCouponPricer).Value.initialize(i.Value)
                                                                                            _InflationCouponPricer.Value)
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv _InflationCouponPricer (fun () -> (curryEvaluationDate _evaluationDate _InflationCouponPricer).Value.registerWith(handler.Value)
                                                                                            _InflationCouponPricer.Value)
    let _swapletPrice                              = triv _InflationCouponPricer (fun () -> (curryEvaluationDate _evaluationDate _InflationCouponPricer).Value.swapletPrice())
    let _swapletRate                               = triv _InflationCouponPricer (fun () -> (curryEvaluationDate _evaluationDate _InflationCouponPricer).Value.swapletRate())
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = triv _InflationCouponPricer (fun () -> (curryEvaluationDate _evaluationDate _InflationCouponPricer).Value.unregisterWith(handler.Value)
                                                                                            _InflationCouponPricer.Value)
    let _update                                    = triv _InflationCouponPricer (fun () -> (curryEvaluationDate _evaluationDate _InflationCouponPricer).Value.update()
                                                                                            _InflationCouponPricer.Value)
