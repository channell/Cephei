...
*)
    ...
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _CubicSplineOvershootingMinimization2.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = triv (fun () -> _CubicSplineOvershootingMinimization2.Value.empty())
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _CubicSplineOvershootingMinimization2.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _CubicSplineOvershootingMinimization2.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = triv (fun () -> _CubicSplineOvershootingMinimization2.Value.update()
                                                                     _CubicSplineOvershootingMinimization2.Value)
    let _value                                     (x : ICell<double>)   
                                                   = triv (fun () -> _CubicSplineOvershootingMinimization2.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _CubicSplineOvershootingMinimization2.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = triv (fun () -> _CubicSplineOvershootingMinimization2.Value.xMax())
    let _xMin                                      = triv (fun () -> _CubicSplineOvershootingMinimization2.Value.xMin())
    let _allowsExtrapolation                       = triv (fun () -> _CubicSplineOvershootingMinimization2.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv (fun () -> _CubicSplineOvershootingMinimization2.Value.disableExtrapolation(b.Value)
                                                                     _CubicSplineOvershootingMinimization2.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv (fun () -> _CubicSplineOvershootingMinimization2.Value.enableExtrapolation(b.Value)
                                                                     _CubicSplineOvershootingMinimization2.Value)
    let _extrapolate                               = triv (fun () -> _CubicSplineOvershootingMinimization2.Value.extrapolate)
    do this.Bind(_CubicSplineOvershootingMinimization2)
(* 
    casting 
*)
    internal new () = CubicSplineOvershootingMinimization2Model(null,null,null)
