...
*)
    ...
    let _discountImpl                              (i : ICell<Interpolation>) (t : ICell<double>)   
                                                   = cell (fun () -> _ZeroInflationTraits.Value.discountImpl(i.Value, t.Value))
    let _forwardImpl                               (i : ICell<Interpolation>) (t : ICell<double>)   
                                                   = cell (fun () -> _ZeroInflationTraits.Value.forwardImpl(i.Value, t.Value))
    let _guess                                     (i : ICell<int>) (c : ICell<InterpolatedCurve>) (validData : ICell<bool>) (f : ICell<int>)   
                                                   = cell (fun () -> _ZeroInflationTraits.Value.guess(i.Value, c.Value, validData.Value, f.Value))
    let _initialDate                               (t : ICell<ZeroInflationTermStructure>)   
                                                   = cell (fun () -> _ZeroInflationTraits.Value.initialDate(t.Value))
    let _initialValue                              (t : ICell<ZeroInflationTermStructure>)   
                                                   = cell (fun () -> _ZeroInflationTraits.Value.initialValue(t.Value))
    let _maxIterations                             = cell (fun () -> _ZeroInflationTraits.Value.maxIterations())
    let _maxValueAfter                             (i : ICell<int>) (c : ICell<InterpolatedCurve>) (validData : ICell<bool>) (f : ICell<int>)   
                                                   = cell (fun () -> _ZeroInflationTraits.Value.maxValueAfter(i.Value, c.Value, validData.Value, f.Value))
    let _minValueAfter                             (i : ICell<int>) (c : ICell<InterpolatedCurve>) (validData : ICell<bool>) (f : ICell<int>)   
                                                   = cell (fun () -> _ZeroInflationTraits.Value.minValueAfter(i.Value, c.Value, validData.Value, f.Value))
    let _updateGuess                               (data : ICell<Generic.List<double>>) (discount : ICell<double>) (i : ICell<int>)   
                                                   = cell (fun () -> _ZeroInflationTraits.Value.updateGuess(data.Value, discount.Value, i.Value)
                                                                     _ZeroInflationTraits.Value)
    let _zeroYieldImpl                             (i : ICell<Interpolation>) (t : ICell<double>)   
                                                   = cell (fun () -> _ZeroInflationTraits.Value.zeroYieldImpl(i.Value, t.Value))
