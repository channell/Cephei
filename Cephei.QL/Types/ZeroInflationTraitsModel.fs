...
*)
    let mutable
        _ZeroInflationTraits                       = make (fun () -> new ZeroInflationTraits ())
    let _discountImpl                              (i : ICell<Interpolation>) (t : ICell<double>)   
                                                   = triv _ZeroInflationTraits (fun () -> _ZeroInflationTraits.Value.discountImpl(i.Value, t.Value))
    let _forwardImpl                               (i : ICell<Interpolation>) (t : ICell<double>)   
                                                   = triv _ZeroInflationTraits (fun () -> _ZeroInflationTraits.Value.forwardImpl(i.Value, t.Value))
    let _guess                                     (i : ICell<int>) (c : ICell<InterpolatedCurve>) (validData : ICell<bool>) (f : ICell<int>)   
                                                   = triv _ZeroInflationTraits (fun () -> _ZeroInflationTraits.Value.guess(i.Value, c.Value, validData.Value, f.Value))
    let _initialDate                               (t : ICell<ZeroInflationTermStructure>)   
                                                   = triv _ZeroInflationTraits (fun () -> _ZeroInflationTraits.Value.initialDate(t.Value))
    let _initialValue                              (t : ICell<ZeroInflationTermStructure>)   
                                                   = triv _ZeroInflationTraits (fun () -> _ZeroInflationTraits.Value.initialValue(t.Value))
    let _maxIterations                             = triv _ZeroInflationTraits (fun () -> _ZeroInflationTraits.Value.maxIterations())
    let _maxValueAfter                             (i : ICell<int>) (c : ICell<InterpolatedCurve>) (validData : ICell<bool>) (f : ICell<int>)   
                                                   = triv _ZeroInflationTraits (fun () -> _ZeroInflationTraits.Value.maxValueAfter(i.Value, c.Value, validData.Value, f.Value))
    let _minValueAfter                             (i : ICell<int>) (c : ICell<InterpolatedCurve>) (validData : ICell<bool>) (f : ICell<int>)   
                                                   = triv _ZeroInflationTraits (fun () -> _ZeroInflationTraits.Value.minValueAfter(i.Value, c.Value, validData.Value, f.Value))
    let _updateGuess                               (data : ICell<Generic.List<double>>) (discount : ICell<double>) (i : ICell<int>)   
                                                   = triv _ZeroInflationTraits (fun () -> _ZeroInflationTraits.Value.updateGuess(data.Value, discount.Value, i.Value)
                                                                                          _ZeroInflationTraits.Value)
    let _zeroYieldImpl                             (i : ICell<Interpolation>) (t : ICell<double>)   
                                                   = triv _ZeroInflationTraits (fun () -> _ZeroInflationTraits.Value.zeroYieldImpl(i.Value, t.Value))
