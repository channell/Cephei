...
*)
    ...
    let _CompareTo                                 (other : ICell<Pair<double,double>>)   
                                                   = cell (fun () -> _pair_double.Value.CompareTo(other.Value))
    let _first                                     = cell (fun () -> _pair_double.Value.first)
    let _second                                    = cell (fun () -> _pair_double.Value.second)
    let _set                                       (first : ICell<double>) (second : ICell<double>)   
                                                   = cell (fun () -> _pair_double.Value.set(first.Value, second.Value)
                                                                     _pair_double.Value)
