...
*)
    ...
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearCubicInterpolation.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearCubicInterpolation.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = triv (fun () -> _MixedLinearCubicInterpolation.Value.update()
                                                                     _MixedLinearCubicInterpolation.Value)
    let _value                                     (x : ICell<double>)   
                                                   = triv (fun () -> _MixedLinearCubicInterpolation.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearCubicInterpolation.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = triv (fun () -> _MixedLinearCubicInterpolation.Value.xMax())
    let _xMin                                      = triv (fun () -> _MixedLinearCubicInterpolation.Value.xMin())
    let _allowsExtrapolation                       = triv (fun () -> _MixedLinearCubicInterpolation.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearCubicInterpolation.Value.disableExtrapolation(b.Value)
                                                                     _MixedLinearCubicInterpolation.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv (fun () -> _MixedLinearCubicInterpolation.Value.enableExtrapolation(b.Value)
                                                                     _MixedLinearCubicInterpolation.Value)
