...
*)
    ...
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _ForwardFlatInterpolation.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _ForwardFlatInterpolation.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = triv (fun () -> _ForwardFlatInterpolation.Value.update()
                                                                     _ForwardFlatInterpolation.Value)
    let _value                                     (x : ICell<double>)   
                                                   = triv (fun () -> _ForwardFlatInterpolation.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _ForwardFlatInterpolation.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = triv (fun () -> _ForwardFlatInterpolation.Value.xMax())
    let _xMin                                      = triv (fun () -> _ForwardFlatInterpolation.Value.xMin())
    let _allowsExtrapolation                       = triv (fun () -> _ForwardFlatInterpolation.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv (fun () -> _ForwardFlatInterpolation.Value.disableExtrapolation(b.Value)
                                                                     _ForwardFlatInterpolation.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv (fun () -> _ForwardFlatInterpolation.Value.enableExtrapolation(b.Value)
                                                                     _ForwardFlatInterpolation.Value)
