...
*)
    ...
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _BackwardFlatInterpolation.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _BackwardFlatInterpolation.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = triv (fun () -> _BackwardFlatInterpolation.Value.update()
                                                                     _BackwardFlatInterpolation.Value)
    let _value                                     (x : ICell<double>)   
                                                   = triv (fun () -> _BackwardFlatInterpolation.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _BackwardFlatInterpolation.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = triv (fun () -> _BackwardFlatInterpolation.Value.xMax())
    let _xMin                                      = triv (fun () -> _BackwardFlatInterpolation.Value.xMin())
    let _allowsExtrapolation                       = triv (fun () -> _BackwardFlatInterpolation.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv (fun () -> _BackwardFlatInterpolation.Value.disableExtrapolation(b.Value)
                                                                     _BackwardFlatInterpolation.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv (fun () -> _BackwardFlatInterpolation.Value.enableExtrapolation(b.Value)
                                                                     _BackwardFlatInterpolation.Value)
    let _extrapolate                               = triv (fun () -> _BackwardFlatInterpolation.Value.extrapolate)
    do this.Bind(_BackwardFlatInterpolation)
(* 
    casting 
*)
    internal new () = BackwardFlatInterpolationModel(null,null,null)
