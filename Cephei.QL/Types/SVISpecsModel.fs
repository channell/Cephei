...
*)
    ...
    let _defaultValues                             (param : ICell<List<Nullable<double>>>) (paramIsFixed : ICell<Generic.List<bool>>) (forward : ICell<double>) (expiryTime : ICell<double>) (addParams : ICell<List<Nullable<double>>>)   
                                                   = cell (fun () -> _SVISpecs.Value.defaultValues(param.Value, paramIsFixed.Value, forward.Value, expiryTime.Value, addParams.Value)
                                                                     _SVISpecs.Value)
    let _dilationFactor                            = cell (fun () -> _SVISpecs.Value.dilationFactor())
    let _dimension                                 = cell (fun () -> _SVISpecs.Value.dimension())
    let _direct                                    (x : ICell<Vector>) (paramIsFixed : ICell<Generic.List<bool>>) (param : ICell<List<Nullable<double>>>) (forward : ICell<double>)   
                                                   = cell (fun () -> _SVISpecs.Value.direct(x.Value, paramIsFixed.Value, param.Value, forward.Value))
    let _eps1                                      = cell (fun () -> _SVISpecs.Value.eps1())
    let _eps2                                      = cell (fun () -> _SVISpecs.Value.eps2())
    let _guess                                     (values : ICell<Vector>) (paramIsFixed : ICell<Generic.List<bool>>) (forward : ICell<double>) (expiryTime : ICell<double>) (r : ICell<Generic.List<double>>) (addParams : ICell<List<Nullable<double>>>)   
                                                   = cell (fun () -> _SVISpecs.Value.guess(values.Value, paramIsFixed.Value, forward.Value, expiryTime.Value, r.Value, addParams.Value)
                                                                     _SVISpecs.Value)
    let _instance                                  (t : ICell<double>) (forward : ICell<double>) (param : ICell<List<Nullable<double>>>) (addParams : ICell<List<Nullable<double>>>)   
                                                   = cell (fun () -> _SVISpecs.Value.instance(t.Value, forward.Value, param.Value, addParams.Value))
    let _inverse                                   (y : ICell<Vector>) (b : ICell<Generic.List<bool>>) (c : ICell<List<Nullable<double>>>) (d : ICell<double>)   
                                                   = cell (fun () -> _SVISpecs.Value.inverse(y.Value, b.Value, c.Value, d.Value))
    let _modelInstance_                            = cell (fun () -> _SVISpecs.Value.modelInstance_)
    let _weight                                    (strike : ICell<double>) (forward : ICell<double>) (stdDev : ICell<double>) (addParams : ICell<List<Nullable<double>>>)   
                                                   = cell (fun () -> _SVISpecs.Value.weight(strike.Value, forward.Value, stdDev.Value, addParams.Value))
