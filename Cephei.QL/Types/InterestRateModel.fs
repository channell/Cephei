...
*)
    ...
    let _compoundFactor                            (t : ICell<double>)   
                                                   = cell (fun () -> _InterestRate.Value.compoundFactor(t.Value))
    let _compoundFactor1                           (d1 : ICell<Date>) (d2 : ICell<Date>) (refStart : ICell<Date>) (refEnd : ICell<Date>)   
                                                   = cell (fun () -> _InterestRate.Value.compoundFactor(d1.Value, d2.Value, refStart.Value, refEnd.Value))
    let _compounding                               = cell (fun () -> _InterestRate.Value.compounding())
    let _dayCounter                                = cell (fun () -> _InterestRate.Value.dayCounter())
    let _discountFactor                            (d1 : ICell<Date>) (d2 : ICell<Date>) (refStart : ICell<Date>) (refEnd : ICell<Date>)   
                                                   = cell (fun () -> _InterestRate.Value.discountFactor(d1.Value, d2.Value, refStart.Value, refEnd.Value))
    let _discountFactor1                           (t : ICell<double>)   
                                                   = cell (fun () -> _InterestRate.Value.discountFactor(t.Value))
    let _equivalentRate                            (resultDC : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (d1 : ICell<Date>) (d2 : ICell<Date>) (refStart : ICell<Date>) (refEnd : ICell<Date>)   
                                                   = cell (fun () -> _InterestRate.Value.equivalentRate(resultDC.Value, comp.Value, freq.Value, d1.Value, d2.Value, refStart.Value, refEnd.Value))
    let _equivalentRate1                           (comp : ICell<Compounding>) (freq : ICell<Frequency>) (t : ICell<double>)   
                                                   = cell (fun () -> _InterestRate.Value.equivalentRate(comp.Value, freq.Value, t.Value))
    let _frequency                                 = cell (fun () -> _InterestRate.Value.frequency())
    let _rate                                      = cell (fun () -> _InterestRate.Value.rate())
    let _ToString                                  = cell (fun () -> _InterestRate.Value.ToString())
    let _value                                     = cell (fun () -> _InterestRate.Value.value())
