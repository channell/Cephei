...
*)
    ...
    let _add                                       (value : ICell<double>) (weight : ICell<double>)   
                                                   = cell (fun () -> _GenericGaussianStatistics.Value.add(value.Value, weight.Value)
                                                                     _GenericGaussianStatistics.Value)
    let _addSequence                               (data : ICell<Generic.List<double>>) (weight : ICell<Generic.List<double>>)   
                                                   = cell (fun () -> _GenericGaussianStatistics.Value.addSequence(data.Value, weight.Value)
                                                                     _GenericGaussianStatistics.Value)
    let _errorEstimate                             = cell (fun () -> _GenericGaussianStatistics.Value.errorEstimate())
    let _expectationValue                          (f : ICell<Func<KeyValuePair<double,double>,double>>) (inRange : ICell<Func<KeyValuePair<double,double>,bool>>)   
                                                   = cell (fun () -> _GenericGaussianStatistics.Value.expectationValue(f.Value, inRange.Value))
    let _gaussianAverageShortfall                  (target : ICell<double>)   
                                                   = cell (fun () -> _GenericGaussianStatistics.Value.gaussianAverageShortfall(target.Value))
    let _gaussianDownsideDeviation                 = cell (fun () -> _GenericGaussianStatistics.Value.gaussianDownsideDeviation())
    let _gaussianDownsideVariance                  = cell (fun () -> _GenericGaussianStatistics.Value.gaussianDownsideVariance())
    let _gaussianExpectedShortfall                 (percentile : ICell<double>)   
                                                   = cell (fun () -> _GenericGaussianStatistics.Value.gaussianExpectedShortfall(percentile.Value))
    let _gaussianPercentile                        (percentile : ICell<double>)   
                                                   = cell (fun () -> _GenericGaussianStatistics.Value.gaussianPercentile(percentile.Value))
    let _gaussianPotentialUpside                   (percentile : ICell<double>)   
                                                   = cell (fun () -> _GenericGaussianStatistics.Value.gaussianPotentialUpside(percentile.Value))
    let _gaussianRegret                            (target : ICell<double>)   
                                                   = cell (fun () -> _GenericGaussianStatistics.Value.gaussianRegret(target.Value))
    let _gaussianShortfall                         (target : ICell<double>)   
                                                   = cell (fun () -> _GenericGaussianStatistics.Value.gaussianShortfall(target.Value))
    let _gaussianTopPercentile                     (percentile : ICell<double>)   
                                                   = cell (fun () -> _GenericGaussianStatistics.Value.gaussianTopPercentile(percentile.Value))
    let _gaussianValueAtRisk                       (percentile : ICell<double>)   
                                                   = cell (fun () -> _GenericGaussianStatistics.Value.gaussianValueAtRisk(percentile.Value))
    let _kurtosis                                  = cell (fun () -> _GenericGaussianStatistics.Value.kurtosis())
    let _max                                       = cell (fun () -> _GenericGaussianStatistics.Value.max())
    let _mean                                      = cell (fun () -> _GenericGaussianStatistics.Value.mean())
    let _min                                       = cell (fun () -> _GenericGaussianStatistics.Value.min())
    let _percentile                                (percent : ICell<double>)   
                                                   = cell (fun () -> _GenericGaussianStatistics.Value.percentile(percent.Value))
    let _reset                                     = cell (fun () -> _GenericGaussianStatistics.Value.reset()
                                                                     _GenericGaussianStatistics.Value)
    let _samples                                   = cell (fun () -> _GenericGaussianStatistics.Value.samples())
    let _skewness                                  = cell (fun () -> _GenericGaussianStatistics.Value.skewness())
    let _standardDeviation                         = cell (fun () -> _GenericGaussianStatistics.Value.standardDeviation())
    let _variance                                  = cell (fun () -> _GenericGaussianStatistics.Value.variance())
    let _weightSum                                 = cell (fun () -> _GenericGaussianStatistics.Value.weightSum())
