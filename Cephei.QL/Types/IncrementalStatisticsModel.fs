...
*)
    ...
    let _add                                       (value : ICell<double>) (weight : ICell<double>)   
                                                   = cell (fun () -> _IncrementalStatistics.Value.add(value.Value, weight.Value)
                                                                     _IncrementalStatistics.Value)
    let _add1                                      (value : ICell<double>)   
                                                   = cell (fun () -> _IncrementalStatistics.Value.add(value.Value)
                                                                     _IncrementalStatistics.Value)
    let _addSequence                               (list : ICell<Generic.List<double>>)   
                                                   = cell (fun () -> _IncrementalStatistics.Value.addSequence(list.Value)
                                                                     _IncrementalStatistics.Value)
    let _addSequence1                              (data : ICell<Generic.List<double>>) (weight : ICell<Generic.List<double>>)   
                                                   = cell (fun () -> _IncrementalStatistics.Value.addSequence(data.Value, weight.Value)
                                                                     _IncrementalStatistics.Value)
    let _downsideDeviation                         = cell (fun () -> _IncrementalStatistics.Value.downsideDeviation())
    let _downsideVariance                          = cell (fun () -> _IncrementalStatistics.Value.downsideVariance())
    let _errorEstimate                             = cell (fun () -> _IncrementalStatistics.Value.errorEstimate())
    let _expectationValue                          (f : ICell<Func<KeyValuePair<double,double>,double>>) (inRange : ICell<Func<KeyValuePair<double,double>,bool>>)   
                                                   = cell (fun () -> _IncrementalStatistics.Value.expectationValue(f.Value, inRange.Value))
    let _kurtosis                                  = cell (fun () -> _IncrementalStatistics.Value.kurtosis())
    let _max                                       = cell (fun () -> _IncrementalStatistics.Value.max())
    let _mean                                      = cell (fun () -> _IncrementalStatistics.Value.mean())
    let _min                                       = cell (fun () -> _IncrementalStatistics.Value.min())
    let _percentile                                (percent : ICell<double>)   
                                                   = cell (fun () -> _IncrementalStatistics.Value.percentile(percent.Value))
    let _reset                                     = cell (fun () -> _IncrementalStatistics.Value.reset()
                                                                     _IncrementalStatistics.Value)
    let _samples                                   = cell (fun () -> _IncrementalStatistics.Value.samples())
    let _skewness                                  = cell (fun () -> _IncrementalStatistics.Value.skewness())
    let _standardDeviation                         = cell (fun () -> _IncrementalStatistics.Value.standardDeviation())
    let _variance                                  = cell (fun () -> _IncrementalStatistics.Value.variance())
    let _weightSum                                 = cell (fun () -> _IncrementalStatistics.Value.weightSum())
