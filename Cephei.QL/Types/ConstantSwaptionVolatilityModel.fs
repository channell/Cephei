...
*)
    ...
    let _maxDate                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.maxDate())
    let _maxStrike                                 = cell (fun () -> _ConstantSwaptionVolatility.Value.maxStrike())
    let _maxSwapTenor                              = cell (fun () -> _ConstantSwaptionVolatility.Value.maxSwapTenor())
    let _minStrike                                 = cell (fun () -> _ConstantSwaptionVolatility.Value.minStrike())
    let _volatilityType                            = cell (fun () -> _ConstantSwaptionVolatility.Value.volatilityType())
    let _blackVariance                             (optionTenor : ICell<Period>) (swapTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.blackVariance(optionTenor.Value, swapTenor.Value, strike.Value, extrapolate.Value))
    let _blackVariance1                            (optionDate : ICell<Date>) (swapTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.blackVariance(optionDate.Value, swapTenor.Value, strike.Value, extrapolate.Value))
    let _blackVariance2                            (optionTime : ICell<double>) (swapTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.blackVariance(optionTime.Value, swapTenor.Value, strike.Value, extrapolate.Value))
    let _blackVariance3                            (optionTenor : ICell<Period>) (swapLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.blackVariance(optionTenor.Value, swapLength.Value, strike.Value, extrapolate.Value))
    let _blackVariance4                            (optionTime : ICell<double>) (swapLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.blackVariance(optionTime.Value, swapLength.Value, strike.Value, extrapolate.Value))
    let _blackVariance5                            (optionDate : ICell<Date>) (swapLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.blackVariance(optionDate.Value, swapLength.Value, strike.Value, extrapolate.Value))
    let _maxSwapLength                             = cell (fun () -> _ConstantSwaptionVolatility.Value.maxSwapLength())
    let _shift                                     (optionTime : ICell<double>) (swapLength : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.shift(optionTime.Value, swapLength.Value, extrapolate.Value))
    let _shift1                                    (optionDate : ICell<Date>) (swapLength : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.shift(optionDate.Value, swapLength.Value, extrapolate.Value))
    let _shift2                                    (optionTenor : ICell<Period>) (swapTenor : ICell<Period>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.shift(optionTenor.Value, swapTenor.Value, extrapolate.Value))
    let _shift3                                    (optionTenor : ICell<Period>) (swapLength : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.shift(optionTenor.Value, swapLength.Value, extrapolate.Value))
    let _shift4                                    (optionTime : ICell<double>) (swapTenor : ICell<Period>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.shift(optionTime.Value, swapTenor.Value, extrapolate.Value))
    let _shift5                                    (optionDate : ICell<Date>) (swapTenor : ICell<Period>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.shift(optionDate.Value, swapTenor.Value, extrapolate.Value))
    let _smileSection                              (optionDate : ICell<Date>) (swapTenor : ICell<Period>) (extr : ICell<bool>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.smileSection(optionDate.Value, swapTenor.Value, extr.Value))
    let _smileSection1                             (optionTenor : ICell<Period>) (swapTenor : ICell<Period>) (extr : ICell<bool>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.smileSection(optionTenor.Value, swapTenor.Value, extr.Value))
    let _smileSection2                             (optionTime : ICell<double>) (swapLength : ICell<double>) (extr : ICell<bool>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.smileSection(optionTime.Value, swapLength.Value, extr.Value))
    let _swapLength                                (start : ICell<Date>) (End : ICell<Date>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.swapLength(start.Value, End.Value))
    let _swapLength1                               (swapTenor : ICell<Period>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.swapLength(swapTenor.Value))
    let _volatility                                (optionTime : ICell<double>) (swapTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.volatility(optionTime.Value, swapTenor.Value, strike.Value, extrapolate.Value))
    let _volatility1                               (optionTenor : ICell<Period>) (swapLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.volatility(optionTenor.Value, swapLength.Value, strike.Value, extrapolate.Value))
    let _volatility2                               (optionDate : ICell<Date>) (swapLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.volatility(optionDate.Value, swapLength.Value, strike.Value, extrapolate.Value))
    let _volatility3                               (optionTime : ICell<double>) (swapLength : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.volatility(optionTime.Value, swapLength.Value, strike.Value, extrapolate.Value))
    let _volatility4                               (optionDate : ICell<Date>) (swapTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.volatility(optionDate.Value, swapTenor.Value, strike.Value, extrapolate.Value))
    let _volatility5                               (optionTenor : ICell<Period>) (swapTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.volatility(optionTenor.Value, swapTenor.Value, strike.Value, extrapolate.Value))
    let _businessDayConvention                     = cell (fun () -> _ConstantSwaptionVolatility.Value.businessDayConvention())
    let _optionDateFromTenor                       (p : ICell<Period>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.optionDateFromTenor(p.Value))
    let _calendar                                  = cell (fun () -> _ConstantSwaptionVolatility.Value.calendar())
    let _dayCounter                                = cell (fun () -> _ConstantSwaptionVolatility.Value.dayCounter())
    let _maxTime                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.maxTime())
    let _referenceDate                             = cell (fun () -> _ConstantSwaptionVolatility.Value.referenceDate())
    let _settlementDays                            = cell (fun () -> _ConstantSwaptionVolatility.Value.settlementDays())
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.timeFromReference(date.Value))
    let _update                                    = cell (fun () -> _ConstantSwaptionVolatility.Value.update()
                                                                     _ConstantSwaptionVolatility.Value)
    let _allowsExtrapolation                       = cell (fun () -> _ConstantSwaptionVolatility.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.disableExtrapolation(b.Value)
                                                                     _ConstantSwaptionVolatility.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _ConstantSwaptionVolatility.Value.enableExtrapolation(b.Value)
                                                                     _ConstantSwaptionVolatility.Value)
    let _extrapolate                               = cell (fun () -> _ConstantSwaptionVolatility.Value.extrapolate)
