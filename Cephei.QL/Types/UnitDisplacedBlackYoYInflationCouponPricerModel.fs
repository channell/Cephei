...
*)
    ...
    let _capletPrice                               (effectiveCap : ICell<double>)   
                                                   = cell (fun () -> _UnitDisplacedBlackYoYInflationCouponPricer.Value.capletPrice(effectiveCap.Value))
    let _capletRate                                (effectiveCap : ICell<double>)   
                                                   = cell (fun () -> _UnitDisplacedBlackYoYInflationCouponPricer.Value.capletRate(effectiveCap.Value))
    let _capletVolatility                          = cell (fun () -> _UnitDisplacedBlackYoYInflationCouponPricer.Value.capletVolatility())
    let _floorletPrice                             (effectiveFloor : ICell<double>)   
                                                   = cell (fun () -> _UnitDisplacedBlackYoYInflationCouponPricer.Value.floorletPrice(effectiveFloor.Value))
    let _floorletRate                              (effectiveFloor : ICell<double>)   
                                                   = cell (fun () -> _UnitDisplacedBlackYoYInflationCouponPricer.Value.floorletRate(effectiveFloor.Value))
    let _initialize                                (coupon : ICell<InflationCoupon>)   
                                                   = cell (fun () -> _UnitDisplacedBlackYoYInflationCouponPricer.Value.initialize(coupon.Value)
    ...
    let _setCapletVolatility                       (capletVol : ICell<Handle<YoYOptionletVolatilitySurface>>)   
                                                   = cell (fun () -> _UnitDisplacedBlackYoYInflationCouponPricer.Value.setCapletVolatility(capletVol.Value)
                                                                     _UnitDisplacedBlackYoYInflationCouponPricer.Value)
    let _swapletPrice                              = cell (fun () -> _UnitDisplacedBlackYoYInflationCouponPricer.Value.swapletPrice())
    let _swapletRate                               = cell (fun () -> _UnitDisplacedBlackYoYInflationCouponPricer.Value.swapletRate())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _UnitDisplacedBlackYoYInflationCouponPricer.Value.registerWith(handler.Value)
                                                                     _UnitDisplacedBlackYoYInflationCouponPricer.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _UnitDisplacedBlackYoYInflationCouponPricer.Value.unregisterWith(handler.Value)
                                                                     _UnitDisplacedBlackYoYInflationCouponPricer.Value)
    let _update                                    = cell (fun () -> _UnitDisplacedBlackYoYInflationCouponPricer.Value.update()
                                                                     _UnitDisplacedBlackYoYInflationCouponPricer.Value)
