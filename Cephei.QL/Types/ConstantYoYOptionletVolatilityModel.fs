...
*)
    ...
    let _maxDate                                   = cell (fun () -> _ConstantYoYOptionletVolatility.Value.maxDate())
    let _maxStrike                                 = cell (fun () -> _ConstantYoYOptionletVolatility.Value.maxStrike())
    let _minStrike                                 = cell (fun () -> _ConstantYoYOptionletVolatility.Value.minStrike())
    let _baseDate                                  = cell (fun () -> _ConstantYoYOptionletVolatility.Value.baseDate())
    let _baseLevel                                 = cell (fun () -> _ConstantYoYOptionletVolatility.Value.baseLevel())
    let _frequency                                 = cell (fun () -> _ConstantYoYOptionletVolatility.Value.frequency())
    let _indexIsInterpolated                       = cell (fun () -> _ConstantYoYOptionletVolatility.Value.indexIsInterpolated())
    let _observationLag                            = cell (fun () -> _ConstantYoYOptionletVolatility.Value.observationLag())
    let _timeFromBase                              (maturityDate : ICell<Date>) (obsLag : ICell<Period>)   
                                                   = cell (fun () -> _ConstantYoYOptionletVolatility.Value.timeFromBase(maturityDate.Value, obsLag.Value))
    let _timeFromBase1                             (maturityDate : ICell<Date>)   
                                                   = cell (fun () -> _ConstantYoYOptionletVolatility.Value.timeFromBase(maturityDate.Value))
    let _totalVariance                             (maturityDate : ICell<Date>) (strike : ICell<double>) (obsLag : ICell<Period>)   
                                                   = cell (fun () -> _ConstantYoYOptionletVolatility.Value.totalVariance(maturityDate.Value, strike.Value, obsLag.Value))
    let _totalVariance1                            (maturityDate : ICell<Date>) (strike : ICell<double>) (obsLag : ICell<Period>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantYoYOptionletVolatility.Value.totalVariance(maturityDate.Value, strike.Value, obsLag.Value, extrapolate.Value))
    let _totalVariance2                            (tenor : ICell<Period>) (strike : ICell<double>)   
                                                   = cell (fun () -> _ConstantYoYOptionletVolatility.Value.totalVariance(tenor.Value, strike.Value))
    let _totalVariance3                            (tenor : ICell<Period>) (strike : ICell<double>) (obsLag : ICell<Period>)   
                                                   = cell (fun () -> _ConstantYoYOptionletVolatility.Value.totalVariance(tenor.Value, strike.Value, obsLag.Value))
    let _totalVariance4                            (tenor : ICell<Period>) (strike : ICell<double>) (obsLag : ICell<Period>) (extrap : ICell<bool>)   
                                                   = cell (fun () -> _ConstantYoYOptionletVolatility.Value.totalVariance(tenor.Value, strike.Value, obsLag.Value, extrap.Value))
    let _totalVariance5                            (maturityDate : ICell<Date>) (strike : ICell<double>)   
                                                   = cell (fun () -> _ConstantYoYOptionletVolatility.Value.totalVariance(maturityDate.Value, strike.Value))
    let _volatility                                (maturityDate : ICell<Date>) (strike : ICell<double>) (obsLag : ICell<Period>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantYoYOptionletVolatility.Value.volatility(maturityDate.Value, strike.Value, obsLag.Value, extrapolate.Value))
    let _volatility1                               (optionTenor : ICell<Period>) (strike : ICell<double>) (obsLag : ICell<Period>)   
                                                   = cell (fun () -> _ConstantYoYOptionletVolatility.Value.volatility(optionTenor.Value, strike.Value, obsLag.Value))
    let _volatility2                               (maturityDate : ICell<Date>) (strike : ICell<double>) (obsLag : ICell<Period>)   
                                                   = cell (fun () -> _ConstantYoYOptionletVolatility.Value.volatility(maturityDate.Value, strike.Value, obsLag.Value))
    let _volatility3                               (optionTenor : ICell<Period>) (strike : ICell<double>) (obsLag : ICell<Period>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _ConstantYoYOptionletVolatility.Value.volatility(optionTenor.Value, strike.Value, obsLag.Value, extrapolate.Value))
    let _volatility4                               (maturityDate : ICell<Date>) (strike : ICell<double>)   
                                                   = cell (fun () -> _ConstantYoYOptionletVolatility.Value.volatility(maturityDate.Value, strike.Value))
    let _volatility5                               (optionTenor : ICell<Period>) (strike : ICell<double>)   
                                                   = cell (fun () -> _ConstantYoYOptionletVolatility.Value.volatility(optionTenor.Value, strike.Value))
    let _businessDayConvention                     = cell (fun () -> _ConstantYoYOptionletVolatility.Value.businessDayConvention())
    let _optionDateFromTenor                       (p : ICell<Period>)   
                                                   = cell (fun () -> _ConstantYoYOptionletVolatility.Value.optionDateFromTenor(p.Value))
    let _calendar                                  = cell (fun () -> _ConstantYoYOptionletVolatility.Value.calendar())
    let _dayCounter                                = cell (fun () -> _ConstantYoYOptionletVolatility.Value.dayCounter())
    let _maxTime                                   = cell (fun () -> _ConstantYoYOptionletVolatility.Value.maxTime())
    let _referenceDate                             = cell (fun () -> _ConstantYoYOptionletVolatility.Value.referenceDate())
    let _settlementDays                            = cell (fun () -> _ConstantYoYOptionletVolatility.Value.settlementDays())
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = cell (fun () -> _ConstantYoYOptionletVolatility.Value.timeFromReference(date.Value))
    let _update                                    = cell (fun () -> _ConstantYoYOptionletVolatility.Value.update()
                                                                     _ConstantYoYOptionletVolatility.Value)
    let _allowsExtrapolation                       = cell (fun () -> _ConstantYoYOptionletVolatility.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _ConstantYoYOptionletVolatility.Value.disableExtrapolation(b.Value)
                                                                     _ConstantYoYOptionletVolatility.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _ConstantYoYOptionletVolatility.Value.enableExtrapolation(b.Value)
                                                                     _ConstantYoYOptionletVolatility.Value)
    let _extrapolate                               = cell (fun () -> _ConstantYoYOptionletVolatility.Value.extrapolate)
