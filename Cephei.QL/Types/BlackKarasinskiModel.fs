...
*)
    let mutable
        _BlackKarasinski                           = make (fun () -> new BlackKarasinski (termStructure.Value, a.Value, sigma.Value))
    let _dynamics                                  = triv _BlackKarasinski (fun () -> _BlackKarasinski.Value.dynamics())
    let _termStructure                             = triv _BlackKarasinski (fun () -> _BlackKarasinski.Value.termStructure())
    let _termStructure_                            = triv _BlackKarasinski (fun () -> _BlackKarasinski.Value.termStructure_)
    let _tree                                      (grid : ICell<TimeGrid>)   
                                                   = triv _BlackKarasinski (fun () -> _BlackKarasinski.Value.tree(grid.Value))
    let _calibrate                                 (instruments : ICell<Generic.List<CalibrationHelper>>) (Method : ICell<OptimizationMethod>) (endCriteria : ICell<EndCriteria>) (additionalConstraint : ICell<Constraint>) (weights : ICell<Generic.List<double>>) (fixParameters : ICell<Generic.List<bool>>)   
                                                   = triv _BlackKarasinski (fun () -> _BlackKarasinski.Value.calibrate(instruments.Value, Method.Value, endCriteria.Value, additionalConstraint.Value, weights.Value, fixParameters.Value)
                                                                                      _BlackKarasinski.Value)
    let _constraint                                = triv _BlackKarasinski (fun () -> _BlackKarasinski.Value.CONSTRAINT())
    let _endCriteria                               = triv _BlackKarasinski (fun () -> _BlackKarasinski.Value.endCriteria())
    let _notifyObservers                           = triv _BlackKarasinski (fun () -> _BlackKarasinski.Value.notifyObservers()
                                                                                      _BlackKarasinski.Value)
    let _parameters                                = triv _BlackKarasinski (fun () -> _BlackKarasinski.Value.parameters())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv _BlackKarasinski (fun () -> _BlackKarasinski.Value.registerWith(handler.Value)
                                                                                      _BlackKarasinski.Value)
    let _setParams                                 (parameters : ICell<Vector>)   
                                                   = triv _BlackKarasinski (fun () -> _BlackKarasinski.Value.setParams(parameters.Value)
                                                                                      _BlackKarasinski.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = triv _BlackKarasinski (fun () -> _BlackKarasinski.Value.unregisterWith(handler.Value)
                                                                                      _BlackKarasinski.Value)
    let _update                                    = triv _BlackKarasinski (fun () -> _BlackKarasinski.Value.update()
                                                                                      _BlackKarasinski.Value)
    let _value                                     (parameters : ICell<Vector>) (instruments : ICell<Generic.List<CalibrationHelper>>)   
                                                   = triv _BlackKarasinski (fun () -> _BlackKarasinski.Value.value(parameters.Value, instruments.Value))
...
*)
    let mutable
        _BlackKarasinski                           = make (fun () -> new BlackKarasinski (termStructure.Value))
    let _dynamics                                  = triv _BlackKarasinski (fun () -> _BlackKarasinski.Value.dynamics())
    let _termStructure                             = triv _BlackKarasinski (fun () -> _BlackKarasinski.Value.termStructure())
    let _termStructure_                            = triv _BlackKarasinski (fun () -> _BlackKarasinski.Value.termStructure_)
    let _tree                                      (grid : ICell<TimeGrid>)   
