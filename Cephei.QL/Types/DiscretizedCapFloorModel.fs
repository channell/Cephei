...
*)
    ...
    let _adjustValues                              = triv (fun () -> _DiscretizedCapFloor.Value.adjustValues()
                                                                     _DiscretizedCapFloor.Value)
    let _initialize                                (Method : ICell<Lattice>) (t : ICell<double>)   
                                                   = triv (fun () -> _DiscretizedCapFloor.Value.initialize(Method.Value, t.Value)
                                                                     _DiscretizedCapFloor.Value)
    let _method                                    = triv (fun () -> _DiscretizedCapFloor.Value.METHOD())
    let _partialRollback                           (To : ICell<double>)   
                                                   = triv (fun () -> _DiscretizedCapFloor.Value.partialRollback(To.Value)
                                                                     _DiscretizedCapFloor.Value)
    let _postAdjustValues                          = triv (fun () -> _DiscretizedCapFloor.Value.postAdjustValues()
                                                                     _DiscretizedCapFloor.Value)
    let _preAdjustValues                           = triv (fun () -> _DiscretizedCapFloor.Value.preAdjustValues()
                                                                     _DiscretizedCapFloor.Value)
    let _presentValue                              = triv (fun () -> _DiscretizedCapFloor.Value.presentValue())
    let _rollback                                  (To : ICell<double>)   
                                                   = triv (fun () -> _DiscretizedCapFloor.Value.rollback(To.Value)
                                                                     _DiscretizedCapFloor.Value)
    let _setTime                                   (t : ICell<double>)   
                                                   = triv (fun () -> _DiscretizedCapFloor.Value.setTime(t.Value)
                                                                     _DiscretizedCapFloor.Value)
    let _setValues                                 (v : ICell<Vector>)   
                                                   = triv (fun () -> _DiscretizedCapFloor.Value.setValues(v.Value)
                                                                     _DiscretizedCapFloor.Value)
    let _time                                      = triv (fun () -> _DiscretizedCapFloor.Value.time())
    let _values                                    = triv (fun () -> _DiscretizedCapFloor.Value.values())
