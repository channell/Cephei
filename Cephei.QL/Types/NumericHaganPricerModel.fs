...
*)
    ...
    let _integrate                                 (a : ICell<double>) (b : ICell<double>) (integrand : ICell<NumericHaganPricer.ConundrumIntegrand>)   
                                                   = cell (fun () -> _NumericHaganPricer.Value.integrate(a.Value, b.Value, integrand.Value))
    let _refineIntegration                         (integralValue : ICell<double>) (integrand : ICell<NumericHaganPricer.ConundrumIntegrand>)   
                                                   = cell (fun () -> _NumericHaganPricer.Value.refineIntegration(integralValue.Value, integrand.Value))
    let _resetUpperLimit                           (stdDeviationsForUpperLimit : ICell<double>)   
                                                   = cell (fun () -> _NumericHaganPricer.Value.resetUpperLimit(stdDeviationsForUpperLimit.Value))
    let _stdDeviations                             = cell (fun () -> _NumericHaganPricer.Value.stdDeviations())
    let _swapletPrice                              = cell (fun () -> _NumericHaganPricer.Value.swapletPrice())
    let _upperLimit                                = cell (fun () -> _NumericHaganPricer.Value.upperLimit())
    let _capletPrice                               (effectiveCap : ICell<double>)   
                                                   = cell (fun () -> _NumericHaganPricer.Value.capletPrice(effectiveCap.Value))
    let _capletRate                                (effectiveCap : ICell<double>)   
                                                   = cell (fun () -> _NumericHaganPricer.Value.capletRate(effectiveCap.Value))
    let _floorletPrice                             (effectiveFloor : ICell<double>)   
                                                   = cell (fun () -> _NumericHaganPricer.Value.floorletPrice(effectiveFloor.Value))
    let _floorletRate                              (effectiveFloor : ICell<double>)   
                                                   = cell (fun () -> _NumericHaganPricer.Value.floorletRate(effectiveFloor.Value))
    let _initialize                                (coupon : ICell<FloatingRateCoupon>)   
                                                   = cell (fun () -> _NumericHaganPricer.Value.initialize(coupon.Value)
                                                                     _NumericHaganPricer.Value)
    let _meanReversion                             = cell (fun () -> _NumericHaganPricer.Value.meanReversion())
    let _setMeanReversion                          (meanReversion : ICell<Handle<Quote>>)   
                                                   = cell (fun () -> _NumericHaganPricer.Value.setMeanReversion(meanReversion.Value)
                                                                     _NumericHaganPricer.Value)
    let _swapletRate                               = cell (fun () -> _NumericHaganPricer.Value.swapletRate())
    let _setSwaptionVolatility                     (v : ICell<Handle<SwaptionVolatilityStructure>>)   
                                                   = cell (fun () -> _NumericHaganPricer.Value.setSwaptionVolatility(v.Value)
                                                                     _NumericHaganPricer.Value)
    let _swaptionVolatility                        = cell (fun () -> _NumericHaganPricer.Value.swaptionVolatility())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _NumericHaganPricer.Value.registerWith(handler.Value)
                                                                     _NumericHaganPricer.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _NumericHaganPricer.Value.unregisterWith(handler.Value)
                                                                     _NumericHaganPricer.Value)
    let _update                                    = cell (fun () -> _NumericHaganPricer.Value.update()
                                                                     _NumericHaganPricer.Value)
