...
*)
    let mutable
        _Sample                                    = make (fun () -> new Sample<'T> (value_.Value, weight_.Value))
    let _value                                     = triv _Sample (fun () -> _Sample.Value.value)
    let _weight                                    = triv _Sample (fun () -> _Sample.Value.weight)
