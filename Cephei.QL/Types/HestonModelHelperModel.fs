...
*)
    let mutable
        _HestonModelHelper                         = make (fun () -> withEngine pricingEngine evaluationDate (new HestonModelHelper (maturity.Value, calendar.Value, s0.Value, strikePrice.Value, volatility.Value, riskFreeRate.Value, dividendYield.Value, errorType.Value)))
    let _addTimesTo                                (t : ICell<Generic.List<double>>)   
                                                   = triv _HestonModelHelper (fun () -> (withEvaluationDate _evaluationDate _HestonModelHelper).addTimesTo(t.Value)
                                                                                        _HestonModelHelper.Value)
    let _blackPrice                                (volatility : ICell<double>)   
                                                   = triv _HestonModelHelper (fun () -> (withEvaluationDate _evaluationDate _HestonModelHelper).blackPrice(volatility.Value))
    let _maturity                                  = triv _HestonModelHelper (fun () -> (withEvaluationDate _evaluationDate _HestonModelHelper).maturity())
    let _modelValue                                = triv _HestonModelHelper (fun () -> (withEvaluationDate _evaluationDate _HestonModelHelper).modelValue())
    let _optionType                                = triv _HestonModelHelper (fun () -> (withEvaluationDate _evaluationDate _HestonModelHelper).optionType())
    let _strike                                    = triv _HestonModelHelper (fun () -> (withEvaluationDate _evaluationDate _HestonModelHelper).strike())
    let _calibrationError                          = triv _HestonModelHelper (fun () -> (withEvaluationDate _evaluationDate _HestonModelHelper).calibrationError())
    let _impliedVolatility                         (targetValue : ICell<double>) (accuracy : ICell<double>) (maxEvaluations : ICell<int>) (minVol : ICell<double>) (maxVol : ICell<double>)   
                                                   = triv _HestonModelHelper (fun () -> (withEvaluationDate _evaluationDate _HestonModelHelper).impliedVolatility(targetValue.Value, accuracy.Value, maxEvaluations.Value, minVol.Value, maxVol.Value))
    let _marketValue                               = triv _HestonModelHelper (fun () -> (withEvaluationDate _evaluationDate _HestonModelHelper).marketValue())
    let _setPricingEngine                          (engine : ICell<IPricingEngine>)   
                                                   = triv _HestonModelHelper (fun () -> (withEvaluationDate _evaluationDate _HestonModelHelper).setPricingEngine(engine.Value)
                                                                                        _HestonModelHelper.Value)
    let _volatility                                = triv _HestonModelHelper (fun () -> (withEvaluationDate _evaluationDate _HestonModelHelper).volatility())
    let _volatilityType                            = triv _HestonModelHelper (fun () -> (withEvaluationDate _evaluationDate _HestonModelHelper).volatilityType())
