...
(*
    Functions
*)
    let _HestonModelHelper                         = cell (fun () -> withEngine _pricingEngine.Value (new HestonModelHelper (maturity.Value, calendar.Value, s0.Value, strikePrice.Value, volatility.Value, riskFreeRate.Value, dividendYield.Value, errorType.Value)))
    let _addTimesTo                                (t : ICell<Generic.List<double>>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _HestonModelHelper).addTimesTo(t.Value)
                                                                     _HestonModelHelper.Value)
    let _blackPrice                                (volatility : ICell<double>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _HestonModelHelper).blackPrice(volatility.Value))
    let _maturity                                  = cell (fun () -> (withEvaluationDate _evaluationDate _HestonModelHelper).maturity())
    let _modelValue                                = cell (fun () -> (withEvaluationDate _evaluationDate _HestonModelHelper).modelValue())
    let _optionType                                = cell (fun () -> (withEvaluationDate _evaluationDate _HestonModelHelper).optionType())
    let _strike                                    = cell (fun () -> (withEvaluationDate _evaluationDate _HestonModelHelper).strike())
    let _calibrationError                          = cell (fun () -> (withEvaluationDate _evaluationDate _HestonModelHelper).calibrationError())
    let _impliedVolatility                         (targetValue : ICell<double>) (accuracy : ICell<double>) (maxEvaluations : ICell<int>) (minVol : ICell<double>) (maxVol : ICell<double>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _HestonModelHelper).impliedVolatility(targetValue.Value, accuracy.Value, maxEvaluations.Value, minVol.Value, maxVol.Value))
    let _marketValue                               = cell (fun () -> (withEvaluationDate _evaluationDate _HestonModelHelper).marketValue())
    let _setPricingEngine                          (engine : ICell<IPricingEngine>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _HestonModelHelper).setPricingEngine(engine.Value)
                                                                     _HestonModelHelper.Value)
    let _volatility                                = cell (fun () -> (withEvaluationDate _evaluationDate _HestonModelHelper).volatility())
    let _volatilityType                            = cell (fun () -> (withEvaluationDate _evaluationDate _HestonModelHelper).volatilityType())
