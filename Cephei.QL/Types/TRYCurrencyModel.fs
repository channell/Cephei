...
*)
    ...
    let _Equals                                    (o : ICell<Object>)   
                                                   = triv (fun () -> _TRYCurrency.Value.Equals(o.Value))
    let _format                                    = triv (fun () -> _TRYCurrency.Value.format)
    let _fractionsPerUnit                          = triv (fun () -> _TRYCurrency.Value.fractionsPerUnit)
    let _fractionSymbol                            = triv (fun () -> _TRYCurrency.Value.fractionSymbol)
    let _name                                      = triv (fun () -> _TRYCurrency.Value.name)
    let _numericCode                               = triv (fun () -> _TRYCurrency.Value.numericCode)
    let _rounding                                  = triv (fun () -> _TRYCurrency.Value.rounding)
    let _symbol                                    = triv (fun () -> _TRYCurrency.Value.symbol)
    let _ToString                                  = triv (fun () -> _TRYCurrency.Value.ToString())
    let _triangulationCurrency                     = triv (fun () -> _TRYCurrency.Value.triangulationCurrency)
