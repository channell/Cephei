...
*)
    ...
    let _apply                                     (x0 : ICell<double>) (dx : ICell<double>)   
                                                   = cell (fun () -> _BlackScholesProcess.Value.apply(x0.Value, dx.Value))
    let _blackVolatility                           = cell (fun () -> _BlackScholesProcess.Value.blackVolatility())
    let _diffusion                                 (t : ICell<double>) (x : ICell<double>)   
                                                   = cell (fun () -> _BlackScholesProcess.Value.diffusion(t.Value, x.Value))
    let _dividendYield                             = cell (fun () -> _BlackScholesProcess.Value.dividendYield())
    let _drift                                     (t : ICell<double>) (x : ICell<double>)   
                                                   = cell (fun () -> _BlackScholesProcess.Value.drift(t.Value, x.Value))
    let _evolve                                    (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>) (dw : ICell<double>)   
                                                   = cell (fun () -> _BlackScholesProcess.Value.evolve(t0.Value, x0.Value, dt.Value, dw.Value))
    let _expectation                               (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = cell (fun () -> _BlackScholesProcess.Value.expectation(t0.Value, x0.Value, dt.Value))
    let _localVolatility                           = cell (fun () -> _BlackScholesProcess.Value.localVolatility())
    let _riskFreeRate                              = cell (fun () -> _BlackScholesProcess.Value.riskFreeRate())
    let _stateVariable                             = cell (fun () -> _BlackScholesProcess.Value.stateVariable())
    let _stdDeviation                              (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = cell (fun () -> _BlackScholesProcess.Value.stdDeviation(t0.Value, x0.Value, dt.Value))
    let _time                                      (d : ICell<Date>)   
                                                   = cell (fun () -> _BlackScholesProcess.Value.time(d.Value))
    let _update                                    = cell (fun () -> _BlackScholesProcess.Value.update()
                                                                     _BlackScholesProcess.Value)
    let _variance                                  (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = cell (fun () -> _BlackScholesProcess.Value.variance(t0.Value, x0.Value, dt.Value))
    let _x0                                        = cell (fun () -> _BlackScholesProcess.Value.x0())
    let _initialValues                             = cell (fun () -> _BlackScholesProcess.Value.initialValues())
    let _size                                      = cell (fun () -> _BlackScholesProcess.Value.size())
    let _covariance                                (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>)   
                                                   = cell (fun () -> _BlackScholesProcess.Value.covariance(t0.Value, x0.Value, dt.Value))
    let _factors                                   = cell (fun () -> _BlackScholesProcess.Value.factors())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _BlackScholesProcess.Value.registerWith(handler.Value)
                                                                     _BlackScholesProcess.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _BlackScholesProcess.Value.unregisterWith(handler.Value)
                                                                     _BlackScholesProcess.Value)
