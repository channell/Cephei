...
*)
    ...
    let _derivativeX                               (x : ICell<double>) (y : ICell<double>)   
                                                   = cell (fun () -> _BicubicSpline.Value.derivativeX(x.Value, y.Value))
    let _derivativeXY                              (x : ICell<double>) (y : ICell<double>)   
                                                   = cell (fun () -> _BicubicSpline.Value.derivativeXY(x.Value, y.Value))
    let _derivativeY                               (x : ICell<double>) (y : ICell<double>)   
                                                   = cell (fun () -> _BicubicSpline.Value.derivativeY(x.Value, y.Value))
    let _secondDerivativeX                         (x : ICell<double>) (y : ICell<double>)   
                                                   = cell (fun () -> _BicubicSpline.Value.secondDerivativeX(x.Value, y.Value))
    let _secondDerivativeY                         (x : ICell<double>) (y : ICell<double>)   
                                                   = cell (fun () -> _BicubicSpline.Value.secondDerivativeY(x.Value, y.Value))
    let _isInRange                                 (x : ICell<double>) (y : ICell<double>)   
                                                   = cell (fun () -> _BicubicSpline.Value.isInRange(x.Value, y.Value))
    let _locateX                                   (x : ICell<double>)   
                                                   = cell (fun () -> _BicubicSpline.Value.locateX(x.Value))
    let _locateY                                   (y : ICell<double>)   
                                                   = cell (fun () -> _BicubicSpline.Value.locateY(y.Value))
    let _update                                    = cell (fun () -> _BicubicSpline.Value.update()
                                                                     _BicubicSpline.Value)
    let _value                                     (x : ICell<double>) (y : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _BicubicSpline.Value.value(x.Value, y.Value, allowExtrapolation.Value))
    let _value1                                    (x : ICell<double>) (y : ICell<double>)   
                                                   = cell (fun () -> _BicubicSpline.Value.value(x.Value, y.Value))
    let _xMax                                      = cell (fun () -> _BicubicSpline.Value.xMax())
    let _xMin                                      = cell (fun () -> _BicubicSpline.Value.xMin())
    let _xValues                                   = cell (fun () -> _BicubicSpline.Value.xValues())
    let _yMax                                      = cell (fun () -> _BicubicSpline.Value.yMax())
    let _yMin                                      = cell (fun () -> _BicubicSpline.Value.yMin())
    let _yValues                                   = cell (fun () -> _BicubicSpline.Value.yValues())
    let _zData                                     = cell (fun () -> _BicubicSpline.Value.zData())
    let _allowsExtrapolation                       = cell (fun () -> _BicubicSpline.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _BicubicSpline.Value.disableExtrapolation(b.Value)
                                                                     _BicubicSpline.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _BicubicSpline.Value.enableExtrapolation(b.Value)
                                                                     _BicubicSpline.Value)
    let _extrapolate                               = cell (fun () -> _BicubicSpline.Value.extrapolate)
