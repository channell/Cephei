...
*)
    ...
    let _add                                       (A : ICell<IOperator>) (B : ICell<IOperator>)   
                                                   = cell (fun () -> _DZero.Value.add(A.Value, B.Value))
    let _applyTo                                   (v : ICell<Vector>)   
                                                   = cell (fun () -> _DZero.Value.applyTo(v.Value))
    let _Clone                                     = cell (fun () -> _DZero.Value.Clone())
    let _diagonal                                  = cell (fun () -> _DZero.Value.diagonal())
    let _identity                                  (size : ICell<int>)   
                                                   = cell (fun () -> _DZero.Value.identity(size.Value))
    let _isTimeDependent                           = cell (fun () -> _DZero.Value.isTimeDependent())
    let _lowerDiagonal                             = cell (fun () -> _DZero.Value.lowerDiagonal())
    let _multiply                                  (a : ICell<double>) (o : ICell<IOperator>)   
                                                   = cell (fun () -> _DZero.Value.multiply(a.Value, o.Value))
    let _setFirstRow                               (valB : ICell<double>) (valC : ICell<double>)   
                                                   = cell (fun () -> _DZero.Value.setFirstRow(valB.Value, valC.Value)
                                                                     _DZero.Value)
    let _setLastRow                                (valA : ICell<double>) (valB : ICell<double>)   
                                                   = cell (fun () -> _DZero.Value.setLastRow(valA.Value, valB.Value)
                                                                     _DZero.Value)
    let _setMidRow                                 (i : ICell<int>) (valA : ICell<double>) (valB : ICell<double>) (valC : ICell<double>)   
                                                   = cell (fun () -> _DZero.Value.setMidRow(i.Value, valA.Value, valB.Value, valC.Value)
                                                                     _DZero.Value)
    let _setMidRows                                (valA : ICell<double>) (valB : ICell<double>) (valC : ICell<double>)   
                                                   = cell (fun () -> _DZero.Value.setMidRows(valA.Value, valB.Value, valC.Value)
                                                                     _DZero.Value)
    let _setTime                                   (t : ICell<double>)   
                                                   = cell (fun () -> _DZero.Value.setTime(t.Value)
                                                                     _DZero.Value)
    let _size                                      = cell (fun () -> _DZero.Value.size())
    let _solveFor                                  (rhs : ICell<Vector>)   
                                                   = cell (fun () -> _DZero.Value.solveFor(rhs.Value))
    let _SOR                                       (rhs : ICell<Vector>) (tol : ICell<double>)   
                                                   = cell (fun () -> _DZero.Value.SOR(rhs.Value, tol.Value))
    let _subtract                                  (A : ICell<IOperator>) (B : ICell<IOperator>)   
                                                   = cell (fun () -> _DZero.Value.subtract(A.Value, B.Value))
    let _upperDiagonal                             = cell (fun () -> _DZero.Value.upperDiagonal())
    do this.Bind(_DZero)
