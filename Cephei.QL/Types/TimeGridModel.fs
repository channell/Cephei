...
*)
    ...
    let _closestIndex                              (t : ICell<double>)   
                                                   = cell (fun () -> _TimeGrid.Value.closestIndex(t.Value))
    let _closestTime                               (t : ICell<double>)   
                                                   = cell (fun () -> _TimeGrid.Value.closestTime(t.Value))
    let _dt                                        (i : ICell<int>)   
                                                   = cell (fun () -> _TimeGrid.Value.dt(i.Value))
    let _empty                                     = cell (fun () -> _TimeGrid.Value.empty())
    let _First                                     = cell (fun () -> _TimeGrid.Value.First())
    let _index                                     (t : ICell<double>)   
                                                   = cell (fun () -> _TimeGrid.Value.index(t.Value))
    let _Last                                      = cell (fun () -> _TimeGrid.Value.Last())
    let _mandatoryTimes                            = cell (fun () -> _TimeGrid.Value.mandatoryTimes())
    let _size                                      = cell (fun () -> _TimeGrid.Value.size())
    let _this                                      (i : ICell<int>)   
                                                   = cell (fun () -> _TimeGrid.Value.[i.Value])
    let _Times                                     = cell (fun () -> _TimeGrid.Value.Times())
