...
*)
    ...
    let _code                                      = cell (fun () -> _Currency.Value.code)
    let _empty                                     = cell (fun () -> _Currency.Value.empty())
    let _Equals                                    (o : ICell<Object>)   
                                                   = cell (fun () -> _Currency.Value.Equals(o.Value))
    let _format                                    = cell (fun () -> _Currency.Value.format)
    let _fractionsPerUnit                          = cell (fun () -> _Currency.Value.fractionsPerUnit)
    let _fractionSymbol                            = cell (fun () -> _Currency.Value.fractionSymbol)
    let _name                                      = cell (fun () -> _Currency.Value.name)
    let _numericCode                               = cell (fun () -> _Currency.Value.numericCode)
    let _rounding                                  = cell (fun () -> _Currency.Value.rounding)
    let _symbol                                    = cell (fun () -> _Currency.Value.symbol)
    let _ToString                                  = cell (fun () -> _Currency.Value.ToString())
    let _triangulationCurrency                     = cell (fun () -> _Currency.Value.triangulationCurrency)
