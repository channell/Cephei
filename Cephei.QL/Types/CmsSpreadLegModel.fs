...
*)
    let mutable
        _CmsSpreadLeg                              = make (fun () -> new CmsSpreadLeg (schedule.Value, swapSpreadIndex.Value))
    let _value                                     = triv _CmsSpreadLeg (fun () -> _CmsSpreadLeg.Value.value())
    let _inArrears                                 = triv _CmsSpreadLeg (fun () -> _CmsSpreadLeg.Value.inArrears())
    let _inArrears1                                (flag : ICell<bool>)   
                                                   = triv _CmsSpreadLeg (fun () -> _CmsSpreadLeg.Value.inArrears(flag.Value))
    let _withCaps                                  (caps : ICell<Generic.List<Nullable<double>>>)   
                                                   = triv _CmsSpreadLeg (fun () -> _CmsSpreadLeg.Value.withCaps(caps.Value))
    let _withCaps1                                 (cap : ICell<Nullable<double>>)   
                                                   = triv _CmsSpreadLeg (fun () -> _CmsSpreadLeg.Value.withCaps(cap.Value))
    let _withFixingDays                            (fixingDays : ICell<int>)   
                                                   = triv _CmsSpreadLeg (fun () -> _CmsSpreadLeg.Value.withFixingDays(fixingDays.Value))
    let _withFixingDays1                           (fixingDays : ICell<Generic.List<int>>)   
                                                   = triv _CmsSpreadLeg (fun () -> _CmsSpreadLeg.Value.withFixingDays(fixingDays.Value))
    let _withFloors                                (floor : ICell<Nullable<double>>)   
                                                   = triv _CmsSpreadLeg (fun () -> _CmsSpreadLeg.Value.withFloors(floor.Value))
    let _withFloors1                               (floors : ICell<Generic.List<Nullable<double>>>)   
                                                   = triv _CmsSpreadLeg (fun () -> _CmsSpreadLeg.Value.withFloors(floors.Value))
    let _withGearings                              (gearing : ICell<double>)   
                                                   = triv _CmsSpreadLeg (fun () -> _CmsSpreadLeg.Value.withGearings(gearing.Value))
    let _withGearings1                             (gearings : ICell<Generic.List<double>>)   
                                                   = triv _CmsSpreadLeg (fun () -> _CmsSpreadLeg.Value.withGearings(gearings.Value))
    let _withPaymentDayCounter                     (dayCounter : ICell<DayCounter>)   
                                                   = triv _CmsSpreadLeg (fun () -> _CmsSpreadLeg.Value.withPaymentDayCounter(dayCounter.Value))
    let _withSpreads                               (spread : ICell<double>)   
                                                   = triv _CmsSpreadLeg (fun () -> _CmsSpreadLeg.Value.withSpreads(spread.Value))
    let _withSpreads1                              (spreads : ICell<Generic.List<double>>)   
                                                   = triv _CmsSpreadLeg (fun () -> _CmsSpreadLeg.Value.withSpreads(spreads.Value))
    let _withZeroPayments                          = triv _CmsSpreadLeg (fun () -> _CmsSpreadLeg.Value.withZeroPayments())
    let _withZeroPayments1                         (flag : ICell<bool>)   
                                                   = triv _CmsSpreadLeg (fun () -> _CmsSpreadLeg.Value.withZeroPayments(flag.Value))
    let _withNotionals                             (notional : ICell<double>)   
                                                   = triv _CmsSpreadLeg (fun () -> _CmsSpreadLeg.Value.withNotionals(notional.Value))
    let _withNotionals1                            (notionals : ICell<Generic.List<double>>)   
                                                   = triv _CmsSpreadLeg (fun () -> _CmsSpreadLeg.Value.withNotionals(notionals.Value))
    let _withPaymentAdjustment                     (convention : ICell<BusinessDayConvention>)   
                                                   = triv _CmsSpreadLeg (fun () -> _CmsSpreadLeg.Value.withPaymentAdjustment(convention.Value))
