...
*)
    ...
    let _currentLink                               = cell (fun () -> _Handle.Value.currentLink())
    let _empty                                     = cell (fun () -> _Handle.Value.empty())
    let _Equals                                    (o : ICell<Object>)   
                                                   = cell (fun () -> _Handle.Value.Equals(o.Value))
    let _link                                      = cell (fun () -> _Handle.Value.link)
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _Handle.Value.registerWith(handler.Value)
                                                                     _Handle.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _Handle.Value.unregisterWith(handler.Value)
                                                                     _Handle.Value)
