...
*)
    ...
    let _include                                   (projectedParameters : ICell<Vector>)   
                                                   = cell (fun () -> _ProjectedCostFunction.Value.INCLUDE(projectedParameters.Value))
    let _project                                   (parameters : ICell<Vector>)   
                                                   = cell (fun () -> _ProjectedCostFunction.Value.project(parameters.Value))
    let _value                                     (freeParameters : ICell<Vector>)   
                                                   = cell (fun () -> _ProjectedCostFunction.Value.value(freeParameters.Value))
    let _values                                    (freeParameters : ICell<Vector>)   
                                                   = cell (fun () -> _ProjectedCostFunction.Value.values(freeParameters.Value))
    let _finiteDifferenceEpsilon                   = cell (fun () -> _ProjectedCostFunction.Value.finiteDifferenceEpsilon())
    let _gradient                                  (grad : ICell<Vector ref>) (x : ICell<Vector>)   
                                                   = cell (fun () -> _ProjectedCostFunction.Value.gradient(grad.Value, x.Value)
                                                                     _ProjectedCostFunction.Value)
    let _jacobian                                  (jac : ICell<Matrix>) (x : ICell<Vector>)   
                                                   = cell (fun () -> _ProjectedCostFunction.Value.jacobian(jac.Value, x.Value)
                                                                     _ProjectedCostFunction.Value)
    let _valueAndGradient                          (grad : ICell<Vector ref>) (x : ICell<Vector>)   
                                                   = cell (fun () -> _ProjectedCostFunction.Value.valueAndGradient(grad.Value, x.Value))
    let _valuesAndJacobian                         (jac : ICell<Matrix>) (x : ICell<Vector>)   
                                                   = cell (fun () -> _ProjectedCostFunction.Value.valuesAndJacobian(jac.Value, x.Value))
