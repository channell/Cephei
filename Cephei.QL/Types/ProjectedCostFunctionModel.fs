...
*)
    let mutable
        _ProjectedCostFunction                     = make (fun () -> new ProjectedCostFunction (costFunction.Value, parametersValues.Value, parametersFreedoms.Value))
    let _include                                   (projectedParameters : ICell<Vector>)   
                                                   = triv _ProjectedCostFunction (fun () -> _ProjectedCostFunction.Value.INCLUDE(projectedParameters.Value))
    let _project                                   (parameters : ICell<Vector>)   
                                                   = triv _ProjectedCostFunction (fun () -> _ProjectedCostFunction.Value.project(parameters.Value))
    let _value                                     (freeParameters : ICell<Vector>)   
                                                   = triv _ProjectedCostFunction (fun () -> _ProjectedCostFunction.Value.value(freeParameters.Value))
    let _values                                    (freeParameters : ICell<Vector>)   
                                                   = triv _ProjectedCostFunction (fun () -> _ProjectedCostFunction.Value.values(freeParameters.Value))
    let _finiteDifferenceEpsilon                   = triv _ProjectedCostFunction (fun () -> _ProjectedCostFunction.Value.finiteDifferenceEpsilon())
    let _gradient                                  (grad : ICell<Vector>) (x : ICell<Vector>)   
                                                   = triv _ProjectedCostFunction (fun () -> _ProjectedCostFunction.Value.gradient(ref grad.Value, x.Value)
                                                                                            _ProjectedCostFunction.Value)
    let _jacobian                                  (jac : ICell<Matrix>) (x : ICell<Vector>)   
                                                   = triv _ProjectedCostFunction (fun () -> _ProjectedCostFunction.Value.jacobian(jac.Value, x.Value)
                                                                                            _ProjectedCostFunction.Value)
    let _valueAndGradient                          (grad : ICell<Vector>) (x : ICell<Vector>)   
                                                   = triv _ProjectedCostFunction (fun () -> _ProjectedCostFunction.Value.valueAndGradient(ref grad.Value, x.Value))
    let _valuesAndJacobian                         (jac : ICell<Matrix>) (x : ICell<Vector>)   
                                                   = triv _ProjectedCostFunction (fun () -> _ProjectedCostFunction.Value.valuesAndJacobian(jac.Value, x.Value))
