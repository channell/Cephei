...
*)
    let mutable
        _TridiagonalOperator                       = make (fun () -> new TridiagonalOperator ())
    let _add                                       (A : ICell<IOperator>) (B : ICell<IOperator>)   
                                                   = triv _TridiagonalOperator (fun () -> _TridiagonalOperator.Value.add(A.Value, B.Value))
    let _applyTo                                   (v : ICell<Vector>)   
                                                   = triv _TridiagonalOperator (fun () -> _TridiagonalOperator.Value.applyTo(v.Value))
    let _Clone                                     = triv _TridiagonalOperator (fun () -> _TridiagonalOperator.Value.Clone())
    let _diagonal                                  = triv _TridiagonalOperator (fun () -> _TridiagonalOperator.Value.diagonal())
    let _identity                                  (size : ICell<int>)   
                                                   = triv _TridiagonalOperator (fun () -> _TridiagonalOperator.Value.identity(size.Value))
    let _isTimeDependent                           = triv _TridiagonalOperator (fun () -> _TridiagonalOperator.Value.isTimeDependent())
    let _lowerDiagonal                             = triv _TridiagonalOperator (fun () -> _TridiagonalOperator.Value.lowerDiagonal())
    let _multiply                                  (a : ICell<double>) (o : ICell<IOperator>)   
                                                   = triv _TridiagonalOperator (fun () -> _TridiagonalOperator.Value.multiply(a.Value, o.Value))
    let _setFirstRow                               (valB : ICell<double>) (valC : ICell<double>)   
                                                   = triv _TridiagonalOperator (fun () -> _TridiagonalOperator.Value.setFirstRow(valB.Value, valC.Value)
                                                                                          _TridiagonalOperator.Value)
    let _setLastRow                                (valA : ICell<double>) (valB : ICell<double>)   
                                                   = triv _TridiagonalOperator (fun () -> _TridiagonalOperator.Value.setLastRow(valA.Value, valB.Value)
                                                                                          _TridiagonalOperator.Value)
    let _setMidRow                                 (i : ICell<int>) (valA : ICell<double>) (valB : ICell<double>) (valC : ICell<double>)   
                                                   = triv _TridiagonalOperator (fun () -> _TridiagonalOperator.Value.setMidRow(i.Value, valA.Value, valB.Value, valC.Value)
                                                                                          _TridiagonalOperator.Value)
    let _setMidRows                                (valA : ICell<double>) (valB : ICell<double>) (valC : ICell<double>)   
                                                   = triv _TridiagonalOperator (fun () -> _TridiagonalOperator.Value.setMidRows(valA.Value, valB.Value, valC.Value)
                                                                                          _TridiagonalOperator.Value)
    let _setTime                                   (t : ICell<double>)   
                                                   = triv _TridiagonalOperator (fun () -> _TridiagonalOperator.Value.setTime(t.Value)
                                                                                          _TridiagonalOperator.Value)
    let _size                                      = triv _TridiagonalOperator (fun () -> _TridiagonalOperator.Value.size())
    let _solveFor                                  (rhs : ICell<Vector>)   
                                                   = triv _TridiagonalOperator (fun () -> _TridiagonalOperator.Value.solveFor(rhs.Value))
    let _SOR                                       (rhs : ICell<Vector>) (tol : ICell<double>)   
                                                   = triv _TridiagonalOperator (fun () -> _TridiagonalOperator.Value.SOR(rhs.Value, tol.Value))
    let _subtract                                  (A : ICell<IOperator>) (B : ICell<IOperator>)   
                                                   = triv _TridiagonalOperator (fun () -> _TridiagonalOperator.Value.subtract(A.Value, B.Value))
    let _upperDiagonal                             = triv _TridiagonalOperator (fun () -> _TridiagonalOperator.Value.upperDiagonal())
...
*)
    let mutable
        _TridiagonalOperator                       = make (fun () -> new TridiagonalOperator (low.Value, mid.Value, high.Value))
    let _add                                       (A : ICell<IOperator>) (B : ICell<IOperator>)   
                                                   = triv _TridiagonalOperator (fun () -> _TridiagonalOperator.Value.add(A.Value, B.Value))
    let _applyTo                                   (v : ICell<Vector>)   
                                                   = triv _TridiagonalOperator (fun () -> _TridiagonalOperator.Value.applyTo(v.Value))
...
*)
    let mutable
        _TridiagonalOperator                       = make (fun () -> new TridiagonalOperator (size.Value))
    let _add                                       (A : ICell<IOperator>) (B : ICell<IOperator>)   
                                                   = triv _TridiagonalOperator (fun () -> _TridiagonalOperator.Value.add(A.Value, B.Value))
    let _applyTo                                   (v : ICell<Vector>)   
                                                   = triv _TridiagonalOperator (fun () -> _TridiagonalOperator.Value.applyTo(v.Value))
