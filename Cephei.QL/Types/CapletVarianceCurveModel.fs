...
*)
    ...
    let _dayCounter                                = cell (fun () -> _CapletVarianceCurve.Value.dayCounter())
    let _maxDate                                   = cell (fun () -> _CapletVarianceCurve.Value.maxDate())
    let _maxStrike                                 = cell (fun () -> _CapletVarianceCurve.Value.maxStrike())
    let _minStrike                                 = cell (fun () -> _CapletVarianceCurve.Value.minStrike())
    let _blackVariance                             (optionTime : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _CapletVarianceCurve.Value.blackVariance(optionTime.Value, strike.Value, extrapolate.Value))
    let _blackVariance1                            (optionDate : ICell<Date>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _CapletVarianceCurve.Value.blackVariance(optionDate.Value, strike.Value, extrapolate.Value))
    let _blackVariance2                            (optionTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _CapletVarianceCurve.Value.blackVariance(optionTenor.Value, strike.Value, extrapolate.Value))
    let _displacement                              = cell (fun () -> _CapletVarianceCurve.Value.displacement())
    let _smileSection                              (optionTime : ICell<double>) (extr : ICell<bool>)   
                                                   = cell (fun () -> _CapletVarianceCurve.Value.smileSection(optionTime.Value, extr.Value))
    let _smileSection1                             (optionTenor : ICell<Period>) (extr : ICell<bool>)   
                                                   = cell (fun () -> _CapletVarianceCurve.Value.smileSection(optionTenor.Value, extr.Value))
    let _smileSection2                             (optionDate : ICell<Date>) (extr : ICell<bool>)   
                                                   = cell (fun () -> _CapletVarianceCurve.Value.smileSection(optionDate.Value, extr.Value))
    let _volatility                                (optionTenor : ICell<Period>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _CapletVarianceCurve.Value.volatility(optionTenor.Value, strike.Value, extrapolate.Value))
    let _volatility1                               (optionDate : ICell<Date>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _CapletVarianceCurve.Value.volatility(optionDate.Value, strike.Value, extrapolate.Value))
    let _volatility2                               (optionTime : ICell<double>) (strike : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _CapletVarianceCurve.Value.volatility(optionTime.Value, strike.Value, extrapolate.Value))
    let _volatilityType                            = cell (fun () -> _CapletVarianceCurve.Value.volatilityType())
    let _businessDayConvention                     = cell (fun () -> _CapletVarianceCurve.Value.businessDayConvention())
    let _optionDateFromTenor                       (p : ICell<Period>)   
                                                   = cell (fun () -> _CapletVarianceCurve.Value.optionDateFromTenor(p.Value))
    let _calendar                                  = cell (fun () -> _CapletVarianceCurve.Value.calendar())
    let _maxTime                                   = cell (fun () -> _CapletVarianceCurve.Value.maxTime())
    let _referenceDate                             = cell (fun () -> _CapletVarianceCurve.Value.referenceDate())
    let _settlementDays                            = cell (fun () -> _CapletVarianceCurve.Value.settlementDays())
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = cell (fun () -> _CapletVarianceCurve.Value.timeFromReference(date.Value))
    let _update                                    = cell (fun () -> _CapletVarianceCurve.Value.update()
                                                                     _CapletVarianceCurve.Value)
    let _allowsExtrapolation                       = cell (fun () -> _CapletVarianceCurve.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _CapletVarianceCurve.Value.disableExtrapolation(b.Value)
                                                                     _CapletVarianceCurve.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _CapletVarianceCurve.Value.enableExtrapolation(b.Value)
                                                                     _CapletVarianceCurve.Value)
    let _extrapolate                               = cell (fun () -> _CapletVarianceCurve.Value.extrapolate)
