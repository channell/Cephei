...
*)
    let mutable
        _FixedLocalVolSurface                      = make (fun () -> new FixedLocalVolSurface (referenceDate.Value, times.Value, strikes.Value, localVolMatrix.Value, dayCounter.Value, lowerExtrapolation.Value, upperExtrapolation.Value))
    let _maxDate                                   = triv _FixedLocalVolSurface (fun () -> _FixedLocalVolSurface.Value.maxDate())
    let _maxStrike                                 = triv _FixedLocalVolSurface (fun () -> _FixedLocalVolSurface.Value.maxStrike())
    let _maxTime                                   = triv _FixedLocalVolSurface (fun () -> _FixedLocalVolSurface.Value.maxTime())
    let _minStrike                                 = triv _FixedLocalVolSurface (fun () -> _FixedLocalVolSurface.Value.minStrike())
    let _setInterpolation                          (i : ICell<'Interpolator>)   
                                                   = triv _FixedLocalVolSurface (fun () -> _FixedLocalVolSurface.Value.setInterpolation(i.Value)
                                                                                           _FixedLocalVolSurface.Value)
    let _localVol                                  (t : ICell<double>) (underlyingLevel : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _FixedLocalVolSurface (fun () -> _FixedLocalVolSurface.Value.localVol(t.Value, underlyingLevel.Value, extrapolate.Value))
    let _localVol1                                 (d : ICell<Date>) (underlyingLevel : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = triv _FixedLocalVolSurface (fun () -> _FixedLocalVolSurface.Value.localVol(d.Value, underlyingLevel.Value, extrapolate.Value))
    let _businessDayConvention                     = triv _FixedLocalVolSurface (fun () -> _FixedLocalVolSurface.Value.businessDayConvention())
    let _optionDateFromTenor                       (p : ICell<Period>)   
                                                   = triv _FixedLocalVolSurface (fun () -> _FixedLocalVolSurface.Value.optionDateFromTenor(p.Value))
    let _calendar                                  = triv _FixedLocalVolSurface (fun () -> _FixedLocalVolSurface.Value.calendar())
    let _dayCounter                                = triv _FixedLocalVolSurface (fun () -> _FixedLocalVolSurface.Value.dayCounter())
    let _referenceDate                             = triv _FixedLocalVolSurface (fun () -> _FixedLocalVolSurface.Value.referenceDate())
    let _settlementDays                            = triv _FixedLocalVolSurface (fun () -> _FixedLocalVolSurface.Value.settlementDays())
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = triv _FixedLocalVolSurface (fun () -> _FixedLocalVolSurface.Value.timeFromReference(date.Value))
    let _update                                    = triv _FixedLocalVolSurface (fun () -> _FixedLocalVolSurface.Value.update()
                                                                                           _FixedLocalVolSurface.Value)
    let _allowsExtrapolation                       = triv _FixedLocalVolSurface (fun () -> _FixedLocalVolSurface.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv _FixedLocalVolSurface (fun () -> _FixedLocalVolSurface.Value.disableExtrapolation(b.Value)
                                                                                           _FixedLocalVolSurface.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv _FixedLocalVolSurface (fun () -> _FixedLocalVolSurface.Value.enableExtrapolation(b.Value)
                                                                                           _FixedLocalVolSurface.Value)
    let _extrapolate                               = triv _FixedLocalVolSurface (fun () -> _FixedLocalVolSurface.Value.extrapolate)
...
*)
    let mutable
        _FixedLocalVolSurface                      = make (fun () -> new FixedLocalVolSurface (referenceDate.Value, dates.Value, strikes.Value, localVolMatrix.Value, dayCounter.Value, lowerExtrapolation.Value, upperExtrapolation.Value))
    let _maxDate                                   = triv _FixedLocalVolSurface (fun () -> _FixedLocalVolSurface.Value.maxDate())
    let _maxStrike                                 = triv _FixedLocalVolSurface (fun () -> _FixedLocalVolSurface.Value.maxStrike())
    let _maxTime                                   = triv _FixedLocalVolSurface (fun () -> _FixedLocalVolSurface.Value.maxTime())
    let _minStrike                                 = triv _FixedLocalVolSurface (fun () -> _FixedLocalVolSurface.Value.minStrike())
