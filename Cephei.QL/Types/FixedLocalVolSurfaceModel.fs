...
*)
    ...
    let _maxDate                                   = cell (fun () -> _FixedLocalVolSurface.Value.maxDate())
    let _maxStrike                                 = cell (fun () -> _FixedLocalVolSurface.Value.maxStrike())
    let _maxTime                                   = cell (fun () -> _FixedLocalVolSurface.Value.maxTime())
    let _minStrike                                 = cell (fun () -> _FixedLocalVolSurface.Value.minStrike())
    let _setInterpolation                          (i : ICell<'Interpolator>)   
                                                   = cell (fun () -> _FixedLocalVolSurface.Value.setInterpolation(i.Value)
                                                                     _FixedLocalVolSurface.Value)
    let _localVol                                  (t : ICell<double>) (underlyingLevel : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _FixedLocalVolSurface.Value.localVol(t.Value, underlyingLevel.Value, extrapolate.Value))
    let _localVol1                                 (d : ICell<Date>) (underlyingLevel : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _FixedLocalVolSurface.Value.localVol(d.Value, underlyingLevel.Value, extrapolate.Value))
    let _businessDayConvention                     = cell (fun () -> _FixedLocalVolSurface.Value.businessDayConvention())
    let _optionDateFromTenor                       (p : ICell<Period>)   
                                                   = cell (fun () -> _FixedLocalVolSurface.Value.optionDateFromTenor(p.Value))
    let _calendar                                  = cell (fun () -> _FixedLocalVolSurface.Value.calendar())
    let _dayCounter                                = cell (fun () -> _FixedLocalVolSurface.Value.dayCounter())
    let _referenceDate                             = cell (fun () -> _FixedLocalVolSurface.Value.referenceDate())
    let _settlementDays                            = cell (fun () -> _FixedLocalVolSurface.Value.settlementDays())
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = cell (fun () -> _FixedLocalVolSurface.Value.timeFromReference(date.Value))
    let _update                                    = cell (fun () -> _FixedLocalVolSurface.Value.update()
                                                                     _FixedLocalVolSurface.Value)
    let _allowsExtrapolation                       = cell (fun () -> _FixedLocalVolSurface.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _FixedLocalVolSurface.Value.disableExtrapolation(b.Value)
                                                                     _FixedLocalVolSurface.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _FixedLocalVolSurface.Value.enableExtrapolation(b.Value)
                                                                     _FixedLocalVolSurface.Value)
    let _extrapolate                               = cell (fun () -> _FixedLocalVolSurface.Value.extrapolate)
