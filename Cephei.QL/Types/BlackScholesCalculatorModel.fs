...
*)
    ...
    let _delta                                     = cell (fun () -> _BlackScholesCalculator.Value.delta())
    let _elasticity                                = cell (fun () -> _BlackScholesCalculator.Value.elasticity())
    let _gamma                                     = cell (fun () -> _BlackScholesCalculator.Value.gamma())
    let _theta                                     (maturity : ICell<double>)   
                                                   = cell (fun () -> _BlackScholesCalculator.Value.theta(maturity.Value))
    let _thetaPerDay                               (maturity : ICell<double>)   
                                                   = cell (fun () -> _BlackScholesCalculator.Value.thetaPerDay(maturity.Value))
    let _alpha                                     = cell (fun () -> _BlackScholesCalculator.Value.alpha())
    let _beta                                      = cell (fun () -> _BlackScholesCalculator.Value.beta())
    let _deltaForward                              = cell (fun () -> _BlackScholesCalculator.Value.deltaForward())
    let _dividendRho                               (maturity : ICell<double>)   
                                                   = cell (fun () -> _BlackScholesCalculator.Value.dividendRho(maturity.Value))
    let _elasticityForward                         = cell (fun () -> _BlackScholesCalculator.Value.elasticityForward())
    let _gammaForward                              = cell (fun () -> _BlackScholesCalculator.Value.gammaForward())
    let _itmAssetProbability                       = cell (fun () -> _BlackScholesCalculator.Value.itmAssetProbability())
    let _itmCashProbability                        = cell (fun () -> _BlackScholesCalculator.Value.itmCashProbability())
    let _rho                                       (maturity : ICell<double>)   
                                                   = cell (fun () -> _BlackScholesCalculator.Value.rho(maturity.Value))
    let _strikeSensitivity                         = cell (fun () -> _BlackScholesCalculator.Value.strikeSensitivity())
    let _value                                     = cell (fun () -> _BlackScholesCalculator.Value.value())
    let _vega                                      (maturity : ICell<double>)   
                                                   = cell (fun () -> _BlackScholesCalculator.Value.vega(maturity.Value))
