...
*)
    ...
    let _atmLevel                                  = cell (fun () -> _FlatSmileSection.Value.atmLevel())
    let _maxStrike                                 = cell (fun () -> _FlatSmileSection.Value.maxStrike())
    let _minStrike                                 = cell (fun () -> _FlatSmileSection.Value.minStrike())
    let _dayCounter                                = cell (fun () -> _FlatSmileSection.Value.dayCounter())
    let _density                                   (strike : ICell<double>) (discount : ICell<double>) (gap : ICell<double>)   
                                                   = cell (fun () -> _FlatSmileSection.Value.density(strike.Value, discount.Value, gap.Value))
    let _digitalOptionPrice                        (strike : ICell<double>) (Type : ICell<Option.Type>) (discount : ICell<double>) (gap : ICell<double>)   
                                                   = cell (fun () -> _FlatSmileSection.Value.digitalOptionPrice(strike.Value, Type.Value, discount.Value, gap.Value))
    let _exerciseDate                              = cell (fun () -> _FlatSmileSection.Value.exerciseDate())
    let _exerciseTime                              = cell (fun () -> _FlatSmileSection.Value.exerciseTime())
    let _optionPrice                               (strike : ICell<double>) (Type : ICell<Option.Type>) (discount : ICell<double>)   
                                                   = cell (fun () -> _FlatSmileSection.Value.optionPrice(strike.Value, Type.Value, discount.Value))
    let _referenceDate                             = cell (fun () -> _FlatSmileSection.Value.referenceDate())
    let _shift                                     = cell (fun () -> _FlatSmileSection.Value.shift())
    let _update                                    = cell (fun () -> _FlatSmileSection.Value.update()
                                                                     _FlatSmileSection.Value)
    let _variance                                  (strike : ICell<double>)   
                                                   = cell (fun () -> _FlatSmileSection.Value.variance(strike.Value))
    let _vega                                      (strike : ICell<double>) (discount : ICell<double>)   
                                                   = cell (fun () -> _FlatSmileSection.Value.vega(strike.Value, discount.Value))
    let _volatility                                (strike : ICell<double>) (volatilityType : ICell<VolatilityType>) (shift : ICell<double>)   
                                                   = cell (fun () -> _FlatSmileSection.Value.volatility(strike.Value, volatilityType.Value, shift.Value))
    let _volatility1                               (strike : ICell<double>)   
                                                   = cell (fun () -> _FlatSmileSection.Value.volatility(strike.Value))
    let _volatilityType                            = cell (fun () -> _FlatSmileSection.Value.volatilityType())
