...
*)
    ...
    let _a                                         = cell (fun () -> _HullWhiteProcess.Value.a())
    let _alpha                                     (t : ICell<double>)   
                                                   = cell (fun () -> _HullWhiteProcess.Value.alpha(t.Value))
    let _diffusion                                 (t : ICell<double>) (x : ICell<double>)   
                                                   = cell (fun () -> _HullWhiteProcess.Value.diffusion(t.Value, x.Value))
    let _drift                                     (t : ICell<double>) (x : ICell<double>)   
                                                   = cell (fun () -> _HullWhiteProcess.Value.drift(t.Value, x.Value))
    let _expectation                               (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = cell (fun () -> _HullWhiteProcess.Value.expectation(t0.Value, x0.Value, dt.Value))
    let _sigma                                     = cell (fun () -> _HullWhiteProcess.Value.sigma())
    let _stdDeviation                              (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = cell (fun () -> _HullWhiteProcess.Value.stdDeviation(t0.Value, x0.Value, dt.Value))
    let _variance                                  (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>)   
                                                   = cell (fun () -> _HullWhiteProcess.Value.variance(t0.Value, x0.Value, dt.Value))
    let _x0                                        = cell (fun () -> _HullWhiteProcess.Value.x0())
    let _apply                                     (x0 : ICell<double>) (dx : ICell<double>)   
                                                   = cell (fun () -> _HullWhiteProcess.Value.apply(x0.Value, dx.Value))
    let _apply1                                    (x0 : ICell<Vector>) (dx : ICell<Vector>)   
                                                   = cell (fun () -> _HullWhiteProcess.Value.apply(x0.Value, dx.Value))
    let _evolve                                    (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>) (dw : ICell<Vector>)   
                                                   = cell (fun () -> _HullWhiteProcess.Value.evolve(t0.Value, x0.Value, dt.Value, dw.Value))
    let _evolve1                                   (t0 : ICell<double>) (x0 : ICell<double>) (dt : ICell<double>) (dw : ICell<double>)   
                                                   = cell (fun () -> _HullWhiteProcess.Value.evolve(t0.Value, x0.Value, dt.Value, dw.Value))
    let _initialValues                             = cell (fun () -> _HullWhiteProcess.Value.initialValues())
    let _size                                      = cell (fun () -> _HullWhiteProcess.Value.size())
    let _covariance                                (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>)   
                                                   = cell (fun () -> _HullWhiteProcess.Value.covariance(t0.Value, x0.Value, dt.Value))
    let _factors                                   = cell (fun () -> _HullWhiteProcess.Value.factors())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _HullWhiteProcess.Value.registerWith(handler.Value)
                                                                     _HullWhiteProcess.Value)
    let _time                                      (d : ICell<Date>)   
                                                   = cell (fun () -> _HullWhiteProcess.Value.time(d.Value))
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _HullWhiteProcess.Value.unregisterWith(handler.Value)
                                                                     _HullWhiteProcess.Value)
    let _update                                    = cell (fun () -> _HullWhiteProcess.Value.update()
                                                                     _HullWhiteProcess.Value)
