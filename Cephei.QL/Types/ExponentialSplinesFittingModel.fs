...
*)
    ...
    let _clone                                     = cell (fun () -> _ExponentialSplinesFitting.Value.clone())
    let _size                                      = cell (fun () -> _ExponentialSplinesFitting.Value.size())
    let _constrainAtZero                           = cell (fun () -> _ExponentialSplinesFitting.Value.constrainAtZero())
    let _discount                                  (x : ICell<Vector>) (t : ICell<double>)   
                                                   = cell (fun () -> _ExponentialSplinesFitting.Value.discount(x.Value, t.Value))
    let _minimumCostValue                          = cell (fun () -> _ExponentialSplinesFitting.Value.minimumCostValue())
    let _numberOfIterations                        = cell (fun () -> _ExponentialSplinesFitting.Value.numberOfIterations())
    let _optimizationMethod                        = cell (fun () -> _ExponentialSplinesFitting.Value.optimizationMethod())
    let _solution                                  = cell (fun () -> _ExponentialSplinesFitting.Value.solution())
    let _weights                                   = cell (fun () -> _ExponentialSplinesFitting.Value.weights())
