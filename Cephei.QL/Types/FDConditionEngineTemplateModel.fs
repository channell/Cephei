...
*)
    let mutable
        _FDConditionEngineTemplate                 = make (fun () -> new FDConditionEngineTemplate ())
    let _setStepCondition                          (impl : ICell<Func<IStepCondition<Vector>>>)   
                                                   = triv _FDConditionEngineTemplate (fun () -> _FDConditionEngineTemplate.Value.setStepCondition(impl.Value)
                                                                                                _FDConditionEngineTemplate.Value)
    let _calculate                                 (r : ICell<IPricingEngineResults>)   
                                                   = triv _FDConditionEngineTemplate (fun () -> _FDConditionEngineTemplate.Value.calculate(r.Value)
                                                                                                _FDConditionEngineTemplate.Value)
    let _ensureStrikeInGrid                        = triv _FDConditionEngineTemplate (fun () -> _FDConditionEngineTemplate.Value.ensureStrikeInGrid()
                                                                                                _FDConditionEngineTemplate.Value)
    let _factory                                   (Process : ICell<GeneralizedBlackScholesProcess>) (timeSteps : ICell<int>) (gridPoints : ICell<int>) (timeDependent : ICell<bool>)   
                                                   = triv _FDConditionEngineTemplate (fun () -> _FDConditionEngineTemplate.Value.factory(Process.Value, timeSteps.Value, gridPoints.Value, timeDependent.Value))
    let _getResidualTime                           = triv _FDConditionEngineTemplate (fun () -> _FDConditionEngineTemplate.Value.getResidualTime())
    let _grid                                      = triv _FDConditionEngineTemplate (fun () -> _FDConditionEngineTemplate.Value.grid())
    let _intrinsicValues_                          = triv _FDConditionEngineTemplate (fun () -> _FDConditionEngineTemplate.Value.intrinsicValues_)
...
*)
    let mutable
        _FDConditionEngineTemplate                 = make (fun () -> new FDConditionEngineTemplate (Process.Value, timeSteps.Value, gridPoints.Value, timeDependent.Value))
    let _setStepCondition                          (impl : ICell<Func<IStepCondition<Vector>>>)   
                                                   = triv _FDConditionEngineTemplate (fun () -> _FDConditionEngineTemplate.Value.setStepCondition(impl.Value)
                                                                                                _FDConditionEngineTemplate.Value)
    let _calculate                                 (r : ICell<IPricingEngineResults>)   
