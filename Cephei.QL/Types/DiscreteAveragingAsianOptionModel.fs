...
(*
    Functions
*)
    let _DiscreteAveragingAsianOption              = triv (fun () -> withEngine _pricingEngine.Value (new DiscreteAveragingAsianOption (averageType.Value, runningAccumulator.Value, pastFixings.Value, fixingDates.Value, payoff.Value, exercise.Value)))
