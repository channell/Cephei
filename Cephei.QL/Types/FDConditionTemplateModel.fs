...
*)
    let mutable
        _FDConditionTemplate                       = make (fun () -> new FDConditionTemplate<'baseEngine> ())
    let _calculate                                 (r : ICell<IPricingEngineResults>)   
                                                   = triv _FDConditionTemplate (fun () -> _FDConditionTemplate.Value.calculate(r.Value)
                                                                                          _FDConditionTemplate.Value)
    let _setStepCondition                          (impl : ICell<Func<IStepCondition<Vector>>>)   
                                                   = triv _FDConditionTemplate (fun () -> _FDConditionTemplate.Value.setStepCondition(impl.Value)
                                                                                          _FDConditionTemplate.Value)
    let _ensureStrikeInGrid                        = triv _FDConditionTemplate (fun () -> _FDConditionTemplate.Value.ensureStrikeInGrid()
                                                                                          _FDConditionTemplate.Value)
    let _factory                                   (Process : ICell<GeneralizedBlackScholesProcess>) (timeSteps : ICell<int>) (gridPoints : ICell<int>) (timeDependent : ICell<bool>)   
                                                   = triv _FDConditionTemplate (fun () -> _FDConditionTemplate.Value.factory(Process.Value, timeSteps.Value, gridPoints.Value, timeDependent.Value))
    let _getResidualTime                           = triv _FDConditionTemplate (fun () -> _FDConditionTemplate.Value.getResidualTime())
    let _grid                                      = triv _FDConditionTemplate (fun () -> _FDConditionTemplate.Value.grid())
    let _intrinsicValues_                          = triv _FDConditionTemplate (fun () -> _FDConditionTemplate.Value.intrinsicValues_)
...
*)
    let mutable
        _FDConditionTemplate                       = make (fun () -> new FDConditionTemplate<'baseEngine> (Process.Value, timeSteps.Value, gridPoints.Value, timeDependent.Value))
    let _calculate                                 (r : ICell<IPricingEngineResults>)   
                                                   = triv _FDConditionTemplate (fun () -> _FDConditionTemplate.Value.calculate(r.Value)
                                                                                          _FDConditionTemplate.Value)
    let _setStepCondition                          (impl : ICell<Func<IStepCondition<Vector>>>)   
