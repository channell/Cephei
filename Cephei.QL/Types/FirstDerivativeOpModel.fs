...
*)
    let mutable
        _FirstDerivativeOp                         = make (fun () -> new FirstDerivativeOp (rhs.Value))
    let _add                                       (m : ICell<TripleBandLinearOp>)   
                                                   = triv _FirstDerivativeOp (fun () -> _FirstDerivativeOp.Value.add(m.Value))
    let _add1                                      (u : ICell<Vector>)   
                                                   = triv _FirstDerivativeOp (fun () -> _FirstDerivativeOp.Value.add(u.Value))
    let _add2                                      (A : ICell<IOperator>) (B : ICell<IOperator>)   
                                                   = triv _FirstDerivativeOp (fun () -> _FirstDerivativeOp.Value.add(A.Value, B.Value))
    let _apply                                     (r : ICell<Vector>)   
                                                   = triv _FirstDerivativeOp (fun () -> _FirstDerivativeOp.Value.apply(r.Value))
    let _applyTo                                   (v : ICell<Vector>)   
                                                   = triv _FirstDerivativeOp (fun () -> _FirstDerivativeOp.Value.applyTo(v.Value))
    let _axpyb                                     (a : ICell<Vector>) (x : ICell<TripleBandLinearOp>) (y : ICell<TripleBandLinearOp>) (b : ICell<Vector>)   
                                                   = triv _FirstDerivativeOp (fun () -> _FirstDerivativeOp.Value.axpyb(a.Value, x.Value, y.Value, b.Value)
                                                                                        _FirstDerivativeOp.Value)
    let _Clone                                     = triv _FirstDerivativeOp (fun () -> _FirstDerivativeOp.Value.Clone())
    let _identity                                  (size : ICell<int>)   
                                                   = triv _FirstDerivativeOp (fun () -> _FirstDerivativeOp.Value.identity(size.Value))
    let _isTimeDependent                           = triv _FirstDerivativeOp (fun () -> _FirstDerivativeOp.Value.isTimeDependent())
    let _mult                                      (u : ICell<Vector>)   
                                                   = triv _FirstDerivativeOp (fun () -> _FirstDerivativeOp.Value.mult(u.Value))
    let _multiply                                  (a : ICell<double>) (D : ICell<IOperator>)   
                                                   = triv _FirstDerivativeOp (fun () -> _FirstDerivativeOp.Value.multiply(a.Value, D.Value))
    let _multR                                     (u : ICell<Vector>)   
                                                   = triv _FirstDerivativeOp (fun () -> _FirstDerivativeOp.Value.multR(u.Value))
    let _setTime                                   (t : ICell<double>)   
                                                   = triv _FirstDerivativeOp (fun () -> _FirstDerivativeOp.Value.setTime(t.Value)
                                                                                        _FirstDerivativeOp.Value)
    let _size                                      = triv _FirstDerivativeOp (fun () -> _FirstDerivativeOp.Value.size())
    let _solve_splitting                           (r : ICell<Vector>) (a : ICell<double>) (b : ICell<double>)   
                                                   = triv _FirstDerivativeOp (fun () -> _FirstDerivativeOp.Value.solve_splitting(r.Value, a.Value, b.Value))
    let _solveFor                                  (rhs : ICell<Vector>)   
                                                   = triv _FirstDerivativeOp (fun () -> _FirstDerivativeOp.Value.solveFor(rhs.Value))
    let _subtract                                  (A : ICell<IOperator>) (B : ICell<IOperator>)   
                                                   = triv _FirstDerivativeOp (fun () -> _FirstDerivativeOp.Value.subtract(A.Value, B.Value))
    let _swap                                      (m : ICell<TripleBandLinearOp>)   
                                                   = triv _FirstDerivativeOp (fun () -> _FirstDerivativeOp.Value.swap(m.Value)
                                                                                        _FirstDerivativeOp.Value)
    let _toMatrix                                  = triv _FirstDerivativeOp (fun () -> _FirstDerivativeOp.Value.toMatrix())
...
*)
    let mutable
        _FirstDerivativeOp                         = make (fun () -> new FirstDerivativeOp (direction.Value, mesher.Value))
    let _add                                       (m : ICell<TripleBandLinearOp>)   
                                                   = triv _FirstDerivativeOp (fun () -> _FirstDerivativeOp.Value.add(m.Value))
    let _add1                                      (u : ICell<Vector>)   
                                                   = triv _FirstDerivativeOp (fun () -> _FirstDerivativeOp.Value.add(u.Value))
