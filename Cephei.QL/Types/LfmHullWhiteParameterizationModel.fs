...
*)
    ...
    let _covariance1                               (t : ICell<double>)   
                                                   = triv (fun () -> _LfmHullWhiteParameterization.Value.covariance(t.Value))
    let _diffusion                                 (t : ICell<double>)   
                                                   = triv (fun () -> _LfmHullWhiteParameterization.Value.diffusion(t.Value))
    let _diffusion1                                (t : ICell<double>) (x : ICell<Vector>)   
                                                   = triv (fun () -> _LfmHullWhiteParameterization.Value.diffusion(t.Value, x.Value))
    let _integratedCovariance                      (t : ICell<double>) (x : ICell<Vector>)   
                                                   = triv (fun () -> _LfmHullWhiteParameterization.Value.integratedCovariance(t.Value, x.Value))
