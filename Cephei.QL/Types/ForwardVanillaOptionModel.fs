...
*)
    let mutable
        _ForwardVanillaOption                      = cell (fun () -> withEngine pricingEngine evaluationDate (new ForwardVanillaOption (moneyness.Value, resetDate.Value, payoff.Value, exercise.Value)))
    ...
    let _elasticity                                = triv (fun () -> (withEvaluationDate _evaluationDate _ForwardVanillaOption).elasticity())
    let _gamma                                     = triv (fun () -> (withEvaluationDate _evaluationDate _ForwardVanillaOption).gamma())
    let _isExpired                                 = triv (fun () -> (withEvaluationDate _evaluationDate _ForwardVanillaOption).isExpired())
    let _itmCashProbability                        = triv (fun () -> (withEvaluationDate _evaluationDate _ForwardVanillaOption).itmCashProbability())
    let _rho                                       = triv (fun () -> (withEvaluationDate _evaluationDate _ForwardVanillaOption).rho())
    let _strikeSensitivity                         = triv (fun () -> (withEvaluationDate _evaluationDate _ForwardVanillaOption).strikeSensitivity())
    let _theta                                     = triv (fun () -> (withEvaluationDate _evaluationDate _ForwardVanillaOption).theta())
    let _thetaPerDay                               = triv (fun () -> (withEvaluationDate _evaluationDate _ForwardVanillaOption).thetaPerDay())
    let _vega                                      = triv (fun () -> (withEvaluationDate _evaluationDate _ForwardVanillaOption).vega())
    ...
    let _errorEstimate                             = triv (fun () -> (withEvaluationDate _evaluationDate _ForwardVanillaOption).errorEstimate())
    let _NPV                                       = cell (fun () -> (withEvaluationDate _evaluationDate _ForwardVanillaOption).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _ForwardVanillaOption).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _ForwardVanillaOption).setPricingEngine(e.Value)
