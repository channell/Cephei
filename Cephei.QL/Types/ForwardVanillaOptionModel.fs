...
(*
    Functions
*)
    let _ForwardVanillaOption                      = triv (fun () -> withEngine _pricingEngine.Value (new ForwardVanillaOption (moneyness.Value, resetDate.Value, payoff.Value, exercise.Value)))
