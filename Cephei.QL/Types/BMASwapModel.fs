...
*)
    let mutable
        _BMASwap                                   = cell (fun () -> withEngine pricingEngine evaluationDate (new BMASwap (Type.Value, nominal.Value, liborSchedule.Value, liborFraction.Value, liborSpread.Value, liborIndex.Value, liborDayCount.Value, bmaSchedule.Value, bmaIndex.Value, bmaDayCount.Value)))
