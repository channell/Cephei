...
(*
    Functions
*)
    let _BMASwap                                   = cell (fun () -> withEngine evaluationDate pricingEngine (new BMASwap (Type.Value, nominal.Value, liborSchedule.Value, liborFraction.Value, liborSpread.Value, liborIndex.Value, liborDayCount.Value, bmaSchedule.Value, bmaIndex.Value, bmaDayCount.Value)))
