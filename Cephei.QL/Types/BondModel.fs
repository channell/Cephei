...
(*
    Functions
*)
    let _Bond                                      = triv (fun () -> withEngine _pricingEngine.Value (new Bond (settlementDays.Value, calendar.Value, faceAmount.Value, maturityDate.Value, issueDate.Value, cashflows.Value)))
...
(*
    Functions
*)
    let _Bond                                      = triv (fun () -> withEngine _pricingEngine.Value (new Bond (settlementDays.Value, calendar.Value, issueDate.Value, coupons.Value)))
    let _accruedAmount                             (settlement : ICell<Date>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _Bond).accruedAmount(settlement.Value))
    let _calendar                                  = triv (fun () -> (withEvaluationDate _evaluationDate _Bond).calendar())
    let _cashflows                                 = triv (fun () -> (withEvaluationDate _evaluationDate _Bond).cashflows())
