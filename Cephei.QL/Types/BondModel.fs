...
*)
    let mutable
        _Bond                                      = make (fun () -> withEngine pricingEngine evaluationDate (new Bond (settlementDays.Value, calendar.Value, faceAmount.Value, maturityDate.Value, issueDate.Value, cashflows.Value)))
    let _accruedAmount                             (settlement : ICell<Date>)   
                                                   = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).accruedAmount(settlement.Value))
    let _calendar                                  = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).calendar())
    let _cashflows                                 = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).cashflows())
    let _cleanPrice                                = cell _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).cleanPrice())
    let _cleanPrice1                               (Yield : ICell<double>) (dc : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (settlement : ICell<Date>)   
                                                   = cell _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).cleanPrice(Yield.Value, dc.Value, comp.Value, freq.Value, settlement.Value))
    let _dirtyPrice                                = cell _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).dirtyPrice())
    let _dirtyPrice1                               (Yield : ICell<double>) (dc : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (settlement : ICell<Date>)   
                                                   = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).dirtyPrice(Yield.Value, dc.Value, comp.Value, freq.Value, settlement.Value))
    let _isExpired                                 = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).isExpired())
    let _issueDate                                 = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).issueDate())
    let _isTradable                                (d : ICell<Date>)   
                                                   = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).isTradable(d.Value))
    let _maturityDate                              = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).maturityDate())
    let _nextCashFlowDate                          (settlement : ICell<Date>)   
                                                   = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).nextCashFlowDate(settlement.Value))
    let _nextCouponRate                            (settlement : ICell<Date>)   
                                                   = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).nextCouponRate(settlement.Value))
    let _notional                                  (d : ICell<Date>)   
                                                   = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).notional(d.Value))
    let _notionals                                 = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).notionals())
    let _previousCashFlowDate                      (settlement : ICell<Date>)   
                                                   = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).previousCashFlowDate(settlement.Value))
    let _previousCouponRate                        (settlement : ICell<Date>)   
                                                   = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).previousCouponRate(settlement.Value))
    let _redemption                                = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).redemption())
    let _redemptions                               = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).redemptions())
    let _settlementDate                            (date : ICell<Date>)   
                                                   = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).settlementDate(date.Value))
    let _settlementDays                            = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).settlementDays())
    let _settlementValue                           (cleanPrice : ICell<double>)   
                                                   = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).settlementValue(cleanPrice.Value))
    let _settlementValue1                          = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).settlementValue())
    let _startDate                                 = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).startDate())
    let _yield                                     (dc : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (accuracy : ICell<double>) (maxEvaluations : ICell<int>)   
                                                   = cell _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).YIELD(dc.Value, comp.Value, freq.Value, accuracy.Value, maxEvaluations.Value))
    let _yield1                                    (cleanPrice : ICell<double>) (dc : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (settlement : ICell<Date>) (accuracy : ICell<double>) (maxEvaluations : ICell<int>)   
                                                   = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).YIELD(cleanPrice.Value, dc.Value, comp.Value, freq.Value, settlement.Value, accuracy.Value, maxEvaluations.Value))
    let _CASH                                      = cell _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).CASH())
    let _errorEstimate                             = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).errorEstimate())
    let _NPV                                       = cell _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).setPricingEngine(e.Value)
                                                                           _Bond.Value)
    let _valuationDate                             = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).valuationDate())
    do this.Bind(_Bond)
(* 
    casting 
*)
...
*)
    let mutable
        _Bond                                      = make (fun () -> withEngine pricingEngine evaluationDate (new Bond (settlementDays.Value, calendar.Value, issueDate.Value, coupons.Value)))
    let _accruedAmount                             (settlement : ICell<Date>)   
                                                   = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).accruedAmount(settlement.Value))
    let _calendar                                  = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).calendar())
    let _cashflows                                 = triv _Bond (fun () -> (withEvaluationDate _evaluationDate _Bond).cashflows())
