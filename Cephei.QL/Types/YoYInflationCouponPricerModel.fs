...
(*
    Functions
*)
    let _YoYInflationCouponPricer                  = cell (fun () -> new YoYInflationCouponPricer (capletVol.Value))
    let _capletPrice                               (effectiveCap : ICell<double>)   
                                                   = cell (fun () -> _YoYInflationCouponPricer.Value.capletPrice(effectiveCap.Value))
    let _capletRate                                (effectiveCap : ICell<double>)   
                                                   = cell (fun () -> _YoYInflationCouponPricer.Value.capletRate(effectiveCap.Value))
    let _capletVolatility                          = cell (fun () -> _YoYInflationCouponPricer.Value.capletVolatility())
    let _floorletPrice                             (effectiveFloor : ICell<double>)   
                                                   = cell (fun () -> _YoYInflationCouponPricer.Value.floorletPrice(effectiveFloor.Value))
    let _floorletRate                              (effectiveFloor : ICell<double>)   
                                                   = cell (fun () -> _YoYInflationCouponPricer.Value.floorletRate(effectiveFloor.Value))
    let _initialize                                (coupon : ICell<InflationCoupon>)   
                                                   = cell (fun () -> _YoYInflationCouponPricer.Value.initialize(coupon.Value)
                                                                     _YoYInflationCouponPricer.Value)
    let _setCapletVolatility                       (capletVol : ICell<Handle<YoYOptionletVolatilitySurface>>)   
                                                   = cell (fun () -> _YoYInflationCouponPricer.Value.setCapletVolatility(capletVol.Value)
                                                                     _YoYInflationCouponPricer.Value)
    let _swapletPrice                              = cell (fun () -> _YoYInflationCouponPricer.Value.swapletPrice())
    let _swapletRate                               = cell (fun () -> _YoYInflationCouponPricer.Value.swapletRate())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _YoYInflationCouponPricer.Value.registerWith(handler.Value)
                                                                     _YoYInflationCouponPricer.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _YoYInflationCouponPricer.Value.unregisterWith(handler.Value)
                                                                     _YoYInflationCouponPricer.Value)
    let _update                                    = cell (fun () -> _YoYInflationCouponPricer.Value.update()
                                                                     _YoYInflationCouponPricer.Value)
