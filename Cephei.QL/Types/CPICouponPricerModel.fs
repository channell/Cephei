...
*)
    ...
    let _capletPrice                               (effectiveCap : ICell<double>)   
                                                   = cell (fun () -> _CPICouponPricer.Value.capletPrice(effectiveCap.Value))
    let _capletRate                                (effectiveCap : ICell<double>)   
                                                   = cell (fun () -> _CPICouponPricer.Value.capletRate(effectiveCap.Value))
    let _capletVolatility                          = cell (fun () -> _CPICouponPricer.Value.capletVolatility())
    let _floorletPrice                             (effectiveFloor : ICell<double>)   
                                                   = cell (fun () -> _CPICouponPricer.Value.floorletPrice(effectiveFloor.Value))
    let _floorletRate                              (effectiveFloor : ICell<double>)   
                                                   = cell (fun () -> _CPICouponPricer.Value.floorletRate(effectiveFloor.Value))
    let _initialize                                (coupon : ICell<InflationCoupon>)   
                                                   = cell (fun () -> _CPICouponPricer.Value.initialize(coupon.Value)
                                                                     _CPICouponPricer.Value)
    let _setCapletVolatility                       (capletVol : ICell<Handle<CPIVolatilitySurface>>)   
                                                   = cell (fun () -> _CPICouponPricer.Value.setCapletVolatility(capletVol.Value)
                                                                     _CPICouponPricer.Value)
    let _swapletPrice                              = cell (fun () -> _CPICouponPricer.Value.swapletPrice())
    let _swapletRate                               = cell (fun () -> _CPICouponPricer.Value.swapletRate())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _CPICouponPricer.Value.registerWith(handler.Value)
                                                                     _CPICouponPricer.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _CPICouponPricer.Value.unregisterWith(handler.Value)
                                                                     _CPICouponPricer.Value)
    let _update                                    = cell (fun () -> _CPICouponPricer.Value.update()
                                                                     _CPICouponPricer.Value)
