...
*)
    ...
    let _atmLevel                                  = cell (fun () -> _SabrSmileSection.Value.atmLevel())
    let _maxStrike                                 = cell (fun () -> _SabrSmileSection.Value.maxStrike())
    let _minStrike                                 = cell (fun () -> _SabrSmileSection.Value.minStrike())
    let _dayCounter                                = cell (fun () -> _SabrSmileSection.Value.dayCounter())
    let _density                                   (strike : ICell<double>) (discount : ICell<double>) (gap : ICell<double>)   
                                                   = cell (fun () -> _SabrSmileSection.Value.density(strike.Value, discount.Value, gap.Value))
    let _digitalOptionPrice                        (strike : ICell<double>) (Type : ICell<Option.Type>) (discount : ICell<double>) (gap : ICell<double>)   
                                                   = cell (fun () -> _SabrSmileSection.Value.digitalOptionPrice(strike.Value, Type.Value, discount.Value, gap.Value))
    let _exerciseDate                              = cell (fun () -> _SabrSmileSection.Value.exerciseDate())
    let _exerciseTime                              = cell (fun () -> _SabrSmileSection.Value.exerciseTime())
    let _optionPrice                               (strike : ICell<double>) (Type : ICell<Option.Type>) (discount : ICell<double>)   
                                                   = cell (fun () -> _SabrSmileSection.Value.optionPrice(strike.Value, Type.Value, discount.Value))
    let _referenceDate                             = cell (fun () -> _SabrSmileSection.Value.referenceDate())
    let _shift                                     = cell (fun () -> _SabrSmileSection.Value.shift())
    let _update                                    = cell (fun () -> _SabrSmileSection.Value.update()
                                                                     _SabrSmileSection.Value)
    let _variance                                  (strike : ICell<double>)   
                                                   = cell (fun () -> _SabrSmileSection.Value.variance(strike.Value))
    let _vega                                      (strike : ICell<double>) (discount : ICell<double>)   
                                                   = cell (fun () -> _SabrSmileSection.Value.vega(strike.Value, discount.Value))
    let _volatility                                (strike : ICell<double>) (volatilityType : ICell<VolatilityType>) (shift : ICell<double>)   
                                                   = cell (fun () -> _SabrSmileSection.Value.volatility(strike.Value, volatilityType.Value, shift.Value))
    let _volatility1                               (strike : ICell<double>)   
                                                   = cell (fun () -> _SabrSmileSection.Value.volatility(strike.Value))
    let _volatilityType                            = cell (fun () -> _SabrSmileSection.Value.volatilityType())
