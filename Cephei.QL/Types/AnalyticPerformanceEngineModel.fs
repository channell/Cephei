...
*)
    let mutable
        _AnalyticPerformanceEngine                 = cell (fun () -> (createEvaluationDate _evaluationDate (fun () ->new AnalyticPerformanceEngine (Process.Value))))
...
*)
    ...
    internal new () = new AnalyticPerformanceEngineModel(null,null)
