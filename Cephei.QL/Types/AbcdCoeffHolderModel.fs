...
*)
    ...
    let _b_                                        = triv (fun () -> _AbcdCoeffHolder.Value.b_)
    let _bIsFixed_                                 = triv (fun () -> _AbcdCoeffHolder.Value.bIsFixed_)
    let _c_                                        = triv (fun () -> _AbcdCoeffHolder.Value.c_)
    let _cIsFixed_                                 = triv (fun () -> _AbcdCoeffHolder.Value.cIsFixed_)
    let _d_                                        = triv (fun () -> _AbcdCoeffHolder.Value.d_)
    let _dIsFixed_                                 = triv (fun () -> _AbcdCoeffHolder.Value.dIsFixed_)
    let _error_                                    = triv (fun () -> _AbcdCoeffHolder.Value.error_)
