...
*)
    let mutable
        _YoYInflationTraits                        = make (fun () -> new YoYInflationTraits ())
    let _discountImpl                              (i : ICell<Interpolation>) (t : ICell<double>)   
                                                   = triv _YoYInflationTraits (fun () -> _YoYInflationTraits.Value.discountImpl(i.Value, t.Value))
    let _forwardImpl                               (i : ICell<Interpolation>) (t : ICell<double>)   
                                                   = triv _YoYInflationTraits (fun () -> _YoYInflationTraits.Value.forwardImpl(i.Value, t.Value))
    let _guess                                     (i : ICell<int>) (c : ICell<InterpolatedCurve>) (validData : ICell<bool>) (f : ICell<int>)   
                                                   = triv _YoYInflationTraits (fun () -> _YoYInflationTraits.Value.guess(i.Value, c.Value, validData.Value, f.Value))
    let _initialDate                               (t : ICell<YoYInflationTermStructure>)   
                                                   = triv _YoYInflationTraits (fun () -> _YoYInflationTraits.Value.initialDate(t.Value))
    let _initialValue                              (t : ICell<YoYInflationTermStructure>)   
                                                   = triv _YoYInflationTraits (fun () -> _YoYInflationTraits.Value.initialValue(t.Value))
    let _maxIterations                             = triv _YoYInflationTraits (fun () -> _YoYInflationTraits.Value.maxIterations())
    let _maxValueAfter                             (i : ICell<int>) (c : ICell<InterpolatedCurve>) (validData : ICell<bool>) (f : ICell<int>)   
                                                   = triv _YoYInflationTraits (fun () -> _YoYInflationTraits.Value.maxValueAfter(i.Value, c.Value, validData.Value, f.Value))
    let _minValueAfter                             (i : ICell<int>) (c : ICell<InterpolatedCurve>) (validData : ICell<bool>) (f : ICell<int>)   
                                                   = triv _YoYInflationTraits (fun () -> _YoYInflationTraits.Value.minValueAfter(i.Value, c.Value, validData.Value, f.Value))
    let _updateGuess                               (data : ICell<Generic.List<double>>) (discount : ICell<double>) (i : ICell<int>)   
                                                   = triv _YoYInflationTraits (fun () -> _YoYInflationTraits.Value.updateGuess(data.Value, discount.Value, i.Value)
                                                                                         _YoYInflationTraits.Value)
    let _zeroYieldImpl                             (i : ICell<Interpolation>) (t : ICell<double>)   
                                                   = triv _YoYInflationTraits (fun () -> _YoYInflationTraits.Value.zeroYieldImpl(i.Value, t.Value))
