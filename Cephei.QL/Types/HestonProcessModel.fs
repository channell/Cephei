...
*)
    ...
    let _apply                                     (x0 : ICell<Vector>) (dx : ICell<Vector>)   
                                                   = cell (fun () -> _HestonProcess.Value.apply(x0.Value, dx.Value))
    let _diffusion                                 (t : ICell<double>) (x : ICell<Vector>)   
                                                   = cell (fun () -> _HestonProcess.Value.diffusion(t.Value, x.Value))
    let _dividendYield                             = cell (fun () -> _HestonProcess.Value.dividendYield())
    let _drift                                     (t : ICell<double>) (x : ICell<Vector>)   
                                                   = cell (fun () -> _HestonProcess.Value.drift(t.Value, x.Value))
    let _evolve                                    (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>) (dw : ICell<Vector>)   
                                                   = cell (fun () -> _HestonProcess.Value.evolve(t0.Value, x0.Value, dt.Value, dw.Value))
    let _factors                                   = cell (fun () -> _HestonProcess.Value.factors())
    let _initialValues                             = cell (fun () -> _HestonProcess.Value.initialValues())
    let _kappa                                     = cell (fun () -> _HestonProcess.Value.kappa())
    let _rho                                       = cell (fun () -> _HestonProcess.Value.rho())
    let _riskFreeRate                              = cell (fun () -> _HestonProcess.Value.riskFreeRate())
    let _s0                                        = cell (fun () -> _HestonProcess.Value.s0())
    let _sigma                                     = cell (fun () -> _HestonProcess.Value.sigma())
    let _size                                      = cell (fun () -> _HestonProcess.Value.size())
    let _theta                                     = cell (fun () -> _HestonProcess.Value.theta())
    let _time                                      (d : ICell<Date>)   
                                                   = cell (fun () -> _HestonProcess.Value.time(d.Value))
    let _v0                                        = cell (fun () -> _HestonProcess.Value.v0())
    let _covariance                                (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>)   
                                                   = cell (fun () -> _HestonProcess.Value.covariance(t0.Value, x0.Value, dt.Value))
    let _expectation                               (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>)   
                                                   = cell (fun () -> _HestonProcess.Value.expectation(t0.Value, x0.Value, dt.Value))
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _HestonProcess.Value.registerWith(handler.Value)
                                                                     _HestonProcess.Value)
    let _stdDeviation                              (t0 : ICell<double>) (x0 : ICell<Vector>) (dt : ICell<double>)   
                                                   = cell (fun () -> _HestonProcess.Value.stdDeviation(t0.Value, x0.Value, dt.Value))
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _HestonProcess.Value.unregisterWith(handler.Value)
                                                                     _HestonProcess.Value)
    let _update                                    = cell (fun () -> _HestonProcess.Value.update()
                                                                     _HestonProcess.Value)
