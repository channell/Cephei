...
*)
    ...
    let _empty                                     = triv (fun () -> _Thirty360.Value.empty())
    let _Equals                                    (o : ICell<Object>)   
                                                   = triv (fun () -> _Thirty360.Value.Equals(o.Value))
    let _name                                      = triv (fun () -> _Thirty360.Value.name())
    let _ToString                                  = triv (fun () -> _Thirty360.Value.ToString())
    let _yearFraction                              (d1 : ICell<Date>) (d2 : ICell<Date>) (refPeriodStart : ICell<Date>) (refPeriodEnd : ICell<Date>)   
                                                   = triv (fun () -> _Thirty360.Value.yearFraction(d1.Value, d2.Value, refPeriodStart.Value, refPeriodEnd.Value))
