...
*)
    let mutable
        _Norway                                    = make (fun () -> new Norway ())
    let _addedHolidays                             = triv _Norway (fun () -> _Norway.Value.addedHolidays)
    let _addHoliday                                (d : ICell<Date>)   
                                                   = triv _Norway (fun () -> _Norway.Value.addHoliday(d.Value)
                                                                             _Norway.Value)
    let _adjust                                    (d : ICell<Date>) (c : ICell<BusinessDayConvention>)   
                                                   = triv _Norway (fun () -> _Norway.Value.adjust(d.Value, c.Value))
    let _advance                                   (d : ICell<Date>) (p : ICell<Period>) (c : ICell<BusinessDayConvention>) (endOfMonth : ICell<bool>)   
                                                   = triv _Norway (fun () -> _Norway.Value.advance(d.Value, p.Value, c.Value, endOfMonth.Value))
    let _advance1                                  (d : ICell<Date>) (n : ICell<int>) (unit : ICell<TimeUnit>) (c : ICell<BusinessDayConvention>) (endOfMonth : ICell<bool>)   
                                                   = triv _Norway (fun () -> _Norway.Value.advance(d.Value, n.Value, unit.Value, c.Value, endOfMonth.Value))
    let _businessDaysBetween                       (from : ICell<Date>) (To : ICell<Date>) (includeFirst : ICell<bool>) (includeLast : ICell<bool>)   
                                                   = triv _Norway (fun () -> _Norway.Value.businessDaysBetween(from.Value, To.Value, includeFirst.Value, includeLast.Value))
    let _calendar                                  = triv _Norway (fun () -> _Norway.Value.calendar)
    let _empty                                     = triv _Norway (fun () -> _Norway.Value.empty())
    let _endOfMonth                                (d : ICell<Date>)   
                                                   = triv _Norway (fun () -> _Norway.Value.endOfMonth(d.Value))
    let _Equals                                    (o : ICell<Object>)   
                                                   = triv _Norway (fun () -> _Norway.Value.Equals(o.Value))
    let _isBusinessDay                             (d : ICell<Date>)   
                                                   = triv _Norway (fun () -> _Norway.Value.isBusinessDay(d.Value))
    let _isEndOfMonth                              (d : ICell<Date>)   
                                                   = triv _Norway (fun () -> _Norway.Value.isEndOfMonth(d.Value))
    let _isHoliday                                 (d : ICell<Date>)   
                                                   = triv _Norway (fun () -> _Norway.Value.isHoliday(d.Value))
    let _isWeekend                                 (w : ICell<DayOfWeek>)   
                                                   = triv _Norway (fun () -> _Norway.Value.isWeekend(w.Value))
    let _name                                      = triv _Norway (fun () -> _Norway.Value.name())
    let _removedHolidays                           = triv _Norway (fun () -> _Norway.Value.removedHolidays)
    let _removeHoliday                             (d : ICell<Date>)   
                                                   = triv _Norway (fun () -> _Norway.Value.removeHoliday(d.Value)
                                                                             _Norway.Value)
