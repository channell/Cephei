...
*)
    ...
    let _CraigSneyd                                = cell (fun () -> _FdmSchemeDesc.Value.CraigSneyd())
    let _CrankNicolson                             = cell (fun () -> _FdmSchemeDesc.Value.CrankNicolson())
    let _Douglas                                   = cell (fun () -> _FdmSchemeDesc.Value.Douglas())
    let _ExplicitEuler                             = cell (fun () -> _FdmSchemeDesc.Value.ExplicitEuler())
    let _Hundsdorfer                               = cell (fun () -> _FdmSchemeDesc.Value.Hundsdorfer())
    let _ImplicitEuler                             = cell (fun () -> _FdmSchemeDesc.Value.ImplicitEuler())
    let _MethodOfLines                             (eps : ICell<double>) (relInitStepSize : ICell<double>)   
                                                   = cell (fun () -> _FdmSchemeDesc.Value.MethodOfLines(eps.Value, relInitStepSize.Value))
    let _ModifiedCraigSneyd                        = cell (fun () -> _FdmSchemeDesc.Value.ModifiedCraigSneyd())
    let _ModifiedHundsdorfer                       = cell (fun () -> _FdmSchemeDesc.Value.ModifiedHundsdorfer())
    let _mu                                        = cell (fun () -> _FdmSchemeDesc.Value.mu)
    let _theta                                     = cell (fun () -> _FdmSchemeDesc.Value.theta)
    let _TrBDF2                                    = cell (fun () -> _FdmSchemeDesc.Value.TrBDF2())
    let _type                                      = cell (fun () -> _FdmSchemeDesc.Value.TYPE)
