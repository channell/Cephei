...
(*
    Functions
*)
    let _CallableZeroCouponBond                    = cell (fun () -> withEngine _pricingEngine.Value (new CallableZeroCouponBond (settlementDays.Value, faceAmount.Value, calendar.Value, maturityDate.Value, dayCounter.Value, paymentConvention.Value, redemption.Value, issueDate.Value, putCallSchedule.Value)))
    let _callability                               = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).callability())
    ...
    let _effectiveConvexity                        (oas : ICell<double>) (engineTS : ICell<Handle<YieldTermStructure>>) (dayCounter : ICell<DayCounter>) (compounding : ICell<Compounding>) (frequency : ICell<Frequency>) (bump : ICell<double>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).effectiveConvexity(oas.Value, engineTS.Value, dayCounter.Value, compounding.Value, frequency.Value, bump.Value))
    let _effectiveDuration                         (oas : ICell<double>) (engineTS : ICell<Handle<YieldTermStructure>>) (dayCounter : ICell<DayCounter>) (compounding : ICell<Compounding>) (frequency : ICell<Frequency>) (bump : ICell<double>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).effectiveDuration(oas.Value, engineTS.Value, dayCounter.Value, compounding.Value, frequency.Value, bump.Value))
    let _impliedVolatility                         (targetValue : ICell<double>) (discountCurve : ICell<Handle<YieldTermStructure>>) (accuracy : ICell<double>) (maxEvaluations : ICell<int>) (minVol : ICell<double>) (maxVol : ICell<double>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).impliedVolatility(targetValue.Value, discountCurve.Value, accuracy.Value, maxEvaluations.Value, minVol.Value, maxVol.Value))
    let _OAS                                       (cleanPrice : ICell<double>) (engineTS : ICell<Handle<YieldTermStructure>>) (dayCounter : ICell<DayCounter>) (compounding : ICell<Compounding>) (frequency : ICell<Frequency>) (settlement : ICell<Date>) (accuracy : ICell<double>) (maxIterations : ICell<int>) (guess : ICell<double>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).OAS(cleanPrice.Value, engineTS.Value, dayCounter.Value, compounding.Value, frequency.Value, settlement.Value, accuracy.Value, maxIterations.Value, guess.Value))
    let _accruedAmount                             (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).accruedAmount(settlement.Value))
    let _calendar                                  = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).calendar())
    let _cashflows                                 = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).cashflows())
    ...
    let _dirtyPrice1                               (Yield : ICell<double>) (dc : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).dirtyPrice(Yield.Value, dc.Value, comp.Value, freq.Value, settlement.Value))
    let _isExpired                                 = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).isExpired())
    let _issueDate                                 = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).issueDate())
    let _isTradable                                (d : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).isTradable(d.Value))
    let _maturityDate                              = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).maturityDate())
    let _nextCashFlowDate                          (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).nextCashFlowDate(settlement.Value))
    let _nextCouponRate                            (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).nextCouponRate(settlement.Value))
    let _notional                                  (d : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).notional(d.Value))
    let _notionals                                 = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).notionals())
    let _previousCashFlowDate                      (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).previousCashFlowDate(settlement.Value))
    let _previousCouponRate                        (settlement : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).previousCouponRate(settlement.Value))
    let _redemption                                = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).redemption())
    let _redemptions                               = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).redemptions())
    let _settlementDate                            (date : ICell<Date>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).settlementDate(date.Value))
    let _settlementDays                            = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).settlementDays())
    let _settlementValue                           (cleanPrice : ICell<double>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).settlementValue(cleanPrice.Value))
    let _settlementValue1                          = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).settlementValue())
    let _startDate                                 = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).startDate())
    ...
    let _errorEstimate                             = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).errorEstimate())
    let _NPV                                       = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).setPricingEngine(e.Value)
                                                                     _CallableZeroCouponBond.Value)
    let _valuationDate                             = cell (fun () -> (withEvaluationDate _evaluationDate _CallableZeroCouponBond).valuationDate())
