...
*)
    ...
    let _dayCounter                                = cell (fun () -> _LocalVolSurface.Value.dayCounter())
    let _maxDate                                   = cell (fun () -> _LocalVolSurface.Value.maxDate())
    let _maxStrike                                 = cell (fun () -> _LocalVolSurface.Value.maxStrike())
    let _minStrike                                 = cell (fun () -> _LocalVolSurface.Value.minStrike())
    let _referenceDate                             = cell (fun () -> _LocalVolSurface.Value.referenceDate())
    let _localVol                                  (t : ICell<double>) (underlyingLevel : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _LocalVolSurface.Value.localVol(t.Value, underlyingLevel.Value, extrapolate.Value))
    let _localVol1                                 (d : ICell<Date>) (underlyingLevel : ICell<double>) (extrapolate : ICell<bool>)   
                                                   = cell (fun () -> _LocalVolSurface.Value.localVol(d.Value, underlyingLevel.Value, extrapolate.Value))
    let _businessDayConvention                     = cell (fun () -> _LocalVolSurface.Value.businessDayConvention())
    let _optionDateFromTenor                       (p : ICell<Period>)   
                                                   = cell (fun () -> _LocalVolSurface.Value.optionDateFromTenor(p.Value))
    let _calendar                                  = cell (fun () -> _LocalVolSurface.Value.calendar())
    let _maxTime                                   = cell (fun () -> _LocalVolSurface.Value.maxTime())
    let _settlementDays                            = cell (fun () -> _LocalVolSurface.Value.settlementDays())
    let _timeFromReference                         (date : ICell<Date>)   
                                                   = cell (fun () -> _LocalVolSurface.Value.timeFromReference(date.Value))
    let _update                                    = cell (fun () -> _LocalVolSurface.Value.update()
                                                                     _LocalVolSurface.Value)
    let _allowsExtrapolation                       = cell (fun () -> _LocalVolSurface.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _LocalVolSurface.Value.disableExtrapolation(b.Value)
                                                                     _LocalVolSurface.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _LocalVolSurface.Value.enableExtrapolation(b.Value)
                                                                     _LocalVolSurface.Value)
    let _extrapolate                               = cell (fun () -> _LocalVolSurface.Value.extrapolate)
