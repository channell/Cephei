...
*)
    ...
    let _inArrears                                 = cell (fun () -> _DigitalIborLeg.Value.inArrears())
    let _inArrears1                                (flag : ICell<bool>)   
                                                   = cell (fun () -> _DigitalIborLeg.Value.inArrears(flag.Value))
    let _value                                     = cell (fun () -> _DigitalIborLeg.Value.value())
    let _withCallATM                               (flag : ICell<bool>)   
                                                   = cell (fun () -> _DigitalIborLeg.Value.withCallATM(flag.Value))
    let _withCallATM1                              = cell (fun () -> _DigitalIborLeg.Value.withCallATM())
    let _withCallPayoffs                           (payoffs : ICell<Generic.List<double>>)   
                                                   = cell (fun () -> _DigitalIborLeg.Value.withCallPayoffs(payoffs.Value))
    let _withCallPayoffs1                          (payoff : ICell<double>)   
                                                   = cell (fun () -> _DigitalIborLeg.Value.withCallPayoffs(payoff.Value))
    let _withCallStrikes                           (strikes : ICell<Generic.List<double>>)   
                                                   = cell (fun () -> _DigitalIborLeg.Value.withCallStrikes(strikes.Value))
    let _withCallStrikes1                          (strike : ICell<double>)   
                                                   = cell (fun () -> _DigitalIborLeg.Value.withCallStrikes(strike.Value))
    let _withFixingDays                            (fixingDays : ICell<Generic.List<int>>)   
                                                   = cell (fun () -> _DigitalIborLeg.Value.withFixingDays(fixingDays.Value))
    let _withFixingDays1                           (fixingDays : ICell<int>)   
                                                   = cell (fun () -> _DigitalIborLeg.Value.withFixingDays(fixingDays.Value))
    let _withGearings                              (gearings : ICell<Generic.List<double>>)   
                                                   = cell (fun () -> _DigitalIborLeg.Value.withGearings(gearings.Value))
    let _withGearings1                             (gearing : ICell<double>)   
                                                   = cell (fun () -> _DigitalIborLeg.Value.withGearings(gearing.Value))
    let _withLongCallOption                        (Type : ICell<Position.Type>)   
                                                   = cell (fun () -> _DigitalIborLeg.Value.withLongCallOption(Type.Value))
    let _withLongPutOption                         (Type : ICell<Position.Type>)   
                                                   = cell (fun () -> _DigitalIborLeg.Value.withLongPutOption(Type.Value))
    let _withNotionals                             (notionals : ICell<Generic.List<double>>)   
                                                   = cell (fun () -> _DigitalIborLeg.Value.withNotionals(notionals.Value))
    let _withNotionals1                            (notional : ICell<double>)   
                                                   = cell (fun () -> _DigitalIborLeg.Value.withNotionals(notional.Value))
    let _withPaymentAdjustment                     (convention : ICell<BusinessDayConvention>)   
                                                   = cell (fun () -> _DigitalIborLeg.Value.withPaymentAdjustment(convention.Value))
    let _withPaymentDayCounter                     (dayCounter : ICell<DayCounter>)   
                                                   = cell (fun () -> _DigitalIborLeg.Value.withPaymentDayCounter(dayCounter.Value))
    let _withPutATM                                (flag : ICell<bool>)   
                                                   = cell (fun () -> _DigitalIborLeg.Value.withPutATM(flag.Value))
    let _withPutATM1                               = cell (fun () -> _DigitalIborLeg.Value.withPutATM())
    let _withPutPayoffs                            (payoffs : ICell<Generic.List<double>>)   
                                                   = cell (fun () -> _DigitalIborLeg.Value.withPutPayoffs(payoffs.Value))
    let _withPutPayoffs1                           (payoff : ICell<double>)   
                                                   = cell (fun () -> _DigitalIborLeg.Value.withPutPayoffs(payoff.Value))
    let _withPutStrikes                            (strike : ICell<double>)   
                                                   = cell (fun () -> _DigitalIborLeg.Value.withPutStrikes(strike.Value))
    let _withPutStrikes1                           (strikes : ICell<Generic.List<double>>)   
                                                   = cell (fun () -> _DigitalIborLeg.Value.withPutStrikes(strikes.Value))
    let _withReplication                           = cell (fun () -> _DigitalIborLeg.Value.withReplication())
    let _withReplication1                          (replication : ICell<DigitalReplication>)   
                                                   = cell (fun () -> _DigitalIborLeg.Value.withReplication(replication.Value))
    let _withSpreads                               (spreads : ICell<Generic.List<double>>)   
                                                   = cell (fun () -> _DigitalIborLeg.Value.withSpreads(spreads.Value))
    let _withSpreads1                              (spread : ICell<double>)   
                                                   = cell (fun () -> _DigitalIborLeg.Value.withSpreads(spread.Value))
