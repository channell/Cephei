...
*)
    ...
    let _aCoefficients                             = cell (fun () -> _Parabolic.Value.aCoefficients())
    let _bCoefficients                             = cell (fun () -> _Parabolic.Value.bCoefficients())
    let _cCoefficients                             = cell (fun () -> _Parabolic.Value.cCoefficients())
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _Parabolic.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = cell (fun () -> _Parabolic.Value.empty())
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _Parabolic.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _Parabolic.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = cell (fun () -> _Parabolic.Value.update()
                                                                     _Parabolic.Value)
    let _value                                     (x : ICell<double>)   
                                                   = cell (fun () -> _Parabolic.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _Parabolic.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = cell (fun () -> _Parabolic.Value.xMax())
    let _xMin                                      = cell (fun () -> _Parabolic.Value.xMin())
    let _allowsExtrapolation                       = cell (fun () -> _Parabolic.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _Parabolic.Value.disableExtrapolation(b.Value)
                                                                     _Parabolic.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _Parabolic.Value.enableExtrapolation(b.Value)
                                                                     _Parabolic.Value)
    let _extrapolate                               = cell (fun () -> _Parabolic.Value.extrapolate)
