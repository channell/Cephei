...
*)
    ...
    let _GetAt                                     (row : ICell<int>) (col : ICell<int>)   
                                                   = triv (fun () -> _SparseMatrix.Value.GetAt(row.Value, col.Value))
    let _GetColumnData                             (col : ICell<int>)   
                                                   = triv (fun () -> _SparseMatrix.Value.GetColumnData(col.Value))
    let _GetColumnDataCount                        (col : ICell<int>)   
                                                   = triv (fun () -> _SparseMatrix.Value.GetColumnDataCount(col.Value))
    let _GetRowData                                (row : ICell<int>)   
                                                   = triv (fun () -> _SparseMatrix.Value.GetRowData(row.Value))
    let _GetRowDataCount                           (row : ICell<int>)   
                                                   = triv (fun () -> _SparseMatrix.Value.GetRowDataCount(row.Value))
    let _RemoveAt                                  (row : ICell<int>) (col : ICell<int>)   
                                                   = triv (fun () -> _SparseMatrix.Value.RemoveAt(row.Value, col.Value)
                                                                     _SparseMatrix.Value)
    let _rows                                      = triv (fun () -> _SparseMatrix.Value.rows())
    let _SetAt                                     (row : ICell<int>) (col : ICell<int>) (value : ICell<double>)   
                                                   = triv (fun () -> _SparseMatrix.Value.SetAt(row.Value, col.Value, value.Value)
                                                                     _SparseMatrix.Value)
