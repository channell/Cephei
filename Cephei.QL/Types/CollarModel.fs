...
*)
    ...
    let _atmRate                                   (discountCurve : ICell<YieldTermStructure>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _Collar).atmRate(discountCurve.Value))
    let _capRates                                  = cell (fun () -> (withEvaluationDate _evaluationDate _Collar).capRates())
    let _floatingLeg                               = cell (fun () -> (withEvaluationDate _evaluationDate _Collar).floatingLeg())
    let _floorRates                                = cell (fun () -> (withEvaluationDate _evaluationDate _Collar).floorRates())
    let _getType                                   = cell (fun () -> (withEvaluationDate _evaluationDate _Collar).getType())
    let _impliedVolatility                         (targetValue : ICell<double>) (discountCurve : ICell<Handle<YieldTermStructure>>) (guess : ICell<double>) (accuracy : ICell<double>) (maxEvaluations : ICell<int>) (minVol : ICell<double>) (maxVol : ICell<double>) (Type : ICell<VolatilityType>) (displacement : ICell<double>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _Collar).impliedVolatility(targetValue.Value, discountCurve.Value, guess.Value, accuracy.Value, maxEvaluations.Value, minVol.Value, maxVol.Value, Type.Value, displacement.Value))
    let _impliedVolatility1                        (targetValue : ICell<double>) (discountCurve : ICell<Handle<YieldTermStructure>>) (guess : ICell<double>) (accuracy : ICell<double>) (maxEvaluations : ICell<int>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _Collar).impliedVolatility(targetValue.Value, discountCurve.Value, guess.Value, accuracy.Value, maxEvaluations.Value))
    let _isExpired                                 = cell (fun () -> (withEvaluationDate _evaluationDate _Collar).isExpired())
    let _lastFloatingRateCoupon                    = cell (fun () -> (withEvaluationDate _evaluationDate _Collar).lastFloatingRateCoupon())
    let _maturityDate                              = cell (fun () -> (withEvaluationDate _evaluationDate _Collar).maturityDate())
    let _optionlet                                 (i : ICell<int>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _Collar).optionlet(i.Value))
    let _startDate                                 = cell (fun () -> (withEvaluationDate _evaluationDate _Collar).startDate())
    let _CASH                                      = cell (fun () -> (withEvaluationDate _evaluationDate _Collar).CASH())
    let _errorEstimate                             = cell (fun () -> (withEvaluationDate _evaluationDate _Collar).errorEstimate())
    let _NPV                                       = cell (fun () -> (withEvaluationDate _evaluationDate _Collar).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _Collar).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _Collar).setPricingEngine(e.Value)
                                                                     _Collar.Value)
    let _valuationDate                             = cell (fun () -> (withEvaluationDate _evaluationDate _Collar).valuationDate())
