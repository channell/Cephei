...
*)
    ...
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _VannaVolgaInterpolation.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = cell (fun () -> _VannaVolgaInterpolation.Value.empty())
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _VannaVolgaInterpolation.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _VannaVolgaInterpolation.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = cell (fun () -> _VannaVolgaInterpolation.Value.update()
                                                                     _VannaVolgaInterpolation.Value)
    let _value                                     (x : ICell<double>)   
                                                   = cell (fun () -> _VannaVolgaInterpolation.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _VannaVolgaInterpolation.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = cell (fun () -> _VannaVolgaInterpolation.Value.xMax())
    let _xMin                                      = cell (fun () -> _VannaVolgaInterpolation.Value.xMin())
    let _allowsExtrapolation                       = cell (fun () -> _VannaVolgaInterpolation.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _VannaVolgaInterpolation.Value.disableExtrapolation(b.Value)
                                                                     _VannaVolgaInterpolation.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _VannaVolgaInterpolation.Value.enableExtrapolation(b.Value)
                                                                     _VannaVolgaInterpolation.Value)
    let _extrapolate                               = cell (fun () -> _VannaVolgaInterpolation.Value.extrapolate)
