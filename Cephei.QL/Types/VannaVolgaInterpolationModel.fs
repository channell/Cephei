...
*)
    ...
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _VannaVolgaInterpolation.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _VannaVolgaInterpolation.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = triv (fun () -> _VannaVolgaInterpolation.Value.update()
                                                                     _VannaVolgaInterpolation.Value)
    let _value                                     (x : ICell<double>)   
                                                   = triv (fun () -> _VannaVolgaInterpolation.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv (fun () -> _VannaVolgaInterpolation.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = triv (fun () -> _VannaVolgaInterpolation.Value.xMax())
    let _xMin                                      = triv (fun () -> _VannaVolgaInterpolation.Value.xMin())
    let _allowsExtrapolation                       = triv (fun () -> _VannaVolgaInterpolation.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv (fun () -> _VannaVolgaInterpolation.Value.disableExtrapolation(b.Value)
                                                                     _VannaVolgaInterpolation.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv (fun () -> _VannaVolgaInterpolation.Value.enableExtrapolation(b.Value)
                                                                     _VannaVolgaInterpolation.Value)
    let _extrapolate                               = triv (fun () -> _VannaVolgaInterpolation.Value.extrapolate)
