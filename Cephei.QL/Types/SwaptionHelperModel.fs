...
(*
    Functions
*)
    let _SwaptionHelper                            = cell (fun () -> withEngine _pricingEngine.Value (new SwaptionHelper (maturity.Value, length.Value, volatility.Value, index.Value, fixedLegTenor.Value, fixedLegDayCounter.Value, floatingLegDayCounter.Value, termStructure.Value, errorType.Value, strike.Value, nominal.Value, Type.Value, shift.Value)))
    let _addTimesTo                                (times : ICell<Generic.List<double>>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).addTimesTo(times.Value)
                                                                     _SwaptionHelper.Value)
    let _blackPrice                                (sigma : ICell<double>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).blackPrice(sigma.Value))
    let _modelValue                                = cell (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).modelValue())
    let _swaption                                  = cell (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).swaption())
    let _underlyingSwap                            = cell (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).underlyingSwap())
    let _calibrationError                          = cell (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).calibrationError())
    let _impliedVolatility                         (targetValue : ICell<double>) (accuracy : ICell<double>) (maxEvaluations : ICell<int>) (minVol : ICell<double>) (maxVol : ICell<double>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).impliedVolatility(targetValue.Value, accuracy.Value, maxEvaluations.Value, minVol.Value, maxVol.Value))
    let _marketValue                               = cell (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).marketValue())
    let _setPricingEngine                          (engine : ICell<IPricingEngine>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).setPricingEngine(engine.Value)
                                                                     _SwaptionHelper.Value)
    let _volatility                                = cell (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).volatility())
    let _volatilityType                            = cell (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).volatilityType())
...
(*
    Functions
*)
    let _SwaptionHelper                            = cell (fun () -> withEngine _pricingEngine.Value (new SwaptionHelper (exerciseDate.Value, endDate.Value, volatility.Value, index.Value, fixedLegTenor.Value, fixedLegDayCounter.Value, floatingLegDayCounter.Value, termStructure.Value, errorType.Value, strike.Value, nominal.Value, Type.Value, shift.Value)))
    let _addTimesTo                                (times : ICell<Generic.List<double>>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).addTimesTo(times.Value)
                                                                     _SwaptionHelper.Value)
    let _blackPrice                                (sigma : ICell<double>)   
...
(*
    Functions
*)
    let _SwaptionHelper                            = cell (fun () -> withEngine _pricingEngine.Value (new SwaptionHelper (exerciseDate.Value, length.Value, volatility.Value, index.Value, fixedLegTenor.Value, fixedLegDayCounter.Value, floatingLegDayCounter.Value, termStructure.Value, errorType.Value, strike.Value, nominal.Value, Type.Value, shift.Value)))
    let _addTimesTo                                (times : ICell<Generic.List<double>>)   
                                                   = cell (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).addTimesTo(times.Value)
                                                                     _SwaptionHelper.Value)
    let _blackPrice                                (sigma : ICell<double>)   
