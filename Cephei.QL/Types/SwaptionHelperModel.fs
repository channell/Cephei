...
*)
    let mutable
        _SwaptionHelper                            = make (fun () -> withEngine pricingEngine evaluationDate (new SwaptionHelper (maturity.Value, length.Value, volatility.Value, index.Value, fixedLegTenor.Value, fixedLegDayCounter.Value, floatingLegDayCounter.Value, termStructure.Value, errorType.Value, strike.Value, nominal.Value, Type.Value, shift.Value)))
    let _addTimesTo                                (times : ICell<Generic.List<double>>)   
                                                   = triv _SwaptionHelper (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).addTimesTo(times.Value)
                                                                                     _SwaptionHelper.Value)
    let _blackPrice                                (sigma : ICell<double>)   
                                                   = triv _SwaptionHelper (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).blackPrice(sigma.Value))
    let _modelValue                                = triv _SwaptionHelper (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).modelValue())
    let _swaption                                  = triv _SwaptionHelper (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).swaption())
    let _underlyingSwap                            = triv _SwaptionHelper (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).underlyingSwap())
    let _calibrationError                          = triv _SwaptionHelper (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).calibrationError())
    let _impliedVolatility                         (targetValue : ICell<double>) (accuracy : ICell<double>) (maxEvaluations : ICell<int>) (minVol : ICell<double>) (maxVol : ICell<double>)   
                                                   = triv _SwaptionHelper (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).impliedVolatility(targetValue.Value, accuracy.Value, maxEvaluations.Value, minVol.Value, maxVol.Value))
    let _marketValue                               = triv _SwaptionHelper (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).marketValue())
    let _setPricingEngine                          (engine : ICell<IPricingEngine>)   
                                                   = triv _SwaptionHelper (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).setPricingEngine(engine.Value)
                                                                                     _SwaptionHelper.Value)
    let _volatility                                = triv _SwaptionHelper (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).volatility())
    let _volatilityType                            = triv _SwaptionHelper (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).volatilityType())
...
*)
    let mutable
        _SwaptionHelper                            = make (fun () -> withEngine pricingEngine evaluationDate (new SwaptionHelper (exerciseDate.Value, endDate.Value, volatility.Value, index.Value, fixedLegTenor.Value, fixedLegDayCounter.Value, floatingLegDayCounter.Value, termStructure.Value, errorType.Value, strike.Value, nominal.Value, Type.Value, shift.Value)))
    let _addTimesTo                                (times : ICell<Generic.List<double>>)   
                                                   = triv _SwaptionHelper (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).addTimesTo(times.Value)
                                                                                     _SwaptionHelper.Value)
    let _blackPrice                                (sigma : ICell<double>)   
...
*)
    let mutable
        _SwaptionHelper                            = make (fun () -> withEngine pricingEngine evaluationDate (new SwaptionHelper (exerciseDate.Value, length.Value, volatility.Value, index.Value, fixedLegTenor.Value, fixedLegDayCounter.Value, floatingLegDayCounter.Value, termStructure.Value, errorType.Value, strike.Value, nominal.Value, Type.Value, shift.Value)))
    let _addTimesTo                                (times : ICell<Generic.List<double>>)   
                                                   = triv _SwaptionHelper (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).addTimesTo(times.Value)
                                                                                     _SwaptionHelper.Value)
    let _blackPrice                                (sigma : ICell<double>)   
