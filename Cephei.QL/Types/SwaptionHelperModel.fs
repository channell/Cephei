...
(*
    Functions
*)
    let _SwaptionHelper                            = triv (fun () -> withEngine _pricingEngine.Value (new SwaptionHelper (maturity.Value, length.Value, volatility.Value, index.Value, fixedLegTenor.Value, fixedLegDayCounter.Value, floatingLegDayCounter.Value, termStructure.Value, errorType.Value, strike.Value, nominal.Value, Type.Value, shift.Value)))
...
(*
    Functions
*)
    let _SwaptionHelper                            = triv (fun () -> withEngine _pricingEngine.Value (new SwaptionHelper (exerciseDate.Value, endDate.Value, volatility.Value, index.Value, fixedLegTenor.Value, fixedLegDayCounter.Value, floatingLegDayCounter.Value, termStructure.Value, errorType.Value, strike.Value, nominal.Value, Type.Value, shift.Value)))
    let _addTimesTo                                (times : ICell<Generic.List<double>>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).addTimesTo(times.Value)
                                                                     _SwaptionHelper.Value)
    let _blackPrice                                (sigma : ICell<double>)   
...
(*
    Functions
*)
    let _SwaptionHelper                            = triv (fun () -> withEngine _pricingEngine.Value (new SwaptionHelper (exerciseDate.Value, length.Value, volatility.Value, index.Value, fixedLegTenor.Value, fixedLegDayCounter.Value, floatingLegDayCounter.Value, termStructure.Value, errorType.Value, strike.Value, nominal.Value, Type.Value, shift.Value)))
    let _addTimesTo                                (times : ICell<Generic.List<double>>)   
                                                   = triv (fun () -> (withEvaluationDate _evaluationDate _SwaptionHelper).addTimesTo(times.Value)
                                                                     _SwaptionHelper.Value)
    let _blackPrice                                (sigma : ICell<double>)   
