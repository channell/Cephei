...
*)
    let mutable
        _SABRInterpolation                         = make (fun () -> new SABRInterpolation (xBegin.Value, xEnd.Value, yBegin.Value, t.Value, forward.Value, alpha.Value, beta.Value, nu.Value, rho.Value, alphaIsFixed.Value, betaIsFixed.Value, nuIsFixed.Value, rhoIsFixed.Value, vegaWeighted.Value, endCriteria.Value, optMethod.Value, errorAccept.Value, useMaxError.Value, maxGuesses.Value, shift.Value, volatilityType.Value, approximationModel.Value))
    let _alpha                                     = triv _SABRInterpolation (fun () -> _SABRInterpolation.Value.alpha())
    let _beta                                      = triv _SABRInterpolation (fun () -> _SABRInterpolation.Value.beta())
    let _endCriteria                               = triv _SABRInterpolation (fun () -> _SABRInterpolation.Value.endCriteria())
    let _expiry                                    = triv _SABRInterpolation (fun () -> _SABRInterpolation.Value.expiry())
    let _forward                                   = triv _SABRInterpolation (fun () -> _SABRInterpolation.Value.forward())
    let _interpolationWeights                      = triv _SABRInterpolation (fun () -> _SABRInterpolation.Value.interpolationWeights())
    let _maxError                                  = triv _SABRInterpolation (fun () -> _SABRInterpolation.Value.maxError())
    let _nu                                        = triv _SABRInterpolation (fun () -> _SABRInterpolation.Value.nu())
    let _rho                                       = triv _SABRInterpolation (fun () -> _SABRInterpolation.Value.rho())
    let _rmsError                                  = triv _SABRInterpolation (fun () -> _SABRInterpolation.Value.rmsError())
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv _SABRInterpolation (fun () -> _SABRInterpolation.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = triv _SABRInterpolation (fun () -> _SABRInterpolation.Value.empty())
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv _SABRInterpolation (fun () -> _SABRInterpolation.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv _SABRInterpolation (fun () -> _SABRInterpolation.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = triv _SABRInterpolation (fun () -> _SABRInterpolation.Value.update()
                                                                                        _SABRInterpolation.Value)
    let _value                                     (x : ICell<double>)   
                                                   = triv _SABRInterpolation (fun () -> _SABRInterpolation.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = triv _SABRInterpolation (fun () -> _SABRInterpolation.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = triv _SABRInterpolation (fun () -> _SABRInterpolation.Value.xMax())
    let _xMin                                      = triv _SABRInterpolation (fun () -> _SABRInterpolation.Value.xMin())
    let _allowsExtrapolation                       = triv _SABRInterpolation (fun () -> _SABRInterpolation.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = triv _SABRInterpolation (fun () -> _SABRInterpolation.Value.disableExtrapolation(b.Value)
                                                                                        _SABRInterpolation.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = triv _SABRInterpolation (fun () -> _SABRInterpolation.Value.enableExtrapolation(b.Value)
                                                                                        _SABRInterpolation.Value)
    let _extrapolate                               = triv _SABRInterpolation (fun () -> _SABRInterpolation.Value.extrapolate)
