...
*)
    ...
    let _alpha                                     = cell (fun () -> _SABRInterpolation.Value.alpha())
    let _beta                                      = cell (fun () -> _SABRInterpolation.Value.beta())
    let _endCriteria                               = cell (fun () -> _SABRInterpolation.Value.endCriteria())
    let _expiry                                    = cell (fun () -> _SABRInterpolation.Value.expiry())
    let _forward                                   = cell (fun () -> _SABRInterpolation.Value.forward())
    let _interpolationWeights                      = cell (fun () -> _SABRInterpolation.Value.interpolationWeights())
    let _maxError                                  = cell (fun () -> _SABRInterpolation.Value.maxError())
    let _nu                                        = cell (fun () -> _SABRInterpolation.Value.nu())
    let _rho                                       = cell (fun () -> _SABRInterpolation.Value.rho())
    let _rmsError                                  = cell (fun () -> _SABRInterpolation.Value.rmsError())
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _SABRInterpolation.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = cell (fun () -> _SABRInterpolation.Value.empty())
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _SABRInterpolation.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _SABRInterpolation.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = cell (fun () -> _SABRInterpolation.Value.update()
                                                                     _SABRInterpolation.Value)
    let _value                                     (x : ICell<double>)   
                                                   = cell (fun () -> _SABRInterpolation.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _SABRInterpolation.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = cell (fun () -> _SABRInterpolation.Value.xMax())
    let _xMin                                      = cell (fun () -> _SABRInterpolation.Value.xMin())
    let _allowsExtrapolation                       = cell (fun () -> _SABRInterpolation.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _SABRInterpolation.Value.disableExtrapolation(b.Value)
                                                                     _SABRInterpolation.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _SABRInterpolation.Value.enableExtrapolation(b.Value)
                                                                     _SABRInterpolation.Value)
    let _extrapolate                               = cell (fun () -> _SABRInterpolation.Value.extrapolate)
