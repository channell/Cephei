...
*)
    let mutable
        _FloatingCatBond                           = make (fun () -> withEngine pricingEngine evaluationDate (new FloatingCatBond (settlementDays.Value, faceAmount.Value, startDate.Value, maturityDate.Value, couponFrequency.Value, calendar.Value, iborIndex.Value, accrualDayCounter.Value, notionalRisk.Value, accrualConvention.Value, paymentConvention.Value, fixingDays.Value, gearings.Value, spreads.Value, caps.Value, floors.Value, inArrears.Value, redemption.Value, issueDate.Value, stubDate.Value, rule.Value, endOfMonth.Value)))
    let _exhaustionProbability                     = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).exhaustionProbability())
    let _expectedLoss                              = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).expectedLoss())
    let _lossProbability                           = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).lossProbability())
    let _accruedAmount                             (settlement : ICell<Date>)   
                                                   = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).accruedAmount(settlement.Value))
    let _calendar                                  = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).calendar())
    let _cashflows                                 = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).cashflows())
    let _cleanPrice                                = cell _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).cleanPrice())
    let _cleanPrice1                               (Yield : ICell<double>) (dc : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (settlement : ICell<Date>)   
                                                   = cell _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).cleanPrice(Yield.Value, dc.Value, comp.Value, freq.Value, settlement.Value))
    let _dirtyPrice                                = cell _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).dirtyPrice())
    let _dirtyPrice1                               (Yield : ICell<double>) (dc : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (settlement : ICell<Date>)   
                                                   = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).dirtyPrice(Yield.Value, dc.Value, comp.Value, freq.Value, settlement.Value))
    let _isExpired                                 = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).isExpired())
    let _issueDate                                 = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).issueDate())
    let _isTradable                                (d : ICell<Date>)   
                                                   = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).isTradable(d.Value))
    let _maturityDate                              = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).maturityDate())
    let _nextCashFlowDate                          (settlement : ICell<Date>)   
                                                   = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).nextCashFlowDate(settlement.Value))
    let _nextCouponRate                            (settlement : ICell<Date>)   
                                                   = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).nextCouponRate(settlement.Value))
    let _notional                                  (d : ICell<Date>)   
                                                   = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).notional(d.Value))
    let _notionals                                 = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).notionals())
    let _previousCashFlowDate                      (settlement : ICell<Date>)   
                                                   = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).previousCashFlowDate(settlement.Value))
    let _previousCouponRate                        (settlement : ICell<Date>)   
                                                   = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).previousCouponRate(settlement.Value))
    let _redemption                                = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).redemption())
    let _redemptions                               = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).redemptions())
    let _settlementDate                            (date : ICell<Date>)   
                                                   = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).settlementDate(date.Value))
    let _settlementDays                            = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).settlementDays())
    let _settlementValue                           (cleanPrice : ICell<double>)   
                                                   = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).settlementValue(cleanPrice.Value))
    let _settlementValue1                          = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).settlementValue())
    let _startDate                                 = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).startDate())
    let _yield                                     (dc : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (accuracy : ICell<double>) (maxEvaluations : ICell<int>)   
                                                   = cell _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).YIELD(dc.Value, comp.Value, freq.Value, accuracy.Value, maxEvaluations.Value))
    let _yield1                                    (cleanPrice : ICell<double>) (dc : ICell<DayCounter>) (comp : ICell<Compounding>) (freq : ICell<Frequency>) (settlement : ICell<Date>) (accuracy : ICell<double>) (maxEvaluations : ICell<int>)   
                                                   = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).YIELD(cleanPrice.Value, dc.Value, comp.Value, freq.Value, settlement.Value, accuracy.Value, maxEvaluations.Value))
    let _CASH                                      = cell _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).CASH())
    let _errorEstimate                             = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).errorEstimate())
    let _NPV                                       = cell _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).NPV())
    let _result                                    (tag : ICell<string>)   
                                                   = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).result(tag.Value))
    let _setPricingEngine                          (e : ICell<IPricingEngine>)   
                                                   = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).setPricingEngine(e.Value)
                                                                                      _FloatingCatBond.Value)
    let _valuationDate                             = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).valuationDate())
...
*)
    let mutable
        _FloatingCatBond                           = make (fun () -> withEngine pricingEngine evaluationDate (new FloatingCatBond (settlementDays.Value, faceAmount.Value, schedule.Value, iborIndex.Value, paymentDayCounter.Value, notionalRisk.Value, paymentConvention.Value, fixingDays.Value, gearings.Value, spreads.Value, caps.Value, floors.Value, inArrears.Value, redemption.Value, issueDate.Value)))
    let _exhaustionProbability                     = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).exhaustionProbability())
    let _expectedLoss                              = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).expectedLoss())
    let _lossProbability                           = triv _FloatingCatBond (fun () -> (withEvaluationDate _evaluationDate _FloatingCatBond).lossProbability())
    let _accruedAmount                             (settlement : ICell<Date>)   
