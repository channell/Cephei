...
*)
    ...
    let _adjustedGrid                              = triv (fun () -> _DiscretizedConvertible.Value.adjustedGrid())
    let _applyCallability                          (i : ICell<int>) (convertible : ICell<bool>)   
                                                   = triv (fun () -> _DiscretizedConvertible.Value.applyCallability(i.Value, convertible.Value)
                                                                     _DiscretizedConvertible.Value)
    let _applyConvertibility                       = triv (fun () -> _DiscretizedConvertible.Value.applyConvertibility()
                                                                     _DiscretizedConvertible.Value)
    let _conversionProbability                     = triv (fun () -> _DiscretizedConvertible.Value.conversionProbability())
    let _dividendValues                            = triv (fun () -> _DiscretizedConvertible.Value.dividendValues())
    let _mandatoryTimes                            = triv (fun () -> _DiscretizedConvertible.Value.mandatoryTimes())
    let _process                                   = triv (fun () -> _DiscretizedConvertible.Value.PROCESS())
    let _reset                                     (size : ICell<int>)   
                                                   = triv (fun () -> _DiscretizedConvertible.Value.reset(size.Value)
                                                                     _DiscretizedConvertible.Value)
    let _spreadAdjustedRate                        = triv (fun () -> _DiscretizedConvertible.Value.spreadAdjustedRate())
    let _adjustValues                              = triv (fun () -> _DiscretizedConvertible.Value.adjustValues()
                                                                     _DiscretizedConvertible.Value)
    let _initialize                                (Method : ICell<Lattice>) (t : ICell<double>)   
                                                   = triv (fun () -> _DiscretizedConvertible.Value.initialize(Method.Value, t.Value)
                                                                     _DiscretizedConvertible.Value)
    let _method                                    = triv (fun () -> _DiscretizedConvertible.Value.METHOD())
    let _partialRollback                           (To : ICell<double>)   
                                                   = triv (fun () -> _DiscretizedConvertible.Value.partialRollback(To.Value)
                                                                     _DiscretizedConvertible.Value)
    let _postAdjustValues                          = triv (fun () -> _DiscretizedConvertible.Value.postAdjustValues()
                                                                     _DiscretizedConvertible.Value)
    let _preAdjustValues                           = triv (fun () -> _DiscretizedConvertible.Value.preAdjustValues()
                                                                     _DiscretizedConvertible.Value)
    let _presentValue                              = triv (fun () -> _DiscretizedConvertible.Value.presentValue())
    let _rollback                                  (To : ICell<double>)   
                                                   = triv (fun () -> _DiscretizedConvertible.Value.rollback(To.Value)
                                                                     _DiscretizedConvertible.Value)
    let _setTime                                   (t : ICell<double>)   
                                                   = triv (fun () -> _DiscretizedConvertible.Value.setTime(t.Value)
                                                                     _DiscretizedConvertible.Value)
    let _setValues                                 (v : ICell<Vector>)   
                                                   = triv (fun () -> _DiscretizedConvertible.Value.setValues(v.Value)
                                                                     _DiscretizedConvertible.Value)
