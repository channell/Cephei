...
*)
    let mutable
        _FixedRateBondHelper                       = make (fun () -> new FixedRateBondHelper (price.Value, settlementDays.Value, faceAmount.Value, schedule.Value, coupons.Value, dayCounter.Value, paymentConvention.Value, redemption.Value, issueDate.Value, paymentCalendar.Value, exCouponPeriod.Value, exCouponCalendar.Value, exCouponConvention.Value, exCouponEndOfMonth.Value, useCleanPrice.Value))
    let _fixedRateBond                             = triv _FixedRateBondHelper (fun () -> _FixedRateBondHelper.Value.fixedRateBond())
    let _bond                                      = triv _FixedRateBondHelper (fun () -> _FixedRateBondHelper.Value.bond())
    let _impliedQuote                              = triv _FixedRateBondHelper (fun () -> _FixedRateBondHelper.Value.impliedQuote())
    let _setTermStructure                          (t : ICell<YieldTermStructure>)   
                                                   = triv _FixedRateBondHelper (fun () -> _FixedRateBondHelper.Value.setTermStructure(t.Value)
                                                                                          _FixedRateBondHelper.Value)
    let _useCleanPrice                             = triv _FixedRateBondHelper (fun () -> _FixedRateBondHelper.Value.useCleanPrice())
    let _earliestDate                              = triv _FixedRateBondHelper (fun () -> _FixedRateBondHelper.Value.earliestDate())
    let _latestDate                                = triv _FixedRateBondHelper (fun () -> _FixedRateBondHelper.Value.latestDate())
    let _latestRelevantDate                        = triv _FixedRateBondHelper (fun () -> _FixedRateBondHelper.Value.latestRelevantDate())
    let _maturityDate                              = triv _FixedRateBondHelper (fun () -> _FixedRateBondHelper.Value.maturityDate())
    let _pillarDate                                = triv _FixedRateBondHelper (fun () -> _FixedRateBondHelper.Value.pillarDate())
    let _quote                                     = triv _FixedRateBondHelper (fun () -> _FixedRateBondHelper.Value.quote())
    let _quoteError                                = triv _FixedRateBondHelper (fun () -> _FixedRateBondHelper.Value.quoteError())
    let _quoteIsValid                              = triv _FixedRateBondHelper (fun () -> _FixedRateBondHelper.Value.quoteIsValid())
    let _quoteValue                                = triv _FixedRateBondHelper (fun () -> _FixedRateBondHelper.Value.quoteValue())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = triv _FixedRateBondHelper (fun () -> _FixedRateBondHelper.Value.registerWith(handler.Value)
                                                                                          _FixedRateBondHelper.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = triv _FixedRateBondHelper (fun () -> _FixedRateBondHelper.Value.unregisterWith(handler.Value)
                                                                                          _FixedRateBondHelper.Value)
    let _update                                    = triv _FixedRateBondHelper (fun () -> _FixedRateBondHelper.Value.update()
                                                                                          _FixedRateBondHelper.Value)
