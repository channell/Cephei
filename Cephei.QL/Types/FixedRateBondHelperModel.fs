...
*)
    ...
    let _fixedRateBond                             = cell (fun () -> _FixedRateBondHelper.Value.fixedRateBond())
    let _bond                                      = cell (fun () -> _FixedRateBondHelper.Value.bond())
    let _impliedQuote                              = cell (fun () -> _FixedRateBondHelper.Value.impliedQuote())
    let _setTermStructure                          (t : ICell<YieldTermStructure>)   
                                                   = cell (fun () -> _FixedRateBondHelper.Value.setTermStructure(t.Value)
                                                                     _FixedRateBondHelper.Value)
    let _useCleanPrice                             = cell (fun () -> _FixedRateBondHelper.Value.useCleanPrice())
    let _earliestDate                              = cell (fun () -> _FixedRateBondHelper.Value.earliestDate())
    let _latestDate                                = cell (fun () -> _FixedRateBondHelper.Value.latestDate())
    let _latestRelevantDate                        = cell (fun () -> _FixedRateBondHelper.Value.latestRelevantDate())
    let _maturityDate                              = cell (fun () -> _FixedRateBondHelper.Value.maturityDate())
    let _pillarDate                                = cell (fun () -> _FixedRateBondHelper.Value.pillarDate())
    let _quote                                     = cell (fun () -> _FixedRateBondHelper.Value.quote())
    let _quoteError                                = cell (fun () -> _FixedRateBondHelper.Value.quoteError())
    let _quoteIsValid                              = cell (fun () -> _FixedRateBondHelper.Value.quoteIsValid())
    let _quoteValue                                = cell (fun () -> _FixedRateBondHelper.Value.quoteValue())
    let _registerWith                              (handler : ICell<Callback>)   
                                                   = cell (fun () -> _FixedRateBondHelper.Value.registerWith(handler.Value)
                                                                     _FixedRateBondHelper.Value)
    let _unregisterWith                            (handler : ICell<Callback>)   
                                                   = cell (fun () -> _FixedRateBondHelper.Value.unregisterWith(handler.Value)
                                                                     _FixedRateBondHelper.Value)
    let _update                                    = cell (fun () -> _FixedRateBondHelper.Value.update()
                                                                     _FixedRateBondHelper.Value)
