...
*)
    ...
    let _derivative                                (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _LogLinearInterpolation.Value.derivative(x.Value, allowExtrapolation.Value))
    let _empty                                     = cell (fun () -> _LogLinearInterpolation.Value.empty())
    let _primitive                                 (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _LogLinearInterpolation.Value.primitive(x.Value, allowExtrapolation.Value))
    let _secondDerivative                          (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _LogLinearInterpolation.Value.secondDerivative(x.Value, allowExtrapolation.Value))
    let _update                                    = cell (fun () -> _LogLinearInterpolation.Value.update()
                                                                     _LogLinearInterpolation.Value)
    let _value                                     (x : ICell<double>)   
                                                   = cell (fun () -> _LogLinearInterpolation.Value.value(x.Value))
    let _value1                                    (x : ICell<double>) (allowExtrapolation : ICell<bool>)   
                                                   = cell (fun () -> _LogLinearInterpolation.Value.value(x.Value, allowExtrapolation.Value))
    let _xMax                                      = cell (fun () -> _LogLinearInterpolation.Value.xMax())
    let _xMin                                      = cell (fun () -> _LogLinearInterpolation.Value.xMin())
    let _allowsExtrapolation                       = cell (fun () -> _LogLinearInterpolation.Value.allowsExtrapolation())
    let _disableExtrapolation                      (b : ICell<bool>)   
                                                   = cell (fun () -> _LogLinearInterpolation.Value.disableExtrapolation(b.Value)
                                                                     _LogLinearInterpolation.Value)
    let _enableExtrapolation                       (b : ICell<bool>)   
                                                   = cell (fun () -> _LogLinearInterpolation.Value.enableExtrapolation(b.Value)
                                                                     _LogLinearInterpolation.Value)
    let _extrapolate                               = cell (fun () -> _LogLinearInterpolation.Value.extrapolate)
