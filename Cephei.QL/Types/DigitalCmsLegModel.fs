...
*)
    ...
    let _inArrears                                 = cell (fun () -> _DigitalCmsLeg.Value.inArrears())
    let _inArrears1                                (flag : ICell<bool>)   
                                                   = cell (fun () -> _DigitalCmsLeg.Value.inArrears(flag.Value))
    let _value                                     = cell (fun () -> _DigitalCmsLeg.Value.value())
    let _withCallATM                               = cell (fun () -> _DigitalCmsLeg.Value.withCallATM())
    let _withCallATM1                              (flag : ICell<bool>)   
                                                   = cell (fun () -> _DigitalCmsLeg.Value.withCallATM(flag.Value))
    let _withCallPayoffs                           (payoff : ICell<double>)   
                                                   = cell (fun () -> _DigitalCmsLeg.Value.withCallPayoffs(payoff.Value))
    let _withCallPayoffs1                          (payoffs : ICell<Generic.List<double>>)   
                                                   = cell (fun () -> _DigitalCmsLeg.Value.withCallPayoffs(payoffs.Value))
    let _withCallStrikes                           (strike : ICell<double>)   
                                                   = cell (fun () -> _DigitalCmsLeg.Value.withCallStrikes(strike.Value))
    let _withCallStrikes1                          (strikes : ICell<Generic.List<double>>)   
                                                   = cell (fun () -> _DigitalCmsLeg.Value.withCallStrikes(strikes.Value))
    let _withFixingDays                            (fixingDays : ICell<int>)   
                                                   = cell (fun () -> _DigitalCmsLeg.Value.withFixingDays(fixingDays.Value))
    let _withFixingDays1                           (fixingDays : ICell<Generic.List<int>>)   
                                                   = cell (fun () -> _DigitalCmsLeg.Value.withFixingDays(fixingDays.Value))
    let _withGearings                              (gearings : ICell<Generic.List<double>>)   
                                                   = cell (fun () -> _DigitalCmsLeg.Value.withGearings(gearings.Value))
    let _withGearings1                             (gearing : ICell<double>)   
                                                   = cell (fun () -> _DigitalCmsLeg.Value.withGearings(gearing.Value))
    let _withLongCallOption                        (Type : ICell<Position.Type>)   
                                                   = cell (fun () -> _DigitalCmsLeg.Value.withLongCallOption(Type.Value))
    let _withLongPutOption                         (Type : ICell<Position.Type>)   
                                                   = cell (fun () -> _DigitalCmsLeg.Value.withLongPutOption(Type.Value))
    let _withNotionals                             (notional : ICell<double>)   
                                                   = cell (fun () -> _DigitalCmsLeg.Value.withNotionals(notional.Value))
    let _withNotionals1                            (notionals : ICell<Generic.List<double>>)   
                                                   = cell (fun () -> _DigitalCmsLeg.Value.withNotionals(notionals.Value))
    let _withPaymentAdjustment                     (convention : ICell<BusinessDayConvention>)   
                                                   = cell (fun () -> _DigitalCmsLeg.Value.withPaymentAdjustment(convention.Value))
    let _withPaymentDayCounter                     (dayCounter : ICell<DayCounter>)   
                                                   = cell (fun () -> _DigitalCmsLeg.Value.withPaymentDayCounter(dayCounter.Value))
    let _withPutATM                                (flag : ICell<bool>)   
                                                   = cell (fun () -> _DigitalCmsLeg.Value.withPutATM(flag.Value))
    let _withPutATM1                               = cell (fun () -> _DigitalCmsLeg.Value.withPutATM())
    let _withPutPayoffs                            (payoffs : ICell<Generic.List<double>>)   
                                                   = cell (fun () -> _DigitalCmsLeg.Value.withPutPayoffs(payoffs.Value))
    let _withPutPayoffs1                           (payoff : ICell<double>)   
                                                   = cell (fun () -> _DigitalCmsLeg.Value.withPutPayoffs(payoff.Value))
    let _withPutStrikes                            (strikes : ICell<Generic.List<double>>)   
                                                   = cell (fun () -> _DigitalCmsLeg.Value.withPutStrikes(strikes.Value))
    let _withPutStrikes1                           (strike : ICell<double>)   
                                                   = cell (fun () -> _DigitalCmsLeg.Value.withPutStrikes(strike.Value))
    let _withReplication                           (replication : ICell<DigitalReplication>)   
                                                   = cell (fun () -> _DigitalCmsLeg.Value.withReplication(replication.Value))
    let _withReplication1                          = cell (fun () -> _DigitalCmsLeg.Value.withReplication())
    let _withSpreads                               (spread : ICell<double>)   
                                                   = cell (fun () -> _DigitalCmsLeg.Value.withSpreads(spread.Value))
    let _withSpreads1                              (spreads : ICell<Generic.List<double>>)   
                                                   = cell (fun () -> _DigitalCmsLeg.Value.withSpreads(spreads.Value))
