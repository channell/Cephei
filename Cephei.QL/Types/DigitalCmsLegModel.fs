...
*)
    let mutable
        _DigitalCmsLeg                             = make (fun () -> new DigitalCmsLeg (schedule.Value, index.Value))
    let _inArrears                                 = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.inArrears())
    let _inArrears1                                (flag : ICell<bool>)   
                                                   = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.inArrears(flag.Value))
    let _value                                     = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.value())
    let _withCallATM                               = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withCallATM())
    let _withCallATM1                              (flag : ICell<bool>)   
                                                   = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withCallATM(flag.Value))
    let _withCallPayoffs                           (payoff : ICell<double>)   
                                                   = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withCallPayoffs(payoff.Value))
    let _withCallPayoffs1                          (payoffs : ICell<Generic.List<double>>)   
                                                   = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withCallPayoffs(payoffs.Value))
    let _withCallStrikes                           (strike : ICell<double>)   
                                                   = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withCallStrikes(strike.Value))
    let _withCallStrikes1                          (strikes : ICell<Generic.List<double>>)   
                                                   = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withCallStrikes(strikes.Value))
    let _withFixingDays                            (fixingDays : ICell<int>)   
                                                   = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withFixingDays(fixingDays.Value))
    let _withFixingDays1                           (fixingDays : ICell<Generic.List<int>>)   
                                                   = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withFixingDays(fixingDays.Value))
    let _withGearings                              (gearings : ICell<Generic.List<double>>)   
                                                   = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withGearings(gearings.Value))
    let _withGearings1                             (gearing : ICell<double>)   
                                                   = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withGearings(gearing.Value))
    let _withLongCallOption                        (Type : ICell<Position.Type>)   
                                                   = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withLongCallOption(Type.Value))
    let _withLongPutOption                         (Type : ICell<Position.Type>)   
                                                   = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withLongPutOption(Type.Value))
    let _withNotionals                             (notional : ICell<double>)   
                                                   = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withNotionals(notional.Value))
    let _withNotionals1                            (notionals : ICell<Generic.List<double>>)   
                                                   = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withNotionals(notionals.Value))
    let _withPaymentAdjustment                     (convention : ICell<BusinessDayConvention>)   
                                                   = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withPaymentAdjustment(convention.Value))
    let _withPaymentDayCounter                     (dayCounter : ICell<DayCounter>)   
                                                   = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withPaymentDayCounter(dayCounter.Value))
    let _withPutATM                                (flag : ICell<bool>)   
                                                   = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withPutATM(flag.Value))
    let _withPutATM1                               = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withPutATM())
    let _withPutPayoffs                            (payoffs : ICell<Generic.List<double>>)   
                                                   = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withPutPayoffs(payoffs.Value))
    let _withPutPayoffs1                           (payoff : ICell<double>)   
                                                   = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withPutPayoffs(payoff.Value))
    let _withPutStrikes                            (strikes : ICell<Generic.List<double>>)   
                                                   = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withPutStrikes(strikes.Value))
    let _withPutStrikes1                           (strike : ICell<double>)   
                                                   = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withPutStrikes(strike.Value))
    let _withReplication                           (replication : ICell<DigitalReplication>)   
                                                   = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withReplication(replication.Value))
    let _withReplication1                          = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withReplication())
    let _withSpreads                               (spread : ICell<double>)   
                                                   = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withSpreads(spread.Value))
    let _withSpreads1                              (spreads : ICell<Generic.List<double>>)   
                                                   = triv _DigitalCmsLeg (fun () -> _DigitalCmsLeg.Value.withSpreads(spreads.Value))
