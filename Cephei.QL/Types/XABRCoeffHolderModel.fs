...
*)
    ...
    let _addParams_                                = cell (fun () -> _XABRCoeffHolder.Value.addParams_)
    let _error_                                    = cell (fun () -> _XABRCoeffHolder.Value.error_)
    let _forward_                                  = cell (fun () -> _XABRCoeffHolder.Value.forward_)
    let _maxError_                                 = cell (fun () -> _XABRCoeffHolder.Value.maxError_)
    let _model_                                    = cell (fun () -> _XABRCoeffHolder.Value.model_)
    let _modelInstance_                            = cell (fun () -> _XABRCoeffHolder.Value.modelInstance_)
    let _paramIsFixed_                             = cell (fun () -> _XABRCoeffHolder.Value.paramIsFixed_)
    let _params_                                   = cell (fun () -> _XABRCoeffHolder.Value.params_)
    let _t_                                        = cell (fun () -> _XABRCoeffHolder.Value.t_)
    let _updateModelInstance                       = cell (fun () -> _XABRCoeffHolder.Value.updateModelInstance()
                                                                     _XABRCoeffHolder.Value)
    let _weights_                                  = cell (fun () -> _XABRCoeffHolder.Value.weights_)
    let _XABREndCriteria_                          = cell (fun () -> _XABRCoeffHolder.Value.XABREndCriteria_)
